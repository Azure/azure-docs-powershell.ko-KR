...
## 설명은
**AzureRmSiteRecoveryStorageClassificationMapping** Cmdlet은 Azure Site Recovery에서 저장소 분류 매핑을 만듭니다.
...
' PrimaryStorageClassification ' 매개 변수는 파이프라인에서 ' ASRStorageClassification ' 형식의 값을 허용 합니다.
