...
## 설명은
**AzureRmSiteRecoveryReplicationProtectedItem** cmdlet은 새 복제 보호 항목을 만듭니다.
보호 가능한 항목에 대 한 복제를 사용 하도록 설정 하려면이 cmdlet을 사용 합니다.
...
### -이름
Azure Site Recovery 복제 보호 항목의 이름을 지정 합니다.
...
### -ProtectableItem
Azure Site Recovery 보호 가능한 항목을 지정 합니다.
...
복제에 사용할 Azure Site Recovery 보호 컨테이너 매핑 개체를 지정 합니다.
...
이 cmdlet이 복제 하는 Azure 저장소 계정의 ID를 지정 합니다.
