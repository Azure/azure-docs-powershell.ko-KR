...
## 설명은
**AzureRmSiteRecoveryStorageClassification** Cmdlet은 Azure Site Recovery의 저장소 분류를 가져옵니다.
...
### -FriendlyName
이 cmdlet이 가져오는 저장소 분류의 이름을 지정 합니다.
...
### System.webserver. t e 1.aspx ' 1 [Microsoft SiteRecovery. ASRStorageClassification]
