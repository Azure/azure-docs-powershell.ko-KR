...
## 설명은
**AzureRmBatchAccount** cmdlet은 현재 구독에서 Azure Batch 계정을 가져옵니다. *AccountName* 매개 변수를 사용 하 여 단일 계정을 가져올 수도 있고, *ResourceGroupName* 매개 변수를 사용 하 여 해당 리소스 그룹 아래에 계정을 가져올 수도 있습니다.
...
이 cmdlet은이 매개 변수에서 지정 하는 태그가 포함 된 계정을 가져옵니다.
