...
## 설명은
**AzureRmDataFactoryV2PipelineRun** cmdlet은 PIELINE run ID를 사용 하 여 지정 된 데이터 팩터리에 파이프라인을 중지 합니다.
...
이 명령은 factory WikiADF에서 id b9730a13-aa12-4926-a8b3-8e3a974ab0bd의 파이프라인 실행을 중지 합니다.
...
Microsoft.Azure.Commands.DataFactoryV2.Models.PSDataFactory의 시스템 문자열
