...
**AzureRmNotificationHub** cmdlet과 함께 사용 하는 경우 앞의 JSON 샘플은 경기도 데이터 센터에 있는 ContosoNotificationHub 라는 알림 허브를 만듭니다.
...
**AzureRmNotificationHub** cmdlet이 새 네임 스페이스를 만들 수 없습니다.
...
**새 AzureRmNotificationHub** cmdlet은 새 리소스 그룹을 만들 수 없습니다.
