...
## 설명은
**AzureRmDataLakeAnalyticsJob** Cmdlet은 Azure Data Lake Analytics 작업을 제출 합니다.
...
U-SQL 스크립트 매개 변수는 주요 스크립트 콘텐츠 위에 앞에 있습니다 (예:).

@Department문자열 = "Sales"를 선언 합니다. @NumRecordsInt = 1000를 선언 합니다. @StartDateTimeDatetime = New datetime (2017, 12, 6, 0, 0, 0, 0)을 선언 합니다.
...
### 이름
' Script ' 매개 변수는 파이프라인에서 ' String ' 형식의 값을 허용 합니다.

## 출력

### JobInformation
제출 된 작업에 대 한 초기 작업 세부 정보입니다.
