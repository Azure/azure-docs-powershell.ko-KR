...
## 설명은
**AzureRmStreamAnalyticsInput** Cmdlet은 Stream Analytics 작업에 정의 된 모든 입력을 나열 하거나 특정 입력에 대 한 정보를 가져옵니다.
...
### System.webserver. List ' 1 [[Microsoft Azure.]. PSInput, Microsoft Azure. commands 분석]] Microsoft Azure. e. e. e t e-PSInput. a n i 입력
