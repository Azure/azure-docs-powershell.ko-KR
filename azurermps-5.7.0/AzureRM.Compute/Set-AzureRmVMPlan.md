...
이미지 정보를 찾는 방법에 대 한 자세한 내용은 PowerShell을 사용 하 여 [Azure 가상 컴퓨터 이미지 탐색 및 선택 및](https://azure.microsoft.com/documentation/articles/resource-groups-vm-searching/) Microsoft azure 설명서에서 azure CLI를 참조 하세요.
