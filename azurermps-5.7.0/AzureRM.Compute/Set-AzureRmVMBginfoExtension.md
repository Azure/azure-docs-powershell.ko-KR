...
## 설명은
**AzureRmVMBGInfoExtension** Cmdlet은 BGInfo 확장을 가상 컴퓨터에 추가 합니다.

## 예제의

### 예제 1: 가상 컴퓨터에 BGInfo 확장 추가
```
PS C:\> Set-AzureRmVMBgInfoExtension -ResourceGroupName "ContosoRG" -VMName "ContosoVM"
```
이 명령은 BGInfo 확장을 리소스 그룹 ContosoRG의 ContosoVM 이라는 가상 컴퓨터에 추가 합니다.

### 예제 2: 가상 컴퓨터에 특정 버전의 BGInfo 확장 추가
```
