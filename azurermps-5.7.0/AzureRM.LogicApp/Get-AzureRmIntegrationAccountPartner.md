...
## 설명은
**Get-AzureRmIntegrationAccountPartner** cmdlet은 리소스 그룹에서 통합 계정 파트너를 가져옵니다.
...
이 명령은 IntegrationAccountPartner22 이라는 통합 계정 파트너를 가져옵니다.

### 예제 2: 통합 계정 이름을 사용 하 여 통합 계정 파트너 가져오기
```
...
이 명령은 IntegrationAccount31 이라는 통합 계정의 통합 계정 파트너를 가져옵니다.
