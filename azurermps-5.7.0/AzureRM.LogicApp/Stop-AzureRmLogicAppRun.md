...
## 설명은
**AzureRmLogicAppRun** cmdlet은 논리 앱의 실행을 취소 합니다.
...
이 명령은 LogicApp03 이라는 논리 앱의 실행을 취소 합니다.
...
### -이름
이 cmdlet이 실행을 취소 하는 논리 앱의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 실행을 취소 하는 리소스 그룹의 이름을 지정 합니다.
...
### -RunName
이 cmdlet이 취소 하는 논리 앱 실행의 이름을 지정 합니다.
