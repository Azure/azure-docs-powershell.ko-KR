...
## 설명은
**새 AzureRmIntegrationAccount** cmdlet은 통합 계정을 만듭니다.
이 cmdlet은 통합 계정을 나타내는 개체를 반환 합니다. 이름, 위치, 리소스 그룹 이름 및 SKU 이름을 지정 합니다.
...
이 명령은 지정 된 리소스 그룹에 IntegrationAccount31 이라는 통합 계정을 만듭니다.
