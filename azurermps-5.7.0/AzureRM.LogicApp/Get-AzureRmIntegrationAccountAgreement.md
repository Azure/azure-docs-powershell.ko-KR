...
## 설명은
**AzureRmIntegrationAccountAgreement** Cmdlet은 Azure 리소스 그룹의 통합 계정 계약을 가져옵니다.
...
이 명령은 IntegrationAccountAgreement06 이라는 통합 계정 계약을 가져옵니다.

### 예제 2: 리소스 그룹 이름을 기준으로 통합 계정 계약 가져오기
```
...
이 명령은 리소스 그룹 이름별 통합 계정 계약을 가져옵니다.
