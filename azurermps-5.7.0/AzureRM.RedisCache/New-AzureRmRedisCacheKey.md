...
## 설명은
**AzureRmRedisCacheKey** Cmdlet은 Azure Redis Cache의 선택 키를 다시 생성 합니다.
...
이 명령은 Redis Cache의 기본 키를 생성 합니다.
...
이 명령은 Redis Cache의 보조 키를 다시 생성 합니다.
...
### -KeyType
기본 또는 보조 선택 키를 다시 생성할지 여부를 지정 합니다.
유효한 값은 Primary, Secondary입니다.
...
이 cmdlet은 Redis Cache의 기본 및 보조 선택 키를 반환 합니다.
