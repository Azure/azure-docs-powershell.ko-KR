...
## 설명은
Get-AzureRmContainerRegistryWebhookEvent cmdlet은 webhook의 모든 이벤트를 나열 합니다.
...
### System.webserver. IList ' 1 [[ContainerRegistry PSContainerRegistryWebhookEvent, Microsoft azure. ContainerRegistry, Version = 1.0.0.0, Culture = 중립, PublicKeyToken = null]]
