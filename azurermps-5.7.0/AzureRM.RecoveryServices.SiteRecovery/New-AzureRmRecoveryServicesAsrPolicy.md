...
### -AzureToAzure
만드는 복제 정책이 두 Azure 지역 간에 Azure 가상 컴퓨터를 복제 하는 데 사용 됨을 지정 하는 스위치 매개 변수입니다.
...
### -AzureToVMware
생성 되는 복제 정책이 VMware 가상 머신 및 Azure에서 실행 되는 실제 서버를 온-프레미스 VMware 사이트로 다시 복제 하는 데 사용 됨을 지정 하는 스위치 매개 변수입니다.
