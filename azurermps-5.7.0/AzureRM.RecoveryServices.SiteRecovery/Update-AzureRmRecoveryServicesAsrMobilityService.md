...
## 설명은
**업데이트 AzureRmRecoveryServicesAsrMobilityService** cmdlet은 보호 된 컴퓨터에 대 한 모바일 서비스 에이전트 업데이트를 푸시 하려고 합니다 (업데이트를 사용할 수 있는 경우).
...
복제 보호 항목의 Moblility 서비스 에이전트 업데이트를 추적 하는 작업입니다.
