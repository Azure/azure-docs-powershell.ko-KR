...
## 설명은
**AzureRmRecoveryServicesAsrvCenter** CMDLET은 ASR 패브릭에 지정 된 구성 서버에서 검색을 위해 등록 된 vCenter 서버의 세부 정보를 가져옵니다.
...
패브릭 이름 및 vCenter 이름으로 azure site recovery vCenter를 가져옵니다.
...
### System.webserver. t e r ' 1 [[SiteRecovery] Recoveryrvcenter, Microsoft Azure. SiteRecovery, Version = 0.1.1.0, Culture = 중립, PublicKeyToken = null]])]
