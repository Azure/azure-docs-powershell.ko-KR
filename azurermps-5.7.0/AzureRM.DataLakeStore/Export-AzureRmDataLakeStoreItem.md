...
## 설명은
**Export-AzureRmDataLakeStoreItem** Cmdlet은 Data Lake store에서 파일을 다운로드 합니다.
...
### -ConcurrentFileCount
폴더 다운로드에 대해 병렬로 다운로드할 최대 파일 수를 나타냅니다.  폴더 및 파일 크기에 기반 하 여 기본적으로 가장 좋은 노력으로 계산 됩니다.
...
### -PerFileThreadCount
파일 당 사용할 최대 스레드 수를 나타냅니다.  폴더 및 파일 크기에 기반 하 여 기본적으로 가장 좋은 노력으로 계산 됩니다.
