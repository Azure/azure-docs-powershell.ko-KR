...
## 설명은
**AzureRmSqlDatabaseDataMaskingPolicy** Cmdlet은 Azure SQL 데이터베이스에 대 한 데이터 마스킹 정책을 설정 합니다.
...
*PrivilegedLogins* 매개 변수를 설정 하 여 마스크 되지 않은 데이터를 볼 수 있는 사용자를 지정할 수도 있습니다.
