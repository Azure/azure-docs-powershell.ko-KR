...
## 설명은
**AzureRmSqlElasticPoolRecommendedAction** Cmdlet은 Azure SQL 탄력적인 풀 Advisor에 대해 권장 되는 작업을 하나 이상 가져옵니다.

## 예제의

### 예제 1: 관리자에 대해 권장 되는 모든 작업 나열
```
...
이 명령은 WIRunnerPool 이라는 탄력적 풀에서 사용할 수 있는 CreateIndex 라는 관리자의 모든 권장 작업 목록을 가져옵니다.
...
### -ElasticPoolName
이 cmdlet이 권장 작업을 요청 하는 탄력적 풀의 이름을 지정 합니다.
...
### RecommendedAction. AzureSqlElasticPoolRecommendedActionModel에 대 한
