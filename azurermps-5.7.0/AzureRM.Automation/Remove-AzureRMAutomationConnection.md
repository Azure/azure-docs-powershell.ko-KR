...
## 설명은
**AzureRmAutomationConnection** Cmdlet은 Azure Automation에서 연결을 제거 합니다.
...
이 명령은 Contoso17 이라는 Automation 계정에서 ContosoConnection 이라는 인증서를 제거 합니다.

## 변수

### -AutomationAccountName
이 cmdlet이 연결을 제거 하는 automation 계정의 이름을 지정 합니다.
...
### -이름
이 cmdlet이 제거 하는 연결의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 연결을 제거 하는 리소스 그룹의 이름을 지정 합니다.
