...
### 예제 1 application insights 리소스에 대 한 가격 계획 및 일일 데이터 볼륨 정보 설정
```
...
가격 책정 계획을 "기본"으로 설정 하 고 일일 데이터에 대 한 하위 cap를 하루에 400GB 설정 하 고 리소스 그룹 "testgroup"의 리소스 "테스트"에 대 한 적중 캡이 없는 경우 알림 보내기를 중지 합니다.
...
### PSPricingTier-ApplicationInsights.
