...
## 설명은
리소스 그룹 또는 특정 리소스의 application insights 리소스 가져오기

## 예제의

### 예제 1 application insights 리소스 가져오기
```
...
Resoruce 그룹 "testgroup"에서 "test" 라는 application insights 리소스 가져오기

### 예제 2 가격 계획 정보가 포함 되어 있는 application insights 리소스 가져오기
```
...
Application insights 리소스를 가져오고 "test" 리소스에 대 한 가격 계획 정보를 resoruce 그룹 "testgroup"에 포함 합니다.
...
### -전체
지정 하는 경우 application insights 구성 요소에 대 한 자세한 가격 계획/일일 cap 및 상태를 가져옵니다.
