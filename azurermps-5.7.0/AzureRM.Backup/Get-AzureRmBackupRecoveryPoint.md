...
## 설명은
**AzureRmBackupRecoveryPoint** cmdlet은 백업 된 Azure 백업 항목에 대 한 복구 지점을 가져옵니다.
항목을 백업한 후에는 백업이 하나 이상의 복구 지점을 저장 합니다.

## 예제의

### 예제 1: 항목에 대 한 복구 지점 가져오기
```
...
마지막 명령은 $BackupItem 항목에 대 한 복구 지점을 가져옵니다.
...
### -RecoveryPointId
이 cmdlet이 가져오는 복구 지점의 ID를 지정 합니다.
