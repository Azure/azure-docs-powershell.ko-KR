...
## 설명은
**AzureRmBackupProtectionPolicy** Cmdlet은 Azure backup 자격 증명 모음에 대 한 백업 정책을 가져옵니다.

## 예제의

### 예제 1: 자격 증명 모음의 정책 보기
```
...
두 번째 명령은 $Vault의 자격 증명 모음에 대 한 모든 백업 보호 정책을 가져옵니다.

### 예제 2: 자격 증명 모음에서 특정 정책 가져오기
```
PS C:\>$Vault = Get-AzureRmBackupVault -Name "Vault03"
...
### -저장실
이 cmdlet에서 정책을 가져오는 백업 자격 증명 모음을 지정 합니다.
