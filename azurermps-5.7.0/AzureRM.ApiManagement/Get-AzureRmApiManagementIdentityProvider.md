...
API Management 서비스에 구성 된 Id 공급자에 대 한 세부 정보입니다.

### IList를<ApiManagement> ServiceManagement. PsApiManagementIdentityProvider
API Management 서비스에 구성 된 Id 공급자 목록입니다.
