...
## 설명은
**AzureRmCognitiveServicesAccount** cmdlet은 지정 된 형식 및 SKU의 인지 서비스 계정을 만듭니다.
...
자세한 내용은 [인식 서비스 api](https://www.microsoft.com/cognitive-services/en-us/apis)를 참조 하세요.
...
### -Type
만들 계정의 유형을 지정 합니다. 이 매개 변수에 허용 되는 현재 값은 다음과 같습니다.
