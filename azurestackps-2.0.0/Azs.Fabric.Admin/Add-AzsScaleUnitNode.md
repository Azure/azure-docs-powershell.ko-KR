...
확장 단위 클러스터에 새 배율 단위 노드를 추가 합니다.
...
### -NodeList
배율 단위 노드의 목록입니다.
생성 하려면 NODELIST 속성에 대 한 메모 섹션을 참조 하 고 해시 테이블을 만듭니다.
...
배율 단위 노드 집합을 추가 하는 데 사용할 수 있는 입력 데이터 목록입니다.
생성 하려면 SCALEUNITNODEPARAMETER 속성에 대 한 메모 섹션을 참조 하 고 해시 테이블을 만듭니다.
...
### FabricAdmin. Api20160501. IScaleOutScaleUnitParametersList에 대 한
...
NODELIST <IScaleOutScaleUnitParameters [] >: 배율 단위 노드의 목록입니다.
  - `[BmciPv4Address <String>]`: 물리적 컴퓨터의 BMC 주소입니다.
  - `[ComputerName <String>]`: 물리적 컴퓨터의 컴퓨터 이름입니다.

SCALEUNITNODEPARAMETER <IScaleOutScaleUnitParametersList> : 배율 단위 노드 집합을 추가 하는 데 사용할 수 있는 입력 데이터 목록입니다.
  - `[AwaitStorageConvergence <Boolean?>]`: 플래그 반환 하기 전에 작업이 저장소를 대기 해야 하는지 여부를 나타냅니다.
  - `[NodeList <IScaleOutScaleUnitParameters[]>]`: 배율 단위 노드의 목록입니다.
    - `[BmciPv4Address <String>]`: 물리적 컴퓨터의 BMC 주소입니다.
    - `[ComputerName <String>]`: 물리적 컴퓨터의 컴퓨터 이름입니다.
