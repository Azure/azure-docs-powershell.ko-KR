...
## 설명
**New-AzPowerBIWorkspaceCollection** cmdlet은 지정된 리소스 그룹 및 위치에 Azure 구독에 대한 Power BI 작업 영역 컬렉션을 만듭니다.
...
이 명령은 지정된 위치의 지정된 리소스 그룹에 WCN11이라는 작업 영역 컬렉션을 만듭니다.
...
### -Location
이 cmdlet이 작업 영역 컬렉션을 만드는 Azure 위치를 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 작업 영역 컬렉션을 만드는 리소스 그룹의 이름을 지정합니다.
