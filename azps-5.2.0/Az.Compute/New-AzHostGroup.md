...
이 명령은 주어진 위치 및 영역의 호스트 그룹을 만듭니다.
...
### -PlatformFaultDomain
호스트 그룹이 확장할 수 있는 장애 도메인의 수를 지정합니다.  최소값은 1, 최대값은 3입니다.
...
HostGroup이 vm의 자동 배치를 사용하도록 설정할지 지정합니다.
자동 배치는 이러한 VM이 전용 호스트 그룹에서 Azure에서 선택한 전용 호스트에 배치되는 것을 의미합니다.
