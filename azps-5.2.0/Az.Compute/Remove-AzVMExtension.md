...
## 설명
**Remove-AzVMExtension** cmdlet은 가상 머신의 Virtual Machine 확장에서 확장을 제거합니다.
...
이 명령은 ResourceGroup11의 VirtualMachine22라는 가상 머신에서 ContosoTest라는 확장을 제거합니다.
...
### -VMName
이 cmdlet이 확장을 제거하는 가상 머신의 이름을 지정합니다.
