...
## 설명
**Start-AzVmss** cmdlet은 VMSS(Virtual Machine Scale Set) 또는 가상 머신 집합 내의 모든 가상 머신을 시작합니다.
...
이 명령은 ContosoVMSS라는 VMSS에 속하는 인스턴스 ID 문자열 배열로 지정된 특정 가상 머신 집합을 시작합니다.
...
이 명령은 ContosoVMSS라는 VMSS에 속한 모든 가상 머신을 시작합니다.
