...
키 자격 증명 모음에 제공된 활성 키를 사용하여 디스크 암호화 집합을 만듭니다.
...
### -EncryptionType
디스크 암호화 집합의 암호화 유형을 설정하는 데 사용합니다. 사용 가능한 값은 'EncryptionAtRestWithPlatformKey', 'EncryptionAtRestWithCustomerKey'입니다.
...
### -IdentityType
DiskEncryptionSet에서 사용하는 관리 ID의 유형입니다. SystemAssigned만 지원됩니다.
