...
## 설명
**Remove-AzContainerService** cmdlet은 Azure 계정에서 컨테이너 서비스를 제거합니다.
...
이 명령은 CSResourceGroup17이라는 컨테이너 서비스를 제거합니다.
...
### -Name
이 cmdlet이 제거하는 컨테이너 서비스의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 제거하는 컨테이너 서비스의 리소스 그룹을 지정합니다.
