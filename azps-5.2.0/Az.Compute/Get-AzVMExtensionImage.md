...
## 설명
**Get-AzVMExtensionImage** cmdlet은 Azure 확장에 대한 모든 버전을 얻습니다.
...
이 명령은 지정된 위치, 게시자 및 형식에 대한 확장 이미지의 모든 버전을 얻습니다.

### 예제 2: 버전에 대한 필터를 사용하여 확장 이미지의 버전 다운로드
```
...
이 명령은 12부터 지정된 위치, 게시자, 형식 및 버전에 대한 확장 이미지의 모든 버전을 얻습니다.

### 예제 3: 버전에 대한 필터를 사용하여 확장 이미지의 버전 다운로드
```
...
이 명령은 지정된 위치, 게시자, 형식 및 버전에 대한 확장 이미지의 모든 버전을 얻습니다.
...
### -PublisherName
확장 게시자의 이름을 지정합니다.
확장 게시자를 얻습니다. Get-AzVMImagePublisher cmdlet을 사용 합니다.
...
### -Type
확장의 유형을 지정합니다.
확장 형식을 얻습니다. Get-AzVMExtensionImageType cmdlet을 사용 합니다.
...
### -Version
이 cmdlet이 다운로드하는 확장의 버전을 지정합니다.
