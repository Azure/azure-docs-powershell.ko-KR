...
첫 번째 명령은 vaultName에 따라 자격 증명 모음 개체를 얻습니다. 두 번째 명령은 7일 전의 날짜를 인용한 다음, $StartDate 저장합니다.
세 번째 명령은 오늘 날짜를 인용한 다음, $EndDate 저장합니다.
네 번째 명령은 AzureVM 백업 컨테이너를 구하고 해당 컨테이너를 $Container 변수에 저장합니다. 다섯 번째 명령은 workloadType, vaultId에 따라 백업 항목을 10진수에 $BackupItem 저장합니다.
