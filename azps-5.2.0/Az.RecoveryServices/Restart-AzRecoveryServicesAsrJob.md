...
## 설명
**Restart-AzRecoveryServicesAsrJob** cmdlet은 Azure Site Recovery 작업을 다시 시작합니다.
...
지정된 ASR 작업을 다시 시작하고 ASR 작업의 업데이트된 ASR 작업 개체를 반환합니다.
...
### -InputObject
cmdlet에 대한 입력 개체: 다시 시작할 ASR 작업에 해당하는 ASR 작업 개체입니다.
