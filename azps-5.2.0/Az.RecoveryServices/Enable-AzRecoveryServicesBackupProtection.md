...
## 설명
**Enable-AzRecoveryServicesBackupProtection** cmdlet을 사용하면 보호 정책을 항목에 연결하여 백업을 사용할 수 있습니다.
현재 cmdlet을 사용하기 전에 Set-AzRecoveryServicesVaultContext cmdlet을 사용하여 자격 증명 모음 컨텍스트를 설정할 수 있습니다.

## 예제

### 예제 1: 항목에 대해 Backup 보호 사용
```powershell
...
두 번째 cmdlet은 백업할 디스크 LUNS를 지정하고 백업 변수에 $inclusionDiskLUNS 지정합니다.
세 번째 cmdlet은 ARM 정책을 사용하여 V2VM이라는 가상 머신에 대한 Backup 보호 정책을 $Pol.

### 예제 2

지정된 Backup 보호 정책을 사용하여 항목에 대한 백업을 사용할 수 있습니다. (자동Generated)
...
### -ExclusionDisksList
백업에서 제외할 디스크 LUNS 목록과 나머지는 자동으로 포함됩니다.
...
### -InclusionDisksList
백업에 포함될 디스크 LUNS 목록과 나머지는 OS 디스크를 제외한 자동으로 제외됩니다.
...
### -Item
이 cmdlet이 보호를 사용할 수 있는 Backup 항목을 지정합니다.
...
### -Policy
이 cmdlet이 항목과 연결되는 보호 정책을 지정합니다.
**AzureRmRecoveryServicesBackupProtectionPolicy** 개체를 얻으면 Get-AzRecoveryServicesBackupProtectionPolicy cmdlet을 사용합니다.
