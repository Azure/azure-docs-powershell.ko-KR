...
## 설명
**Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** cmdlet은 이미 보호된 Azure 가상 머신에 대한 보호를 위해 디스크를 추가합니다.
...
보호를 위해 지정된 디스크 구성을 추가하는 작업을 시작 합니다.
...
보호를 위해 지정된 디스크 구성을 추가하는 작업을 시작 합니다. 입력 복제 보호된 항목을 파이핑합니다.

## PARAMETERS

### -AzureToAzureDiskReplicationConfiguration
Azure에서 Azure로의 재해 복구 시나리오에 대한 디스크 보호에 사용할 디스크 구성을 지정합니다.
...
### -InputObject
cmdlet에 대한 입력 개체: 새 디스크를 보호해야 하는 ASR 복제 보호된 항목 개체입니다.
