...
### 예제 1: EndPointName에서 azDigitalTwinsEndPoint 삭제
```powershell
...
EndPointName ResourceGroupName 및 ResourceName으로 azDigitalTwinsEndPoint 삭제

### 예제 2: 개체에서 azDigitalTwinsEndPoint 삭제
```powershell
...
개체에 의해 azDigitalTwinsEndPoint 삭제
