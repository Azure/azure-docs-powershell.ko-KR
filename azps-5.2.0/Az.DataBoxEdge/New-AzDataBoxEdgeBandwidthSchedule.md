...
## 설명
**New-AzDataBoxEdgeBandwidthSchedule** cmdlet은 대역폭 사용량을 관리하는 데 도움이 되는 Data Box Edge 디바이스에 대한 새 대역폭 일정을 만듭니다.
...
### -UnlimitedBandwidth
무제한 대역폭을 설정합니다. false로 설정하면 기본값이 20Mbps로 설정됩니다.
