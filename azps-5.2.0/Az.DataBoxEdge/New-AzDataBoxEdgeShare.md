...
## 설명
**New-AzDataBoxEdgeShare** cmdlet은 Data Box Edge 디바이스에 새 공유를 만듭니다.
...
### -ClientAccessRight
clientIds에 대한 읽기/쓰기 액세스, 예:@(@{"ClientId"="192.168.10.10";" AccessRight"="NoAccess"}, @{"ClientId"="192.168.10.11";" AccessRight"="ReadOnly"})
...
### -ContainerName
컨테이너 이름(지정된 데이터 형식에 따라 Azure Files/Pageblob/블록 Blob의 이름을 나타)
...
### -UserAccessRight
기존 사용자 이름과 함께 SMB 공유 유형에 액세스할 수 있는 액세스 권한을 제공합니다. 예: @(@{"Username"="user-name-1";" AccessRight"="Read"}, @{"Username"="user-name-2";" AccessRight"="Read"}, @{"Username"="user-name-3";" AccessRight"="Custom"})
