...
## 설명
**Update-AzCognitiveServicesAccountNetworkRuleSet** cmdlet은 Cognitive Services 계정의 NetworkRule 속성을 업데이트합니다.
...
### 예제 3: Cognitive Services 계정의 NetworkRule 규칙 정리
```
...
이 명령은 Cognitive Services 계정의 NetworkRule 규칙을 정리합니다(다른 속성은 변경되지 않습니다).

## PARAMETERS

### -DefaultAction
Cognitive Services 계정 NetworkRule DefaultAction. 기본값. `Deny`
