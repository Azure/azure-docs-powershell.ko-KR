...
### -Template
업스트림 설정에 대한 템플릿 항목입니다.
필수 키: UrlTemplate.
선택적 키: HubPattern, EventPattern, CategoryPattern.
템플릿 매개 변수를 전달하기 위해 Splatting 구문을 사용하는 예제: @{UrlTemplate=' http://host-connections1.com ', HubPattern= 'chat'; EventPattern='broadcast' },@{UrlTemplate=' http://host-connections2.com '}
...
[PowerShell에서 Splatting을 사용하여 명령에 매개 변수를 전달하는 방법](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
