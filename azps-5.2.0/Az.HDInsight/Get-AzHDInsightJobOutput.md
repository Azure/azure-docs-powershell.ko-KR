...
## 설명
**Get-AzHDInsightJobOutput** cmdlet은 Azure HDInsight 클러스터와 연결된 Storage 계정에서 작업의 로그 출력을 얻습니다.

## 예제

### 예제 1: 작업의 로그 출력을 구합니다.
```
PS C:\># Cluster info
...
이 명령은 your-hadoop-001이라는 클러스터에서 로그 출력을 얻습니다.
