...
## 설명
이 **Restart-AzHDInsightHost** cmdlet은 HDInsight 클러스터의 특정 호스트를 다시 시작합니다.
...
이 명령은 클러스터의 두 호스트인 worknode1, worknode2를 다시 시작합니다.
...
이 명령은 'Get-AzHDInsightHost' cmdlet과 협력하는 방법을 보여줍니다.
