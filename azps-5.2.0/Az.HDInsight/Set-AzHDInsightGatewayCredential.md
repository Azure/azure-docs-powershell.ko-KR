...
이 명령은 이름 매개 변수 집합으로 your-hadoop-001이라는 클러스터의 게이트웨이 자격 증명을 설정합니다.
...
이 명령은 ResourceId 매개 변수 집합에 의해 hadoop-001이라는 클러스터의 게이트웨이 자격 증명을 설정합니다.
...
이 명령은 InputObject 매개 변수 집합에 의해 hadoop-001이라는 클러스터의 게이트웨이 자격 증명을 설정합니다.
