...
## 설명
**Set-AzHDInsightDefaultStorage** cmdlet은 New-AzHDInsightClusterConfig cmdlet에서 만든 Azure HDInsight 클러스터 구성 개체의 기본 Storage 계정 설정을 지정합니다.

## 예제

### 예제 1: 클러스터 구성 개체에 대한 기본 저장소 계정 설정
```
...
이 명령은 클러스터 구성 개체에 대한 기본 Storage 계정을 설정합니다.
...
### -StorageAccountKey
HDInsight 클러스터에서 사용할 기본 Azure Storage 계정에 대한 계정 키를 지정합니다.
...
새 클러스터에 추가할 저장소 계정의 저장소 계정 이름입니다.
...
### -StorageAccountType
기본 저장소 계정의 유형을 얻거나 설정합니다. 기본값은 AzureStorage입니다.
