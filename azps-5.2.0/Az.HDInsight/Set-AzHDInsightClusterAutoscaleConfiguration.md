...
## 설명
이 cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration은** Azure HDInsight 클러스터의 자동 크기 조정 구성을 설정합니다.

## 예제

### 예제 1: HDInsight 클러스터의 부하 기반 자동 조정 구성 설정
```powershell
...
이 명령은 Azure HDInsight 클러스터의 부하 기반 자동 조정 구성을 설정합니다.

### 예제 2: HDInsight 클러스터의 일정 기반 자동 조정 설정
```powershell
...
이 명령은 HDInsight 클러스터의 일정 기반 자동 조정 구성을 설정합니다.

### 예제 3: 자동 조정 구성을 설정한 다른 클러스터를 기반으로 HDInsight 클러스터의 자동 조정 구성 설정
```powershell
...
이 명령은 다른 클러스터를 기반으로 하는 HDInsight 클러스터의 자동 조정 구성을 설정합니다.
...
### -MaxWorkerNodeCount
부하 기반 자동 조정의 최대 worknode 수를 얻거나 설정합니다.
