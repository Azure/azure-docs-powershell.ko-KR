...
## 설명
**Get-AzP2sVpnGateway** cmdlet을 사용하면 VirtualHub에서 기존 P2SVpnGateway를 얻을 수 있습니다.
...
**Get-AzP2sVpnGateway** cmdlet을 사용하면 지점 및 사이트 연결에 사용되는 VirtualHub에서 기존 P2SVpnGateway를 얻을 수 있습니다.
