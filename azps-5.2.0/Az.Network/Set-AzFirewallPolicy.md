...
## 설명
**Set-AzFirewallPolicy** cmdlet은 Azure Firewall 정책을 업데이트합니다.
...
이 예제에서는 새 방화벽 정책 값으로 방화벽 정책을 설정합니다.
...
이 예제에서는 새 위협 Intel 모드로 방화벽 정책을 설정합니다.
...
이 예제에서는 새 위협 Intel 허용 목록을 통해 방화벽 정책을 설정합니다.
