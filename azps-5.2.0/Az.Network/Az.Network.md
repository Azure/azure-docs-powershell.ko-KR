...
주어진 가상 네트워크 게이트웨이를 사용하여 연결된 VPN 클라이언트 연결을 끊습니다.
...
개인 링크 서비스에서 개인 엔드포인트 연결 상태를 업데이트합니다.
...
Azure의 네트워킹 리소스에 대한 문제 해결을 시작합니다.
