...
## 설명
**New-AzVpnClientRevokedCertificate** cmdlet은 가상 네트워크 게이트웨이에서 사용할 새 VPN(가상 사설망) 클라이언트 해지 인증서를 만듭니다.
...
예를 들어 새 인증서를 만들고 새 인증서를 새 인증서에 저장했다고 $Certificate.
