...
## 설명
가상 허브 경로 테이블 리소스에는 연결될 수 있는 경로 목록 및 연결 목록이 포함되어 있으며 가상 허브에서 트래픽을 라우팅하는 데 사용됩니다.
...
위의 명령은 전달된 경로에서 Virtual Hub 경로 테이블 리소스를 만들고 가상 허브에서 트래픽을 라우팅하는 데 이 개체를 사용할 수 있습니다.  
