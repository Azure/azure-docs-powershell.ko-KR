...
## 설명
**New-AzExpressRoutePortIdentity** cmdlet은 로컬 Azure ExpressRoutePort ID 개체를 만듭니다. **New-AzExpressRoutePort** 또는 **Set-AzExpressRoutePort를** 사용하여 Azure ExpressRoutePort에 할당합니다.
...
ExpressRoutePort에 할당할 사용자 할당 ID의 ResourceId입니다.
