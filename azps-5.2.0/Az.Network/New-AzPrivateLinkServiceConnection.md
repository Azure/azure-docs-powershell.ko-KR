...
## 설명
**New-AzPrivateLinkServiceConnection** cmdlet은 개인 링크 서비스 연결 구성을 만듭니다.
...
이 예제에서는 개인 엔드포인트를 만드는 데 사용할 개인 링크 서비스 연결 개체를 메모리에 만듭니다.

### 예제 2

개인 링크 서비스 연결 구성을 만듭니다. (자동Generated)
