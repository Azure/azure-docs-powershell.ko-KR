...
```
## 설명
**New-AzIpConfigurationBgpPeeringAddressObject는** 가상 네트워크 게이트웨이 bgpsettings에서 BgpPeeringAddresses 속성을 나타내는 IpConfigurationBgpPeeringAddressObject 개체를 만듭니다.
...
위에서는 IpConfigurationBgpPeeringAddressObject를 만듭니다. 이 새 개체는 gw1ipconfBgp1이 됩니다.
...
### -CustomAddress
BgpPeeringAddresses에 대한 가상 네트워크 게이트웨이 CustomAddress 목록입니다.
...
### -IpConfigurationId
BgpPeeringAddresses에 대한 가상 네트워크 게이트웨이 IpConfigurationId입니다.
