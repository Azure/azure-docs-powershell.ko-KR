...
## 설명
**Get-AzLoadBalancerOutboundRuleConfig** cmdlet은 부하 분산의 아웃바운드 규칙 구성 또는 아웃바운드 규칙 구성 목록을 얻습니다.

## 예제

### 예제 1: 부하 균형 조정기에서 아웃바운드 규칙 구성을 얻을 수 있습니다.
```powershell
...
두 번째 명령은 해당 부하 균형 조정과 연결된 MyRule이라는 아웃바운드 규칙 구성을 얻습니다.
