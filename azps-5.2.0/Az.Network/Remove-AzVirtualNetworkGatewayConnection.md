...
**Remove-AzVirtualNetworkGatewayConnection** cmdlet은 이름 및 리소스 그룹 이름에 따라 연결의 개체를 삭제합니다.

## 예제

### 예제 1: Virtual Network 게이트웨이 연결 삭제
```powershell
Remove-AzVirtualNetworkGatewayConnection -Name myTunnel -ResourceGroupName myRG
```

리소스 그룹 "myRG"에서 "myTunnel"으로 Virtual Network 게이트웨이 연결의 개체를 삭제합니다.
...
### -Name
이 cmdlet에서 제거하는 가상 네트워크 게이트웨이 연결의 이름을 지정합니다.
...
### -ResourceGroupName
가상 네트워크 게이트웨이 연결을 포함하는 리소스 그룹의 이름을 지정합니다.
