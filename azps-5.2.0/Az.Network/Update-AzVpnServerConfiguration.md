...
## 설명
**Update-AzVpnServerConfiguration** cmdlet을 사용하면 지점 및 사이트 연결에 대한 고객의 요구 사항에 따라 다른 VpnProtocols, VpnAuthenticationTypes, IpsecPolicies로 기존 VpnServerConfiguration을 업데이트하고 선택한 VPN 인증 유형 관련 매개 변수를 설정할 수 있습니다.
