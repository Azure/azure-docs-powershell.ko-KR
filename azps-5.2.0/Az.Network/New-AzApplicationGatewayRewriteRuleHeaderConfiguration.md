...
## 설명
**AzApplicationGatewayRewriteRuleHeaderConfiguration** cmdlet은 Azure 애플리케이션 게이트웨이에 대한 다시 작성 규칙 작업 집합을 만듭니다.
...
이 명령은 다시 작성 규칙 헤더 구성을 만들고 결과를 $hc.
...
### -HeaderValue
지정한 헤더 이름에 대한 집합에 대한 헤더 값입니다.
이 헤더를 생략하면 헤더가 삭제됩니다.
