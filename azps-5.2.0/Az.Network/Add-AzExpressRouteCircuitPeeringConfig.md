...
## 설명
**Add-AzExpressRouteCircuitPeeringConfig** cmdlet은 피어링 구성을 ExpressRoute 회로에 추가합니다. ExpressRoute 회로는 공용 인터넷 대신 연결 공급자를 사용하여 Microsoft 클라우드에 연결합니다. **Add-AzExpressRouteCircuitPeeringConfig를** 실행한 후 Set-AzExpressRouteCircuit cmdlet을 호출하여 구성을 활성화해야 합니다.
