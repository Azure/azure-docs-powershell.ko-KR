...
그런 다음 ResourceGroupName 및 ResourceName을 사용하여 가상 허브를 삭제합니다.
...
그런 다음 입력 개체를 사용하여 가상 허브를 삭제합니다. 입력 개체는 PSVirtualHub 형식입니다.
...
그런 다음 Get-AzVirtualHub의 출력을 사용하여 PowerShell 파이핑을 사용하여 가상 허브를 삭제합니다.
