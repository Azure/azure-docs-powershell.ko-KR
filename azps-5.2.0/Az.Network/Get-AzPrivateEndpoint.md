...
## 설명
**Get-AzPrivateEndpoint** cmdlet은 하나 이상의 개인 엔드포인트를 얻습니다.
...
이 명령은 리소스 그룹 TestResourceGroup에서 MyPrivateEndpoint1이라는 개인 엔드포인트를 얻습니다.

### 예제 2: ResourceGroup의 모든 개인 엔드포인트 나열
```powershell
...
이 명령은 리소스 그룹 TestResourceGroup의 모든 개인 엔드포인트를 얻습니다.
