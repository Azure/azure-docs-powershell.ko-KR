...
## 설명
**Set-AzExpressRouteCrossConnection** cmdlet은 수정된 ExpressRoute 교차 연결을 Azure에 저장합니다.

## 예제

### 예제 1: ExpressRoute 교차 연결의 서비스 공급자 프로비전 상태 변경
```
...
이 cmdlet이 수정하는 **ExpressRouteCrossConnection** 개체를 지정합니다.
