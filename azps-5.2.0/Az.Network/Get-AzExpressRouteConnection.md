...
게이트웨이가 만들어졌다면 게이트웨이는 New-AzExpressRouteConnection 명령을 사용하여 프레미스 ExpressRoute 회로에 New-AzExpressRouteConnection.
...
이 명령은 "test"로 시작하는 ExpressRoute "testExpressRoutegw"의 모든 연결을 얻습니다.
