...
## 설명
**New-AzPrivateDnsZoneConfig** cmdlet을 사용하면 DNS 영역 그룹에 설정될 새 DNS 영역 구성 개체를 만들 수 있습니다.
...
위의 예제에서는 DNS 영역이 만들어진 다음 DNS 영역 구성을 만듭니다. `New-AzPrivateDnsZone` cmdlet은 모듈 Az.PrivateDns에 의해 입증됩니다.
