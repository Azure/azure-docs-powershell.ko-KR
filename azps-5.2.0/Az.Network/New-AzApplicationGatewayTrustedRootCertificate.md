...
## 설명
**New-AzApplicationGatewayTrustedRootCertificate** cmdlet은 Azure 애플리케이션 게이트웨이에 대한 신뢰할 수 있는 루트 인증서를 만듭니다.
...
이 명령은 목록 "trc1"이라는 신뢰할 수 있는 루트 인증서를 만들고 이 인증서의 변수에 결과를 $trc.
