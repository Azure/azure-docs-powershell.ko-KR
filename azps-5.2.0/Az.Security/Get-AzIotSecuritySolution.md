...
## 설명
Get-AzIotSecuritySolution cmdlet은 하나 이상의 iot 보안 솔루션을 반환합니다. IoT 보안 솔루션은 위협을 방지하고 검색할 수 있도록 IoT 디바이스 및 IoT Hub에서 보안 데이터 및 이벤트를 수집합니다.
...
리소스 그룹 "MyResourceGroup"의 모든 보안 솔루션 목록을 얻습니다.
