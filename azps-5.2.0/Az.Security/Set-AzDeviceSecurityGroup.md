...
IoT Hub "/subscriptions/XXXXXXXX-XXXX-XXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"에서 규칙 유형 "ActiveConnectionsNotInAllowedRange"로 기존 디바이스 보안 그룹을 업데이트합니다.
