...
## 설명
이 New-AzDeviceSecurityGroupTimeWindowRuleObject cmdlet은 IoT 보안 솔루션의 디바이스 보안 그룹에 대한 새로운 시간 창 경고 규칙 목록을 만듭니다.
...
"ActiveConnectionsNotInAllowedRange" 형식에서 새 기간 규칙 만들기
