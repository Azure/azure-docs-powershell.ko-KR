...
리소스 ID "/subscriptions/XXXXXXXX-XXXXXXXXXX"를 사용하여 IoT Hub용 새 IoT Hub용 IoT Hub용 "MySample" 보안 솔루션 만들기XXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (솔루션의 이름은 IoT Hub의 이름과 동일해야 합니다.)
