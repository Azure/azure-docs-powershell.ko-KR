...
### 예제 1: 리소스에 대한 이동을 시작하기 전에 종속성의 유효성을 검사합니다.
```powershell
...
리소스에 대한 이동을 시작하기 전에 종속성의 유효성을 검사합니다.

### 예제 2: 입력으로 "MoveResource Name"을 사용하여 Move 컬렉션의 리소스 집합에 대한 이동 시작
```powershell
...
### 예제 3: 입력으로 "SourceARMID"를 사용하여 이동 컬렉션의 리소스 집합에 대한 이동 시작
```powershell
