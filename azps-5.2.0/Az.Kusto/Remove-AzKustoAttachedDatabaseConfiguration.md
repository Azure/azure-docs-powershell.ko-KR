...
### 예제 1: 이름에 따라 기존 AttachedDatabaseConfiguration 삭제
```powershell
...
위의 명령은 클러스터 "testnewkustoclusterf"에서 AttachedDatabaseConfiguration "myfollowerconfiguration"에 정의된 팔로워 데이터베이스를 삭제합니다.
