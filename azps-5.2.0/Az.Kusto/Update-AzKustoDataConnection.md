...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대해 "myeventhubdc"라는 기존 EventHub 데이터 연결을 업데이트합니다.

### 예제 2: 기존 EventGrid 데이터 연결 업데이트
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터의 데이터베이스 "mykustodatabase"에 대해 "myeventgriddc"라는 기존 EventGrid 데이터 연결을 업데이트합니다.

### 예제 3: 기존 IotHub 데이터 연결 업데이트
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대해 "myiothubdc"라는 기존 IotHub 데이터 연결을 업데이트합니다.

### 예제 4: ID를 통해 기존 EventHub 데이터 연결 업데이트
```powershell
...
### 예제 5: ID를 통해 기존 EventGrid 데이터 연결 업데이트
```powershell
...
### 예제 6: ID를 통해 기존 IotHub 데이터 연결 업데이트
```powershell
