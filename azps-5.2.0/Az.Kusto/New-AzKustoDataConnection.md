...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대해 "myeventhubdc"라는 새 EventHub 데이터 연결을 만듭니다.
...
위의 명령은 "testnewkustocluster" 클러스터의 데이터베이스 "mykustodatabase"에 대해 "myeventgriddc"라는 새 EventGrid 데이터 연결을 만듭니다.
...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대해 "myiothubdc"라는 새 IotHub 데이터 연결을 만듭니다.
