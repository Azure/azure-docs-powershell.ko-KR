...
## 설명
**Get-AzConsumptionReservationDetail** cmdlet은 제공된 날짜 범위에 대한 예약 세부 정보를 얻습니다.

## 예제

### 예제 1: 제공된 날짜 범위에 대한 예약 주문 ID를 통해 예약 세부 정보 확인
```powershell
...
### 예제 2: 제공된 날짜 범위에 대한 예약 주문 ID 및 예약 ID를 통해 예약 세부 정보 확인
```powershell
...
### -EndDate
예약 세부 정보의 최종 데이터(UTC의 YYYY-MM-DD)입니다.
...
### -StartDate
예약 세부 정보의 시작 데이터(UTC의 YYYY-MM-DD)입니다.
