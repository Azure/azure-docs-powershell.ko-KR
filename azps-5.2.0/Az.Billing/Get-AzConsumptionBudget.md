...
## 설명
Get-AzConsumptionBudget cmdlet은 구독 또는 리소스 그룹의 예산 목록을 얻습니다.

## 예제

### 예제 1: 구독 수준에서 예산 목록 확인
```powershell
...
### 예제 4: 자원 그룹 수준에서 예산 이름을 지정한 예산을 얻습니다.
```powershell
