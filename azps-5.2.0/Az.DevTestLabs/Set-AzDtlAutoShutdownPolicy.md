...
## 설명
**Set-AzDtlAutoShutdownPolicy** cmdlet은 랩의 자동 종료 정책을 설정하여 하루 중 지정된 시간 동안 랩의 모든 가상 머신을 자동으로 종료합니다.
...
랩 DevTest Labs의 자동 종료 정책을 설정합니다. (자동Generated)
...
### -Disable
cmdlet이 랩에서 정책을 사용하지 않도록 설정하는지 나타냅니다.
...
### -Enable
cmdlet이 랩에서 정책을 사용 가능하게 하여 나타냅니다.
...
### -LabName
이 cmdlet이 자동 종료 정책을 설정하는 랩의 이름을 지정합니다.
...
### -Time
랩의 가상 머신을 종료해야 하는 경우의 시간을 **DateTime** 개체로 지정합니다.
