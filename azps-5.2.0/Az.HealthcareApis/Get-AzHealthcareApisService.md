...
## 설명
지정된 구독 또는 리소스 그룹 내에서 만든 기존 healthcareApis fhir 서비스 계정을 얻습니다.
...
제공된 리소스 그룹의 모든 HealthcareApis 서비스에 대한 메타데이터를 얻습니다.
...
주어진 구독의 모든 HealthcareApis 서비스에 대한 메타데이터를 얻습니다.
