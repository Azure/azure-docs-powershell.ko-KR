...
## 설명
**Get-AzSqlDatabaseAudit** cmdlet은 Azure SQL 데이터베이스의 감사 설정을 얻습니다.
cmdlet을 사용하려면 *ResourceGroupName,* *ServerName* 및 *DatabaseName* 매개 변수를 사용하여 데이터베이스를 식별합니다.

## 예제

### 예제 1: Azure SQL 데이터베이스의 감사 설정
```
...
### 예제 2: 파이프라인을 통해 Azure SQL 데이터베이스의 감사 설정
```
