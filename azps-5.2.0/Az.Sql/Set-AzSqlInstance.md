...
## 설명
**Set-AzSqlInstance** cmdlet은 Azure SQL 데이터베이스 관리되는 인스턴스의 속성을 수정합니다.
...
### -AssignIdentity
Azure KeyVault와 같은 키 관리 서비스에서 사용할 이 인스턴스에 대한 Azure Active Directory ID를 생성하고 할당합니다.
