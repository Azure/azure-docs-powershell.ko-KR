...
## 설명
특정 인스턴스 장애 조치(failover) 그룹을 얻거나 사용자의 구독에 속한 지역의 인스턴스 장애 조치(failover) 그룹을 나열합니다.

인스턴스 장애 조치 그룹의 두 지역 중 하나를 사용하여 명령을 실행할 수 있습니다. 반환된 값은 인스턴스 장애 조치(failover) 그룹과 관련한 해당 지역의 Managed Instance 상태를 반영합니다.
...
지역의 모든 장애 조치(failover) 그룹을 나열합니다.
...
특정 인스턴스 장애 조치(failover) 그룹을 얻습니다.
