...
## 설명
**Get-AzSqlVirtualCluster** cmdlet은 가상 클러스터에 대한 하나 이상의 Azure SQL 반환합니다.
해당 클러스터에 대한 정보만 표시하기 위해 가상 클러스터의 이름을 지정합니다.

## 예제

### 예제 1: 리소스 그룹에 할당된 모든 가상 클러스터를 얻습니다.
```powershell
...
이 명령은 리소스 그룹 ResourceGroup01에 할당된 모든 가상 클러스터에 대한 정보를 얻습니다.

### 예제 2: 특정 가상 클러스터에 대한 정보 얻기
```
...
이 명령은 리소스 그룹 ResourceGroup01의 가상 클러스터 VirtualCluster1에 대한 정보를 얻습니다.
