...
## 설명
**Remove-AzSqlDatabaseSecondary** cmdlet은 지역 복제 링크를 강제로 종료합니다.
이 cmdlet은 Stop-AzSqlDatabaseCopy 대체합니다.
종료 전에는 복제 동기화가 없습니다.
...
### -DatabaseName
이 cmdlet이 제거하는 복제 링크가 SQL 기본 Azure SQL 데이터베이스의 이름을 지정합니다.
