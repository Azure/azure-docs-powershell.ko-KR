...
## 설명
**Get-AzSqlDatabaseDataMaskingPolicy** cmdlet은 Azure SQL 데이터베이스의 데이터 마스킹 정책을 얻습니다.
...
### 예제 1: Azure SQL 데이터베이스에 대한 데이터 마스킹 정책 사용
```
...
이 명령은 server Server01의 리소스 그룹 ResourceGroup01에 있는 Database01에서 데이터 마스킹 정책을 얻습니다.
