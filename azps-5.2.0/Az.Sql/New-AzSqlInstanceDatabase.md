...
## 설명
**New-AzSqlInstanceDatabase** cmdlet은 Azure SQL Managed Instance 데이터베이스를 만듭니다.

## 예제

### 예제 1: 지정된 인스턴스에 데이터베이스 만들기
```
...
이 명령은 managedInstance1 인스턴스에 Database01이라는 인스턴스 데이터베이스를 만듭니다.
...
### -Collation
사용할 Azure SQL Instance 데이터베이스 데이터입니다.
...
### -Name
만들 Azure SQL Instance 데이터베이스의 이름입니다.
...
### -Tag
Azure Sql Instance 데이터베이스와 연결하기 위해 태그
