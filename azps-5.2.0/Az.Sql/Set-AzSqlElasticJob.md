...
## 설명
Set-AzSqlElasticJob cmdlet은 작업을 업데이트합니다.

## 예제

### 예제 1: 지금부터 1시간을 시작하고 1시간마다 반복할 수 있는 작업을 업데이트합니다.
```powershell
...
### -Enable
고객이 이 작업을 사용하도록 설정하려는 것을 나타내는 플래그입니다.
...
### -IntervalType
반복 일정 간격 유형 - 분, 시간, 일, 주, 월일 수 있습니다.
