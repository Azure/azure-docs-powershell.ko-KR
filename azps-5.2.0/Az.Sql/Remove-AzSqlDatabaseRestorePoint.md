...
## 설명
**Remove-AzSqlDatabaseRestorePoint** cmdlet은 Azure SQL 데이터베이스에서 주어진 복원 지점을 제거합니다.
이 cmdlet은 현재 Azure SQL Database의 SQL Server Datawarehouse 서비스에서 지원됩니다.
...
이 명령은 Azure SQL 데이터베이스의 복원 지점을 제거합니다.
