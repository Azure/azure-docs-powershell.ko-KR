...
## SYNOPSIS
주어진 CosmosDB 계정에 대한 키{"ConnectionKeys", "PrimaryReadOnly" 또는 "키"}를 얻습니다. 
...
CosmosDB 계정에 대한 키를 나열합니다. 키 유형은 ConnectionStrings, 키 및 ReadOnlyKeys의 값일 수 있습니다. 기본값은 키입니다.
...
### -Type
값: {ConnectionStrings, Keys, ReadOnlyKeys}.
기본값은 키입니다.
