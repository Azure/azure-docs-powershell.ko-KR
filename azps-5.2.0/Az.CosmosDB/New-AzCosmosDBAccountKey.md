...
ResourceGroup rg에서 계정 이름 dbname이 있는 계정에 대해 새 키가 생성됩니다.

### 예제 2

주어진 CosmosDB 계정 키를 다시 생성합니다. (자동Generated)
...
### -KeyKind
다시 생성할 액세스 키입니다.
허용되는 값: primary, primaryReadonly, secondary, secondaryReadonly
