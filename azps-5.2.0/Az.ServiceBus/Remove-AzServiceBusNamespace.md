...
## 설명
**Remove-AzServiceBusNamespace** cmdlet은 지정된 리소스 그룹에서 네임스페이스를 제거합니다.
...
지정된 리소스 그룹에서 Service Bus `SB-Example1` 네임스페이스를 `Default-ServiceBus-WestUS` 제거합니다.

### 예제 2.1 - InputObject - 변수 사용:
```
PS C:\> $inputobject = Get-AzServiceBusNamespace <params>
PS C:\> Remove-AzServiceBusNamespace -InputObject $inputobject
```

다음을 통해 제공된 Service Bus 네임스페이스를 $inputobject.

### 예제 2.2 - InputObject - 파이핑 사용:
```
PS C:\> Get-AzServiceBusNamespace <params> | Remove-AzServiceBusNamespace
```

Piping을 사용하여 Service Bus 네임스페이스를 제거합니다.
...
-ResourceId 매개 변수에 대한 ARM 또는 파이핑을 통해 $resourceid ID를 통해 제공된 Service Bus 네임스페이스를 제거합니다.
