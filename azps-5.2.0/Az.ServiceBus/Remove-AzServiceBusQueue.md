...
## 설명
**Remove-AzServiceBusQueue** cmdlet은 지정된 Service Bus 네임스페이스에서 큐를 제거합니다.
...
네임스페이스에서 Service Bus `SB-Queue_exampl1` 큐를 `SB-Example1` 제거합니다.
...
-InputObject 매개 변수에 대한 $inputobject Service Bus 큐를 제거합니다.
...
-ResourceId 매개 변수에 대한 ARM/string의 $resourceid Id에 제공된 Service Bus 큐를 제거합니다.

### 예제 5: ResourceId - 문자열로 전달:
```powershell
