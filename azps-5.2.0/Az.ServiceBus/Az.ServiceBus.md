...
# Az.ServiceBus 모듈
## 설명
이 항목에서는 Azure Service Bus cmdlet에 대한 도움말 항목을 제공합니다.

## Az.ServiceBus Cmdlet
### [Complete-AzServiceBusMigration](Complete-AzServiceBusMigration.md)
Cmdlet은 표준에서 프리미엄 네임스페이스로 마이그레이션을 완료로 설정하고 표준 네임스페이스의 연결 문자열은 이제 프리미엄 네임스페이스를 지정합니다.

### [Get-AzServiceBusAuthorizationRule](Get-AzServiceBusAuthorizationRule.md)
지정된 네임스페이스 또는 큐 또는 토픽 또는 별칭(GeoDR 구성)에 대해 지정된 권한 부여 규칙에 대한 설명을 얻습니다. 
...
Cmdlet은 표준-프리미엄 네임스페이스에 대한 마이그레이션 구성을 삭제합니다.
...
지정된 Service Bus 네임스페이스에서 큐를 제거합니다.

### [Remove-AzServiceBusRule](Remove-AzServiceBusRule.md)
지정된 구독의 지정된 규칙을 제거합니다.

### [Remove-AzServiceBusSubscription](Remove-AzServiceBusSubscription.md)
지정된 Service Bus 네임스페이스에서 토픽에 대한 구독을 제거합니다.

### [Remove-AzServiceBusTopic](Remove-AzServiceBusTopic.md)
지정된 Service Bus 네임스페이스에서 토픽을 제거합니다.

### [Set-AzServiceBusAuthorizationRule](Set-AzServiceBusAuthorizationRule.md)
지정된 Service Bus 네임스페이스 또는 큐 또는 토픽에 대해 지정된 권한 부여 규칙 설명을 업데이트합니다.
...
기존 Service Bus 네임스페이스에 대한 설명을 업데이트합니다.

### [Set-AzServiceBusQueue](Set-AzServiceBusQueue.md)
지정된 Service Bus 네임스페이스에서 Service Bus 큐에 대한 설명을 업데이트합니다.

### [Set-AzServiceBusRule](Set-AzServiceBusRule.md)
지정된 구독에 대해 지정된 규칙 설명을 업데이트합니다.

### [Set-AzServiceBusSubscription](Set-AzServiceBusSubscription.md)
지정된 Service Bus 네임스페이스에서 Service Bus 토픽에 대한 구독 설명을 업데이트합니다.

### [Set-AzServiceBusTopic](Set-AzServiceBusTopic.md)
지정된 Service Bus 네임스페이스에서 Service Bus 토픽에 대한 설명을 업데이트합니다.

### [Start-AzServiceBusMigration](Start-AzServiceBusMigration.md)
새 마이그레이션 구성을 만들고 표준에서 프리미엄 네임스페이스로 엔터티 마이그레이션을 시작합니다.
