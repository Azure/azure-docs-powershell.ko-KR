...
## 설명
**Set-AzServiceBusQueue** cmdlet은 지정된 Service Bus 네임스페이스에서 Service Bus 큐에 대한 설명을 업데이트합니다.
...
지정된 네임스페이스에서 새 설명으로 지정된 큐를 업데이트합니다. 이 예제에서는 **DeadLetteringOnMessageExpiration** 속성을 **true로** 업데이트하고 **SupportOrdering을** **true로 업데이트합니다.**
