...
## 설명
**Get-AzServiceBusTopic** cmdlet은 지정된 Service Bus 네임스페이스에 대한 토픽 설명을 반환합니다.
...
지정된 Service Bus 네임스페이스에 대해 지정된 토픽에 대한 설명을 반환합니다.
...
주어진 Service Bus 네임스페이스에 대한 토픽 목록을 반환합니다. 기본적으로 100개 이상의 토픽이 반환됩니다. 100개가 넘는 토픽이 반환되는 경우 -MaxCount 매개 변수를 사용하세요.
...
주어진 Service Bus 네임스페이스에 대한 처음 150개 항목 목록을 반환합니다.
