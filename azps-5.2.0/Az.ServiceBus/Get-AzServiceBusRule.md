...
## 설명
**Get-AzServiceBusRule** cmdlet은 지정된 토픽 구독에서 지정된 규칙에 대한 설명을 얻습니다.
...
지정된 구독에 대한 규칙 설명 목록을 반환합니다.  기본적으로 100개 규칙이 반환됩니다. 100개가 넘는 규칙이 반환되는 경우 -MaxCount 매개 변수를 사용하시기 바랍니다.
