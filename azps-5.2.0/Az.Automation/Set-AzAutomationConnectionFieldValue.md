...
## 설명
**Set-AzAutomationConnectionFieldValue** cmdlet은 Azure Automation의 연결에서 필드 값을 수정합니다.
...
이 명령은 AutomationAccount01이라는 Automation 계정에서 ContosoConnection이라는 Azure 연결에 대한 구독 ID를 변경합니다.

## PARAMETERS

### -AutomationAccountName
이 cmdlet이 연결의 필드를 수정하는 Automation 계정의 이름을 지정합니다.
...
### -Name
이 cmdlet이 필드를 수정하는 연결의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 연결의 필드를 수정하는 리소스 그룹의 이름을 지정합니다.
