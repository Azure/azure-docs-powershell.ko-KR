...
## 설명
**New-AzEventHubGeoDRConfiguration** cmdlet은 새 별칭을 만듭니다(재해 복구 구성).
...
보조 네임스페이스 "SampleNamespace_Primary" 기본 네임스페이스가 있는 "SampleDRConfigName" 별칭을 만듭니다SampleNamespace_Secondary

## PARAMETERS

### -AlternateName
DR 구성 이름이 기본 네임스페이스와 같은 경우 AlternateName 필요
