...
## 설명
New-AzEventHubCluster cmdlet은 주어진 리소스 그룹에 전용 eventhub 클러스터를 만듭니다.
...
위치 southcentralus 및 용량이 1인 리소스 그룹 'RSG-Cluster27651'에 'Eventhub-Cluster-5557' 전용 클러스터를 만듭니다.
