...
## 설명
**Remove-AzDataLakeGen2AclRecursive** cmdlet은 지정된 경로에서 ACL을 재발적으로 제거합니다. 입력 ACL 항목(다른 권한 포함)이 제거된 AccessControlType, DefaultScope 및 EntityId가 동일한 원래 ACL의 ACL 항목입니다.
