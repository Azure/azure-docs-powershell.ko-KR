...
## 설명
**Get-AzStorageObjectReplicationPolicy** cmdlet은 개체 복제 정책 규칙을 만듭니다. 이 규칙은 Set-AzStorageObjectReplicationPolicy cmdlet에 사용됩니다.

## 예제

### 예제 1: 원본 및 대상 계정만 사용하여 개체 복제 정책 규칙 만들기 및 해당 속성 표시
```
...
이 명령은 원본 및 대상 계정만 사용하여 개체 복제 정책 규칙을 만들고 해당 속성을 보여 주며,

### 예제 2: 모든 속성이 있는 개체 복제 정책 규칙 만들기 및 해당 속성 표시
```
...
이 명령은 모든 속성이 있는 개체 복제 정책 규칙을 표시하고 해당 속성을 나타냅니다.
...
### -PrefixMatch
결과를 필터하여 이름이 지정된 사전으로 시작하는 Blob만 복제합니다.
