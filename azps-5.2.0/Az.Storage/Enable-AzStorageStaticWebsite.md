...
## 설명
**Enable-AzStorageStaticWebsite** cmdlet을 사용하면 Azure Storage 계정에 대한 정적 웹 사이트를 사용할 수 있습니다.

## 예제

### 예제 1: Azure Storage 계정에 대해 정적 웹 사이트 사용
```
C:\PS>Enable-AzStorageStaticWebsite -IndexDocument $indexdoc -ErrorDocument404Path $errordoc
```

이 명령은 Azure Storage 계정에 대한 정적 웹 사이트를 사용할 수 있습니다.
...
404가 발급될 때 표시해야 하는 오류 문서의 경로입니다(브라우저에서 존재하지 않는 페이지를 요청하는 경우).
...
### -PassThru
ServiceProperties에서 정적 웹 사이트 설정을 표시합니다.
