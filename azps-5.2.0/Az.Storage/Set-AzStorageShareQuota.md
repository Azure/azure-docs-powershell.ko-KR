...
## 설명
**Set-AzStorageShareQuota** cmdlet은 지정된 공유에 대한 저장소 용량을 설정합니다.
...
이 명령은 ContosoShare01이라는 공유에 대한 저장소 용량을 1024GB로 설정합니다.
...
### -할당량
할당량 값을 기가바이트(GB)로 지정합니다.
에서 할당량 제한을 https://docs.microsoft.com/en-us/azure/azure-subscription-service-limits#azure-files-limits 참조합니다. 
...
### -공유
이 cmdlet이 할당량을 설정하는 공유를 나타내는 **CloudFileShare** 개체를 지정합니다.
