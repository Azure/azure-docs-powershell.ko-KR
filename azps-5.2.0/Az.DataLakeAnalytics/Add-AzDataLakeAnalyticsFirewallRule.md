...
## 설명
**Add-AzDataLakeAnalyticsFirewallRule** cmdlet은 Azure Data Lake Analytics 계정에 방화벽 규칙을 추가합니다.
...
이 명령은 IP 범위가 127.0.0.1 - 127.0.0.10인 계정 "ContosoAdlAcct"에서 "내 방화벽 규칙"이라는 방화벽 규칙을 추가합니다.
