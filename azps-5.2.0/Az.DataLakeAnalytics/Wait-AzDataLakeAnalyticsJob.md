...
## 설명
**Wait-AzDataLakeAnalyticsJob** cmdlet은 Azure Data Lake Analytics 작업이 완료될 때까지 대기합니다.
...
다음 명령은 지정된 ID를 사용하여 작업이 완료될 때까지 기다릴 수 있습니다.
...
### -TimeoutInSeconds
대기 작업을 종료하기 전에 대기할 시간(초)을 지정합니다.
...
작업 상태의 각 검사 사이에 경과되는 시간(초)을 지정합니다.
