...
## 설명
Add-AzAttestationPolicySigner cmdlet은 Azure Attestation에서 테넌트에 대한 신뢰할 수 있는 정책 서명자 추가합니다.
...
*pshtest라는* Atteestation Provider에 신뢰할 수 있는 서명자를 추가합니다.
...
### -Signer
추가할 신뢰할 수 있는 새 서명 키가 포함된 RFC7517 JSON 웹 키 값인 "maa-policyCertificate"라는 클레임이 포함된 RFC7519 JSON 웹 토큰을 지정합니다.
RFC7519 JWT는 기존의 신뢰할 수 있는 서명 키 중 하나를 사용하여 서명해야 합니다.
