...
## 설명
이 New-AzAttestation cmdlet은 지정된 리소스 그룹에 대한 토의를 만듭니다.
...
몇 가지 태그와 TEE 정책 마스터에 AAD 트러스트를 사용하여 *pshtest4라는 Attestation* Provider의 새 인스턴스를 만들 수 있습니다.
...
PEM 파일을 통해 신뢰할 수 있는 서명 키 집합을 지정하여 TEE 정책을 마스터하는 데 Isoladed 트러스트를 사용하는 *pshtest3'이라는 Attestation* Provider의 새 인스턴스를 만들 수 있습니다.
...
### -Location
등록 공급자를 만들 Azure 지역을 지정합니다. ProviderNamespace Get-AzResourceProvider 명령을 사용하여 선택을 볼 수 있습니다.
...
단일 인증서 파일에서 발급 정책에 대한 신뢰할 수 있는 서명 키 집합을 지정합니다.
