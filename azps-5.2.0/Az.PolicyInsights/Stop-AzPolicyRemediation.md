...
## 설명
**Stop-AzPolicyRemediation** cmdlet은 진행 중 정책 수정을 취소합니다. 활성 배포가 취소되고 새 배포가 생성되지 않습니다.

## 예제

### 예제 1: 리소스 그룹 범위에서 정책 수정 취소
```
PS C:\> Stop-AzPolicyRemediation -ResourceGroupName "myRG" -Name "remediation1"
```

이 명령은 리소스 그룹 'myRG'에서 'remediation1'이라는 수정을 취소합니다.

### 예제 2: 파이핑을 통해 관리 그룹 수정 취소
```
PS C:\> $remediation = Get-AzPolicyRemediation -ManagementGroupName "mg1" -Name "remediation1"
PS C:\> $remediation | Stop-AzPolicyRemediation
```

이 명령은 관리 그룹 'mg1'에서 'remediation1'이라는 수정을 취소합니다.
