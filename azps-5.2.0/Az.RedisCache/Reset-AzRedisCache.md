...
## 설명
**Reset-AzRedisCache** cmdlet은 Azure Redis Cache 인스턴스의 노드를 다시 시작합니다.
...
이 명령은 RedisCache06이라는 캐시에 대해 두 노드를 모두 다시 시작합니다.
...
### -ShardId
클러스터링이 활성화된 프리미엄 캐시에 대해 이 cmdlet이 다시 시작하는 shard의 ID를 지정합니다.
