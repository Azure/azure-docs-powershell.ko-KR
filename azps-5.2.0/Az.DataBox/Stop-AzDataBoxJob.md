...
## SYNOPSIS
작업이 취소 가능한 상태인 경우 진행되는 데이터 상자 작업을 취소합니다.
...
## 설명
**Stop-AzDataBoxJob** cmdlet은 데이터 상자 작업을 취소하는 데 사용됩니다.
...
확인 없이 지정된 데이터 상자 작업을 강제로 취소합니다.
