...
## 설명
generate-verification-code를 호출하여 얻은 확인 코드를 포함하는 확인 인증서를 업로드하여 인증서를 확인합니다. 소유 증명 프로세스의 마지막 단계입니다.
Azure IoT Hub Device Provisioning Service의 CA 인증서에 대한 자세한 설명은 다음을 참조하세요. https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates
...
"mycertificate" 개인 키의 소유권을 확인해야 합니다.
...
파이프라인을 사용하여 "mycertificate" 개인 키의 소유권을 검증합니다.
...
### -Path
x509 인증서 .cer 파일 또는 .pem 파일 경로의 base-64 표현
