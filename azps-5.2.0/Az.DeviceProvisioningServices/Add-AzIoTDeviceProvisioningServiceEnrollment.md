...
## 설명
Azure IoT Hub Device Provisioning Service에서 디바이스 등록을 생성합니다.
...
SymmetricKey 및 초기 쌍 상태를 사용하여 등록을 생성합니다.
...
여러 IoT Hub에 공백으로 구분된 목록을 사용하세요.
