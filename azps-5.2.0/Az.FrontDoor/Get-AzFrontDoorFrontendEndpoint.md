...
## 설명
**Get-AzFrontDoorFrontendEndpoint** cmdlet은 제공된 정보와 일치하는 현재 Front Door 리소스의 모든 기존 프런트 엔드 엔드포인트를 얻습니다.

## 예제

### 예제 1: 리소스 그룹 "rg1"의 일부인 Front Door "frontdoor1"에서 모든 프런트 엔드포인트를 얻습니다.
```powershell
...
리소스 그룹 "rg1"의 일부인 Front Door "frontdoor1"에서 모든 프런트 엔드포인트를 얻습니다.

### 예제 2: 리소스 그룹 "rg1"의 일부인 Front Door "frontdoor1"에서 이름이 "frontdoor1-azurefd-net"인 프런트 엔드 엔드포인트를 얻습니다.
```powershell
...
리소스 그룹 "rg1"의 일부인 Front Door "frontdoor1"에서 이름이 "frontdoor1-azurefd-net"인 프런트 엔드 엔드포인트를 얻습니다.
