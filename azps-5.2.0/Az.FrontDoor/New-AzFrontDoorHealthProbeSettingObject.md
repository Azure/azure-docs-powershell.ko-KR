...
참고: HealthProbeMethod 설정은 대/소문자 구분이 없습니다.
...
### -EnabledState
backendPools 아래에 정의된 백드에 대해 상태 프로브를 만들지 여부입니다. 상태 프로브는 활성화된 단일 백end 풀에 단일 활성화된 백드가 있는 경우 비활성화할 수 있습니다.
...
### -HealthProbeMethod
backendPools에서 정의된 백안을 프로브하는 데 사용할 HTTP 메서드를 구성합니다.
...
### -Protocol
이 프로브에 사용할 프로토콜 스키마 기본값은 HTTP입니다.
