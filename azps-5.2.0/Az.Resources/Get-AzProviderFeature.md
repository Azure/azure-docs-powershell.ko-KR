...
## 설명
**Get-AzProviderFeature** cmdlet은 Azure 공급자 기능에 대한 기능 이름, 공급자 이름 및 등록 상태를 얻습니다.

## 예제

### 예제 1: 사용 가능한 모든 기능 다운로드
```
PS C:\>Get-AzProviderFeature -ListAvailable
```

이 명령은 사용 가능한 모든 기능을 얻습니다.
...
### -ProviderNamespace
이 cmdlet에서 공급자 기능을 얻을 네임스페이스를 지정합니다.
