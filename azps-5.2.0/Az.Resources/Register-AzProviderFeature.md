...
## 설명
**Register-AzProviderFeature** cmdlet은 계정에 Azure 공급자 기능을 등록합니다.
...
그러면 Microsoft.Network에 대한 AllowApplicationSecurityGroups 기능이 계정에 추가됩니다.
...
### -ProviderNamespace
이 cmdlet이 공급자 기능을 등록하는 네임스페이스를 지정합니다.
