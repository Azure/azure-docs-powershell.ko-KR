...
## 설명
**Remove-AzManagementGroupDeployment** cmdlet은 관리 그룹 및 연결된 작업에서 Azure 배포를 제거합니다.
...
이 명령은 관리 그룹 "myMG"에서 "RolesDeployment" 배포를 제거합니다.
...
이 명령은 관리 그룹 "myMG"에서 배포 "RolesDeployment"를 사용하여 제거합니다.
