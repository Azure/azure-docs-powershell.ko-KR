...
## 설명
이 Remove-AzADAppCredential cmdlet을 사용하여 손상된 경우 또는 자격 증명 키 롤오버 만료의 일부로 애플리케이션에서 자격 증명 키를 제거할 수 있습니다.
애플리케이션은 개체 ID 또는 AppId를 제공하여 식별됩니다.
제거할 자격 증명은 키 ID로 식별됩니다.

## 예제

### 예제 1: 애플리케이션에서 특정 자격 증명 제거

```powershell
PS C:\> Remove-AzADAppCredential -ObjectId 7663d3fb-6f86-4352-9e6d-cf9d50d5ee82 -KeyId 9044423a-60a3-45ac-9ab1-09534157ebb
```

개체 ID가 '7663d3fb-6f86-4352-9e6d50d5ee82'인 애플리케이션에서 키 ID가 '9044423a-60a3-45ac-9ab1-09534157ebb'인 자격 증명을 제거합니다.

### 예제 2: 애플리케이션에서 모든 자격 증명 제거

```powershell
PS C:\> Remove-AzADAppCredential -ApplicationId 4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58
```

애플리케이션 ID가 '4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58'인 애플리케이션에서 모든 자격 증명을 제거합니다.

### 예제 3: 파이핑을 사용하여 모든 자격 증명 제거

```powershell
PS C:\> Get-AzADApplication -ObjectId 7663d3fb-6f86-4352-9e6d-cf9d50d5ee82 | Remove-AzADAppCredential
```

개체 ID가 '7663d3fb-6f86-4352-9e6d-cf9d50d5ee82'인 애플리케이션을 Remove-AzADAppCredential cmdlet에 파이프하고 해당 애플리케이션에서 모든 자격 증명을 제거합니다.

## PARAMETERS

### -ApplicationId
자격 증명을 제거할 애플리케이션의 ID입니다.
...
### -KeyId
제거할 자격 증명 키를 지정합니다.
애플리케이션에 대한 키 ID는 Get-AzADAppCredential 수 있습니다.
