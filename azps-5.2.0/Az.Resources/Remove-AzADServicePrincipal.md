...
### 예제 4 - 파이핑하여 서비스 주체 제거

```
PS C:\> Get-AzADServicePrincipal -ObjectId 61b5d8ea-fdc6-40a2-8d5b-ad447c678d45 | Remove-AzADServicePrincipal
```

개체 ID가 '61b5d8ea-fdc6-40a2-8d5b-ad447c678d45'인 서비스 주체 및 Remove-AzADServicePrincipal cmdlet에 파이프하여 해당 서비스 주체 제거
...
애플리케이션 ID가 '9263469e-d328-4321-8646-3e3e75d20e76'인 애플리케이션을, Remove-AzADServicePrincipal cmdlet에 파이프하여 해당 애플리케이션과 연결된 서비스 주체를 제거합니다.
