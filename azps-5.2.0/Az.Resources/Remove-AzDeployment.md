...
## 설명
**Remove-AzDeployment** cmdlet은 구독 범위 및 연결된 작업에서 Azure 배포를 제거합니다.
...
이 명령은 현재 구독 범위에서 배포 "RolesDeployment"를 제거합니다.
...
이 명령은 현재 구독 범위에서 배포 "RolesDeployment"를 얻게 하여 제거합니다.
