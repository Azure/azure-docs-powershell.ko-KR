...
## 설명
**Get-AzDataShareSynchronizationSetting** cmdlet은 공유에서 사용하도록 설정된 동기화에 대한 정보를 제공합니다. 
...
이 명령은 데이터 공유 계정 WikiAds의 Share AdsShare에서 사용하도록 설정된 동기화 ShareSynchronization에 대한 정보를 제공합니다.
