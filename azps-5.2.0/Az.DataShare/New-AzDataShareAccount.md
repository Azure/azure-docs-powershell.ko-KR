...
## 설명
**New-AzDataShareAccount** cmdlet은 지정된 Azure 리소스 그룹에 데이터 공유 계정을 만듭니다.
...
리소스 그룹 "ADS"에서 "WikiADS"라는 계정을 만듭니다.
...
### -ResourceGroupName
Azure 데이터 공유 계정의 리소스 그룹 이름이 만들어집니다.
...
### -Tag
Azure 데이터 공유 계정과 연결하기 위해 사용할 태그입니다.
