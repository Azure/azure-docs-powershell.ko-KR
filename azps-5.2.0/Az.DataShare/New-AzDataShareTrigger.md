...
## 설명
**New-AzDataShareTrigger** cmdlet은 Azure 데이터 공유 계정에서 지정된 반복 간격 및 동기화 시간의 공유 구독에 대한 트리거를 만듭니다.
...
이 명령은 매일 recurrence 간격이 오전 9시인 공유 구독 AdsShareSubscription에 대한 새 트리거 AdsTrigger를 만듭니다.
