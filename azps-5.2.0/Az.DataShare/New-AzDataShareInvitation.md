...
## 설명
**New-AzDataShareInvitation** cmdlet은 공급자 공유에 대한 정보가 있는 대상 소비자에게 초대를 전송합니다. 
...
이 명령은 공유 AdsShare에 대한 AdsInvitation 초대를 만들고 대상 전자 메일로 adstest@microsoft.com 전송합니다.
