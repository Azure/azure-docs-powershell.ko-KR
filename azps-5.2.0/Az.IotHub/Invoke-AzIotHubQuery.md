...
## 설명
강력한 SQL 같은 언어를 사용하여 IoT Hub를 쿼리하여 디바이스 및 모듈 쌍, 작업 및 메시지 라우팅에 대한 정보를 검색합니다.
자세한 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language 내용은 다음을 참조하세요.
...
Azure IoT Hub에서 모든 디바이스 쌍 데이터를 쿼리합니다.
