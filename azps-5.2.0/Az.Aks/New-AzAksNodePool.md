...
### -OsType
os 유형을 지정하는 데 사용할 OsType입니다.
Linux 및 Windows에서 선택
Linux의 기본값입니다.
...
우선 순위가 낮은 가상 머신 확장 집합에 대한 지우기 정책을 지정하는 데 사용할 ScaleSetEvictionPolicy입니다.
기본값은 삭제입니다.
...
### -ScaleSetPriority
가상 머신 확장 집합 우선 순위를 지정하는 데 사용할 ScaleSetPriority입니다.
기본값은 일반입니다.
...
### -VmSetType
노드 풀의 형식을 나타 내는 것입니다.
가능한 값은 'VirtualMachineScaleSets', 'AvailabilitySet'입니다.
