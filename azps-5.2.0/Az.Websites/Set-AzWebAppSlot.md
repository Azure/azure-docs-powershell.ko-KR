...
## 설명
**Set-AzWebApp** cmdlet은 Azure 웹앱 슬롯을 설정합니다.
...
이 명령은 리소스 그룹 Default-Web-WestUS와 연결된 Webapp ContosoWebApp에서 Slot001과 연결된 appservice 계획을 변경합니다. 이 링크를 사용하여 연결된 AppService 계획 및 제약 조건 변경에 대해 자세히 알아보면 됩니다.
...
이 명령은 리소스 그룹 Default-Web-WestUS와 연결된 웹앱 ContosoWebApp과 관련된 Slot Slot001에 대해 HttpLoggingEnabled를 true로 설정

### 예제 3

Azure 웹앱 슬롯을 수정합니다. (자동Generated)
...
### -AssignIdentity
기존 슬롯에서 MSI 사용/사용 안 하도록 설정 [미리 보기]
...
### -FtpsState
앱에 대한 Ftps 상태 값을 설정합니다. 허용되는 값 [AllAllowed | 사용 안 으로 설정 | FtpsOnly].
...
### -HttpsOnly
기존 슬롯의 HTTPS로 모든 트래픽 리디렉션 사용/사용 안 하도록 설정
