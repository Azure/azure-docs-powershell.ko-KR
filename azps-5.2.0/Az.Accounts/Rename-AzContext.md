...
구독 user1@contoso.org '12345-6789-2345-3567890'을 '작업'으로 '에 대한 컨텍스트의 이름을 변경합니다.  이 명령 후에 'Select-AzContext Work'를 사용하여 컨텍스트를 대상으로 할 수 있습니다.  탭 완료를 사용하여 'SourceName'에 대한 값을 탭할 수 있습니다.
...
"내 컨텍스트"라는 컨텍스트의 이름을 "Work"로 변경합니다.  이 명령 다음에는 Work를 사용하여 컨텍스트를 대상으로 Select-AzContext 있습니다.
