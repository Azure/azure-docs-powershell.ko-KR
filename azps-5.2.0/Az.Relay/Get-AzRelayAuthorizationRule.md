...
## 설명
**Get-AzRelayAuthorizationRule** cmdlet은 지정된 Relay 엔터티(네임스페이스/WcfRelay/HybridConnection)에서 지정된 권한 부여 규칙에 대한 설명을 얻습니다.
...
지정된 WcfRelay에 대해 지정된 권한 부여 규칙 설명을 반환합니다.
...
지정된 HybridConnection에 대해 지정된 권한 부여 규칙 설명을 반환합니다.
