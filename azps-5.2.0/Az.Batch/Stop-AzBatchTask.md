...
이 명령은 ID Job-000001이 있는 작업에서 ID Task23이 있는 태스크를 중지합니다.
...
이 명령은 Get-AzBatchTask cmdlet을 사용하여 ID Job-000001이 있는 작업에 ID Task26이 있는 Batch 태스크를 Get-AzBatchTask 합니다.
