...
## 설명
**Stop-AzBatchCertificateDeletion** cmdlet은 Azure Batch 서비스에서 인증서 삭제에 실패한 삭제를 취소합니다.
인증서가 **DeleteFailed** 상태인 경우 삭제를 중지할 수 있습니다.
이 cmdlet은 인증서를 **활성** 상태로 복원합니다.
...
이 명령은 지정된 지문이 있는 인증서의 지문을 취소합니다.
...
### -Thumbprint
이 cmdlet이 활성 상태로 복원하는 인증서의 **지문을 지정합니다.**
