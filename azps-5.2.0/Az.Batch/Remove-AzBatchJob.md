...
## 설명
**Remove-AzBatchJob** cmdlet은 Azure Batch 작업을 삭제합니다.
이 cmdlet은 Force 매개 변수를 지정하지 않는 한 작업을 제거하기 전에 확인을 *요청하는 메시지를* 표시합니다.
...
이 명령은 ID Job-000001이 있는 작업을 삭제합니다.
...
이 명령은 Get-AzBatchJob cmdlet을 사용하여 ID Job-000002가 있는 작업을 Get-AzBatchJob 합니다.
