...
지정된 계산 노드에서 태스크를 설정합니다.

### [Enable-AzBatchJob](Enable-AzBatchJob.md)
Batch 작업을 가능하게 합니다.

### [Enable-AzBatchJobSchedule](Enable-AzBatchJobSchedule.md)
Batch 작업 일정을 가능하게 합니다.
...
Batch 계정의 애플리케이션 패키지에 대한 정보를 얻습니다.
...
지정된 Batch 계정에서 Batch 풀을 얻습니다.

### [Get-AzBatchPoolNodeCount](Get-AzBatchPoolNodeCount.md)
풀 ID로 그룹화되는 노드 상태당 Batch 노드 수를 얻습니다.
