...
이름으로 마이그레이션 프로젝트의 서버를 얻습니다.
이름은 서버에 대한 고유한 파라메더입니다.
...
마이그레이션 프로젝트의 서버를 나열하고 표시 이름으로 응답을 필터링합니다.

### 예제 6: 어플라이언스에 나열 및 표시 이름으로 필터링
```powershell
...
마이그레이션 프로젝트에서 어플라이언스에 대한 서버를 나열하고 표시 이름으로 응답을 필터링합니다.
