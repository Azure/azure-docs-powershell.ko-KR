...
C:\PS \> Test-AzStackHCIConnection 테스트: Azure Stack HCI 서비스 EndpointTested에 연결: https://azurestackhci-df.azurefd.net/health IsRequired: True 결과: 성공
...
C:\PS \> Test-AzStackHCIConnection 테스트: Azure Stack HCI 서비스 EndpointTested에 연결: https://azurestackhci-df.azurefd.net/health IsRequired: True 결과: FailedNodes: Node1inClus2, Node2inClus3
