...
## 설명
**New-AzMetricAlertRuleV2Criteria** cmdlet은 새 메트릭 경고 규칙을 만드는 [입력 Add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) cmdlet으로 사용할 로컬 메트릭 조건 개체를 만듭니다.
...
### -TimeAggregation
기간 간격에 걸쳐 여러 메트릭 값을 롤업하는 데 사용되는 집계 작업
...
### -ViolationCount
경고를 발생하는 데 필요한 선택한 콜백 기간 내에 필요한 최소 위반 수
