...
### 예제 1: 이름으로 PostgreSql 서버 Virtual Network 규칙 제거
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

이 cmdlet은 이름으로 PostgreSql 서버 Virtual Network 규칙을 제거합니다.

### 예제 2: ID에 의해 PostgreSql 서버 Virtual Network 규칙 제거
```powershell
...
이러한 cmdlet은 ID에 의해 PostgreSql 서버 Virtual Network 규칙을 제거합니다.
