...
## 설명
이 명령은 지정된 저장소 동기화 서비스를 삭제합니다. 저장소 동기화 서비스는 포함된 모든 동기화 그룹 및 등록된 서버가 먼저 삭제될 때만 제거할 수 있습니다.
...
### -InputObject
StorageSyncService 입력 개체로, 일반적으로 파이프라인을 통해 전달됩니다.
