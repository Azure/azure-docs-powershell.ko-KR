...
## 설명
이 명령은 주어진 동기화 그룹 내의 모든 클라우드 엔드포인트를 나열합니다. 또한 각 클라우드 엔드포인트의 특성을 나열하는 데 사용할 수 있습니다.
...
이 명령은 지정된 동기화 그룹 내에 포함된 모든 클라우드 엔드포인트를 얻습니다. 특정 값을 반환하도록 -CloudEndpointName을 지정합니다.
