...
## 설명
노드 유형 내에서 노드 유형 또는 특정 노드를 제거합니다. paremter -NodeName을 사용하는 경우 지정된 노드만 제거됩니다.
...
파이핑을 사용하여 노드 유형에서 2개 노드를 제거합니다.
...
상태 저장 워크로드가 노드에서 실행되는 경우 데이터 손실을 발생하거나 opearion 후 시드 노드가 충분하지 않은 경우 클러스터를 종료할 수 있습니다.
