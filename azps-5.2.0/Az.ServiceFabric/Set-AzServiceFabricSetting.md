...
## 설명
**Set-AzServiceFabricSetting을** 사용하여 클러스터에서 Service Fabric 설정을 추가하거나 업데이트합니다.
...
이 명령은 'NamingService' 섹션에서 'MaxFileOperationTimeout'을 '5000' 값으로 설정합니다.
...
이 명령은 SettingsSectionDescription 매개 변수를 사용하여 여러 패브릭 설정을 설정하는 업그레이드를 트리거합니다.
