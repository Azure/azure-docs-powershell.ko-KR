...
## SYNOPSIS
클러스터에서 애플리케이션을 제거합니다. 그러면 애플리케이션의 모든 서비스가 제거됩니다. 배포된 ARM 지원됩니다.
...
## 설명
이 cmdlet은 클러스터를 구성하는 애플리케이션을 제거합니다. 그러면 애플리케이션 리소스에서 모든 서비스(있는 경우)가 제거됩니다.
...
이 예제에서는 리소스 그룹 "testRG" 및 클러스터 "testCluster"에서 애플리케이션 "testApp"을 제거합니다.
