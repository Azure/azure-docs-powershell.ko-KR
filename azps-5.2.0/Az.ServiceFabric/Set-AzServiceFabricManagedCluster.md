...
클러스터에 대한 DNS 이름 및 클라이언트 연결 포트를 업데이트합니다.
...
파이핑을 사용하여 클러스터에 대한 DNS 이름 및 클라이언트 연결 포트를 업데이트합니다.
...
클러스터에 대한 클라이언트 연결에 사용되는 포트입니다. 기본값: 19000.
...
### -CodeVersion
클러스터 코드 버전입니다. 업그레이드 모드가 수동인 경우만 사용할 수 있습니다.
...
클러스터에 대한 http 연결에 사용되는 포트입니다. 기본값: 19080.
...
### -UpgradeMode
클러스터 코드 버전 업그레이드 모드입니다. 자동 또는 수동.
