...
## 설명
클러스터에 이미 사용 중인 다른 유효한 인증서가 있는 한 **Remove-AzServiceFabricClusterCertificate를** 사용하여 클러스터에서 클러스터 인증서를 제거합니다.
...
이 명령은 지문이 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A인 인증서를 클러스터 보안에 사용되지 않습니다.
