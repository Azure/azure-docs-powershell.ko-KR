...
## 설명
이름별로 노드 형식에서 vm 확장을 제거합니다. [Get-AzServiceFabricManagedNodeType을](./Get-AzServiceFabricManagedNodeType.md) 사용하여 VmExtensions 속성을 확인하여 노드 형식에서 현재 확장을 봐야 합니다.
...
파이핑을 사용하여 이름별로 노드 형식에서 확장을 제거합니다.
