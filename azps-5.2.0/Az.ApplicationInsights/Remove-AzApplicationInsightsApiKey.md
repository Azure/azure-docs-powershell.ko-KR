...
### 예제 1 Application Insights 리소스에 대한 Application Insights API 키 제거
```
...
리소스 그룹 "testGroup"에서 리소스 "테스트"에 대해 ID가 "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867"인 특정 Application Insights API 키를 제거합니다.
...
### -PassThru
지정된 경우 작업이 성공하는 경우 true를 기록합니다. 이 매개 변수는 선택 사항입니다. 기본값은 false입니다.
