...
종류가 "java"인 리소스 그룹 "testgroup"에서 "test"로 명명된 새 Application Insights 리소스를 추가합니다.
...
### -Location
Application Insights 리소스 위치입니다.
...
Application Insights에 액세스하기 위한 네트워크 액세스 유형입니다. 값은 'Enabled' 또는 'Disabled'입니다.
...
Application Insights 쿼리에 액세스하기 위한 네트워크 액세스 유형입니다. 값은 'Enabled' 또는 'Disabled'입니다.
