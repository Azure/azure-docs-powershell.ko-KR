...
## 설명
**Remove-AzDataFactoryV2Trigger** cmdlet은 데이터 팩터리에서 트리거를 제거합니다. Force _매개_ 변수를 지정하면 트리거를 제거하기 전에 cmdlet이 프롬프트를 표시하지 않습니다.
...
데이터 팩터리 "WikiADF"에서 "ScheduledTrigger"라는 트리거를 제거합니다.
