...
## 설명
이 Get-AzDataFactoryV2DataFlow cmdlet은 Azure Data Factory의 데이터 흐름에 대한 정보를 얻습니다.
데이터 흐름의 이름을 지정하는 경우 이 cmdlet은 해당 데이터 흐름에 대한 정보를 얻습니다.
이름을 지정하지 않으면 이 cmdlet은 데이터 팩터리의 모든 데이터 흐름에 대한 정보를 얻습니다.

## 예제
### 예제 1: 모든 데이터 흐름에 대한 정보 얻기
```powershell
...
이 명령은 WikiADF라는 데이터 팩터리의 모든 데이터 흐름에 대한 정보를 얻습니다.

### 예제 2: 특정 데이터 흐름에 대한 정보 얻기
```powershell
...
이 명령은 WikiADF라는 데이터 팩터리에서 dataflow1이라는 데이터 흐름에 대한 정보를 얻습니다.
