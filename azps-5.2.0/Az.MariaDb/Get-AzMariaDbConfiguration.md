...
ms.locfileid: "98369972"
---
# <span data-ttu-id="9484a-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="9484a-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="9484a-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="9484a-102">SYNOPSIS</span></span>
<span data-ttu-id="9484a-103">서버 구성에 대한 정보를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="9484a-104">구문</span><span class="sxs-lookup"><span data-stu-id="9484a-104">SYNTAX</span></span>

### <span data-ttu-id="9484a-105">목록(기본값)</span><span class="sxs-lookup"><span data-stu-id="9484a-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="9484a-106">가져오기</span><span class="sxs-lookup"><span data-stu-id="9484a-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="9484a-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="9484a-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="9484a-108">설명</span><span class="sxs-lookup"><span data-stu-id="9484a-108">DESCRIPTION</span></span>
<span data-ttu-id="9484a-109">서버 구성에 대한 정보를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="9484a-110">예제</span><span class="sxs-lookup"><span data-stu-id="9484a-110">EXAMPLES</span></span>

### <span data-ttu-id="9484a-111">예제 1: MariaDB에서 모든 구성 나열</span><span class="sxs-lookup"><span data-stu-id="9484a-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="9484a-112">이 명령은 MariaDB의 모든 구성을 나열합니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="9484a-113">예제 2: MariaDB의 구성을 얻다</span><span class="sxs-lookup"><span data-stu-id="9484a-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="9484a-114">이 명령은 MariaDB의 구성을 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="9484a-115">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="9484a-115">PARAMETERS</span></span>

### <span data-ttu-id="9484a-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="9484a-116">-DefaultProfile</span></span>
<span data-ttu-id="9484a-117">Azure와의 통신에 사용되는 자격 증명, 계정, 테넌트 및 구독입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="9484a-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="9484a-118">-InputObject</span></span>
<span data-ttu-id="9484a-119">ID 매개 변수를 생성하는 경우 INPUTOBJECT 속성에 대한 NOTES 섹션을 참조하고 해시 테이블을 만드십시오.</span><span class="sxs-lookup"><span data-stu-id="9484a-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="9484a-120">-Name</span><span class="sxs-lookup"><span data-stu-id="9484a-120">-Name</span></span>
<span data-ttu-id="9484a-121">서버 구성의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="9484a-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="9484a-122">-ResourceGroupName</span></span>
<span data-ttu-id="9484a-123">리소스를 포함하는 리소스 그룹의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="9484a-124">Azure Resource Manager API 또는 포털에서 이 값을 얻을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="9484a-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="9484a-125">-ServerName</span></span>
<span data-ttu-id="9484a-126">서버의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-126">The name of the server.</span></span>
...
### <span data-ttu-id="9484a-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="9484a-127">-SubscriptionId</span></span>
<span data-ttu-id="9484a-128">Azure 구독을 식별하는 구독 ID입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="9484a-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="9484a-129">CommonParameters</span></span>
<span data-ttu-id="9484a-130">이 cmdlet은 -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction 및 -WarningVariable의 일반적인 매개 변수를 지원합니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="9484a-131">자세한 내용은 [다음](http://go.microsoft.com/fwlink/?LinkID=113216)about_CommonParameters.</span><span class="sxs-lookup"><span data-stu-id="9484a-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="9484a-132">입력</span><span class="sxs-lookup"><span data-stu-id="9484a-132">INPUTS</span></span>

### <span data-ttu-id="9484a-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="9484a-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="9484a-134">출력</span><span class="sxs-lookup"><span data-stu-id="9484a-134">OUTPUTS</span></span>

### <span data-ttu-id="9484a-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="9484a-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="9484a-136">참고 사항</span><span class="sxs-lookup"><span data-stu-id="9484a-136">NOTES</span></span>

<span data-ttu-id="9484a-137">별칭</span><span class="sxs-lookup"><span data-stu-id="9484a-137">ALIASES</span></span>

<span data-ttu-id="9484a-138">복합 매개 변수 속성</span><span class="sxs-lookup"><span data-stu-id="9484a-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="9484a-139">아래에 설명된 매개 변수를 만들 수 있도록 적절한 속성을 포함하는 해시 테이블을 생성합니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="9484a-140">해시 테이블에 대한 자세한 내용은 다음 Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="9484a-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="9484a-141">INPUTOBJECT: <IMariaDbIdentity> ID 매개 변수</span><span class="sxs-lookup"><span data-stu-id="9484a-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="9484a-142">`[ConfigurationName <String>]`: 서버 구성의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="9484a-143">`[DatabaseName <String>]`: 데이터베이스의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="9484a-144">`[FirewallRuleName <String>]`: 서버 방화벽 규칙의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="9484a-145">`[Id <String>]`: 리소스 ID 경로</span><span class="sxs-lookup"><span data-stu-id="9484a-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="9484a-146">`[LocationName <String>]`: 위치의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="9484a-147">`[ResourceGroupName <String>]`: 리소스를 포함하는 리소스 그룹의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="9484a-148">Azure Resource Manager API 또는 포털에서 이 값을 얻을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="9484a-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: 보안 경고 정책의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="9484a-150">`[ServerName <String>]`: 서버의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="9484a-151">`[SubscriptionId <String>]`: Azure 구독을 식별하는 구독 ID입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="9484a-152">`[VirtualNetworkRuleName <String>]`: 가상 네트워크 규칙의 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="9484a-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="9484a-153">관련 링크</span><span class="sxs-lookup"><span data-stu-id="9484a-153">RELATED LINKS</span></span>
