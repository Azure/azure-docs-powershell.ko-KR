...
## 설명
**Get-AzSmartGroup** cmdlet은 스마트 그룹 정보를 얻습니다.
...
지난 1시간 동안 형성된 모든 스마트 그룹을 나열합니다. 목록에서 Format-List 각 스마트 그룹의 전체 세부 정보를 얻습니다.
...
ID(GUID) 또는 리소스 ID로 스마트 그룹 세부 정보(전체 ARM ID)
...
### -SmartGroupId
SmartGroup/SmartGroup의 ResourceId의 고유 식별자입니다.
