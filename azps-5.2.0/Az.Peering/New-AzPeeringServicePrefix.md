...
## 설명
피어링 서비스 개체와 연결된 피어링 서비스 prefix를 만듭니다.
...
피어링 서비스 리소스 그룹 이름 및 이름에서 prefix를 만듭니다.
...
### -PeeringServiceName
피어링 서비스 이름입니다.
새 New-AzPeeringService 서비스에 대해 Get-AzPeeringService cmdlet을 사용하세요.
