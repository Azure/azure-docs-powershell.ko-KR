...
## 설명
Update-AzPeering과 함께 사용하며 메모리 내 작업으로, 에서만 `Update-AzPeering` 지속됩니다. 
...
메모리의 피어링 개체에서 첫 번째 연결에 대한 대역폭을 업그레이드합니다. 
...
메모리의 피어링 개체에서 첫 번째 연결에 대한 피어링 주소를 업데이트합니다. 
