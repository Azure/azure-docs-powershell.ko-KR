...
이 명령은 모든 함수 앱 계획을 얻습니다.

### 예제 2: 리소스 그룹 이름으로 함수 앱 계획을 얻습니다.
```powershell
...
이 명령은 리소스 그룹 이름으로 함수 앱 계획을 얻습니다.

### 예제 3: 주어진 구독에 대한 함수 앱 계획을 얻습니다.
```powershell
...
이 명령은 주어진 구독에 대한 함수 앱 계획을 얻습니다.

### 예제 4: 위치로 함수 앱 계획을 얻습니다.
```powershell
