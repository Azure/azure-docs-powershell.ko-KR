...
## 설명
**New-AzDataLakeStoreAccount** cmdlet은 새 Data Lake Store 계정을 만듭니다.
...
이 명령은 미국 동부 2 위치에 대해 ContosoADL이라는 Data Lake Store 계정을 만듭니다.

## PARAMETERS

### -DefaultGroup
새 파일 및 폴더에 대한 기본 그룹 소유자로 사용할 AzureActive Directory 그룹의 개체 ID를 지정합니다.
...
### -DisableEncryption
계정에 적용된 어떠한 형태의 암호화도 없는지 나타냅니다.
