...
## 설명
**Set-AzDataLakeStoreItemOwner** cmdlet은 Data Lake Store에서 파일 또는 폴더의 소유자를 수정합니다.
...
이 명령은 루트 디렉터리의 소유자를 Patti Fuller로 설정합니다.
...
### -Id
소유자로 사용할 AzureActive Directory 사용자, 그룹 또는 서비스 주체의 개체 ID를 지정합니다.
