...
## 설명
**Get-AzApiManagementCertificate** cmdlet은 사용자가 지정한 모든 Azure API Management 인증서 또는 인증서를 얻습니다.
...
이 명령은 지정된 ID로 API Management 인증서를 얻습니다.
...
### -ResourceId
인증서의 Arm 리소스 식별자입니다. 지정된 경우 식별자에 의해 인증서를 찾으려고 시도합니다. 이 매개 변수는 필수입니다.
