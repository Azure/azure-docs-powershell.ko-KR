...
## SYNOPSIS
게이트웨이로 들어오는/보내기 HTTP 메시지에 대한 진단 설정을 생성합니다.
...
## 설명
**New-AzApiManagementPipelineDiagnosticSetting** cmdlet은 게이트웨이로 들어오는/발신 HTTP 메시지에 대한 진단 설정을 만듭니다.
...
진단 엔터티의 FrontEnd 또는 백 엔드에서 사용할 파이프라인 진단을 만듭니다.
