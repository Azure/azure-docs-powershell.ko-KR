...
## 설명
**Set-AzApiManagementLogger** cmdlet은 Azure API Management 로거의 설정을 **수정합니다.**
...
API Management 로거를 수정합니다. (자동Generated)
...
### -IsBuffered
게시하기 전에 로거의 레코드가 버퍼링될 수 있도록 지정합니다.
...
### -PassThru
이 cmdlet이 이 cmdlet이 수정하는  **PsApiManagementLogger를** 반환합니다.
