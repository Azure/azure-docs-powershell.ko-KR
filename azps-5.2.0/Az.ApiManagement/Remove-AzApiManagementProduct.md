...
## 설명
**Remove-AzApiManagementProduct** cmdlet은 기존 API Management 제품을 제거합니다.
...
### -DeleteSubscriptions
제품에 대한 구독을 삭제할지 여부를 나타냅니다.
이 매개 변수를 설정하지 않은 경우 구독이 있으면 예외가 throw됩니다.
...
### -PassThru
이 cmdlet이 성공하는 경우 $True, 실패하는 경우 $False 값을 반환합니다.
