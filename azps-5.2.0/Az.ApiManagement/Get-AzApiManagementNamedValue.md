...
명명된 값이 비밀로 표시된 경우 값이 결과 세부 정보에 포함되지 않습니다. 비밀 값을 얻습니다. **Get-AzApiManagementNamedValueSecretValue를 사용 합니다.**
...
### -Name
이름 문자열이 포함된 이름이 있는 명명된 값을 검색합니다.
이 매개 변수는 선택 사항입니다.
...
### -NamedValueId
명명된 값의 식별자입니다.
지정된 경우 식별자에 의해 명명된 값을 찾으려고 시도합니다.
이 매개 변수는 선택 사항입니다.
