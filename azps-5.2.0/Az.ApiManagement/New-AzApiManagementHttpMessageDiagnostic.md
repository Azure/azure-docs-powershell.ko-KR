...
## 설명
**New-AzApiManagementHttpMessageDiagnostic** cmdlet은 Http 메시지 진단 설정을 만듭니다.
...
100비트와 함께 로그 및 헤더에 대한 http 메시지 진단 `Content-Type` `User-Agent` 설정 만들기 `body`

## PARAMETERS

### -BodyBytesToLog
기록할 요청 본문의 수입니다. 이 매개 변수는 선택 사항입니다.
