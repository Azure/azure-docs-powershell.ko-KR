...
이 명령은 리소스 ID로 Azure Synapse Analytics Spark 풀을 업데이트합니다.
...
이 명령을 사용하면 Azure Synapse Analytics Spark 풀에 대해 자동 크기 조정을 사용할 수 있습니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대한 자동 크기 조정을 비활성화합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대한 자동 일시 중지를 비활성화합니다.
...
유휴 시간(분)입니다. 자동 일시 중지를 사용할 때 이 매개 변수를 지정해야 합니다.
...
### -NodeSize
지정된 Spark 풀에 할당된 노드에 사용할 코어 및 메모리의 수입니다.
