...
## 설명
**Wait-AzSynapseSparkJob** cmdlet은 Azure Synapse Analytics 작업이 완료될 때까지 대기합니다.
...
이 명령은 지정된 ID를 사용하여 작업이 완료될 때까지 기다릴 수 있습니다.
...
### -SparkJobObject
Spark 작업 입력 개체로, 일반적으로 파이프라인을 통해 전달됩니다.
...
### -TimeoutInSeconds
오류가 발생하기 전에 대기할 최대 시간입니다. 기본값은 시간 제한이 없는 것입니다.
