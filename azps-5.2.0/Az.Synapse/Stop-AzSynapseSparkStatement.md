...
### StopSparkStatementByIdParameterSet(기본값)
```
...
## 설명
**Stop-AzSynapseSparkStatement** cmdlet은 Synapse Analytics Spark 문을 취소합니다.
...
이 명령은 지정된 livy ID를 사용하여 Spark 문을 취소합니다.
...
이 명령은 파이프라인을 통해 지정된 livy ID를 사용하여 Spark 문을 취소합니다.
