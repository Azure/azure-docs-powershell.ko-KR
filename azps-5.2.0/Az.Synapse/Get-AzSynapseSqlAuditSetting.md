...
## 설명
**Get-AzSynapseSqlAuditSetting** cmdlet은 Azure Synapse 분석 작업 영역의 감사 설정을 얻습니다.
...
ContosoWorkspace라는 작업 영역의 감사 설정을 얻습니다.
...
파이프라인을 통해 ContosoWorkspace라는 작업 영역의 감사 설정을 얻습니다.
