...
### 예제 1: 구독에서 연결된 모든 kubernetes를 얻게
```powershell
...
이 명령은 구독에서 연결된 모든 kubernetes를 얻습니다.

### 예제 2: 리소스 그룹에서 연결된 모든 kubernetes를 얻게
```powershell
...
이 명령은 개체에 의해 연결된 kubernetes를 얻습니다.
