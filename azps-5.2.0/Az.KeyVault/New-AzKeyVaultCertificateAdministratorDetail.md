...
## 설명
**New-AzKeyVaultCertificateAdministratorDetail** cmdlet은 메모리 내 인증서 관리자 세부 정보 개체를 만듭니다.
...
이 명령은 메모리 내 인증서 관리자 세부 정보 개체를 만든 다음, 메모리 내 $AdminDetails 저장합니다.
