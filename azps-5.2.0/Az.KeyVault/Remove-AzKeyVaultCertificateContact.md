...
## 설명
**Remove-AzKeyVaultCertificateContact** cmdlet은 키 자격 증명 모음에서 인증서 알림에 등록된 연락처를 삭제합니다.
...
이 명령은 Contoso01 키 자격 증명 모음에 대한 인증서 연락처로 Patti Fuller를 제거합니다.  PassThru를 지정하면 cmdlet은 나머지 인증서 연락처 목록을 반환합니다.
