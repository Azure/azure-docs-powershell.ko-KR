...
## 설명
**Add-AzKeyVaultCertificate** cmdlet은 Azure Key Vault의 키 자격 증명 모음에 인증서를 등록하는 프로세스를 시작합니다.
...
첫 번째 명령은 New-AzKeyVaultCertificatePolicy cmdlet을 사용하여 인증서 정책을 만든 다음 $Policy 변수에 저장합니다.
두 번째 명령은 **Add-AzKeyVaultCertificate를** 사용하여 인증서를 만드는 프로세스를 시작합니다.
세 번째 명령은 Get-AzKeyVaultCertificateOperation cmdlet을 사용하여 작업을 폴링하여 완료 여부를 확인할 수 있습니다.
마지막 명령은 Get-AzKeyVaultCertificate cmdlet을 사용하여 인증서를 얻습니다.

## PARAMETERS

### -CertificatePolicy
**KeyVaultCertificatePolicy 개체를 지정합니다.**
