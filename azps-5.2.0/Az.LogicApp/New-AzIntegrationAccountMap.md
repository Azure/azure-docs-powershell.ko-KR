...
## 설명
**New-AzIntegrationAccountMap** cmdlet은 통합 계정 맵을 만듭니다.
이 cmdlet은 통합 계정 맵을 나타내는 개체를 반환합니다.
통합 계정 이름, 리소스 그룹 이름, 맵 이름 및 맵 정의를 지정합니다.
...
이 명령은 지정된 리소스 그룹에 통합 계정 맵을 만듭니다.
이 명령은 이전 명령으로 $MapContent 변수에 저장된 맵 정의를 지정합니다.

### 예제 2

통합 계정 맵을 만듭니다. (자동Generated)
...
### -MapDefinition
통합 계정 맵에 대한 정의 개체를 지정합니다.
이 매개 변수 또는 *MapFilePath* 매개 변수를 지정합니다.
...
### -MapFilePath
통합 계정 맵에 대한 정의의 파일 경로를 지정합니다. 이 매개 변수 또는 *MapDefinition* 매개 변수를 지정합니다.
