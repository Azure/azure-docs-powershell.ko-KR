...
## 설명
**Get-AzLogicAppTrigger** cmdlet은 논리 앱에서 트리거를 얻습니다.
이 cmdlet은 **WorkflowTrigger 개체를 반환합니다.**
워크플로, 리소스 그룹 및 트리거를 지정합니다.
...
이 명령은 LogicApp05라는 논리 앱에서 Trigger01이라는 트리거를 얻습니다.

### 예제 2: 논리 앱의 모든 트리거를 얻습니다.
```
...
이 명령은 LogicApp07이라는 논리 앱의 트리거를 얻습니다.
...
### -Name
이 cmdlet이 트리거를 받을 논리 앱의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 트리거를 받을 리소스 그룹의 이름을 지정합니다.
