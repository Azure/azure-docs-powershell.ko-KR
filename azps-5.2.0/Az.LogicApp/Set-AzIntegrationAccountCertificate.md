...
## 설명
**Set-AzIntegrationAccountCertificate** cmdlet은 통합 계정 인증서를 수정합니다.
...
이 명령은 지정된 리소스 그룹의 통합 계정 인증서를 수정합니다.
