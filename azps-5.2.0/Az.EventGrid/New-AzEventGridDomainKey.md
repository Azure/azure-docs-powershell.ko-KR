...
리소스 그룹 \' \` \` \` MyResourceGroupName에서 Event Grid 도메인 Domain1의 key key1'\에 해당하는 키를 다시 \` 생성합니다.
...
전체 리소스 ID를 사용하여 리소스 그룹 \' \` \` \` MyResourceGroupName에서 Event Grid 도메인 Domain1의 key key2'\에 해당하는 키를 \` 다시 생성합니다.
