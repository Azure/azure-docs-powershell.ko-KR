...
그러면 "ContosoADL"의 방화벽 규칙 "MyProvider"에 대한 공급자 엔드포인트가 ""로 https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 업데이트됩니다.

## 매개 변수

### -Account
신뢰할 수 있는 ID 공급자를 추가하는 Data Lake Store 계정
...
### -ResourceGroupName
신뢰할 수 있는 ID 공급자를 업데이트할 계정을 포함하는 리소스 그룹의 이름을 지정합니다.
