...
## 설명
**Get-AzDataLakeStoreAccount** cmdlet은 Data Lake Store 계정의 세부 정보를 제공합니다.

## 예제

### 예제 1: Data Lake Store 계정 다운로드
```
PS C:\>Get-AzDataLakeStoreAccount -Name "ContosoADL"
```

이 명령은 ContosoADL이라는 계정을 얻습니다.
...
### -ResourceGroupName
얻을 Data Lake Store 계정이 포함된 리소스 그룹의 이름을 지정합니다.
