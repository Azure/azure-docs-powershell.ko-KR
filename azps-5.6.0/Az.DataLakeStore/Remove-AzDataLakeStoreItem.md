...
## 설명
**Remove-AzDataLakeStoreItem** cmdlet은 Data Lake Store에서 파일 또는 폴더를 삭제합니다.
...
이 명령은 Data Lake Store에서 File01.txt File.csv 파일을 제거합니다.
...
### -Paths
루트 디렉터리(/)로 시작하여 제거할 파일의 Data Lake Store 경로 배열을 지정합니다.
...
### -Recurse
이 작업은 하위 폴더를 포함하여 대상 폴더의 모든 항목을 삭제합니다.
