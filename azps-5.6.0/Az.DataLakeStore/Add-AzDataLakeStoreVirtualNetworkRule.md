...
## 설명
**Add-AzDataLakeStoreVirtualNetworkRule** cmdlet은 지정된 Data Lake Store 계정에 가상 네트워크 규칙을 추가합니다.
...
그러면 서브넷 ID "testId"가 있는 계정 "dls"에 "myVNET"이라는 새 가상 네트워크 규칙이 생성됩니다.

## 매개 변수

### -Account
가상 네트워크 규칙을 추가하는 Data Lake Store 계정
