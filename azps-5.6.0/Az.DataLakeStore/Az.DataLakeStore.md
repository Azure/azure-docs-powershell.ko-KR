...
# Az.DataLakeStore 모듈
## 설명
이 섹션의 항목에서는 Azure Resource Manager(Azure Resource Manager) 프레임워크의 Azure Data Lake Store용 Azure PowerShell cmdlet을 ARM 설명합니다. cmdlet은 Microsoft.Azure.Commands.DataLakeStore 네임스페이스에 있습니다. 이러한 cmdlet은 Azure Data Lake Storage Gen1 계정에서만 작동합니다.
...
Data Lake Store에서 파일 또는 폴더의 소유자를 확인합니다.
...
하나 이상의 파일을 조인하여 Data Lake Store에서 하나의 파일을 만들 수 있습니다.
...
Data Lake Store에서 새 파일 또는 폴더를 만듭니다.
...
Data Lake Store에서 파일 또는 폴더의 ACL을 지우습니다.
...
Data Lake Store에서 파일 또는 폴더의 사용 권한 octal을 수정합니다.
