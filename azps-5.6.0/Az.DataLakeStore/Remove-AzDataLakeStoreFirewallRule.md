...
## 설명
**Remove-AzDataLakeStoreFirewallRule** cmdlet은 지정된 Data Lake Store에서 지정된 방화벽 규칙을 제거합니다.
...
계정 "ContosoADL"에서 방화벽 규칙 "MyFirewallRule" 제거

## 매개 변수

### -Account
에서 방화벽 규칙을 업데이트하는 Data Lake Store 계정
...
### -ResourceGroupName
방화벽 규칙을 제거하기 위해 계정을 포함하는 리소스 그룹의 이름을 지정합니다.
