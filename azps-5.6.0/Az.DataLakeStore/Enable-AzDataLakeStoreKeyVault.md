...
## 설명
**Enable-AzDataLakeStoreKeyVault** cmdlet은 사용자가 관리되는 Key Vault에서 지정된 Data Lake Store 계정 암호화를 사용하도록 설정하려고 시도합니다.

## 예제

### 예제 1: ContosoADLS 계정에 Key Vault 사용
```
PS C:\>Enable-AzDataLakeStoreKeyVault -Name "ContosoADLS"
```

이 명령은 ContosoADLS라는 Data Lake Store 계정에 대해 사용자가 관리되는 Key Vault를 사용하도록 설정하려고 시도합니다.

## 매개 변수

### -Account
사용자 관리 Key Vault를 사용하도록 설정하는 Data Lake Store 계정
...
### -ResourceGroupName
계정과 연결된 리소스 그룹의 이름입니다. 지정하지 않으면 검색을 시도합니다.
