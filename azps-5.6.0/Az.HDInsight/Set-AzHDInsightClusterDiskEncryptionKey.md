...
## 설명
지정된 HDInsight 클러스터의 디스크 암호화 키를 회전합니다. 이 작업의 경우 클러스터는 현재 키와 의도한 새 키 모두에 대한 액세스 권한이 있어야 합니다. 그렇지 않으면 회전 키 작업이 실패합니다.
...
[고객 관리 키 디스크 암호화](https://docs.microsoft.com/azure/hdinsight/disk-encryption)
