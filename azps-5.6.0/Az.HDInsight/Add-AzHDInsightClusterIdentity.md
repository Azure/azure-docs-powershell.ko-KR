...
## 설명
**Add-AzHDInsightClusterIdentity** cmdlet은 클러스터 ID를 azure HDInsight 구성 개체에 New-AzHDInsightClusterConfig cmdlet을 추가합니다.
...
이 명령은 클러스터 ID 정보를 your-hadoop-001이라는 클러스터에 추가하여 클러스터가 Azure Data Lake Store에 액세스할 수 있도록 합니다.
