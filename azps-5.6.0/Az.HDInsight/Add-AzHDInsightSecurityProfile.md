...
## 설명
보안 프로필은 커버링하여 보안 클러스터를 만드는 데 사용됩니다.
보안 프로필에는 클러스터를 Active Directory 도메인에 조인하는 구성이 포함됩니다.

## 예제

### 예제 1: 클러스터 구성 개체에 보안 프로필 추가
```
...
이 명령은 your-hadoop-001이라는 클러스터에 보안 프로필 값을 추가합니다.

## 매개 변수

### -ClusterUsersGroupDNS
Ambari 및 Ranger에서 사용할 수 있는 Active Directory 그룹의 고유 이름
...
### -DomainResourceId
클러스터에 대한 Active Directory 도메인 리소스 ID입니다.
...
클러스터를 만들기 위한 충분한 권한이 있는 도메인 사용자 계정 자격 증명입니다.
사용자 이름이 형식이 user@domain 되어야 합니다.
...
### -LdapsUrls
Active Directory에 대한 하나 또는 여러 LDAPS 서버의 URL
...
사용자 및 컴퓨터 계정이 생성되는 Active 디렉터리의 조직 단위의 고유 이름
