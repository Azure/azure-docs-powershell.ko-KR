...
## 설명
**Add-AzHDInsightStorage** cmdlet은 azure HDInsight 구성 개체에 Azure Storage 계정 항목을 New-AzHDInsightClusterConfig cmdlet을 추가합니다.
...
이 명령은 your-hadoop-001이라는 HDInsight 구성에 Blob Storage 계정 항목을 추가합니다.
