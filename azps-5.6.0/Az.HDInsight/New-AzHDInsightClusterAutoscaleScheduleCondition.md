...
## 설명
**New-AzHDInsightClusterAutoscaleScheduleCondition cmdlet은** 일정 기반 자동 크기 조정 조건을 만듭니다.
...
### 예제 2: 자동 조정 조건으로 클러스터의 일정 기반 자동 조정을 사용하도록 설정합니다.
```powershell
...
### -WorkerNodeCount
자동 조정 일정 조건의 일정 작업자 수를 얻거나 설정합니다.
