...
## 설명
**Set-AzHDInsightDefaultStorage** cmdlet은 azure HDInsight 클러스터 구성 개체의 기본 Storage 계정 설정을 New-AzHDInsightClusterConfig cmdlet입니다.
...
새 클러스터에 추가할 저장소 계정에 대한 저장소 계정 이름입니다.
...
### -StorageAccountType
기본 저장소 계정의 형식을 얻거나 설정합니다. AzureStorage 기본값
