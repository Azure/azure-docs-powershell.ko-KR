...
## 설명
공간 앵커 계정의 기본 키 또는 보조 키를 다시 생성합니다.
...
리소스 그룹 "rg1"에서 공간 앵커 계정 "예제"의 보조 키를 다시 생성합니다. 
...
배관을 통해 현재 구독 및 리소스 그룹 "rg1"에서 공간 앵커 계정 "예제"의 보조 키를 다시 생성합니다.
