...
### -OsType
OS 형식을 지정하는 데 사용할 OsType입니다.
Linux 및 Windows에서 선택할 수 있습니다.
Linux의 기본값입니다.
...
ScaleSetEvictionPolicy를 사용하여 우선 순위가 낮은 가상 머신 확장 집합에 대한 eviction 정책을 지정합니다.
기본적으로 삭제합니다.
...
### -ScaleSetPriority
Virtual Machine Scale Set 우선 순위를 지정하는 데 사용할 ScaleSetPriority입니다.
기본값은 일반입니다.
...
### -VmSetType
노드 풀의 유형을 나타내고 있습니다.
가능한 값에는 'VirtualMachineScaleSets', 'AvailabilitySet'이 포함됩니다.
