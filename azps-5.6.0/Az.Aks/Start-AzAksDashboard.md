...
## 설명
관리되는 클러스터의 대시보드에 Kubectl SSH 터널을 생성합니다. SSH 터널은 Kubectl-Tunnel PowerShell 작업에서 설정되고 를 실행하여 찾을 수 `Get-Job` 있습니다. 터널은 을 통해 액세스할 수 [http://127.0.0.1:8001](http://127.0.0.1:8001) 있습니다.

## 예제

### SSH 터널을 시작하고 Kubernetes 대시보드에 브라우저 열기
```
...
### -ListenPort
대시보드에 대한 수신 수신 포트입니다. 기본값은 8003입니다.
