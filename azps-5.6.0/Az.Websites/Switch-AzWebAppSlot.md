...
## 설명
**Switch-AzWebAppSlot은** Azure Web App과 연결된 두 개의 슬롯을 전환합니다.
...
이 명령은 리소스 그룹 Default-Web-WestUS와 연결된 Web App ContosoWebApp "destinationslot"을 사용하여 슬롯 "sourceslot" 슬롯을 전환합니다.
