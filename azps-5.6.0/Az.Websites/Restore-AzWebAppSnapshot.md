...
## 설명
웹앱 스냅숏을 웹앱으로 복원합니다. 스냅숏을 복원하면 스냅숏에 포함된 파일이 포함된 웹앱의 모든 파일을 덮어 덮어 만듭니다. 설정을 복원하려면 RecoverConfiguration 스위치 매개 변수를 사용합니다. 한 웹앱의 스냅숏을 동일한 구독의 다른 웹앱으로 복원할 수 있습니다.
...
"Default-Web-WestUS" 리소스 그룹에 "스테이징"이라는 슬롯이 있는 "ContosoApp"이라는 웹앱의 최신 스냅숏을 얻습니다. 웹앱의 "복원" 슬롯에 스냅숏을 복원합니다.
...
### -Force
경고를 표시하지 않고 원래 웹앱을 덮어 덮어 덮을 수 있습니다.
...
### -UseDisasterRecovery
오프라인인 확장 단위에서 스냅숏을 복구하는 데 사용할 수 있습니다.
