...
## SYNOPSIS
웹앱에 탑재할 Azure Storage 경로를 나타내는 개체를 만듭니다. 매개 변수(-AzureStoragePath)를 사용하여 Set-AzWebApp Set-AzWebAppSlot
...
## 설명
웹앱에 탑재할 Azure Storage 경로를 나타내는 개체를 만듭니다.
...
### -Type
Azure Storage 계정 유형입니다.
Windows 컨테이너는 Azure 파일만 지원
