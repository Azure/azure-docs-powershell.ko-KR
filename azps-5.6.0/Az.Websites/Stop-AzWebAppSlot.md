...
## 설명
**Stop-AzWebAppSlot cmdlet은** Azure Web App Slot을 중지합니다.
...
이 명령은 Default-Web-WestUS라는 리소스 그룹에 속하는 ContosoWebApp이라는 웹앱에 대한 슬롯 슬롯001을 중지합니다.
