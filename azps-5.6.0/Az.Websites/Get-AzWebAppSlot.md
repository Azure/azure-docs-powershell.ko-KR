...
## 설명
**Get-AzWebAppSlot cmdlet은** Azure Web App Slot에 대한 정보를 얻습니다.
...
이 명령은 Resource Group Default-Web-WestUS에 속하는 WebAppStandard라는 웹앱에서 Slot001이라는 슬롯을 얻습니다.
