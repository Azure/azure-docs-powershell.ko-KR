...
## 설명
**Restore-AzWebAppBackup** cmdlet은 Azure Web App Backup을 복원합니다.
...
에 있는 Blob "myBlob"에서 리소스 그룹 Default-Web-WestUS 내에 있는 지정된 앱 ContosoWebApp의 백업을 복원합니다. https://storageaccount.file.core.windows.net

### 예제 2

Restore-AzWebAppBackup cmdlet은 Azure Web App Backup을 복원합니다. (자동 재생)
...
### -AppServicePlan
복원된 앱에 대한 App Service 계획의 이름입니다. 비워 두면 앱의 현재 App Service 계획이 사용됩니다.
...
### -Databases
DatabaseBackupSetting 형식의 데이터베이스[]
