...
## SYNOPSIS
App Service Environment를 제거합니다.
...
## 설명
**Remove-AzAppServiceEnvironment** cmdlet은 App Service 환경을 제거합니다. 모든 App Service 계획은 ASE를 삭제하기 전에 삭제해야 합니다.

## 예제

### 예제 1: App Service Environment 삭제
```powershell
PS C:\> Remove-AzAppServiceEnvironment -ResourceGroupName MyResourceGroup -Name MyAseName
```

App Service Environment 삭제
