...
리소스 그룹 Default-Web-WestUS 내에 있는 지정된 앱 ContosoWebApp에 대해 SqlAzure 형식의 데이터베이스 백업 설정(연결 문자열)을 만듭니다.

### 예제 2

New-AzWebAppDatabaseBackupSetting cmdlet은 새 Azure Web App Backup 설정을 만듭니다. (자동 재생)
