...
에서 리소스 그룹 Default-Web-WestUS 내에 있는 지정된 앱 ContosoWebApp의 백업을 만듭니다. https://storageaccount.file.core.windows.net

### 예제 2

New-AzWebAppBackup cmdlet은 Azure Web App Backup을 만듭니다. (자동 재생)
