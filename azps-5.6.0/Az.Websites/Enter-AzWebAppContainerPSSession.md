...
## SYNOPSIS
지정된 사이트 또는 슬롯 및 지정된 리소스 그룹에 지정된 Windows 컨테이너에 원격 PowerShell 세션 열기
...
## 설명
지정된 사이트 또는 슬롯 및 지정된 리소스 그룹에 지정된 Windows 컨테이너로 원격 PowerShell 세션을 니다.
...
이 명령은 원격 PowerShell 세션을 Windows 컨테이너 앱 ContosoASP로 열립니다.
