...
테넌트 범위에 배포를 추가하기 위해 위치 및 템플릿을 지정합니다.
...
이 명령은 정의된 태그 매개 변수를 사용하여 디스크의 사용자 지정 템플릿 및 템플릿 파일을 사용하여 현재 테넌트 범위에 새 배포를 만듭니다.
...
이 명령은 메모리 내 해시테이블로 변환된 디스크의 사용자 지정 템플릿 및 템플릿 파일을 사용하여 현재 테넌트에 새 배포를 만듭니다.
