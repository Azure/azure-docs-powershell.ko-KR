...
## 설명
Remove-AzADAppCredential cmdlet은 손상된 경우 또는 자격 증명 키 롤오버 만료의 일부로 애플리케이션에서 자격 증명 키를 제거하는 데 사용할 수 있습니다.
...
개체 ID '7663d3fb-6f86-4352-9e6d50d-cf9d50d5ee82'를 사용하여 애플리케이션에서 키 ID '904423-60a3-45a3-450d5ee82'로 자격 증명을 제거합니다.
...
애플리케이션 ID '4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58'을 사용하여 애플리케이션에서 모든 자격 증명을 제거합니다.

### 예제 3: 배관을 사용하여 모든 자격 증명 제거

```powershell
PS C:\> Get-AzADApplication -ObjectId 7663d3fb-6f86-4352-9e6d-cf9d50d5ee82 | Remove-AzADAppCredential
```

개체 ID '7663d3fb-6f86-4352-9e6d-cf9d50d5ee82'를 사용하여 애플리케이션을 Remove-AzADAppCredential cmdlet에 연결하고 해당 애플리케이션에서 모든 자격 증명을 제거합니다.
...
### -KeyId
제거할 자격 증명 키를 지정합니다.
애플리케이션에 대한 키 ID는 cmdlet을 사용하여 Get-AzADAppCredential 수 있습니다.
