...
## 설명
기존 Azure Active Directory 서비스 주체가 업데이트됩니다. 이 서비스 주체와 연결된 자격 증명을 업데이트하기 위해 New-AzADSpCredential cmdlet을 사용하시기 바랍니다. 기본 애플리케이션과 연결된 속성을 업데이트하기 위해 Update-AzADApplication cmdlet을 사용하시기 바랍니다.
...
'784136ca-3ae2-4fdd-a388-89d793e7c780'을 'MyNewDisplayName'로 서비스 주체의 표시 이름을 업데이트합니다.

### 예제 2: 배관을 사용하여 서비스 주체의 표시 이름 업데이트

```powershell
PS C:\> Get-AzADServicePrincipal -ObjectId 784136ca-3ae2-4fdd-a388-89d793e7c780 | Update-AzADServicePrincipal -DisplayName MyNewDisplayName
```

개체 ID '784136ca-3ae2-4fdd-a388-89d793e7c780' 및 서비스 주체의 표시 이름을 "MyNewDisplayName"로 업데이트하기 위해 Update-AzADServicePrincipal cmdlet에 있는 파이프를 사용합니다.

### 예제 3

기존 Azure Active Directory 서비스 주체가 업데이트됩니다. (자동 재생)
