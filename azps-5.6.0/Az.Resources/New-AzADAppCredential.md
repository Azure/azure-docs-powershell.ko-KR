...
## 설명
New-AzADAppCredential cmdlet을 사용하여 새 자격 증명을 추가하거나 애플리케이션에 대한 자격 증명을 롤링할 수 있습니다.
애플리케이션은 애플리케이션 개체 ID 또는 애플리케이션 ID를 제공하여 식별됩니다.

## 예제

### 예제 1 - 암호를 사용하여 새 애플리케이션 자격 증명 만들기
...
개체 ID '1f89cf81-0146-4f4e-beae-2007d0668416'을 사용하여 기존 애플리케이션에 새 암호 자격 증명이 추가됩니다.

### 예제 2 - 인증서를 사용하여 새 애플리케이션 자격 증명 만들기
...
제공된 base64 인코딩된 공용 X509 인증서("myapp.cer")는 애플리케이션 ID '4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58'을 통해 기존 애플리케이션에 추가됩니다.

### 예제 3 - 배관을 사용하여 새 애플리케이션 자격 증명 만들기
...
개체 ID '1f89cf81-0146-4f4e-beae-2007d0668416'을 사용하여 애플리케이션을 New-AzADAppCredential 암호로 해당 애플리케이션에 대한 새 애플리케이션 자격 증명을 만듭니다.

## 매개 변수

### -ApplicationId
자격 증명을 추가할 애플리케이션의 애플리케이션 ID입니다.
...
### -CertValue
"비대칭" 자격 증명 형식의 값입니다. 기본 64 인코딩된 인증서를 나타내고 있습니다.
...
### -EndDate
자격 증명 사용의 유효 종료 날짜입니다. 기본 종료 날짜 값은 오늘부터 1년입니다.  "비대칭" 형식 자격 증명의 경우 X509 인증서가 유효한 날짜 또는 이전으로 설정해야 합니다.
