...
이 예제에서는 구독 ID에 대해 자리 1개 값을 사용 합니다.
...
이 cmdlet이 제거한 리소스의 확장 리소스 이름을 지정합니다.
...
### -ResourceId
이 cmdlet이 제거한 리소스의 완전히 자격을 갖춘 리소스 ID를 지정합니다.
