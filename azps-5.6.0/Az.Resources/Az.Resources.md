...
# Az.Resources 모듈
## 설명
이 항목에서는 Azure Resource Manager Cmdlet에 대한 도움말 항목을 제공합니다.
...
기본적으로 선택한 Azure 구독의 모든 거부 할당을 나열합니다.
각 매개 변수를 사용하여 특정 사용자에게 거부 할당을 나열하거나 특정 리소스 그룹 또는 리소스에 거부 할당을 나열합니다.
...
구독 범위에서 ARM What-If 결과를 얻을 수 있습니다. 
...
관리 그룹 ARM 배포에 대한 What-If 템플릿을 제공합니다. 
...
리소스 ARM 범위에서 What-If 대한 기본 템플릿 결과를 얻습니다. 
...
각 매개 변수를 사용하여 특정 사용자에게 할당을 나열하거나 특정 리소스 그룹 또는 리소스에 할당을 나열합니다.

### [Get-AzRoleDefinition](Get-AzRoleDefinition.md)
할당에 사용할 수 있는 모든 Azure RBAC 역할을 나열합니다.

### [Get-AzTag](Get-AzTag.md)
미리 정의된 Azure 태그를 | 리소스 또는 구독에서 전체 태그 집합을 얻습니다.
...
지정된 범위의 지정된 주체에 지정된 RBAC 역할을 할당합니다.
...
Azure RBAC에서 사용자 지정 역할을 삭제합니다.
삭제할 역할은 역할의 ID 속성을 사용하여 지정됩니다.
사용자 지정 역할에 대한 기존 역할 할당이 있는 경우 삭제가 실패합니다.
...
리소스 공급자 등록을 등록하지 않습니다.

### [Update-AzADApplication](Update-AzADApplication.md)
기존 Azure Active Directory 애플리케이션을 업데이트합니다.

### [Update-AzADServicePrincipal](Update-AzADServicePrincipal.md)
기존 Azure Active Directory 서비스 주체가 업데이트됩니다.
