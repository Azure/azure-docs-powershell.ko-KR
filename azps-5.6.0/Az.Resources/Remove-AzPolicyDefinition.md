...
## 설명
**Remove-AzPolicyDefinition** cmdlet은 정책 정의를 제거합니다.

## 예제

### 예제 1: 이름에 따라 정책 정의 제거
```
PS C:\> Remove-AzPolicyDefinition -Name 'VMPolicyDefinition'
```

이 명령은 지정된 정책 정의를 제거합니다.

### 예제 2: 리소스 ID로 정책 정의 제거
```
...
명령은 이 변수를 $PolicyDefinition 저장합니다.
두 번째 명령은 리소스의 **ResourceId** 속성에 의해 식별된 정책 정의를 $PolicyDefinition.
...
### -Id
이 cmdlet이 제거하는 정책 정의에 대해 완전히 자격을 갖춘 리소스 ID를 지정합니다.
...
### -InputObject
다른 cmdlet에서 출력된 정책을 제거할 정책 정의 개체입니다.
...
### -Name
이 cmdlet이 제거하는 정책 정의의 이름을 지정합니다.
