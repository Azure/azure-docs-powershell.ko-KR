...
## 설명
**New-AzManagedApplication** cmdlet은 Azure 관리 애플리케이션을 만듭니다.
...
### -매개 변수
관리되는 애플리케이션에 대한 매개 변수의 JSON 형식 문자열입니다.
매개 변수를 포함하는 파일 이름 또는 uri에 대한 경로 또는 매개 변수를 문자열로 사용할 수 있습니다.
