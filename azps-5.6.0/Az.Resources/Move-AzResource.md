...
첫 번째 명령은 contosoStorageAccount라는 리소스를 Get-AzResource cmdlet을 사용한 다음 해당 $Resource 저장합니다.
두 번째 명령은 리소스 그룹인 ResourceGroup14로 이동합니다.
명령은 리소스의 **ResourceId** 속성을 사용하여 이동할 리소스를 $Resource.
...
### -ResourceId
이 cmdlet이 이동하는 리소스의 아이디 배열을 지정합니다.
