...
### 예제 2: 주어진 ProviderNamespace에서 모든 리소스 공급자 세부 정보 확인
...
이 명령은 "Microsoft.Compute"에서 모든 리소스 공급자를 얻습니다.

### 예제 3: 주어진 ProviderNamespace 배열에서 모든 리소스 공급자 세부 정보 얻습니다.
...
이 명령은 "Microsoft.Compute" 및 "Microsoft.Network"에서 모든 리소스 공급자를 얻습니다.
...
### -ListAvailable
이 작업은 사용 가능한 모든 리소스 공급자를 얻게 됐습니다.
