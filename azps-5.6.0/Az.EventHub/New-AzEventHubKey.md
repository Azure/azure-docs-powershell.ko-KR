...
## 설명
New-AzEventHubKey cmdlet은 지정된 Event Hubs 권한 부여 규칙에 대한 기본 또는 보조 SAS 키를 다시 생성합니다.
...
권한 부여 규칙 \` MyAuthRuleName의 기본 키를 다시 \` 생성합니다.
...
권한 부여 규칙 \` MyAuthRuleName의 보조 키를 다시 \` 생성합니다.
