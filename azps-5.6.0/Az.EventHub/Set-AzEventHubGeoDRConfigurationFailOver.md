...
## 설명
**Set-AzEventHubGeoDRConfigurationFailOver** cmdlet은 GEO DR 장애 조치(failover)를 호출하고 보조 네임스페이스를 지적하기 위해 별칭을 다시 구성합니다.
...
"SampleDRConfigName"을 통해 장애 조치(Failover)를 호출하고 보조 네임스페이스 "SampleNamespace_Secondary"
