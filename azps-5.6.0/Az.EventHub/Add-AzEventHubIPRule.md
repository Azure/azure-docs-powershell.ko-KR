...
```
이름 : defaultAction : Id 허용 : /subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.Eventhub/namespaces/eventhub-Namespaces/default Type : Microsoft.Eventhub/Namespaces/NetworkRuleSet IpRules : {11.22.33.4, Allow} VirtualNetworkRules : 

IPMask "11.22.33.44"와 주어진 네임스페이스에 대한 작업 허용을 사용하여 IPRule을 추가합니다.
