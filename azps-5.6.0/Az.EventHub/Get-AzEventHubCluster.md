...
## SYNOPSIS
단일 Event Hub 클러스터의 세부 정보를 얻거나 Event Hub 클러스터 목록을 얻습니다.
...
## 설명
Get-AzEventHubCluster cmdlet은 Event Hub 클러스터의 세부 정보 또는 주어진 리소스 그룹의 모든 Event Hub 클러스터 목록을 반환합니다.
...
리소스 그룹 'RSG-Cluster27651'에서 클러스터 'Eventhub-Cluster-5557'의 부수적을 반환합니다.
