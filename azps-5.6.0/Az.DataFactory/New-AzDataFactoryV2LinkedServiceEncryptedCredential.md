...
## 설명
New-AzDataFactoryV2LinkedServiceEncryptedCredential 런타임이 지정된 연결된 서비스에서 자격 증명을 암호화합니다.

다음 전제가 충족되도록 합니다.
* **자체 호스팅** 통합 런타임에서 원격 액세스 옵션이 활성화됩니다.
...
이 명령은 test-selfhost-ir이라는 C:\samples\WikiSample\TaxiDemo1.js런타임으로 파일에서 자격 증명을 암호화합니다.
