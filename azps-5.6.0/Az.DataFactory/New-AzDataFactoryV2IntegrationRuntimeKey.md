...
## 설명
cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey는** 'KeyName' 매개 변수에 의해 지정된 키 이름으로 통합 런타임 키를 다시 생성합니다. 이전 키가 잘못되었습니다.

## 예제

### 예제 1: 통합 런타임에 대한 새 키 생성
```
...
cmdlet은 'test-selfhost-ir'이라는 통합 런타임에 대한 키 'authKey2'를 다시 생성합니다.
