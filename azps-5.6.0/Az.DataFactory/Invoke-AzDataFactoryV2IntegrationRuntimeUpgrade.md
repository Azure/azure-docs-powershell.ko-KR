...
## 설명
**Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** cmdlet은 새 버전을 사용할 수 있는 경우 자체 호스팅 통합 런타임을 업그레이드합니다.
...
cmdlet은 데이터 팩터리 'test-df-eu2'에서 'test-selfhost-ir'이라는 자체 호스팅 통합 런타임을 업그레이드합니다.
