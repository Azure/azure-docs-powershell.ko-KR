...
## 설명
Get-AzDataFactoryV2Pipeline cmdlet은 Azure Data Factory의 파이프라인에 대한 정보를 얻습니다.
...
### 예제 4: 첫 번째 활동에 대한 입력에 대한 정보 얻습니다.
```powershell
...
이 명령은 WikiADF라는 데이터 팩터리에서 DPWikisample이라는 파이프라인에 대한 정보를 얻은 다음, 표준 점표를 사용하여 해당 파이프라인과 연결된 활동 속성을 볼 수 있습니다.
명령은 cmdlet을 사용하여 활동 배열의 첫 번째 요소의 Inputs 속성을 Format-List 표시됩니다.
