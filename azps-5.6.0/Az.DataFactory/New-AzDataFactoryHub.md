...
허브를 만든 후 허브를 사용하여 그룹에서 연결된 서비스를 저장하고 관리할 수 있으며 허브에 파이프라인을 추가할 수 있습니다.
...
### -File
허브에 대한 설명이 포함된 JSON(JavaScript 개체 표기)파일의 전체 경로를 지정합니다.
...
### -Force
확인을 요청하지 않고 이 cmdlet이 기존 허브를 대체합니다.
