...
## 설명
Set-AzDataFactoryV2DataFlow cmdlet은 Azure Data Factory에서 데이터 흐름을 만들거나 기존 데이터 흐름을 업데이트합니다.
...
이 명령은 WikiADF라는 데이터 팩터리에서 TaxiDemo1이라는 데이터 흐름을 만듭니다.
명령은 파일에서 데이터 흐름을 TaxiDemo1.js기반입니다.
