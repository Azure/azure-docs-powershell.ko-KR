...
현재 WaitingOnDependency 상태의 TumblingWindowTriggers에만 지원됩니다.
...
이 명령은 팩터리 WikiADF에서 '085860024680058884970724879CU16'을 사용하여 트리거 실행을 중지합니다.
...
### -PassThru
cmdlet 쓰기를 지정한 경우 작업이 성공하는 경우 true입니다.
