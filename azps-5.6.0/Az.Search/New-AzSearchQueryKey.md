...
## 설명
**New-AzSearchQueryKey** cmdlet은 Azure Cognitive Search 서비스에 대한 새 쿼리 키를 만듭니다.
...
이 예제에서는 Azure Cognitive Search 서비스에 대한 새 쿼리 키를 만듭니다.
...
### -Name
Azure Cognitive Search Service 쿼리 키 이름입니다.
