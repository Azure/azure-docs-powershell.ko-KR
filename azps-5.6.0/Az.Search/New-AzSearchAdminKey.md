...
## 설명
**New-AzSearchAdminKey** cmdlet은 Azure Cognitive Search 서비스의 관리자 키를 다시 생성합니다.
...
이 예제에서는 Azure Cognitive Search 서비스의 기본 키를 다시 생성합니다.
...
### -KeyKind
Azure Cognitive Search Service 관리자 키 종류(주/보조)
