...
## 설명
**Set-AzSearchPrivateEndpointConnection은** Azure Cognitive Search 서비스에 대한 개인 엔드포인트 연결을 업데이트합니다.
...
이 예제에서는 Azure Cognitive Search 서비스의 개인 엔드포인트 연결 상태를 "거부"로 업데이트합니다.
