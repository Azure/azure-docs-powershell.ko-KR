...
이 두 번째 명령은 ResourceGroup123이라는 리소스 그룹에 속하는 MediaService001이라는 미디어 서비스를 변수에 $Tags 업데이트합니다.
또한 명령은 변수에 저장된 스토리지 구성 개체의 배열을 $StorageAccounts 사용합니다.
...
### -StorageAccounts
이 cmdlet이 미디어 서비스에 연결된 저장소 계정의 배열을 지정합니다.
