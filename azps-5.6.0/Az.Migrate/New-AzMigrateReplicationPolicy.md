...
복제ProviderSettings.
생성을 위해 PROVIDERSPECIFICINPUT 속성에 대한 노트 섹션을 참조하고 해시 테이블을 만드십시오.
...
PROVIDERSPECIFICINPUT <IPolicyProviderSpecificInput> : 복제ProviderSettings.
