...
그러면 프로젝트의 모든 작업이 얻습니다.

### 예제 3: 리소스 그룹, 프로젝트 및 작업 이름 사용
```powershell
...
INPUTOBJECT : 복제 서버의 작업 <IJob> 개체를 지정합니다.
  - `[Location <String>]`: 리소스 위치
  - `[ActivityId <String>]`: 활동 ID입니다.
  - `[AllowedAction <String[]>]`: 작업이 허용된 작업입니다.
  ...
  - `[Error <IJobErrorDetails[]>]`: 오류입니다.
    ...
    - `[ProviderErrorDetailRecommendedAction <String>]`: 오류를 해결하는 권장 작업입니다.
    ...
    - `[ServiceErrorDetailRecommendedAction <String>]`: 오류를 해결하는 권장 작업입니다.
    - `[TaskId <String>]`: 작업의 ID입니다.
  - `[FriendlyName <String>]`: DisplayName입니다.
  - `[ScenarioName <String>]`: 시나리오 이름입니다.
  - `[StartTime <DateTime?>]`: 시작 시간입니다.
  - `[State <String>]`: 작업의 상태입니다. NotStarted, InProgress, 성공, 실패, 취소, 일시 중단 또는 기타 값 중 하나입니다.
  - `[StateDescription <String>]`: 작업의 상태 설명입니다. 예를 들어 - 성공 상태의 경우 설명을 완료하거나 부분적으로, 완료된WithInformation 또는 건너뜁니다.
  - `[TargetInstanceType <String>]`: {Microsoft.Azure.SiteRecovery.V2015_11_10.AffectedObjectType} 클래스의 영향을 받는 개체의 형식입니다.
  ...
  - `[Task <IAsrTask[]>]`: 작업입니다.
    ...
    - `[StartTime <DateTime?>]`: 시작 시간입니다.
    - `[State <String>]`: 상태입니다. NotStarted, InProgress, 성공, 실패, 취소, 일시 중단 또는 기타 값 중 하나입니다.
    - `[StateDescription <String>]`: 작업 상태 설명입니다. 예를 들어 성공 상태의 경우 설명을 완료, 부분적으로, CompletedWithInformation 또는 건너뜁니다.
    - `[TaskId <String>]`: Id입니다.
    - `[TaskType <String>]`: 작업 유형입니다. CustomDetails 속성의 세부 정보는 이 형식에 따라 다릅니다.
