...
### -TurnOffSourceServer
마이그레이션 후 원본 서버를 해제해야 하는지 여부를 지정합니다.
...
INPUTOBJECT : 마이그레이션을 시작해야 하는 복제 <IMigrationItem> 서버를 지정합니다. 서버 개체는 cmdlet을 사용하여 Get-AzMigrateServerReplication 수 있습니다.
