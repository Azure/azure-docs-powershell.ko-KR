...
### -ProjectName
현재 구독에서 Azure Migrate 프로젝트를 지정합니다.
...
INPUTOBJECT : 복제 서버의 <IMigrationItem> 컴퓨터 개체를 지정합니다.
