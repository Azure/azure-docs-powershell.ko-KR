...
이름으로 마이그레이션 프로젝트에서 서버를 얻습니다.
이름은 서버에 대한 고유 패러멘터입니다.
...
마이그레이션 프로젝트의 서버를 나열하고 표시 이름을 사용하여 응답을 필터링합니다.

### 예제 6: 어플라이언스에 나열하고 표시 이름으로 필터링
```powershell
...
마이그레이션 프로젝트에서 어플라이언스에 대한 서버를 나열하고 표시 이름을 사용하여 응답을 필터링합니다.

## 매개 변수

### -applianceName
어플라이언스 이름을 지정합니다.
이 맵은 사이트에 내부적으로 매핑됩니다.
