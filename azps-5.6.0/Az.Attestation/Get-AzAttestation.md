...
## 설명
Get-AzAttestation cmdlet은 구독의 확인에 대한 정보를 얻습니다.
...
리소스 그룹 *psh-test-rg에서* 테스트 공급자 *pshtest를* 얻습니다.
...
사용 가능한 모든 Attestation 기본 공급자를 얻습니다.
...
### -ResourceGroupName
는 Queriation과 연결된 리소스 그룹의 이름을 지정합니다.
