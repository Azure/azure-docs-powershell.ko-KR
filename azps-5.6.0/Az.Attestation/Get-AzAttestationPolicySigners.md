...
## 설명
Get-AzAttestationPolicySigners cmdlet은 Azure Attestation의 테넌트에서 신뢰할 수 있는 정책 서명자입니다.
...
리소스 그룹 *psh-test-rg에서* 테스트 공급자 *pshtest에* 대한 신뢰할 수 있는 정책 서명자를 얻습니다.  이 Attestation 공급자에 대한 신뢰할 수 있는 서명자는 없습니다.
...
리소스 그룹 *psh-test-rg에서* 테스트 공급자 *pshtest2에* 대한 신뢰할 수 있는 정책 서명자를 얻습니다.  이 Attestation 공급자에 대한 신뢰할 수 있는 서명자가 하나 있습니다.
...
미국 중부 위치의 Attestation 기본 공급자에 대한 신뢰할 수 있는 정책 *서명자를 얻습니다.*  Attestation 기본 공급자에 대한 신뢰할 수 있는 서명자는 없습니다.
