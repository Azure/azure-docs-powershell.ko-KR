...
Tee 형식 *SgxEnclave에* 대한 Attestation Provider *pshtest에* 대한 정책을 을 을 를 를 사용합니다.
...
Tee 형식 *SgxEnclave에* 대한 *영국* 남부 위치에서 Attestation 기본 공급자에 대한 정책을 얻습니다.
...
### -Name
테넌트의 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 테넌트에 대한 설명 정책을 제공합니다.
