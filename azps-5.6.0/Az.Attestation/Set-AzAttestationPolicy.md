...
텍스트 정책 형식(기본값)을 사용하여 TEE 형식 *SgxEnclave for Atest* 공급자 *pshtest에* 대해 사용자 정의 정책을 설정합니다.
...
JWT 정책 형식을 사용하여 TEE 형식 *SgxEnclave* forTest Provider *pshtest에* 대한 사용자 정의 정책을 설정합니다.
...
### -PolicyFormat
텍스트 또는 JWT(JSON 웹 토큰)의 정책 형식을 지정합니다.  기본 정책 형식은 Text입니다.
