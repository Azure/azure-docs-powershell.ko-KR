...
## 설명
**Remove-AzDeploymentManagerStep** cmdlet은 단계를 삭제합니다.
...
이 명령은 ContosoResourceGroup에서 ContosoService1WaitStep이라는 단계를 삭제합니다.

### 예제 2: 리소스 식별자를 사용하여 단계 제거
```powershell
...
### 예제 3: 개체가 반환한 개체를 사용하여 단계를 New-AzDeploymentManagerStep
### 예제 1
```powershell
PS C:\> Remove-AzDeploymentManagerStep -InputObject $stepObject
```

 이 명령은 이름과 ResourceGroup이 각각 해당 명령의 이름 및 ResourceGroupName 속성과 일치하는 $stepObject 삭제합니다.
