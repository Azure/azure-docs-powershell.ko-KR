...
필수 키: UrlTemplate입니다.
선택적 키: HubPattern, EventPattern, CategoryPattern입니다.
splatting 구문을 사용하여 템플릿 매개 변수를 전달하는 예제: @{UrlTemplate=' http://host-connections1.com ', HubPattern= 'chat'; EventPattern='broadcast' },@{URLTemplate=' http://host-connections2.com '}
...
[Splatting을 사용하여 PowerShell에서 명령에 매개 변수를 전달하는 방법](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
