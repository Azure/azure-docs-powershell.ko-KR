...
## 설명
**Get-AzCosmosDBSqlContainer** cmdlet은 주어진 ResourceGroupName, AccountName 및 DatabaseName에 대한 모든 기존 CosmosDB Sql Container의 목록을 구하고, 주어진 ResourceGroupName, AccountName, DatabaseName 및 ContainerName에 대한 단일 CosmosDB Sql Container를 얻습니다.
