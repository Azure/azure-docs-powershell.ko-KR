...
## SYNOPSIS
PSSpatialSpec 형식의 새 개체를 만듭니다. Set-AzCosmosDBSqlIndexingPolicy의 매개 변수 값으로 전달할 수 있습니다.
...
## 설명
Sql API의 SpatialSpec에 해당하는 개체를 만듭니다.
...
### -Type
허용 가능한 값이 있는 문자열 배열: 점, LineString, Polygon, MultiPolygon입니다.
공간 형식을 나타내는 경로입니다.
