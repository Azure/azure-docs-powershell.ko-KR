...
## SYNOPSIS
CosmosDB Cassandra 키스페이스를 얻습니다.
...
## 설명
**Get-AzCosmosDBCassandraKeyspace** cmdlet은 기존 CosmosDB Cassandra 키스페이스를 새로 생성하거나 업데이트합니다.
...
Get-AzCosmosDBCassandraKeyspace CassandraKeyspace의 속성을 얻습니다. 리소스를 확장하여 _etag, _ts _rid 수 있습니다.
