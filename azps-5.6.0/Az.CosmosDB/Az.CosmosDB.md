...
# Az.CosmosDB 모듈
## 설명
이 섹션의 항목에서는 Azure Resource Manager(azure Resource Manager) 프레임워크의 Azure CosmosDB용 Azure PowerShell cmdlet을 ARM 설명합니다. cmdlet은 Microsoft.Azure.Commands.CosmosDB 네임스페이스에 있습니다.
...
PSVirtualNetworkRule 형식의 새 로컬 개체를 만듭니다. 
