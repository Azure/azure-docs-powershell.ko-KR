...
## SYNOPSIS
CosmosDB Cassandra Table을 삭제합니다.
...
## 설명
**Remove-AzCosmosDBCasandraTable은** CosmosDB Cassandra 테이블을 삭제합니다.
...
cmdlet은 삭제가 성공한 경우 true인 형식 bool(-PassThru가 전달될 때)의 개체를 반환합니다.
