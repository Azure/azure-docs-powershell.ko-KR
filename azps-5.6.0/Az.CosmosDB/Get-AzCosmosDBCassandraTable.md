...
## SYNOPSIS
CosmosDB Cassandra Table을 얻습니다.
...
## 설명
**Get-AzCosmosDBCassandraTable** cmdlet은 기존 CosmosDB Cassandra 키스페이스를 새로 생성하거나 업데이트합니다.
...
{{ Get-AzCosmosDBCassandraTable CassandraKeyspace의 속성을 얻습니다. Resource를 확장하여 DefaultTtl, Schema, _etag, _ts _rid 있습니다.}}
