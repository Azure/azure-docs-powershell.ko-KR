...
## SYNOPSIS
PSCompositePath 형식의 새 개체를 만듭니다. Set-AzCosmosDBGremlinGraph의 매개 변수 값으로 전달할 수 있습니다.
...
## 설명
Gremlin API의 CompositePath에 해당하는 개체입니다.
...
### -Order
복합 경로에 대한 정렬 순서를 얻거나 설정합니다.
가능한 값은 다음과 같습니다. '오르기', '내선'
