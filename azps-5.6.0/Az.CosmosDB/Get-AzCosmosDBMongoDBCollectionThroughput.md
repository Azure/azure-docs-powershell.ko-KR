...
## SYNOPSIS
MongoDB 컬렉션의 CosmosDB의 데이터당 속성을 얻습니다.
...
## 설명
**Get-AzCosmosDBMongoDBCollectionThroughput** cmdlet은 MongoDB Collection의 프로퍼티를 얻습니다.
...
### -InputObject
그런 다음 제공된 경우 cmdlet은 해당 처리률 값으로 컬렉션을 반환합니다.
