...
## 설명
**Get-AzCosmosDBMongoDBCollection** cmdlet은 CosmosDB MongoDB 컬렉션을 얻습니다.
...
리소스 개체에는 MongoIndexes, _rid, _ts _etag 속성이 포함되어 있습니다.
...
이 예제에서는 검색된 컬렉션의 ShardKey를 가져온다.
