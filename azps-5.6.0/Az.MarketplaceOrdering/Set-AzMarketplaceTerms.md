...
## 설명
**Set-AzMarketplaceTerms** cmdlet은 주어진 게시자 ID(Publisher), 제품 ID(제품) 및 계획 ID(이름) 튜플에 대한 용어 개체를 저장합니다.

## 예제

### 예제 1
마켓플레이스 퍼블리셔 계약을 얻게 됩니다.
...
### 예제 2
게시자 계약을 '수락'으로 설정합니다. 'Get-AzMarketplaceTerms' cmdlet에서 'Terms' 매개 변수의 값을 얻습니다.
...
### -InputObject
Get-AzMarketplaceTerms cmdlet에서 반환되는 용어 개체입니다. 수락 매개 변수가 true인 경우 필수 매개 변수입니다.
