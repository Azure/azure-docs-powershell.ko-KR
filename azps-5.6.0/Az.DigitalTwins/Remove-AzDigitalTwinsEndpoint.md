...
### 예제 1: EndPointName에 의해 azDigitalTwinsEndPoint 삭제
```powershell
...
EndPointName ResourceGroupName 및 ResourceName에 의해 azDigitalTwinsEndPoint 삭제

### 예제 2: 개체에 따라 azDigitalTwinsEndPoint 삭제
```powershell
...
개체에 따라 azDigitalTwinsEndPoint 삭제
