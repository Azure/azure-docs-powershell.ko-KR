...
### -사용하도록 설정
값이 true이면 인증서를 사용하도록 설정합니다.
값이 false인 경우 인증서를 사용하지 않도록 설정합니다.
지정하지 않으면 인증서의 사용 가능/사용 안 함 상태의 기존 값은 변경되지 않습니다.
...
이 스위치가 지정되어 있는 경우 인증서 개체를 반환합니다.
