...
## 설명
**Get-AzKeyVaultCertificateIssuer** cmdlet은 Azure Key Vault의 키 자격 증명 모음에 대해 지정된 인증서 발급자 또는 모든 인증서 발급자 를 얻습니다.
...
이 명령은 TestIssuer01이라는 인증서 발급자 를 얻습니다.
...
이 명령은 "test"로 시작하는 인증서 발급자 를 얻습니다.
