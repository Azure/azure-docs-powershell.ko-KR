...
이 명령은 지정된 IP 범위 및 가상 네트워크에 대해 'myVault'라는 자격 증명 모음의 네트워크 규칙 모음을 업데이트하여 Azure 서비스에 대한 네트워크 규칙을 우회할 수 있습니다.

### 예제 2

키 자격 증명 모음에 설정된 네트워크 규칙을 업데이트합니다. (자동 재생)
...
### -IpAddressRange
허용되는 네트워크 IP 주소 범위의 네트워크 규칙을 지정합니다.
...
이 스위치가 지정되어 있는 경우 업데이트된 키 자격 증명 모음 개체를 반환합니다.
