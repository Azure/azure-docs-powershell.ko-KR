...
## 설명
명령을 `New-AzKeyVaultRoleAssignment` 사용하여 액세스 권한을 부여합니다.
...
할당되는 역할은 RoleDefinitionName pr RoleDefinitionId 매개 변수를 사용하여 지정해야 합니다. 액세스가 부여되는 범위를 지정할 수 있습니다. 기본값은 선택한 구독입니다.
...
이 예제에서는 "관리되는 HSM 정책 관리자"를 사용자 "에 최상위 범위에 user1@microsoft.com 할당합니다.
