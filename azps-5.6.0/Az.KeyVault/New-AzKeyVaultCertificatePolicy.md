...
### -DnsName
인증서에 DNS 이름을 지정합니다. 주체 대체 이름(SANS)을 DNS 이름으로 지정할 수 있습니다.
...
### -EmailAtNumberOfDaysBeforeExpiry
자동 알림 프로세스가 시작되기 전의 일 수를 지정합니다.
...
> [!NOTE]
> 매개 변수의 속성 내에서 콤마(,) 또는 마침표(.)를 사용해야 하는 경우 속성 필드를 인용 부호로 `SubjectName` 묶아야 합니다. 예를 들어 O="Contoso, Ltd"를 사용할 수 있습니다. 조직 이름 필드에 있습니다.
...
### System.Collections.Generic.List'1[[System.Security.Cryptography.X509KeyUsageFlags, System.Security.Cryptography.X509Certificates, Version=4.2.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a]]
