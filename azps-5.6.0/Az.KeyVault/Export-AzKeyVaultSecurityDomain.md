...
이 명령은 testmhsm이라는 관리되는 HSM을 검색하고 관리되는 HSM 보안 도메인의 백업을 지정된 출력 파일에 저장합니다.
...
### -쿼럼
복구를 위해 보안 도메인을 암호 해독하는 데 필요한 최소 공유 수입니다.
