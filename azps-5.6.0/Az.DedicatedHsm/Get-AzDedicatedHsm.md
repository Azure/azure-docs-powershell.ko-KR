...
이 명령은 구독에서 모든 전용 HSM을 얻습니다.

### 예제 2: 리소스 그룹에서 모든 전용 HSM을 얻습니다.
```powershell
...
이 명령은 리소스 그룹 아래에서 모든 전용 HSM을 얻습니다.

### 예제 3: 이름에 의해 전용 HSM을 얻습니다.
```powershell
...
이 명령은 이름으로 전용 HSM을 얻습니다.

### 예제 4: 개체에 따라 전용 HSM을 얻습니다.
```powershell
