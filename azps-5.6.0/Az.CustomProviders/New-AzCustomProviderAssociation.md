...
사용자 지정 공급자 연결 만들기, 연결된 대상 provioder는 "연결" 경로로 올바르게 구성되어야 합니다.
...
예를 들어 가상 머신 리소스에 대해 '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{vm-name}'을 사용하세요.
