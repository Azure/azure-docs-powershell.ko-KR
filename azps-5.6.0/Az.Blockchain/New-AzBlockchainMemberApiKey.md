...
### 예제 1: 이름을 사용하여 블록체인 멤버에 대한 Api 키를 다시 생성합니다.
```powershell
...
이 명령은 이름, 리소스 그룹을 사용하여 블록체인 멤버에 대한 Api 키를 다시 생성합니다.

### 예제 2: ID를 사용하여 블록체인 멤버에 대한 Api 키를 다시 생성합니다.
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
이 명령은 ID를 사용하여 블록체인 멤버에 대한 Api 키를 다시 생성합니다.
