...
## 설명
**Remove-AzHpcCacheStorageTarget** cmdlet은 Azure HPC Cache에서 저장소 대상을 제거합니다.
...
### -Force
cmdlet에서 확인을 묻는 메시지가 표시되지 않는다는 의미입니다. 기본적으로 이 cmdlet은 저장소 대상을 제거하려는지 확인하라는 메시지를 표시합니다.
