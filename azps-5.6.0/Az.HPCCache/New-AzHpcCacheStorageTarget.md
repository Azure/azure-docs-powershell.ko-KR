...
## 설명
**New-AzHpcCacheStorageTarget** cmdlet은 Azure HPC Cache에 저장소 대상을 추가합니다.
...
### -Force
cmdlet에서 확인을 묻는 메시지가 표시되지 않는다는 의미입니다. 기본적으로 이 cmdlet은 캐시를 플러시할지 묻는 메시지가 표시됩니다.
