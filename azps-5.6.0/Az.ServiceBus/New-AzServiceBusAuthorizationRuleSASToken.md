...
## SYNOPSIS
네임스페이스/큐/토픽의 Azure servicebus 권한 부여 규칙에 대한 SAS를 생성합니다. 
...
## 설명
New-AzServiceBusAuthorizationRuleSASToken cmdlet은 Azure Eventhub Namesapce 또는 Azure Eventhub에 대한 SAS(공유 액세스 서명) 토큰을 생성합니다.
