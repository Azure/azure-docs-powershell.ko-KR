...
## 설명
**Get-AzServiceBusKey** cmdlet은 주어진 네임스페이스 또는 큐 또는 토픽 또는 별칭(GeoDR 구성)에 대한 기본 및 보조 연결 문자열을 반환합니다.
...
지정된 네임스페이스에 대한 기본 및 보조 연결 문자열입니다.
...
지정된 네임스페이스 및 별칭에 대한 기본 및 보조 연결 문자열입니다.
