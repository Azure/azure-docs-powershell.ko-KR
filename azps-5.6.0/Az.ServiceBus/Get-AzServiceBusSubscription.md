...
## 설명
**Get-AzServiceBusSubscription** cmdlet은 지정된 Service Bus 토픽에 대한 구독 설명을 반환합니다.
...
지정된 Service Bus 토픽에 대한 구독 설명을 반환합니다.
...
지정된 Service Bus 토픽에 대한 구독 목록을 반환합니다. 기본적으로 100개 구독이 반환됩니다. 구독 수의 경우 -MaxCount 매개 변수를 사용하세요.
...
지정된 Service Bus 토픽에 대한 처음 150개 구독 목록을 반환합니다.
