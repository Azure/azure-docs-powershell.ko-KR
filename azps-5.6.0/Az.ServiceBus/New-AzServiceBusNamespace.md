...
## 설명
**New-AzServiceBusNamespace** cmdlet은 새 Service Bus 네임스페이스를 만듭니다. 만든 후 네임스페이스 리소스 매니페스트는 변경 불가능합니다. 이 작업은 idempotent입니다.
...
### -SkuCapacity
Service Bus 프리미엄 네임스페이스의 사용이 허용되는 값 1 또는 2 또는 4
