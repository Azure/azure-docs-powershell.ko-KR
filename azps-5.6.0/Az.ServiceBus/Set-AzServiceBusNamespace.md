...
## 설명
**Set-AzServiceBusNamespace** cmdlet은 리소스 그룹 내에서 지정된 Service Bus 네임스페이스에 대한 설명을 업데이트합니다.
...
새 설명으로 Service Bus 네임스페이스를 업데이트합니다.
...
### -확인
지정된 정보로 Service Bus 네임스페이스를 업데이트합니다.
