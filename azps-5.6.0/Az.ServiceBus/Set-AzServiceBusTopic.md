...
## 설명
**Set-AzServiceBusTopic** cmdlet은 지정된 Service Bus 네임스페이스에서 Service Bus 토픽에 대한 설명 개체를 업데이트합니다.
...
지정된 네임스페이스에서 새 설명으로 지정된 토픽을 업데이트합니다. 이 예제에서는 **enableExpress 속성을 true로** **업데이트합니다.** 
