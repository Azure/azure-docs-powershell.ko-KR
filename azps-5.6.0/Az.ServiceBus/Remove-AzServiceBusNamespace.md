...
서비스 버스를 통해 제공된 Service Bus 네임스페이스를 $inputobject.

### 예제 2.2 - InputObject - 배관 사용:
```
...
-ResourceId 매개 변수에 대한 ARM 또는 배관을 통해 $resourceid id를 통해 제공된 Service Bus 네임스페이스를 제거합니다.
