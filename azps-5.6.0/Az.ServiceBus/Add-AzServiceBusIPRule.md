...
```
이름 : defaultAction : Id 허용 : /subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.ServiceBus/namespaces/ServiceBus-Namespaces/default Type : Microsoft.ServiceBus/Namespaces/NetworkRuleSet IpRules : {11.22.33.4, Allow} VirtualNetworkRules : 

IpMask "11.22.33.44"를 사용하여 IPRule을 추가하고 작업 허용이 주어진 네임스페이스를 프로브합니다.
