...
## 설명
**Remove-AzServiceBusTopic** cmdlet은 지정된 Service Bus 네임스페이스에서 토픽을 제거합니다.
...
네임스페이스에서 `SB-Topic_exampl1` 토픽을 `SB-Example1` 제거합니다.
