...
## 설명
**New-AzServiceBusRule** cmdlet은 주어진 구독에 대한 새 규칙을 만듭니다.
...
New-AzServiceBusRule cmdlet은 지정된 구독에 대한 새 규칙을 만듭니다.
...
New-AzServiceBusRule cmdlet은 ActionFilter를 통해 지정된 구독에 대한 새 규칙을 만듭니다.
