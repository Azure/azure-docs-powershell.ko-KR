...
**네임스페이스의** 권한 부여 규칙의 액세스 권한에서 `AuthoRule1` 관리를 `SB-Example1` 제거합니다.
...
큐의  권한 부여 규칙의 액세스 권한에서 `AuthoRule1` 관리를 `SBQueue` 제거합니다.
...
항목의  권한 부여 규칙의 액세스 권한에서 관리를 `AuthoRule1` `SBTopic` 제거합니다.
