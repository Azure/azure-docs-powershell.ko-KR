...
## 설명
generate-verify-code를 호출하여 얻은 확인 코드가 포함된 확인 인증서를 업로드하여 인증서를 확인합니다. 소유 증명 프로세스의 마지막 단계입니다.
Azure IoT Hub Device Provisioning Service의 CA 인증서에 대한 자세한 설명은 다음을 참조하세요. https://docs.microsoft.com/azure/iot-dps/how-to-verify-certificates
...
파이프라인을 사용하여 "mycertificate" 개인 키의 소유권을 확인해야 합니다.
