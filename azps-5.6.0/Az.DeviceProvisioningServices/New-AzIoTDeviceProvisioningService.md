...
리소스 그룹의 지역에서 표준 가격 책정 계층 S1 및 태그를 사용하여 Azure IoT Hub 디바이스 프로비전 서비스를 생성합니다.
...
'eastus' 지역에서 표준 가격 책정 계층 S1을 사용하여 Azure IoT Hub 디바이스 프로비전 서비스를 생성합니다.
...
### -Tag
IoT Device Provisioning Service 인스턴스 태그입니다. 해시 테이블의 키 값 쌍의 속성 가방입니다.
