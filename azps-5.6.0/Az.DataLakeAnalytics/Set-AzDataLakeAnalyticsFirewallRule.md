...
## 설명
**Set-AzDataLakeAnalyticsFirewallRule** cmdlet은 Azure Data Lake Analytics 계정에서 방화벽 규칙을 업데이트합니다.
...
이 명령은 "ContosoAdlAcct" 계정에서 "내 방화벽 규칙"이라는 방화벽 규칙을 업데이트하여 새 IP 범위: 127.0.0.10

## 매개 변수

### -Account
에서 방화벽 규칙을 업데이트하는 Data Lake Analytics 계정
