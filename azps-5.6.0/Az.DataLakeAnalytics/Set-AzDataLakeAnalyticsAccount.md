...
Data Lake Analytics 계정을 수정합니다. (자동 재생)
...
### -FirewallState
선택적으로 기존 방화벽 규칙을 사용하도록 설정/사용하지 않도록 설정합니다.
...
### -MaxJobCount
설정하는 동시에 계정에서 실행되는 선택적 최대 지원되는 작업입니다.
...
### -QueryStoreRetention
작업 메타데이터가 계정에서 설정하기 위해 보존되는 선택적 일 수입니다.
...
### -Tag
현재 태그 집합을 대체해야 하는 이 계정과 연결된 태그의 문자열 사전
...
### System.Nullable'1[[Microsoft.Azure.Management.DataLake.Analytics.Models.FirewallState, Microsoft.Azure.Management.DataLake.Analytics, Version=3.0.0,Culture=neutral, PublicKeyToken=31bf3856ad364e35]]
