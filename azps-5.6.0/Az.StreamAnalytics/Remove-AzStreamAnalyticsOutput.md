...
## 설명
**Remove-AzStreamAnalyticsOutput** cmdlet은 Azure의 Stream Analytics 작업에서 출력을 비동기적으로 삭제합니다.
...
이 명령은 StreamingJob 작업의 출력 출력을 제거합니다.
...
### -Name
제거할 Azure Stream Analytics 출력의 이름을 지정합니다.
