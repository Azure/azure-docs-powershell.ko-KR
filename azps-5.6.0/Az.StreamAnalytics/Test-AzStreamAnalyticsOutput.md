...
## 설명
**Test-AzStreamAnalyticsOutput** cmdlet은 Stream Analytics에서 출력에 연결하는 기능을 테스트합니다.
...
이렇게 하여 StreamingJob의 출력 출력의 연결 상태를 테스트합니다.
...
### -JobName
원하는 Azure Stream Analytics 출력이 속하는 Azure Stream Analytics 작업의 이름을 지정합니다.
