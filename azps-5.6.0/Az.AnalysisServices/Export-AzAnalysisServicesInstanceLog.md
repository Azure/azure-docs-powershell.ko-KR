...
## 설명
Export-AzAnalysisServicesInstance cmdlet은 Azure Analysis Services 서버 인스턴스에서 파일로 로그를 내보낼 수 있습니다.
...
이 명령은 Add-AzAnalysisServicesAccount 명령에 지정된 환경에서 서버 'testserver'에서 로그를 내보낸 다음 OutputPath 'C:\path\to\log\testserver.log'에 지정된 파일에 저장합니다.

## 매개 변수

### -Force
묻지 않고 존재하는 경우 파일을 덮어
