...
## 설명
JIT(Just In Time) 네트워크 액세스 정책을 사용하면 간단한 사용자가 VM에 대한 임시 네트워크 연결을 만들 수 있도록 정책을 정의할 수 있습니다.
정책은 VM에 대한 연결을 요청할 수 있는 포트, 프로토콜 및 원본 IP 주소와 연결이 자동으로 닫히기 전에 최대 기간을 정의합니다.
정책에서 이 정책으로 만든 연결 요청을 볼 수 있습니다. 
...
"myService1" 리소스 그룹의 모든 JIT 네트워크 액세스 경찰을 얻습니다.
...
### -ResourceId
jit Network Access Policy 리소스의 리소스 ID입니다.
