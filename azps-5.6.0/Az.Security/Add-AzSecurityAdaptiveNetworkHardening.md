...
## 설명
적응형 네트워크 강화는 Azure Security Center에서 자동으로 계산되며 이 cmdlet을 사용하여 요청에 나열된 NSG에 대해 주어진 규칙을 적용합니다.
...
적응 네트워크 강화 규칙에서 만든 보안 규칙으로 업데이트될 효과적인 네트워크 보안 그룹의 Azure 리소스 아이디입니다.
