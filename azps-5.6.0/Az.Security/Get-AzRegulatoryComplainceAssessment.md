...
## 설명
spcific 평가 세부 정보를 얻거나 특정 제어 및 규정 준수 표준에 따라 모든 평가를 나열합니다.
...
평가 ID에 따라 특정 제어 및 표준에서 특정 평가를 얻습니다.
...
리소스 ID에 따라 특정 제어 및 표준에서 특정 평가를 얻습니다.
