...
Azure Security Center에서 구독에 대해 Azure Defender 계획을 활성화하거나 사용하지 않도록 설정합니다.
...
구독에 대한 Azure Defender 계획을 사용하도록 설정하거나 사용하지 않도록 설정합니다.
...
구독에 **대한 서버에 대해 Azure Defender를** 사용할 수 있습니다.

"표준"은 Azure Portal의 Azure Security Center의 가격 책정 및 설정 영역에 표시된 Azure Defender 계획의 "On" 상태를 참조합니다.
