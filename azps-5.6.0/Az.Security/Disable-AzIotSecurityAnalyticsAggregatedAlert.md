...
## 설명
Disable-AzIotSecurityAnalyticsAggregatedAlert cmdlet은 iot Hub의 디바이스에서 특정 가해진 경고를 기각합니다. 집계된 경고의 이름은 '/'로 구분된 경고 유형과 경고가 가해진 날짜의 조합입니다.
...
리소스 그룹 "MyResourceGroup"의 IoT 보안 솔루션 "MySolutionName"에서 집계된 경고 "IoT_SucessfulLocalLogin/2020-03-15"(경고 유형 및 집계 날짜에서 결합된 이름)를 기각합니다.
...
리소스 ID "/subscriptions/XXXXXXX-XXXX-XXXXXXXXXXXXXXXXXXXXX/resourceGroups/MyResource로 집계된 경고를 취소합니다.Group/providers/Microsoft.Security/iotSecuritySolutions/MySolutionName/analyticsModels/default/aggregatedAlerts/IoT_SucessfulLocalLogin/2020-03-15"
