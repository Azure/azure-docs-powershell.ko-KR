...
## 설명
Azure Security Center는 리소스를 검색하여 잠재적인 보안 문제를 검색합니다.
이 cmdlet을 사용하면 Azure Security Center에서 권장하는 보안 작업을 검색할 수 있습니다.
...
구독 내부 리소스에서 검색된 모든 보안 작업을 얻습니다.
...
리소스 그룹 내에서 리소스에서 검색된 모든 보안 작업을 얻습니다.
