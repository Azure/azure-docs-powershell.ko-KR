...
## 설명
임시 네트워크 액세스 요청을 호출합니다.
요청은 구성된 JIT 네트워크 액세스 정책에 대해 유효성을 검사하며, 허용되는 경우 사용자의 요청에 따라 네트워크 연결을 오픈합니다.
요청은 나중에 검토하기 위해 정책에 기록되고 지정된 기간을 초과하면 종료됩니다.
...
내 공용 IP에서 포트 22를 통해 1시간 동안 네트워크 연결을 갖습니다(표시되지 않습니다).
