...
# Az.Security 모듈
## 설명
Azure Security Center를 사용하면 Azure 구독 및 Azure 외부에 연결된 다른 컴퓨터의 보안을 제어할 수 있습니다.
...
저장소/cosmosDB 계정에 대한 고급 위협 보호 정책을 사용하지 않도록 설정합니다.
...
저장소/cosmosDB 계정에 대한 고급 위협 보호 정책을 제공합니다.

### [Get-AzSecurityAlert](Get-AzSecurityAlert.md)
Azure Security Center에서 검색된 보안 경고를 얻습니다.
...
시간이 경과에 따라 구독의 보안 준수를 얻게 됩니다.

### [Get-AzSecurityContact](Get-AzSecurityContact.md)
이 구독에서 구성된 보안 연락처를 얻습니다.

### [Get-AzSecurityLocation](Get-AzSecurityLocation.md)
Azure Security Center에서 특정 구독에 대한 데이터를 자동으로 저장하는 위치를 얻습니다.

### [Get-AzSecurityPricing](Get-AzSecurityPricing.md)
구독에 대해 Azure Security Center에서 사용하도록 설정된 Azure Defender 요금제에 대한 가격 책정 데이터를 얻습니다.

### [Get-AzSecurityTask](Get-AzSecurityTask.md)
보안 태세를 강화하기 위해 Azure Security Center에서 권장하는 보안 작업을 제공합니다.
...
iot 보안 솔루션에 대한 새 사용자 정의 리소스 만들기
...
IoT 보안 솔루션에서 하나 이상의 속성을 업데이트합니다. 태그, 권장 구성, 사용자 정의 리소스
