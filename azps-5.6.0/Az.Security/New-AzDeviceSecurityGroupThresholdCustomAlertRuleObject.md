...
## 설명
New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject cmdlet은 IoT 보안 솔루션의 디바이스 보안 그룹에 대한 임계값 사용자 지정 경고 규칙의 새 목록을 만듭니다.
...
최소 및 최대 임계값에 대한 상태 사용 개미 값을 사용하여 "SomeRuleType" 형식에서 새 임계값 사용자 지정 경고 규칙 만들기
