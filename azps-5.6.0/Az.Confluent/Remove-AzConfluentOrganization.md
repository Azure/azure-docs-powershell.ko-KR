...
INPUTOBJECT <IConfluentIdentity> : ID 매개 변수
  - `[Id <String>]`: 리소스 ID 경로
  - `[OrganizationName <String>]`: 조직 리소스 이름
  - `[ResourceGroupName <String>]`: 리소스 그룹 이름
  - `[SubscriptionId <String>]`: Microsoft Azure 구독 ID
