...
이 명령은 Databricks 작업 영역 을 만들고 암호화를 준비하기 위해 설정합니다.
암호화에 대한 자세한 Update-AzDatabricksWorkspace 예제를 참조하세요.
...
DBFS 루트 파일 시스템이 미사용 데이터에 대한 플랫폼 관리 키를 사용하여 보조 암호화 계층을 사용하여 사용하도록 설정될지 여부를 나타내는 부울입니다.
