...
이 명령은 개체에 따라 vnet 피어링의 AllowForwardedTraffic을 업데이트합니다.

## 매개 변수

### -AllowForwardedTraffic
[System.Management.Automation.SwitchParameter] 원격 가상 네트워크에서 로컬 가상 네트워크의 VM에서 전달된 트래픽을 허용/허용하지 않습니다.
...
### -AllowGatewayTransit
[System.Management.Automation.SwitchParameter] 이 가상 네트워크에 연결하기 위해 원격 가상 네트워킹에서 게이트웨이 링크를 사용할 수 있는 경우.
...
[System.Management.Automation.SwitchParameter] 로컬 가상 네트워크 공간의 VM이 원격 가상 네트워크 공간에서 VM에 액세스할 수 있는지 여부입니다.
