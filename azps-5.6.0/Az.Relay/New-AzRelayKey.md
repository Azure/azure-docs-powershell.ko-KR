...
## 설명
**New-AzRelayKey** cmdlet은 주어진 릴레이 엔터티(네임스페이스/WcfRelay/HybridConnection)에 대한 기본 및 보조 연결 문자열을 생성합니다.
...
지정한 엔터티에 대한 기본 또는 보조 연결 Relay-Namespace 다시 생성합니다.
...
제공된 키 값을 사용하여 주어진 Relay-Namespace 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
...
지정한 엔터티에 대한 기본 또는 보조 연결 Relay-WcfRelay 다시 생성합니다.
...
제공된 키 값을 사용하여 주어진 Relay-WcfRelay 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
...
주어진 릴레이 엔터티(네임스페이스/WcfRelay/HybridConnection)에 대한 기본 또는 보조 연결 문자열을 다시 생성합니다.
...
제공된 키 값을 사용하여 주어진 Relay-HybridConnection 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
