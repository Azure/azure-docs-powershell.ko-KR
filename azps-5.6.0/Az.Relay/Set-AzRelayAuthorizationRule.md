...
## 설명
**Set-AzRelayAuthorizationRule** cmdlet은 지정된 릴레이 엔터티(네임스페이스/WcfRelay/HybridConnection)의 지정된 권한 부여 규칙에 대한 설명을 업데이트합니다.

## 예제

### 예제 1.1 - InputObject를 사용하여 네임스페이스
```
PS C:\>
...
**네임스페이스의** 권한 부여 규칙의 액세스 권한에서 `AuthoRule1` 보내기 를 `TestNameSpace-Relay1` 추가합니다.
...
WcfRelay의 권한 부여 규칙의 액세스 권한에  `AuthoRule1` 보내기 를 추가합니다. `TestWCFRelay1`
...
HybridConnection의 권한 부여 규칙의 액세스 권한에  `AuthoRule1` 보내기 를 추가합니다. `TestHybridConnection`
