...
### 예제 1: 리소스 그룹 MyResourceGroup에서 MyService라는 기존 Healthcareapis 서비스를 cosmosdb OfferThroughput = 500으로 업데이트합니다.
...
### 예제 2: 리소스 그룹 MyResourceGroup의 MyService라는 기존 healthcareapis 서비스를 cosmosdb OfferThroughput = 500 및 키 자격 증명 모음 키 uri "https:// \<my-keyvault> \<my-key> .vault.azure.net/keys/"
