...
### 예제 1 : cosmosdb 제품 프로비전을 사용하여 위치 westus2의 리소스 그룹 MyResourceGroup에서 MyService라는 새 Azure Healthcareapis fhir 서비스를 만듭니다.
```powershell
...
### 예제 2 : cosmosdb 제품 프로비전 = 400 및 키 자격 증명 모음 키 uri "https:// .vault.azure.net/keys/ " 로 위치 westus2의 리소스 그룹 MyResourceGroup에서 MyService라는 새 Azure healthcareapis fhir \<my-keyvault> 서비스를 \<my-key> 만듭니다.
```powershell
...
### -CorsHeader
HealthcareApis Fhir Cors 헤더의 서비스 목록입니다.
...
요청의 결과를 몇 초 만에 캐시할 수 있는 시간을 지정합니다.
예: 600은 10분을 의미합니다.
...
### -CorsMethod
HealthcareApis Fhir Cors 메서드의 서비스 목록입니다.
...
### -CorsOrigin
HealthcareApis Fhir Cors Origin의 서비스 목록입니다.
...
HealthcareApis Fhir Service Export Storage 계정 이름입니다.
...
### -Tag
HealthcareApis Fhir Service 계정 태그입니다.
