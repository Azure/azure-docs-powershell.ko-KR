...
이 명령은 "AvailabilitySet0"로 시작하는 ResourceGroup11이라는 리소스 그룹의 모든 가용성 집합을 얻습니다.

### 예제 4: AvailabilitySet0부터 시작하는 이름으로 모든 가용성 집합을 얻게 됩니다.
```
...
이 명령은 "AvailabilitySet0"로 시작하는 모든 가용성 집합을 얻습니다.
