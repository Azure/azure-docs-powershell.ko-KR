...
이 명령은 "ResourceGroupName1"이라는 리소스 그룹의 모든 스냅숏의 속성을 얻습니다.
...
이 명령은 "ResourceGroupName1"이라는 리소스 그룹에서 "스냅숏Name1"이라는 스냅숏의 속성을 얻습니다.
...
이 명령은 "스냅숏 이름"으로 시작하는 모든 스냅숏을 얻습니다.
