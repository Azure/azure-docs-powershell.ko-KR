...
## 설명
이 cmdlet은 근접 배치 그룹 리소스를 얻거나 나열합니다.
...
이 명령은 주어진 리소스 그룹 아래에 있는 모든 근접 배치 그룹을 나열합니다.
...
이 명령은 구독 아래에 있는 모든 근접 배치 그룹을 나열합니다.

## 매개 변수

### -ColocationStatus
근접 배치 그룹에서 리소스의 공동 위치 상태를 보여 옵니다.
