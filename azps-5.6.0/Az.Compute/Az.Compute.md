...
# Az.Compute 모듈
## 설명
이 항목에서는 Azure Compute Cmdlet에 대한 도움말 토픽을 표시합니다.
...
Blob 기반 디스크가 있는 가상 머신을 관리 디스크가 있는 가상 머신으로 변환합니다.
...
주어진 시간 창에서 이 구독에 대한 총 스로틀된 Api 요청을 표시하는 로그를 내보낼 수 있습니다.

### [Get-AzAvailabilitySet](Get-AzAvailabilitySet.md)
리소스 그룹에서 Azure 가용성 집합을 얻습니다.
...
### [Get-AzDiskAccesss](Get-AzDiskAccess.md)
Disk Accesses의 속성을 얻습니다.
...
### [Get-AzVMADomainExtension](Get-AzVMADDomainExtension.md)
AD 도메인 확장에 대한 정보를 얻습니다.
...
### [New-AzDiskAccesss](New-AzDiskAccess.md)
디스크 액세스 리소스 만듭니다.
...
가상 머신 또는 Vmss VM에 대한 로컬 데이터 디스크 개체를 만듭니다.
...
가상 머신에서 서버 SQL 자격 증명 모음 자격 증명을 사용할 구성 개체를 만듭니다.
...
VMSS의 네트워크 인터페이스에 대한 IP 태그 개체를 만듭니다.
...
컨테이너 서비스에서 에이전트 풀 프로필을 제거합니다.

### [Remove-AzDisk](Remove-AzDisk.md)
디스크를 제거합니다.

### [Remove-AzDiskAccesss](Remove-AzDiskAccess.md)
디스크 액세스 리소스를 제거합니다.
...
Azure에서 가상 머신을 제거합니다.

### [Remove-AzVMAccessExtension](Remove-AzVMAccessExtension.md)
가상 머신에서 VMAccess 확장을 제거합니다.

### [Remove-AzVMAEMExtension](Remove-AzVMAEMExtension.md)
가상 머신에서 AEM 확장을 제거합니다.
...
가상 머신에서 진단 확장을 제거합니다.

### [Remove-AzVMDiskEncryptionExtension](Remove-AzVMDiskEncryptionExtension.md)
가상 머신에서 디스크 암호화 확장을 제거합니다.

### [Remove-AzVMDscExtension](Remove-AzVMDscExtension.md)
리소스 그룹의 가상 머신에서 DSC 확장 처리기를 제거합니다.
...
가상 머신에서 SQL Server 확장을 제거합니다.

### [Remove-AzVmss](Remove-AzVmss.md)
VMSS 내에 있는 VMSS 또는 가상 머신을 제거합니다.
...
### [Set-AzVMADomainExtension](Set-AzVMADDomainExtension.md)
가상 머신에 AD 도메인 확장을 추가합니다.

### [Set-AzVMAEMExtension](Set-AzVMAEMExtension.md)
SAP 시스템에 대한 모니터링을 지원하도록 설정합니다.

### [Set-AzVMBackupExtension](Set-AzVMBackupExtension.md)
가상 머신에서 백업 확장 속성을 설정합니다.

### [Set-AzVMBginfoExtension](Set-AzVMBginfoExtension.md)
BGInfo 확장을 가상 머신에 추가합니다.
...
VMSS에 대한 오케스트레이션 서비스 상태를 설정합니다.
...
모든 가상 머신 확장 집합 인스턴스를 사용 가능한 최신 플랫폼 이미지 OS 버전으로 이동하기 위한 롤링 업그레이드를 시작합니다.
