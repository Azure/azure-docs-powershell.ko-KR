...
다음 세 가지 명령은 os 디스크의 경로와 두 개의 데이터 디스크를 $osDiskVhdUri, $dataDiskVhdUri 1 및 $dataDiskVhdUri 2 변수에 할당합니다. 이 방법은 다음 명령의 가독성을 위한 것입니다.
...
### -HyperVGeneration
이미지에서 만든 가상 머신에 대한 HyperVGeneration 형식을 지정합니다.  허용되는 값은 V1 및 V2입니다.
