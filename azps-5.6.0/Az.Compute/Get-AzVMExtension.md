...
확장의 인스턴스 보기만 얻게 만들 경우 상태 매개 변수를 지정합니다.
...
이 명령은 ResourceGroup11의 VirtualMachine22라는 가상 머신에서 CustomScriptExtension이라는 확장에 대한 속성을 얻습니다.
...
이 명령은 ResourceGroup11의 VirtualMachine22라는 가상 머신에서 CustomScriptExtension이라는 확장에 대한 인스턴스 보기를 얻습니다.

### 예제 3: VM에 설치된 모든 확장 사용
```
...
### 예제 4: VM 매개 변수를 사용하여 확장의 속성 얻습니다.
```
