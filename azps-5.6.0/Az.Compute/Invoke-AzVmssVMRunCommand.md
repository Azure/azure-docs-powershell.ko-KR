...
## 설명
Virtual Machine Scale Set VM에서 실행 명령을 호출합니다.
...
리소스 그룹 'rgname'의 'vmssname'의 가상 머신 확장 집합에서 스크립트 'sample.ps1' 및 ID '0' VM의 매개 변수를 를 를 통해 RunPowerShellScript의 실행 명령을 호출합니다.
...
### -ScriptPath
실행할 스크립트의 경로입니다.  이 값이 지정될 때 주어진 스크립트는 명령의 기본 스크립트를 다시 지정합니다.
...
PS Virtual Machine 확장 집합 VM 개체입니다.
