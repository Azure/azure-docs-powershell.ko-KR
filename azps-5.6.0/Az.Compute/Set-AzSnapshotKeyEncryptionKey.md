...
## 설명
**Set-AzSnapshotKeyEncryptionKey** cmdlet은 스냅숏 개체의 키 암호화 키 속성을 설정합니다.
...
첫 번째 명령은 저장소 계정 유형에 크기가 5GB인 로컬 빈 스냅숏 개체를 Standard_LRS 만듭니다.  또한 Windows OS 유형을 설정하고 암호화 설정을 사용할 수 있습니다.
두 번째 및 세 번째 명령은 스냅숏 개체에 대한 디스크 암호화 키 및 키 암호화 키 설정을 설정합니다.
마지막 명령은 스냅숏 개체를 만들고 리소스 그룹 'ResourceGroup01'에서 '스냅숏01'을 사용하여 스냅숏을 만듭니다.
