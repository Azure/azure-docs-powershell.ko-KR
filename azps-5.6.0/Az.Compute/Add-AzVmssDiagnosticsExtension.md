...
## 설명
**Add-AzVmssDiagnosticsExtension** cmdlet은 VMSS(Virtual Machine Scale Set) 인스턴스에 진단 확장을 추가합니다.
...
### -TypeHandlerVersion
이 VMSS에 사용할 확장 버전을 지정합니다.
버전을 구하기 위해 *PublisherName* 매개 변수에 대한 Microsoft.Azure.Diagnostics 값과 형식 매개 변수에 대한 IaaSDiagnostics 값을 사용하여 [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) cmdlet을 *실행합니다.*
