...
## 설명
**Set-AzDiskImageReference** cmdlet은 디스크 개체의 이미지 참조 속성을 설정합니다.
...
첫 번째 명령은 저장소 계정 유형에 크기가 10GB인 로컬 Premium_LRS 만듭니다.  또한 Windows OS 유형을 설정합니다.
두 번째 명령은 디스크 개체에 대한 이미지 ID 및 논리 단위 번호 0을 설정합니다.
