...
## 설명
수동 플랫폼 업데이트 도메인 워크를 강제로 적용하여 서비스 패브릭 가상 머신 확장 집합에서 가상 머신을 업데이트합니다.
...
이 명령은 리소스 그룹 이름 및 확장 집합 이름으로 지정된 가상 머신 확장 집합에 대해 UD 0에서 서비스 패브릭 업데이트 워크를 강제합니다.
...
이 명령은 VM 확장 집합 개체에 지정된 가상 머신 확장 집합에 대해 UD 1에서 서비스 패브릭 업데이트 워크를 강제합니다.
...
이 명령은 리소스 ID로 지정된 가상 머신 확장 집합에 대해 UD 2에서 서비스 패브릭 업데이트 워크를 강제로 실행합니다.
...
수동 복구 워크가 요청되는 플랫폼 업데이트 도메인입니다.
