...
## 설명
**Set-AzDiskUpdateDiskEncryptionKey** cmdlet은 디스크 업데이트 개체의 디스크 암호화 키 속성을 설정합니다.
...
첫 번째 명령은 저장소 계정 유형에 크기가 10GB인 로컬 빈 디스크 Premium_LRS 만듭니다.  또한 Windows OS 유형을 설정하고 암호화 설정을 사용할 수 있습니다.
