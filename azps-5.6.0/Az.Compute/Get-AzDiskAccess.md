...
## 설명
**Get-AzDiskAccesss** cmdlet은 Disk Accesses의 속성을 얻습니다.
...
이 명령은 리소스 그룹 'ResourceGroup01'에서 'DiskAccess01'이라는 디스크 액세스 리소스의 속성을 얻습니다.

### 예제 2: Get-AzDiskAccess 그룹
```
...
이 명령은 리소스 그룹 'ResourceGroup01'의 모든 디스크 액세스의 속성을 얻습니다.
...
이 명령은 구독 아래에서 모든 디스크 액세스의 속성을 얻습니다.

### 예제 4: 와일드카드 문자를 사용하여 모든 디스크 액세스 사용
```
...
이 명령은 'DiskAccessMicrosoft'로 시작하는 구독 이름 아래에서 모든 디스크 액세스의 속성을 얻습니다.

### 예제 5: ResourceId를 사용하여 디스크 액세스를 얻습니다.
```
...
이 명령은 주어진 ResourceId를 사용하여 Disk Access의 속성을 얻습니다.
...
### Microsoft.Azure.Commands.Compute.Automation.Models.PSDiskAccesss
