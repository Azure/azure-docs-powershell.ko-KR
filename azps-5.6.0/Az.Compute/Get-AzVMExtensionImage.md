...
## 설명
**Get-AzVMExtensionImage** cmdlet은 Azure 확장에 대한 모든 버전을 제공합니다.
...
### 예제 2: 버전 오버 필터를 사용하여 확장 이미지의 버전 다운로드
```
...
### 예제 3: 버전 오버 필터를 사용하여 확장 이미지의 버전 다운로드
```
...
### -Type
확장의 유형을 지정합니다.
확장 형식을 얻은 경우 Get-AzVMExtensionImageType cmdlet을 사용 합니다.
