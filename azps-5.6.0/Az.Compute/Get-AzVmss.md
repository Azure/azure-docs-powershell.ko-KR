...
## 설명
**Get-AzVmss** cmdlet은 VMSS(Virtual Machine Scale Set)의 모델 및 인스턴스 보기를 제공합니다.
모델 보기는 가상 머신 확장 집합의 사용자 지정 속성입니다.
인스턴스 보기는 가상 머신 확장 집합의 인스턴스 수준 상태입니다.
*InstanceView* 매개 변수를 지정하여 가상 머신 확장 집합의 인스턴스 보기만 얻습니다.
...
명령은 *InstanceView* 스위치 매개 변수를 지정하지 않습니다. cmdlet은 가상 머신 확장 집합의 모델 보기를 얻습니다.

### 예제 2: 리소스 그룹의 모든 VM을 얻습니다.
```
...
### -InstanceView
이 cmdlet은 가상 머신 확장 집합의 인스턴스 보기만 얻습니다.
