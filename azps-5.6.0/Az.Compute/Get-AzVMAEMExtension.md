...
## 설명
**Get-AzVMAEMExtension** cmdlet은 AEM(Azure Enhanced Monitoring) 확장에 대한 정보를 얻습니다.
...
이 명령은 contoso-server라는 가상 머신에 대한 AEM 확장에 대한 정보를 얻습니다.
...
### -Name
가상 머신의 이름을 지정합니다.
이 cmdlet은 이 cmdlet이 지정하는 가상 머신의 AEM 확장에 대한 정보를 얻습니다.
...
이 cmdlet은 해당 가상 머신의 AEM 확장에 대한 정보를 얻습니다.
...
### -Status
이 cmdlet은 AEM 확장의 인스턴스 보기만 얻게 됩니다.
...
### -VMName
가상 머신의 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 가상 머신에 대한 AEM 확장에 대한 정보를 제공합니다.
