...
## 설명
지원 티켓에 대한 통신을 받습니다. 다른 매개 변수를 지정하지 않으면 티켓에 대한 모든 통신을 검색합니다. 필터 매개 변수를 사용하여 CreatedDate 또는 CommunicationType을 사용하여 통신을 필터링할 수도 있습니다. 다음은 지정할 수 있는 필터 값의 몇 가지 예입니다.


| 시나리오                                                        | 필터                                                     |
|-----------------------------------------------------------------|------------------------------------------------------------|
| 웹 통신을 얻습니다.                                          | "CommunicationType eq 'Web'"                               |
| 전화 통신하기                                        | "CommunicationType eq 'Phone'"                             |
| 2019년 12월 20일 이후에 생성된 통신을 얻습니다. | "CreatedDate ge 2019-12-20"                                |
| 2019년 12월 20일 이후에 생성된 통신을 얻습니다.       | "CreatedDate gt 2019-12-20"                                |
| 2019년 12월 20일 이후에 만든 웹 통신을 얻습니다.            | "CreatedDate gt 2019-12-20 및 CommunicationType eq 'Web'" |
...
### 예제 4: 지원 티켓에 대한 처음 2개 통신을 건너뛰고 나서 다음 2개 통신 검색
```powershell
