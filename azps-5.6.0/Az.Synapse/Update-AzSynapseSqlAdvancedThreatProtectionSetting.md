...
## 설명
**Update-AzSynapseSqlAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse Analytics 작업 영역의 고급 위협 보호 설정을 업데이트합니다. 작업 영역의 고급 위협 보호를 사용하도록 설정하려면 해당 작업 영역에서 감사 설정을 사용하도록 설정해야 합니다.
