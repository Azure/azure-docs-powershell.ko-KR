...
## SYNOPSIS
Synapse Analytics 방화벽 규칙을 얻습니다.
...
## 설명
**Get-AzSynapseFirewallRule** cmdlet은 Azure Synapse Analytics 방화벽 규칙을 얻습니다.
규칙 이름을 지정하지 않으면 이 cmdlet은 모든 규칙을 제공합니다.
...
이 명령은 작업 영역 아래에서 모든 방화벽 규칙을 얻습니다.
...
이 명령은 ContosoFirewallRule 이름이 있는 작업 영역 ContosoWorkspace에서 방화벽 규칙을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역 아래에서 모든 방화벽 규칙을 제공합니다.
