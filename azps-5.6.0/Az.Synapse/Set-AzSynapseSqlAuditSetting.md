...
## 설명
**Set-AzSynapseSqlAuditSetting** cmdlet은 Azure Synapse Analytics 작업 영역의 감사 설정을 변경합니다.
...
ContosoWorkspace라는 Azure Synapse Analytics 작업 영역의 Blob Storage 감사 정책을 사용하도록 설정합니다.
...
T-SQL 사용하여 고급 필터링을 사용하여 ContosoWorkspace라는 Azure Synapse Analytics 작업 영역의 Blob Storage 감사 정책을 사용하도록 SQL.
