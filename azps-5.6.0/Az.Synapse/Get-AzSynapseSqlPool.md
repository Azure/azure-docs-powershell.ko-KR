...
## 설명
**Get-AzSynapseSqlPool** cmdlet은 Azure Synapse Analytics SQL 정보를 얻습니다.
...
이 명령은 contosoSqlPool 이름이 SQL ContosoWorkspace에서 SQL 풀을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 SQL 모든 SQL 풀을 얻습니다.
...
### -Version
[이 기능은 제한된 미리 보기에 있습니다. 처음에는 특정 구독에만 액세스할 수 있습니다.] Synapse SQL 풀입니다. 예를 들어 2 또는 3.
