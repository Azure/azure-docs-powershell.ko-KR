...
## SYNOPSIS
풀의 열의 정보 유형 및 민감도 레이블을 SQL 제거합니다.
...
## 설명
Remove-AzSynapseSqlPoolSensitivityClassification cmdlet은 SQL 열의 정보 형식 및 민감도 레이블을 제거합니다.

## 예제

### 예제 1: Azure Synapse SQL 열의 정보 형식 및 민감도 레이블을 제거합니다.
```powershell
