...
## 설명
**Get-AzSynapseActivityRun** cmdlet은 지정된 기간에 발생한 지정된 파이프라인 실행에 대한 작업 영역의 실행에 대한 정보를 얻습니다. 또한 활동 이름 및 실행 상태에 대한 필터를 지정할 수 있습니다.
...
이 명령은 ID "f288712d-fb08-4cb8-96ef-82d3b9b를 사용하여 ContosoPipeline 실행이라는 파이프라인의 모든 활동 실행에 대한 세부 정보를 제공합니다. "2018-09-01T21:00"과 "2018-09-30T21:00" 사이에 발생한 30621입니다.
...
이 명령은 ID "f288712d-fb08-4cb8-96ef-82d3b9b3을 사용하여 ContosoPipeline 실행이라는 파이프라인에서 실행되는 모든 작업 실행에 대한 세부 정보를 제공합니다. 파이프라인을 통해 "2018-09-01T21:00"과 "2018-09-30T21:00" 사이에 발생했습니다.
