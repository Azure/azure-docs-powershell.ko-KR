...
## 설명
**Remove-AzSynapseLinkedService** cmdlet은 작업 영역에서 연결된 서비스를 제거합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역에서 ContosoLinkedService라는 연결된 서비스를 제거합니다.
...
이 명령은 파이프라인을 통해 ContosoWorkspace라는 작업 영역에서 ContosoLinkedService라는 연결된 서비스를 제거합니다.
