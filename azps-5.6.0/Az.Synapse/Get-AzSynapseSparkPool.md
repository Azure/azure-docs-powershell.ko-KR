...
이 명령은 작업 영역 아래에서 모든 Spark 풀을 얻습니다.
...
이 명령은 ContosoSparkPool 이름이 있는 작업 영역 ContosoWorkspace에서 Spark 풀을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역 아래에서 모든 Spark 풀을 얻습니다.
...
이 명령은 지정된 리소스 ID가 있는 Spark 풀을 얻습니다.
