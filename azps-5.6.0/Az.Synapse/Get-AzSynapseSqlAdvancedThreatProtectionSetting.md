...
## 설명
**Get-AzSynapseSqlAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse Analytics 작업 영역의 고급 위협 보호 설정을 제공합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 고급 위협 보호 설정을 제공합니다.
