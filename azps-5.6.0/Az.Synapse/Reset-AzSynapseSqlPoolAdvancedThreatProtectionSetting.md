...
## 설명
**Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse Analytics SQL 제거합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역 아래에서 ContosoSqlPool이라는 SQL 풀에서 고급 위협 보호 설정을 제거합니다.
