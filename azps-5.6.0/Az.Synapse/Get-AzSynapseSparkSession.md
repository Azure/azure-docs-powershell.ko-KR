...
## 설명
**Get-AzSynapseSparkSession** cmdlet은 Azure Synapse Analytics Spark 세션에 대한 정보를 제공합니다.
...
이 명령은 지정된 Spark 풀에서 모든 Spark 세션을 얻습니다.
...
이 명령은 지정된 livy ID를 사용하여 Spark 세션을 얻습니다.
...
이 명령은 파이프라인을 통해 지정된 Spark 풀에서 모든 Spark 세션을 얻습니다.
