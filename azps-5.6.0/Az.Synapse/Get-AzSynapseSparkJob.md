...
## 설명
**Get-AzSynapseSparkJob** cmdlet은 Azure Synapse Analytics Spark 작업을 얻습니다.
...
이 명령은 Spark 풀 아래에서 모든 작업을 얻습니다.
...
이 명령은 지정된 애플리케이션 ID를 사용하여 작업을 얻습니다.
...
이 명령은 파이프라인을 통해 Spark 풀 아래에서 모든 작업을 얻습니다.
