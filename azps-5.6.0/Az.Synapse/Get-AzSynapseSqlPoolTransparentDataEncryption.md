...
## 설명
**Get-AzSynapseSqlPoolTransparentDataEncryption** cmdlet은 Azure Synapse Analytics 풀에 대한 TDE(투명한 데이터 암호화) SQL 합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역 아래에서 ContosoSqlPool이라는 SQL 풀에 대한 TDE 상태를 얻습니다.
