...
이름을 지정하지 않으면 이 cmdlet은 작업 영역의 모든 통합 런타임에 대한 정보를 제공합니다.
...
ContosoWorkspace라는 작업 영역의 모든 통합 런타임을 나열합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 'test-selfhost-ir'이라는 통합 런타임에 대한 세부 상태를 표시합니다.
