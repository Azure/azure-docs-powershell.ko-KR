...
## 설명
**Get-AzSynapseRoleDefinition** cmdlet은 Azure Synapse Analytics 역할 정의를 얻습니다.
역할 이름 또는 역할 ID를 지정하지 않으면 이 cmdlet은 모든 역할 정의를 얻습니다.
...
이 명령은 작업 영역 아래에서 모든 역할 정의를 얻습니다.
...
이 명령은 ContosoRole 이름의 작업 영역 ContosoWorkspace에서 역할 정의를 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역 아래에서 모든 역할 정의를 얻습니다.
