...
이 명령은 ContosoFirewallRule이라는 이름의 작업 영역 ContosoWorkspace에서 ContosoFirewallRule이라는 방화벽 규칙을 만듭니다.
...
이 명령은 작업 영역 아래에서 모든 azure ips를 허용하는 방화벽 규칙을 만듭니다.

## 매개 변수

### -AllowAllAzureIP
모든 Azure IP에 액세스할 수 있도록 허용하는 특수한 방화벽 규칙을 만듭니다.
