...
## 설명
**Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse Analytics SQL 설정합니다.
풀에서 고급 위협 보호를 사용하도록 SQL 해당 풀에서 감사 설정을 사용하도록 SQL 합니다.
...
이 명령은 ContosoWorkspace라는 작업 SQL ContosoSqlPool이라는 풀에 대한 고급 위협 보호 설정을 설정합니다.
