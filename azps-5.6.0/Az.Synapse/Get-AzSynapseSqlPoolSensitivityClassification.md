...
## SYNOPSIS
현재 정보 형식 및 열의 민감도 레이블을 SQL 합니다.
...
## 설명
Get-AzSynapseSqlPoolSensitivityClassification cmdlet은 Azure Synapse SQL 열의 현재 정보 형식 및 민감도 레이블을 반환합니다.

## 예제

### 예제 1: Azure Synapse 풀의 현재 정보 유형 및 민감도 레이블을 SQL 합니다.
```powershell
...
### 예제 3: Azure Synapse 풀의 특정 열의 현재 정보 유형 및 민감도 레이블을 SQL.
```powershell
