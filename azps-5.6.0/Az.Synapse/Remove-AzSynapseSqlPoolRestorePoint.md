...
## SYNOPSIS
Synapse Analytics SQL 복원 지점을 삭제합니다.
...
## 설명
**Remove-AzSynapseSqlPoolRestorePoint** cmdlet은 Azure Synapse Analytics SQL 복원 지점을 영구적으로 삭제합니다.
...
이 명령은 Azure Synapse Analytics SQL 복원 지점을 삭제합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics SQL 풀 복원 지점을 삭제합니다.
...
이 명령은 지정된 리소스 ID를 사용하여 Azure Synapse Analytics SQL 풀 복원 지점을 삭제합니다.
...
### -InputObject
SQL 복원 지점 만들기 시간 입력 개체입니다. 일반적으로 파이프라인을 통해 전달됩니다.
...
### -SqlPoolObject
일반적으로 파이프라인을 통해 전달되는 Sql Pool 입력 개체입니다.
