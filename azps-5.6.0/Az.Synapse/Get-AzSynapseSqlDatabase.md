...
## SYNOPSIS
Synapse Analytics SQL 데이터베이스를 만듭니다.
...
## 설명
[이 기능은 제한된 미리 보기에 있습니다. 처음에는 특정 구독에만 액세스할 수 있습니다.] **Get-AzSynapseSqlDatabase** cmdlet은 Azure Synapse Analytics SQL 정보를 제공합니다.
...
이 명령은 contosoSqlDatabase 이름으로 SQL ContosoWorkspace에서 데이터베이스를 얻습니다.
...
이 명령은 파이프라인을 통해 작업 SQL 모든 데이터베이스를 제공합니다.
