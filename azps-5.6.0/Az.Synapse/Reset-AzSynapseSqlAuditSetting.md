...
## 설명
**Reset-AzSynapseSqlAuditSetting** cmdlet은 Azure Synapse Analytics 작업 영역의 감사 설정을 제거합니다.
...
이 명령은 ContosoWorkspace라는 Azure Synapse Analytics 작업 영역의 감사 설정을 제거합니다.
...
이 명령은 파이프라인을 통해 ContosoWorkspace라는 Azure Synapse Analytics 작업 영역의 감사 설정을 제거합니다.
