...
## 설명
**Get-AzSynapseRoleAssignment** cmdlet은 Azure Synapse Analytics 역할 할당을 얻습니다.
역할 정의 또는 사용자 주체 이름을 지정하지 않으면 이 cmdlet은 모든 역할 할당을 얻습니다.
...
이 명령은 작업 영역 아래에서 모든 역할 할당을 얻습니다.
...
이 명령은 역할 이름 ContosoRole이 있는 작업 영역 ContosoWorkspace에서 모든 역할 할당을 얻습니다.
...
이 명령은 역할 이름 ContosoRole 및 사용자 주체 이름 ContosoName을 사용하여 작업 영역 ContosoWorkspace에서 역할 할당을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역 아래에서 모든 역할 할당을 얻습니다.
