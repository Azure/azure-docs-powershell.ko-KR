...
## SYNOPSIS
Synapse Analytics 데이터베이스를 SQL 삭제합니다.
...
## 설명
**Remove-AzSynapseSqlPool** cmdlet은 Azure Synapse Analytics SQL 삭제합니다.
...
이 명령은 Azure Synapse Analytics SQL 삭제합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics SQL 데이터베이스를 삭제합니다.
...
이 명령은 지정된 리소스 ID로 Azure Synapse Analytics SQL 데이터베이스를 삭제합니다.
...
### -InputObject
SQL 데이터베이스 입력 개체를 입력합니다. 일반적으로 파이프라인을 통해 전달됩니다.
