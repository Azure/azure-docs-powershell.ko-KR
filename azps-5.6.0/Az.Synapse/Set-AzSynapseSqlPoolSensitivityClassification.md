...
## SYNOPSIS
풀에서 열의 정보 형식 및 민감도 레이블을 SQL 있습니다.
...
## 설명
Set-AzSynapseSqlPoolSensitivityClassification cmdlet은 SQL 열의 정보 형식 및 민감도 레이블을 SQL 설정합니다.

## 예제

### 예제 1: Azure Synapse SQL 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
...
### 예제 2: Azure Synapse SQL 열의 권장 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
...
### 예제 3: 배관을 사용하여 Azure Synapse SQL 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
