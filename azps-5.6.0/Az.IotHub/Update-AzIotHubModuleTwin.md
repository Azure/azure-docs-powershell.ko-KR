...
## 설명
디바이스 쌍을 업데이트하거나 대체합니다. 자세한 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-module-twins 내용은 를 참조하세요.
...
업데이트된 원하는 속성으로 디바이스 모듈 쌍 개체를 반환합니다.
...
업데이트된 태그 속성으로 디바이스 모듈 쌍 개체를 반환합니다.
...
### -부분
모듈 쌍의 태그 및 원하는 속성만 부분적으로 업데이트할 수 있습니다.
