...
IoT Hub에서 대상 IoT 디바이스에 모듈을 생성합니다.
...
Azure IoT Hub에 포함된 모든 인증서 또는 특정 인증서를 나열합니다. 
