...
## 설명
IoT Hub를 보조 위치로 장애 조치(failover)를 트리거합니다. 이 작업은 솔루션에 대한 다운 시간 및 원격 분석 손실을 유발합니다. 이 작업은 장기 실행 작업으로 완료하는 데 몇 분 정도 걸릴 수 있습니다. 사용 시 주의하세요.
...
"myiothub" IoT Hub의 장애 조치(failover) 프로세스를 시작합니다.
...
백그라운드에서 "myiothub" IoT Hub의 장애 조치(failover) 프로세스를 시작합니다.
