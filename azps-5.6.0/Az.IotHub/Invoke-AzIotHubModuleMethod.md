...
## 설명
Edge 모듈 메서드를 호출합니다. 자세한 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods 내용은 를 참조하세요.
...
### -ConnectionTimeOut
연결이 성공적으로 완료될 때까지 기다리는 시간(초)입니다.
기본값은 10입니다.
...
### -페이로드
이 디바이스 모듈에서 호출할 메서드에 대한 페이로드입니다.
...
### -ResponseTimeOut
결과가 직접 메서드에서 수신될 때까지 기다리는 시간(초)입니다.
기본값은 10입니다.
