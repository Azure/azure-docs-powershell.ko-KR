...
자세한 내용은 https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
키 "newKey"와 값 "newValue"가 있는 새 보강을 추가합니다. 이 새 보강은 "엔드포인트1" 및 "엔드포인트2" 엔드포인트에 적용됩니다.
