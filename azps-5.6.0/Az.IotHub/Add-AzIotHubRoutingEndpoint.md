...
## 설명
IoT Hub에 새 엔드포인트를 추가합니다. 지원되는 엔드포인트에 대한 자세한 내용은 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
"myiothub" IoT Hub에 EventHub 형식의 새 엔드포인트 "E2"를 추가합니다.
...
"myiothub" IoT Hub에 AzureStorageContainer 형식의 새 엔드포인트 "S1"을 추가합니다.
