...
## 설명
지정된 IotHub와 연결된 Eventhub에서 소비자 그룹을 만듭니다.

## 예제

### 예제 1: 원격 분석 에도 소비자 그룹 추가
```
...
"myiothub"이라는 iothub의 원격 분석 이벤트에 대한 eventhub에 "myconsumergroup"이라는 새 소비자가 추가됩니다.
...
추가할 EventHub ConsumerGroup의 이름입니다.
