...
## 설명
에지 배포는 사용자 정의 메트릭을 사용하여 수요 평가를 만들 수 있습니다.
자세한 https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring 내용은 를 참조하세요.
...
디바이스가 건물 9에서 태그가 지정되어 환경이 '테스트'인 경우 조건에 적용되는 3의 우선 순위가 있는 Edge 배포를 만드십시오.
...
### -Priority
경쟁 규칙(가장 높은 승리)의 경우 배포의 가중치입니다.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDMicrosoft.Azure.Commands.Management.IotHub.Models.PSD
