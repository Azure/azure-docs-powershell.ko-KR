...
종류 "java"를 사용하여 리소스 그룹 "testgroup"에서 "test"로 명명된 새 애플리케이션 인사이트 리소스 추가
...
Application Insights 분석에 액세스하기 위한 네트워크 액세스 유형입니다. 값은 '사용' 또는 '사용 안 되어' 입니다.
...
Application Insights 쿼리에 액세스하기 위한 네트워크 액세스 유형입니다. 값은 '사용' 또는 '사용 안 되어' 입니다.
