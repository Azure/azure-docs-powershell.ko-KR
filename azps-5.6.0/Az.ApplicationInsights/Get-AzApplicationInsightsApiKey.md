...
### 예제 1 애플리케이션 인사이트 리소스에 대한 Api 키 Get
```
...
### 예제 2 애플리케이션 인사이트 리소스에 대한 특정 API 키 사용
```
...
"testGroup"의 리소스 "테스트"에 대한 ID가 "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867"인 특정 애플리케이션 인사이트 api 키를 얻습니다.
