...
### 예제 1 애플리케이션 인사이트 리소스에 대한 새 Api 키 만들기
```
...
리소스 그룹 "testGroup"의 리소스 "test"에 대한 "ReadTelemetry", "WriteAnnotations"를 사용하여 "testapiKey"로 애플리케이션 인사이트 api 키 설명을 만들 수 있습니다.
