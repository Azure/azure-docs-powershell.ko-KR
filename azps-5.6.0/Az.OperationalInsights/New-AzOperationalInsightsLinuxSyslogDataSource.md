...
## 설명
**New-AzOperationalInsightsLinuxSyslogDataSource** cmdlet은 작업 영역의 연결된 Linux 컴퓨터에 syslog 데이터 원본을 추가합니다.
...
### -CollectCritical
Operational Insights가 중요한 메시지를 수집하는지 나타냅니다.
...
### -CollectDebug
Operational Insights가 디버그 메시지를 수집하는지 나타냅니다.
...
### -CollectEmergency
Operational Insights가 긴급 메시지를 수집하는지 나타냅니다.
...
### -CollectInformational
Operational Insights가 정보 메시지를 수집하고 있습니다.
...
### -CollectNotice
Operational Insights가 알림 메시지를 수집하는지 나타냅니다.
...
### -Name
데이터 원본의 이름을 지정합니다. 이름은 Azure Portal에 노출되지 않습니다. 고유하면 문자열을 사용할 수 있습니다.
...
### -ResourceGroupName
Linux 컴퓨터가 포함된 리소스 그룹의 이름을 지정합니다.
