...
## SYNOPSIS
지정된 인텔리전스 팩을 활성화하거나 사용하지 않도록 설정합니다.
...
## 설명
**Set-AzOperationalInsightsIntelligencePack** cmdlet을 사용하면 활성화가  설정되어 있는 경우 지정된 인텔리전스 팩을 $True 설정하고 활성화가 설정되어 있는 경우 사용하지 않도록 $False. 
