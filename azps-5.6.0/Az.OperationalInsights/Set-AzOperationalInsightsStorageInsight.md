...
## 설명
**Set-AzOperationalInsightsStorageInsight** cmdlet은 Storage Insight의 구성을 변경합니다.

## 예제

### 예제 1: 이름으로 Storage Insight 수정
```
...
이 명령은 MyStorageInsight라는 Storage Insight가 읽는 테이블을 수정합니다.

### 예제 2: 작업 영역 개체를 사용하여 Storage Insight 수정
```
...
두 번째 명령은 MyStorageInsight라는 Storage Insight가 읽는 컨테이너를 수정합니다.

## 매개 변수

### -Containers
데이터를 제공하는 컨테이너 목록을 지정합니다.
...
### -작업 영역
Storage Insight를 포함하는 작업 공간을 지정합니다.
