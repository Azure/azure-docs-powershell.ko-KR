...
PeerAsn 65000을 사용하여 시애틀 시설에서 단일 연결로 새 Direct 피어링 만들기
...
### -DirectConnection
이 명령에 대한 New-AzExchangePeeringConnection 파이프를 사용하여 새 직접 연결을 생성합니다.
...
### -ExchangeConnection
이 명령에 대한 New-AzExchangePeeringConnection 새 Exchange 연결을 생성합니다.
...
### -PeerAsnResourceId
피어 Asn 리소스 ID. Get-AzPeerAsn ID를 검색합니다.
...
### -PeeringLocation
Azure 지역과 다른 물리적 위치입니다.
Get-AzPeeringLocation \<kind\> -Kind를 키로 사용하여 도시 이름을 사용 합니다.
...
### -Sku
명시적으로 Basic_Direct_Free 선택해야 Premium_Direct_Free 선택하거나 선택을 선택합니다.
