...
공급자 및 피어링 위치를 통해 피어링 서비스 개체를 만듭니다. 를 사용하여 에 사용 `Get-AzPeeringServiceProvider``Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Azure 지역과 다른 물리적 위치입니다. Get-AzPeeringServiceLocation [-Country] 사용 <country>
...
### -Tag
Microsoft InputObject 서비스에 연결되는 태그입니다.
