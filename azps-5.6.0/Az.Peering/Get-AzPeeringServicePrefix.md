...
## 설명
피어링 서비스 개체에 대한 피어링 서비스 프리픽스 나열
...
파이핑 명령을 기반으로 피어링 서비스에 대한 도두를 얻습니다.
...
리소스 ID를 통해 피어링 서비스에 대한 특정 도두를 얻습니다.
...
확장된 특성이 있는 피어링 서비스에 대한 특정 도두를 얻습니다.
...
### -PeeringServiceName
피어링 서비스 이름입니다. 새 피어링 서비스에 New-AzPeeringService cmdlet을 사용하거나 목록에 Get-AzPeeringService 수 있습니다.
