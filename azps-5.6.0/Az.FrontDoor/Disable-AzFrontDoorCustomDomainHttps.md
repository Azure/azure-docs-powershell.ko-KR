...
### 예제 1: FrontDoorName 및 ResourceGroupName을 사용하여 사용자 지정 도메인에 대해 HTTPS를 사용하지 않도록 설정합니다.
```powershell
...
FrontDoorName을 "frontdoor1"로, ResourceGroupName을 "resourcegroup1"으로 사용하여 사용자 지정 도메인 "frontendpointname1-custom-xyz"에 대해 HTTPS를 사용하지 않도록 설정합니다.

### 예제 2: PSFrontendendpoint 개체가 있는 사용자 지정 도메인에 대해 HTTPS를 사용하지 않도록 설정합니다.
```powershell
...
PSFrontendEndpoint 개체가 있는 사용자 지정 도메인에 대해 HTTPS를 사용하지 않도록 설정합니다.

### 예제 3: ResourceId를 사용하여 사용자 지정 도메인에 대해 HTTPS를 사용하지 않도록 설정합니다.
```powershell
...
### -ResourceId
https를 사용하지 않도록 설정하는 프런트 도어 엔드포인트의 리소스 ID
