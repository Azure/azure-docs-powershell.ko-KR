...
Front Door 만들기를 위한 PSFrontendpoint 개체를 만듭니다.
...
### -CertificateType
프런트 엔드포인트에 대한 보안 연결에 사용되는 인증서 유형
...
해당하는 경우 세션에 대해 몇 초 만에 사용할 TTL입니다. 기본값은 0입니다.
