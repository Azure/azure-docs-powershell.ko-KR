...
### -MatchVariable
변수 일치.
가능한 값에는 'RemoteAddr', 'RequestMethod', 'QueryString', 'PostArgs', 'RequestUri', 'RequestHeader', 'RequestBody', 'SocketAddr'가 포함됩니다.
...
### -NegateCondition
이 조건이 negate 조건이지 기본값이 false인 경우를 설명합니다.
...
### -OperatorProperty
일치할 연산자를 설명합니다.
가능한 값은 'Any', 'IPMatch', 'GeoMatch', 'Equal', 'Include', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'BeginsWith', 'EndsWith', 'RegEx' 등입니다.
...
### -Transform
적용할 변환입니다. 가능한 값은 '소문자', '대문자', 'Trim', 'UrlDecode', 'UrlEncode', 'RemoveNulls'를 포함합니다.
