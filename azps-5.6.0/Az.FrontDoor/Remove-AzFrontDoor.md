...
### 예제 1: 현재 구독에서 리소스 그룹 "rg1"에서 "frontdoor1"을 제거합니다.
```powershell
PS C:\> Remove-AzFrontDoor -Name "frontdoor1" -ResourceGroupName "rg1"
```

현재 구독에서 리소스 그룹 "rg1"에서 "frontdoor1"을 제거합니다.
...
### 예제 4: 현재 구독에서 이름 "frontdoor1"이 있는 모든 FrontDoors를 제거합니다.
```powershell
PS C:\> Remove-AzFrontDoor -Name "frontdoor1" | Remove-AzFrontDoor
```

현재 구독에서 이름 "frontdoor1"이 있는 모든 FrontDoors를 제거합니다.
