...
## 설명
**Get-AzFrontDoor** cmdletGet는 제공된 정보와 일치하는 현재 구독의 모든 기존 Front Doors를 제공합니다.

## 예제

### 예제 1: 현재 구독에서 모든 FrontDoors를 얻습니다.
```powershell
...
현재 구독에서 모든 FrontDoors를 얻습니다.

### 예제 2: 현재 구독에서 리소스 그룹 "rg1"의 모든 FrontDoors를 얻습니다.
```powershell
...
현재 구독에서 리소스 그룹 "rg1"에서 모든 FrontDoors를 얻습니다.

### 예제 3: 현재 구독에서 "frontDoor1"으로 리소스 그룹 "rg1"에서 FrontDoors를 얻습니다.
```powershell
...
현재 구독에서 "frontDoor1"으로 리소스 그룹 "rg1"에서 FrontDoors를 얻습니다.
