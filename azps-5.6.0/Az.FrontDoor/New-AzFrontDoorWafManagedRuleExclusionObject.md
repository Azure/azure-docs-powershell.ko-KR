...
### -연산자
선택기 일치 시 사용할 연산자, EqualsAny는 선택기 없음(지정된 형식의 모든 일치 변수)을 의미하지 않습니다.
...
### -Selector
연산자를 사용하여 일치하는 선택기 패턴(연산자가 EqualsAny이 아닌 경우)
...
예를 들어 QueryStringArgNames는 선택기와 주어진 연산자와 일치하는 GET 매개 변수를 제외합니다.
