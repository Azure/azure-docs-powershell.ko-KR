...
### ByFieldsWithBackendPoolsSettingParameterSet(기본값)
```
...
## 설명
**New-AzFrontDoor** cmdlet은 현재 구독에서 지정된 리소스 그룹에 새 Azure Front Door 부하 균형 조정기를 만듭니다.

## 예제

### 예제 1: 주어진 매개 변수에 따라 Front Door 만들기
```powershell
...
주어진 매개 변수에 따라 Front Door를 생성합니다.
...
### -EnabledState
Front Door 부하 저울의 EnabledState입니다.
