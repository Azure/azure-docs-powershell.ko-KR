...
## 설명
**Get-AzFrontDoorFrontendpoint** cmdlet은 제공된 정보와 일치하는 현재 Front Door 리소스에 있는 모든 기존 프런트 엔드 엔드포인트를 제공합니다.
...
### 예제 2: "rg1" 리소스 그룹의 일부인 Front Door "frontdoor1"에서 이름 "frontdoor1-azurefd-net"을 사용하여 프런트 엔드 엔드포인트를 얻습니다.
```powershell
...
리소스 그룹 "rg1"의 일부인 Front Door "frontdoor1"에서 이름 "frontdoor1-azurefd-net"을 사용하여 프런트 엔드 엔드포인트를 얻습니다.
