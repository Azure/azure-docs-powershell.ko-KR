...
명령은 상태와 정책 설정을 $enabledState 모드로, requestBodyCheck를 false로 $enabledMode FileUploadLimitInMb를 $fileUploadLimitInMb 및 MaxRequestBodySizeInKb를 $$maxRequestBodySizeInKb.
새 정책Settings는 새 정책에 $condition.
...
방화벽 정책의 정책 설정에서 MaxRequestBodySizeInKb.
