...
## SYNOPSIS
Virtual Network Gateway 연결에서 패킷 캡처 작업을 중지합니다.
...
## 설명
Virtual Network Gateway 연결에서 패킷 캡처 작업을 중지하고 해당 저장소 컨테이너의 SasUrl에 결과를 업로드합니다.
...
### -SasUrl
가상 네트워크 게이트웨이에서 패킷 캡처 중지에 대한 SAS URL입니다.
