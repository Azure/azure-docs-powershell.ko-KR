...
이 예제에서는 Mysql이라는 sql Server에 속하는 모든 개인 엔드포인트 연결 목록을 반환합니다.
...
개인 엔드포인트 연결이 속한 개인 링크 리소스의 Azure 리소스 관리자 ID입니다.
...
### -ResourceId
개인 엔드포인트 연결의 Azure 리소스 관리자 ID입니다.
