...
## SYNOPSIS
자동 승인을 통해 개인 엔드포인트에 연결할 수 있는 개인 링크 서비스 ID의 배열을 얻습니다.
...
## 설명
**Get-AzAutoApprovedPrivateLinkService는** 자동 승인을 통해 개인 엔드포인트에 연결할 수 있는 개인 링크 서비스 ID의 배열을 제공합니다.
...
이 예제에서는 자동 승인된 개인 엔드포인트에 연결할 수 있는 개인 링크 서비스 ID 배열을 반환합니다.
