...
## SYNOPSIS
Azure 가상 네트워크 게이트웨이의 BGP 피어 나열
...
## 설명
이 명령은 Azure 가상 네트워크 게이트웨이가 피어링하도록 구성된 BGP 피어를 열소합니다. 각 피어의 상태도 부여됩니다.
...
리소스 그룹 리소스Group에서 GatewayName이라는 Azure 가상 네트워크 게이트웨이에 대한 BGP 피어를 검색합니다.
