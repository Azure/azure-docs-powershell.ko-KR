...
구성된 모든 원본 탭 VM의 트래픽은 이 대상 IP + 포트로 라우팅됩니다.
...
구성된 모든 원본 탭 VM의 트래픽은 이 LoadBalancer IpConfiguration으로 라우팅됩니다. 기본 대상 포트는 4789입니다.
...
대상 부하 균형기 프런트 엔드 IP 구성 리소스의 참조입니다.
