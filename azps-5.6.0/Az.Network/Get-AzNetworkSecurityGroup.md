...
## 설명
**Get-AzNetworkSecurityGroup** cmdlet은 Azure 네트워크 보안 그룹을 얻습니다.

## 예제

### 예제 1: 기존 네트워크 보안 그룹 검색
```powershell
...
이 명령은 리소스 그룹 "rg1"에서 Azure 네트워크 보안 그룹 "nsg1"의 콘텐츠를 반환합니다.

### 예제 2: 필터링을 사용하여 기존 네트워크 보안 그룹 나열
```powershell
...
이 명령은 "nsg"로 시작하는 Azure 네트워크 보안 그룹의 콘텐츠를 반환합니다.
...
### -Name
이 cmdlet이 도착하는 네트워크 보안 그룹의 이름을 지정합니다.
...
### -ResourceGroupName
네트워크 보안 그룹이 속한 리소스 그룹의 이름을 지정합니다.
