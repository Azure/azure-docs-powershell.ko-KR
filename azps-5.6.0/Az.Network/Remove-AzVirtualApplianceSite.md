...
## SYNOPSIS
네트워크 가상 어플라이언스 리소스에서 가상 어플라이언스 사이트를 제거합니다.
...
## 설명
Remove-AzVirtualApplianceSite 명령은 네트워크 가상 어플라이언스 리소스에서 Virtual Appliance 사이트를 제거합니다.
...
Virtual Appliance 사이트 리소스를 삭제합니다. 
...
이 사이트와 연결된 네트워크 가상 어플라이언스의 리소스 ID입니다.
