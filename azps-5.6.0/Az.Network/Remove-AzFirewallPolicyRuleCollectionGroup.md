...
## SYNOPSIS
Azure 방화벽 정책에서 Azure 방화벽 정책 규칙 컬렉션 그룹 제거
...
## 설명
**Remove-AzFirewallPolicyRuleCollectionGroup** cmdlet은 Azure 방화벽 정책에서 규칙 컬렉션 그룹을 제거합니다.
...
이 예제에서는 방화벽 정책 개체에서 "testRcGroup"이라는 방화벽 정책 규칙 콜lction 그룹을 $fp
...
이 예제에서는 "fpName"이라는 방화벽에서 "testRcGroup"이라는 방화벽 정책 규칙 콜lction 그룹을 제거합니다.
