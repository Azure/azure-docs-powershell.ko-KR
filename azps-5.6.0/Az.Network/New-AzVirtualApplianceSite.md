...
## SYNOPSIS
네트워크 가상 어플라이언스에 연결된 사이트를 만드십시오.
...
## 설명
New-AzVirtualApplianceSite 가상 어플라이언스 리소스에 연결된 Virtual Appliance 사이트를 만듭니다.
...
리소스 그룹( testrg)에서 새 Virtual Appliance 사이트를 만드십시오.
