...
## 설명
**Get-AzLoadBalancer** cmdlet은 리소스 그룹에 포함된 하나 이상의 Azure 부하 분산을 제공합니다.
...
이 명령은 MyLoadBalancer라는 부하 분산기 를 얻습니다.
이 cmdlet을 실행하려면 먼저 부하 균형 조정기가 있어야 합니다.

### 예제 2: 필터링을 사용하여 부하 잔액 나열
```
