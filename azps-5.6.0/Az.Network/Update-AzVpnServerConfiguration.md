...
## 설명
**Update-AzVpnServerConfiguration** cmdlet을 사용하면 다른 VpnProtocols, VpnAuthenticationTypes, IpsecPolicies로 기존 VpnServerConfiguration을 업데이트하고 사이트 연결 지점에 대한 고객의 요구 사항에 따라 선택한 VPN 인증 형식 관련 매개 변수를 설정할 수 있습니다.
...
위의 명령은 기존 VpnServerConfiguration을 IkeV2로 VpnProtocol로 업데이트합니다.

## 매개 변수

### -AadAudience
P2S AAD 인증에 대한 AAD 대상입니다.
...
파일 경로를 추가할 VpnClientRootCertificates 목록
