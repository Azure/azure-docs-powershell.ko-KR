...
**New-AzLocalNetworkGateway** cmdlet은 Azure에 연결할 게이트웨이의 이름, 리소스 그룹 이름, 위치 및 IP 주소를 기반으로 프레미스 게이트웨이를 나타내는 개체를 만듭니다.
...
"23.99.221.164"의 IP 주소와 "10.5.51.0/24" on-prem의 주소가 있는 위치 "myRG"에 리소스 그룹 "myLocalGW" 이름으로 로컬 네트워크 게이트웨이의 개체를 만듭니다.
