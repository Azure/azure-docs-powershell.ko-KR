...
## 설명
**Remove-AzNetworkProfile** cmdlet은 컨테이너 네트워크 인터페이스(컨테이너 네트워크 인터페이스 구성과 대조)가 없는 경우 네트워크 프로필을 제거합니다.
...
그러면 리소스 그룹 rg1에서 이름 np1이 있는 네트워크 프로필이 제거됩니다.
...
### -ResourceId
네트워크 프로필의 Azure 리소스 관리자 리소스 ID입니다.
