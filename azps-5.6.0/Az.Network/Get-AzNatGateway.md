...
## SYNOPSIS
리소스 그룹의 이름 또는 NatGateway ID 또는 리소스 그룹의 모든 Nat Gateway 리소스를 리소스 그룹에서 얻습니다.
...
## 설명
리소스 그룹의 이름 또는 NatGateway ID 또는 리소스 그룹의 모든 Nat Gateway 리소스를 이름으로 리소스 그룹에서 Nat Gateway 리소스를 얻습니다.
