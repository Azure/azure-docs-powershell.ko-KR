...
## 설명
분기 트래픽에 분기를 사용하도록 설정하거나 사용하지 않도록 가상 라우터를 업데이트합니다.
...
분기 트래픽에 분기를 허용하도록 Virtual 라우터를 업데이트합니다.
...
분기 트래픽을 차단하기 위해 Virtual 라우터를 업데이트합니다.

## 매개 변수

### -AllowBranchToBranchTraffic
가상 라우터에 대한 분기 트래픽을 분기할 수 있도록 플래그를 지정합니다.
