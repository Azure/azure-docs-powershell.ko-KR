...
## 설명
**Remove-AzLoadBalancer** cmdlet은 Azure 부하 분산기를 제거합니다.
...
이 명령은 MyResourceGroup이라는 리소스 그룹에서 MyLoadBalancer라는 부하 분산기 를 삭제합니다.
...
### -Force
리소스가 할당되어 있는지 여부에 관계없이 이 cmdlet이 부하 균형 조정기를 제거합니다.
