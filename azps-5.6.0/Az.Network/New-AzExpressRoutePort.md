...
## 설명
**New-AzExpressRoutePort** cmdlet은 Azure ExpressRoutePort를 만듭니다.
...
### -Link
ExpressRoutePort 리소스의 물리적 링크 집합
...
### -PeeringLocation
ExpressRoutePort가 물리적으로 매핑된 피어링 위치의 이름입니다.
