...
## SYNOPSIS
Remove-AzVirtualHubVnetConnection cmdlet은 허브 VNET에 원격 VNET을 피어링하는 Azure Virtual Network 연결을 제거합니다.
...
허브 가상 네트워크 연결을 만든 후 Get-AzHubVirtualNetworkConnection에서 출력의 powershell 배관을 사용하여 허브 가상 네트워크 연결을 제거합니다.
