...
## SYNOPSIS
새 Azure Firewall Policy Nat Rule Collection 만들기
...
## 설명
**New-AzFirewallPolicyNatRuleCollection** cmdlet은 Azure 방화벽 정책에 대한 Nat 규칙 컬렉션을 만듭니다.
...
이 예제에서는 네트워크 규칙이 있는 nat 규칙 컬렉션을 만듭니다.
