...
위의 리소스 그룹 "testRG", Virtual WAN 및 Azure의 해당 리소스 그룹에 미국 서부의 Virtual Hub가 생성됩니다. 가상 허브에는 주소 공간 "10.0.1.0/24" 및 경로 테이블이 연결됩니다.

이 예제는 예제 2와 비슷하지만 가상 허브에 경로 테이블을 연결합니다.
...
### -HubVnetConnection
이 Virtual Hub와 연결된 허브 가상 네트워크 연결입니다.
