...
## SYNOPSIS
가상HubRoute 개체를 만듭니다. 이 개체를 매개 변수로 전달할 Add-AzVirtualHubRouteTable 있습니다. 
...
위의 명령은 VirtualHubRoute 개체를 만든 다음 VirtualHubRouteTable 리소스에 추가하고 VirtualHub로 설정할 수 있습니다.
