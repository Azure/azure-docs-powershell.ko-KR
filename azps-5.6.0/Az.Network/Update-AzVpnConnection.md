...
VPN 연결은 VPN 게이트웨이를 VPN 사이트로 Azure로 나타내는 원격 고객 분기에 연결하는 IPsec 연결을 만듭니다.
...
그런 다음, 새 IpSecPolicy를 갖기 위해 연결은 Set-AzVpnConnection 합니다.
...
그런 다음 보안 문자열 구문을 사용하여 새 공유 키를 하게 하여 연결이 업데이트됩니다.
