...
## 설명
**Get-AzExpressRouteCircuitRouteTable** cmdlet은 ExpressRoute 회로의 자세한 경로 테이블을 검색합니다. 경로 테이블은 모든 경로를 표시하거나 필터링하여 특정 피어링 유형에 대한 경로를 표시하도록 필터링할 수 있습니다. 경로 테이블을 사용하여 피어링 구성 및 연결의 유효성을 검사할 수 있습니다.
