...
## SYNOPSIS
애플리케이션 게이트웨이에 다시 덧붙이는 규칙 집합을 추가합니다.
...
## 설명
**Add-AzApplicationGatewayRewriteRuleSet** cmdlet은 애플리케이션 게이트웨이에 재작성 규칙 집합을 추가합니다.
...
두 번째 명령은 애플리케이션 게이트웨이에 다시 기록 규칙 집합을 추가합니다.
