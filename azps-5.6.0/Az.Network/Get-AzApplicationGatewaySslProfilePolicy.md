...
## SYNOPSIS
애플리케이션 게이트웨이 SSL 프로필의 SSL 정책을 얻습니다.
...
## 설명
**Get-AzApplicationGatewaySslProfilePolicy** cmdlet은 애플리케이션 게이트웨이 SSL 프로필의 SSL 정책을 얻습니다.
...
첫 번째 명령은 ResourceGroup01이라는 리소스 그룹에 ApplicationGateway01이라는 애플리케이션 게이트웨이를 $AppGw 변수에 저장합니다. 두 번째 명령은 SslProfile01이라는 SSL 프로필을 $AppGw 변수에 $SslProfile 저장합니다. 마지막 명령은 SSL 프로필에서 SSL 정책을 $SslProfile 및 $sslpolicy 변수에 저장합니다.
