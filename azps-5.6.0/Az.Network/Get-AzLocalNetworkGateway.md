...
**Get-AzLocalNetworkGateway** cmdlet은 이름 및 리소스 그룹 이름을 기반으로 프레미스 게이트웨이를 나타내는 개체를 반환합니다.

## 예제

### 예제 1: 로컬 네트워크 게이트웨이를 얻다
```powershell
...
리소스 그룹 "myRG" 내에서 "myLocalGW1"으로 로컬 네트워크 게이트웨이의 개체를 반환합니다.
