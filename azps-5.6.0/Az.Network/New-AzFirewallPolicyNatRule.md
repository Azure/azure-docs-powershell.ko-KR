...
## 설명
**New-AzFirewallPolicyNatRule** cmdlet은 Azure 방화벽 정책에 대한 NAT 규칙을 만듭니다.
...
이 예제에서는 원본 주소, 프로토콜, 대상 주소, 대상 포트, 번역된 주소 및 번역된 포트를 사용하여 NAT 규칙을 만듭니다.
...
이 예제에서는 원본 주소, 프로토콜, 대상 주소, 대상 포트, 번역된 fqdn 및 번역된 포트를 사용하여 NAT 규칙을 만듭니다.
