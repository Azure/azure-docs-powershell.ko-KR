...
## 설명
**Get-AzApplicationGatewaySku** cmdlet은 애플리케이션 게이트웨이의 SKU(재고 유지 장치)를 얻습니다.

## 예제

### 예제 1: 애플리케이션 게이트웨이 SKU를 얻다
```
...
두 번째 명령은 ApplicationGateway01이라는 애플리케이션 게이트웨이의 SKU를 얻게 하여 결과를 $SKU.
