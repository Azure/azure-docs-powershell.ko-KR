...
이 명령은 "westus"의 리소스 그룹 "rg1"에서 "nsg1"이라는 새 Azure 네트워크 보안 그룹을 만듭니다.
...
단계:1 인터넷에서 포트 3389로 액세스를 허용하는 보안 규칙 만들기
단계:2 인터넷에서 포트 80으로 액세스를 허용하는 보안 규칙 만들기
단계:3 NSG-FrontEnd라는 새 NSG에 위에서 만든 규칙을 추가합니다.
...
### -SecurityRules
네트워크 보안 그룹에서 만들 네트워크 보안 규칙 개체 목록을 지정합니다.
