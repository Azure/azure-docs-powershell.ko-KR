...
## 설명
New-AzNetworkWatcherProtocolConfiguration cmdlet은 새 프로토콜 구성 개체를 만듭니다. 이 개체는 지정된 조건을 사용하여 연결 검사 세션 중에 프로토콜 구성을 제한하는 데 사용됩니다. 

## 예제

### 예제 1: 프로토콜 구성을 사용하여 VM에서 웹 사이트로의 네트워크 감시자 연결 테스트
```
...
이 예제에서는 Azure의 VM에서 연결과 연결 www.bing.com.
