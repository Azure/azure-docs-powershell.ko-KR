...
## 설명
**New-AzPublicIpPrefix** cmdlet은 공용 IP 프리픽스를 만듭니다.

## 예제

### 예제 1: 새 공용 IP 연결부 만들기
```powershell
PS C:\> $publicIpPrefix = New-AzPublicIpPrefix -Name $prefixName -ResourceGroupName $rgName -PrefixLength 30
```

이 명령은 새 공용 IP 연결부 리소스를 만듭니다. 

### 예제 2: 새 전역 공용 IP 연결부 만들기
```powershell
...
이 명령은 새 전역 공용 IP 강두사 리소스를 만듭니다. 
...
### -CustomIpPrefix
이 PublicIpPrefix가 연결된 CustomIpPrefix
