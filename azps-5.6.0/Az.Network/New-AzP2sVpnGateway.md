...
## SYNOPSIS
사이트 연결 지점을 위해 VirtualHub에서 새 P2SVpnGateway를 생성합니다.
...
## 설명
New-AzP2sVpnGateway cmdlet을 사용하면 지점 및 사이트 클라이언트에서 Azure VirtualWan으로의 지점 및 사이트 연결에 대한 VirtualHub에서 새 P2SVpnGateway를 만들 수 있습니다.
...
New-AzP2sVpnGateway cmdlet을 사용하면 VirtualHub for Point to Site 연결을 사용하여 새 P2SVpnGateway를 만들 수 있습니다.
...
### -VirtualHub
VirtualHub 이 P2SVpnGateway를 연결해야 합니다.
...
### -VirtualHubId
VirtualHub 이 P2SVpnGateway의 ID를 연결해야 합니다.
...
이 P2SVpnGateway에서 라우팅 기본 설정 인터넷을 사용하도록 설정하려면 플래그를 지정합니다.
