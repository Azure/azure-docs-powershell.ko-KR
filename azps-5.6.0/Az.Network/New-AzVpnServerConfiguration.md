...
## SYNOPSIS
사이트 연결을 지점에 대한 새 VpnServerConfiguration을 생성합니다.
...
## 설명
**New-AzVpnServerConfiguration** cmdlet을 사용하면 다양한 VpnProtocols, VpnAuthenticationTypes, IpsecPolicies를 사용하여 새 VpnServerConfiguration을 만들고 사이트 연결 지점에 대한 고객의 요구 사항에 따라 선택한 VPN 인증 형식 관련 매개 변수를 설정할 수 있습니다.
...
사이트 연결을 지점에 대한 새 VpnServerConfiguration을 생성합니다. (자동 재생)
