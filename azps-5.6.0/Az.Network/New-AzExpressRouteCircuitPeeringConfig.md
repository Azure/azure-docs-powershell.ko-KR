...
## 설명
**New-AzExpressRouteCircuitPeeringConfig** cmdlet은 ExpressRoute 회로에 피어링 구성을 추가합니다. ExpressRoute 회로는 공용 인터넷 대신 연결 공급자를 사용하여 Microsoft 클라우드에 프레미스 네트워크를 연결합니다.

## 예제

### 예제 1: 피어링 구성을 사용하여 새 ExpressRoute 회로 만들기
```powershell
$parameters = @{
