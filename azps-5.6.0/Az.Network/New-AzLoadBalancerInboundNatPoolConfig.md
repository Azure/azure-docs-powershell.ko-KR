...
## 설명
**New-AzLoadBalancerInboundNatPoolConfig** cmdlet은 부하 분산기에 대한 인바운드 NAT 풀 구성을 만듭니다.
...
### -EnableFloatingIP
AlwaysOn 가용성 그룹을 구성하는 데 필요한 부동 IP 기능에 SQL 엔드포인트를 구성합니다. 이 설정은 서버의 SQL AlwaysOn 가용성 그룹을 사용할 SQL 필요합니다. 엔드포인트를 만든 후 이 설정을 변경할 수 없습니다.
...
TCP 유휴 연결의 시간 제한입니다. 값은 4분에서 30분 사이로 설정할 수 있습니다. 기본값은 4분입니다. 이 요소는 프로토콜이 TCP로 설정되어 있는 경우만 사용됩니다.
