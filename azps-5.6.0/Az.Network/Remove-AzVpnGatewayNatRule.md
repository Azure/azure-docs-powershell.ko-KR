...
위의 리소스 그룹, Virtual WAN, Virtual Network, Virtual Hub, VpnGateway 및 해당 VpnGateway와 연결된 NAT 규칙을 만들 것입니다.
그런 다음 NAT 규칙 이름을 사용하여 NAT 규칙을 제거합니다.
