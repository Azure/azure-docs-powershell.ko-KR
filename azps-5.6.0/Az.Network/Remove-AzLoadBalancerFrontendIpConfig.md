...
## 설명
**Remove-AzLoadBalancerFrontendIpConfig** cmdlet은 Azure 부하 분산기에서 프런트 엔드 IP 구성을 제거합니다.

## 예제

### 예제 1: 부하 저울에서 프런트 엔드 IP 구성 제거
```
...
두 번째 명령은 연결된 프런트 엔드 IP 구성을 부하 $loadbalancer.
