...
위의 리소스 그룹은 "미국 서부"에 리소스 그룹 "testRG"를 만들고 Azure의 해당 리소스 그룹에 Azure Virtual WAN을 생성합니다. VirtualWan은 새 속성으로 업데이트됩니다.

## 매개 변수

### -AllowBranchToBranchTraffic
VirtualWan에 대한 분기 트래픽에 분기할 수 있도록 허용합니다.
...
VirtualWan에 대한 vnet 트래픽에 vnet을 허용합니다.
