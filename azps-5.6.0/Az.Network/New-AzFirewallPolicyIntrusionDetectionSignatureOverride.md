...
## SYNOPSIS
새 Azure 방화벽 정책 침입 감지 서명을 오버라이드 만듭니다.
...
## 설명
**New-AzFirewallPolicyIntrusionDetectionSignatureOverride** cmdlet은 Azure 방화벽 정책 서명 재지정 개체를 만듭니다.

## 예제

### 예제 1: 1. 서명을 오버라이드하여 침입 감지 만들기
```powershell
