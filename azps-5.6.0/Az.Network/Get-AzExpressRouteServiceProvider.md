...
## SYNOPSIS
ExpressRoute 서비스 공급자 및 해당 특성 목록이 표시됩니다.
...
## 설명
**Get-AzExpressRouteServiceProvider** cmdlet은 ExpressRoute 서비스 공급자 및 해당 특성 목록을 검색합니다. 특성에는 위치 및 대역폭 옵션이 포함됩니다.

## 예제

### 예제 1: "실리콘 밸리"의 위치가 있는 서비스 공급자 목록 얻습니다.
```
Get-AzExpressRouteServiceProvider |
