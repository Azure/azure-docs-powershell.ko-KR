...
## 설명
**New-AzPrivateLinkServiceIpConfig** cmdlet은 개인 링크 서비스 IP 구성을 만듭니다. 이 구성은 원본 NAT-ing 개인 엔드포인트에서 들어오는 트래픽에 사용됩니다. 
...
### -PrivateIpAddress
정적 할당이 지정된 경우 ipConfiguration의 개인 IP 주소입니다.
