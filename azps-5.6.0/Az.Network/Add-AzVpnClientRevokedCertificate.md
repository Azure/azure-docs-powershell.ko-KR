...
## 설명
**Add-AzVpnClientRevokedCertificate** cmdlet은 가상 네트워크 게이트웨이에 클라이언트 해지 인증서를 할당합니다.
...
예를 들어 -지문 "E3A38EBA60CAA1C1C162785A2E1C44A15AD450199C3" 다음과 유사한 Windows PowerShell 명령을 사용하여 인증서에 대한 지문 정보를 얻을 수 `Get-ChildItem -Path Cert:\LocalMachine\Root` 있습니다.
위의 명령은 루트 인증서 저장소에 있는 모든 로컬 컴퓨터 인증서에 대한 정보를 얻습니다.
