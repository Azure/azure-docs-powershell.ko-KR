...
## 설명
**New-AzLoadBalancerRuleConfig** cmdlet은 Azure 부하 분산기에 대한 규칙 구성을 만듭니다.
...
처음 세 명령은 첫 번째 명령에서 공용 IP, 프런트 엔드 및 규칙 구성에 대한 프로브를 설정합니다. 첫 번째 명령은 특정 사양을 사용하여 MyLBrule이라는 새 규칙을 만듭니다.

## 매개 변수

### -BackendAddressPool
Load Balancer 규칙 구성과 연결하기 위해 **BackendAddressPool** 개체를 지정합니다.
...
### -BackendPort
이 부하 조정기 규칙 구성과 일치하는 트래픽에 대한 백end 포트를 지정합니다.
...
### -Protocol
부하 균형기 규칙 구성과 일치하는 프로토콜을 지정합니다.
