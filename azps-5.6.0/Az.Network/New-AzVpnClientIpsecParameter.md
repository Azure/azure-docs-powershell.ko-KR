...
## SYNOPSIS
이 명령을 사용하면 사용자가 IpsecEncryption, IpsecIntegrity, IkeEncryption, IkeIntegrity, DhGroup, PfsGroup과 같은 하나 또는 모든 값을 지정하는 VPN ipsec 매개 변수 개체를 만들 수 있습니다.
...
### -DhGroup
초기 SA에 IKE 1단계에서 사용되는 VpnClient DH 그룹입니다.
