...
## 설명
**Remove-AzLoadBalancerOutboundRuleConfig** cmdlet은 Azure 부하 분산기에서 아웃바운드 규칙 구성을 제거합니다.
...
두 번째 명령은 부하 저울에서 연결된 아웃바운드 규칙 구성을 제거합니다.
세 번째 명령은 부하 저울을 업데이트합니다.
