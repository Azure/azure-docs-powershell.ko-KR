...
이 예제에서는 두 개의 서브넷이 있는 리소스 그룹과 가상 네트워크를 만듭니다. 그런 다음, Remove-AzVirtualNetworkSubnetConfig 명령을 사용하여 가상 네트워크의 메모리 내 표현에서 백end 서브넷을 제거합니다. Set-AzVirtualNetwork 를 호출하여 서버 쪽에서 가상 네트워크를 수정합니다.
