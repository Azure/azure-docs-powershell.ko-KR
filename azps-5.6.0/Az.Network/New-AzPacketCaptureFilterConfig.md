...
## 설명
New-AzPacketCaptureFilterConfig cmdlet은 새 패킷 캡처 필터 개체를 만듭니다. 이 개체는 지정된 조건을 사용하여 패킷 캡처 세션 중에 캡처되는 패킷 유형을 제한하는 데 사용됩니다. New-AzNetworkWatcherPacketCapture cmdlet은 여러 필터 개체를 수락하여 작성 가능한 캡처 세션을 사용하도록 설정할 수 있습니다.
