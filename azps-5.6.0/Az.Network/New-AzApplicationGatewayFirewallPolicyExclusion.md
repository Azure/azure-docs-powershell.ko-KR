...
## 설명
**New-AzApplicationGatewayFirewallPolicyExclusion** cmdlet은 방화벽 정책에 대한 새 제외 규칙 목록입니다.
...
이 명령은 RequestHeaderNames라는 변수와 StartWith라는 연산자 및 xyz라는 선택기에 대한 새 제외 항목을 만듭니다. 제외 항목은 $exclusionEntry.
