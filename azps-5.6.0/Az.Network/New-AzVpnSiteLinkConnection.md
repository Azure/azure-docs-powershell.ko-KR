...
위의 리소스 그룹, Virtual WAN, Virtual Network, Virtual Hub 및 VpnSite를 Azure의 "testRG" 리소스 그룹에서 미국 서부에 1개 VpnSiteLinks를 만들 것입니다.
가상 허브에서 VPN 게이트웨이가 생성됩니다.
게이트웨이가 만들어지면 VpnSite의 VpnSiteLink에 New-AzVpnConnection 1개 vpnSiteLink를 사용하여 VpnSite에 연결됩니다.

## 매개 변수

### -ConnectionBandwidth
이 링크 연결에서 처리해야 하는 대역폭은 mbps입니다.
...
이 링크 연결에 대해 로컬 Azure IP 주소를 원본 IP로 사용하세요.
