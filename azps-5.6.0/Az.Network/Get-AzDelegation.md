...
## 설명
**Get-AzDelegation** cmdlet은 서브넷에서 명명된 위임을 얻습니다. 위임이 지정되지 않고 제공된 서브넷의 모든 위임이 반환됩니다.
...
첫 번째 줄은 관심 있는 서브넷을 검색합니다. 두 번째 줄은 "myDelegation"이라는 위임에 대한 위임 정보를 보여줍니다.
...
첫 번째 줄은 관심 있는 서브넷을 검색합니다. 두 번째 줄은 $delegations _mySubnet에_ 모든 위임 목록을 저장합니다.
