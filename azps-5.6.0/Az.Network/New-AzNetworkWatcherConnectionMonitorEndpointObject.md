...
이름 : workspaceEndpoint 유형 : MMAWorkspaceMachine ResourceId : /subscriptions/0000000-0000-0000-000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace address : Scope : { "Include": { "Address": "WIN-P0HGNDO2S1B" } } }
...
### -CoverageLevel
엔드포인트에 대한 적용 범위를 테스트합니다.
지원되는 값은 기본값, 낮음, 아래Average, Average, AboveAvergae, Full입니다.
