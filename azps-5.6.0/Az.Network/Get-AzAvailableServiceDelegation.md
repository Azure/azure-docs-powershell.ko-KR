...
## 설명
**Get-AzAvailableServiceDelegation** cmdlet을 사용하면 제공된 위치에서 서브넷에 대해 사용 가능한 모든 서비스 위임을 검색할 수 있습니다. 이 cmdlet은  단일 서브넷에 공존할 수 있는 위임에 대해 설명하지 않습니다.

## 예제

### 1: 사용 가능한 모든 서비스 위임 사용
```powershell
