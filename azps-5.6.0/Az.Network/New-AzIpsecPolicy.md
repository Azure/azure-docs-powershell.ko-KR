...
새 가상 네트워크 게이트웨이 연결에 사용할 IPSec 정책을 생성합니다.
...
### -PfsGroup
새 자식 SA에 대해 IKE 2단계에 사용되는 DH 그룹
...
### -SADataSizeKilobytes
KB의 IPSec 보안 협회(빠른 모드 또는 2단계 SA라고도 하는) 페이로드 크기
...
### -SALifeTimeSeconds
IPSec 보안 협회(빠른 모드 또는 2단계 SA라고도 하는) 수명이 몇 초 만에
