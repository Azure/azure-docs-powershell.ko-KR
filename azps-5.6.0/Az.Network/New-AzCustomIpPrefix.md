...
## 설명
**New-AzCustomIpPrefix** cmdlet은 CustomIpPrefix 리소스를 만듭니다.
...
이 명령은 40.40.40.0/$rgName 24의 cidr를 $prefixName 그룹에서 이름과 함께 새 CustomIpPrefix 리소스를 만듭니다.
