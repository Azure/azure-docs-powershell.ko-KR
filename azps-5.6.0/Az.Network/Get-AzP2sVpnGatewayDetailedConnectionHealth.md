...
## SYNOPSIS
P2SVpnGateway에서 사이트 연결에 대한 현재 지점에 대한 자세한 정보를 얻습니다.
...
## 설명
**Get-AzP2sVpnGatewayDetailedConnectionHealth** cmdlet을 사용하면 P2SVpnGateway에서 사이트 연결에 대한 현재 지점에 대한 자세한 정보를 얻을 수 있습니다. 고객은 이 자세한 상태 정보를 넣을 수 있는 SAS URL을 전달해야 합니다.
...
**Get-AzP2sVpnGatewayDetailedConnectionHealth** cmdlet을 사용하면 P2SVpnGateway에서 사이트 연결에 대한 현재 지점에 대한 자세한 정보를 얻을 수 있습니다. 고객은 전달된 SAS URL 다운로드에서 상태 정보를 다운로드할 수 있습니다. 그러면 사용자 이름, bytes in, bytes out, 할당된 IP 주소와 사이트 연결에 대한 각 지점의 정보가 표시됩니다.
...
### -OutputBlobSasUrl
p2s vpn 연결 상태가 기록될 OutputBlob Sas URL입니다.
