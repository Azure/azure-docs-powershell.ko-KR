...
## SYNOPSIS
VpnSiteLinkConnection과 연결할 수 있는 VpnGateway에서 NAT 규칙을 만듭니다.
...
## 설명
VpnGateway와 연결될 수 있는 VPNGateway에 NAT 규칙을 만듭니다.
...
위의 리소스 그룹, Virtual WAN, Virtual Network, Virtual Hub를 만들 것입니다. 그런 다음 해당 Virtual Hub 아래에 VpnGateway를 만들 것입니다. 그런 다음 이 명령을 사용하여 New-AzVpnGatewayNatRule, NAT 규칙을 만들 수 있습니다. 생성된 VpnGateway와 연결됩니다.
...
### -ParentResourceId
이 NAT 규칙에 대한 부모 VpnGateway의 리소스 ID입니다.
