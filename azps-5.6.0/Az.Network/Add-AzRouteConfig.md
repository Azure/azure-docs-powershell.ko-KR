...
이 명령은 **Get-AzRouteTable** 을 사용하여 RouteTable01이라는 경로 테이블을 얻습니다.
명령은 파이프라인 연산자를 사용하여 현재 cmdlet에 테이블을 전달합니다.
현재 cmdlet은 Route02라는 경로를 추가한 다음, **결과를 Set-AzRouteTable** cmdlet에 전달하여 변경 내용을 반영하기 위해 표를 업데이트합니다.
