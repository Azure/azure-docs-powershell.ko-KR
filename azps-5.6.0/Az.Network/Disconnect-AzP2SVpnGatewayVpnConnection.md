...
## SYNOPSIS
주어진 p2s VPN 게이트웨이로 연결된 VPN 클라이언트 연결 끊기
...
## 설명
**Connection-AzP2sVpnGatewayVpnConnection** cmdlet을 사용하면 P2SVpnGateway에서 사이트 간 현재 지점 연결을 끊을 수 있습니다.
...
### -ResourceId
P2s Virtual Network Gateway 리소스 ID
