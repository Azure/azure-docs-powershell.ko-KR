...
## 설명
**Set-AzApplicationGatewayFirewallPolicy** cmdlet은 Azure 애플리케이션 게이트웨이 방화벽 정책을 업데이트합니다.
...
이 명령은 애플리케이션 게이트웨이 방화벽 정책을 $AppGwFirewallPolicy 설정으로 업데이트하고 업데이트된 게이트웨이를 $UpdatedAppGwFirewallPolicy 저장합니다.
