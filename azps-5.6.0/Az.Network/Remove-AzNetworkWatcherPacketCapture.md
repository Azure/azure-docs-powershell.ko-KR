...
## 설명
Remove-AzNetworkWatcherPacketCapture 캡처 리소스를 제거합니다. Remove-AzNetworkWatcherPacketCapture를 호출하기 전에 Stop-AzNetworkWatcherPacketCapture 호출하는 것이 좋습니다. 패킷 캡처 세션이 실행되는 Remove-AzNetworkWatcherPacketCapture 패킷 캡처를 저장하지 않을 수 있습니다. 캡처 데이터가 포함된 .cap 파일을 제거하기 전에 세션이 중지된 경우 제거되지 않습니다. 
