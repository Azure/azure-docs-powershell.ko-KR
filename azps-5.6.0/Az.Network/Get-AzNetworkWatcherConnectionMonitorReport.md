...
## 설명
Get-AzNetworkWatcherConnectionMonitorReport cmdlet은 가장 최근 연결 상태의 보고서를 반환합니다.

## 예제

### 예제 1: 지정된 위치에서 이름에 따라 연결 모니터의 가장 최근 연결 스냅숏을 얻습니다.
```
...
이 예제에서는 지정된 연결 모니터의 가장 최근 연결 상태도 쿼리합니다.
