...
## 설명
**Remove-AzFirewall** cmdlet은 Azure 방화벽을 제거합니다.
...
이 예제에서는 방화벽을 만든 다음 삭제합니다. 방화벽을 삭제할 때 프롬프트를 표시하지 않습니다.
...
### -ResourceGroupName
이 cmdlet이 제거하는 방화벽을 포함하는 리소스 그룹의 이름을 지정합니다.
