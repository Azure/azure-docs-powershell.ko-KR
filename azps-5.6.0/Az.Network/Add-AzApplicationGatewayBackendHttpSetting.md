...
## 설명
Add-AzApplicationGatewayBackendHttpSetting cmdlet은 백 엔드 HTTP 설정을 애플리케이션 게이트웨이에 추가합니다.
...
애플리케이션 게이트웨이에 백 엔드 HTTP 설정을 추가합니다. (자동 재생)
...
이 매개 변수에 대해 허용되는 값은 사용 안 되어 있습니다.
...
### -Protocol
애플리케이션 게이트웨이와 백 엔드 서버 간의 통신을 위한 프로토콜을 지정합니다.
