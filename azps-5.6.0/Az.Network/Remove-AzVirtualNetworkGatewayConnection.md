...
## SYNOPSIS
Virtual Network Gateway 연결을 삭제합니다.
...
**Remove-AzVirtualNetworkGatewayConnection** cmdlet은 이름 및 리소스 그룹 이름을 기반으로 연결 개체를 삭제합니다.
...
리소스 그룹 "myRG" 내에서 "myTunnel"으로 Virtual Network Gateway 연결의 개체를 삭제합니다.
...
### -Name
이 cmdlet이 제거한 가상 네트워크 게이트웨이 연결의 이름을 지정합니다.
