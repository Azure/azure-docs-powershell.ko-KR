...
VirtualHub 내부 사이트 연결에 대한 소프트웨어 정의 연결입니다.

이 게이트웨이는 이 또는 cmdlet에 지정된 확장 단위를 Set-AzVpnGateway 크기 조정합니다.

연결은 VPNSite라고 하는 분기/사이트에서 확장 가능한 게이트웨이로 설정됩니다.
각 연결은 2개의 Active-Active 구성됩니다.
...
이 VpnGateway에서 라우팅 기본 설정 인터넷을 사용하도록 설정하려면 플래그를 지정합니다.
