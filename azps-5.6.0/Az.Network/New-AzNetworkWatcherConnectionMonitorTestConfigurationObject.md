...
이름 : httpTC TestFrequencySec : 120 PreferredIPVersion : ProtocolConfiguration : { "Port": 443, "메서드": "GET", "RequestHeaders": [ { "Name": "Allow", "Value": "GET" } ], "ValidStatusCodeRanges": [ "2xx", "300-308" ], "PreferHTTPS": true } SuccessThreshold : { "ChecksFailedPercent": { "ChecksFailedPercent": 20, "RoundTripTimeMs": 30 } 
...
일부 프로토콜에 대한 테스트 평가를 수행하는 데 사용되는 매개 변수입니다.
