...
(게이트웨이에 루트 인증서가 두 개 이상일 수 있습니다.) 그러나 **VpnClientRootCertificateName** 매개 변수를 포함하면 반환된 데이터를 특정 인증서로 제한할 수 있습니다.

## 예제

### 예제 1: 모든 루트 인증서에 대한 정보 얻습니다.
```
...
이 cmdlet이 도착하는 클라이언트 루트 인증서의 이름을 지정합니다.
