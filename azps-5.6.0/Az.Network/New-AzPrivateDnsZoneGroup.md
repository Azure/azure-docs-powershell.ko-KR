...
## 설명
**New-AzPrivateDnsZoneGroup** cmdlet을 사용하면 새 개인 DNS 영역 그룹을 만들 수 있습니다.
...
개인 엔드포인트가 만들어지면 위의 예제에서는 해당 개인 `test-pr-endpoint` 엔드포인트 아래에 DNS 영역 그룹을 만듭니다.
...
개인 dns 영역 그룹의 개인 dns 영역 구성의 컬렉션입니다.
