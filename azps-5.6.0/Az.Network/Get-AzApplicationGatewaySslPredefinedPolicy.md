...
## 설명
**Get-AzApplicationGatewaySslPredefinedPolicy** cmdlet은 Application Gateway에서 제공하는 미리 정의된 SSL 정책을 얻습니다.
...
이 명령은 AppGwSslPolicy20170401 이름으로 미리 정의된 정책을 반환합니다.
...
이 명령은 "AppGwSslPolicy2017"으로 시작하는 이름으로 미리 정의된 정책을 반환합니다.
