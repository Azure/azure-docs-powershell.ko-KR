...
## SYNOPSIS
Azure 방화벽 정책에 대한 새 위협 인텔리전스 허용 목록 만들기
...
## 설명
**New-AzFirewallPolicyThreatIntelWhitelist** cmdlet은 Azure 방화벽 정책을 만들거나 설정할 때 사용할 수 있는 위협 인텔 허용 목록 개체를 만듭니다.
...
이 예제에서는 하나의 항목의 FQDN 화이트리스트와 두 항목의 IP 주소 화이트리스트가 포함된 위협 인텔 화이트리스트를 만듭니다.
