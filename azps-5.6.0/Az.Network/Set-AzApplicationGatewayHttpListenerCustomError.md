...
## 설명
**Set-AzApplicationGatewayCustomError** cmdlet은 애플리케이션 게이트웨이의 http 수신기에서 사용자 지정 오류를 업데이트합니다.

## 예제

### 예제 1: http 수신기에서 사용자 지정 오류를 업데이트합니다.
```powershell
...
이 명령은 http 수신기 $listener 01의 http 상태 코드 502의 사용자 지정 오류를 업데이트하고 업데이트된 수신기를 반환합니다.
