...
## SYNOPSIS
VpnConnections를 통해 이 WAN에 연결된 VpnSites의 하위 집합에 대한 VPN 구성을 얻습니다. 고객이 지정한 저장소 Blob에 생성된 Vpn 구성을 업로드합니다.
...
그런 다음 이 명령줄을 사용하여 구성을 다운로드합니다.

명령렛이 성공하면 다운로드 구성이 SignedSasUrl로 표시된 Blob에 기록됩니다.
