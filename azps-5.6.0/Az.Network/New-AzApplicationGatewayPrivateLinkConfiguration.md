...
개인 링크 기능을 사용하도록 설정하려면 개인 링크 구성을 프런트 엔드 IP 구성에 연결해야 합니다.
...
### 예제 2: 여러 IP 구성을 사용하여 개인 링크 구성 만들기
```powershell
...
이 명령은 두 개의 ipConfigurations를 사용하여 'privateLinkConfig01'이라는 PrivateLink 구성을 만들고 결과를 2개의 ipConfigurations라는 변수에 $PrivateLinkConfiguration. 
