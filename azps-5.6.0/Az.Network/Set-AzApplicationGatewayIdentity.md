...
## 설명
**Set-AzApplicationGatewayIdentity** cmdlet은 애플리케이션 게이트웨이에 할당된 ID를 업데이트합니다.
...
이 예제에서는 기존 애플리케이션 게이트웨이에 사용자 할당 ID를 할당합니다.
참고: 이 ID는 인증서/비밀을 참조할 keyvault에 액세스할 수 있습니다.
