...
### 1: 네트워크 인터페이스의 IP 구성 얻기
```
$nic1 = Get-AzNetworkInterface -Name mynic -ResourceGroupName $myrg
Get-AzNetworkInterfaceIpConfig -Name ipconfig1 -NetworkInterface $nic1
```

첫 번째 명령은 mynic이라는 기존 네트워크 인터페이스를 얻게 하여 변수에 $nic 1. 두 번째 명령은 이 네트워크 인터페이스의 ipconfig1이라는 IP 구성을 얻습니다.
...
### -Name
이 cmdlet이 얻을 네트워크 IP 구성의 이름을 지정합니다.
...
### -NetworkInterface
이 cmdlet이 얻을 네트워크 IP 구성을 포함하는 **NetworkInterface** 개체를 지정합니다.
