...
## 설명
**Get-AzDtlVMsPerLabPolicy** cmdlet은 랩의 랩 정책당 가상 머신을 얻게 하여 랩에서 허용되는 총 가상 머신 수를 설정할 수 있습니다.
cmdlet은 정책의 사용 또는 사용 안 하도록 설정된 상태 및 정책에서 설정한 랩에서 허용되는 총 가상 머신 수를 반환합니다.
...
### -LabName
이 cmdlet에서 가상 머신을 얻을 랩의 이름을 지정합니다.
