...
## 설명
**Get-AzDtlAllowedVMSizesPolicy** cmdlet은 허용되는 가상 머신 크기 정책을 얻게 하여 랩에서 허용되는 가상 머신 크기 목록을 지정할 수 있습니다.
cmdlet은 정책의 사용 또는 사용 안 하도록 설정된 상태 및 지정된 정책에서 설정한 허용된 모든 가상 머신 크기 목록을 반환합니다.
...
### -LabName
이 cmdlet에서 가상 머신 크기 정책을 얻을 랩의 이름을 지정합니다.
