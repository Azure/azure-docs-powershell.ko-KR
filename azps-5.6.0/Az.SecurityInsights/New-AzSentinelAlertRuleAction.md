...
Logic App 모듈을 사용하여 찾을 수 있는 Logic App Resorce ID 및 트리거 Uri를 제공해야 합니다.
...
이 예제에서는 Logic App의 속성을 사용하여 지정된 경고 규칙에 대한 **AlertRuleAction을** 만든 다음, 해당 경고 $AlertRuleAction 저장합니다.
