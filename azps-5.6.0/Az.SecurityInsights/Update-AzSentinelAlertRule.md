...
-InputObject 또는 -ResourceId 또는 -AlertId를 사용할 수 있습니다.  1개 이상의 프로퍼리 파마터를 업데이트할 수 있습니다.
...
이 예제에서는 **AlertRule** 설정을  사용하지 않도록 설정하고 *Disabled-AlertRuleDisplayName로 이름을 변경합니다.*  다른 모든 속성은 동일하게 유지됩니다.
...
이 예제에서는 InputObject를 사용하지 않도록 설정하여 **AlertRule을** *업데이트합니다.*  다른 모든 속성은 동일하게 유지됩니다.
