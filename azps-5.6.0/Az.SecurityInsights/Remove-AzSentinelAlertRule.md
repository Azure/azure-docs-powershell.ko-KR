...
## 설명
**Remove-AzSentinelAlertRule** cmdlet은 지정된 작업 영역의 경고 규칙을 영구적으로 삭제합니다.
파이프라인 연산자를 사용하여 **AlertRule** 개체를 전달하거나 또는 필요한 매개 변수를 지정할 수 있습니다.
