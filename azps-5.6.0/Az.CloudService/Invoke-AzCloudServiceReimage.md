...
이 명령은 ContosOrg라는 리소스 그룹에 속하는 ContosoCS라는 ContosoFrontEnd_IN_0 ContosoBackEnd_IN_1 2개 역할 인스턴스를 다시 생성합니다.

### 예제 2: 클라우드 서비스의 모든 역할 다시 사용
```powershell
