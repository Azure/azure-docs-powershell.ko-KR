...
## 설명
New-AzPowerBIEmbeddedCapacity cmdlet에서 새 PowerBI Embedded 용량을 만듭니다.
...
미국 중서부 Azure 지역과 리소스 그룹 testRG에서 testcapacity라는 용량을 만듭니다. 용량의 sku 수준은 A1입니다.

## 매개 변수

### -Administrator
용량에서 관리자로 설정할 콤마로 구분된 이름
