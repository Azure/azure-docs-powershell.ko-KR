...
## 설명
**Reset-AzPowerBIWorkspaceCollectionAccessKey** cmdlet은 Power BI 작업 영역 컬렉션에서 지정된 액세스 키를 재설정합니다.
...
이 명령은 지정된 리소스 그룹의 WCN11이라는 작업 영역 컬렉션의 기본 액세스 키를 다시 설정합니다.
...
### -Key1
이 cmdlet이 기본 액세스 키를 재설정하는지 나타냅니다.
...
### -Key2
이 cmdlet이 보조 액세스 키를 재설정하는지 나타냅니다.
