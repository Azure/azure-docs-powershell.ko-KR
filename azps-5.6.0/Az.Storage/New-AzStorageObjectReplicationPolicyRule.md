...
이 명령은 원본 및 대상 계정만 있는 개체 복제 정책 규칙을 만들고 해당 속성을 보여 니다.
...
이 명령은 모든 속성을 사용하여 개체 복제 정책 규칙을 명령하고 해당 속성을 보여 니다.
...
### -PrefixMatch
결과를 필터하여 이름이 지정된 도두로 시작하는 Blob만 복제합니다.
