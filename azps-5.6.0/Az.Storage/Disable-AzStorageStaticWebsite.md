...
## 설명
**Disable-AzStorageStaticWebsite** cmdlet은 Azure Storage 계정에 대한 정적 웹 사이트를 사용하지 않도록 설정합니다.

## 예제

### 예제 1: Azure Storage 계정에 대한 정적 웹 사이트 사용 안 하세요.
```
C:\PS>Disable-AzStorageStaticWebsite
```

이 명령은 Azure Storage 계정에 대한 정적 웹 사이트를 사용하지 않도록 설정합니다.
