...
### 예제 2: 파일 공유 개체에 지정된 파일 공유에서 폴더 만들기
```
PS C:\>Get-AzStorageShare -Name "ContosoShare06" | New-AzStorageDirectory -Path "ContosoWorkingFolder"
```

이 명령은 **Get-AzStorageShare** cmdlet을 사용하여 ContosoShare06이라는 파일 공유를 얻은 다음 파이프라인 연산자를 사용하여 현재 cmdlet에 전달합니다.
현재 cmdlet은 ContosoShare06에서 ContosoWorkingFolder라는 폴더를 만듭니다.
...
이 cmdlet은 이 매개 변수가 지정하는 파일 공유에 폴더를 만듭니다.
