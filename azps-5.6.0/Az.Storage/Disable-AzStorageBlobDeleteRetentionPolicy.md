...
## 설명
**Disable-AzStorageBlobDeleteRetentionPolicy** cmdlet은 Azure Storage Blob 서비스에 대한 삭제 보존 정책을 사용하지 않도록 설정합니다.

## 예제

### 예제 1: Blob 서비스에 대한 삭제 보존 정책을 사용하지 않도록 설정
```
...
이 명령은 Blob 서비스에 대한 삭제 보존 정책을 사용하지 않도록 설정합니다.
