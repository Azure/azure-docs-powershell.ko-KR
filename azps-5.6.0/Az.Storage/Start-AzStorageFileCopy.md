...
컨텍스트를 얻은 경우 **New-AzStorageContext 를 사용 합니다.**
...
### -SrcBlob
**CloudBlob 개체를 지정합니다.**
클라우드 Blob을 만들거나 cmdlet을 사용하여 클라우드 blob을 만들거나 Get-AzStorageBlob 수 있습니다.
...
클라우드 Blob 컨테이너 개체를 만들거나 cmdlet을 Get-AzStorageContainer 수 있습니다.
...
### -SrcFile
**CloudFile 개체를 지정합니다.**
**Get-AzStorageFile** 을 사용하여 클라우드 파일을 만들거나 파일을 얻을 수 있습니다.
...
클라우드 파일 공유를 만들거나 cmdlet을 사용하여 Get-AzStorageShare 수 있습니다.
