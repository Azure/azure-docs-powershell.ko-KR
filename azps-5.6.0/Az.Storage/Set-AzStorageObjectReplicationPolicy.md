...
## 설명
**Set-AzStorageObjectReplicationPolicy** cmdlet은 Storage 계정에서 지정된 개체 복제 정책을 생성하거나 업데이트합니다.
...
이 명령은 개체 복제 정책을 대상 및 원본 계정으로 설정합니다.
먼저 2개 개체 복제 정책 규칙을 만들고 2개 규칙으로 정책을 대상 계정에 설정합니다. 그런 다음 대상 계정에서 원본 계정으로 개체 복제 정책을 설정합니다.
...
### -PolicyId
개체 복제 정책 ID입니다. GUID 또는 'default'입니다.
