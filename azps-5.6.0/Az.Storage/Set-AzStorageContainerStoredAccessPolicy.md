...
## 설명
**Set-AzStorageContainerStoredAccessPolicy** cmdlet은 Azure Storage 컨테이너에 대한 저장된 액세스 정책을 설정합니다.

## 예제

### 예제 1: 전체 권한으로 저장소 컨테이너에 저장된 액세스 정책 설정
```
...
### -권한
저장소 컨테이너에 액세스하기 위해 저장된 액세스 정책에서 권한을 지정합니다.
