...
## 설명
**Get-AzDataLakeGen2Item** cmdlet은 Azure Storage 계정의 Filesystem에서 파일 또는 디렉터리의 세부 정보를 제공합니다.
...
### 예제 1: Filesystem에서 디렉터리를 다운로드하고 세부 정보를 표시
```
...
이 명령은 Filesystem에서 디렉터리를 얻게 하여 세부 정보를 나타냅니다.

### 예제 2: Filesystem에서 파일 다운로드
```
...
이 명령은 Filesystem에서 파일의 세부 정보를 얻습니다. 
...
Filesystem의 루트 디렉터리를 얻기 위해 이 매개 변수를 지정하지 않습니다.
