...
## 설명
**Get-AzStorageTableStoredAccessPolicy** cmdlet은 Azure Storage 테이블에 대한 저장된 액세스 정책 또는 정책을 나열합니다.

## 예제

### 예제 1: 저장소 테이블에 저장된 액세스 정책 사용
```
...
### 예제 2: 저장소 테이블에 저장된 모든 액세스 정책 사용
```
...
### Microsoft.WindowsAzure.Storage.Table.SharedAccesssTablePolicy
