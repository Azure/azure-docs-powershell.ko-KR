...
이 명령은 보존일을 5일로 사용하여 파일 공유 softdelete 삭제를 가능하게 합니다.
...
저장소 계정에 대한 공유 보존 정책을 사용하도록 설정하여 저장소 $true 삭제 정책 공유를 $false.
...
### -ShareRetentionDays
Share DeleteRetentionPolicy에 대한 보존 일 수를 설정합니다.
공유 보존 정책을 사용하도록 설정하는 경우만 값을 설정해야 합니다.
