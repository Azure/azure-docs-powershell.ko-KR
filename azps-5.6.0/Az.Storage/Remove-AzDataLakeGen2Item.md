...
이 명령은 Filesystem에서 디렉터리를 제거합니다.
...
이 명령은 프롬프트 없이 Filesystem에서 디렉터리를 제거합니다.

### 예제 3: 파이프라인을 사용하여 Filesystem의 모든 항목 제거
```
PS C:\>Get-AzDataLakeGen2ChildItem -FileSystem "filesystem1" | Remove-AzDataLakeGen2Item -Force
```

이 명령은 파이프라인이 있는 Filesystem의 모든 항목을 제거합니다.
...
### -Force
파일 및 해당 콘텐츠의 모든 콘텐츠를 제거하려면 강제로
...
### -PassThru
지정된 Filesystem이 성공적으로 제거된지 여부를 반환합니다.
