...
이 명령은 ManagementPolicy 작업 그룹 개체에 4개 작업, ManagementPolicy 규칙 필터 개체가 포함된 ManagementPolicy 규칙 개체를 만든 다음 저장소 계정으로 규칙을 설정합니다.

## 매개 변수

### -Action
작업 집합을 정의하는 개체입니다.
cmdlet을 Add-AzureStorageAccountManagementPolicyAction
...
### -Filter
필터 집합을 정의하는 개체입니다.
cmdlet을 New-AzureStorageAccountManagementPolicyFilter
...
### -Name
규칙 이름은 알파 숫자 문자의 조합을 포함할 수 있습니다.
규칙 이름은 대소문자 구분입니다.
정책 내에서 고유해야 합니다.
