...
## 설명
**Get-AzStorageContainerStoredAccessPolicy** cmdlet에는 Azure 저장소 컨테이너에 대한 저장된 액세스 정책 또는 정책이 나열됩니다.

## 예제

### 예제 1: 저장소 컨테이너에 저장된 액세스 정책 사용
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

이 명령은 Container07이라는 저장소 컨테이너에서 Policy22라는 액세스 정책을 얻습니다.

### 예제 2: 저장소 컨테이너에 저장된 모든 액세스 정책 사용
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07"
```

이 명령은 Container07이라는 저장소 컨테이너의 모든 액세스 정책을 제공합니다.
...
### Microsoft.Azure.Storage.Blob.SharedAccesssBlobPolicy
