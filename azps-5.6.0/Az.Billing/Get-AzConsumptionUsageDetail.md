...
## 설명
**Get-AzConsumptionUsageDetail** cmdlet은 구독의 사용 세부 정보를 제공합니다. 

## 예제

### 예제 1: MeterDetails의 확장을 통해 사용 세부 정보 확인
```powershell
...
### 예제 3: InstanceName 필터를 사용하여 BillingPeriodName의 사용 세부 정보 확인
```powershell
...
### -BillingPeriodName
연결된 사용량 세부 정보를 얻을 수 있는 특정 청구 기간의 이름입니다.
...
### -확장
MeterDetails 또는 AdditionalInfo를 기반으로 사용량을 확장합니다.
