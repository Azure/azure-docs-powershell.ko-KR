...
## 설명
**Get-AzBillingProfile** cmdlet은 지정된 청구 계정 아래에서 청구 프로필을 얻습니다. 
...
지정된 청구 계정에서 모든 청구 프로필을 얻고 결과에 송장 섹션을 포함합니다.
...
지정된 이름으로 청구 프로필을 얻고 결과에 송장 섹션을 포함합니다.
