...
## 설명
**Get-AzConsumptionMarketplace** cmdlet은 구독의 마켓플레이스를 얻습니다.

## 예제

### 예제 1: 마켓플레이스 사용 현황 확인
```powershell
...
### 예제 3: BillingPeriodName의 마켓플레이스 사용
```powershell
...
### 예제 4: InstanceName 필터를 사용하여 마켓플레이스 사용 현황 확인
```powershell
...
### -BillingPeriodName
연결된 마켓플레이스를 얻을 수 있는 특정 청구 기간의 이름입니다.
