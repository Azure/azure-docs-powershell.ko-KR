...
## 설명
**Get-AzConsumptionPriceSheet** cmdlet은 구독의 가격 시트를 얻습니다.
...
### 예제 2: MeterDetails의 확장을 통해 가격표를 얻습니다.
```powershell
...
### 예제 3: BillingPeriodName의 가격표를 얻습니다.
```powershell
...
### -BillingPeriodName
연결된 가격 시트를 얻을 수 있는 특정 청구 기간의 이름입니다.
