...
모든 BotServices를 얻을 수 있습니다.

### 예제 2: ResourceGroupName 및 Name로 BotService를 얻다
```powershell
...
ResourceGroupName 및 Name로 BotService를 얻게 됩니다.

### 예제 3: ResourceGroupName에 의해 모든 BotServices를 얻다
```powershell
...
ResourceGroupName에 의해 모든 BotServices를 얻게 됩니다.
