...
## 설명
**New-AzDataShareSynchronizationSetting은** 특정 시간의 반복 간격에 대해 공유 계정에서 공유에 대한 동기화 설정을 만듭니다.
...
이 명령은 데이터 공유 계정 WikiAds에서 Share AdsShare를 위해 매일 오전 9:00에 매일 반복 간격에 동기화 설정을 만듭니다.
