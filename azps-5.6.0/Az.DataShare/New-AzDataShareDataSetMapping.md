...
## 설명
**New-AzDataShareDataSetMapping** cmdlet은 공유 구독에서 원본 데이터 집합과 싱크 저장소 계정 간에 데이터 집합 매핑을 만듭니다.
...
이 명령은 데이터 공유 계정 WikiAdsAccount에서 공유 구독용 AdsShareSubscription용 Storage 계정 AdsStorage에 AdsDataSetMapping 매핑을 매핑하는 데이터 집합을 만듭니다.
