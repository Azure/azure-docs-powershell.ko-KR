...
## 설명
**Get-AzDataShareProviderSubscription** cmdlet은 공급자 쪽에서 소비자 공유 구독에 대한 정보를 얻습니다. 공유 하위 구독 ID를 지정하는 경우 이 cmdlet은 공유 구독에 대한 정보를 얻습니다. 공유 구독 ID를 지정하지 않으면 이 cmdlet은 공유와 연결된 모든 소비자 공유 구독에 대한 정보를 얻습니다.
...
이 명령은 데이터 공유 계정 WikiAds에서 Share AdsShare와 연결된 소비자 공유 구독에 대한 정보를 제공합니다.
