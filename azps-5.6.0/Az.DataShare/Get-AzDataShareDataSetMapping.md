...
## 설명
**Get-AzDataShareDataSetMapping** cmdlet은 이름이 지정된 경우 특정 데이터 세트 매핑에 대한 정보를 얻습니다. 그렇지 않으면 공유 구독의 모든 데이터 세트 매핑에 대한 정보를 얻습니다. 
...
```
 ...
 이 명령은 공유 구독의 모든 데이터 세트 매핑에 대한 정보를 표시합니다.
