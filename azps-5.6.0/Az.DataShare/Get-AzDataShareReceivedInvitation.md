...
## 설명
**Get-AzDataShareReceivedInvitation** cmdlet은 소비자가 수집한 모든 초대에 대한 정보를 제공합니다. 위치 또는 초대 ID를 제공하는 경우 이 cmdlet은 특정 위치 또는 초대 ID가 있는 초대에 대한 정보를 제공합니다. 그렇지 않으면 소비자에게 전송된 초대 목록을 제공합니다.
