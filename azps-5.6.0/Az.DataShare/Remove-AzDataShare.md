...
필수: True 위치: 명명된 기본값: 없음 수락 파이프라인 입력: True(ByValue) 와일드카드 문자 수락: False
...
필수: True 위치: 명명된 기본값: 없음 수락 파이프라인 입력: False 수락 와일드카드 문자: False
...
필수: False 위치: 명명된 기본값: 없음 수락 파이프라인 입력: False 수락 와일드카드 문자: False
...
필수: True 위치: 명명된 기본값: 없음 수락 파이프라인 입력: True(ByPropertyName) 와일드카드 문자 수락: False
