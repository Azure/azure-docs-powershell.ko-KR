...
## 설명
**Remove-AzDataShareSynchronizationSetting** cmdlet은 데이터 공유 동기화 설정을 제거합니다.
...
이 명령은 Share AdsShare에서 AdsShareSynchronizationSetting이라는 동기화 설정을 제거합니다. 
