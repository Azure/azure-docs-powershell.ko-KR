...
### 예제 1: 매개 변수 kubeConfig 및 kubeContext를 사용하여 연결된 kubernetes 만들기
```powershell
...
이 명령은 매개 변수 kubeConfig 및 kubeContext를 사용하여 연결된 kubernetes를 만듭니다.
