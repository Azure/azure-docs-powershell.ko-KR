...
## 설명
**Get-AzAlertHistory** cmdlet은 클래식 경고 규칙의 기록을 사용하도록 설정하고, 사용하지 않도록 설정하고, 해제하고, 해결되었습니다.
...
이 명령은 현재 구독에 대해 지정된 시간 프레임에 대한 경고 기록을 얻습니다.

### 예제 2: 지정된 리소스에 대한 경고 기록을 얻습니다.
```
...
이 명령은 지정된 리소스에 대한 경고 규칙 관련 이벤트를 얻습니다.
