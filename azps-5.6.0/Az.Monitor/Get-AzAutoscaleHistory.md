...
## 설명
**Get-AzAutoscaleHistory** cmdlet은 자동 크기 조정 설정과 관련된 이벤트의 기록을 제공합니다.

## 예제

### 예제 1: 구독과 연결된 모든 이벤트 얻기
```
PS C:\>Get-AzAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

이 명령은 현재 구독과 연결된 모든 자동 조정 관련 이벤트를 얻습니다.
...
이 명령은 리소스의 ID(기본적으로 ResourceUri)에서 식별된 특정 리소스와 연결된 모든 자동 조정 관련 이벤트를 얻습니다.
