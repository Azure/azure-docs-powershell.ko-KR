...
이 명령은 시간 입자가 1분인 website3의 메트릭 값을 얻습니다.

### 예제 2: 자세한 출력이 있는 메트릭을 얻게 됩니다.
```
...
이 명령은 지정된 차원 필터 및 집계 형식이 있는 PageViews 메트릭에 대한 요약된 출력을 얻습니다.
...
### -OrderBy
결과 정렬 및 정렬 방향에 사용할 집계를 지정합니다(예: sum asc).
...
### -TimeGrain
hh:mm:ss 형식의 메트릭의 시간 그레인을 **TimeSpan** 개체로 지정합니다.
...
지원되는 메트릭에 대한 자세한 내용은 다음에서 찾을 수 있습니다. https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported
