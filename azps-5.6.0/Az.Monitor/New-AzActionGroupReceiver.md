...
일반적인 경고를 사용할지 여부를 플래그로 지정합니다. 이 값은 SMS, Azure App push, ITSM 및 Voice recievers에서 무시됩니다.
