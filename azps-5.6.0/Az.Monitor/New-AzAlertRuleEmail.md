...
이 명령은 경고 규칙이 실행된 경우 해당 서비스 소유자에게 보낼 경고 규칙 전자 메일 작업을 만듭니다.

### 예제 2: 비서비스 소유자에 대한 경고 규칙 전자 메일 작업 만들기
```
PS C:\>New-AzAlertRuleEmail -CustomEmail pattif@contoso.com,davidchew@contoso.net
```

이 명령은 서비스 소유자에 대해 지정한 전자 메일 주소에 대한 경고 규칙 전자 메일 작업을 만듭니다.

### 예제 3: 서비스 소유자 및 비서비스 소유자에 대한 경고 규칙 전자 메일 작업 만들기
```
...
### -SendToServiceOwner
규칙이 발생하면 이 작업이 서비스 소유자에게 전자 메일을 보낸 경우를 나타냅니다.
