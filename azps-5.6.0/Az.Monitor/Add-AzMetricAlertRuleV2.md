...
## 설명
V2(클래식이 아닌) 메트릭 기반 경고 규칙을 **추가하거나 업데이트합니다.** 추가된 규칙은 리소스 그룹과 연결되어 있으며 이름이 있습니다. 이 cmdlet은 ShouldProcess 패턴을 구현합니다. 즉, 리소스를 실제로 만들거나 수정하거나 제거하기 전에 사용자로부터 확인을 요청할 수 있습니다.
...
이 명령은 가상 머신에 대한 메트릭 경고 규칙을 만듭니다. $condition [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2criteria) cmdlet의 출력이고 [$act-AzActionGroup](https://docs.microsoft.com/powershell/module/az.monitor/new-azactiongroup) cmdlet의 출력입니다.
...
이 명령은 메트릭 경고 규칙을 사용하지 않도록 설정합니다. 여기에서 [Get-AzMetricAlertRuleV2의](https://docs.microsoft.com/powershell/module/az.monitor/get-azmetricalertrulev2) 배관 출력을 [Add-AzMetricAlertRuleV2로 출력합니다.](https://docs.microsoft.com/powershell/module/az.monitor/add-azmetricalertrulev2) 
...
차원 값을 선택하거나 여러 조건이 있는 메트릭 경고 규칙과 같은 더 복잡한 메트릭 경고 규칙을 만들하려면 도우미 cmdlet [New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) 및 [New-AzMetricAlertRuleV2Criteria를](https://docs.microsoft.com/powershell/module/az.monitor/new-azmetricalertrulev2criteria)사용할 수 있습니다.

위의 cmdlet 집합은 차원을 사용하여 메트릭 경고 규칙을 만들 것입니다.
