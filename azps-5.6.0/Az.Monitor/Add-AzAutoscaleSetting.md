...
처음 두 명령은 [New-AzAutoscaleRule을](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscalerule) 사용하여 두 개의 자동 조정 규칙($Rule 1 및 $Rule 2)을 $Rule.
세 번째 및 네 번째 명령은 [New-AzAutoscaleProfile을](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscaleprofile) 사용하여 $Profile 1 및 $Profile 2, $Rule 1 및 $Rule 2를 $Rule 2를 생성합니다.
