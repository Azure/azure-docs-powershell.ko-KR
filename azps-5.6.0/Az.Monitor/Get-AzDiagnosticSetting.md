...
## 설명
**Get-AzDiagnosticSetting** cmdlet은 리소스에 대해 기록된 범주 및 시간 그레인을 얻습니다.
시간 그레인은 메트릭의 집계 간격입니다.

## 예제

### 예제 1: 로깅 범주 및 시간 입자의 상태 확인
```
...
이 명령은 /subscriptions/1a66ce04-b633-4a0b-b2bc-a912ec8986a6/ResourceGroups/ContosoRG/providers/microsoft.keyvault/KeyVaults/ContosoKeyVault를 사용하여 Azure Key Vault에 기록된 범주 및 시간 그레인을 얻습니다. 
...
### -Name
진단 설정의 이름입니다. 이전 API에서와 같은 호출 기본값을 "service"로 지정하지 않은 경우.
