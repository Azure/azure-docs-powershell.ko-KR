...
## 설명
**New-AzPrivateDnsZone cmdlet은** 지정된 리소스 그룹에 새 DNS(개인 도메인 이름 시스템) 지역을 만듭니다. 이름 매개 변수에 대한 고유한  개인 DNS 영역 이름을 지정해야 합니다. 또는 cmdlet에서 오류를 반환합니다. 영역이 만들어진 후 New-AzPrivateDnsRecordSet cmdlet을 사용하여 영역의 레코드 집합을 만들 수 있습니다.
