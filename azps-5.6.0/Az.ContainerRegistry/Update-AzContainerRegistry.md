...
### 예제 1: 지정된 컨테이너 레지스트리에 대해 관리자 사용자 사용
```powershell
...
이 명령을 사용하면 지정된 컨테이너 레지스트리에 대한 관리자 사용자를 사용할 수 있습니다.
...
이 명령은 지정된 컨테이너 레지스트리를 설정하여 동일한 구독에서 기존 저장소 계정 \` mystorageaccount를 \` 사용할 수 있습니다.
