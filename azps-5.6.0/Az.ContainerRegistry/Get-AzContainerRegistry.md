...
## 설명
Get-AzContainerRegistry cmdlet은 지정된 컨테이너 레지스트리 또는 리소스 그룹 또는 구독의 모든 컨테이너 레지스트리를 얻습니다.

## 예제

### 예제 1: 지정된 컨테이너 레지스트리를 얻습니다.
```powershell
...
이 명령은 지정된 컨테이너 레지스트리를 얻습니다.

### 예제 2: 리소스 그룹의 모든 컨테이너 레지스트리를 얻습니다.
```powershell
...
이 명령은 리소스 그룹의 모든 컨테이너 레지스트리를 얻습니다.

### 예제 3: 구독의 모든 컨테이너 레지스트리를 얻습니다.
```powershell
