...
## 설명
ACR 매니페스트를 업데이트합니다.
이 cmdlet을 사용 하시기 바랍니다. `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -WriteEnable $true`
먼저.
...
매니페스트 sha256:185518070891758909c9f839cf4ca393ee977ac378609f700f60a771a2dfe321 아래에서 특성 업데이트
...
레지스트리 아래 태그를 사용하여 매니페스트에 대한 특성을 업데이트합니다.
