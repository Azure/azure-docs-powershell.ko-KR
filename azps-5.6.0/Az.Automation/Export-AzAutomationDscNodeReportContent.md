...
## 설명
**Export-AzAutomationDscNodeReportContent** cmdlet은 DSC(원시 상태 구성) 보고서의 원시 콘텐츠를 내보낼 수 있습니다.
DSC 노드는 DSC 보고서를 Azure Automation에 전송합니다.
...
### -NodeId
이 cmdlet에서 보고서 콘텐츠를 내보내는 DSC 노드의 고유 ID를 지정합니다.
...
### -OutputFolder
이 cmdlet이 보고서 내용을 내보내는 출력 폴더를 지정합니다.
...
### -ReportId
이 cmdlet이 내보내는 DSC 노드 보고서의 고유 ID를 지정합니다.
...
### -ResourceGroupName
리소스 그룹의 이름을 지정합니다.
이 cmdlet은 이 cmdlet이 지정하는 리소스 그룹에 속하는 DSC 노드에 대한 보고서의 내용을 내보낼 수 있습니다.
