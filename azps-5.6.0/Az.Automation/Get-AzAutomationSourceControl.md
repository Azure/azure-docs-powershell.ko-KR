...
## 설명
Get-AzAutomationSourceControl cmdlet은 Automation 원본 컨트롤을 제공합니다.
특정 원본 컨트롤을 얻지 못하도록 이름을 지정합니다.

## 예제

### 예제 1
이 명령은 devAccount라는 계정에서 VSTSNative라는 Automation 원본 컨트롤을 얻습니다.
