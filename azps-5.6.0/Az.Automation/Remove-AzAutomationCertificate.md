...
## 설명
**Remove-AzAutomationCertificate** cmdlet은 Azure Automation에서 인증서를 제거합니다.
...
이 명령은 Contoso17이라는 Automation 계정에서 Cert01이라는 인증서를 제거합니다.

## 매개 변수

### -AutomationAccountName
이 cmdlet에서 인증서를 제거하는 Automation 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet에서 인증서를 제거하는 리소스 그룹의 이름을 지정합니다.
