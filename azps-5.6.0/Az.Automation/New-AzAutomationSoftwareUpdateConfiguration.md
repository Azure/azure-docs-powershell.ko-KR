...
## 설명
컴퓨터 목록을 업데이트하기 위해 일정에 따라 실행되는 소프트웨어 업데이트 구성을 만듭니다. 컴퓨터에는 Azure 가상 머신 또는 비아즈 컴퓨터가 모두 포함됩니다.

## 예제

### 예제 1
매주 토요일 9시에 두 개의 Windows Azure 가상 머신에 중요한 업데이트를 설치하는 소프트웨어 업데이트 구성을 만듭니다. 업데이트 기간은 이 예제에서 2시간으로 설정됩니다.
...
### -Linux
Linux 운영 체제 머신을 대상으로 하는 소프트웨어 업데이트 구성을 나타냅니다.
