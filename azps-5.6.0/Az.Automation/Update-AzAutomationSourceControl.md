...
## 설명
Update-AzAutomationSourceControl cmdlet은 Azure Automation의 원본 컨트롤에서 필드 값을 수정합니다.

## 예제

### 예제 1
이 명령은 devAccount라는 계정에서 VSTSNative라는 Azure Automation 원본 컨트롤에 대해 PublishRunbook 필드를 false로 설정합니다.
...
Azure Automation 원본 컨트롤을 업데이트합니다. (자동 재생)
