...
# Az.Automation 모듈
## 설명
이 항목에서는 Azure Automation Cmdlet에 대한 도움말 항목을 제공합니다.

## Az.Automation Cmdlet
### [Export-AzAutomationDscConfiguration](Export-AzAutomationDscConfiguration.md)
Automation에서 로컬 파일로 DSC 구성을 내보낼 수 있습니다.

### [Export-AzAutomationDscNodeReportContent](Export-AzAutomationDscNodeReportContent.md)
DSC 노드에서 Automation으로 전송된 DSC 보고서의 원시 콘텐츠를 내보낼 수 있습니다.

### [Export-AzAutomationRunbook](Export-AzAutomationRunbook.md)
Automation Runbook을 내보낼 수 있습니다.

### [Get-AzAutomationAccount](Get-AzAutomationAccount.md)
리소스 그룹에서 Automation 계정을 얻습니다.

### [Get-AzAutomationCertificate](Get-AzAutomationCertificate.md)
Automation 인증서를 얻습니다.
...
Automation에서 DSC 노드 구성 배포를 얻습니다.
...
DSC 노드 또는 하이브리드 작업원을 Automation에 온보드하기 위한 등록 정보를 얻습니다.
...
Automation 자격 증명을 만듭니다.

### [New-AzAutomationKey](New-AzAutomationKey.md)
Automation 계정에 대한 등록 키를 다시 생성합니다.
...
Automation에서 하이브리드 작업자 그룹을 제거합니다.
...
Automation Runbook에 대한 웹후크를 수정합니다.
...
Azure Automation 원본 제어 동기화 작업을 시작합니다.
