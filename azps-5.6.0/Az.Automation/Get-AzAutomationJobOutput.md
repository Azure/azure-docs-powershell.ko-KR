...
## 설명
**Get-AzAutomationJobOutput** cmdlet은 Azure Automation 작업의 출력을 얻습니다.

## 예제

### 예제 1: Automation 작업의 출력을 얻게 됩니다.
```
PS C:\>Get-AzAutomationJobOutput -AutomationAccountName "Contoso17" -Id 2989b069-24fe-40b9-b3bd-cb7e5eac4b64 -ResourceGroupName "ResourceGroup01" -Stream "Any"
```

이 명령은 지정된 ID가 있는 작업의 모든 출력을 얻습니다.

## 매개 변수

### -AutomationAccountName
이 cmdlet에서 작업 출력을 얻을 수 있는 Automation 계정의 이름을 지정합니다.
...
### -Id
이 cmdlet에서 출력을 얻을 작업의 ID를 지정합니다.
...
### -ResourceGroupName
이 cmdlet에서 작업 출력을 얻을 수 있는 리소스 그룹의 이름을 지정합니다.
...
### -StartTime
시작 시간을 **DateTimeOffset 개체로 지정합니다.**
유효한 **DateTimeOffset로** 변환할 수 있는 문자열을 지정할 수 있습니다.
cmdlet은 이 시간 이후에 생성된 출력을 검색합니다.
