...
## 설명
**Remove-AzAutomationRunbook** cmdlet은 Azure Automation에서 Runbook을 제거합니다.
...
이 명령은 Contoso17이라는 Azure Automation 계정에서 Runbook03이라는 Runbook을 제거합니다.

## 매개 변수

### -AutomationAccountName
이 cmdlet에서 Runbook을 제거하는 Automation 계정의 이름을 지정합니다.
...
### -Name
이 cmdlet이 제거한 Runbook의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet에서 Runbook을 게시하는 리소스 그룹의 이름을 지정합니다.
