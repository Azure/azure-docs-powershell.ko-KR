...
## 설명
Get-AzAutomationSourceControlSyncJob cmdlet은 Azure Automation 원본 제어 동기화 작업을 얻습니다. 특정 원본 제어 동기화 작업을 얻지 못하도록 ID를 지정합니다.

## 예제

### 예제 1
이 명령은 원본 제어 VSTSNative에 대한 모든 Automation 원본 제어 동기화 작업을 제공합니다.
...
### 예제 2
이 명령은 원본 제어 VSTSNative에 대한 id 08d6d266-27b6-463c-beea-bc48a67ace15를 사용하여 원본 제어 동기화 작업을 얻습니다. 
...
Azure Automation 원본 제어 동기화 작업을 얻습니다. (자동 재생)
