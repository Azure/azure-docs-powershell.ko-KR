...
## 설명
**Get-AzAutomationVariable** cmdlet은 하나 이상의 Azure Automation 변수를 얻습니다.
특정 변수를 얻지 못하도록 이름을 지정합니다.
...
첫 번째 명령은 Contoso17이라는 계정에서 Variable06이라는 Automation 변수를 얻습니다.
명령은 해당 개체를 $Variable 저장합니다.
두 번째 명령은 표준 점표를  사용하여 $Variable.
명령은 변수 변수에 $value 저장합니다.

## 매개 변수

### -AutomationAccountName
이 cmdlet이 얻을 변수를 포함하는 Automation 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet에서 변수를 얻을 리소스 그룹을 지정합니다.
