...
## 설명
**Get-AzDataBoxEdgeStorageContainer** cmdlet은 Data Box Edge 디바이스의 Edge Storage 계정에 대한 저장소 컨테이너를 얻습니다. 이름을 cmdlet에서 매개 변수로 지정하여 특정 저장소 컨테이너의 세부 정보를 인용할 수 있습니다. 
