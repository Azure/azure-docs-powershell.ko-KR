...
## 설명
**New-AzDataBoxEdgeStorageAccount** cmdlet은 Data Box Edge 디바이스에 새 Edge Storage 계정을 만듭니다. 디바이스의 경우 하나의 Edge Storage 계정은 대부분 하나의 Cloud Storage 계정에만 매핑될 수 있습니다.
