...
## 설명
**New-AzDataBoxEdgeOrder** cmdlet은 Data Box Edge 디바이스에 대한 새 순서를 만듭니다. Data Box Edge 디바이스 리소스는 주문을 만들기 전에 먼저 만들어야 합니다. 연락처, 회사 이름, 전자 메일, 주소 등의 세부 정보를 주문을 만드는 매개 변수로 지정할 수 있습니다.
