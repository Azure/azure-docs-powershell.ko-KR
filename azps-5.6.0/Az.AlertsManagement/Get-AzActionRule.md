...
## 설명
**Get-AzActionRule** cmdlet은 구성된 작업 규칙을 제공합니다.
...
Sev2 심각도 및 플랫폼 모니터 서비스에 필터링된 리소스 그룹 test-rg에 구성된 모든 작업 규칙을 나열합니다. 목록에서 Format-List 각 작업 규칙의 세부 정보를 얻습니다.
...
test-rg 리소스 그룹의 이름 Test-Action-Rule이 있는 작업 규칙을 얻습니다.
