...
이 cmdlet은 구독 범위와 함께 supression에 대한 작업 규칙을 만듭니다.
...
이 cmdlet은 리소스 그룹 범위 목록과 함께 작업 그룹에 대한 작업 규칙을 만듭니다.
...
이 cmdlet은 리소스 범위와 함께 진단 설정에 대한 작업 규칙을 만듭니다.
...
### -ReccurentValue
해당하는 경우 재시도 값입니다. 주간의 경우 - \[ 1,2 월간의 경우 \] - \[ 1,3,5,30\]
...
### -SuppressionEndTime
억제 종료 시간입니다.
2018년 12월 09일 06:00:00 +를 1회, 일, 매주 또는 매월 재발방지 일정의 경우 언급해야 합니다.
