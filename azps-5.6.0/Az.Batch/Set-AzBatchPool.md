...
## 설명
**Set-AzBatchPool** cmdlet은 Azure Batch 서비스의 풀 속성을 업데이트합니다.
...
첫 번째 명령은 **Get-AzBatchPool을** 사용하여 풀을 한 다음, 해당 풀을 $Pool 저장합니다.
다음 세 가지 명령은 개체의 시작 작업 $Pool 수정합니다.
마지막 명령은 Batch 서비스를 업데이트하여 로컬 개체와 $Pool.
