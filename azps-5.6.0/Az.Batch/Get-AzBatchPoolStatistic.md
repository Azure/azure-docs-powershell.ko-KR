...
통계는 계정 생성에서 통계의 마지막 업데이트 시간까지 계정에 있는 모든 풀에 집계됩니다.

## 예제

### 예제 1: 계정의 모든 풀의 리소스 통계를 얻습니다.
```
...
두 번째 명령은 지정된 계정의 모든 풀의 통계를 얻은 다음, 해당 풀을 $PoolStatistics.
마지막 명령은 리소스 통계의 **ResourceStatistics** 속성을 $PoolStatistics.
...
### Microsoft.Azure.Commands.Bat. Models.PSPoolStatistics
