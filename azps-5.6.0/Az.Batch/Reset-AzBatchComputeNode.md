...
이 명령은 MyPool이라는 풀의 ID "tvm-3257026573_2-20150813t200938z"로 계산 노드를 다시 계산합니다.
...
이 명령은 MyPool이라는 풀의 모든 계산 노드를 다시 계산합니다.
...
### -ComputeNode
다시 계산 노드를 나타내는 **PSComputeNode** 개체를 지정합니다.
...
### -ReimageOption
노드를 다시 구성할 때와 현재 실행 중인 태스크에서 수행할 작업을 지정합니다.
기본값은 다시큐어입니다.
