...
## 설명
**Get-AzBatchJob** cmdlet은 *BatchAccountContext* 매개 변수에 의해 지정된 Batch 계정에 대한 Azure Batch 작업을 얻습니다.
ID 매개 변수를 *사용하여* 단일 작업을 얻을 수 있습니다.
필터 매개  변수를 사용하여 OData(Open Data Protocol) 필터와 일치하는 작업을 얻을 수 있습니다.
...
이 명령은 Get-AzBatchJobSchedule cmdlet을 사용하여 ID JobSchedule27이 있는 작업 일정을 Get-AzBatchJobSchedule 합니다.
명령은 파이프라인 연산자를 사용하여 현재 cmdlet에 작업 일정을 전달합니다.
명령은 이 작업 일정에 대한 모든 작업을 얻습니다.
