...
이 cmdlet은 Force 매개 변수를 지정하지 않는 한 계정을 제거하기 전에 메시지를 *표시합니다.*
...
이 명령은 계정을 삭제하기 전에 확인을 묻는 메시지를 표시합니다.

## 매개 변수

### -AccountName
이 cmdlet이 제거한 Batch 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 제거한 계정의 리소스 그룹을 지정합니다.
