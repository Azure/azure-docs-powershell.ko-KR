...
## 설명
**New-AzBatchApplication** cmdlet은 지정된 Azure Batch 계정에 애플리케이션을 추가합니다.

## 예제

### 예제 1: Batch 계정에 빈 애플리케이션 추가
```
...
이 명령은 ContosoBatch 계정에 Litware 애플리케이션을 만듭니다.
애플리케이션에 처음에는 패키지가 포함되어 없습니다.

## 매개 변수

### -AccountName
이 cmdlet에서 애플리케이션을 추가하는 Batch 계정의 이름을 지정합니다.
...
### Microsoft.Azure.Commands.Bat. Models.PSApplication
