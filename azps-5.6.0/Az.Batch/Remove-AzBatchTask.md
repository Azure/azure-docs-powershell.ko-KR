...
이 cmdlet은 Force 매개 변수를 지정하지 않는 한 확인을 *묻는 메시지를* 표시합니다.
...
이 명령은 ID Job-000001이 있는 작업 아래에 ID Task23이 있는 작업을 삭제합니다.
...
이 명령은 **Get-AzBatchTask** cmdlet을 사용하여 ID Job-000001이 있는 작업에 ID Task26이 있는 Batch 작업을 제공합니다.
