...
이 명령은 Litware 애플리케이션의 버전 1.0을 만들고 활성화하고 애플리케이션 litware.1.0.zip 콘텐츠로 업로드합니다.

## 매개 변수

### -AccountName
이 cmdlet에서 애플리케이션 패키지를 추가하는 Batch 계정의 이름을 지정합니다.
...
### -ActivateOnly
이 cmdlet은 이미 업로드된 애플리케이션 패키지를 활성화합니다.
