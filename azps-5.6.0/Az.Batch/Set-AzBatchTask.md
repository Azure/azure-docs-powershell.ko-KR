...
## 설명
**Set-AzBatchTask** cmdlet은 Azure Batch 서비스의 태스크 속성을 업데이트합니다.
**psCloudTask** 개체를 Get-AzBatchTask cmdlet을 사용합니다.
...
첫 번째 명령은 **Get-AzBatchTask를** 사용하여 작업을 수행한 다음, 해당 작업을 $Task 저장합니다.
다음 두 명령은 작업의 제약 조건을 $Task.
마지막 명령은 Batch 서비스를 업데이트하여 에 있는 로컬 개체와 $Task.
