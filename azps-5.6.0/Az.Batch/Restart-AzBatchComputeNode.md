...
## 설명
**Restart-AzBatchComputeNode** cmdlet은 지정된 계산 노드를 다시 부트합니다.
...
이 명령은 풀 MyPool에서 "tvm-3257026573_2-20150813t200938z"를 사용하여 계산 노드를 다시 부트합니다.
...
이 명령은 풀 MyPool의 모든 계산 노드를 다시 부트합니다.
...
### -RebootOption
노드를 다시 부팅할 때와 현재 실행 중인 태스크에서 수행할 작업을 지정합니다.
기본값은 다시큐어입니다.
