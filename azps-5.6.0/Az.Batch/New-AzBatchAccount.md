...
### -AccountName
이 cmdlet이 만드는 Batch 계정의 이름을 지정합니다.
일괄 처리 계정 이름은 3~24자 사이에 있어야 합니다. 숫자와 소문자만 포함해야 합니다.
...
### -KeyVaultId
Batch 계정과 연결된 Azure 키 자격 증명 모음의 리소스 ID입니다.
...
### -Location
이 cmdlet에서 계정을 만드는 지역을 지정합니다.
자세한 내용은 [Azure 지역 을 참조하세요.](https://azure.microsoft.com/en-us/regions)
...
### -ResourceGroupName
이 cmdlet에서 계정을 만드는 리소스 그룹의 이름을 지정합니다.
