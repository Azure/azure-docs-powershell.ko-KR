...
## 설명
**Disable-AzBatchJob** cmdlet은 Azure Batch 작업을 사용하지 않도록 설정합니다.
작업을 사용하도록 설정한 후 새 작업을 실행할 수 있습니다.
비활성화된 작업은 새 작업을 실행하지 않습니다.
나중에 비활성화된 작업을 사용하도록 설정할 수 있습니다.

## 예제

### 예제 1: Batch 작업 사용 안 하여
```
PS C:\>Disable-AzBatchJob -Id "Job-000001" -DisableJobOption "Terminate" -BatchContext $Context
```

이 명령은 ID Job-0000001이 있는 작업을 사용하지 않도록 설정합니다.
명령은 작업에 대한 활성 작업을 종료합니다.
...
### -DisableJobOption
이 cmdlet이 사용하지 않도록 설정한 작업과 연결된 활성 태스크로 수행할 작업을 지정합니다.
유효한 값은:
- 다시 퀘이어
- 종료
- 대기 중
...
### -Id
이 cmdlet이 사용하지 않도록 설정한 작업의 ID를 지정합니다.
