...
## SYNOPSIS
관리되는 인스턴스에 대한 TDE(투명한 데이터 SQL 보호합니다.
...
## 설명
Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet은 지정된 관리되는 인스턴스에 대한 TDE SQL 합니다.
...
이 명령은 ContosoResourceGroup이라는 리소스 그룹에서 ContosoManagedInstanceName이라는 관리 인스턴스에 대한 TDE 보호를 제공합니다.
