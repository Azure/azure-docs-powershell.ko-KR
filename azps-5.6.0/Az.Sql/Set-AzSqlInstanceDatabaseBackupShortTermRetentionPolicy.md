...
## 설명
**Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** cmdlet은 이 데이터베이스에 등록된 단기 보존 정책을 제공합니다.
...
이 명령은 삭제된 데이터베이스 개체의 배관을 통해 DB1이라는 모든 삭제된 데이터베이스에 대한 단기 보존 정책을 설정합니다. 삭제된 데이터베이스에 대한 보존 기간만 줄일 수 있습니다.
