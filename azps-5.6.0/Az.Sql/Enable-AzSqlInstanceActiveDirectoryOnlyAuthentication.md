...
## SYNOPSIS
특정 Managed Instance에 대해 Azure AD SQL 수 있습니다.
...
## 설명
**Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** cmdlet을 사용하면 Azure AD(Azure Active Directory) 현재 구독에서 AzureSQL Managed Instance에 대한 인증 요구 사항만 사용할 수 있습니다.
...
이 명령은 ResourceGroup01이라는 리소스 그룹과 연결된 ManagedInstance01이라는 AzureSQL Managed Instance에만 Azure AD(Azure Active Directory) 인증 요구 사항을 사용할 수 있습니다.
