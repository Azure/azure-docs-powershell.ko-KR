...
## SYNOPSIS
데이터베이스의 열의 정보 형식 및 민감도 레이블을 설정합니다.
...
## 설명
Set-AzSqlDatabaseSensitivityClassification cmdlet은 데이터베이스의 열의 정보 형식 및 민감도 레이블을 설정합니다.

## 예제

### 예제 1: Azure SQL 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
...
### 예제 2: Azure SQL 열의 권장 정보 형식 및 민감도 레이블을 설정합니다.
```powershell
...
### 예제 3: 배관을 사용하여 Azure SQL 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
