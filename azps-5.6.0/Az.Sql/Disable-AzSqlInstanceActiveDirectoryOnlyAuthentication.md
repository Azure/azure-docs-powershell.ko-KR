...
## SYNOPSIS
특정 Managed Instance에 대한 Azure AD SQL 사용하지 않도록 설정합니다.
...
## 설명
**Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** cmdlet은 현재 구독에서 AzureSQL Managed Instance에 대한 인증 요구 사항만 Azure AD(Azure Active Directory)를 사용하지 않도록 설정합니다.
...
이 명령은 ResourceGroup01이라는 리소스 그룹과 연결된 ManagedInstance01이라는 AzureSQL Managed Instance에만 Azure AD(Azure Active Directory) 인증 요구 사항을 사용하지 않도록 설정합니다.
...
### -InstanceName
Azure SQL Azure Active Directory만 인증에 있는 Managed Instance의 이름입니다.
