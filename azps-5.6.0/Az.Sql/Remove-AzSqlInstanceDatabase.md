...
## SYNOPSIS
Managed Instance SQL Azure를 제거합니다.

## 구문

### RemoveInstanceDatabaseFromInputParameters(기본값)
```
...
## 설명
**Remove-AzSqlInstanceDatabase** cmdlet은 Azure SQL 데이터베이스를 제거합니다.
...
이 명령은 Instance managedInstance1에서 Database01이라는 데이터베이스를 제거합니다.
...
### -ResourceId
제거할 Instance Database 개체의 리소스 ID
