...
## 설명
**Get-AzSqlServerAudit** cmdlet은 Azure SQL 설정됩니다.
*Server를 식별하기 위해 ResourceGroupName* 및 *ServerName* 매개 변수를 지정합니다.

## 예제

### 예제 1: Azure 서버의 감사 SQL
```
...
### 예제 2: 파이프라인을 통해 Azure 서버의 감사 설정 SQL 합니다.
```
