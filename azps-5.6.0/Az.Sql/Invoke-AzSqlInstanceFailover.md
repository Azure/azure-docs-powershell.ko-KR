...
## SYNOPSIS
Managed Instance에서 Azure SQL 장애 조치(Failover)를 실행합니다.
...
## 설명
**Invoke-AzSqlInstanceFailover** cmdlet은 Azure SQL 장애 조치(failover)합니다.
...
이 명령은 "ManagedInstance01"이라는 인스턴스의 기본 복제본을 장애 조치합니다.
