...
## 설명
Disable-AzSqlDatabaseSensitivityRecommendation cmdlet은 데이터베이스의 열에 대한 민감도 권장 사항을 사용하지 않도록 설정(해제)합니다.

## 예제

### 예제 1: Azure SQL 열에서 민감도 권장 사항을 사용하지 않도록 설정합니다.
```powershell
...
### 예제 2: Piping을 사용하여 Azure SQL 권장 사항이 있는 열에 대한 민감도 권장 사항을 사용하지 않도록 설정합니다.
```powershell
...
### 예제 3: Piping을 사용하여 Azure SQL 열에 대한 민감도 권장 사항을 사용하지 않도록 설정합니다.
```powershell
