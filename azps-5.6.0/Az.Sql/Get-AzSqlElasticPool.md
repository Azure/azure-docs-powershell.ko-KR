...
## SYNOPSIS
Azure SQL 데이터베이스에서 탄력적 풀 및 해당 속성 값을 얻습니다.
...
기존 탄력적 풀의 이름을 지정하여 해당 풀에 대한 속성 값을 표시합니다.
...
이 명령은 Server01이라는 서버의 모든 탄력적 풀을 얻습니다.
...
### 예제 3: Azure SQL 탄력적 데이터베이스 풀에 대한 메트릭을 얻습니다.
```
...
이 명령은 ElasticPool01이라는 azure SQL 탄력적 데이터베이스 풀에 대한 메트릭을 반환합니다.

### 예제 4: 필터링 -ElasticPoolName "ElasticPool*" 필터링을 사용하여 모든 탄력적 풀을 얻습니다.
```
PS C:\>Get-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
ResourceId        : /subscriptions/00000000-0000-0000-0000-000000000001/resourceGroups/resourcegroup01/providers/Microsoft.Sql/servers/server01/elasticPools/elasticpool01
ResourceGroupName : resourcegroup01
...
이 명령은 "ElasticPool"으로 시작하는 Server01이라는 서버의 모든 탄력적 풀을 얻습니다.
...
### -ResourceGroupName
이 cmdlet에서 얻을 탄력적 풀을 포함하는 리소스 그룹의 이름을 지정합니다.
...
### -ServerName
이 cmdlet이 얻을 탄력적 풀을 포함하는 서버 이름을 지정합니다.
