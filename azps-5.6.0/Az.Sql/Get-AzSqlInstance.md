...
## SYNOPSIS
Managed Database Instance에 대한 Azure SQL 반환합니다.
...
## 설명
**Get-AzSqlInstance** cmdlet은 Managed Instances에 대한 하나 이상의 Azure SQL 반환합니다.
인스턴스의 이름을 지정하여 해당 인스턴스에 대한 정보를 볼 수 있습니다.
...
이 명령은 ResourceGroup01 리소스 그룹에 할당된 모든 인스턴스에 대한 정보를 얻습니다.
...
### 예제 7: 리소스 식별자를 사용하여 관리되는 인스턴스를 얻다
```powershell
