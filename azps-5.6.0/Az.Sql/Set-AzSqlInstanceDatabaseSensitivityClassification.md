...
## SYNOPSIS
Azure 및 관리되는 인스턴스 데이터베이스에서 열의 정보 형식 및 민감도 SQL 설정합니다.
...
## 설명
Set-AzSqlInstanceDatabaseSensitivityClassification cmdlet은 Azure SQL 관리되는 인스턴스 데이터베이스의 열의 정보 형식 및 민감도 레이블을 설정합니다.

## 예제

### 예제 1: 관리되는 인스턴스 데이터베이스에서 Azure SQL 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
...
### 예제 2: Azure 관리되는 인스턴스 데이터베이스에서 권장되는 정보 유형 및 열의 민감도 SQL 설정합니다.
```powershell
...
### 예제 3: 배관을 사용하여 Azure SQL 관리되는 인스턴스 데이터베이스에서 열의 정보 유형 및 민감도 레이블을 설정합니다.
```powershell
...
관리되는 인스턴스 데이터베이스 SQL 분류를 나타내는 개체입니다.
