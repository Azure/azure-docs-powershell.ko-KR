...
## SYNOPSIS
데이터베이스의 열의 정보 형식 및 민감도 레이블을 제거합니다.
...
## 설명
Remove-AzSqlDatabaseSensitivityClassification cmdlet은 데이터베이스의 열의 정보 형식 및 민감도 레이블을 제거합니다.

## 예제

### 예제 1: Azure SQL 열의 정보 형식 및 민감도 레이블을 제거합니다.
```powershell
