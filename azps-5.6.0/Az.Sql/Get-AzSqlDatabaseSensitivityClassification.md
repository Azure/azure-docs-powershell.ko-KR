...
## SYNOPSIS
데이터베이스의 열의 현재 정보 유형 및 민감도 레이블을 얻습니다.
...
## 설명
Get-AzSqlDatabaseSensitivityClassification cmdlet은 Azure SQL 열의 현재 정보 형식 및 민감도 레이블을 반환합니다.

## 예제

### 예제 1: Azure 데이터베이스 데이터베이스의 현재 정보 유형 및 민감도 레이블을 SQL.
```powershell
...
### 예제 2: Piping을 사용하여 Azure SQL 데이터베이스의 현재 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
...
### 예제 3: Azure 데이터베이스의 특정 열의 현재 정보 유형 및 민감도 레이블을 SQL 합니다.
```powershell
...
### 예제 4: Piping을 사용하여 Azure SQL 열의 현재 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
