...
## SYNOPSIS
데이터베이스를 복원할 수 있는 SQL 복원 지점을 만듭니다.
...
## 설명
**New-AzSqlDatabaseRestorePoint** cmdlet은 Azure SQL 데이터 웨어하우스에서 복원할 수 있는 새 복원 지점을 만듭니다.
이 cmdlet은 현재 Azure SQL 지원됩니다.
...
이 명령은 Azure SQL 데이터 웨어하우스에 대한 복원 지점을 만들고 복원 지점의 세부 정보를 반환합니다.
