...
## SYNOPSIS
가상 네트워크 규칙을 사용하여 Azure SQL Server 나열합니다.
...
## 설명
이 명령은 특정 Azure SQL Server 가상 네트워크 규칙 또는 서버 SQL Server 가상 네트워크 규칙 목록을 얻습니다.
...
지정된 서버 아래에서 Azure SQL Server 가상 네트워크 규칙 목록을 얻습니다.
...
"virtualNetworkRule"으로 시작하는 지정된 SQL Server 아래에서 Azure 가상 네트워크 규칙 목록을 얻습니다.
