...
## 설명
**Get-AzSqlDatabaseRestorePoint** cmdlet은 Azure SQL 데이터 웨어하우스에서 복원할 수 있는 고유한 복원 지점을 검색합니다.
Azure SQL 데이터베이스의 경우 복원 창이 연속됩니다.
즉, 데이터베이스의 백업 보존 기간의 모든 시점을 복원 지점으로 사용할 수 있습니다.
이 cmdlet은 Azure의 SQL Server Stretch Database 서비스에서 지원됩니다.

## 예제

### 예제 1: 모든 복원 지점을 얻게 됩니다.
```
