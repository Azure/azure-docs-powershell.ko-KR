...
## 설명
이 명령은 서버를 그대로 SQL Server 서버에서 Azure SQL Server DNS 별칭을 제거합니다.
...
이름 서버 SQL Server 서버에서 별칭이 있는 Azure SQL Server DNS 별칭 제거
