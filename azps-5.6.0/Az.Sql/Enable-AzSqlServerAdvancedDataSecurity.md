...
## 설명
**Enable-AzSqlServerAdvancedDataSecurity** cmdlet을 사용하면 서버에서 고급 데이터 보안을 사용할 수 있습니다. 고급 데이터 보안은 서버에 대한 데이터 분류, 취약성 평가 및 고급 위협 보호를 포함하는 통합 보안 패키지입니다. (취약성 평가를 저장하기 위해 새 저장소 계정이 자동으로 생성됩니다. 이러한 목적으로 이전에 저장소 계정을 만든 경우 대신 사용됩니다.
...
서버에서 고급 데이터 보안을 사용할 수 있습니다. (자동 재생)
