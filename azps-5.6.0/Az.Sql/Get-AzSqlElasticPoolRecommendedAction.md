...
## SYNOPSIS
탄력적 풀 Advisor에서 Azure에 대해 하나 SQL 작업을 제공합니다.
...
## 설명
**Get-AzSqlElasticPoolRecommendedAction** cmdlet은 Azure SQL 권장되는 작업을 제공합니다.
...
이 명령은 \[ \] \[ CreateIndex라는 IR_ test_schema _test_table_0.0361551 _6C7AE8CC9C87E7FD5893 권장되는 작업을 \] 제공합니다.

## 매개 변수

### -AdvisorName
이 cmdlet에서 권장 작업을 요청하는 어드바이저의 이름을 지정합니다.
...
### -ElasticPoolName
이 cmdlet에서 권장 작업을 요청하는 탄력적 풀의 이름을 지정합니다.
