...
## SYNOPSIS
Managed Instance SQL Azure를 만듭니다.
...
## 설명
**New-AzSqlInstanceDatabase** cmdlet은 Azure SQL 데이터베이스를 만듭니다.
...
이 명령은 instance managedInstance1에서 Database01이라는 인스턴스 데이터베이스를 만듭니다.
...
### -Collation
사용할 인스턴스 데이터베이스 SQL Azure의 데이터 데이터 통합입니다.
...
### -Name
Azure 인스턴스 데이터베이스의 SQL 인스턴스 데이터베이스를 만듭니다.
...
### -Tag
Azure Sql Instance Database와 연결되는 태그
