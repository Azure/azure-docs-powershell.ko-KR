...
### [<span data-ttu-id="50587-111">Add-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="50587-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="50587-125">Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="50587-125">Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
...
### [<span data-ttu-id="50587-139">Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="50587-139">Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Convert-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
...
### [<span data-ttu-id="50587-151">Disable-AzSqlServerAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="50587-151">Disable-AzSqlServerAdvancedDataSecurity</span></span>](Disable-AzSqlServerAdvancedDataSecurity.md)
...
### [<span data-ttu-id="50587-163">Enable-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="50587-163">Enable-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Enable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="50587-177">Get-AzSqlDatabaseAdvisor</span><span class="sxs-lookup"><span data-stu-id="50587-177">Get-AzSqlDatabaseAdvisor</span></span>](Get-AzSqlDatabaseAdvisor.md)
...
### [<span data-ttu-id="50587-191">Get-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-191">Get-AzSqlDatabaseFailoverGroup</span></span>](Get-AzSqlDatabaseFailoverGroup.md)
...
### [<span data-ttu-id="50587-205">Get-AzSqlDatabaseRecommendedAction</span><span class="sxs-lookup"><span data-stu-id="50587-205">Get-AzSqlDatabaseRecommendedAction</span></span>](Get-AzSqlDatabaseRecommendedAction.md)
...
### [<span data-ttu-id="50587-217">Get-AzSqlDatabaseTransparentDataEncryptionActivity</span><span class="sxs-lookup"><span data-stu-id="50587-217">Get-AzSqlDatabaseTransparentDataEncryptionActivity</span></span>](Get-AzSqlDatabaseTransparentDataEncryptionActivity.md)
...
### [<span data-ttu-id="50587-231">Get-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="50587-231">Get-AzSqlElasticJob</span></span>](Get-AzSqlElasticJob.md)
...
### [<span data-ttu-id="50587-247">Get-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="50587-247">Get-AzSqlElasticPool</span></span>](Get-AzSqlElasticPool.md)
...
### [<span data-ttu-id="50587-261">Get-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="50587-261">Get-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Get-AzSqlInstanceActiveDirectoryAdministrator.md)
...
### [<span data-ttu-id="50587-273">Get-AzSqlInstanceDatabaseGeoBackup</span><span class="sxs-lookup"><span data-stu-id="50587-273">Get-AzSqlInstanceDatabaseGeoBackup</span></span>](Get-AzSqlInstanceDatabaseGeoBackup.md)
...
### [<span data-ttu-id="50587-287">Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="50587-287">Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="50587-301">Get-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="50587-301">Get-AzSqlServer</span></span>](Get-AzSqlServer.md)
...
### [<span data-ttu-id="50587-315">Get-AzSqlServerCommunicationLink</span><span class="sxs-lookup"><span data-stu-id="50587-315">Get-AzSqlServerCommunicationLink</span></span>](Get-AzSqlServerCommunicationLink.md)
...
### [<span data-ttu-id="50587-329">Get-AzSqlServerRecommendedAction</span><span class="sxs-lookup"><span data-stu-id="50587-329">Get-AzSqlServerRecommendedAction</span></span>](Get-AzSqlServerRecommendedAction.md)
...
### [<span data-ttu-id="50587-343">Get-AzSqlSyncAgentLinkedDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-343">Get-AzSqlSyncAgentLinkedDatabase</span></span>](Get-AzSqlSyncAgentLinkedDatabase.md)
...
### [<span data-ttu-id="50587-359">Invoke-AzSqlInstanceFailover</span><span class="sxs-lookup"><span data-stu-id="50587-359">Invoke-AzSqlInstanceFailover</span></span>](Invoke-AzSqlInstanceFailover.md)
...
### [<span data-ttu-id="50587-373">New-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-373">New-AzSqlDatabaseInstanceFailoverGroup</span></span>](New-AzSqlDatabaseInstanceFailoverGroup.md)
...
### [<span data-ttu-id="50587-387">New-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="50587-387">New-AzSqlElasticPool</span></span>](New-AzSqlElasticPool.md)
...
### [<span data-ttu-id="50587-403">New-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="50587-403">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="50587-419">Remove-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="50587-419">Remove-AzSqlDatabaseDataMaskingRule</span></span>](Remove-AzSqlDatabaseDataMaskingRule.md)
...
### [<span data-ttu-id="50587-433">Remove-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="50587-433">Remove-AzSqlDatabaseSensitivityClassification</span></span>](Remove-AzSqlDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="50587-447">Remove-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="50587-447">Remove-AzSqlElasticPool</span></span>](Remove-AzSqlElasticPool.md)
...
### [<span data-ttu-id="50587-461">Remove-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="50587-461">Remove-AzSqlInstancePool</span></span>](Remove-AzSqlInstancePool.md)
...
### [<span data-ttu-id="50587-475">Remove-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="50587-475">Remove-AzSqlServerFirewallRule</span></span>](Remove-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="50587-485">Remove-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="50587-485">Remove-AzSqlSyncGroup</span></span>](Remove-AzSqlSyncGroup.md)
<span data-ttu-id="50587-486">Azure 데이터베이스 동기화 SQL 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-486">Removes an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="50587-487">Remove-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="50587-487">Remove-AzSqlSyncMember</span></span>](Remove-AzSqlSyncMember.md)
<span data-ttu-id="50587-488">Azure 데이터베이스 동기화 SQL 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-488">Removes an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="50587-489">Remove-AzSqlVirtualCluster</span><span class="sxs-lookup"><span data-stu-id="50587-489">Remove-AzSqlVirtualCluster</span></span>](Remove-AzSqlVirtualCluster.md)
<span data-ttu-id="50587-490">가상 클러스터에서 Azure SQL 제거합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-490">Removes an Azure SQL Virtual Cluster.</span></span>

### [<span data-ttu-id="50587-491">Restore-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-491">Restore-AzSqlDatabase</span></span>](Restore-AzSqlDatabase.md)
<span data-ttu-id="50587-492">데이터베이스를 SQL 복원합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-492">Restores a SQL database.</span></span>

### [<span data-ttu-id="50587-493">Restore-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-493">Restore-AzSqlInstanceDatabase</span></span>](Restore-AzSqlInstanceDatabase.md)
<span data-ttu-id="50587-494">Managed Instance SQL Azure를 복원합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-494">Restores an Azure SQL Managed Instance database.</span></span>

### [<span data-ttu-id="50587-495">Resume-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-495">Resume-AzSqlDatabase</span></span>](Resume-AzSqlDatabase.md)
<span data-ttu-id="50587-496">데이터 SQL 데이터베이스를 다시 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-496">Resumes a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="50587-497">Set-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-497">Set-AzSqlDatabase</span></span>](Set-AzSqlDatabase.md)
<span data-ttu-id="50587-498">데이터베이스에 대한 속성을 설정하거나 기존 데이터베이스를 탄력적 풀로 이동합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-498">Sets properties for a database, or moves an existing database into an elastic pool.</span></span>

### [<span data-ttu-id="50587-499">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="50587-499">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span></span>](Set-AzSqlDatabaseAdvisorAutoExecuteStatus.md)
<span data-ttu-id="50587-500">Azure 데이터베이스 Advisor의 자동 SQL 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-500">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="50587-501">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="50587-501">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="50587-502">Azure 데이터베이스 데이터베이스의 감사 SQL 변경합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-502">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="50587-503">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-503">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="50587-504">서버 장기 보존 정책을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-504">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="50587-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-505">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="50587-506">백업 단기 보존 정책을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-506">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="50587-507">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-507">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="50587-508">데이터베이스에 대한 데이터 마스킹을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-508">Sets data masking for a database.</span></span>

### [<span data-ttu-id="50587-509">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="50587-509">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="50587-510">데이터베이스에 대한 데이터 마스킹 규칙의 속성을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-510">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="50587-511">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-511">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="50587-512">Azure 데이터베이스 장애 조치(failover) 그룹에서 Azure SQL 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-512">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="50587-513">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-513">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="50587-514">데이터베이스 지역 백업 정책을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-514">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="50587-515">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-515">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="50587-516">인스턴스 장애 조치(Failover) 그룹의 구성을 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-516">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="50587-517">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="50587-517">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="50587-518">Azure 데이터베이스 권장 작업의 SQL 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-518">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="50587-519">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="50587-519">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="50587-520">장애 조치(failover)를 시작하려면 보조 데이터베이스를 기본 데이터베이스로 전환합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-520">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="50587-521">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="50587-521">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="50587-522">데이터베이스의 열의 정보 형식 및 민감도 레이블을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-522">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="50587-523">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="50587-523">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="50587-524">데이터베이스에 대한 TDE 속성을 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-524">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="50587-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="50587-525">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="50587-526">취약성 평가 규칙 기준을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-526">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="50587-527">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="50587-527">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="50587-528">작업 업데이트</span><span class="sxs-lookup"><span data-stu-id="50587-528">Updates a job</span></span>

### [<span data-ttu-id="50587-529">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="50587-529">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="50587-530">탄력적 작업 에이전트 업데이트</span><span class="sxs-lookup"><span data-stu-id="50587-530">Updates an elastic job agent</span></span>

### [<span data-ttu-id="50587-531">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="50587-531">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="50587-532">작업 자격 증명 업데이트</span><span class="sxs-lookup"><span data-stu-id="50587-532">Updates a job credential</span></span>

### [<span data-ttu-id="50587-533">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="50587-533">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="50587-534">작업 단계 업데이트</span><span class="sxs-lookup"><span data-stu-id="50587-534">Updates a job step</span></span>

### [<span data-ttu-id="50587-535">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="50587-535">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="50587-536">Azure 데이터베이스 데이터베이스에서 탄력적 데이터베이스 풀의 SQL 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-536">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="50587-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="50587-537">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="50587-538">Elastic Pool Advisor에서 Azure SQL 실행 상태를 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-538">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="50587-539">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="50587-539">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="50587-540">탄력적 풀 권장 작업에서 Azure SQL 상태를 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-540">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="50587-541">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="50587-541">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="50587-542">Azure SQL Managed Instance에 대한 속성을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-542">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="50587-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="50587-543">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="50587-544">Managed Instance에 대한 Azure AD SQL 프로비전합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-544">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="50587-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-545">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="50587-546">**Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet은 관리되는 데이터베이스의 장기 보존 정책을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-546">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="50587-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="50587-547">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="50587-548">백업 단기 보존 정책을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-548">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="50587-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="50587-549">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="50587-550">Azure 및 관리되는 인스턴스 데이터베이스에서 열의 정보 형식 및 민감도 SQL 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-550">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="50587-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="50587-551">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="50587-552">취약성 평가 규칙 기준을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-552">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="50587-553">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="50587-553">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="50587-554">Azure SQL 인스턴스 풀에 대한 속성을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-554">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="50587-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="50587-555">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="50587-556">관리되는 인스턴스에 대해 TDE(투명한 데이터 암호화) SQL 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-556">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="50587-557">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="50587-557">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="50587-558">데이터베이스 서버의 SQL 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-558">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="50587-559">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="50587-559">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="50587-560">Azure AD 관리자를 프로비전하여 SQL Server.</span><span class="sxs-lookup"><span data-stu-id="50587-560">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="50587-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="50587-561">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="50587-562">Azure SQL Server 실행 상태를 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-562">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="50587-563">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="50587-563">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="50587-564">Azure 서버의 감사 SQL 변경합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-564">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="50587-565">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="50587-565">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="50587-566">데이터베이스 서버 복구 구성을 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-566">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="50587-567">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="50587-567">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="50587-568">Azure에서 DNS 별칭이 SQL Server 서버를 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-568">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="50587-569">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="50587-569">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="50587-570">Azure SQL 데이터베이스 서버에서 방화벽 규칙을 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-570">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="50587-571">Set-AzSqlServerMSSupportAudit</span><span class="sxs-lookup"><span data-stu-id="50587-571">Set-AzSqlServerMSSupportAudit</span></span>](Set-AzSqlServerMSSupportAudit.md)
<span data-ttu-id="50587-572">Azure 데이터베이스의 Microsoft 지원 작업 감사 설정을 SQL 변경합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-572">Changes the Microsoft support operations auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="50587-573">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="50587-573">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="50587-574">권장되는 작업에서 Azure SQL Server 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-574">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="50587-575">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="50587-575">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="50587-576">TDE(투명한 데이터 암호화) 보호구를 서버의 SQL 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-576">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="50587-577">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="50587-577">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="50587-578">가상 네트워크 규칙에서 Azure SQL Server 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-578">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="50587-579">Start-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="50587-579">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="50587-580">권장 인덱스 작업을 실행하는 워크플로를 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-580">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="50587-581">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="50587-581">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="50587-582">취약성 평가 검색을 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="50587-583">Start-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="50587-583">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="50587-584">작업을 시작하고 폴링하여 상태를 볼 수 있는 작업 실행 ID를 반환합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-584">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="50587-585">Start-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="50587-585">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="50587-586">주어진 매개 변수를 사용하여 Log Replay 서비스를 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-586">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="50587-587">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="50587-587">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="50587-588">취약성 평가 검색을 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-588">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="50587-589">Start-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="50587-589">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="50587-590">동기화 그룹 동기화를 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-590">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="50587-591">Stop-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="50587-591">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="50587-592">데이터베이스의 비동기 업데이트 작업을 취소합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-592">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="50587-593">Stop-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="50587-593">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="50587-594">권장 인덱스 작업을 실행하는 워크플로를 중지합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-594">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="50587-595">Stop-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="50587-595">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="50587-596">작업 실행 ID가 주어진 작업을 중지합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-596">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="50587-597">Stop-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="50587-597">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="50587-598">탄력적 풀에서 비동기 업데이트 작업을 취소합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-598">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="50587-599">Stop-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="50587-599">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="50587-600">데이터베이스를 삭제하여 Log Replay 서비스를 취소합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-600">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="50587-601">Stop-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="50587-601">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="50587-602">관리되는 SQL 작업을 중지합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-602">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="50587-603">Stop-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="50587-603">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="50587-604">동기화 그룹 동기화를 중지합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-604">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="50587-605">suspend-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="50587-605">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="50587-606">데이터 SQL 데이터베이스를 일시 중단합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-606">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="50587-607">Switch-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-607">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="50587-608">Azure 데이터베이스 장애 조치(failover) 그룹의 장애 조치(failover)SQL 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-608">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="50587-609">Switch-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="50587-609">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="50587-610">인스턴스 장애 조치(failover) 그룹의 장애 조치(failover)를 실행합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-610">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="50587-611">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="50587-611">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="50587-612">데이터베이스에 대한 고급 위협 보호 설정을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-612">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="50587-613">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="50587-613">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="50587-614">데이터베이스의 취약성 평가 설정을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-614">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="50587-615">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="50587-615">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="50587-616">관리되는 데이터베이스의 취약성 평가 설정을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-616">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="50587-617">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="50587-617">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="50587-618">관리되는 인스턴스의 취약성 평가 설정을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-618">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="50587-619">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="50587-619">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="50587-620">서버에서 고급 위협 보호 설정을 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-620">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="50587-621">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="50587-621">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="50587-622">서버의 취약성 평가 설정을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-622">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="50587-623">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="50587-623">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="50587-624">Azure 데이터베이스 SQL 동기화 그룹을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-624">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="50587-625">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="50587-625">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="50587-626">Azure 데이터베이스 동기화 SQL 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-626">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="50587-627">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="50587-627">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="50587-628">동기화 멤버 데이터베이스 또는 동기화 허브 데이터베이스에 대한 동기화척도 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-628">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="50587-629">실제 데이터베이스에서 최신 데이터베이스를 얻은 다음 동기화 메타데이터 데이터베이스로 캐시된 스마를 새로 고침합니다.</span><span class="sxs-lookup"><span data-stu-id="50587-629">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="50587-630">"SyncMemberName"이 지정되어 있는 경우 멤버 데이터베이스척도 새로 고침됩니다. 그렇지 않은 경우 허브 데이터베이스를 새로 고치게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="50587-630">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
