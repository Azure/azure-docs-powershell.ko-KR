...
## 설명
**Get-AzSqlElasticPoolRecommendation** cmdlet은 서버에 대한 탄력적 풀 권장 사항을 제공합니다.
이러한 권장 사항은 다음과 같은 값을 포함합니다.
...
- StorageMb. 탄력적 풀의 저장소는 메가바이트입니다. 
- 버전입니다. 탄력적 풀에 대한 버전입니다. 이 매개 변수에 대해 허용되는 값은 기본, 표준 및 프리미엄입니다. 
...
이 명령은 Server01이라는 서버에 대한 탄력적 풀 권장 사항을 제공합니다.
...
### -ServerName
이 cmdlet에서 권장 사항을 얻을 서버의 이름을 지정합니다.
