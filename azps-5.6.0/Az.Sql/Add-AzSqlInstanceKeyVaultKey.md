...
## 설명
Add-AzSqlInstanceKeyVaultKey cmdlet은 제공된 Managed Instance에 키 자격 증명 모음 키를 추가합니다. 관리되는 인스턴스에는 자격 증명 모음에 'get, wrapKey, unwrapKey' 권한이 있어야 합니다. 다음 스크립트를 사용하여 관리되는 인스턴스에 대한 권한을 부여합니다.
...
이 명령은 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 'ContosoResourceGroup'의 'ContosoManagedInstanceName'이라는 SQL 관리되는 인스턴스에 Id ''를 사용하여 Key Vault 키를 추가합니다. 
