...
## SYNOPSIS
데이터베이스의 열의 권장 정보 유형 및 민감도 레이블을 얻습니다.
...
## 설명
Get-AzSqlDatabaseSensitivityRecommendation cmdlet은 데이터베이스의 열의 권장 정보 유형 및 민감도 레이블을 반환합니다.

## 예제

### 예제 1: Azure 데이터베이스 데이터베이스의 권장 정보 유형 및 민감도 레이블을 SQL.
```powershell
