...
## SYNOPSIS
가상 네트워크 규칙에서 Azure SQL Server 수정합니다.
...
## 설명
이 명령은 Azure SQL Server 가상 네트워크 규칙의 구성을 수정합니다.
서버에서 가상 네트워크 규칙 집합을 제어하려면 대신 'Add-AzSqlServerVirtualNetworkRule'과 'Remove-AzSqlServerVirtualNetworkRule'을 사용합니다.
