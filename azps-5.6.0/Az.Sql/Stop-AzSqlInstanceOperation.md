...
## 설명
Stop-AzSqlInstanceOperation cmdlet은 관리되는 인스턴스에서 제공된 작업 이름을 SQL 중지합니다.
...
이 명령은 관리되는 인스턴스에서 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9'를 사용하여 작업을 SQL 중지합니다.
...
이 명령은 리소스 ID $managedInstanceOperation.Id.
...
이 명령은 개체가 있는 작업을 $managedInstanceOperation.
