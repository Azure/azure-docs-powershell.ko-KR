...
## SYNOPSIS
Azure 데이터베이스 Advisor에 대해 하나 이상의 권장 SQL 합니다.
...
## 설명
**Get-AzSqlDatabaseRecommendedAction** cmdlet은 Azure SQL 권장되는 작업을 제공합니다.

## 예제

### 예제 1: Advisor에 대한 권장되는 모든 작업 나열
```
...
이 명령은 CreateIndex라는 Advisor에 IR_ test_schema \[ \] \[ _test_table_0.0361551 _6C7AE8CC9C87E7FD5893 라는 권장 작업을 \] 제공합니다.

## 매개 변수

### -AdvisorName
이 cmdlet에서 권장 작업을 요청하는 Advisor의 이름을 지정합니다.
...
### -DatabaseName
이 cmdlet에서 권장 작업을 요청하는 데이터베이스의 이름을 지정합니다.
