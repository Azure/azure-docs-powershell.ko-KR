...
## SYNOPSIS
특정 사용자에 대해 Azure AD만 인증을 SQL Server.
...
## 설명
**Enable-AzSqlServerActiveDirectoryOnlyAuthentication** cmdlet을 사용하면 Azure AD(Azure Active Directory) 현재 구독에서 AzureSQL Server에 대한 인증 요구 사항만 사용할 수 있습니다.
...
이 명령은 ResourceGroup01이라는 리소스 그룹과 연결된 Server01이라는 AzureSQL 서버에 대해 Azure AD(Azure Active Directory) 인증 요구 사항만 사용할 수 있습니다.
