...
## SYNOPSIS
주어진 데이터베이스에 대한 Log Replay 서비스를 완료합니다.
...
## 설명
**Complete-AzSqlInstanceDatabaseLogReplay** cmdlet은 주어진 데이터베이스의 Log Replay 서비스를 완료합니다.
...
이 명령은 마지막 백업이 복원된 후 주어진 데이터베이스에 대한 Log Replay 서비스를 완료합니다.
