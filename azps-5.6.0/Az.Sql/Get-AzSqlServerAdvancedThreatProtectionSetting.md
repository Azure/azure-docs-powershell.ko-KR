...
## 설명
**Get-AzSqlServerAdvancedThreatProtectionSetting** cmdlet은 Azure SQL 보호 설정을 제공합니다.
이 cmdlet을 사용하려면 *ResourceGroupName* 및 *ServerName* 매개 변수를 지정하여 이 cmdlet에서 설정을 받을 서버를 식별합니다.
...
이 명령은 Server01이라는 서버에 대한 고급 위협 보호 설정을 제공합니다.
서버는 ResourceGroup11 리소스 그룹에 할당됩니다.
