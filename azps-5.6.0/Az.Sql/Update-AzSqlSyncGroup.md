...
## SYNOPSIS
Azure 데이터베이스 SQL 동기화 그룹을 업데이트합니다.
...
## 설명
**Update-AzSqlSyncGroup** cmdlet은 Azure 데이터베이스 동기화 그룹의 속성을 SQL 수정합니다.

## 예제

### 예제 1: Azure SQL 데이터베이스를 업데이트합니다.
```
...
이 명령은 Azure SQL 동기화 그룹을 업데이트합니다. "schema.js"은 로컬 디스크의 파일입니다. json 형식의 schema 페이로드가 포함되어 있습니다. schema json의 예로 {"Tables": [{"Columns": [{"QuotedName": "b3ee3a7f-7614-4644-ad07-afa832620b4bManualTestsm4column1"}, {"QuotedName": "b3ee3a7f-7614-4644-ad07-afa832620b4bManualTestsm4column2"}], "QuotedName": "MayQuotedTable1"}, {"Columns": [{"QuotedName": "b3ee3a7f-7614-4644-ad07-afa832620b4bManualTestsm4column1"}, {"QuotedName": "b3ee3a7f-7614-4644-ad07-afa832620b4bManualTestsm4column2"}]: "MayQuotedTable2"}], "MasterSyncMemberName": null }
