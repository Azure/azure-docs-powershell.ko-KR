...
## SYNOPSIS
Azure 데이터베이스 동기화 멤버에 대한 SQL 반환합니다.
...
## 설명
**Get-AzSqlSyncMember** cmdlet은 데이터베이스 동기화 멤버에 대한 하나 SQL 반환합니다.
동기화 멤버의 이름을 지정하여 해당 동기화 멤버에 대한 정보를 표시합니다.
...
이 명령은 "SyncMember01"을 사용하여 Azure SQL 데이터베이스 동기화 멤버에 대한 정보를 얻습니다.
...
이 명령은 "SyncMember"로 시작하는 동기화 SQL SyncGroup01에 할당된 모든 Azure 데이터베이스 동기화 멤버에 대한 정보를 얻습니다.
