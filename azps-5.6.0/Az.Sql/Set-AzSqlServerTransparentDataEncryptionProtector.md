...
## SYNOPSIS
TDE(투명한 데이터 암호화) 보호구를 서버의 SQL 설정합니다.
...
## 설명
Set-AzSqlServerTransparentDataEncryptionProtector cmdlet은 SQL TDE 보호를 설정합니다.
TDE 보호기 유형을 변경하면 보호가 회전됩니다.
...
이 명령은 서버의 TDE 보호자 유형을 Service Managed로 업데이트합니다.
...
이 명령은 서버를 업데이트하여 Id ''가 있는 서버 키 자격 증명 모음 키를 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 TDE 보호기로 사용할 수 있습니다.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Azure Sql Database TDE 보호자 유형입니다.
