...
## SYNOPSIS
Azure 데이터베이스 동기화 그룹의 로그를 SQL 반환합니다.
...
## 설명
**Get-AzSqlSyncGroupLog** cmdlet은 Azure 데이터베이스 동기화 그룹의 로그를 SQL 반환합니다.
...
이 명령은 Azure 동기화 그룹의 로그를 SQL 합니다.
