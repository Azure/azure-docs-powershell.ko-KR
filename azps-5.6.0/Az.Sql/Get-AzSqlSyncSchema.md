...
## SYNOPSIS
멤버 데이터베이스 또는 허브 데이터베이스의 동기화 계획에 대한 정보를 반환합니다.
...
## 설명
**Get-AzSqlSyncSchema** cmdlet은 멤버 데이터베이스 또는 허브 데이터베이스의 동기화척도에 대한 정보를 반환합니다.

## 예제

### 예제 1: 허브 데이터베이스에 대한 동기화척도 얻습니다.
```powershell
...
이 명령은 동기화 그룹 syncGroup01에서 허브 데이터베이스에 대한 동기화 스마를 얻습니다.

### 예제 2: 허브 데이터베이스에 대한 동기화척도 및 테이블 확장
```powershell
...
이 명령은 동기화 그룹 syncGroup01에서 허브 데이터베이스에 대한 동기화를 얻게 하여 테이블 속성을 확장합니다.

### 예제 3: 구성원 데이터베이스에 대한 동기화척도 얻습니다.
```powershell
...
이 명령은 동기화 멤버 syncMember01에서 멤버 데이터베이스에 대한 동기화를 얻습니다.
