...
## 설명
**Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** cmdlet은 이 관리되는 데이터베이스에 대한 장기 보존 정책을 설정합니다.
...
데이터베이스의 장기 보존 주간 정책을 1주로 구성합니다.
...
이 명령은 데이터베이스에서 장기 보존 정책을 제거합니다.

### 예제 3

Set-AzSqlInstanceDatabaseLongTermRetentionBackup cmdlet은 관리되는 데이터베이스의 장기 보존 정책을 설정합니다. (자동 재생)
...
### -DatabaseName
사용할 Azure Managed Database의 이름입니다.
...
### -InstanceName
데이터베이스가 속한 Azure Managed Instance의 이름입니다.
