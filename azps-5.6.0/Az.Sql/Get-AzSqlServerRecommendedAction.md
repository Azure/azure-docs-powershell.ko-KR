...
## SYNOPSIS
Azure SQL Server 권장되는 작업을 제공합니다.
...
## 설명
**Get-AzSqlServerRecommendedAction** cmdlet은 Azure SQL Server 권장되는 작업을 제공합니다.
...
이 명령은 wi-runner-australia-east라는 서버에 사용할 수 있는 CreateIndex라는 SQL Server Advisor에 대해 권장되는 모든 작업 목록을 제공합니다.
...
이 명령은 \[ \] \[ CreateIndex라는 IR_ test_schema _test_table_0.0361551 _6C7AE8CC9C87E7FD5893 라는 권장 작업을 \] 제공합니다.

## 매개 변수

### -AdvisorName
이 cmdlet에서 작업을 요청하는 어드바이저의 이름을 지정합니다.
...
## 참고 사항
* 키워드: azure, azurerm, arm, 리소스, 관리, 관리자, SQL, 서버, mssql, 고문, 권장되는 작업
