...
## 설명
**Remove-AzSqlDatabaseRestorePoint** cmdlet은 Azure SQL 복원 지점을 제거합니다.
이 cmdlet은 현재 Azure SQL Server 데이터베이스의 SQL Server Datawarehouse 서비스에서 SQL 지원합니다.
...
이 명령은 생성 날짜가 주어진 Azure SQL 데이터베이스의 복원 지점을 제거합니다.
