...
## 설명
**New-AzUserAssignedIdentity** cmdlet은 새 사용자 할당 ID를 만듭니다. 기존 ID와 함께 사용하는 경우 ID가 업데이트됩니다.
ID에 Azure Resource Manager 태그를 추가하기 위해 Set-AzResource cmdlet을 사용하세요.

## 예제

### 예제 1
이 예제 cmdlet은 ResourceGroup의 위치에 리소스 그룹 **PSRG** 아래에 이름 **ID1이** 있는 새 사용자 할당 ID를 만듭니다.
...
### 예제 2
이 예제 cmdlet은 서부 지역의 리소스 그룹 **PSRG** 아래에 이름 **ID1이** 있는 새 사용자 할당 ID를 만듭니다.
