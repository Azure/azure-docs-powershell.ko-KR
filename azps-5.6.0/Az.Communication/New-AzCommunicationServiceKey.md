...
### -매개 변수
매개 변수는 액세스 키를 다시 생성하는 요청을 설명합니다. 구성하기 위해 매개 변수 속성에 대한 NOTES 섹션을 참조하고 해시 테이블을 만드십시오.
...
매개 변수 : 매개 변수는 액세스 키를 <IRegenerateKeyParameters> 다시 생성하는 요청을 설명합니다.
  - `[KeyType <KeyType?>]`: 다시 생성하는 keyType입니다. '기본' 또는 '보조'(대소문자 무감소식)되어야 합니다.
