...
통신 서비스에 연결하기 위한 Azure Notification Hub에 대한 설명을 구성하려면 LINKNOTIFICATIONHUBPARAMETER 속성에 대한 노트 섹션을 참조하고 해시 테이블을 만드십시오.
...
LINKNOTIFICATIONHUBPARAMETER : 통신 서비스에 연결하기 위한 Azure Notification Hub에 대한 <ILinkNotificationHubParameters> 설명
