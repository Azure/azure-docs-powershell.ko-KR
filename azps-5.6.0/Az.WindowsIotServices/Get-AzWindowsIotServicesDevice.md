...
## SYNOPSIS
Windows IoT Device Service의 비보안 관련 메타데이터를 확인합니다.
...
### 예제 1: 구독에서 모든 Windows IoT 서비스 다운로드
```powershell
...
이 명령은 구독 아래에서 모든 Windows IoT 서비스를 얻습니다.

### 예제 2: 리소스 그룹에서 모든 Windows IoT 서비스 다운로드
```powershell
...
이 명령은 리소스 그룹 아래에서 모든 Windows IoT 서비스를 얻습니다.

### 예제 3: 이름으로 Windows IoT 서비스 다운로드
```powershell
...
이 명령은 이름으로 Windows IoT 서비스를 얻습니다.

### 예제 4: 개체에 따라 Windows IoT 서비스 다운로드
```powershell
...
이 명령은 개체에 따라 Windows IoT 서비스를 얻습니다.

### 예제 4: 파이프라인에 의해 Windows IoT 서비스 다운로드
```powershell
...
이 명령은 파이프라인에 의해 Windows IoT 서비스를 얻습니다.
