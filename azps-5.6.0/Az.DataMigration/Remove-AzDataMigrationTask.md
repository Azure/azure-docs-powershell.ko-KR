...
## 설명
Remove-AzDataMigrationTask cmdlet은 Azure에서 Azure Database Migration Service 작업을 제거합니다.
...
이전 예제에서는 작업 이름 매개 변수를 기반으로 Azure에서 TestTask라는 Azure Database Migration Service 작업을 제거합니다.
...
위의 예제에서는 전달된 PSProjectTask 개체를 기반으로 Azure Database Migration Service 작업을 제거합니다.
