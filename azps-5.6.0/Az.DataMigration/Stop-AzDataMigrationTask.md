...
위의 예제에서는 project myDMSProject 및 TestService라는 Azure Database Migration Service 인스턴스와 연결된 myDMSTask라는 Azure Database Migration Service 태스크를 중지합니다.
...
위의 예제에서는 입력 매개 변수 PSProjectTask 개체로 전달된 Azure Database Migration Service 태스크를 중지합니다.
