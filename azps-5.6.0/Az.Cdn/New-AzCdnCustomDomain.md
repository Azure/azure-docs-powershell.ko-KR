...
## 설명
**New-AzCdnCustomDomain** cmdlet은 CDN(Azure Content Delivery Network) 엔드포인트에 대한 사용자 지정 도메인을 만듭니다.
...
### -CdnEndpoint
사용자 지정 도메인이 추가되는 CDN 엔드포인트 개체를 지정합니다.
