...
## 설명
New-AzCdnOriginGroup 엔드포인트 내에서 새 원본 그룹을 생성합니다. 엔드포인트의 첫 번째 원본 그룹인 경우 DefaultOriginGroup 속성도 설정해야 합니다.
...
```
이 cmdlet은 지정된 엔드포인트 내에서 새 원본 그룹을 생성합니다. 원본 집합으로 주어진 원본 ID를 활용합니다.
