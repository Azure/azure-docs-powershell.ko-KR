...
## 설명
**Get-AzCognitiveServicesAccount** cmdlet은 *ResourceGroupName* 매개 변수에 의해 지정된 리소스 그룹에서 프로비전된 Cognitive Services 계정을 얻습니다.
...
### -Name
Get할 Cognitive Services 계정의 이름을 지정합니다.
