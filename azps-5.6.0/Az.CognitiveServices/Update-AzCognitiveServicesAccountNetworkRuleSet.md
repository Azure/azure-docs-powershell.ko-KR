...
NetworkRule의 이 명령 업데이트 Bypass 속성(다른 속성은 변경되지 않습니다).
...
이 명령은 Cognitive Services 계정의 NetworkRule 규칙 정리(다른 속성은 변경되지 않습니다).

## 매개 변수

### -DefaultAction
Cognitive Services 계정 NetworkRule DefaultAction. 기본값 `Deny` 입니다.
