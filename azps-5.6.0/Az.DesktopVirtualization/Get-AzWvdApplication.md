...
### 예제 1: 이름에 따라 Windows Virtual Desktop 애플리케이션을 다운로드합니다.
```powershell
...
이 명령은 해당 애플리케이션 그룹에서 Windows Virtual Desktop Application을 얻습니다.

### 예제 2: Windows Virtual Desktop 애플리케이션 나열
```powershell
...
이 명령은 해당 애플리케이션 그룹에 Windows Virtual Desktop 애플리케이션을 나열합니다.
