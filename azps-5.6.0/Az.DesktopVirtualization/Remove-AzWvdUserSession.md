...
### 예제 1: 이름에 따라 Windows Virtual Desktop UserSession 삭제
```powershell
...
이 명령은 세션 호스트에서 Windows Virtual Desktop UserSession을 삭제합니다.
...
### -Force
플래그를 강제로 입력하여 userSession에서 로그인합니다.
