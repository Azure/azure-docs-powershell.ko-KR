...
### 예제 1: 이름에 의해 Windows Virtual Desktop SessionHost 삭제
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

이 명령은 호스트 풀에서 Windows Virtual Desktop SessionHost를 삭제합니다.
...
### -Force
사용자 시전이 있는 경우에도 강제로 sessionHost 지우기를 강제로 지정합니다.
