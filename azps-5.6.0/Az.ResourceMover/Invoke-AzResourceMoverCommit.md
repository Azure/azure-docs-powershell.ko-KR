...
### 예제 1: 리소스를 커밋하기 전에 종속성의 유효성을 검사합니다.
```powershell
...
### 예제 2: "MoveResource Name"을 입력으로 사용하여 이동 컬렉션에서 리소스 집합을 커밋합니다.
```powershell
...
"MoveResource Name"을 입력으로 사용하여 이동 컬렉션의 리소스 집합을 커밋합니다.

### 예제 3: 입력으로 "SourceARMID"를 사용하여 이동 컬렉션에서 리소스 집합을 커밋합니다.
```powershell
...
"SourceARMID"를 입력으로 사용하여 이동 컬렉션의 리소스 집합을 커밋합니다.
