...
### 예제 1: 구독의 모든 이동 컬렉션에 대한 세부 정보 확인
```powershell
...
### 예제 2: 구독에서 지정된 이동 컬렉션 이름으로 이동 컬렉션에 대한 세부 정보 확인
```powershell
...
구독에서 지정된 이동 컬렉션 이름으로 이동 컬렉션에 대한 세부 정보를 얻습니다.

### 예제 3: 구독에서 지정된 리소스 그룹 이름으로 이동 컬렉션에 대한 세부 정보 확인
```powershell
