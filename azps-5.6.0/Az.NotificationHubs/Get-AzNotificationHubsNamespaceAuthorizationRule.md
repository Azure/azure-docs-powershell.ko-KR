...
또는 *AuthorizationRule* 매개 변수를 포함하여 특정 규칙에 대한 정보를 반환할 수 있습니다.
...
네임스페이스 자체에 대한 정보를 얻은 경우 Get-AzNotificationHubsNamespace를 사용하세요.

## 예제

### 예제 1: 네임스페이스에 할당된 모든 권한 부여 규칙에 대한 정보 얻습니다.
```
