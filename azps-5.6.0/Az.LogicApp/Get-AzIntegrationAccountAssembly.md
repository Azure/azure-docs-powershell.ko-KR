...
"sampleResourceGroup"에 포함된 통합 계정 "sampleIntegrationAccount"에 있는 "sampleAssembly"라는 어셈블리를 얻습니다.

### 예제 2: 매개 변수에 따라 통합 계정의 모든 어셈블리 나열
```powershell
...
"sampleResourceGroup"에 포함된 통합 계정 "sampleIntegrationAccount"에 있는 모든 어셈블리를 얻습니다.
