...
## 설명
**New-AzIntegrationAccountPartner** cmdlet은 통합 계정 파트너를 만듭니다.
이 cmdlet은 통합 계정 파트너를 나타내는 개체를 반환합니다.
통합 계정 이름, 리소스 그룹 이름, 파트너 이름 및 파트너 ID를 지정합니다.
...
이 명령은 지정된 리소스 그룹에 IntegrationAccountPartner22라는 통합 계정 파트너를 만듭니다.
