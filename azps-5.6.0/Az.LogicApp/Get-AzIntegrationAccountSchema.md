...
## 설명
**Get-AzIntegrationAccountSchema** cmdlet은 통합 계정 스케마를 얻습니다.
통합 계정 이름, 리소스 그룹 이름 및척도 이름을 지정합니다.
...
이 명령은 IntegrationAccountSchema43이라는 통합 계정스마를 얻습니다.

### 예제 2: 리소스 그룹에 대한 통합 계정 스케마를 얻게 됩니다.
```
...
이 명령은 ResourceGroup11이라는 리소스 그룹에 대한 통합 계정 스케마를 얻습니다.
