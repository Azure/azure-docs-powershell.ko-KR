...
## 설명
**Get-AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정에 새 일괄 처리 구성을 만듭니다.

## 예제

### 예제 1: 로컬 파일을 사용하여 새 일괄 처리 구성 만들기
```powershell
...
"$batchConfigurationFilePath"에 포함된 파일 경로에 있는 로컬 파일을 사용하여 새 일괄 처리 $batchConfigurationFilePath.

### 예제 2: JSON 문자열을 사용하여 새 일괄 처리 구성 만들기
```powershell
...
"$batchConfigurationContent" 포함된 JSON 문자열을 사용하여 새 일괄 처리 $batchConfigurationContent.

### 예제 3: 매개 변수를 사용하여 새 일괄 처리 구성 만들기
```powershell
...
필요한 모든 매개 변수를 수동으로 제공하여 새 일괄 처리 구성을 만듭니다.
