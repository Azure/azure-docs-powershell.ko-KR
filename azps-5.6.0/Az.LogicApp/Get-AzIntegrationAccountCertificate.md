...
## 설명
**Get-AzIntegrationAccountCertificate** cmdlet은 리소스 그룹에서 통합 계정 인증서를 얻습니다.
...
이 명령은 IntegrationAccountCertificate01이라는 통합 계정 인증서를 얻습니다.

### 예제 2: 통합 계정 이름으로 통합 계정 인증서를 얻습니다.
```
...
이 명령은 IntegrationAccount31이라는 통합 계정에 대한 통합 계정 인증서를 얻습니다.
