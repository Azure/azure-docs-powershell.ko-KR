...
## 설명
**Set-AzIntegrationAccountPartner** cmdlet은 통합 계정 파트너를 수정합니다.
이 cmdlet은 통합 계정 파트너를 나타내는 개체를 반환합니다.
통합 계정 이름, 리소스 그룹 이름 및 파트너 이름을 지정합니다.
...
이 명령은 지정된 리소스 그룹에서 IntegrationAccountPartner22라는 통합 계정 파트너를 수정합니다.

### 예제 2

통합 계정 파트너를 수정합니다. (자동 재생)
