...
## 설명
**Set-AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정 일괄 처리 구성을 수정합니다.

## 예제

### 예제 1: 로컬 파일을 사용하여 일괄 처리 구성 수정
```powershell
...
"$batchConfigurationFilePath"에 포함된 파일 경로에 있는 로컬 파일을 사용하여 "sampleBatchConfig"라는 일괄 처리 구성을 $batchConfigurationFilePath.

### 예제 2: JSON 문자열을 사용하여 일괄 처리 구성 수정
```powershell
...
"$batchConfigurationContent"에 포함된 JSON 문자열을 사용하여 "sampleBatchConfig"라는 일괄 처리 구성을 $batchConfigurationContent.

### 예제 3: 매개 변수를 사용하여 일괄 처리 구성 수정
```powershell
...
필요한 모든 매개 변수를 수동으로 제공하여 "sampleBatchConfig"라는 일괄 처리 구성을 수정합니다.
