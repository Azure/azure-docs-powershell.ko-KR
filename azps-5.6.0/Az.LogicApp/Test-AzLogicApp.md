...
이 명령은 지정된 리소스 그룹의 LogicApp01이라는 논리 앱의 유효성을 검사합니다.
명령은 정의 및 매개 변수 파일 경로를 지정합니다.
...
이 명령은 지정된 리소스 그룹의 LogicApp01이라는 논리 앱의 유효성을 검사합니다.
명령은 정의 및 매개 변수 개체를 지정합니다.

### 예제 3

논리 앱 정의의 유효성을 검사합니다. (자동 재생)
...
### -DefinitionFilePath
논리 앱의 정의를 JSON 형식으로 정의 파일의 경로로 지정합니다.
