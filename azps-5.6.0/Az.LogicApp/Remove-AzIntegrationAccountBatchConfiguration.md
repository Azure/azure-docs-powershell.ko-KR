...
## 설명
**Remove-AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정에서 일괄 처리 구성을 제거합니다.

## 예제

### 예제 1: 매개 변수에 따라 일괄 처리 구성 제거
```powershell
...
통합 계정 "sampleIntegrationAccount"에 있는 "sampleBatchConfig"라는 일괄 처리 구성을 제거합니다.
