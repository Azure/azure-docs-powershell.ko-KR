...
**Get-AzLogicAppRunAction** cmdlet은 논리 앱 실행에서 작업을 제공합니다.
...
이 명령은 ID 08559251844236971838804972CU26을 사용하여 실행에 대한 LogicApp05라는 논리 앱에서 특정 논리 앱 작업을 얻습니다.

### 예제 2: Logic App 실행에서 모든 작업 다운로드
...
이 명령은 LogicApp05라는 논리 앱의 식별자 0855925184423369718380498702CU26을 사용하여 실행에서 모든 논리 앱 작업을 제공합니다.

## 매개 변수

### -ActionName

논리 앱 실행에서 작업 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 작업을 제공합니다.
...
이 cmdlet에서 작업을 수행하게 하는 논리 앱의 이름을 지정합니다.
...
이 cmdlet에서 작업을 수행하게 하는 리소스 그룹의 이름을 지정합니다.
...
논리 앱의 실행 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 실행에 대한 작업을 제공합니다.
