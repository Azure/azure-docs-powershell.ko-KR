...
## 설명
**New-AzIntegrationAccountSchema** cmdlet은 통합 계정도 만듭니다.
이 cmdlet은 통합 계정 구성을 나타내는 개체를 반환합니다.
통합 계정 이름, 리소스 그룹 이름, schema 이름 및척도 정의를 지정합니다.
...
이 명령은 지정된 리소스 그룹에 IntegrationAccountSchema1이라는 통합 계정 스마를 만듭니다.
