...
## 설명
Import-AzContext cmdlet은 파일의 인증 정보를 로드하여 Azure 환경 및 컨텍스트를 설정합니다.
현재 세션에서 실행 중인 Cmdlet은 이 정보를 사용하여 Azure Resource Manager에 대한 요청을 인증합니다.
...
이 예제에서는 cmdlet에 전달된 PSAzureProfile에서 컨텍스트를 가져온다.
