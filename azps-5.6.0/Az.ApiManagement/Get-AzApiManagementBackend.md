...
Api Management 서비스에 구성된 모든 Backends 목록을 을 선택합니다.

### 예제 2: 식별자 123에서 지정한 백end을 얻게 됩니다.
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementBackend -Context $apimContext -backendId 123
```

식별자 '123'에서 식별된 지정된 백end의 세부 정보 얻습니다.

## 매개 변수

### -BackendId
백end의 식별자입니다.
지정한 경우 식별자에 의해 백END를 찾으려고 합니다.
이 매개 변수는 선택 사항입니다.
...
### -ResourceId
백END의 Arm 리소스 식별자입니다. 지정한 경우 식별자에 의해 백END를 찾으려고 합니다. 이 매개 변수는 필수입니다.
