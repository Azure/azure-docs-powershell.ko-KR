...
### -Type
그룹 형식입니다. 사용자 지정 그룹은 사용자 정의 그룹입니다. 시스템 그룹에는 관리자, 개발자 및 게스트가 포함됩니다. 시스템 그룹을 만들거나 업데이트할 수 없습니다.  외부 그룹은 Azure Active Directory와 같은 외부 ID 공급자의 그룹입니다. 이 매개 변수는 선택 사항이며 기본적으로 사용자 지정 그룹으로 가정합니다.
