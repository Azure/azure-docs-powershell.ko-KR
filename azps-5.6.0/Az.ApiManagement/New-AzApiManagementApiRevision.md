...
### 예제 2: 기존 Api에서 API 수정을 만들고 모든 작업, 태그 및 정책을 복사합니다.
```powershell
...
### -ServiceUrl
백end 서비스에 API를 노출하는 웹 서비스의 URL입니다. 이 URL은 Azure API Management에서만 사용하며 공개되지 않습니다. 1~2000자 이상이 되어야 합니다. 이 매개 변수는 필수입니다.
