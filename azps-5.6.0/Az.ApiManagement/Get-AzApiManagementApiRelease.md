...
## 설명
**Get-AzApiManagementApiRelease** cmdlet은 Azure API Management API의 하나 이상의 릴리스를 제공합니다.
...
이 명령은 지정된 컨텍스트에 대한 API의 모든 `echo-api` 릴리스를 얻습니다.
...
### -ResourceId
Api 릴리스의 Arm 리소스 식별자입니다. 지정한 경우 식별자에 의해 API 릴리스를 찾으려고 합니다. 이 매개 변수는 필수입니다.
