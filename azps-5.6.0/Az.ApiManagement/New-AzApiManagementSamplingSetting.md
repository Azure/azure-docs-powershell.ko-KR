...
## 설명
cmdlet **New-AzApiManagementSamplingSetting은** 진단에 대한 새 샘플링 설정을 만듭니다.
...
요청/응답의 100%에 대한 로깅을 사용하여 형식 샘플링 `Fixed` 설정을 만듭니다.

### 예제 2

진단에 대한 새 샘플링 설정을 생성합니다. (자동 재생)
...
### -SamplingPercentage
고정 속도 샘플링에 대한 샘플링 속도입니다. 이 매개 변수는 선택 사항입니다.
