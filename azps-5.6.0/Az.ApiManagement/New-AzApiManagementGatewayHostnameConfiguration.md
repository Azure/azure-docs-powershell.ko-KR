...
## 설명
**New-AzApiManagementGatewayHostnameConfiguration** cmdlet은 기존 게이트웨이에 대한 호스트 이름 구성atin을 만듭니다.
...
이 명령은 "g01" 게이트웨이에 대해 "h01" 호스트 이름 구성을 만듭니다.
...
NegotiateClientCertificate를 적용하기 위해 플래그를 지정합니다.
이 매개 변수는 선택 사항입니다.
