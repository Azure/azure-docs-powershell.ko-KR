...
## 설명
**Set-AzApiManagementApiSchema** cmdlet은 Azure API Management API Schema를 수정합니다.
...
### -ResourceId
Arm ResourceId of Diagnostic 또는 Api Schema. 이 매개 변수는 필수입니다.
...
### -SchemaDocument
Api schema 문서는 문자열로 작성됩니다. 이 매개 변수는 -SchemaDocumentFile이 지정되지 않습니다.
...
Api schema 문서 파일 경로입니다. 이 매개 변수는 -SchemaDocument가 지정되지 않습니다.
