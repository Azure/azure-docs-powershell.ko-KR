...
이 예제에서는 요청 및 응답 세부 정보를 사용하는 API 관리 작업을 만듭니다.
...
### -TemplateParameters
매개 변수 *UrlTemplate에* 정의된 매개 변수 배열을 지정합니다.
이 매개 변수를 지정하지 않으면 UrlTemplate 를 기반으로 *기본값이 생성됩니다.*
