...
## 설명
cmdlet **Remove-AzApiManagementDiagnostic는** 전역 범위 또는 범위에서 지정된 진단 엔터티를 `DiagnosticId` `ApiId` 제거합니다.
...
이 예제에서는 `applicationinsights` Api Management 서비스에서 진단을 제거합니다.
...
### -ResourceId
Arm ResourceId of Diagnostic. 이 매개 변수는 필수입니다.
