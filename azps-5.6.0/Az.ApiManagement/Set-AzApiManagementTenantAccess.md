...
## 설명
**Set-AzApiManagementTenantAccess** cmdlet은 테넌트 액세스를 사용 또는 사용하지 않도록 설정합니다.
...
이 명령을 사용하면 지정된 컨텍스트에서 테넌트 액세스가 허용됩니다.
...
### -사용하도록 설정
이 cmdlet이 테넌트 액세스를 허용하거나 사용하지 않도록 설정하는지 여부를 지정합니다.
...
### -PassThru
이 cmdlet은 이 cmdlet이 수정하는 **PsApiManagementAccesssInformation을** 반환합니다.
