...
## 설명
**Get-AzApiManagementApiVersionSet** cmdlet은 API Management 컨텍스트에 구성된 API 버전 집합의 세부 정보를 제공합니다.

## 예제

### 예제 1

### 예제 2: 모든 API 버전 집합 다운로드
```powershell
...
이 명령은 지정된 ID를 사용하여 API 버전 집합을 얻습니다.
...
### -ResourceId
ApiVersionSet의 Arm 리소스 식별자입니다. 지정한 경우 식별자에 의해 apiVersionSet을 찾으려고 합니다. 이 매개 변수는 필수입니다.
