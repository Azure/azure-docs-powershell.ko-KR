...
이 명령은 `echo-api-release` Api의 API 릴리스를 새 `echo-api` 메모로 업데이트합니다.
...
### -PassThru
지정한 경우 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiRelease 형식의 인스턴스가 설정된 API 릴리스를 나타내는 인스턴스입니다.
...
### -ReleaseId
Api Revision ReleaseId의 식별자입니다.
이 매개 변수는 필수입니다.
