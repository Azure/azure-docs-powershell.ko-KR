...
## 설명
**Get-AzApiManagementSubscription** cmdlet은 구독이 지정되지 않은 경우 지정된 구독 또는 모든 구독을 얻습니다.
키는 결과 세부 정보에 포함되지 않습니다. 키를 얻기 위해 **Get-AzApiManagementSubscriptionKey를 사용 합니다.**
...
### -ProductId
제품 식별자를 지정합니다.
지정된 경우 이 cmdlet은 제품 식별자에 의해 모든 구독을 찾습니다.
...
### -Scope
범위 식별자입니다. 구독 범위는 Api Scope /apis/{apiId} 또는 제품 범위 /products/{productId} 또는 글로벌 API 범위 /apis 또는 전역 범위 /인지 여부입니다.
...
### -UserId
사용자 식별자를 지정합니다.
지정한 경우 이 cmdlet은 사용자 식별자에 의해 모든 구독을 찾습니다.
