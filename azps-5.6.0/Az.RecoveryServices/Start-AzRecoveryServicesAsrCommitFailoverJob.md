...
## 설명
**Start-AzRecoveryServicesAsrCommitFailoverJob** cmdlet은 장애 조치(failover) 작업 후 Azure Site Recovery 개체에 대한 커밋 장애 조치 프로세스를 시작합니다.
...
Site Recovery 개체에 대한 커밋 장애 조치(failover) 작업을 시작합니다. (자동 재생)
