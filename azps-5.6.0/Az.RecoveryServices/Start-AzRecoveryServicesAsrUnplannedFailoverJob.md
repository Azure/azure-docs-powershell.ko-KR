...
## 설명
**Start-AzRecoveryServicesAsrUnplannedFailoverJob** cmdlet은 Azure Site Recovery 복제로 보호된 항목 또는 복구 계획의 계획되지 않은 장애 조치(failover)를 시작합니다.
...
### -RecoveryPoint
보호된 컴퓨터의 장애 조치(failover)를 위한 사용자 지정 복구 지점을 지정합니다.
