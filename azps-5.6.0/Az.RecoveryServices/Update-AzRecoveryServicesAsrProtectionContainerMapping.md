...
컨테이너에 대한 자동 업데이트를 사용하지 않도록 설정하는 작업을 시작합니다.
...
컨테이너에 대해 자동 업데이트를 사용하도록 설정하지 않도록 설정하려면 작업을 시작하세요.
...
### -DisableAutoUpdate
매개 변수를 전환하여 자동 업데이트를 사용하지 않도록 설정합니다.
