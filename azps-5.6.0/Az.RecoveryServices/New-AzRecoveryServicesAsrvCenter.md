...
## 설명
**New-AzRecoveryServicesAsrvCenter** cmdlet은 보호 가능한 항목을 검색하기 위해 vCenter 서버를 추가합니다. 이 cmdlet은 구성 서버와 검색을 위해 vCenter 서버를 등록합니다.
...
vCenter 서버를 추가하여 보호 가능한 항목을 검색합니다. (자동 재생)
...
### -IpOrHostName
vCenter 서버의 IPv4 주소 또는 FQDN입니다.
