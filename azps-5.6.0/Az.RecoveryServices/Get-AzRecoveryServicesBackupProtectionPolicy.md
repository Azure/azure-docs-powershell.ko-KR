...
## 설명
**Get-AzRecoveryServicesBackupProtectionPolicy** cmdlet은 자격 증명 모음에 대한 Azure Backup 보호 정책을 제공합니다.
현재 cmdlet을 사용하기 전에 Set-AzRecoveryServicesVaultContext cmdlet을 사용하여 자격 증명 모음 컨텍스트를 설정합니다.

## 예제

### 예제 1: 자격 증명 모음의 모든 정책 사용
```
...
이 명령은 DefaultPolicy라는 보호 정책을 얻은 다음, 해당 $Pol 저장합니다.

## 매개 변수

### -BackupManagementType
보호되는 리소스의 클래스입니다. 현재 이 cmdlet에 대해 지원되는 값은 AzureVM, AzureStorage, AzureWorkload입니다.
