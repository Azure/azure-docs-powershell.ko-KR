...
---
# Az.RecoveryServices 모듈
## 설명
이 항목에서는 Azure Recovery Services cmdlet에 대한 도움말 항목을 제공합니다.
...
이미 보호된 Azure 가상 머신에 대한 보호를 위해 디스크를 추가합니다.
...
보호 가능한 항목에 대한 자동 백업을 사용하지 않도록 설정합니다.
...
지정된 Backup 보호 정책을 사용하여 항목에 대한 백업을 사용할 수 있습니다.

### [Get-AzRecoveryServicesAsrAlertSetting](Get-AzRecoveryServicesAsrAlertSetting.md)
자격 증명 모음에 대해 구성된 Azure Site Recovery 알림 설정을 얻습니다.

### [Get-AzRecoveryServicesAsrEvent](Get-AzRecoveryServicesAsrEvent.md)
자격 증명 모음에서 Azure Site Recovery 이벤트에 대한 세부 정보를 얻습니다.
...
현재 자격 증명 모음에 대한 Site Recovery에서 관리되는 네트워크에 대한 정보를 얻습니다.

### [Get-AzRecoveryServicesAsrNetworkMapping](Get-AzRecoveryServicesAsrNetworkMapping.md)
현재 자격 증명 모음에 대한 Site Recovery 네트워크 매핑에 대한 정보를 얻습니다.
...
Recovery Services 자격 증명 모음에서 ASR 보호 컨테이너를 얻습니다.

### [Get-AzRecoveryServicesAsrProtectionContainerMapping](Get-AzRecoveryServicesAsrProtectionContainerMapping.md)
Azure Site Recovery Protection Container 매핑을 얻습니다.

### [Get-AzRecoveryServicesAsrRecoveryPlan](Get-AzRecoveryServicesAsrRecoveryPlan.md)
Recovery Services 자격 증명 모음에서 복구 계획 또는 모든 복구 계획을 얻습니다.
...
ASR 패브릭에서 지정한 구성 서버에서 검색에 등록된 vCenter 서버의 세부 정보를 얻습니다.
...
이 명령은 특정 컨테이너 내에서 또는 등록된 모든 컨테이너에서 보호 가능한 모든 항목을 검색합니다. 애플리케이션의 계층 구조의 모든 요소로 구성됩니다. 인스턴스, 가용성Group 등의 DB 및 해당 상위 계층 엔터티를 반환합니다.

### [Get-AzRecoveryServicesBackupProtectionPolicy](Get-AzRecoveryServicesBackupProtectionPolicy.md)
자격 증명 모음에 대한 백업 보호 정책을 얻습니다.
...
이 명령은 백업된 항목(예: db)의 복구 SQL 구성합니다. 구성 개체는 복구 모드, 복원 대상 대상 및 애플리케이션 특정 매개 변수(예: 대상 물리적 경로)과 같은 모든 세부 정보를 SQL.

### [Get-AzRecoveryServicesVault](Get-AzRecoveryServicesVault.md)
Recovery Services 자격 증명 모음 목록을 얻습니다.

### [Get-AzRecoveryServicesVaultProperty](Get-AzRecoveryServicesVaultProperty.md)
Recovery Services Vault의 속성을 반환합니다.
...
지정된 패브릭 내에서 Azure Site Recovery Protection Container를 만듭니다.

### [New-AzRecoveryServicesAsrProtectionContainerMapping](New-AzRecoveryServicesAsrProtectionContainerMapping.md)
지정된 복제 정책을 지정된 ASR 보호 컨테이너에 연결하여 Azure Site Recovery Protection Container 매핑을 만듭니다.
...
Recovery Services 자격 증명 모음에서 지정된 ASR 복구 계획을 삭제합니다.

### [Remove-AzRecoveryServicesAsrReplicationProtectedItem](Remove-AzRecoveryServicesAsrReplicationProtectedItem.md)
Azure Site Recovery 복제로 보호된 항목에 대한 복제를 중지/비활성화합니다.
...
ASR 패브릭에서 vCenter 서버를 제거하고 vCenter 서버에서 가상 머신의 검색을 중지합니다.

### [Remove-AzRecoveryServicesBackupProtectionPolicy](Remove-AzRecoveryServicesBackupProtectionPolicy.md)
자격 증명 모음에서 백업 보호 정책을 삭제합니다.

### [Remove-AzRecoveryServicesVault](Remove-AzRecoveryServicesVault.md)
Recovery Services 자격 증명 모음을 삭제합니다.

### [Restart-AzRecoveryServicesAsrJob](Restart-AzRecoveryServicesAsrJob.md)
Azure Site Recovery 작업을 다시 시작합니다.

### [Restore-AzRecoveryServicesBackupItem](Restore-AzRecoveryServicesBackupItem.md)
백업 항목에 대한 데이터 및 구성을 복구 지점으로 복원합니다.
...
자격 증명 모음에 대한 Azure Site Recovery 알림 설정(전자 메일 알림)을 구성합니다.
...
장애 조치(failover) 작업을 커밋하기 전에 장애 조치(failover) 보호된 항목에 대한 복구 지점을 변경합니다.
...
등록된 vCenter에 대한 검색 세부 정보를 업데이트합니다.
