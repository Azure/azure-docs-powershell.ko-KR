...
두 번째 cmdlet은 백업할 디스크 LUNS를 지정하고 백업 변수에 $inclusionDiskLUNS 있습니다.
세 번째 cmdlet은 ARM V2VM이라는 가상 머신에 대한 백업 보호 정책을 $Pol.

### 예제 2

지정된 Backup 보호 정책을 사용하여 항목에 대한 백업을 사용할 수 있습니다. (자동 재생)
...
### -InclusionDisksList
백업에 포함될 디스크 LUEN 목록과 나머지는 OS 디스크를 제외한 자동으로 제외됩니다.
...
### -항목
이 cmdlet에서 보호를 사용할 수 있는 Backup 항목을 지정합니다.
