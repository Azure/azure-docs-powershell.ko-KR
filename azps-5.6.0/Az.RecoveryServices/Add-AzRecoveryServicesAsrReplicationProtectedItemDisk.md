...
보호를 위해 지정된 디스크 구성을 추가하려면 작업을 시작합니다.
...
보호를 위해 지정된 디스크 구성을 추가하려면 작업을 시작합니다. Piping 입력 복제 보호된 항목입니다.

## 매개 변수

### -AzureToAzureDiskReplicationConfiguration
Azure에서 Azure 재해 복구 시나리오에 대한 디스크 보호에 사용할 디스크 구성을 지정합니다.
...
### -InputObject
cmdlet에 대한 입력 개체: 새 디스크를 보호해야 하는 ASR 복제 보호 항목 개체입니다.
