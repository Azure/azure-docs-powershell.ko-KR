...
## 설명
**Start-AzRecoveryServicesAsrResynchronizeReplicationJob** cmdlet은 보호된 항목이 재동기화 필수 상태인 경우 지정된 보호된 항목에 대한 복제 재동기화를 시작합니다.
...
전달된 복제 보호 항목에 대한 복제를 다시 동시화하는 작업을 시작합니다.
...
복제를 다시동기하기 위해 ASR 복제로 보호된 항목입니다.
