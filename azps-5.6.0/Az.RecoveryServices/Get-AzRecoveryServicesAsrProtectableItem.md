...
## 설명
**Get-AzRecoveryServicesAsrProtectableItem** cmdlet은 Azure Site Recovery Protection Container에서 보호 가능한 항목을 얻습니다.
...
지정된 ASR 보호 컨테이너의 모든 보호 가능한 항목을 얻습니다.
...
### -ProtectionContainer
Azure Site Recovery Protection Container 개체를 지정합니다.
