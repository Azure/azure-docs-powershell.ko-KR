...
## 설명
**Start-AzRecoveryServicesAsrApplyRecoveryPoint는** 장애 조치(failover) 작업을 커밋하기 전에 보호되지 못한 보호된 항목에 대한 복구 지점을 변경합니다.
...
데이터 암호화가 사용되는 경우 보조 인증서 파일을 지정합니다.
