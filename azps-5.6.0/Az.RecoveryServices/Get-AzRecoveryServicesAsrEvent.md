...
## 설명
**Get-AzRecoveryServicesAsrEvent는** 지정된 선택 필터에 따라 자격 증명 모음의 이벤트 목록을 제공합니다.
...
시간 시작 시간과 종료 시간 사이의 이벤트 목록, 심각도 중요도 및 상태 유형 VmHealth입니다.

## 매개 변수

### -AffectedObjectFriendlyName
검색에 대해 영향을 받는Object FriendlyName을 지정합니다.
...
### -EndTime
검색 창의 종료 시간을 지정합니다. 이 매개 변수를 사용하여 지정된 시간 전에 발생한 이벤트만 얻습니다.
...
### -ResourceId
event ResourceId of event를 지정합니다.
...
### -StartTime
검색 창의 시작 시간을 지정합니다. 이 매개 변수를 사용하여 지정된 시간 후에 발생한 이벤트만 얻습니다.
