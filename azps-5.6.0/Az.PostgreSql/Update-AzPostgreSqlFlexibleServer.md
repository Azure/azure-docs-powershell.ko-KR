...
서버 Update-AzPostSqlFlexibleServerConfiguration 서버 매개 변수를 업데이트하려는 경우 대신 wait_timeout net_retry_count.
...
이 cmdlet은 ID로 PostgreSql 서버를 업데이트합니다.
...
### -Sku
sku의 이름(예: Burstable_B1ms Standard_D2ds_v4
