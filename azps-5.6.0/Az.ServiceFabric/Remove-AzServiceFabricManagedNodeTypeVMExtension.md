...
## 설명
노드 형식에서 이름별로 vm 확장을 제거합니다. [Get-AzServiceFabricManagedNodeType을](./Get-AzServiceFabricManagedNodeType.md) 사용하여 VmExtensions 속성을 살펴보고 노드 형식의 현재 확장을 볼 수 있습니다.
...
배관을 사용하여 이름별로 노드 형식에서 확장을 제거합니다.
