...
## 설명은
**새 AzureRmDeployment** cmdlet은 현재 구독 범위에 배포를 추가 합니다.
...
리소스 그룹에 리소스를 추가 하려면 리소스 그룹에 배포를 만드는 **New AzureRmDeployment** 를 사용 합니다.
**AzureRmDeployment** cmdlet은 구독 수준 리소스를 배포 하는 현재 구독 범위에서 배포를 만듭니다. 
