...
## 설명은
**AzureRmLoadBalancerProbeConfig** cmdlet은 부하 분산 장치에 대 한 하나 이상의 프로브 구성을 가져옵니다.

## 예제의

### 예제 1: 부하 분산 장치에 대 한 프로브 구성 가져오기
```
...
두 번째 명령은 $slb의 부하 분산 장치에서 MyProbe 라는 연결 된 프로브 구성을 가져옵니다.
...
### -LoadBalancer
가져올 프로브 구성과 연결 된 부하 분산 장치를 지정 합니다.
