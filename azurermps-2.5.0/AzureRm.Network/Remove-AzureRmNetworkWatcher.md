...
## 설명은
Remove-AzureRmNetworkWatcher cmdlet은 네트워크 감시자 리소스를 제거 합니다.

## 예제의

### --------------------------예제 1: 네트워크 감시자--------------------------만들기 및 삭제
```
...
이 예제에서는 리소스 그룹에 네트워크 감시자를 만든 다음 즉시 삭제 합니다. 구독 당 지역 당 하나의 네트워크 감시자만 만들 수 있습니다.
가상 네트워크를 삭제할 때 메시지가 표시 되지 않도록 하려면-Force 플래그를 사용 합니다.
