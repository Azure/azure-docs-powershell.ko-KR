...
## 설명은
**Get-AzureRmApplicationGatewayHttpListener** cmdlet은 응용 프로그램 게이트웨이의 HTTP 수신기를 가져옵니다.
...
이 명령은 Listener01 이라는 HTTP 수신기를 가져옵니다.
...
### -ApplicationGateway
HTTP 수신기를 포함 하는 응용 프로그램 게이트웨이 개체를 지정 합니다.
...
### -이름
이 cmdlet이 가져오는 HTTP 수신기의 이름을 지정 합니다.
