...
## 설명은
Start-AzureRmNetworkWatcherResourceTroubleshooting cmdlet은 Azure에서 네트워킹 리소스에 대 한 문제 해결을 시작 하 고 잠재적인 문제 및 완화에 대 한 정보를 반환 합니다. 현재 가상 네트워크 게이트웨이 및 연결이 지원 됩니다.
