...
## 설명은
**추가-AzureRmVMSecret** cmdlet은 가상 컴퓨터에 비밀을 추가 합니다.
...
세 번째 명령은 **AzureRmVMOperatingSystem** cmdlet을 사용 하 여 $VirtualMachine에 저장 된 가상 컴퓨터를 구성 합니다.
...
**추가-AzureRmVMSecret** 를 반복적으로 실행 하 여 다른 인증서에 대 한 비밀을 추가할 수 있습니다.
...
{"data": " \<Base64-encoded-file\> ", "dataType": " \<file-format\> ", "암호": " \<pfx-file-password\> "}
