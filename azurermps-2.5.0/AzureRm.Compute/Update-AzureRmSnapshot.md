...
## 설명은
**업데이트 AzureRmSnapshot** cmdlet은 스냅숏을 업데이트 합니다.
...
또한이 명령은 리소스 그룹 ' ResourceGroup01 '에서 10gb 디스크 크기로 이름이 ' Snapshot01 ' 인 기존 스냅샷을 업데이트 합니다.
...
### System. 문자열
PSSnapshotUpdate. a. a. m a. 모델. m a m a.
