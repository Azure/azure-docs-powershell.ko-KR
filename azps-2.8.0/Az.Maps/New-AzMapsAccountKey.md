...
## 설명은
New-AzMapsAccountKey cmdlet은 Azure Maps 계정에 대 한 API 키를 생성 합니다.
...
리소스 그룹 MyResourceGroup의 계정 내 계정에 대 한 기본 API 키를 다시 생성 합니다.
...
지정 된 Azure Maps 계정에 대 한 보조 API 키를 다시 생성 합니다.
