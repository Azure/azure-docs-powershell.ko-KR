...
## 설명은
Remove-AzMapsAccount cmdlet은 지정 된 Azure Maps 계정을 삭제 합니다.
...
리소스 그룹 MyResourceGroup에서 계정 내 계정를 삭제 합니다.
...
### -PassThru
지정 된 계정이 성공적으로 삭제 되었는지 여부를 반환 합니다.
