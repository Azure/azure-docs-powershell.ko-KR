...
## 설명은
**AzDataShareTrigger** cmdlet은 azure data 공유 계정 아래에서 지정 된 되풀이 간격과 동기화 시간에 대 한 공유 구독에 대 한 트리거를 만듭니다.
...
이 명령은 일일 되풀이 간격 9 am을 사용 하 여 공유 구독 AdsShareSubscription에 대 한 새 트리거 AdsTrigger를 만듭니다.
