...
## 설명은
AzDataShareSynchronizationSetting cmdlet은 datashare 동기화 설정을 제거 **함**
...
이 명령은 AdsShareSynchronizationSetting에서 공유 하는 동기화 설정 (AdsShare)을 제거 합니다. 
