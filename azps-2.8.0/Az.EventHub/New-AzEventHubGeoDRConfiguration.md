...
## 설명은
**AzEventHubGeoDRConfiguration** cmdlet은 새 별칭을 만듭니다 (재해 복구 구성).
...
보조 네임 스페이스가 "SampleNamespace_Primary" 인 "SampleDRConfigName" 별칭을 만듭니다. "SampleNamespace_Secondary"

## 변수

### -AlternateName
DR 구성 이름이 기본 네임 스페이스와 같은 경우 AlternateName 필요 함
