...
## 설명은
**새 AzServiceBusNamespace** cmdlet은 새 Service Bus 네임 스페이스를 만듭니다. 네임 스페이스 리소스 매니페스트를 만든 후에는 변경할 수 없습니다. 이 작업은 idempotent입니다.
...
### -SkuCapacity
Service Bus premium 네임 스페이스 처리 단위, 허용 값 1 또는 2 또는 4
