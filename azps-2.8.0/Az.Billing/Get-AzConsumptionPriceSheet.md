...
## 설명은
**AzConsumptionPriceSheet** cmdlet은 구독에 대 한 가격 시트를 가져옵니다.
...
### 예제 2: MeterDetails 확대 된 가격 시트 가져오기
```powershell
...
### 예제 3: BillingPeriodName의 가격 시트 가져오기
```powershell
...
### -BillingPeriodName
특정 청구 기간의 이름에 연결 된 가격 시트를 가져오는 데 사용 됩니다.
...
### -ExpandMeterDetail
MeterDetails를 기반으로 가격 시트를 확장 합니다.
...
### PSPriceSheet를 사용 하 여 명령을 사용 합니다.
