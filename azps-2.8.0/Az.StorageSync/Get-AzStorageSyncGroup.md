...
## 설명은
이 명령은 지정 된 저장소 동기화 서비스 내의 모든 동기화 그룹을 나열 합니다. 또한 각 동기화 그룹의 특성을 나열 하는 데 사용 될 수 있습니다.
...
이 명령은 지정 된 저장소 동기화 서비스 내에 포함 된 모든 동기화 그룹을 가져옵니다. -Name을 지정 하 여 특정 이름을 반환 합니다.
