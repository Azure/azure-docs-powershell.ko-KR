...
### -Metadata
정책 집합 정의에 대 한 메타 데이터입니다. 메타 데이터를 포함 하는 파일 이름에 대 한 경로 이거나 메타 데이터를 string으로 사용할 수 있습니다.
...
### -PolicyDefinition
정책 정의입니다. 이는 정책 정의를 포함 하는 파일 이름에 대 한 경로 이거나 문자열 형식으로 된 정책 정의 일 수 있습니다.
