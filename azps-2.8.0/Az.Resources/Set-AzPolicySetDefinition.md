...
### -Metadata
업데이트 된 정책 집합 정의의 메타 데이터입니다. 메타 데이터를 포함 하는 파일 이름의 경로 이거나 메타 데이터를 문자열로 지정할 수 있습니다.
...
### -Parameter
업데이트 된 정책 집합 정의의 매개 변수 선언입니다. 매개 변수 선언을 포함 하는 uri 또는 파일 이름에 대 한 경로 이거나 매개 변수 선언이 string 일 수 있습니다.
