...
## 설명은
`Enable-AzSecurityAdvancedThreatProtection`Cmdlet은 저장소/cosmosDB 계정에 대 한 위협 보호 정책을 사용 하도록 설정 합니다.
...
이 명령은 리소스 id에 고급 위협 보호 정책을 사용 하도록 설정 `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` 합니다.
...
```
이 명령은 리소스 id에 고급 위협 보호 정책을 사용 하도록 설정 ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` 합니다.
