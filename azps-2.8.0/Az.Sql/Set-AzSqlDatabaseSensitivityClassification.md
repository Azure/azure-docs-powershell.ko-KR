...
## 설명은
Set-AzSqlDatabaseSensitivityClassification cmdlet은 데이터베이스의 열에 대 한 정보 유형 및 민감도 레이블을 설정 합니다.

## 예제의

### 예제 1: Azure SQL 데이터베이스에서 열의 정보 유형 및 민감도 레이블을 설정 합니다.
```powershell
...
### 예제 2: Azure SQL 데이터베이스에서 열의 권장 정보 유형 및 민감도 레이블을 설정 합니다.
```powershell
...
### 예제 3: 파이프를 사용 하 여 Azure SQL 데이터베이스의 열에 대 한 정보 유형 및 민감도 레이블을 설정 합니다.
```powershell
