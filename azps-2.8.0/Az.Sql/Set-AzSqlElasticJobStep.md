...
## 설명은
Set-AzSqlElasticJobStep cmdlet은 작업 단계를 업데이트 합니다.

## 예제의

### 예제 1-작업 단계의 대상 그룹 업데이트
```
...
### 예제 2-작업 단계의 T-sql 스크립트를 업데이트 합니다.
```
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
### ElasticJobs. AzureSqlElasticJobStepModel에 대 한
