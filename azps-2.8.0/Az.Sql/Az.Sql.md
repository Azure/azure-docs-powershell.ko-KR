...
### [일반-AzSqlDatabaseAdvancedThreatProtectionSettings](Clear-AzSqlDatabaseAdvancedThreatProtectionSettings.md)
...
### [일반-AzSqlServerAdvancedThreatProtectionSettings](Clear-AzSqlServerAdvancedThreatProtectionSettings.md)
...
데이터베이스에 대 한 보안 연결 정책을 가져옵니다. 보안 연결은 더 이상 사용 되지 않으며 이후 릴리스에서이 명령이 제거 됩니다. 연결 문자열을 보려면 Azure portal에서 SQL 데이터베이스 블레이드를 사용 하세요.
...
### [업데이트-AzSqlDatabaseAdvancedThreatProtectionSettings](Update-AzSqlDatabaseAdvancedThreatProtectionSettings.md)
...
### [업데이트-AzSqlServerAdvancedThreatProtectionSettings](Update-AzSqlServerAdvancedThreatProtectionSettings.md)
