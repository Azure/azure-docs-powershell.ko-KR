...
## 설명은
Set-AzSqlElasticJob cmdlet이 작업을 업데이트 합니다.

## 예제의

### 예제 1-작업을 업데이트 하 여 한 시간에 시작 하 고 1 시간 마다 반복
```
...
### -간격 종류
되풀이 일정 간격 형식-분, 시간, 일, 주, 월을 사용할 수 있습니다.
