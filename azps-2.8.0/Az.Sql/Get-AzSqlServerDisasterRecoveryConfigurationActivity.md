...
## 설명은
**AzSqlServerDisasterRecoveryConfigurationActivity** CMDLET은 SQL 데이터베이스 서버 시스템 복구 구성에 대 한 작업을 가져옵니다.
...
### ServerDisasterRecoveryConfiguration. AzureSqlServerDisasterRecoveryConfigurationActivityModel에 대 한
