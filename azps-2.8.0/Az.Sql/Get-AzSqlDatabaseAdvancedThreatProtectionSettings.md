...
## 설명은
**AzSqlDatabaseAdvancedThreatProtectionSettings** Cmdlet은 Azure SQL 데이터베이스의 고급 위협 방지 설정을 가져옵니다.
...
[제거-AzSqlDatabaseAdvancedThreatProtectionSettings](./Remove-AzSqlDatabaseAdvancedThreatProtectionSettings.md)
