...
## 설명은
Undo-AzRecoveryServicesBackupItemDeletion cmdlet rehydrates에 일시 삭제 된 항목이 있습니다.
...
네 번째 명령으로, 소프트 삭제 된 상태의 새 항목입니다.
마지막 명령은 rehydrates에서 소프트 삭제 된 VM을 제거 합니다.
