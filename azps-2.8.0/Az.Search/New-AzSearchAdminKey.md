...
## 설명은
**AzSearchAdminKey** Cmdlet은 Azure Search 서비스의 관리자 키를 다시 생성 합니다.
...
이 예제에서는 Azure Search 서비스의 기본 키를 다시 생성 합니다.
