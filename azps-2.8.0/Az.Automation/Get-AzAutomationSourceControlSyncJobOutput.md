...
## 설명은
**AzAutomationSourceControlSyncJobOutput** Cmdlet은 Azure Automation 소스 제어 동기화 작업에 대 한 출력을 가져옵니다.

## 예제의

### 예제 1
이 명령은 원본 컨트롤 VSTSNative에 대 한 id 08d6d266-27b6-463c-beea-bc48a67ace15를 사용 하 여 소스 제어 동기화 작업의 출력을 가져옵니다. 
...
### SourceControlSyncJobStreamType-. m m.

## 출력

### SourceControlSyncJobStream를 통해 서.

### SourceControlSyncJobStreamRecord를 통해 서.
