...
## 설명은
Get-AzBatchPoolNodeCount cmdlet을 사용 하면 고객이 풀 별로 그룹화 된 노드 상태별로 다시 돌아갈 수 있습니다. 노드 상태는 만들기, 유휴, leavingPool, 오프 라인, 선취, 다시 부팅, reimaging, 실행, 시작, startTaskFailed, unknown, 사용할 수 없음, waitingForStartTask입니다. Cmdlet은 PoolId 또는 Pool 매개 변수를 사용 하 여 풀 id가 지정 된 풀만 필터링 합니다. 
