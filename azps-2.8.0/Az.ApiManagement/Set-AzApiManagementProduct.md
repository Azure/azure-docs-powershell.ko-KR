...
## 설명은
**AzApiManagementProduct** CMDLET은 API 관리 제품 세부 정보를 설정 합니다.
...
이 명령은 API Management 제품 세부 정보를 업데이트 하 고, 구독을 요청 하 고, 게시를 취소 합니다.

## 변수

### -ApprovalRequired
제품 구독에 승인이 필요한 지 여부를 나타냅니다.
기본값은 **$False** 입니다.
...
제품에 구독이 필요한 지 여부를 나타냅니다.
이 매개 변수의 기본값은 **$True** 입니다.
...
### -Title
이 cmdlet이 설정 하는 제품 타이틀을 지정 합니다.
...
### 시스템 Null 허용 ' 1 [[ApiManagement]. ServiceManagement, PsApiManagementProductState, Microsoft azure. PowerShell. ApiManagement, Version = 1.0.0.0, Culture = 중립, PublicKeyToken = null]]
