...
## 설명은
Api Management 서비스의 네트워크 상태를 가져옵니다.
...
ApiManagement 서비스에 종속 되는 여러 리소스의 연결 상태를 가져옵니다.
...
### -ResourceGroupName
API Management가 존재 하는 리소스 그룹의 이름입니다.
...
### ApiManagement. PsApiManagementNetworkStatus/.
