...
## 설명은
**AzApiManagementApiSchema** Cmdlet은 Azure API Management api 스키마를 수정 합니다.
...
### -ResourceId
진단 또는 Api 스키마의 팔 ResourceId입니다. 이 매개 변수는 필수입니다.
...
Api 스키마의 ContentType 이 매개 변수는 선택 사항입니다.
