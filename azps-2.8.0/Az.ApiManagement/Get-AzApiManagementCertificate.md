...
## 설명은
**AzApiManagementCertificate** cmdlet은 지정 하는 모든 Azure API Management 인증서 또는 인증서를 가져옵니다.
...
이 명령은 모든 API Management 인증서를 가져옵니다.

### 예제 2: 해당 ID로 인증서 가져오기
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementCertificate -Context $ApiMgmtContext -CertificateId "0123456789"
```

이 명령은 지정 된 ID를 가진 API Management 인증서를 가져옵니다.
...
### -ResourceId
인증서의 Arm 리소스 식별자입니다. 지정 된 경우 식별자를 사용 하 여 인증서를 찾아 봅니다. 이 매개 변수는 필수입니다.
