...
## 설명은
**AzApiManagementGroup** CMDLET은 API 관리 그룹을 만듭니다.
...
### 시스템 Null 허용 ' 1 [[ApiManagement]. ServiceManagement, PsApiManagementGroupType, Microsoft azure. PowerShell. ApiManagement, Version = 1.0.0.0, Culture = 중립, PublicKeyToken = null]]
