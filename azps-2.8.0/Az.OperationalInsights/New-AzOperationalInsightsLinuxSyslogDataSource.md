...
## 설명은
**AzOperationalInsightsLinuxSyslogDataSource** cmdlet은 작업 영역의 연결 된 Linux 컴퓨터에 syslog 데이터 원본을 추가 합니다.
Azure Operational Insights는 syslog 데이터를 수집할 수 있습니다.
...
### -CollectAlert
Operational Insights가 알림 메시지를 수집 함을 나타냅니다.
...
### -CollectCritical
Operational Insights에 중요 한 메시지가 수집 됨을 나타냅니다.
...
### -CollectDebug
Operational Insights에서 디버그 메시지를 수집 함을 나타냅니다.
...
### -CollectEmergency
Operational Insights 긴급 메시지를 수집 함을 나타냅니다.
...
### -CollectError
Operational Insights에서 오류 메시지를 수집 함을 나타냅니다.
...
### -CollectInformational
Operational Insights가 정보 메시지를 수집 함을 나타냅니다.
...
### -CollectNotice
Operational Insights에서 알림 메시지를 수집 함을 나타냅니다.
...
### -이름
데이터 원본의 이름을 지정 합니다. 이름이 Azure 포털에는 표시 되지 않으며, 모든 문자열이 고유 하기만 하는 경우 사용할 수 있습니다.
