...
## 설명은
**Set-AzPrivateLinkService** cmdlet은 개인 링크 서비스를 업데이트 합니다.

## 예제의

### 1: 개인 링크 서비스를 만들고 업데이트 합니다.
```
...
이 예제에서는 mypls 라는 개인 링크 서비스를 만듭니다. 그런 다음 메모리 내 IpipConfigurations 개체에서 해당를 바꿉니다. 그런 다음 서비스 쪽에서 수정 된 개인 링크 서비스 상태를 쓰는 데 Set-AzPrivateLinkService cmdlet을 사용 합니다. 
...
### -PrivateLinkService
개인 링크 서비스를 설정 해야 하는 상태를 나타내는 개인 링크 서비스 개체를 지정 합니다.
