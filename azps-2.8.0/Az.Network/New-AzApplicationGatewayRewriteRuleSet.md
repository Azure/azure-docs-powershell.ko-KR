...
## 설명은
**AzApplicationGatewayRewriteRuleSet Cmdlet은** Azure application gateway에 대 한 다시 쓰기 규칙 집합을 만듭니다.
...
이 명령은 ruleset1 이라는 재작성 규칙 집합을 만들고 그 결과를 이름이 지정 된 변수 $ruleset에 저장 합니다.
...
### PSApplicationGatewayRewriteRuleSet에 대 한.
