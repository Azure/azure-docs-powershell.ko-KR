...
## 설명
**Get-AzApplicationGatewayConnectionDraining** cmdlet은 백 엔드 HTTP 설정 개체의 연결 드레이팅 구성을 얻습니다.
...
마지막 명령은 백 엔드 HTTP 설정에서 연결 드레인 구성을 $Settings 변수에 $ConnectionDraining 저장합니다.
