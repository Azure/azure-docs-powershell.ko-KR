...
## 설명은
Get-AzDdosProtectionPlan cmdlet은 DDoS protection 계획을 가져옵니다.
...
이 cmdlet은 "test"로 시작 하는 모든 DdosProtectionPlans를 반환 합니다.
