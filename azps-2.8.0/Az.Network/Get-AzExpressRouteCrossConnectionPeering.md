...
## 설명은
**AzExpressRouteCrossConnectionPeering** Cmdlet은 express 경로 간 연결에 대 한 피어 링 관계의 구성을 검색 합니다.

## 예제의

### 예제 1: Express 경로 간 연결에 대 한 피어 링 구성 표시
```
...
피어 링 구성을 포함 하는 Express 경로 간 연결 개체입니다.
