...
Group001 이라는 리소스 그룹에 속하는 VMSS001 이라는 VM 크기 집합에서 VM 인스턴스 1의 디스크 암호화 상태를 표시 합니다.
...
### PSVmssVMDiskEncryptionStatusContext를 계산 합니다.
