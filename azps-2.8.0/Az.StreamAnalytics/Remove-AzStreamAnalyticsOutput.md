...
## 설명은
**AzStreamAnalyticsOutput** Cmdlet은 Azure에서 Stream Analytics 작업의 출력을 비동기적으로 삭제 합니다.
...
이 명령은 작업 StreamingJob에서 출력 출력을 제거 합니다.
...
### -이름
제거할 Azure Stream Analytics 출력의 이름을 지정 합니다.
