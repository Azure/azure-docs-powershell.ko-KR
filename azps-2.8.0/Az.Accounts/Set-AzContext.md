...
## 설명은
Set-AzContext cmdlet은 현재 세션에서 실행 하는 cmdlet에 대 한 인증 정보를 설정 합니다.
...
### -구독
컨텍스트를 설정 해야 하는 구독의 이름 또는 id입니다. 이 매개 변수에는-SubscriptionName 및-SubscriptionId에 대 한 별칭이 있으므로 명확 하 게 하기 위해 각각 이름 및 id를 지정 하는 대신 구독을 사용 하는 것이 좋습니다.
