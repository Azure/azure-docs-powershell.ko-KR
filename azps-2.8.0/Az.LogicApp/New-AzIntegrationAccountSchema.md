...
## 설명은
**새 AzIntegrationAccountSchema** cmdlet은 통합 계정 스키마를 만듭니다.
이 cmdlet은 통합 계정 스키마를 나타내는 개체를 반환 합니다.
통합 계정 이름, 리소스 그룹 이름, 스키마 이름 및 스키마 정의를 지정 합니다.
...
이 명령은 지정 된 리소스 그룹에 IntegrationAccountSchema1 이라는 통합 계정 스키마를 만듭니다.
...
이 매개 변수 또는 *Schemafilepath* 매개 변수 중 하나를 지정 합니다.
...
이 매개 변수 또는 *Schemadefinition* 매개 변수 중 하나를 지정 합니다.
