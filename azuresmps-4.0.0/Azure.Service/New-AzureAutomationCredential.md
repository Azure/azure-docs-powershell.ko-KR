...
**새-AzureAutomationCredential** Cmdlet은 Microsoft Azure Automation에서 자격 증명을 **PSCredential** 개체로 만듭니다.
...
이러한 명령은 MyCredential 이라는 자격 증명을 만듭니다.
사용자 이름 및 암호를 포함 하는 자격 증명 개체가 먼저 만들어집니다.
그런 다음 마지막 명령에서 자동화 자격 증명을 만드는 데 사용 됩니다.

## 변수

### -AutomationAccountName
자격 증명을 저장할 Automation 계정의 이름을 지정 합니다.
