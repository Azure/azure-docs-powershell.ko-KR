...
## SYNOPSIS
Azure 가상 컴퓨터의 운영 체제 디스크를 가져옵니다.
...
## 설명은
**AzureOSDisk** Cmdlet은 Azure 가상 컴퓨터의 운영 체제 디스크를 가져옵니다.
...
현재 cmdlet은 해당 가상 컴퓨터의 운영 체제 디스크를 가져옵니다.
...
### -VM
이 cmdlet이 운영 체제 디스크를 가져오는 가상 컴퓨터를 지정 합니다.
