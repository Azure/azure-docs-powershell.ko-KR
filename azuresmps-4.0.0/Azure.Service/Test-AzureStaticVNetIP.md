...
## SYNOPSIS
정적 가상 네트워크 IP 주소의 가용성을 테스트 하 고, 쿼리 된 주소를 사용할 수 없는 경우 추천 단어 목록을 가져옵니다.
...
## 설명은
**테스트-AzureStaticVNetIP** cmdlet은 정적 가상 네트워크 IP 주소의 가용성을 테스트 하 고 쿼리 된 주소를 사용할 수 없는 경우 제안 목록을 가져옵니다.
