...
## 설명은
**AzureAffinityGroup** cmdlet은 현재 구독에서 Azure 선호도 그룹을 삭제 합니다.
구성원이 있는 선호도 그룹은 삭제할 수 없습니다.
먼저 선호도 그룹의 모든 구성원을 삭제 해야 합니다.
...
이 명령은 현재 구독에서 South01 affinity 그룹을 삭제 합니다.
...
### -이름
이 cmdlet이 삭제 하는 선호도 그룹의 이름을 지정 합니다.
