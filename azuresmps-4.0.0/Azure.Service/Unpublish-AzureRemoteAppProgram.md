...
## SYNOPSIS
Azure RemoteApp 프로그램을 게시 취소 합니다.
...
## 설명은
AzureRemoteAppProgram cmdlet은 Azure RemoteApp 프로그램을 게시 **취소** 합니다.
프로그램의 게시를 취소 한 후에는 Azure RemoteApp 컬렉션의 사용자가 더 이상 사용할 수 없습니다.
...
### -별칭
게시 취소할 프로그램의 별칭 배열을 지정 합니다.
**AzureRemoteAppProgram** 를 사용 하 여 프로그램의 별칭을 검색 하 여 게시 취소 합니다.
