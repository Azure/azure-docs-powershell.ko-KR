...
## SYNOPSIS
하나의 Azure RemoteApp 컬렉션에서 지정 된 Azure 저장소 계정으로 모든 사용자 디스크를 내보냅니다.
...
## 설명은
**AzureRemoteAppUserDisk** cmdlet은 하나의 azure RemoteApp 컬렉션에서 지정 된 azure 저장소 계정으로 모든 사용자 디스크를 내보냅니다.

## 예제의

### 예제 1: 컬렉션의 모든 사용자 디스크를 지정 된 Azure 저장소 계정으로 내보내기
```
...
이 명령은 Contoso 라는 컬렉션의 모든 사용자 디스크를 지정 된 Azure storage 계정에서 이름 AccountName 및 키 AccountKey 인 ContainerName 이라는 컨테이너로 내보냅니다.
...
Cmdlet이 기존 사용자 디스크를 덮어쓴다는 것을 나타냅니다.
