...
## SYNOPSIS
HDInsight 클러스터에 RDP 액세스를 허용 합니다.
...
**AzureHDInsightRdpAccess** Cmdlet은 원격 데스크톱 프로토콜 (RDP)에 Azure HDInsight 클러스터에 대 한 액세스 권한을 부여 합니다.
...
[철회-AzureHdinsightRdpAccess](./Revoke-AzureHdinsightRdpAccess.md)
