...
## SYNOPSIS
작업을 제출 하는 데 사용할 Invoke-AzureHDInsightHiveJob cmdlet에 대해 HDInsight 클러스터를 선택 합니다.
...
**AzureHDInsightCluster** cmdlet은 작업을 제출 하는 데 사용할 **AzureHDInsightHiveJob** Cmdlet에 대 한 Azure HDInsight 클러스터를 선택 합니다.
...
### -이름
**AzureHDInsightHiveJob** cmdlet에 사용 되는 클러스터의 이름을 지정 합니다.
...
### -구독
사용할 HDInsight 클러스터를 포함 하는 구독을 지정 합니다.
