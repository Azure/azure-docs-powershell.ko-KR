...
## SYNOPSIS
Azure 가상 네트워크 게이트웨이의 키를 설정 합니다.
...
## 설명은
**AzureVirtualNetworkGatewayKey** Cmdlet은 Azure 가상 네트워크 게이트웨이의 키를 설정 합니다.
...
[다시 설정-AzureVirtualNetworkGatewayKey](./Reset-AzureVirtualNetworkGatewayKey.md)
