...
**AzureSBNamespace** Cmdlet은 service Bus에 대 한 서비스 네임 스페이스를 제거 합니다.
...
### -Force
이 설정을 사용 하면 확인 메시지를 표시 하지 않고 네임 스페이스를 제거 합니다.
...
[새로운 AzureSBNamespace](./New-AzureSBNamespace.md)
