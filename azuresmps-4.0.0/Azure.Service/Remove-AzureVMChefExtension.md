...
## 설명은
**AzureVMChefExtension** cmdlet은 가상 컴퓨터에 적용 된 요리사 extension을 삭제 합니다.

## 예제의

### 예제 1: 지정 된 가상 컴퓨터에 적용 된 요리사 확장 제거
```
PS C:\> Remove-AzureVMChefExtension -VM $VM;
```

이 명령은 가상 컴퓨터에 적용 된 요리사 확장을 제거 합니다.
