...
## 설명은
**AzureSiteRecoveryVault** cmdlet은 현재 구독에서 Azure site recovery 자격 증명 모음 또는 특정 사이트 복구 자격 증명 모음 목록을 가져옵니다.

## 예제의

### 예제 1: 활성 자격 증명 모음 가져오기
```
...
이 명령은 활성 Azure Site Recovery 자격 증명 모음을 가져옵니다.
...
[새로운 AzureSiteRecoveryVault](./New-AzureSiteRecoveryVault.md)
