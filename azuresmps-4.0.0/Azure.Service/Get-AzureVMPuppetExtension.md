...
## 설명은
**AzureVMPuppetExtension** cmdlet은 가상 컴퓨터에 적용 된 퍼핏 확장을 가져옵니다.

## 예제의

### 예제 1: 가상 컴퓨터에 적용 된 퍼핏 확장 기능 가져오기
```
PS C:\> Get-AzureVMPuppetExtension -VM $VM
```

이 명령은 가상 컴퓨터에 적용 된 퍼핏 확장을 가져옵니다.
...
[제거-AzureVMPuppetExtension](./Remove-AzureVMPuppetExtension.md)
