...
## 설명은
**AzureSiteRecoveryRecoveryPlan** cmdlet은 현재 Azure site recovery에서 사이트 복구 계획을 제거 합니다.
...
첫 번째 명령은 **AzureSiteRecoveryRecoveryPlan** cmdlet을 사용 하 여 사이트 복구 계획을 얻은 다음 $RecoveryPlan 변수에 저장 합니다.
