...
## SYNOPSIS
가상 컴퓨터 개체에서 Azure virtual machine SQL Server 확장을 제거 합니다.
...
## 설명은
**AzureVMSqlServerExtension** cmdlet은 가상 컴퓨터 개체에서 Azure VIRTUAL Machine SQL Server 확장을 제거 합니다.
...
### -VM
이 cmdlet에서 확장명을 제거 하는 영구 가상 컴퓨터 개체를 지정 합니다.
