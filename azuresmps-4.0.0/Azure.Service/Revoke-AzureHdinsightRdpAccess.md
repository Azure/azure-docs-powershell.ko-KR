...
## SYNOPSIS
HDInsight 클러스터에 대 한 RDP 액세스를 사용 하지 않도록 설정 합니다.
...
**AzureHDInsightRdpAccess** Cmdlet은 Azure HDInsight 클러스터에 대 한 RDP (원격 데스크톱 프로토콜) 액세스를 사용 하지 않도록 설정 합니다.
...
### -이름
Azure HDInsight 클러스터의 이름을 지정 합니다.
...
### -구독
구독을 지정 합니다.
이 cmdlet은이 매개 변수에서 지정 하는 구독에 대 한 RDP (원격 데스크톱 프로토콜) 액세스를 해지 합니다.
...
[부여-AzureHdinsightRdpAccess](./Grant-AzureHdinsightRdpAccess.md)
