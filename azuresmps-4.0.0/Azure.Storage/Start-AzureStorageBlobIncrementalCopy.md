...
### -AbsoluteUri
원본에 대 한 절대 Uri입니다.
원본에 필요한 경우 자격 증명을 Uri에 제공 해야 한다는 점에 유의 하세요.
...
### -CloudBlob
Azure Storage 클라이언트 라이브러리의 CloudBlob 개체입니다.
이를 만들거나 Get-AzureStorageBlob cmdlet을 사용할 수 있습니다.
...
### -CloudBlobContainer
Azure Storage 클라이언트 라이브러리의 CloudBlobContainer 개체입니다.
