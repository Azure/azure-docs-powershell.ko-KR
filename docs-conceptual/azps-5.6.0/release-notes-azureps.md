...
## <a name="560---march-2021"></a>5.6.0 - 2021년 3월
#### <a name="azaccounts"></a>Az.Accounts
* ADFS 자격 증명을 사용하는 경우 Azure.Identity를 업그레이드하여 Connect-AzAccount가 실패하는 문제 해결 [#13560]

#### <a name="azautomation"></a>Az.Automation
* 문자열이 올바르게 직렬화되지 않는 문제가 해결되었습니다. [#14215]
* Python3 Runbook 형식에 대한 지원 추가

#### <a name="azcompute"></a>Az.Compute
* Windows 머신의 'Set-AzVMOperatingSystem' cmdlet에 '-EnableHotpatching' 매개 변수가 추가되었습니다. 
* 'Set-AzVMOperatingSystem' cmdlet의 Linux 매개 변수 집합에 '-PatchMode' 매개 변수가 추가되었습니다. 
* [호환성이 손상되는 변경] VM 게스트 패치 기능의 공개 미리 보기 사용자를 위한 호환성이 손상되는 변경입니다.
    - 'Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary' 개체에서 'RebootStatus' 속성이 제거되었습니다. 
    - 'Microsoft.Azure.Management.Compute.Models.LastPatchInstallationSummary' 개체에서 'StartedBy' 속성이 제거되었습니다.
    - 'Microsoft.Azure.Management.Compute.Models.VirtualMachineSoftwarePatchProperties' 개체에서 'Kbid' 속성의 이름이 'KbId'로 변경되었습니다. 
    - 'Microsoft.Azure.Management.Compute.Models.VirtualMachineAssessPatchesResult' 개체에서 'patches' 속성의 이름이 'availablePatches'로 변경되었습니다. 
    - 'Microsoft.Azure.Management.Compute.Models.SoftwareUpdateRebootBehavior' 개체의 이름이 'Microsoft.Azure.Management.Compute.Models.VMGuestPatchRebootBehavior'로 변경되었습니다.
    - 'Microsoft.Azure.Management.Compute.Models.InGuestPatchMode' 개체의 이름이 'Microsoft.Azure.Management.Compute.Models.WindowsVMGuestPatchMode'로 변경되었습니다.
* [호환성이 손상되는 변경] 'ContainerService' cmdlet이 모두 제거되었습니다. 2020년 1월부터 컨테이너 서비스 API가 사용되지 않습니다. 
...
* `Connect-AzContainerRegistry`에 대한 인증 수정

#### <a name="azcosmosdb"></a>Az.CosmosDB
* Database Account cmdlet에 대한 NetworkAclBypass 및 NetworkAclBypassResourceIds가 도입되었습니다.
* Update-AzCosmosDBAccount에 ServerVersion 매개 변수가 도입되었습니다.
* Database Account cmdlet에 대한 BackupInterval 및 BackupRetention이 도입되었습니다.

#### <a name="azdatafactory"></a>Az.DataFactory
* ADF .Net SDK 버전이 4.14.0으로 업데이트됨

#### <a name="azmigrate"></a>Az.Migrate
* Az.Migrate GA
* 현재 실행되는 외부 스크립트에서 Az.Migrate 모듈의 cmdlet으로 Initialize-AzMigrateReplicationInfrastructure를 통합합니다.
* New-AzMigrateServerReplication, New-AzMigrateDiskMapping의 일부 매개 변수가 대/소문자를 구분하지 않도록 만들었습니다.
* 새 V3 키를 처리하기 위해 어플라이언스 스케일링 변경에 대한 지원이 추가되었습니다.

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* FileShare 복원의 대상 스토리지 계정에 대한 null 검사가 추가되었습니다.

#### <a name="azresources"></a>Az.Resources
* Bicep 언어의 Azure 리소스 배포에 대한 지원 추가
* 'New-AzTenantDeployment' 및 'New-AzManagementGroupDeployment'에서 TemplateSpec 배포와 관련된 문제 해결
* 'Test-Az*Deployments' cmdlet에서 '-QueryString' 매개 변수에 대한 지원 추가
* 'New-Az*Deployments'를 '-QueryString'과 함께 사용하는 경우 동적 매개 변수와 관련된 문제 해결
* 'New-Az*Deployments' cmdlet에 '-TemplateSpecId' 매개 변수를 사용하는 동안 '-TemplateParameterObject' 매개 변수에 대한 지원 추가
* 존재하지 않는 템플릿 사양을 배포하려고 할 때 수신되는 부정확한 오류 메시지가 수정됨

#### <a name="azstorage"></a>Az.Storage
* 새로운 API 버전 2021-01-01을 지원하기 위해 Microsoft.Azure.Management.Storage 19.0.0으로 업그레이드되었습니다.
* NetworkRuleSet에서 리소스 액세스 규칙이 지원됨
    - 'Update-AzStorageAccountNetworkRuleSet'
    - 'Add-AzStorageAccountNetworkRule'
    - 'Remove-AzStorageAccountNetworkRule'
* 관리 정책에서 Blob 버전 및 Blob 유형 추가가 지원됨
    - 'Add-AzStorageAccountManagementPolicyAction'
    - 'New-AzStorageAccountManagementPolicyFilter'
    - 'Set-AzStorageAccountManagementPolicy'
* AllowSharedKeyAccess를 사용한 계정 만들기/업데이트 지원
    - 'New-AzStorageAccount'
    - 'Set-AzStorageAccount'
* RequireInfrastructureEncryption을 사용한 암호화 범위 만들기 지원
    - 'New-AzStorageEncryptionScope'
* 암호화 범위를 사용하여 블록 Blob을 동기적으로 복사하는 기능 지원
    - 'Copy-AzStorageBlob'
* Linux 및 MacOS에서 Get-AzStorageBlobContent가 잘못된 디렉터리 구분 문자를 사용하는 문제 해결 [#14234]

#### <a name="azwebsites"></a>Az.Websites
* 'Publish-AzWebApp'에 대한 사용자 지정 시간 제한을 제공하는 옵션 도입 
* App Service Environment에 대한 지원 추가
...
* @alunmj, 사소한 철자, 서식 변경(#14155)
* @chakra146, AzLoadBalancerInboundNatPoolConfig.md 업데이트(#14231)
* Martin Ehrnst(@ehrnst), cmdlet의 오타 수정(#14112)
* 1월 David Narkiewicz(@jdnark)
  * 예제에서는 기존 cmdlet이자 New-AzAksCluster의 별칭인 New-AzAks를 사용했습니다. 이 설명서 페이지에서 대상으로 하는 cmdlet인 New-AzAksCluster를 사용하도록 예제를 변경했습니다. (#14088)
  * 오타 수정: SshKeyVaule를 SshKeyValue로 변경(#14087)
* Ivan Kulezic(@kukislav), sql mi 유지 관리 구성 예제 추가(#14216)
* @webguynj, Set-AzNetworkSecurityRuleConfig.md 업데이트(#14176)
* Yannick Dils(@yannickdils), 부하 분산 장치에 변경 사항을 적용하는 예제에 cmdline 추가(#14185)
