...
* Webhook에서 이제 Azure Active Directory 인증을 지원합니다.
...
* 네트워크 인터페이스에 사설 IP 기능을 위한 속성이 추가되었습니다.
...
* https://github.com/Azure/azure-powershell/issues/9307 및 https://github.com/Azure/azure-powershell/issues/8432 이슈 수정
...
* 'New-AzEventGridSubscription' 설명서의 오타 수정
...
* 고객이 TDE 키를 추가하고 관리형 인스턴스에 TDE 보호기를 설정할 수 있도록 Management.Sql용 새 Cmdlet 추가
...
* 확장에서 클러스터 id를 확인하여 클러스터에 해당하는 VM Scale Sets에만 추가되도록 클러스터/애플리케이션 인증서 추가를 수정하세요.
...
* 유일하게 업데이트된 속성인데 작동하지 않는 관리형 인스턴스 ID의 업데이트 수정
* 관리형 인스턴스에서의 사용자 지정 데이터 정렬에 대한 지원
...
* 일부 끊어진 링크 수정
    - New-AzureRmFrontDoor 및 Set-AzureRmFrontDoor 문서에서 New-AzureRmFrontDoorHealthProbeSettingObject cmdlet 문서에 대한 링크가 수정되었습니다.
    - New-AzureRmFrontDoorManagedRuleObject 문서에서 New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet 문서에 대한 링크가 수정되었습니다.
...
* 해결된 문제 # 7513[자세한 정보] Set-AzDiagnosticSetting은 설정을 생성하는 동안 범주를 명시적으로 지정해야 합니다
    - 이제 cmdlet은 생성 중에 사용할 범주를 명시적으로 표시할 필요가 없습니다. 즉, 문서화된 대로 작동합니다
