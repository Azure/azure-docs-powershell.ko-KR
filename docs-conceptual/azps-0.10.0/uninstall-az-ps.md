...
이 화면의 프로그램 목록에서 __Azure PowerShell__ 또는 __Microsoft Azure PowerShell - Month Year__를 확인할 수 있습니다. 이 앱을 제거하면 됩니다. 이 프로그램이 나열되지 않으면 PowerShellGet을 통해 설치한 후 다음 지침을 따라야 합니다.
