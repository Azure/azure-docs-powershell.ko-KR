...
## <a name="reset-credentials"></a><span data-ttu-id="c5940-173">자격 증명 다시 설정</span><span class="sxs-lookup"><span data-stu-id="c5940-173">Reset credentials</span></span>
