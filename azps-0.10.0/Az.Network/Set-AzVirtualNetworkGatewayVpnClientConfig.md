...
## 설명은
**AzVirtualNetworkVpnClientConfig** cmdlet은 가상 네트워크 게이트웨이의 클라이언트 주소 풀을 구성 합니다.
...
그런 다음이 예제의 두 번째 명령은 **Set-AzVirtualNetworkGatewayVpnClientConfig** cmdlet을 사용 하 여 주소 풀 10.0.0.0/16을 ContosoVirtualGateway에 할당 합니다.
...
그런 다음이 예제의 두 번째 명령은 **Set-AzVirtualNetworkGatewayVpnClientConfig** cmdlet을 사용 하 여 주소 풀 10.0.0.0/16을 ContosoVirtualGateway에 할당 합니다. 또한 vpn 클라이언트에 대 한 인증에 사용할 외부 radius 서버 "TestRadiusServer"를 구성 합니다.
