...
이 명령은 C:\VMPolicy.js에 지정 된 정책 정의를 포함 하는 VMPolicyDefinition 이라는 정책 집합 정의를 만듭니다. VMPolicy.js의 예제 콘텐츠는 위에 나와 있습니다.
...
이 명령은 C:\VMPolicy.js에 지정 된 정책 정의를 포함 하는 VMPolicyDefinition 이라는 매개 변수가 있는 정책 집합 정의를 만듭니다. VMPolicy.js의 예제 콘텐츠는 위에 나와 있습니다.
