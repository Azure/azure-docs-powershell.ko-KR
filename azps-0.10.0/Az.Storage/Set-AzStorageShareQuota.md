...
## 설명은
**AzStorageShareQuota** cmdlet은 지정 된 공유에 대 한 저장소 용량을 설정 합니다.
...
의 할당량 제한을 참조 하세요 https://docs.microsoft.com/en-us/azure/azure-subscription-service-limits#azure-files-limits . 
...
### FileShareProperties를 통해 파일을 저장 합니다.
