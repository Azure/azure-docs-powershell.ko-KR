...
## 설명은
공간 앵커 계정의 기본 키 또는 보조 키를 다시 생성 합니다.
...
리소스 그룹 "rg1"에서 공간 앵커 계정의 보조 키 "예제"를 다시 생성 합니다. 
...
현재 구독 및 리소스 그룹 "rg1"에서 "example" 공간 앵커 계정의 보조 키를 파이프로 다시 생성 합니다.
