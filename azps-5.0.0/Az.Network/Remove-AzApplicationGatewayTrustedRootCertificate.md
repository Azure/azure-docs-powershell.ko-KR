...
## 설명은
**AzApplicationGatewayTrustedRootCertificate** cmdlet은 기존 응용 프로그램 게이트웨이에서 신뢰할 수 있는 루트 인증서를 제거 합니다.
...
두 번째 명령은 $gw에 저장 된 응용 프로그램 게이트웨이에서 myRootCA 이라는 신뢰할 수 있는 루트 인증서를 제거 합니다.
