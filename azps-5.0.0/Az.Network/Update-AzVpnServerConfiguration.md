...
## 설명은
**AzVpnServerConfiguration** cmdlet을 사용 하면 다른 VpnProtocols, VpnAuthenticationTypes, VpnServerConfiguration 정책을 사용 하 여 기존를 업데이트 하 고, 사이트 연결을 위한 고객의 요구 사항에 따라 선택한 vpn 인증 유형 관련 매개 변수를 설정할 수 있습니다.
...
위의 명령을 사용 하면 IkeV2로 VpnProtocol 하는 기존 VpnServerConfiguration 업데이트 됩니다.

## 변수

### -AadAudience
P2S AAD 인증을 위한 AAD 대상 그룹입니다.
...
RadiusClientRootCertificate 파일 경로 목록
...
### -ResourceId
Vpn 서버 구성에 대 한 Azure 리소스 ID입니다.
...
VpnServerConfiguration에 대 한 IPSec 정책 목록입니다.
...
파일 경로를 해지할 VpnClientCertificates 목록
...
추가 되는 파일 경로에 대 한 VpnClientRootCertificates 목록
