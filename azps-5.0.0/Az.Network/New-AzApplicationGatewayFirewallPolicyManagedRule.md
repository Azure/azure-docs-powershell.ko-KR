...
## 설명은
**새로운 AzApplicationGatewayFirewallPolicyManagedRule** 는 방화벽 정책에 대 한 관리 규칙을 만듭니다.
...
이 명령은 관리 되는 규칙을 $managedRuleSet 및 $exclusion 1 ($exclusion 2)의 항목을 포함 하는 제외 목록에 대 한 ManagedRuleSet 목록을 만듭니다.
