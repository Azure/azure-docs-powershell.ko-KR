...
## 설명은
New-AzNetworkVirtualAppliance 명령은 Azure에서 네트워크 가상 어플라이언스 리소스를 만듭니다.
...
리소스 그룹: testrg에서 새 네트워크 가상 기기 리소스를 만듭니다.
...
### Microsoft. 네트워크 모델. PSNetworkVirtualAppliance
