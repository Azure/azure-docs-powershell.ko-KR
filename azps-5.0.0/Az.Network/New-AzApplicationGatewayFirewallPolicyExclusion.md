...
## 설명은
**AzApplicationGatewayFirewallPolicyExclusion** cmdlet은 방화벽 정책의 새 제외 규칙 목록입니다.
...
이 명령은 xyz 라는 RequestHeaderNames 및 선택기 라는 StartsWith 라는 변수에 대해 새 제외 항목을 만듭니다. 제외 항목이 $exclusionEntry에 저장 됩니다.
...
### PSApplicationGatewayFirewallPolicyExclusion에 대 한.
