...
## 설명은
**AzPrivateEndpoint** cmdlet은 하나 이상의 비공개 끝점을 가져옵니다.
...
이 명령은 리소스 그룹 TestResourceGroup에서 MyPrivateEndpoint1 라는 개인 끝점을 가져옵니다.

### 예제 2: ResourceGroup의 모든 개인 끝점 나열
```powershell
...
이 명령은 리소스 그룹 TestResourceGroup의 모든 비공개 끝점을 가져옵니다.
