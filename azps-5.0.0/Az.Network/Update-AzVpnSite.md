...
### ByVpnSiteNameNoVirtualWanUpdate (기본값)
```
...
## 설명은
**업데이트 AzVpnSite** CMDLET은 VPN 사이트를 업데이트 합니다.
...
사이트를 만든 후에는 Set-AzVpnSite 명령을 사용 하 여 사이트의 IpAddress를 업데이트 합니다.

## 변수

### -AddressSpace
가상 네트워크의 주소 접두사입니다.
이 or AddressSpaceObject을 모두 사용 합니다.
...
### -O365Policy
이 VpnSite에 대 한 office 365 트래픽 아웃 브레이크 정책입니다.
...
### -VpnSiteLink
이 VpnSite에 있는 VpnSiteLinks의 목록입니다.
