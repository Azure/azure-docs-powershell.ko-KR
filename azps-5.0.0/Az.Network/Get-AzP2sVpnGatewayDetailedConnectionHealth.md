...
## 설명은
**AzP2sVpnGatewayDetailedConnectionHealth** cmdlet을 사용 하면 P2SVpnGateway에서 현재 지점의 사이트 연결에 대 한 자세한 정보를 얻을 수 있습니다. 이 자세한 상태 정보를 저장할 수 있는 SAS url을 전달 해야 합니다.
...
**AzP2sVpnGatewayDetailedConnectionHealth** cmdlet을 사용 하면 P2SVpnGateway에서 현재 지점의 사이트 연결에 대 한 자세한 정보를 얻을 수 있습니다. 고객이 통과 한 SAS url 다운로드에서 상태 세부 정보를 다운로드할 수 있습니다. 여기에는 사용자 이름, 바이트 수, 바이트 출력, 할당 된 ip 주소 등과 같은 사이트 연결에 대 한 각 지점의 정보가 표시 됩니다.
...
### -OutputBlobSasUrl
P2s vpn 연결 상태가 기록 될 OutputBlob Sas url입니다.
