...
## 설명은
**AzExpressRouteCrossConnection** cmdlet은 수정 된 express 경로 간 연결을 Azure에 저장 합니다.

## 예제의

### 예제 1: Express 경로 연결의 서비스 공급자 프로비저닝 상태 변경
```
...
이 cmdlet이 수정 하는 **ExpressRouteCrossConnection** 개체를 지정 합니다.
