...
## 설명은
**AzNetworkProfile** cmdlet은 새 네트워크 프로필 최상위 수준 리소스를 만듭니다.
...
### -ContainerNicConfig
이 네트워크 프로필에 추가할 컨테이너 네트워크 인터페이스 구성입니다.
...
### PSContainerNetworkInterfaceConfiguration [] (으)로
