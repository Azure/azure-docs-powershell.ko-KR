...
## 설명은
**새로운 AzApplicationGatewayFirewallPolicyManagedRuleSet** 는 방화벽 정책에 대 한 관리 규칙을 만듭니다.
...
RuleSetType을 $ruleSetType로 사용 하 고 $ruleSetVersion와 RuleGroupOverrides로 Rulesettype을 $ruleGroupOverride 1로 표시 하는 목록으로, $ruleGroupOverride 2 인 새 ManagedRuleSet 집합이 지정 되어 $managedRuleSet
...
### -RuleSetVersion
Managedsetversion에 대 한 규칙을 지정 합니다.
...
### PSApplicationGatewayFirewallPolicyManagedRuleSet에 대 한.
