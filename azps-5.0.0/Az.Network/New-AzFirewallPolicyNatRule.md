...
## 설명은
**AzFirewallPolicyNatRule** Cmdlet은 Azure 방화벽 정책에 대 한 NAT 규칙을 만듭니다.
...
이 예제에서는 원본 주소, 프로토콜, 대상 주소, 대상 포트, 번역 된 주소 및 변환 된 포트를 사용 하 여 NAT 규칙을 만듭니다.
...
### -DestinationAddress
규칙의 대상 주소입니다. 이는 방화벽의 공용 IP 여야 합니다.
