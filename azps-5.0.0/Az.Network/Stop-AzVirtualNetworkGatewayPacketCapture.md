...
## 설명은
가상 네트워크 게이트웨이에서 패킷 캡처 작업을 중지 하 고 지정 된 SasUrl 저장소 컨테이너에 대 한 결과를 업로드 합니다.
...
### -InputObject
패킷 캡처가 시작 될 가상 네트워크 게이트웨이 개체입니다.
...
### -이름
패킷을 캡처를 시작할 가상 네트워크 게이트웨이 이름입니다.
...
### -ResourceId
패킷 캡처가 시작 되는 VirtualNetworkGateway의 Azure 리소스 ID입니다.
...
## 관련 링크
[시작-AzVirtualnetworkGatewayPacketCapture](./Stop-AzVirtualnetworkGatewayPacketCapture.md)
