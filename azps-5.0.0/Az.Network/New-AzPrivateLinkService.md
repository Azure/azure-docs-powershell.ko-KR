...
## 설명은
**새 AzPrivateLinkService** cmdlet은 개인 링크 서비스를 만듭니다.

## 예제의

### 예제 1

다음 예제에서는 개인 링크 서비스를 만듭니다.
...
### -EnableProxyProtocol
개인 링크 서비스에 대해 프록시 프로토콜을 사용 하도록 설정 합니다.
...
### PSPrivateLinkServiceIpConfiguration [] (으)로

## 출력

### PSPrivateLinkService에 대 한.
