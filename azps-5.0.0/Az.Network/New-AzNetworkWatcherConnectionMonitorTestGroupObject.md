...
### 예제 1:2 개의 testConfigurations, w 원본 및 2 개의 대상 끝점을 사용 하 여 테스트 그룹 만들기
...
### -Disable
테스트 그룹을 사용할 수 있는지 여부를 나타내는 플래그입니다.
...
### PSNetworkWatcherConnectionMonitorTestGroupObject에 대 한.
