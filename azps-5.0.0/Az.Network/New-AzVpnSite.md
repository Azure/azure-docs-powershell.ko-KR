...
위의 방법으로 Azure에서 "nonlinkSite" 리소스 그룹에 있는 동쪽의 가상 WAN 인 리소스 그룹을 만듭니다. 
...
Azure의 "멀티 링크" 리소스 그룹에 미국 VpnSiteLinks 1 개를 사용 하 여 리소스 그룹, 가상 WAN 및 VpnSite를 만듭니다.

### 예제 3

새 Azure VpnSite 리소스를 만듭니다. 생성
