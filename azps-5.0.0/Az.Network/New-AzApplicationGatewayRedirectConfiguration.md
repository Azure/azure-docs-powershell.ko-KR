...
## 설명은
**AzApplicationGatewayRedirectConfiguration Cmdlet은** 응용 프로그램 게이트웨이에 대 한 리디렉션 구성을 만듭니다.
...
이 명령은 Redirect01 이라는 리디렉션 구성을 만들고 그 결과를 $RedirectConfig 라는 변수에 저장 합니다.

### 예제 2

응용 프로그램 게이트웨이에 대 한 리디렉션 구성을 만듭니다. 생성
