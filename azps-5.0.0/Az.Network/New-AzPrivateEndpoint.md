...
**AzPrivateEndpoint** cmdlet은 개인 끝점을 만듭니다.

## 예제의

### 예제 1: 개인 끝점 만들기

다음 예제에서는 가상 네트워크의 지정 된 서브넷에서 특정 개인 링크 서비스 ID를 사용 하 여 개인 끝점을 만듭니다.
...
개인 끝점의 위치를 지정 합니다. 이 매개 변수에 대 한 유효한 값을 확인 하려면 [Get-AzLocation](/powershell/module/az.resources/get-azlocation) 을 사용 합니다.
...
해시 테이블 형태의 키-값 쌍입니다. 예를 들어 @ {key0 = ' value0 ', key1 = $null, key2 = ' value2 = ' 2, 2,.
...
### PSPrivateLinkServiceConnection [] (으)로
