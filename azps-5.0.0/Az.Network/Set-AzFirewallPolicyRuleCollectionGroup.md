...
## 설명은
**AzFirewallPolicyRuleCollectionGroup** Cmdlet은 Azure 방화벽 정책의 규칙 컬렉션 그룹을 업데이트 합니다.
...
이 예제에서는 방화벽 정책의 규칙 모음 그룹을 업데이트 $fp

### 예제 2

수정 된 azure 방화벽 정책 규칙 모음 그룹을 저장 합니다. 생성
