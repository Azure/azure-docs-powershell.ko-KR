...
## 설명은
**새로운 AzPrivateDnsZoneGroup** cmdlet을 사용 하 여 새 개인 DNS 영역 그룹을 만들 수 있습니다.
...
개인 끝점 `test-pr-endpoint` 을 만든 후 위 예제에서는 해당 개인 끝점 아래에 DNS 영역 그룹을 만듭니다.
...
개인 dns 영역 그룹의 개인 dns 영역 구성 모음입니다.
...
### System.webserver. List ' 1 [[PSPrivateDnsZoneConfig, Microsoft. e. e l t. i = 2.5.0.0, Culture = 중립, PublicKeyToken = null]] 목록

## 출력

### PSPrivateDnsZoneGroup에 대 한.
