...
TCP, HTTP 또는 ICMP를 통해 테스트 평가를 수행 하는 데 사용 되는 프로토콜 구성을 만듭니다. 생성
...
대상 포트 동작입니다.
지원 되는 값은 없음, ListenIfAvailable입니다.
...
HTTP 상태 코드를 성공적으로 고려 합니다.
예를 들어 "2xx, 301-304418".
...
### PSNetworkWatcherConnectionMonitorTcpConfiguration에 대 한.

### PSNetworkWatcherConnectionMonitorHttpConfiguration에 대 한.

### PSNetworkWatcherConnectionMonitorIcmpConfiguration에 대 한.
