...
## 설명은
**AzApplicationGatewayFirewallPolicy** cmdlet은 응용 프로그램 게이트웨이 방화벽 정책을 제거 합니다.
...
이 명령은 ResourceGroup01 이라는 리소스 그룹에서 ApplicationGatewayFirewallPolicy01 이라는 응용 프로그램 게이트웨이 방화벽 정책을 제거 합니다.
