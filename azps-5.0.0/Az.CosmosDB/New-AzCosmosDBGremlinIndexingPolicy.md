...
## SYNOPSIS
새 CosmosDB IndexingPolicy 개체를 만듭니다.
...
## 설명은
**AzCosmosDBGremlinIndexingPolicy** Cmdlet은 PSIndexingPolicy 유형의 새 개체를 만듭니다.
...
### -CompositePath
CosmosDB. PSCompositePath에 해당 하는 개체 배열의 배열 형식
...
### -ExcludedPath
ExcludedPath를 포함 하는 문자열 배열 (Azure Cosmos DB 서비스에서 제외할 JSON 문서 내의 경로를 지정 합니다.)  요소.
...
### -IncludedPath
IncludedPath를 포함 하는 문자열 배열 (Azure Cosmos DB service에 포함할 JSON 문서 내의 경로를 지정 합니다.) 요소.
...
### -IndexingMode
인덱싱 모드를 나타냅니다.
사용할 수 있는 값은 다음과 같습니다. ' 일관성 ', ' 지연 ', ' 없음 '
...
### -SpatialSpec
CosmosDB. PSSpatialSpec에 해당 하는 개체의 배열입니다.
...
### CosmosDB. a m a. m 인덱스 Ingpolicy
