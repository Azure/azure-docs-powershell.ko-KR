...
## 설명은
**AzCosmosDBSqlUserDefinedFunction** cmdlet은 지정 된 ResourceGroupName, Accountname, Databasename 및 ContainerName에 대 한 모든 기존 CosmosDB sql UserDefinedFunctions 목록을 가져오고 지정 된 CosmosDB, Accountname, Databasename, Containername 및 UserDefinedFunction에 대 한 단일 ResourceGroupName sql UserDefinedFunctionName를 가져옵니다.
