...
## SYNOPSIS
새 CosmosDB Cassandra Cluster 키를 만듭니다.
...
## 설명은
**AzCosmosDBCassandraClusterKey** 는 새 CosmosDB Cassandra Cluster 키를 만듭니다.
...
### -OrderBy
Cassandra 클러스터 키의 순서를 지정 합니다.
사용할 수 있는 값은 다음과 같습니다. ' Asc ', ' Desc '
