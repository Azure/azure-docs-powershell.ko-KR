...
ConflictResolutionPolicy 매개 변수와 함께 제공 된 경우이는 무시 됩니다.
...
### CosmosDB. PSSqlUniqueKeyPolicy/.

### CosmosDB. PSSqlConflictResolutionPolicy/.
...
### CosmosDB (ConflictingResourceException).
