...
## 설명은
이 cmdlet은 이전에 백업한 보안 도메인 데이터를 관리 되는 HSM에 복원 합니다.
...
먼저 보안 도메인 데이터를 해독 하는 데 키를 제공 해야 합니다. 그런 다음 **Restore-AzManagedHsmSecurityDomain** 명령은 이러한 키를 사용 하 여 이전에 백업한 보안 도메인 데이터를 관리 되는 HSM으로 복원 합니다.
...
### -키
보안 도메인 데이터의 암호를 해독 하는 데 사용 되는 키에 대 한 정보입니다.
생성 방법에 대 한 예제를 참조 하세요.
