...
## 설명은
**AzKeyVaultCertificate** cmdlet은 인증서를 키 보관소로 가져옵니다.
다음 방법 중 하나를 사용 하 여 가져올 인증서를 만들 수 있습니다.
- `Add-AzKeyVaultCertificate`인증서 서명 요청을 만들어 인증 기관에 제출 하는 데 사용 합니다. 보기 https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[키 자격 증명 모음에서 CSR 만들기 및 병합](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)