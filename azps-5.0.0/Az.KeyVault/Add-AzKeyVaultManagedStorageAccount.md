...
키 보관소는 재생성 기간을 기준으로 활성 키를 자동으로 다시 생성 하 고 전환 합니다. 이 기능에 대 한 개요는 [Azure 키 자격 증명 모음 관리 저장소 계정-PowerShell](https://docs.microsoft.com/azure/key-vault/key-vault-overview-storage-keys-powershell) 을 참조 하세요.
