...
## 설명은
**AzSynapseWorkspace** Cmdlet은 Azure Synapse Analytics 작업 영역을 영구적으로 삭제 합니다.
...
이 명령은 Azure Synapse Analytics 작업 영역을 삭제 합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics 작업 영역을 삭제 합니다.
...
이 명령은 지정 된 리소스 ID를 가진 파이프라인을 통해 Azure Synapse Analytics 작업 영역을 삭제 합니다.
