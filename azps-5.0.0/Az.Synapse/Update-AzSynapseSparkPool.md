...
## 설명은
**업데이트 AzSynapseSparkPool** Cmdlet은 Azure Synapse Analytics Spark 풀을 업데이트 합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀을 업데이트 합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics Spark 풀을 업데이트 합니다.
...
이 명령은 리소스 ID를 사용 하 여 Azure Synapse Analytics Spark 풀을 업데이트 합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대 한 자동 크기 조정을 사용 하도록 설정 합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대 한 자동 크기 조정을 사용 하지 않도록 설정 합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대 한 자동 일시 중지를 사용 하도록 설정 합니다.
...
이 명령은 Azure Synapse Analytics Spark 풀에 대 한 자동 일시 중지를 사용 하지 않도록 설정 합니다.
...
유휴 상태인 분 수입니다. 자동 일시 정지가 설정 된 경우이 매개 변수를 지정 해야 합니다.
...
지정 된 Spark 풀에 할당할 최대 노드 수입니다.
자동 크기 조정을 사용 하는 경우이 매개 변수를 지정 해야 합니다.
...
### -EnableAutoScale 크기 조정
자동 크기 조정을 사용 해야 하는지 여부를 나타냅니다.
...
### -NodeSize
지정 된 Spark 풀에 할당 된 노드에 사용할 코어 및 메모리 수입니다.
자동 크기 조정을 사용 하지 않는 경우이 매개 변수를 지정 해야 합니다.
