...
## 설명은
**업데이트 AzSynapseIntegrationRuntime** cmdlet은 통합 런타임 속성을 업데이트 합니다. 현재 cmdlet은 자체 호스팅 통합 런타임으로 ' 자동 업데이트 ' 및 ' AutoUpdateDelayOffset ' 업데이트가 지원 됩니다.
...
자체 호스팅 통합 런타임 자동 업데이트에 대 한 일 시간입니다.
...
### Synapse. PSSelfHostedIntegrationRuntimeStatus/.
