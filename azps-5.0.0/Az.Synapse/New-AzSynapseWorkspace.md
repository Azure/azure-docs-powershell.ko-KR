...
## 설명은
**AzSynapseWorkspace** Cmdlet은 Azure Synapse Analytics 작업 영역을 만듭니다.
...
이 명령은 ContosoResourceGroup 이라는 리소스 그룹에서 ContosoAdlGenStorage 데이터 저장소를 사용 하는 ContosoWorkspace 이라는 Synapse Analytics 작업 영역을 만듭니다.
...
Azure Synapse workspace 전용 Synapse 관리 가상 네트워크의 이름입니다.
