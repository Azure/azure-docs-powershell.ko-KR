...
## 설명은
**AzSynapseSparkStatement** Cmdlet은 Azure Synapse Analytics Spark 문에 대 한 정보를 가져옵니다.
...
이 명령은 Spark 세션 아래에 있는 모든 Spark 문을 가져옵니다.
...
이 명령은 지정 된 livy ID의 Spark 문을 가져옵니다.
...
이 명령은 파이프라인을 통해 Spark 세션 아래에 있는 모든 Spark 문을 가져옵니다.
...
### Synapse. PSSynapseSparkStatement/.
