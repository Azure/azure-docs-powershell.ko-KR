...
## 설명은
**AzSynapseRoleAssignment** Cmdlet은 Azure Synapse Analytics 역할 할당을 만듭니다.
...
이 명령은 principal name이 ContosoName 인 사용자에 게 ContosoRole를 할당 합니다.
...
이 명령은 principal name이 파이프라인을 통해 ContosoName 된 사용자에 게 ContosoRole를 할당 합니다.
