...
## 설명은
**AzSqlSyncMember** Cmdlet은 Azure SQL 데이터베이스 동기화 구성원을 만듭니다.
...
UsePrivateLinkConnection가 true로 설정 된 경우 사용 되는 동기화 구성원 데이터베이스의 리소스 ID입니다.
...
이 동기화 구성원에 연결할 때 비공개 링크 연결을 사용 합니다.
