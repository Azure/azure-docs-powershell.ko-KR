...
## 설명은
**AzSqlInstanceActiveDirectoryOnlyAuthentication** cmdlet은 현재 구독의 AzureSQL 관리 인스턴스에 대 한 azure AD (Azure Active Directory) 인증 요구 사항만 가져옵니다.
...
이 명령은 ResourceGroup01 이라는 리소스 그룹과 연결 된 ManagedInstance01 라는 AzureSQL 관리 되는 인스턴스에 대 한 azure AD (Azure Active Directory) 인증 요구 사항만 가져옵니다.
