...
### [<span data-ttu-id="56a9a-111">추가-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="56a9a-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="56a9a-125">일반-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="56a9a-125">Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Clear-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
...
### [<span data-ttu-id="56a9a-137">변환-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="56a9a-137">Convert-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Convert-AzSqlDatabaseVulnerabilityAssessmentScan.md)
...
### [<span data-ttu-id="56a9a-149">Disable-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="56a9a-149">Disable-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Disable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="56a9a-161">Enable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="56a9a-161">Enable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Enable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="56a9a-175">Get-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-175">Get-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Get-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
...
### [<span data-ttu-id="56a9a-189">Get-AzSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="56a9a-189">Get-AzSqlDatabaseExpanded</span></span>](Get-AzSqlDatabaseExpanded.md)
...
### [<span data-ttu-id="56a9a-203">Get-AzSqlDatabaseLongTermRetentionBackup</span><span class="sxs-lookup"><span data-stu-id="56a9a-203">Get-AzSqlDatabaseLongTermRetentionBackup</span></span>](Get-AzSqlDatabaseLongTermRetentionBackup.md)
...
### [<span data-ttu-id="56a9a-217">Get-AzSqlDatabaseTransparentDataEncryptionActivity</span><span class="sxs-lookup"><span data-stu-id="56a9a-217">Get-AzSqlDatabaseTransparentDataEncryptionActivity</span></span>](Get-AzSqlDatabaseTransparentDataEncryptionActivity.md)
...
### [<span data-ttu-id="56a9a-231">Get-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="56a9a-231">Get-AzSqlElasticJob</span></span>](Get-AzSqlElasticJob.md)
...
### [<span data-ttu-id="56a9a-247">Get-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="56a9a-247">Get-AzSqlElasticPool</span></span>](Get-AzSqlElasticPool.md)
...
### [<span data-ttu-id="56a9a-261">Get-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="56a9a-261">Get-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Get-AzSqlInstanceActiveDirectoryAdministrator.md)
...
### [<span data-ttu-id="56a9a-273">Get-AzSqlInstanceDatabaseGeoBackup</span><span class="sxs-lookup"><span data-stu-id="56a9a-273">Get-AzSqlInstanceDatabaseGeoBackup</span></span>](Get-AzSqlInstanceDatabaseGeoBackup.md)
...
### [<span data-ttu-id="56a9a-287">Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-287">Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="56a9a-301">Get-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="56a9a-301">Get-AzSqlServer</span></span>](Get-AzSqlServer.md)
...
### [<span data-ttu-id="56a9a-315">Get-AzSqlServerCommunicationLink</span><span class="sxs-lookup"><span data-stu-id="56a9a-315">Get-AzSqlServerCommunicationLink</span></span>](Get-AzSqlServerCommunicationLink.md)
...
### [<span data-ttu-id="56a9a-329">Get-AzSqlServerServiceObjective</span><span class="sxs-lookup"><span data-stu-id="56a9a-329">Get-AzSqlServerServiceObjective</span></span>](Get-AzSqlServerServiceObjective.md)
...
### [<span data-ttu-id="56a9a-343">Get-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-343">Get-AzSqlSyncGroup</span></span>](Get-AzSqlSyncGroup.md)
...
### [<span data-ttu-id="56a9a-357">AzSqlInstanceFailover-호출</span><span class="sxs-lookup"><span data-stu-id="56a9a-357">Invoke-AzSqlInstanceFailover</span></span>](Invoke-AzSqlInstanceFailover.md)
...
### [<span data-ttu-id="56a9a-371">새로운 AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-371">New-AzSqlDatabaseInstanceFailoverGroup</span></span>](New-AzSqlDatabaseInstanceFailoverGroup.md)
...
### [<span data-ttu-id="56a9a-385">새로운 AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="56a9a-385">New-AzSqlElasticPool</span></span>](New-AzSqlElasticPool.md)
...
### [<span data-ttu-id="56a9a-401">새로운 AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-401">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="56a9a-417">제거-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-417">Remove-AzSqlDatabaseDataMaskingRule</span></span>](Remove-AzSqlDatabaseDataMaskingRule.md)
...
### [<span data-ttu-id="56a9a-431">제거-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="56a9a-431">Remove-AzSqlDatabaseSensitivityClassification</span></span>](Remove-AzSqlDatabaseSensitivityClassification.md)
...
### [<span data-ttu-id="56a9a-445">제거-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="56a9a-445">Remove-AzSqlElasticPool</span></span>](Remove-AzSqlElasticPool.md)
...
<span data-ttu-id="56a9a-458">SQL 관리 인스턴스에서 키 보관소 키를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-458">Removes a Key Vault key from a SQL managed instance</span></span>

### [<span data-ttu-id="56a9a-459">제거-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="56a9a-459">Remove-AzSqlInstancePool</span></span>](Remove-AzSqlInstancePool.md)
<span data-ttu-id="56a9a-460">Azure SQL 인스턴스 풀을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-460">Removes an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="56a9a-461">제거-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="56a9a-461">Remove-AzSqlServer</span></span>](Remove-AzSqlServer.md)
<span data-ttu-id="56a9a-462">Azure SQL 데이터베이스 서버를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-462">Removes an Azure SQL Database server.</span></span>

### [<span data-ttu-id="56a9a-463">제거-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="56a9a-463">Remove-AzSqlServerActiveDirectoryAdministrator</span></span>](Remove-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="56a9a-464">SQL Server에 대 한 Azure AD 관리자를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-464">Removes an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="56a9a-465">제거-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="56a9a-465">Remove-AzSqlServerAudit</span></span>](Remove-AzSqlServerAudit.md)
<span data-ttu-id="56a9a-466">Azure SQL server의 감사 설정을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-466">Removes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="56a9a-467">제거-AzSqlServerCommunicationLink</span><span class="sxs-lookup"><span data-stu-id="56a9a-467">Remove-AzSqlServerCommunicationLink</span></span>](Remove-AzSqlServerCommunicationLink.md)
<span data-ttu-id="56a9a-468">두 서버 간의 탄력적 데이터베이스 거래에 대 한 통신 링크를 삭제 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-468">Deletes a communication link for elastic database transactions between two servers.</span></span>

### [<span data-ttu-id="56a9a-469">제거-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="56a9a-469">Remove-AzSqlServerDisasterRecoveryConfiguration</span></span>](Remove-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="56a9a-470">SQL 데이터베이스 서버 시스템 복구 구성을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-470">Removes a SQL database server system recovery configuration.</span></span>

### [<span data-ttu-id="56a9a-471">제거-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="56a9a-471">Remove-AzSqlServerDnsAlias</span></span>](Remove-AzSqlServerDnsAlias.md)
<span data-ttu-id="56a9a-472">Azure SQL Server DNS 별칭을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-472">Removes Azure SQL Server DNS Alias.</span></span>

### [<span data-ttu-id="56a9a-473">제거-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-473">Remove-AzSqlServerFirewallRule</span></span>](Remove-AzSqlServerFirewallRule.md)
<span data-ttu-id="56a9a-474">SQL 데이터베이스 서버에서 방화벽 규칙을 삭제 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-474">Deletes a firewall rule from a SQL Database server.</span></span>

### [<span data-ttu-id="56a9a-475">제거-AzSqlServerKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="56a9a-475">Remove-AzSqlServerKeyVaultKey</span></span>](Remove-AzSqlServerKeyVaultKey.md)
<span data-ttu-id="56a9a-476">SQL server에서 키 자격 증명 모음 키를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-476">Removes a Key Vault key from a SQL server.</span></span>

### [<span data-ttu-id="56a9a-477">제거-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-477">Remove-AzSqlServerVirtualNetworkRule</span></span>](Remove-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="56a9a-478">Azure SQL Server 가상 네트워크 규칙을 삭제 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-478">Deletes an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="56a9a-479">제거-AzSqlSyncAgent</span><span class="sxs-lookup"><span data-stu-id="56a9a-479">Remove-AzSqlSyncAgent</span></span>](Remove-AzSqlSyncAgent.md)
<span data-ttu-id="56a9a-480">Azure SQL 동기화 에이전트를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-480">Removes an Azure SQL Sync Agent.</span></span>

### [<span data-ttu-id="56a9a-481">제거-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-481">Remove-AzSqlSyncGroup</span></span>](Remove-AzSqlSyncGroup.md)
<span data-ttu-id="56a9a-482">Azure SQL 데이터베이스 동기화 그룹을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-482">Removes an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="56a9a-483">제거-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="56a9a-483">Remove-AzSqlSyncMember</span></span>](Remove-AzSqlSyncMember.md)
<span data-ttu-id="56a9a-484">Azure SQL 데이터베이스 동기화 구성원을 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-484">Removes an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="56a9a-485">제거-AzSqlVirtualCluster</span><span class="sxs-lookup"><span data-stu-id="56a9a-485">Remove-AzSqlVirtualCluster</span></span>](Remove-AzSqlVirtualCluster.md)
<span data-ttu-id="56a9a-486">Azure SQL 가상 클러스터를 제거 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-486">Removes an Azure SQL Virtual Cluster.</span></span>

### [<span data-ttu-id="56a9a-487">Restore-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="56a9a-487">Restore-AzSqlDatabase</span></span>](Restore-AzSqlDatabase.md)
<span data-ttu-id="56a9a-488">SQL 데이터베이스를 복원 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-488">Restores a SQL database.</span></span>

### [<span data-ttu-id="56a9a-489">Restore-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="56a9a-489">Restore-AzSqlInstanceDatabase</span></span>](Restore-AzSqlInstanceDatabase.md)
<span data-ttu-id="56a9a-490">Azure SQL 관리 인스턴스 데이터베이스를 복원 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-490">Restores an Azure SQL Managed Instance database.</span></span>

### [<span data-ttu-id="56a9a-491">이력서-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="56a9a-491">Resume-AzSqlDatabase</span></span>](Resume-AzSqlDatabase.md)
<span data-ttu-id="56a9a-492">SQL Data Warehouse 데이터베이스를 다시 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-492">Resumes a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="56a9a-493">Set-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="56a9a-493">Set-AzSqlDatabase</span></span>](Set-AzSqlDatabase.md)
<span data-ttu-id="56a9a-494">데이터베이스의 속성을 설정 하거나 기존 데이터베이스를 탄력적인 풀로 이동 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-494">Sets properties for a database, or moves an existing database into an elastic pool.</span></span>

### [<span data-ttu-id="56a9a-495">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="56a9a-495">Set-AzSqlDatabaseAdvisorAutoExecuteStatus</span></span>](Set-AzSqlDatabaseAdvisorAutoExecuteStatus.md)
<span data-ttu-id="56a9a-496">Azure SQL 데이터베이스 관리자의 자동 실행 상태를 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-496">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="56a9a-497">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="56a9a-497">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="56a9a-498">Azure SQL 데이터베이스에 대 한 감사 설정을 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-498">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="56a9a-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="56a9a-500">서버 장기간 보존 정책을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-500">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="56a9a-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="56a9a-502">단기 백업 기간 보존 정책을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-502">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="56a9a-503">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-503">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="56a9a-504">데이터베이스에 대 한 데이터 마스킹을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-504">Sets data masking for a database.</span></span>

### [<span data-ttu-id="56a9a-505">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-505">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="56a9a-506">데이터베이스에 대 한 데이터 마스킹 규칙의 속성을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-506">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="56a9a-507">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-507">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="56a9a-508">Azure SQL Database 장애 조치 (Failover) 그룹의 구성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-508">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="56a9a-509">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-509">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="56a9a-510">데이터베이스 지역 백업 정책을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-510">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="56a9a-511">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-511">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="56a9a-512">인스턴스 장애 조치 (Failover) 그룹의 구성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-512">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="56a9a-513">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="56a9a-513">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="56a9a-514">Azure SQL 데이터베이스 권장 작업의 상태를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-514">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="56a9a-515">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="56a9a-515">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="56a9a-516">장애 조치를 시작 하기 위해 보조 데이터베이스를 기본으로 전환 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-516">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="56a9a-517">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="56a9a-517">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="56a9a-518">데이터베이스의 열에 대 한 정보 유형 및 민감도 레이블을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-518">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="56a9a-519">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="56a9a-519">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="56a9a-520">데이터베이스의 TDE 속성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-520">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="56a9a-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="56a9a-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="56a9a-522">취약점 평가 규칙 기준을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-522">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="56a9a-523">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="56a9a-523">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="56a9a-524">작업 업데이트</span><span class="sxs-lookup"><span data-stu-id="56a9a-524">Updates a job</span></span>

### [<span data-ttu-id="56a9a-525">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="56a9a-525">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="56a9a-526">탄력적 작업 에이전트 업데이트</span><span class="sxs-lookup"><span data-stu-id="56a9a-526">Updates an elastic job agent</span></span>

### [<span data-ttu-id="56a9a-527">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="56a9a-527">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="56a9a-528">작업 자격 증명 업데이트</span><span class="sxs-lookup"><span data-stu-id="56a9a-528">Updates a job credential</span></span>

### [<span data-ttu-id="56a9a-529">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="56a9a-529">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="56a9a-530">작업 단계 업데이트</span><span class="sxs-lookup"><span data-stu-id="56a9a-530">Updates a job step</span></span>

### [<span data-ttu-id="56a9a-531">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="56a9a-531">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="56a9a-532">Azure SQL 데이터베이스에서 탄력적 데이터베이스 풀의 속성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-532">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="56a9a-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="56a9a-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="56a9a-534">Azure SQL 탄력적인 풀 관리자의 자동 실행 상태를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-534">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="56a9a-535">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="56a9a-535">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="56a9a-536">Azure SQL 탄력적 풀 권장 작업의 상태를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-536">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="56a9a-537">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="56a9a-537">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="56a9a-538">Azure SQL 데이터베이스 관리 인스턴스의 속성을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-538">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="56a9a-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="56a9a-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="56a9a-540">SQL 관리 인스턴스에 대 한 Azure AD 관리자를 프로 비전 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-540">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="56a9a-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="56a9a-542">**Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet은 관리 데이터베이스의 장기 보존 정책을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-542">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="56a9a-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="56a9a-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="56a9a-544">단기 백업 기간 보존 정책을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-544">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="56a9a-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="56a9a-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="56a9a-546">Azure SQL 관리 인스턴스 데이터베이스의 열에 대 한 정보 유형 및 민감도 레이블을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-546">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="56a9a-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="56a9a-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="56a9a-548">취약점 평가 규칙 기준을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-548">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="56a9a-549">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="56a9a-549">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="56a9a-550">Azure SQL 인스턴스 풀에 대 한 속성을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-550">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="56a9a-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="56a9a-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="56a9a-552">SQL 관리 인스턴스에 대 한 TDE (투명 한 데이터 암호화) 보호기를 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-552">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="56a9a-553">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="56a9a-553">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="56a9a-554">SQL 데이터베이스 서버의 속성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-554">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="56a9a-555">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="56a9a-555">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="56a9a-556">SQL Server 용 Azure AD 관리자를 프로 비전 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-556">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="56a9a-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="56a9a-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="56a9a-558">Azure SQL Server Advisor의 자동 실행 상태를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-558">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="56a9a-559">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="56a9a-559">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="56a9a-560">Azure SQL server의 감사 설정을 변경 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-560">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="56a9a-561">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="56a9a-561">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="56a9a-562">데이터베이스 서버 복구 구성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-562">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="56a9a-563">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="56a9a-563">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="56a9a-564">Azure SQL Server DNS 별칭이 가리키는 서버를 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-564">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="56a9a-565">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-565">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="56a9a-566">Azure SQL 데이터베이스 서버의 방화벽 규칙을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-566">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="56a9a-567">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="56a9a-567">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="56a9a-568">Azure SQL Server 권장 작업의 상태를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-568">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="56a9a-569">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="56a9a-569">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="56a9a-570">SQL server에 대 한 TDE (투명 한 데이터 암호화) 보호기를 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-570">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="56a9a-571">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="56a9a-571">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="56a9a-572">Azure SQL Server 가상 네트워크 규칙의 구성을 수정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-572">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="56a9a-573">시작-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="56a9a-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="56a9a-574">추천 인덱스 작업을 실행 하는 워크플로를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-574">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="56a9a-575">시작-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="56a9a-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="56a9a-576">취약점 평가 검사를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-576">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="56a9a-577">시작-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="56a9a-577">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="56a9a-578">작업을 시작 하 고, 상태를 보기 위해 폴링할 수 있는 작업 실행 id를 반환 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-578">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="56a9a-579">시작-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="56a9a-579">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="56a9a-580">주어진 매개 변수를 사용 하 여 로그 재생 서비스를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-580">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="56a9a-581">시작-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="56a9a-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="56a9a-582">취약점 평가 검사를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="56a9a-583">시작-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="56a9a-583">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="56a9a-584">동기화 그룹 동기화를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-584">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="56a9a-585">중지-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="56a9a-585">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="56a9a-586">데이터베이스에서 비동기 업데이트 작업을 취소 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-586">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="56a9a-587">중지-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="56a9a-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="56a9a-588">추천 인덱스 작업을 실행 하는 워크플로를 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-588">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="56a9a-589">중지-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="56a9a-589">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="56a9a-590">작업 실행 id가 지정 된 작업을 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-590">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="56a9a-591">중지-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="56a9a-591">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="56a9a-592">탄력적 풀에서 비동기 업데이트 작업을 취소 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-592">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="56a9a-593">중지-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="56a9a-593">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="56a9a-594">데이터베이스를 삭제 하 여 로그 재생 서비스를 취소 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-594">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="56a9a-595">중지-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="56a9a-595">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="56a9a-596">SQL 관리 되는 인스턴스의 작업을 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-596">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="56a9a-597">중지-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="56a9a-597">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="56a9a-598">동기화 그룹 동기화를 중지 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-598">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="56a9a-599">일시 중단-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="56a9a-599">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="56a9a-600">SQL 데이터 웨어하우스 데이터베이스를 일시 중단 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-600">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="56a9a-601">스위치-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-601">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="56a9a-602">Azure SQL 데이터베이스 장애 조치 그룹의 장애 조치를 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-602">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="56a9a-603">스위치-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="56a9a-604">인스턴스 장애 조치 (Failover) 그룹의 장애 조치를 실행 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-604">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="56a9a-605">업데이트-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="56a9a-606">데이터베이스에 고급 위협 보호 설정을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-606">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="56a9a-607">업데이트-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="56a9a-608">데이터베이스의 취약점 평가 설정을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-608">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="56a9a-609">업데이트-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="56a9a-610">관리 데이터베이스의 취약점 평가 설정을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-610">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="56a9a-611">업데이트-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="56a9a-612">관리 되는 인스턴스의 취약점 평가 설정을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-612">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="56a9a-613">업데이트-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="56a9a-614">서버에서 고급 위협 방지 설정을 설정 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-614">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="56a9a-615">업데이트-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="56a9a-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="56a9a-616">서버의 취약점 평가 설정을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-616">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="56a9a-617">업데이트-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="56a9a-617">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="56a9a-618">Azure SQL 데이터베이스 동기화 그룹을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-618">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="56a9a-619">업데이트-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="56a9a-619">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="56a9a-620">Azure SQL 데이터베이스 동기화 구성원을 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-620">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="56a9a-621">업데이트-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="56a9a-621">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="56a9a-622">동기화 구성원 데이터베이스 또는 동기화 허브 데이터베이스의 동기화 스키마를 업데이트 합니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-622">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="56a9a-623">실제 데이터베이스에서 최신 데이터베이스 스키마를 가져온 다음이를 사용 하 여 동기화 메타 데이터 데이터베이스에서 캐시 된 스키마를 새로 고칩니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-623">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="56a9a-624">"SyncMemberName"를 지정 하면 구성원 데이터베이스 스키마가 새로 고쳐집니다. 그렇지 않은 경우에는 hub 데이터베이스 스키마를 새로 고칩니다.</span><span class="sxs-lookup"><span data-stu-id="56a9a-624">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
