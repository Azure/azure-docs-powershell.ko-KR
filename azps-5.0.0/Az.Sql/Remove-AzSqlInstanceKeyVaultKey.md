...
## 설명은
Remove-AzSqlInstanceKeyVaultKey cmdlet은 지정 된 관리 되는 인스턴스에서 키 자격 증명 모음 키를 제거 합니다. 키 보관소에 대 한 SQL 관리 인스턴스의 권한은 변경 되지 않습니다. 사용 권한을 변경 하려면 Set-AzKeyVaultAccessPolicy를 사용 합니다. 이 cmdlet은 키 자격 증명을 변경할 수 없습니다. 키 자격 증명 모음에서 키를 제거 하려면 AzureKeyVaultKey를 사용 합니다.
...
이 명령은 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 지정 된 관리 되는 인스턴스에서 Id가 ' ' 인 키 보관소 키를 제거 합니다. 
