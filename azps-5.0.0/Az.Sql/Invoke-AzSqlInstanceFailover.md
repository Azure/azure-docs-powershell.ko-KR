...
## 설명은
**AzSqlInstanceFailover** Cmdlet은 Azure SQL 관리 인스턴스를 장애 조치 합니다.
...
이 명령은 "ManagedInstance01" 인스턴스의 주 복제본에 대 한 장애 조치를 합니다.
...
이 명령은 관리 되는 인스턴스 "ManagedInstance01"의 읽을 수 있는 보조 복제본의 장애 조치를 합니다.
