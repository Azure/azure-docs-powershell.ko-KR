...
## 설명은
Get-AzSqlElasticJobTargetExecution cmdlet은 작업 실행에서 하나 이상의 작업 대상 실행을 가져옵니다.

## 예제의

### 예제 1: 작업 실행에서 하나 이상의 작업 대상 실행을 가져옵니다.
```powershell
...
### 예제 2: 작업 실행에서 하나 이상의 작업 대상 실행을 가져옵니다.-단계별 이름 필터링
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
