...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (기본값)
```
...
## 설명은
Stop-AzSqlInstanceOperation cmdlet은 SQL 관리 인스턴스에서 제공 된 작업 이름을 사용 하 여 작업을 중지 합니다.
...
이 명령은 SQL 관리 인스턴스에서 이름이 ' d0f5bef5-e2b1-4ef8-bb42-2e54073874f9 ' 인 작업을 중지 합니다.
...
이 명령은 리소스 id $managedInstanceOperation. i a i d에 대 한 작업을 중지 합니다.
...
이 명령은 $managedInstanceOperation 개체를 사용 하 여 작업을 중지 합니다.
