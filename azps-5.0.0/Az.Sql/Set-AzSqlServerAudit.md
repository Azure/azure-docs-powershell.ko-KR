...
### 예제 10: Azure SQL server의 감사 레코드를 blob 저장소로 보내는 기능을 사용 하지 않도록 설정 하 고 로그 분석으로 보내는 기능을 사용 하도록 설정 합니다.
```powershell
...
### 예제 11: Azure SQL server의 감사 레코드를 blob 저장소, 이벤트 허브 및 로그 분석으로 보내는 기능을 사용 하도록 설정 합니다.
```powershell
