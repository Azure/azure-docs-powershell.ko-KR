...
## 설명은
Disable-AzSqlDatabaseSensitivityRecommendation cmdlet에서는 데이터베이스의 열에 대 한 민감도 추천을 사용 하지 않도록 설정 합니다.

## 예제의

### 예제 1: Azure SQL 데이터베이스에서 지정 된 열에 대해 우편물 종류 추천을 사용 하지 않도록 설정 합니다.
```powershell
...
### 예제 2: 파이핑을 사용 하는 Azure SQL 데이터베이스에 민감도 추천이 있는 열에 대해 우편물 종류 추천을 사용 하지 않도록 설정 합니다.
```powershell
...
### 예제 3: 파이핑을 사용 하 여 Azure SQL 데이터베이스의 지정 된 열에 대해 민감도 추천을 사용 하지 않도록 설정 합니다.
```powershell
