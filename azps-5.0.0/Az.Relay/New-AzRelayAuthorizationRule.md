...
## 설명은
**AzRelayAuthorizationRule** cmdlet은 지정 된 릴레이 엔터티 (Namespace/WcfRelay/HybridConnection)에 대 한 새 권한 부여 규칙을 만듭니다.
...
`AuthoRule1`하이브리드 연결에 대 한 **듣기** 권한을 사용 하 여 만듭니다 `TestHybridConnection` .
