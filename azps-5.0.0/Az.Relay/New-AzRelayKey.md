...
## 설명은
**AzRelayKey** cmdlet은 지정 된 릴레이 엔터티 (Namespace/WcfRelay/HybridConnection)에 대 한 기본 및 보조 연결 문자열을 생성 합니다.
...
지정 된 Relay-Namespace 엔터티에 대 한 기본 또는 보조 연결 문자열을 다시 생성 합니다.

### 예제 1.1-네임 스페이스 KeyValue 제공
```
...
키 값을 제공 하 여 지정 된 Relay-Namespace 엔터티에 대 한 기본 또는 보조 연결 문자열을 생성 합니다.
...
지정 된 Relay-WcfRelay 엔터티에 대 한 기본 또는 보조 연결 문자열을 다시 생성 합니다.

### 예제 2.1-WcfRelay KeyValue 제공 됨
```
...
키 값을 제공 하 여 지정 된 Relay-WcfRelay 엔터티에 대 한 기본 또는 보조 연결 문자열을 생성 합니다.
...
### 예제 3.1-HybridConnection KeyValue 제공 됨
```
...
키 값을 제공 하 여 지정 된 Relay-HybridConnection 엔터티에 대 한 기본 또는 보조 연결 문자열을 생성 합니다.
...
### PSAuthorizationRuleKeysAttributes에 대 한 자세한
