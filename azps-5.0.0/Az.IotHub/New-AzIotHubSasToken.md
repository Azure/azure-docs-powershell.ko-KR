...
## 설명은
장치 SAS 토큰의 경우 정책 매개 변수는 장치 레지스트리에만 액세스 하는 데 사용 됩니다. 따라서 정책에는 레지스트리에 대 한 읽기 권한이 있어야 합니다.
IoT Hub 토큰의 경우 정책은 SA의 일부입니다.
...
Iothubowner 정책을 사용 하 여 {iothub_name} 장치 레지스트리에 액세스 하는 디바이스 SAS 토큰을 생성 합니다.
...
Iothubowner 정책을 사용 하 여 {iothub_name} 장치 레지스트리에 액세스 하는 모듈 SAS 토큰을 생성 합니다.
