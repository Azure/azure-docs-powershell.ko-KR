...
## SYNOPSIS
인지 서비스 계정 ApiProperties의 새 인스턴스를 생성 합니다.
...
## 설명은
인지 서비스 계정 ApiProperties의 새 인스턴스를 생성 합니다.
ApiProperties를 사용 하 여 새 계정을 만들거나 기존 계정을 업데이트할 수 있습니다.
ApiProperties은 특정 계정 유형에 필요 합니다.
...
위의 예에서는 API 속성 "QnaRuntimeEndpoint"을 사용 하 여 QnAMaker 계정을 만듭니다.
...
### CognitiveServices. CognitiveServicesAccountApiProperties/.
