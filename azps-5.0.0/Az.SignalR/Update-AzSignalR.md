...
### -AllowedOrigin
SignalR 서비스에 대해 허용 된 원본입니다. 모두 허용 하려면 "*"를 사용 하 여 목록에서 다른 모든 원본을 제거 합니다. 슬래시는 도메인의 일부로 또는 TLD 이후 허용 되지 않습니다.
...
### -단위 개수
SignalR 서비스 단위 개수, {1, 2, 5, 10, 20, 50, 100}의 값입니다.
기본값은 1입니다.
