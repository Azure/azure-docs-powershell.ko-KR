...
## 설명은
**AzDataShareTrigger** cmdlet은 datashare 트리거를 제거 합니다.
...
이 명령은 공유 구독 AdsShareSubscription에서 AdsTrigger 이라는 트리거를 제거 합니다. 
