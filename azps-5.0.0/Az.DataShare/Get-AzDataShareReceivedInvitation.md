...
## 설명은
**AzDataShareReceivedInvitation** cmdlet은 소비자가 receieved 하는 모든 초대에 대 한 정보를 제공 합니다. 위치 또는 초대 id를 제공 하는 경우이 cmdlet은 특정 위치의 초대 또는 초대 id를 포함 하는 방법에 대 한 정보를 제공 합니다. 그렇지 않으면 소비자에 게 전송 되는 초대 목록을 제공 합니다.
...
이 commant는 소비자 초대에 대 한 정보를 제공 합니다.
