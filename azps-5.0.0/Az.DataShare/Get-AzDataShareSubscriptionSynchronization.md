...
## 설명은
**AzDataShareSubscriptionSynchronization** cmdlet은 소비자의 데이터 공유 계정에서 공유 구독의 모든 동기화 실행에 대 한 informaiton을 제공 합니다.
...
이 명령은 data share 계정 WikiAds에서 공유 구독 AdsShareSubscription에 대 한 모든 동기화 실행에 대 한 정보를 제공 합니다.
