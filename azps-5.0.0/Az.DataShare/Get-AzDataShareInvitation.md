...
## 설명은
**AzDataShareInvitation** cmdlet은 데이터 공유에 추가 된 초대에 대 한 정보를 가져옵니다. 초대의 이름을 지정 하는 경우이 cmdlet은 초대에 대 한 정보를 가져옵니다. 이름을 지정 하지 않으면이 cmdlet은 공유의 모든 초대에 대 한 정보를 가져옵니다.
...
이 명령은 adsinvitation 공유에 제공 되는 초대에 대 한 정보를 제공 합니다.
...
### -ResourceId
Azure data share 초대의 리소스 id입니다.
