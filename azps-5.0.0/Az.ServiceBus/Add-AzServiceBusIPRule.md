...
```
Name: 기본 DefaultAction: 허용 Id:/subscriptions/SubscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.ServiceBus/namespaces/ServiceBus-Namespace-2389/networkRuleSets/default Type: Microsoft ServiceBus/네임 스페이스/네트워크 규칙 집합 IpRules: {11.22.33.44, Allow} VirtualNetworkRules: 

IpMask "11.22.33.44"를 사용 하 여 IPRule를 추가 하 고 해당 네임 스페이스 값 허용 작업을 수행 합니다.
...
### ServiceBus. PSNWRuleSetIpRulesAttributes/.
