...
## SYNOPSIS
항목의 지정 된 구독에서 기존 규칙의 정의를 검색 합니다. 
...
## 설명은
**AzServiceBusRule** cmdlet은 항목의 지정 된 구독에서 지정 된 규칙에 대 한 설명을 가져옵니다.
...
지정 된 구독에 대해 지정 된 규칙 설명을 반환 합니다.
...
지정 된 구독에 대 한 규칙 설명 목록을 반환 합니다.  기본적으로 100 규칙이 반환 되 고, 반환 되는 100 규칙이 더 있으면-MaxCount 매개 변수를 사용 하세요.
...
지정 된 구독에 대 한 첫 번째 150 규칙 설명의 목록을 반환 합니다.
