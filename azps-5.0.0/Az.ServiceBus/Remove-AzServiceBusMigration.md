...
## 설명은
AzServiceBusMigration cmdlet은 표준에서 Premium 네임 스페이스에 대 한 마이그레이션 구성을 삭제 **함**
...
' TestingNamespaceStandardMigration ' 마이그레이션 구성을 삭제 합니다.
...
### -InputObject
Service Bus 마이그레이션 표준 네임 스페이스 개체
...
### -ResourceId
Service Bus 마이그레이션 표준 네임 스페이스 리소스 Id
