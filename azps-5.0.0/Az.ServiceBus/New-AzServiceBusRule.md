...
## 설명은
**AzServiceBusRule** cmdlet은 지정 된 구독에 대 한 새 규칙을 만듭니다.
...
New-AzServiceBusRule cmdlet은 지정 된 구독에 대 한 새 규칙을 만듭니다.
...
New-AzServiceBusRule cmdlet은 ActionFilter를 사용 하 여 지정 된 구독에 대 한 새 규칙을 만듭니다.
