...
### 예제 1: 이름으로 PostgreSql 서버 가상 네트워크 규칙 제거
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

이 cmdlet은 이름으로 PostgreSql 서버 가상 네트워크 규칙을 제거 합니다.

### 예제 2: id를 기준으로 PostgreSql 서버 가상 네트워크 규칙 제거
```powershell
...
이러한 cmdlet은 id를 기준으로 PostgreSql 서버 가상 네트워크 규칙을 제거 합니다.
