...
## 설명은
New-AzSqlVM cmdlet은 Azure SQL 가상 컴퓨터를 만듭니다.
...
리소스 그룹 ResourceGroup01의 이름 vm을 사용 하 여 새 Azure SQL 가상 컴퓨터를 만듭니다. 
...
### -Sku
SQL virtual machine edition 유형입니다.
