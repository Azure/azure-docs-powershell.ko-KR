...
이 cmdlet은 이름으로 MySql 구성을 업데이트 합니다.

### 예제 2: id를 기준으로 MySql 구성을 업데이트 합니다.
```powershell
...
이러한 cmdlet은 id를 기준으로 MySql 구성을 업데이트 합니다.
...
INPUTOBJECT <IMySqlIdentity> : Identity 매개 변수입니다.
