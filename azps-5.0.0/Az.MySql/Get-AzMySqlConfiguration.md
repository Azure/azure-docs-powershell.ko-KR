...
이 cmdlet은 지정 된 MySql 서버의 모든 구성을 나열 합니다.

### 예제 2: 이름별로 지정 된 MySql 구성 가져오기
```powershell
...
이 cmdlet은 이름을 기준으로 지정 된 MySql 구성을 가져옵니다.
...
### Api20171201. IConfiguration에 대 한 Microsoft.
