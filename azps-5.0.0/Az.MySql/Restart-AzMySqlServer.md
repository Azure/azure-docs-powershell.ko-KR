...
### 예제 1: 리소스 그룹 및 서버 이름으로 MySql 서버 다시 시작
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

이 cmdlet은 리소스 그룹 및 서버 이름에 따라 MySql 서버를 다시 시작 합니다.

### 예제 2: id를 기준으로 MySql 서버 다시 시작
```powershell
...
이러한 cmdlet은 id를 기준으로 MySql 서버를 다시 시작 합니다.
