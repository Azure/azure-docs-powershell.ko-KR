...
이 명령은 구독 하는 동안 SAP 모니터를 가져옵니다.

### 예제 2: 이름으로 SAP 모니터 가져오기
```powershell
...
이 명령은 이름으로 SAP 모니터를 가져옵니다.

### 예제 3: 개체 별로 SAP 모니터 가져오기
```powershell
...
이 명령은 SAP 모니터를 개체 별로 가져옵니다.

### 예제 4: 파이프라인을 기준으로 SAP 모니터 가져오기
```powershell
...
이 명령은 파이프라인을 기준으로 SAP 모니터를 가져옵니다.
