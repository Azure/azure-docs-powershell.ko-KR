...
가격이 계산 된 후, 고객은 RI가 calculatePrice 제공 하는 것을 purcahse 수 있습니다.
...
### -ReservationOrderId
구매할 예약 순서에 대 한 Id, az 예약 예약 주문 계산에서 생성 됩니다.
...
### ReservationOrderResponse를 통해 관리 합니다.
