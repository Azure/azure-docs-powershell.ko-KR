...
## 설명은
New-AzCdnOriginGroup에서는 지정 된 끝점 내에 새 원본 그룹을 만듭니다. 끝점의 첫 번째 원본 그룹인 경우 DefaultOriginGroup 속성도 설정 해야 합니다.
...
```
이 cmdlet은 지정 된 끝점 내에 새 근원 그룹을 만듭니다. 지정 된 출처 id를 원본 집합으로 사용 합니다.
