...
### -InputObject
테스트 마이그레이션을 시작 해야 하는 복제 서버를 지정 합니다.
...
### -TestNetworkID
테스트 마이그레이션에 사용할 대상 Azure 구독 내의 가상 네트워크 id를 업데이트 합니다.
...
INPUTOBJECT <IMigrationItem> : 테스트 마이그레이션을 시작 해야 하는 복제 서버를 지정 합니다. 서버 개체는 Get-AzMigrateServerReplication cmdlet을 사용 하 여 검색할 수 있습니다.
