...
### -TargetObjectID
Replicatio을 사용 하지 않도록 설정 해야 하는 replcating 서버를 지정 합니다.
...
INPUTOBJECT <IMigrationItem> : 복제 서버의 컴퓨터 개체를 지정 합니다.
