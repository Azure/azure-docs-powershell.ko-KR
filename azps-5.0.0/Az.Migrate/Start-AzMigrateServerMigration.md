...
### -InputObject
마이그레이션을 시작 해야 하는 복제 서버를 지정 합니다.
...
### -TargetObjectID
마이그레이션을 시작 해야 하는 replcating 서버를 지정 합니다.
...
### -TurnOffSourceServer
원본 서버에서 마이그레이션 후 해제 해야 하는지 여부를 지정 합니다.
...
INPUTOBJECT <IMigrationItem> : 마이그레이션을 시작 해야 하는 복제 서버를 지정 합니다. 서버 개체는 Get-AzMigrateServerReplication cmdlet을 사용 하 여 검색할 수 있습니다.
