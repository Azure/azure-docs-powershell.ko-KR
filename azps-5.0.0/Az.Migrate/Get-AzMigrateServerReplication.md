...
### 예제 2: id를 기준으로 project의 모든 목록 나열
```powershell
...
### -ProjectName
현재 구독에서 Azure 마이그레이션 프로젝트를 지정 합니다.
...
### Api20180110 IMigrationItem (Microsoft. PowerShell.)
