...
## 설명은
**AzDtlAutoStartPolicy** cmdlet은 랩의 자동 시작 정책을 설정 하 여 랩 가상 컴퓨터에 자동 시작을 예약할 수 있도록 합니다.
...
DevTest 랩에서 랩에서 자동 시작 정책을 설정 합니다. 생성
...
### 일
랩의 가상 컴퓨터를 시작 해야 하는 경우의 요일을 배열로 지정 합니다.
...
### -Disable
이 cmdlet이 랩에서 가상 컴퓨터에 대 한 정책을 사용 하지 않도록 지정 합니다.
...
### -사용
이 cmdlet이 랩에서 가상 컴퓨터에 대 한 정책을 사용할 수 있도록 지정 합니다.
...
### -시 이름
이 cmdlet이 자동 시작 정책을 설정 하는 랩의 이름을 지정 합니다.
...
### 타임
랩의 가상 컴퓨터를 시작 해야 하는 시간을 지정 합니다.
