...
## 설명은
**AzStackEdgeRole** Cmdlet은 스택 경계 장치에 대 한 IoT 역할을 업데이트 합니다. 이전에 탑재 된 공유가 ShareName 매개 변수에서 새로 제공 된 공유로 대체 됩니다.
...
공유 이름으로 이전에 탑재 된 공유를 새로 제공 된 것으로 바꿉니다.
...
### StackEdge. PSStackEdgeRole에 대 한 Microsoft PowerShell
