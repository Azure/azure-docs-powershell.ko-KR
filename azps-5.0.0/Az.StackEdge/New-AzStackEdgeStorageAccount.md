...
## 설명은
**AzStackEdgeStorageAccount** Cmdlet은 스택 경계 장치에서 새 Edge 저장소 계정을 만듭니다. 장치의 경우 한 Edge 저장소 계정을 최대 하나의 클라우드 저장소 계정에만 매핑할 수 있습니다.
...
2 EdgeStorageAccounts 장치에서 1 개 이상의 클라우드 저장소 계정을 공유할 수 없습니다.
...
### -클라우드
은 (는) tiering Storageaccount를 사용 합니다.
