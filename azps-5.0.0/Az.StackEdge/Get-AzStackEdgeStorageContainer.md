...
## 설명은
**AzStackEdgeStorageContainer** Cmdlet은 스택 경계 디바이스의 edge 저장소 계정에 대 한 저장소 컨테이너를 가져옵니다. Cmdlet에서 이름을 매개 변수로 지정 하 여 특정 저장소 컨테이너의 세부 정보를 가져올 수 있습니다. 
...
### StackEdge. PSStackEdgeStorageAccount에 대 한 Microsoft PowerShell

## 출력

### StackEdge. PSStackEdgeStorageContainer에 대 한 Microsoft PowerShell
