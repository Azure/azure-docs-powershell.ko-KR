...
## 설명은
Get-AzAutomationSourceControlSyncJob cmdlet은 Azure Automation 소스 제어 동기화 작업을 가져옵니다. 특정 소스 제어 동기화 작업을 가져오려면 해당 id를 지정 합니다.

## 예제의

### 예제 1
이 명령은 소스 제어 VSTSNative에 대 한 모든 자동화 소스 제어 동기화 작업을 가져옵니다.
...
### 예제 2
이 명령은 원본 컨트롤 VSTSNative에 대 한 id 08d6d266-27b6-463c-beea-bc48a67ace15를 사용 하 여 소스 제어 동기화 작업을 가져옵니다. 
...
Azure Automation 소스 제어 동기화 작업을 가져옵니다. 생성
...
### SourceControlSyncJob를 통해 서.

### SourceControlSyncJobRecord를 통해 서.
