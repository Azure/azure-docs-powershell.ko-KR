...
### -컨소시엄
Blockchain 구성원에 대 한 컨소시엄을 가져오거나 설정 합니다.
...
### -FirewallRule
생성할 방화벽 규칙을 가져오거나 설정 하 고, FIREWALLRULE 속성에 대 한 참고 섹션을 참조 하 고, 해시 테이블을 만듭니다.
...
### -암호
Blockchain 구성원의 기본 인증 암호를 설정 합니다.
