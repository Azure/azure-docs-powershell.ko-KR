...
이 명령은 리소스 이름을 사용할 수 있는지 여부를 확인 합니다.

### 예제 2: 리소스 이름을 사용할 수 있는지 확인
```powershell
...
### Api20180601Preview를 사용 하는 경우의. PowerShell.
