...
대시보드의 태그를 업데이트 합니다.
태그는 인라인 hashtable로 표현 됩니다.

### 예제 2: 파이프라인을 사용 하 여 대시보드 태그 업데이트
```powershell
...
AzPortalDashboard를 사용 하 여 다시 시도 된 대시보드의 태그를 업데이트 합니다.
이를 사용 하 여 단일 대시보드 또는 여러 일점 dashboard fs를 통해 태그를 업데이트할 수 있습니다.
