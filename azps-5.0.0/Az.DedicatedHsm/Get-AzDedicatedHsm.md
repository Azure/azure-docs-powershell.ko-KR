...
이 명령은 구독에서 모든 전용 HSM을 가져옵니다.

### 예제 2: 리소스 그룹에 있는 모든 전용 HSM 가져오기
```powershell
...
이 명령은 리소스 그룹에 있는 모든 전용 HSM을 가져옵니다.

### 예제 3: 이름으로 전용 HSM 가져오기
```powershell
...
이 명령은 이름으로 전용 HSM을 가져옵니다.

### 예제 4: 개체 별로 전용 HSM 가져오기
```powershell
