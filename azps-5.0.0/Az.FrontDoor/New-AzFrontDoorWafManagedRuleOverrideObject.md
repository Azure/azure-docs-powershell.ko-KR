...
## 설명은
관리 WAF 규칙 그룹에 대해 PSAzureManagedRuleOverride 개체 만들기 개체 생성을 재정의 합니다.

## 예제의

### 예제 1
규칙 942250 (SQLI 그룹에 있음)에 대 한 관리 규칙 재정의 개체를 만듭니다.
...
### FrontDoor를 통해 PSAzureManagedRuleOverride
