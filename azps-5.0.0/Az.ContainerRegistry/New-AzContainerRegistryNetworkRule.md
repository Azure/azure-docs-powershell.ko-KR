...
## 설명은
현재 powershell 세션에서 네트워크 규칙 개체를 만듭니다.
...
서브넷의 리소스 ID (예:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.)
...
### -VirtualNetworkRule
VirtualNetworkRule를 만들도록 표시 합니다.
...
### ContainerRegistry. a s m a 네트워크 규칙
