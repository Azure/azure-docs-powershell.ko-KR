...
## 설명은
**AzConsumptionMarketplace** cmdlet은 구독의 마켓플레이스를 가져옵니다.
...
### 예제 2: 날짜 범위를 사용 하 여 마켓플레이스 사용법 가져오기
```powershell
...
### 예제 3: BillingPeriodName의 마켓플레이스 사용법 가져오기
```powershell
...
### 예제 4: InstanceName 필터를 사용 하 여 마켓플레이스 사용 가져오기
```powershell
...
### -BillingPeriodName
연결 하는 마켓플레이스를 받을 특정 청구 기간의 이름입니다.
...
### Microsoft. i. m a. 모델. PSMarketplace
