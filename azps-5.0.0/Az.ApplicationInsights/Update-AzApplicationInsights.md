...
### 예제 1 업데이트 application insights 구성 요소
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

application insights 구성 요소 업데이트 "aiName" PublicNetworkAccessForIngestion/Publicnetworkaccessforingestion를 "사용 안 함"으로 설정 합니다.
...
Application Insights 수집에 액세스 하는 데 사용 되는 네트워크 액세스 형식입니다.
값은 ' Enabled ' 또는 ' Disabled ' 여야 합니다.
...
Application Insights 쿼리에 액세스 하는 데 사용할 네트워크 액세스 형식입니다.
값은 ' Enabled ' 또는 ' Disabled ' 여야 합니다.
