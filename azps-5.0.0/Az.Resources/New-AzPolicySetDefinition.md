...
## 설명은
**새 AzPolicySetDefinition** cmdlet은 정책 집합 정의를 만듭니다.

## 예제의

### 예제 1: 정책 집합 파일을 사용 하 여 메타 데이터를 사용 하 여 정책 집합 정의 만들기
```
[
   {
...
이 명령은 해당 범주를 나타내는 메타 데이터가 있는 VMPolicySetDefinition 이라는 정책 집합 정의를 C:\VMPolicy.js에 지정 된 정책 정의를 포함 하는 "가상 컴퓨터"로 만듭니다. VMPolicy.js의 예제 콘텐츠는 위에 나와 있습니다.
...
이 명령은 C:\VMPolicy.js에 지정 된 정책 정의를 포함 하는 VMPolicySetDefinition 이라는 매개 변수가 있는 정책 집합 정의를 만듭니다. VMPolicy.js의 예제 콘텐츠는 위에 나와 있습니다.

### 예제 3: 정책 정의 그룹을 사용 하 여 정책 집합 정의 만들기
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
이 명령은 C:\VMPolicy.js에 지정 된 정책 정의를 그룹화 하 여 VMPolicySetDefinition 이라는 정책 집합 정의를 만듭니다. VMPolicy.js의 예제 콘텐츠는 위에 나와 있습니다.
...
### -GroupDefinition
새 정책 집합 정의에 대 한 정책 정의 그룹입니다. 그룹을 포함 하는 파일의 경로 이거나 그룹을 JSON 문자열로 지정할 수 있습니다.
...
### -Metadata
정책 집합 정의에 대 한 메타 데이터입니다. 메타 데이터를 포함 하는 파일 이름의 경로 이거나 메타 데이터를 JSON 문자열로 지정할 수 있습니다.
...
매개 변수 선언이 포함 된 파일 이름의 경로 이거나 매개 변수 선언이 JSON 문자열 일 수 있습니다.
