...
## 설명은
특정 템플릿 사양 버전을 로컬 파일 시스템으로 내보냅니다.
...
리소스 그룹 ' myRG ' 내에서 이름이 ' MyTemplateSpec ' 인 템플릿 사양의 ' v 1.0 ' 버전을 로컬 출력 폴더 "v1"으로 내보냅니다.

### 예제 2: 리소스 id를 기준으로 내보내기
```powershell
...
구독 하위 id의 ' myRG ' 리소스 그룹에 있는 ' MyTemplateSpec ' 템플릿 사양의 ' v 1.0 ' 버전 \{ \} 을 로컬 출력 폴더 "v1"으로 내보냅니다.
