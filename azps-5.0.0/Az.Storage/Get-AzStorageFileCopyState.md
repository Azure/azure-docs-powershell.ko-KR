...
### 예제 2: 복사 및 파이프라인을 시작 하 여 복사 상태 가져오기
```
...
첫 번째 명령은 "contosofile" 파일을 "contosofile_copy"으로 복사 하 고 destiantion file 개체를 출력 합니다. 두 번째 명령 파이프라인은 destiantion file 개체를 AzStorageFileCopyState 하 여 파일 복사 상태를 가져옵니다.
