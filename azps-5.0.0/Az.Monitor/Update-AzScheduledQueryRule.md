...
## 설명은
로그 경고 규칙을 업데이트 하 고,이 명령에서는 "Enabled" 속성만 업데이트 합니다.
다른 속성을 업데이트 하려면 [Set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) 명령을 참조 하세요.
