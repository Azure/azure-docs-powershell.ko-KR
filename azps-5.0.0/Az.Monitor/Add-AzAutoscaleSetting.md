...
## 설명은
**AzAutoscaleSetting** Cmdlet은 자동 크기 조정 설정을 만듭니다.
...
처음 두 명령은 [AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) 를 사용 하 여 두 개의 자동 크기 조정 규칙 (1 $Rule $Rule 2)을 만듭니다.
세 번째와 네 번째 명령은 [AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) 를 사용 하 여 크기 자동 조정 프로필 ($Profile 1 및 $Profile 2)을 $Rule 1 및 $Rule 2를 사용 하 여 만듭니다.
...
### System.webserver. List ' 1 [[AutoscaleProfile, Microsoft azure.. t e l. i = 1.0.0.0, Culture = 중립, PublicKeyToken = null]] 목록입니다.

### System.webserver. List ' 1 [[AutoscaleNotification, Microsoft azure.. t e l. i = 1.0.0.0, Culture = 중립, PublicKeyToken = null]] 목록입니다.
