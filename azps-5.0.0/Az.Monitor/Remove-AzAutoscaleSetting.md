...
## 설명은
**AzAutoscaleSetting** Cmdlet은 자동 크기 조정 설정을 제거 합니다.
설정의 이름과이를 할당 받은 리소스 그룹의 이름을 지정 해야 합니다.
