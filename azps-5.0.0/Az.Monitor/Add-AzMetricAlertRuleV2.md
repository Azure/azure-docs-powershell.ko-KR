...
이 명령은 가상 컴퓨터에 대 한 메트릭 알림 규칙을 만듭니다. $condition는 [AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria) cmdlet의 출력이 며 $Act는 [새 AzActionGroup](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azactiongroup) cmdlet의 출력입니다.
...
이 명령은 메트릭 알림 규칙을 사용 하지 않도록 설정 합니다. 여기서는 [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) 에 대 한 [AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmetricalertrulev2) 파이프 출력을 제공 합니다. 
