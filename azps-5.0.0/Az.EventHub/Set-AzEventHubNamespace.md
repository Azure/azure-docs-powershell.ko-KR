...
## 설명은
Set-AzEventHubNamespace cmdlet은 지정 된 이벤트 허브 네임 스페이스의 속성을 업데이트 합니다.
...
네임 스페이스 MyNamespaceName의 태그 \` \` 를 생성으로 업데이트 합니다.
...
### 시스템 Null 허용 ' 1 [[NamespaceState, [Microsoft Azure. 1.4.3.0., Microsoft Azure. PowerShell, Version =, Culture = 중립, PublicKeyToken = null]]
