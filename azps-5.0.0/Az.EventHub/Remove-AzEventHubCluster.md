...
## 설명은
Remove-AzEventHubCluster cmdlet은 지정 된 resourcegroup에서 지정 된 전용 eventhub 클러스터 이름을 삭제 합니다.
...
Eventhub-클러스터-5557 클러스터를 RSG-Cluster27651 resourcegroup에서 삭제 합니다.
