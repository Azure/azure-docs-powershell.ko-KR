...
## 설명은
이 cmdlet은 지정 된 리소스 그룹 및 클러스터의 응용 프로그램 세부 정보를 가져옵니다.
...
이 예제에서는 "testApp" 응용 프로그램에 대 한 응용 프로그램 리소스 세부 정보를 가져옵니다.
...
이 예제에서는 "testCluster" 클러스터 아래에 있는 응용 프로그램의 목록을 가져옵니다.
