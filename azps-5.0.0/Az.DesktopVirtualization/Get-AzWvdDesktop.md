...
### 예제 1: 이름별로 Windows 가상 데스크톱 데스크톱 가져오기
```powershell
...
이 명령은 applicaton 그룹의 Windows 가상 데스크톱 데스크톱을 가져옵니다.

### 예제 2: Windows 가상 데스크톱 데스크톱 나열
```powershell
...
이 명령은 applicaton 그룹의 가상 데스크톱 데스크톱을 listsWindows 합니다.
...
### Microsoft Api20191210Preview. i i m. IDesktop

### Api20191210Preview. IDesktopList에 대 한 Microsoft Azure.
