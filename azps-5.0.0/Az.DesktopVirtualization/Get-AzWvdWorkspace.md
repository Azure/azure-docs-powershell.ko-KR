...
### 예제 1: 이름으로 Windows 가상 데스크톱 Worksapce 가져오기
```powershell
...
이 명령은 리소스 그룹의 Windows 가상 데스크톱 작업 영역을 가져옵니다.

### 예제 2: Windows 가상 데스크톱 작업 영역 나열
```powershell
...
이 명령은 리소스 그룹에 Windows 가상 데스크톱 작업 영역을 나열 합니다.
