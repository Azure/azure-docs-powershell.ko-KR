...
### 예제 1: 이름으로 Windows 가상 데스크톱 호스트 풀 만들기
```powershell
...
이 명령은 리소스 그룹에 Windows 가상 데스크톱 호스트 풀을 만듭니다.
...
HostPool의 PersonalDesktopAssignment 유형입니다.
...
기본 응용 프로그램 그룹 종류, 데스크톱 응용 프로그램 그룹의 기본값
...
### -SsoContext
SsoContext 비밀을 포함 하는 keyvault 경로입니다.
...
### -VMTemplate
Hostpool의 sessionhosts 구성에 대 한 VM 템플릿입니다.
...
### Api20191210Preview. IHostPool에 대 한 Microsoft Azure.
