...
### 예제 1: databricks에서 모든 vnet 피어 링 나열
```powershell
...
이 명령은 databricks에 있는 모든 vnet 피어 링을 나열 합니다.
...
이 명령은 vnet 피어 링을 가져옵니다.

### 예제 3: 개체에의 한 vnet 피어 링 가져오기
```powershell
