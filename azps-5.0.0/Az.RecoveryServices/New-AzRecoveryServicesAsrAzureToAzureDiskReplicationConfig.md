...
복제할 Azure virtual machine 디스크에 대 한 디스크 매핑 개체를 만듭니다. Azure에서 Azure로 Dr 및 다시 보호 작업 중에 사용 됩니다.
...
복제할 Azure virtual machine 디스크에 대 한 관리 되는 디스크 매핑 개체를 만듭니다. Azure에서 Azure로 Dr 및 다시 보호 작업 중에 사용 됩니다.
...
복제할 Azure virtual machine 디스크에 대 한 패스 암호화 설정이 하나인 관리 되는 디스크 매핑 개체를 만듭니다. Azure에서 Azure로 Dr 및 다시 보호 작업 중에 사용 됩니다.
...
대상 디스크 암호화 집합 Id가 포함 된 관리 되는 디스크 매핑 개체를 만들어 복제 될 Azure 가상 머신 디스크에 대해 지정 합니다. Azure에서 Azure로 Dr 및 다시 보호 작업 중에 사용 됩니다.
...
### -Recoverydiska Setid
복구 디스크에 사용할 Azure 디스크 암호화 집합의 ID를 지정 합니다.
...
### -Tdiskname
테스트 장애 조치 (failover) 중에 만든 디스크의 이름을 지정 합니다.
