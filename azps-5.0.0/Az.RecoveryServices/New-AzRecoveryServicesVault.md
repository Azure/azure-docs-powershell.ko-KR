...
## 설명은
**AzRecoveryServicesVault** cmdlet은 새 복구 서비스 자격 증명 모음을 만듭니다.
...
리소스 그룹 및 지정 된 위치에 복구 서비스 자격 증명 모음을 만듭니다.
...
복구 서비스 자격 증명 모음에 추가할 태그를 지정 합니다.
