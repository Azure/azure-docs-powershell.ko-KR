...
## 설명은
**AzDataBoxEdgeStorageAccountCredential** Cmdlet은 데이터 상자 가장자리 디바이스의 해당 저장소 계정에 대 한 저장소 계정 자격 증명을 가져옵니다. 특정 저장소 계정 자격 증명에 대 한 정보를 얻기 위해 이름, 리소스 그룹 이름 및 디바이스 이름 매개 변수를 지정할 수 있습니다.
