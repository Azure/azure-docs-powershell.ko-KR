...
이름에 따라 스프링 클라우드 배포를 업데이트 합니다.

### 예제 2: 파이프에서 스프링 클라우드 배포 업데이트
```powershell
...
### -SourceArtifactSelector
다중 모듈 프로젝트의 배포에 사용 되는 아티팩트의 선택기입니다.
이는 대상 모듈/프로젝트에 대 한 상대 경로를 지켜야 합니다.
