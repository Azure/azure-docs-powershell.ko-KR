...
이름으로 스프링 클라우드 서비스 가져오기

### 예제 2: 모든 스프링 클라우드 서비스를 리소스 그룹 아래에 나열 합니다.
```powershell
...
모든 스프링 클라우드 서비스를 리소스 그룹 아래에 나열 합니다.
...
### SpringCloud. PowerShell. Api20200701. IServiceResource
