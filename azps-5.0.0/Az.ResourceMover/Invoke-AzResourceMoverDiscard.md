...
### 예제 1: 리소스를 삭제 하기 전에 dependecies의 유효성을 검사 합니다.
```powershell
...
리소스를 삭제 하기 전에 dependecies의 유효성을 검사 합니다.

### 예제 2: "MoveResource Name"을 입력으로 사용 하 여 리소스의 이동을 취소 합니다.
```powershell
...
"MoveResource Name"을 입력으로 사용 하 여 리소스의 이동을 취소 합니다.

### 예제 3: 입력으로 "Sourc? Mid"를 사용 하 여 리소스의 이동을 삭제 합니다.
```powershell
...
"Sourc? Mid"를 입력으로 사용 하 여 리소스의 이동을 취소 합니다.
