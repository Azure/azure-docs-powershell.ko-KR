...
## 설명은
피어 링 서비스 개체와 연결 된 피어 링 서비스 접두사를 만듭니다.
...
피어 링 서비스 리소스 그룹 이름 및 이름에서 접두사를 만듭니다.
...
### -PeeringServiceName
피어 링 서비스 이름입니다.
새 피어 링 서비스 또는 목록 Get-AzPeeringService에 대해 New-AzPeeringService cmdlet을 사용 합니다.
