...
## 설명은
메모리 PeerAsn 연락처 정보를 만듭니다.

## 예제의

### 연락처 세부 정보를 만들고 PeerAsn에 추가
```powershell
...
역할 및 전자 메일이 필요 합니다. 전화는 선택 사항입니다. 전화는 +-() 또는 공백을 지원 합니다. PeerAsn에는 "Noc" 유형의 연락처 세부 정보가 하나 이상 포함 되어야 합니다.
...
### -전자 메일
일반적으로 네트워크 작업 센터에 문제가 arrise 때 연락 하는 데 사용 되는 전자 메일 주소
...
### -전화
일반적으로 네트워크 작업 센터에 문제가 arrise 때 사용 하는 전화
...
### Microsoft. PowerShell. a i m/. i a m a 모델 정보
