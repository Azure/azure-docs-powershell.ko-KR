...
## 설명은
**AzDataFactoryV2IntegrationRuntime** cmdlet은 ' 시작 됨 ' 상태의 관리 전용 통합 런타임을 중지 하며,이는 Start-AzDataFactoryV2IntegrationRuntime cmdlet에 의해 시작 되었습니다. 리소스가 해제 되 고 상태가 ' 중지 됨 '으로 전송 됩니다.
...
관리 되는 통합 런타임 ' 테스트-reserlved-ir '은 ' 시작 됨 ' 상태입니다. Stop-AzDataFactoryV2IntegrationRuntime cmdlet을 실행 한 후 리소스가 해제 되 고 상태가 ' 중지 됨 '으로 전송 됩니다.
...
[시작-AzDataFactoryV2IntegrationRuntime]()
