...
## 설명은
**AzDataFactoryV2IntegrationRuntimeNode** cmdlet은 통합 런타임 노드의 세부 정보를 가져옵니다.

## 예제의

### 예제 1: 통합 런타임 노드의 세부 정보를 가져옵니다.
```
...
Cmdlet은 ' selfhost-eu2 ' 데이터 팩터리의 자체 호스팅된 통합 런타임 ' test-ir '의 ' Node_1 ' 노드에 대 한 정보를 가져옵니다.

### 예제 2: IP 주소와 통합 런타임 노드의 세부 정보를 가져옵니다.
```
...
Cmdlet은 IP 주소를 포함 하 여 데이터 팩터리 ' test-df-eu2 '의 자체 호스팅된 통합 런타임 ' selfhost-ir '의 ' Node_1 ' 노드에 대 한 정보를 가져옵니다.
...
### DataFactoryV2. PSManagedIntegrationRuntimeNode/.
