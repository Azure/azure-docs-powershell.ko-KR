...
## 설명은
이 명령은 디버그 세션을 중지 하 고, 그렇지 않으면 디버그 세션의 시간 대 라이브 설정에 따라 세션이 자동으로 해제 됩니다.
...
```
Data factory "WikiADF"에서 데이터 흐름 디버그 세션 "fd76cd0d-8b37-4dc0-a370-3f9d43ac686d"을 중지 합니다.
