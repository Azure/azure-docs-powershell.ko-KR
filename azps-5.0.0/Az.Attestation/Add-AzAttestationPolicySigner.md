...
## 설명은
Add-AzAttestationPolicySigner cmdlet은 Azure 증명에 테 넌 트에 대해 신뢰할 수 있는 정책 서명자를 추가 합니다.
...
*Pshtest* 라는 Atteestation 공급자에 대해 신뢰할 수 있는 서명자를 추가 합니다.
...
### -서명자
해당 값이 추가할 새 신뢰할 수 있는 서명 키를 포함 하는 RFC7517 JSON 웹 키인 "maa-policyCertificate" 라는 클레임을 포함 하는 RFC7519 JSON 웹 토큰을 지정 합니다.
