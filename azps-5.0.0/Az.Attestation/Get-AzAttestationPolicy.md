...
## 설명은
Get-AzAttestationPolicy cmdlet은 Azure 증명의 테 넌 트에서 정책을 가져옵니다.
...
티 유형 *SgxEnclave* 에 대 한 증명 공급자 *pshtest* 에 대 한 정책을 가져옵니다.
...
T e t t e t t e t e t e t e t e *SgxEnclave* 의 증명 기본 공급자 위치 *영국 남아프리카*
...
### -이름
테 넌 트의 이름을 지정 합니다.
이 cmdlet은이 매개 변수에서 지정 하는 테 넌 트에 대 한 증명 정책을 가져옵니다.
