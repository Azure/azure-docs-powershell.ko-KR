...
## 설명은
New-AzAttestation cmdlet은 지정 된 리소스 그룹에 증명을 만듭니다.
...
두 개의 태그로 *pshtest4* 이라는 증명 공급자의 새 인스턴스를 만들고, 마스터링 티에 대 한 AAD 신뢰를 사용 합니다.
...
PEM 파일을 통해 신뢰할 수 있는 서명 키 집합을 지정 하 여 Isoladed 신뢰를 사용 하는 *pshtest3* ' 라는 증명 공급자의 새 인스턴스를 만듭니다.
...
### -위치
증명 공급자를 만들 Azure 지역을 지정 합니다. 명령 Get-AzResourceProvider를 ProviderNamespace 매개 변수와 함께 사용 하 여 선택 항목을 확인 합니다.
...
단일 인증서 파일의 발급 정책에 대 한 신뢰할 수 있는 서명 키 집합을 지정 합니다.
