...
### -값
데이터베이스 주체에 대 한 Kusto의 목록입니다.
생성 하려면 값 속성에 대 한 참고 섹션을 참조 하 고 해시 테이블을 만듭니다.
...
### Api20200614. i a PowerShell. IDatabasePrincipal.
...
값 <IDatabasePrincipal [] >: Kusto 데이터베이스 사용자의 목록입니다.
  - `Name <String>`: 데이터베이스 사용자 이름입니다.
  - `Role <DatabasePrincipalRole>`: 데이터베이스 주체 역할입니다.
  - `Type <DatabasePrincipalType>`: 데이터베이스 보안 주체 유형입니다.
  - `[AppId <String>]`: 응용 프로그램 id-응용 프로그램 보안 주체 유형에만 관련이 있습니다.
  - `[Email <String>]`: 데이터베이스 보안 주체 전자 메일 (있는 경우)
  - `[Fqn <String>]`: 데이터베이스 주체 정규화 된 이름입니다.
