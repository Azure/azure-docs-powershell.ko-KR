...
### 예제 1: 클러스터 데이터베이스 위치에 대 한 Kusto 만들기 할당
```powershell
...
위의 명령은 Kusto 클러스터 데이터베이스 principalAssignment을 만듭니다.
...
### -PrincipalId
데이터베이스 보안 주체에 할당 된 principal ID입니다.
사용자 전자 메일, 응용 프로그램 ID 또는 보안 그룹 이름이 될 수 있습니다.
