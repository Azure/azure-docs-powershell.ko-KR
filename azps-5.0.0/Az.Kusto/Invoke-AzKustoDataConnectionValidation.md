...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대 한 "myeventhubdc" 이라는 EventHub 데이터 연결의 유효성을 검사 합니다.
...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대 한 "myeventgriddc" 라는 EventGrid 데이터 연결의 유효성을 검사 합니다.

### 예제 3: IotHub data connection 매개 변수 유효성 검사
```powershell
...
위의 명령은 "mykustodatabase" 데이터베이스의 "myiothubdc" IotHub 데이터 연결을 "testnewkustocluster" 클러스터의 유효성을 검사 합니다.
...
### Microsoft. Api20200614. IDataConnectionValidationResult에 대 한.
