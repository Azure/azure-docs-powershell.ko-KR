...
직접 주어진 roleDefinitionId 및 principalId 값을 기준으로 등록 정의를 만듭니다.
...
인증 세부 정보를 사용 하 여 등록 정의를 만들거나 업데이트 합니다.
...
인증 세부 정보 및 등록 정의의 이름을 사용 하 여 등록 정의를 업데이트 합니다.

## 변수

### -권한 부여
PrincipalId-roleDefinitionId 인 인증 매핑 목록입니다.
