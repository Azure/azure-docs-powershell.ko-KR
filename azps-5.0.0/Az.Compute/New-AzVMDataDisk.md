...
## 설명은
**AzVMDataDisk** cmdlet은 가상 컴퓨터 또는 VMSS VM에 대 한 로컬 데이터 디스크 개체를 만듭니다.
...
가상 컴퓨터 또는 Vmss VM에 대 한 로컬 데이터 디스크 개체를 만듭니다. 생성
...
### Microsoft. a q. PSVirtualMachineDataDisk
