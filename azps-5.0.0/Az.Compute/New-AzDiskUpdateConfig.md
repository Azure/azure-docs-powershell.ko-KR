...
### -DiskMBpsReadOnly
공유 디스크를 읽기 전용으로 탑재 하는 모든 Vm에서 허용 되는 총 처리량 (MBps)입니다. MBps는 초당 수백만 바이트의 수를 의미 합니다. 여기서는 ISO 표기법을 10의 거듭제곱으로 사용 합니다.
...
### -MaxSharesCount
디스크에 동시에 연결할 수 있는 최대 Vm 수입니다. 값이 1 보다 크면 여러 Vm에 동시에 탑재할 수 있는 디스크가 표시 됩니다.
