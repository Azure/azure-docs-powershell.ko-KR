...
이 명령은 ResourceGroup11 이라는 리소스 그룹에서 AvailabilitySet03 이라는 가용성 집합을 가져옵니다.
...
### 예제 3: 필터링을 사용 하 여 모든 가용성 집합 가져오기
```
...
이 명령은 ResourceGroup11 이라는 리소스 그룹에서 "AvailabilitySet0"로 시작 하는 모든 가용성 집합을 가져옵니다.

### 예제 4: 이름이 AvailabilitySet0로 시작 하는 모든 가용성 집합 가져오기
```
...
이 명령은 "AvailabilitySet0"로 시작 하는 모든 가용성 집합을 가져옵니다.
