...
## 설명은
이 cmdlet은 근접 배치 그룹 리소스를 가져오거나 나열 합니다.
...
이 명령은 지정 된 리소스 그룹 아래의 모든 근접 배치 그룹을 나열 합니다.
...
이 명령은 구독 아래의 모든 근접 배치 그룹을 나열 합니다.

## 변수

### -ColocationStatus
근접 배치 그룹에 있는 리소스의 공동 위치 상태를 보여 줍니다.
...
### PSProximityPlacementGroup의. m a.
