...
## SYNOPSIS
지정 된 디스크 암호화 집합과 연결 된 리소스 목록을 가져옵니다.
...
## 설명은
**AzDiskEncryptionSetAssociatedResource** cmdlet은 지정 된 디스크 암호화 집합과 연결 된 리소스 목록을 가져옵니다.
...
Cmdlet은 제공 된 디스크 암호화 집합과 연결 된 두 리소스 (' exampleDisk01 ' 및 ' exampleDisk02 ')를 검색 합니다.
