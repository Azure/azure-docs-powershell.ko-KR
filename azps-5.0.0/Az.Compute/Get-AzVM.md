...
## 설명은
**AzVM** Cmdlet은 Azure 가상 컴퓨터의 인스턴스 뷰 또는 모델 보기를 가져옵니다.
모델 보기는 가상 컴퓨터의 사용자 지정 속성입니다.
인스턴스 보기는 가상 컴퓨터의 인스턴스 수준 상태입니다.
*Status* 매개 변수를 지정 하 여 기본값인 모델 보기 대신 가상 컴퓨터의 인스턴스 보기를 가져옵니다.
...
### 예제 6: 필터링을 사용 하 여 모든 가상 컴퓨터 가져오기
```
...
이 명령은 구독에서 "test"로 시작 하는 모든 가상 컴퓨터를 가져옵니다.
