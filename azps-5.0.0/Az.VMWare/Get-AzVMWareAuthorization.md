...
이 cmdlet은 사설 클라우드에서 인증을 받습니다. `azps-test-auth``azps-test-cloud`
...
이 cmdlet은 사설 클라우드의 권한 부여를 나열 합니다. `azps-test-auth``azps-test-cloud`
...
### Api20200320. IExpressRouteAuthorization에 대 한 Microsoft.
