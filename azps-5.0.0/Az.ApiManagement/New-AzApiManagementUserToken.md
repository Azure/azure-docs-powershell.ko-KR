...
## 설명은
Cmdlet **AzApiManagementUserToken** 는 지정 된 사용자에 대 한 공유 액세스 토큰을 생성 합니다.

## 예제의

### 예제 1: Git 사용자에 대 한 공유 액세스 토큰 생성
```powershell
...
이 스크립트는 ApiManagement 서비스에서 구성 된 Git 사용자를 가져오고 8 시간 동안 유효한 기본 키를 사용 하 여 공유 액세스 토큰을 생성 합니다.

### 예제 2

사용자에 대 한 공유 액세스 토큰을 생성 합니다. 생성
...
### -만료
토큰 만료
지정 하지 않으면 8 시간 후에 만료 되도록 토큰이 만들어집니다.
이 매개 변수는 선택 사항입니다.
...
### ApiManagement. ServiceManagement. \ PsApiManagementUserKeyType

### 시스템 Null 허용 ' 1 [[System. DateTime, mscorlib, Version = 4.0.0.0, Culture = 중립, PublicKeyToken = b77a5c561934e089]]

## 출력

### ApiManagement. ServiceManagement. \ PsApiManagementUserToken
