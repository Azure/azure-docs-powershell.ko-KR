...
## 설명은
**AzApiManagementTenantAccess** cmdlet은 테 넌 트에 대 한 테 넌 트 액세스 구성을 가져옵니다.
키가 결과 세부 정보에 포함 되지 않습니다. 클라이언트 비밀을 가져오려면 Get-help를 **AzApiManagementTenantAccessSecret** 를 사용 합니다.
...
이 명령은 지정 된 컨텍스트에 대 한 테 넌 트 액세스 구성을 가져옵니다.
