...
## 설명은
Cmdlet **집합-AzApiManagementDiagnostic** 는 전역 또는 Api 범위에서 구성 된 진단을 업데이트 합니다.
...
이 명령은 지정 된 진단 샘플링 백분율을 100에서 50%로 수정 합니다.

### 예제 2

전역 또는 Api 범위에서 API Management 진단을 수정 합니다. 생성
...
### -AlwaysLog
샘플링 설정을 적용 하지 않아야 하는 유형의 메시지를 지정 합니다.
이 매개 변수는 선택 사항입니다.
...
### -BackendSetting
백 엔드에 수신/송신 Http 메시지에 대 한 진단 설정입니다. 이 매개 변수는 선택 사항입니다.
...
### -FrontEndSetting
게이트웨이로 들어오는/나가는 Http 메시지에 대 한 진단 설정입니다. 이 매개 변수는 선택 사항입니다.
...
### -PassThru
지정한 경우 ApiManagement의 인스턴스가 set 진단을 나타내는 ServiceManagement 유형의 PsApiManagementDiagnostic 형식입니다.
...
### -ResourceId
진단 또는 Api 진단의 팔 ResourceId입니다. 이 매개 변수는 필수입니다.
...
### ApiManagement. ServiceManagement. \ PsApiManagementDiagnostic

### ApiManagement. ServiceManagement. \ PsApiManagementSamplingSetting

### ApiManagement. ServiceManagement. \ PsApiManagementPipelineDiagnosticSetting
