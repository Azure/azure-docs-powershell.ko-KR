...
## 설명은
**Add-AzApiManagementApiToGateway** Cmdlet은 게이트웨이에 Azure API Management api를 추가 합니다.
...
이 명령은 지정 된 게이트웨이에 지정 된 API를 추가 합니다.
...
### 시스템 Null 허용 ' 1 [[ApiManagement]. ServiceManagement, PsApiManagementGatewayApiProvisioningState, Microsoft azure. PowerShell. ApiManagement, Version = ServiceManagement, Culture = 중립, PublicKeyToken = null]]
