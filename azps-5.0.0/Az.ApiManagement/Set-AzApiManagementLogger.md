...
## 설명은
**Set-AzApiManagementLogger** Cmdlet은 Azure API Management **로 거** 의 설정을 수정 합니다.
...
이 명령은 ID Logger123 인로 거를 수정 합니다.

### 예제 2

API Management로 거를 수정 합니다. 생성
...
### -ConnectionString
정책 보내기 권한이 포함 된 Azure 이벤트 허브 연결 문자열을 지정 합니다.
...
### -IsBuffered
게시 하기 전에로 거의 레코드를 버퍼링 하도록 지정 합니다.
...
### -PassThru
이 cmdlet이이 cmdlet이 수정 하는  **PsApiManagementLogger** 를 반환 함을 나타냅니다.
