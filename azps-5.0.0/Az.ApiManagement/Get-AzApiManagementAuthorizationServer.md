...
ClientSecret는 결과 정보에 포함 되지 않습니다. 클라이언트 비밀을 가져오려면 Get-help를 **AzApiManagementAuthorizationServerClientSecret** 를 사용 합니다.
...
### -ResourceId
권한 부여 서버의 Arm 리소스 식별자입니다. 지정 된 경우 식별자를 사용 하 여 권한 부여 서버를 찾습니다. 이 매개 변수는 필수입니다.
