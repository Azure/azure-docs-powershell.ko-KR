...
## 설명은
**AzApiManagementGatewayHostnameConfiguration** cmdlet은 기존 게이트웨이에 대 한 모든 또는 특정 호스트 이름 구성을 가져옵니다.

## 예제의

### 예제 1: 게이트웨이에 대 한 모든 호스트 이름 구성 가져오기
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayHostnameConfiguration -Context $apimContext  -GatewayId "0123456789"
```

이 명령은 "0123456789" 게이트웨이에 대 한 모든 호스트 이름 구성을 가져옵니다.

### 예제 2: 게이트웨이에 대 한 호스트 이름 구성 가져오기
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
이 명령은 "0123456789" 게이트웨이에 대 한 "123" 호스트 이름 구성을 가져옵니다.
