...
## SYNOPSIS
Azure HDInsight 클러스터의 자동 크기 조정 구성을 설정 합니다.

## 구문과

### LoadAutoscaleByNameParameterSet (기본값)
```
...
## 설명은
이 cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** 는 Azure HDInsight 클러스터의 자동 크기 조정 구성을 설정 합니다.

## 예제의

### 예제 1: HDInsight 클러스터의 부하 기반 자동 크기 조정 구성 설정
```powershell
...
이 명령은 Azure HDInsight 클러스터의 부하 기반 자동 크기 조정 구성을 설정 합니다.

### 예제 2: HDInsight 클러스터의 일정 기반 자동 크기 조정 설정
```powershell
...
이 명령은 HDInsight 클러스터의 일정 기반 자동 크기 조정 구성을 설정 합니다.

### 예제 3: 자동 크기 조정 구성을 사용 하는 다른 클러스터를 기반으로 HDInsight 클러스터의 자동 크기 조정 구성 설정
```powershell
...
이 명령은 다른 클러스터를 기반으로 HDInsight 클러스터의 자동 크기 조정 구성을 설정 합니다.
