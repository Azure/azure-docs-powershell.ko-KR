...
### 예제 2: 고객 관리 키 디스크 암호화를 사용 하 여 클러스터 만들기
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 3: 암호화를 통과 하도록 설정 하는 Azure HDInsight 클러스터 만들기
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 4: 비공개 링크 기능을 사용 하 여 Azure HDInsight 클러스터 만들기
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 5: 호스트에서 암호화를 사용 하도록 설정 하는 Azure HDInsight 클러스터 만들기
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 6: 자동 크기 조정을 사용 하는 Azure HDInsight 클러스터 만들기
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 7: Kafka Rest 프록시를 사용 하 여 Azure HDInsight 클러스터를 만듭니다.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 8: Azure Data Lake Gen2 storage를 사용 하 여 Azure HDInsight 클러스터를 만듭니다.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### 예제 9: ESP (Enterprise Security Package)를 사용 하 여 Azure HDInsight 클러스터를 만들고 HDInsight ID Broker를 사용 하도록 설정 합니다.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### -EnableIDBroker
HDInsight Identity Broker 기능을 사용 하도록 설정 합니다.
...
### -KafkaClientGroupId
Kafka Rest 프록시 액세스에 대 한 클라이언트 그룹 id를 가져오거나 설정 합니다.
...
Kafka Rest 프록시 액세스에 대 한 클라이언트 그룹 이름을 가져오거나 설정 합니다.
...
### -StorageAccountKey
저장소 계정에 대 한 저장소 계정 액세스 키를 가져오거나 설정 합니다.
...
저장소 계정의 저장소 리소스 Id를 가져오거나 설정 합니다.
...
### -StorageContainer
기본 Azure 저장소 계정의 StorageContainer 이름을 가져오거나 설정 합니다.
...
### -StorageFileSystem
기본 Azure Data Lake Storage Gen2 account에 대 한 파일 시스템을 가져오거나 설정 합니다.
...
### -StorageRootPath
기본 Data Lake Store 계정에서 클러스터 루트의 경로를 가져오거나 설정 합니다.
...
### -SubnetName
이 HDInsight 클러스터의 서브넷 이름을 가져오거나 설정 합니다.
