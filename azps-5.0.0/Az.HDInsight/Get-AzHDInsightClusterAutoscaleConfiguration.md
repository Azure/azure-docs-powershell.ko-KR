...
## 설명은
**AzHDInsightClusterAutoscaleConfiguration** Cmdlet은 HDInsight 클러스터의 자동 크기 조정 구성을 가져옵니다.

## 예제의

### 예제 1: HDInsight 클러스터의 자동 크기 조정 구성을 가져옵니다.
```powershell
...
이 명령은 HDInsight 클러스터의 자동 크기 조정 구성을 가져옵니다.
