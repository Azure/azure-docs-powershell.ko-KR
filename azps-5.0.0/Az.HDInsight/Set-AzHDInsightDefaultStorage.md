...
## 설명은
**AzHDInsightDefaultStorage** cmdlet은 New-AzHDInsightClusterConfig cmdlet에서 만든 Azure HDInsight 클러스터 구성 개체의 기본 저장소 계정 설정을 설정 합니다.

## 예제의

### 예제 1: 클러스터 구성 개체에 대 한 기본 저장소 계정 설정
```
...
이 명령은 클러스터 구성 개체에 대 한 기본 저장소 계정을 설정 합니다.
...
### -StorageAccountType
기본 저장소 계정의 유형을 가져오거나 설정 합니다. 기본값은 AzureStorage입니다.
