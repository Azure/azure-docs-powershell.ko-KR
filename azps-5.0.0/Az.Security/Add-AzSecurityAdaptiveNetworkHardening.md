...
## SYNOPSIS
요청에 나열 된 NSG (s)에 대 한 지정 된 규칙을 적용 합니다.
...
## 설명은
적응 네트워크 Hardenings Azure 보안 센터에서 자동으로 계산 되며,이 cmdlet을 사용 하 여 요청에 나열 된 NSG (s)에 지정 된 규칙을 적용 합니다.
...
적응 네트워크 강화 규칙에서 생성 된 보안 규칙으로 업데이트 되는 효과적인 네트워크 보안 그룹의 Azure 리소스 Id입니다.
...
### AdaptiveNetworkHardenings. PSSecurityAdaptiveNetworkHardeningsRule에 대 한 Microsoft
