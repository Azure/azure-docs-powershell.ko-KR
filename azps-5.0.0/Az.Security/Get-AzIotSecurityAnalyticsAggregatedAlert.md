...
## 설명은
Get-AzIotSecurityAnalyticsAggregatedAlert cmdlet은 iot hub의 장치에서 하나 이상의 집계 된 경고를 반환 합니다.
집계 된 경고의 이름은 '/'로 구분 된 경고 유형 및 alert aggragted date의 조합입니다.
...
솔루션 "MySolution" 및 리소스 그룹 "Mysolution"에서 집계 된 경고 "IoT_Bruteforce_Fail/2019-02-02" (경고 유형 및 해당 집계 날짜와 조합 된 이름)을 가져옵니다.
...
솔루션 "MySolution" 및 리소스 그룹 "Mysolution"의 모든 집계 된 알림 목록 가져오기
