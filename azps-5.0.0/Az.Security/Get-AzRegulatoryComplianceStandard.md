...
## 설명은
Spcific 규제 준수 satandard 세부 정보를 확인 하거나 특정 구독에서 모든 규정 준수 표준을 나열 하세요.
...
표준 이름에 따라 특정 규제 준수 표준에 대 한 세부 정보를 확인 하세요.
...
리소스 id에 따라 특정 규제 준수 표준에 대 한 세부 정보를 확인 하세요.
...
### RegulatoryCompliance. PSSecurityRegulatoryComplianceStandard에 대 한 Microsoft
