...
## 설명은
Remove-AzIotSecuritySolution cmdlet은 특정 iot 보안 솔루션을 삭제 합니다. IoT security 솔루션은 iot 디바이스 및 iot hub의 보안 데이터 및 이벤트를 수집 하 여 위협을 방지 하 고 검색 합니다.
...
리소스 그룹 "MyResourceGroup"을 사용 하 여 IoT security 솔루션 "MySample" 삭제
