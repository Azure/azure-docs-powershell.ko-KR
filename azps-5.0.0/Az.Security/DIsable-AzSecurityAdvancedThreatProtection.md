...
## 설명은
`Disable-AzSecurityAdvancedThreatProtection`Cmdlet은 저장소/cosmosDB 계정에 대 한 위협 보호 정책을 사용 하지 않도록 설정 합니다.
...
이 명령은 리소스 id에 대 한 고급 위협 보호 정책을 사용 하지 않도록 설정 합니다 `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` .
...
이 명령은 리소스 id에 대 한 고급 위협 보호 정책을 사용 하지 않도록 설정 합니다 ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` .
