...
## 설명은
리소스에 대 한 보안 평가 결과를 만들거나 업데이트 하 여 기존 결과의 상태를 변경 하거나 추가 데이터를 추가 하는 데 사용 될 수 있습니다.
"CustomerManaged" 평가 유형에만 사용할 수 있으며, 일치 하는 평가 메타 데이터를 만든 후에만 사용 가능 합니다.
...
"4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" 유형의 평가에 대 한 "비정상"으로 구독 결과를 표시 합니다. 평가 형식에 대 한 자세한 내용은 assessmentMetadata 형식 아래에서 확인할 수 있습니다.

## 변수

### -AdditionalData
더 나은 조사 또는 상태 명확성을 위해 평가 결과에 첨부 된 데이터입니다.
...
### -StatusCause
평가 결과의 원인을 Progremmatic 코드를 생성 합니다.
...
### -StatusCode
평가 결과에 대 한 코드를 Progremmatic.
"정상", "비정상" 또는 "NotApplicable" 일 수 있습니다.
...
### -StatusDescription
평가 결과의 원인에 대 한 사람이 읽을 수 있는 설명입니다.
