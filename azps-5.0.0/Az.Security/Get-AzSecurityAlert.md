...
ms.locfileid: "94226183"
---
# <span data-ttu-id="80ea2-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="80ea2-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="80ea2-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="80ea2-102">SYNOPSIS</span></span>
<span data-ttu-id="80ea2-103">Azure 보안 센터에서 검색 된 보안 경고를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="80ea2-104">구문과</span><span class="sxs-lookup"><span data-stu-id="80ea2-104">SYNTAX</span></span>

### <span data-ttu-id="80ea2-105">구독 범위 (기본값)</span><span class="sxs-lookup"><span data-stu-id="80ea2-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="80ea2-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="80ea2-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="80ea2-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="80ea2-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="80ea2-108">구독 Levelresource</span><span class="sxs-lookup"><span data-stu-id="80ea2-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="80ea2-109">리소스</span><span class="sxs-lookup"><span data-stu-id="80ea2-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="80ea2-110">설명은</span><span class="sxs-lookup"><span data-stu-id="80ea2-110">DESCRIPTION</span></span>
<span data-ttu-id="80ea2-111">Azure 보안 센터에서 검색 된 보안 경고를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="80ea2-112">예제의</span><span class="sxs-lookup"><span data-stu-id="80ea2-112">EXAMPLES</span></span>

### <span data-ttu-id="80ea2-113">예제 1</span><span class="sxs-lookup"><span data-stu-id="80ea2-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="80ea2-114">구독 내 리소스에서 검색 된 모든 보안 경고를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="80ea2-115">예제 2</span><span class="sxs-lookup"><span data-stu-id="80ea2-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="80ea2-116">"MyService1" 리소스 그룹 내의 리소스에서 검색 된 모든 보안 경고를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="80ea2-117">예제 3</span><span class="sxs-lookup"><span data-stu-id="80ea2-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="80ea2-118">"MyService1" 리소스 그룹 내의 리소스에 대해 검색 된 특정 보안 경고를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="80ea2-119">변수</span><span class="sxs-lookup"><span data-stu-id="80ea2-119">PARAMETERS</span></span>

### <span data-ttu-id="80ea2-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="80ea2-120">-DefaultProfile</span></span>
<span data-ttu-id="80ea2-121">Azure와 통신 하는 데 사용 되는 자격 증명, 계정, 테 넌 트 및 구독입니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="80ea2-122">-위치</span><span class="sxs-lookup"><span data-stu-id="80ea2-122">-Location</span></span>
<span data-ttu-id="80ea2-123">Location.</span><span class="sxs-lookup"><span data-stu-id="80ea2-123">Location.</span></span>
...
### <span data-ttu-id="80ea2-124">-이름</span><span class="sxs-lookup"><span data-stu-id="80ea2-124">-Name</span></span>
<span data-ttu-id="80ea2-125">리소스 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-125">Resource name.</span></span>
...
### <span data-ttu-id="80ea2-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="80ea2-126">-ResourceGroupName</span></span>
<span data-ttu-id="80ea2-127">리소스 그룹 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-127">Resource group name.</span></span>
...
### <span data-ttu-id="80ea2-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="80ea2-128">-ResourceId</span></span>
<span data-ttu-id="80ea2-129">리소스 ID입니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-129">Resource ID.</span></span>
...
### <span data-ttu-id="80ea2-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="80ea2-130">CommonParameters</span></span>
<span data-ttu-id="80ea2-131">이 cmdlet은-Debug,-ErrorAction,-Erroraction,-InformationAction,-Informationaction,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose,-WarningAction,-WarningVariable 등의 공통 매개 변수를 지원 합니다.</span><span class="sxs-lookup"><span data-stu-id="80ea2-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="80ea2-132">자세한 내용은 [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="80ea2-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="80ea2-133">입력</span><span class="sxs-lookup"><span data-stu-id="80ea2-133">INPUTS</span></span>

### <span data-ttu-id="80ea2-134">System. 문자열</span><span class="sxs-lookup"><span data-stu-id="80ea2-134">System.String</span></span>

## <span data-ttu-id="80ea2-135">출력</span><span class="sxs-lookup"><span data-stu-id="80ea2-135">OUTPUTS</span></span>

### <span data-ttu-id="80ea2-136">Microsoft. Azure. 경고용. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="80ea2-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="80ea2-137">상속자</span><span class="sxs-lookup"><span data-stu-id="80ea2-137">NOTES</span></span>

## <span data-ttu-id="80ea2-138">관련 링크</span><span class="sxs-lookup"><span data-stu-id="80ea2-138">RELATED LINKS</span></span>
