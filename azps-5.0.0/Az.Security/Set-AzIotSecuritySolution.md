...
## 설명은
Set-AzIotSecuritySolution cmdlet은 특정 iot 보안 솔루션을 만들거나 업데이트 합니다. IoT security 솔루션은 iot 디바이스 및 iot hub의 보안 데이터 및 이벤트를 수집 하 여 위협을 방지 하 고 검색 합니다.
Iot 보안 솔루션의 이름은 iot hub의 이름과 동일 해야 합니다.
...
"/Subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" 리소스 id를 사용 하 여 IoT hub에 대 한 새 iot 보안 솔루션 "MySample" 만들기 (솔루션의 이름은 IoT hub의 이름과 동일 해야 합니다.)
