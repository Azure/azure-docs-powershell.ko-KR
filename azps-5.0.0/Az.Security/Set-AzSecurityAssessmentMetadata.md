...
## 설명은
보안 평가 메타 데이터를 만들거나 업데이트 하 여 다양 한 평가 속성을 만들고 관리 하는 데 사용할 수 있습니다.
이 작업을 수행한 후에는이 구독의 모든 리소스에서 평가 결과를 보고할 수 있습니다.
...
### -설명
이 평가의 의미와 계산 방법을 이해 하는 데 도움이 되는 자세한 문자열입니다.
...
사용자가 보안 문제를 완화 하거나 해결 하는 다양 한 방법을 이해 하는 데 도움이 되는 자세한 문자열입니다.
...
### -심각도
평가가 비정상 인 경우 보안 위험의 중요성을 나타냅니다.
