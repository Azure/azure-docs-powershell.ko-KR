...
이 명령은 "MyDestinationAnfVolume" 볼륨에서 ANF 복제 연결을 다시 시작 합니다.
...
### -PassThru
지정 된 복제 볼륨의 재 동기화가 수행 되었는지 여부 반환
