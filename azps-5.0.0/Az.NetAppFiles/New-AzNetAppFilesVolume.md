...
## 설명은
**새 AzNetAppFilesVolume** cmdlet은 anf 볼륨을 만듭니다.
...
이 명령은 "MyAnfPool" 풀 내에 새 ANF 볼륨 "MyAnfVolume"를 만듭니다.
...
### -SnapshotId
스냅숏에서 볼륨을 만듭니다. 스냅숏을 식별 하는 데 사용 되는 UUID v4 또는 리소스 식별자
...
### -UsageThreshold
파일 시스템에 허용 되는 최대 저장소 할당량 (바이트)입니다.
