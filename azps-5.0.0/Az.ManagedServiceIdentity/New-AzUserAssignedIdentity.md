...
## SYNOPSIS
새 사용자에 게 할당 된 Id를 만들거나 기존 사용자에 게 할당 된 Id를 업데이트 합니다.
...
## 설명은
**AzUserAssignedIdentity** cmdlet은 새 사용자 지정 id를 만듭니다. 이미 기존 id와 함께 사용 하면 id를 업데이트 합니다.
Azure 리소스 관리자 태그를 id에 추가 하려면 Set-AzResource cmdlet을 사용 하세요.

## 예제의

### 예제 1
이 예제 cmdlet은 ResourceGroup의 위치에 있는 리소스 그룹 **Psrg** 아래에서 이름이 **ID1** 인 새 사용자 할당 id를 만듭니다.
...
### 예제 2
이 예제 cmdlet은 westus 지역의 리소스 그룹 **Psrg** 아래에서 이름이 **ID1** 인 새 사용자 할당 id를 만듭니다.
...
### 태그
Id와 연결 된 Azure Resource Manager 태그입니다.
