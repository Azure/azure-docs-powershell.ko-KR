...
### 예제 1: kubernetes cluster에 대 한 configuation 만들기
```powershell
...
이 명령은 kubernetes cluster에 대 한 configuation를 만듭니다.
...
### -ClusterScoped
성공으로 구성 범위를 Cluster (기본값은 네임 스페이스)로 설정 합니다.
...
### -Enable<c13> Moperon
이 git 구성에 대해 투구 연산자를 사용 하도록 설정 하는 옵션입니다.
...
### -OperatorNamespace
이 연산자가 설치 되어 있는 네임 스페이스입니다.
최대 253 소문자 영숫자 문자, 하이픈 및 마침표만에만 해당 됩니다.
...
### -OperatorParameters
문자열 형식의 연산자 인스턴스에 대 한 모든 매개 변수
