...
이 명령은 모든 함수 앱 계획을 가져옵니다.

### 예제 2: 리소스 그룹 이름을 기준으로 함수 앱 계획을 가져옵니다.
```powershell
...
이 명령은 리소스 그룹 이름을 기준으로 함수 앱 계획을 가져옵니다.

### 예제 3: 지정 된 구독에 대 한 함수 앱 계획을 가져옵니다.
```powershell
...
이 명령은 지정 된 구독에 대 한 함수 앱 계획을 가져옵니다.

### 예제 4: 위치에 따라 함수 앱 계획을 가져옵니다.
```powershell
