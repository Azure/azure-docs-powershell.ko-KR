...
' 없음 ' 형식은 함수 앱에서 모든 id를 제거 합니다.
이 매개 변수에 허용 되는 값은-SystemAssigned 됨-UserAssigned 됨입니다. 없음
