...
## 설명은
**AzureRmDeploymentManagerArtifactSource** cmdlet은 아티팩트 원본을 만듭니다.
*Name* , *ResourceGroupName* 및 required 속성을 지정 합니다.

반환 된 개체를 로컬로 수정한 다음 Set-AzureRmDeploymentManagerArtifactSource cmdlet을 사용 하 여 아티팩트 원본에 변경 내용을 적용할 수 있습니다.

Cmdlet은 ServiceUnit 리소스, 템플릿 및 매개 변수 파일에 필요한 아티팩트를이 위치에서 참조할 수 있도록 New-AzureRmDeloymentManagerServiceTopology cmdlet에서 참조할 수 있는 ResourceId가 있는 ArtifactSource 개체를 반환 합니다.
