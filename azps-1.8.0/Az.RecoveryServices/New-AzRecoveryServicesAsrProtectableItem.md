...
## 설명은
**AzRecoveryServicesAsrProtectableItem** 는 ASR 패브릭 내의 보호 컨테이너에 있는 발견 된 보안 가능한 항목 목록에 보호 가능한 새 항목을 추가 합니다 (VMware 패브릭 유형에만 해당).
...
새 Azure Recovery Service ProtectableItem를 추가 하거나 검색 합니다.
...
### -ProtectionContainer
보호 가능한 항목을 추가 해야 하는 ASR 보호 컨테이너 개체입니다.
