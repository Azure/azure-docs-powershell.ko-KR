...
## 설명은
**AzStorageFileCopy** cmdlet은 원본 파일을 대상 파일에 복사 하는 데부터 시작 됩니다.
...
컨텍스트를 얻으려면 **New-AzStorageContext** 를 사용 합니다.
...
클라우드 blob을 만들거나 Get-AzStorageBlob cmdlet을 사용 하 여 가져올 수 있습니다.
...
클라우드 blob 컨테이너 개체를 만들거나 Get-AzStorageContainer cmdlet을 사용할 수 있습니다.
...
### -SrcFile
**Cloudfile** 개체를 지정 합니다.
클라우드 파일을 만들거나 **AzStorageFile** 를 사용 하 여 가져올 수 있습니다.
...
클라우드 파일 공유를 만들거나 Get-AzStorageShare cmdlet을 사용 하 여 가져올 수 있습니다.
