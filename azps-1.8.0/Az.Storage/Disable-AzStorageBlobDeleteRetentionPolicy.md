...
## 설명은
**AzStorageBlobDeleteRetentionPolicy** Cmdlet은 Azure Storage Blob service에 대 한 삭제 보존 정책을 사용 하지 않도록 설정 합니다.

## 예제의

### 예제 1: Blob 서비스에 대 한 삭제 보존 정책 사용 안 함
```
...
이 명령은 Blob 서비스에 대 한 삭제 보존 정책을 사용 하지 않도록 설정 합니다.
