...
## 설명은
**AzStorageShareStoredAccessPolicy** Cmdlet은 Azure 저장소 공유에서 저장 된 액세스 정책을 제거 합니다.

## 예제의

### 예제 1: Azure 저장소 공유에서 저장 된 액세스 정책 제거
```
PS C:\>Remove-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy"
```

이 명령은 ContosoShare에서 일반 정책 이라는 저장 된 액세스 정책을 제거 합니다.
...
### -ShareName
이 cmdlet이 정책을 제거할 저장소 공유 이름을 지정 합니다.
