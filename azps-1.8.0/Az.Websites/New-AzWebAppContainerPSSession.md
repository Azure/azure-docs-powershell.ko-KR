...
이렇게 하면 windows 컨테이너 앱 ContosoASP에 새 원격 PowerShell 세션이 생성 되 고 컨테이너에서 실행 중인 프로세스가 표시 됩니다 ContosoASP
...
### -Force
확인 메시지를 표시 하지 않고 PowerShell 세션을 만듭니다.
