...
이 명령은 Slot001와 연결 된 appservice 요금제를 리소스 그룹 기본값-웹 WestUS와 연결 된 Web app ContosoWebApp으로 변경 합니다. 링크를 사용 하 여 관련 된 appservice 계획 및 제약 조건을 변경 하는 방법에 대 한 자세한 learm.
