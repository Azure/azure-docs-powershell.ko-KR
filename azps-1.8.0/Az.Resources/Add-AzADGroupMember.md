...
개체 id가 ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' 인 그룹을 가져와이 그룹에 사용자를 추가 하도록 Add-AzADGroupMember cmdlet에 파이프 합니다.

### 예제 3-사용자 이름을 주체 이름으로 그룹에 추가
...
그룹에 사용자를 추가 하 고 그룹 구성원을 나열 합니다.
