...
## 설명은
**AzSqlServerAuditing** Cmdlet은 Azure SQL server의 감사 설정을 가져옵니다.
...
### 예제 1: Azure SQL server의 blob 저장소 감사 설정 가져오기
```
...
### 예제 2: Azure SQL server의 blob 저장소 감사 설정 가져오기
```
...
### 예제 3: Azure SQL server의 blob 저장소 감사 설정, 파이프라인으로 가져오기
```
...
### 예제 4: Azure SQL server의 이벤트 허브 감사 설정 가져오기
```
...
### 예제 5: Get, 파이프라인, Azure SQL server의 이벤트 허브 감사 설정
```
...
### 예제 6: Azure SQL server의 로그 분석 감사 설정 가져오기
```
