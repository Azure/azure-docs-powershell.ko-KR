...
## 설명은
Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet은 Azure SQL 관리 인스턴스 데이터베이스의 열에 대 한 권장 정보 유형 및 민감도 레이블을 반환 합니다.

## 예제의

### 예제 1: Azure SQL 관리 인스턴스 데이터베이스의 권장 정보 유형 및 민감도 레이블을 가져옵니다.
```powershell
...
### 예제 2: 파이핑을 사용 하 여 Azure SQL 관리 인스턴스 데이터베이스의 권장 정보 유형 및 민감도 레이블을 가져옵니다.
```powershell
