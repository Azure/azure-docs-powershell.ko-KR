...
이 명령은 northeurope의 모든 데이터베이스 (활성 또는 삭제 될 수 있음)에 대 한 장기 보존 백업을 모두 가져옵니다.

### 예제 2: 특정 장기 보존 백업 가져오기
```powershell
...
### 예제 3: 데이터베이스에 대 한 모든 장기 보존 백업 가져오기
```powershell
...
### 예제 4: 필터링을 사용 하 여 장기 보존 백업 가져오기
```powershell
