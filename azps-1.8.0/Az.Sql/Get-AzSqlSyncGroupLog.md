...
## 설명은
**AzSqlSyncGroupLog** Cmdlet은 Azure SQL 데이터베이스 동기화 그룹의 로그를 반환 합니다.

## 예제의

### 예제 1: Azure SQL 동기화 그룹의 로그 가져오기
```
...
이 명령은 Azure SQL 동기화 그룹의 로그를 가져옵니다.
...
### -LogLevel
쿼리할 로그의 유형입니다.
유효한 값은 ' Error ', ' Warning ', ' Success ' 및 ' All '입니다.
...
### AzureSqlSyncGroupLogModel (*)를 호출 합니다.
