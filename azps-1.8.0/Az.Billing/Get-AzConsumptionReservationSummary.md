...
## 설명은
**AzConsumptionReservationSummay** cmdlet은 일일 또는 월별 그레인에 대 한 예약 요약을 가져옵니다.

## 예제의

### 예제 1: 월간 그레인에 대 한 예약 주문 Id를 사용 하 여 예약 요약 가져오기
```powershell
...
### 예제 2: 예약 주문 Id와 월별 그레인에 대 한 예약 Id를 사용 하 여 예약 요약 가져오기
```powershell
...
### 예제 3: 일일 그레인 제공 날짜 범위에 대 한 예약 주문 Id를 사용 하 여 예약 요약 가져오기
```powershell
...
### 예제 4: 일일 그레인 제공 날짜 범위에 대 한 예약 주문 Id 및 예약 Id를 사용 하 여 예약 요약 가져오기
```powershell
...
### -EndDate
예약 요약의 끝 데이터 (UTC의 YYYY-DD)는 일일 그레인에만 필요 합니다.
...
### -그레인
예약 summaryy의 시간 세분화는 매일 또는 매월 일 수 있습니다.
...
### -시작 날짜
일일 그레인에만 필요 하며 예약 요약의 시작 데이터 (UTC에서 yyyy-mm-dd)입니다.
...
### PSReservationSummary를 사용 하 여 명령을 사용 합니다.
