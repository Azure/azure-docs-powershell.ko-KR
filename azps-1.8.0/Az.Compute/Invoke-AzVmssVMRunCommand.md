...
## 설명은
가상 머신 확장 집합 VM에서 실행 명령을 호출 합니다.
...
' sample.ps1 ' 스크립트와 ' rgname ' 리소스 그룹의 ' vmssname ' 집합에 있는 ' 0 ' VM의 매개 변수를 재정의 하 여 RunPowerShellScript의 실행 명령을 호출 합니다.
...
### -ScriptPath
실행할 스크립트의 경로입니다.  이 값을 지정 하면 지정 된 스크립트는 명령의 기본 스크립트를 재정의 합니다.
...
### Microsoft. a. m a. 모델. PSRunCommandResult
