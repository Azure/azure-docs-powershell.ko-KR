...
## 설명은
New-AzNetworkWatcherConnectionMonitor cmdlet rcreates 지정 된 원본 및 대상에 대 한 연결 모니터를 만듭니다.

## 예제의

### 예제 1: vm 및 인터넷 대상에 대 한 연결 모니터 만들기
```
...
New-AzNetworkWatcherConnectionMonitor cmdlet은 지정 된 원본 및 대상에 대 한 연결 모니터를 만듭니다.
