...
## 설명은
**AzExpressRouteCircuitStat** Cmdlet은 express 경로 회로에 대 한 트래픽 통계를 검색 합니다. 통계에는 기본 및 보조 경로를 통해 주고 받은 바이트 수가 포함 됩니다.

## 예제의

### 예제 1: Express 경로 피어에 대 한 트래픽 통계 표시
```
...
### PSExpressRouteCircuitStats에 대 한.
