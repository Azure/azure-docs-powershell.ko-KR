...
## 설명
Get-AzNetworkWatcherNextHop cmdlet은 VM에서 다음 홉을 얻습니다.
다음 홉을 사용하면 Azure 리소스의 유형, 해당 리소스의 연결된 IP 주소 및 경로를 담당하는 라우팅 테이블 규칙을 볼 수 있습니다.
...
지정된 Virtual Vachine의 기본 네트워크 인터페이스에서 204.79.197.200(www.bing.com)
