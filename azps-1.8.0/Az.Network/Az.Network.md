...
사용 가능한 모든 서버 변수, 요청 및 응답 헤더를 가져옵니다.
...
응용 프로그램 게이트웨이에 대 한 재작성 규칙 actionset을 만듭니다.
...
새 네트워크 구성 진단 프로필 개체를 만듭니다. 이 개체는 지정 된 기준을 사용 하 여 진단 세션 중에 네트워크 confiuration를 제한 하는 데 사용 됩니다.
