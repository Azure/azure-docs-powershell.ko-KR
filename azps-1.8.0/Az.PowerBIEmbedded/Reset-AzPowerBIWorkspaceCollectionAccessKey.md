...
## 설명은
**AzPowerBIWorkspaceCollectionAccessKey** Cmdlet은 Power BI workspace 컬렉션에서 지정 된 선택 키를 다시 설정 합니다.
...
이 명령은 지정 된 리소스 그룹의 WCN11 이라는 작업 영역 컬렉션에 대 한 기본 선택 키를 다시 설정 합니다.
...
### -Key1
이 cmdlet이 기본 선택 키를 다시 설정 하는 것을 나타냅니다.
...
### -Key2
이 cmdlet이 보조 선택 키를 다시 설정 하는 것을 나타냅니다.
