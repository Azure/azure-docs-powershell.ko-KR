...
## 설명은
**AzKeyVaultCertificateContact** cmdlet은 키 보관소의 인증서 알림에 대해 등록 된 연락처를 삭제 합니다.
...
이 명령은 Patti을 Contoso01 키 보관소의 인증서 연락처로 제거 합니다.  PassThru를 지정 하면 cmdlet은 나머지 인증서 연락처 목록을 반환 합니다.
