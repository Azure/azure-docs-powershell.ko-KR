...
## 설명은
**Set-AzServiceBusRule** cmdlet은 지정 된 구독에 대 한 지정 된 규칙에 대 한 설명을 업데이트 합니다.
...
항목의 구독 규칙에 대 한 sqlexpression **mysqlexpression = ' condition '** 을 업데이트 합니다. `SBEule` `SBSubscription``SBTopic`
