...
## 설명은
Azure Advisor 권장 사항 목록을 가져옵니다. 범주, 리소스 ID, 이름 등을 기준으로 필터링 할 수 있습니다.
...
Type                 : Microsoft.Advisor/recommendations
```
범주 성능에 따라 필터링 된 모든 권장 구성 목록을 가져옵니다.
