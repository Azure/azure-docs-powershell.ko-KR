...
## SYNOPSIS
Azure Advisor 추천을 사용 하도록 설정 합니다.
...
## 설명은
이 cmdlet은 이전에 억제 된 권고안을 사용 하도록 설정 합니다. 권장 하는 것과 관련 된 비 표시 오류도 모두 제거할 수 있습니다.
...
"Recommendation_id" 이름을 사용 하 여 지정 된 추천에 대 한 모든 비 대 인을 제거 합니다.
...
파이프라인에서 전달 된 주어진 권장 사항에 대 한 모든 비 대 인을 제거 합니다.
...
### -RecommendationName
이 권고안의 Context.resourcename입니다.
