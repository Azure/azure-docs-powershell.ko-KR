...
## 설명은
**AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정에서 일괄 처리 구성을 제거 합니다.

## 예제의

### 예제 1: 매개 변수를 기준으로 일괄 처리 구성 제거
```powershell
...
통합 계정 "sampleIntegrationAccount"에 있는 "sampleBatchConfig" 이라는 일괄 처리 구성을 제거 합니다.
