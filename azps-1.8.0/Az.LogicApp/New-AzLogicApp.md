...
## 설명은
**새 AzLogicApp** Cmdlet은 논리 앱 기능을 사용 하 여 논리 앱을 만듭니다.
...
이 명령은 Get-AzResourceGroup cmdlet을 사용 하 여 ResourceGroup11 라는 리소스 그룹을 가져옵니다.
...
첫 번째 명령은 Get-AzLogicApp cmdlet을 사용 하 여 LogicApp03 이라는 논리 앱을 가져옵니다.
