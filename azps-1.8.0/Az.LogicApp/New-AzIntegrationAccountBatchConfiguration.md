...
## 설명은
**AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정에서 새 일괄 처리 구성을 만듭니다.

## 예제의

### 예제 1: 로컬 파일을 사용 하 여 새 일괄 처리 구성 만들기
```powershell
...
"$BatchConfigurationFilePath"에 포함 된 파일 경로에 있는 로컬 파일을 사용 하 여 새 일괄 처리 구성을 만듭니다.

### 예제 2: JSON 문자열을 사용 하 여 새 일괄 처리 구성 만들기
```powershell
...
"$BatchConfigurationContent"에 포함 된 JSON 문자열을 사용 하 여 새 일괄 처리 구성을 만듭니다.

### 예제 3: 매개 변수를 사용 하 여 새 일괄 처리 구성 만들기
```powershell
...
모든 nessecary 매개 변수를 수동으로 제공 하 여 새 일괄 처리 구성을 만듭니다.
