...
## SYNOPSIS
Azure Data Lake에서 삭제 된 파일 또는 폴더를 복원 합니다.
...
## 설명은
**Restore-AzDataLakeStoreDeletedItem** Cmdlet은 Data Lake store에서 삭제 된 파일 또는 폴더를 복원 합니다. 휴지통 retunred에서 삭제 된 항목의 경로가 Get-AzDataLakeStoreDeletedItem에 필요 합니다.

## 예제의

### 예제 1:-force 옵션을 사용 하 여 Data Lake Store에서 파일 복원
```
...
### -RestoreAction
대상 이름 충돌 시 수행할 작업-"copy" 또는 "overwrite"
