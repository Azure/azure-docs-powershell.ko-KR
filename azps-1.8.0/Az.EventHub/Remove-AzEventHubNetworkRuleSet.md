...
```
Name: 기본 DefaultAction: Allow Id:/subscriptions/subscriptionId/resourceGroups/ResourceGroup/providers/Microsoft.EventHub/namespaces/EventHub-Namespace-1375/networkRuleSets/default Type: Microsoft. EventHub/네임 스페이스/NetworkRuleSet 집합 IpRules: VirtualNetworkRules: 


지정 된 "Eventhub-Namespace1-1375" namesapce에 대 한 NetwrokRuleSet를 삭제 합니다. 
...
InputObject를 사용 하 여 NetwrokRuleSet를 삭제 합니다. 
...
Namepsace의 ResourceId를 사용 하 여 NetwrokRuleSet를 삭제 합니다.
