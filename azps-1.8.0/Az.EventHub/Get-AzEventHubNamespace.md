...
## 설명은
Get-AzEventHubNamespace cmdlet은 지정 된 이벤트 허브 네임 스페이스에 대 한 세부 정보 또는 현재 Azure 구독에서 모든 이벤트 허브 네임 스페이스의 목록 중 하나를 가져옵니다.
...
\` \` 리소스 그룹 MyResourceGroupName에서 네임 스페이스 MyNamespaceName의 세부 정보를 가져옵니다 \` \` .
