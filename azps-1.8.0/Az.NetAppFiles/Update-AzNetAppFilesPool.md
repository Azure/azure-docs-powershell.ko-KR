...
## SYNOPSIS
새 데이터 집합으로 Azure NetApp Files (ANF) 풀을 업데이트 합니다.
...
## 설명은
**업데이트 AzNetAppFilesPool** cmdlet은 anf 풀을 수정 합니다.
...
이 명령은 ANF 풀 "MyAnfPool"를 지정 된 크기와 ServiceLevel으로 변경 합니다.
