...
## 설명은
**업데이트 AzFrontDoorFireWallPolicy** cmdlet은 기존 waf 정책을 업데이트 합니다. 입력 매개 변수를 제공 하지 않으면 기존 WAF 정책의 이전 매개 변수가 사용 됩니다.
...
[새로운 AzFrontDoorFireWallPolicy](./New-AzFrontDoorFireWallPolicy.md) 
 ...
 [새로운 AzFrontDoorCustomRuleObject](./New-AzFrontDoorManagedRuleObject.md)
