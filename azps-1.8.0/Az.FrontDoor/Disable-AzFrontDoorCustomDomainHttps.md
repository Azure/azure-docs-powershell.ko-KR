...
## 설명은
**Disable-AzFrontDoorCustomDomainHttps** 는 사용자 지정 도메인에 대해 HTTPS를 비활성화 합니다.

## 예제의

### 예제 1: FrontDoorName 및 ResourceGroupName를 사용 하는 사용자 지정 도메인에 대해 HTTPS를 비활성화 합니다.
```powershell
...
"Frontendpointname1-custom-xyz" 사용자 지정 도메인에 대해 HTTPS를 사용 하지 않도록 설정 하 고 FrontDoorName "frontdoor1" 및 ResourceGroupName를 "resourcegroup1"로 바꿉니다.

### 예제 2: PSFrontendEndpoint 개체를 사용 하는 사용자 지정 도메인에 대해 HTTPS를 사용 하지 않도록 설정 합니다.
```powershell
...
PSFrontendEndpoint 개체를 사용 하는 사용자 지정 도메인에 대해 HTTPS를 사용 하지 않도록 설정 합니다.

### 예제 3: ResourceId를 사용 하는 사용자 지정 도메인에 대해 HTTPS를 비활성화 합니다.
```powershell
...
$ResourceId에 ResourceId가 있는 사용자 지정 도메인 "frontendpointname1-xyz"에 대해 HTTPS를 사용 하지 않도록 설정 합니다.
...
### -ResourceId
Https를 사용 하지 않도록 설정 하는 프론트 도어 끝점의 리소스 Id입니다.
