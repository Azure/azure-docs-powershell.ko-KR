...
## 설명은
**AzBatchComputeNode** cmdlet은 풀에서 Azure 일괄 처리 계산 노드를 가져옵니다.
...
이 명령은 Get-AzBatchPool cmdlet을 사용 하 여 ID Pool07 있는 풀을 가져옵니다.
...
**Pscloudpool** 개체를 가져오려면 Get-AzBatchPool cmdlet을 사용 합니다.
