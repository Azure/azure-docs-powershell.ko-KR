...
## 설명
Get-AzMapsAccount cmdlet은 리소스 그룹 및 이름 또는 리소스 ID로 프로비전된 Azure Maps 계정을 얻습니다. 또한 ResourceGroup의 모든 계정 목록 또는 현재 구독에 대한 모든 Azure Maps 계정 목록을 반환할 수 있습니다.
...
리소스 그룹 MyResourceGroup에 MyAccount라는 계정이 있는 경우 해당 계정을 얻습니다.
...
리소스 그룹 MyResourceGroup의 모든 Azure Maps 계정을 얻습니다.
