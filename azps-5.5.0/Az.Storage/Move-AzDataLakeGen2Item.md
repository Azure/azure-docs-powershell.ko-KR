...
## 설명
**Move-AzDataLakeGen2Item** cmdlet은 파일 또는 디렉터리를 동일한 Storage 계정의 다른 파일 또는 디렉터리로 이동합니다.
...
이 명령은 디렉터리 'dir1'을 동일한 파일 파일의 디렉터리 'dir3'로 이동합니다.

### 예제 2: 파이프라인을 통해 동일한 Storage 계정의 다른 파일 시스템으로 프롬프트 없이 파일 이동
```
...
이 명령은 'filesystem1'의 'dir1/file1' 파일을 프롬프트 없이 동일한 Storage 계정의 'filesystem2'에 있는 'dir2/file2' 파일로 이동합니다.
...
### -InputObject
이동할 Azure Datalake Gen2 항목 개체입니다.
