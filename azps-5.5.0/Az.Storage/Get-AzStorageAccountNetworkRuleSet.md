...
## 설명
**Get-AzStorageAccountNetworkRuleSet** cmdlet은 Storage 계정의 NetworkRule 속성을 얻습니다.

## 예제

### 예제 1: 지정된 Storage 계정의 NetworkRule 속성 얻기
```
PS C:\> Get-AzStorageAccountNetworkRuleSet  -ResourceGroupName "rg1" -AccountName "mystorageaccount"
```

이 명령은 지정된 Storage 계정의 NetworkRule 속성을 얻습니다.
