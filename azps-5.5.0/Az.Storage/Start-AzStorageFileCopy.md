...
## 설명
**Start-AzStorageFileCopy** cmdlet은 원본 파일을 대상 파일에 복사하기 시작합니다.

## 예제

### 예제 1: 공유 이름 및 파일 이름을 사용하여 파일에서 파일로 복사 작업 시작
```
...
이 명령은 파일에서 파일로 복사 작업을 시작합니다.
이 명령은 공유 이름 및 파일 이름을 지정합니다.

### 예제 2: 컨테이너 이름 및 Blob 이름을 사용하여 Blob에서 파일로 복사 작업 시작
```
...
이 명령은 Blob에서 파일로 복사 작업을 시작합니다.
이 명령은 컨테이너 이름 및 Blob 이름을 지정합니다.

## PARAMETERS

### -AbsoluteUri
원본 파일의 URI를 지정합니다.
원본 위치에 자격 증명이 필요한 경우 자격 증명을 제공해야 합니다.
...
### -DestContext
대상의 Azure Storage 컨텍스트를 지정합니다.
컨텍스트를 얻습니다. **New-AzStorageContext를 사용 합니다.**
...
### -DestFile
**CloudFile** 개체를 지정합니다.
클라우드 파일을 만들거나 클라우드 cmdlet을 사용하여 Get-AzStorageFile 있습니다.
...
### -SrcBlob
**CloudBlob** 개체를 지정합니다.
클라우드 Blob을 만들거나 다음 cmdlet을 사용하여 Get-AzStorageBlob 있습니다.
...
### -SrcContainer
클라우드 Blob 컨테이너 개체를 지정합니다.
클라우드 Blob 컨테이너 개체를 만들거나 다음 cmdlet을 Get-AzStorageContainer 있습니다.
...
### -SrcFile
**CloudFile** 개체를 지정합니다.
**Get-AzStorageFile을** 사용하여 클라우드 파일을 만들거나 클라우드 파일을 얻을 수 있습니다.
...
### -SrcFilePath
원본 디렉터리 또는 원본 공유를 상대로 원본 파일의 경로를 지정합니다.
...
### -SrcShare
클라우드 파일 공유 개체를 지정합니다.
클라우드 파일 공유를 만들거나 Get-AzStorageShare 수 있습니다.
