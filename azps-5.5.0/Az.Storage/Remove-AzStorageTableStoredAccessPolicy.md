...
## 설명
**Remove-AzStorageTableStoredAccessPolicy** cmdlet은 Azure 저장소 테이블에서 저장된 액세스 정책을 제거합니다.

## 예제

### 예제 1: 저장소 테이블에서 저장된 액세스 정책 제거
```
PS C:\>Remove-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy05"
```

이 명령은 MyTable이라는 저장소 테이블에서 Policy05라는 정책을 제거합니다.
