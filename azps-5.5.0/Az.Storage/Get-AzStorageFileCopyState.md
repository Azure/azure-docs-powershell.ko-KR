...
### 예제 2: 복사 및 파이프라인을 시작하여 복사 상태 얻기
```
...
첫 번째 명령은 "contosofile" 파일을 "contosofile_copy"로 복사하고 destiantion 파일 개체를 출력합니다. 두 번째 명령 파이프라인은 Destiantion 파일 개체를 Get-AzStorageFileCopyState로 파이프라인하여 파일 복사 상태를 얻습니다.
