...
## 설명
**Get-AzDataLakeGen2ItemContent** cmdlet은 Azure 저장소 계정의 파일 시스템으로 파일을 다운로드합니다.
...
### 예제 2: 파일을 다운로드한 다음, 파일을 로컬 파일에 다운로드하는 파이프라인
```
...
이 명령은 먼저 파일을 다운로드한 다음, 파일을 로컬 파일에 다운로드하는 파이프라인을 얻습니다.
