...
## 설명
**Get-AzDataLakeGen2Item** cmdlet은 Azure 저장소 계정의 파일 시스템으로 파일 또는 디렉터리의 세부 정보를 얻습니다.
...
### 예제 1: 파일에서 디렉터리를 다운로드하고 세부 정보 표시
```
...
이 명령은 파일 파일에서 디렉터리를 다운로드하고 세부 정보를 보여 주며,

### 예제 2: 파일 시스템에서 파일 다운로드
```
...
이 명령은 파일 시스템으로부터 파일의 세부 정보를 얻습니다. 
...
파일 파일의 루트 디렉터리를 얻게 이 매개 변수를 지정하지 않습니다.
