...
## 설명
**Remove-AzStorageCORSRule** cmdlet은 Azure Storage 서비스에 대한 CORS(원본 간 리소스 공유)를 제거합니다.
이 cmdlet은 Storage 서비스 형식의 모든 CORS 규칙을 삭제합니다.
이 cmdlet에 대한 저장소 서비스의 유형은 Blob, 테이블, 큐 및 파일입니다.

## 예제

### 예제 1: Blob service에 대한 CORS 규칙 제거
```
PS C:\>Remove-AzStorageCORSRule -ServiceType Blob
```

이 명령은 Blob service 형식에 대한 CORS 규칙을 제거합니다.
...
저장소 컨텍스트를 얻기 위해 New-AzStorageContext cmdlet을 실행합니다.
...
### -ServiceType
이 cmdlet에서 규칙을 제거하는 Azure Storage 서비스 유형을 지정합니다.
이 매개 변수에 허용되는 값은
- Blob 
- 표 
- 큐 
