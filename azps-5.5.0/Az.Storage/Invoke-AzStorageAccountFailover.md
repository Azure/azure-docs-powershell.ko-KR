...
3. 저장소 계정에 대해 GRS를 다시 사용하도록 설정하면 Microsoft는 새 보조 지역에 데이터를 복제합니다. 복제 시간은 복제할 데이터의 양에 따라 달라집니다. 부트스트락에 대한 대역폭 요금이 있습니다. https://azure.microsoft.com/en-us/pricing/details/bandwidth/
