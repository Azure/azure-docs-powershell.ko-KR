...
### 예제 1: 구독에 대한 기존 CommunicationServices 나열
```powershell
...
해당 구독의 모든 ACS 리소스 목록을 반환합니다.

### 예제 2: 지정된 Azure Communication 리소스에 대한 정보 얻기
```powershell
...
일치하는 제공된 매개 변수가 있는 경우 ACS 리소스에 대한 정보를 반환합니다.
