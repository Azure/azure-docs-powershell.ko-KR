...
## 설명
**New-AzSearchService** cmdlet은 지정된 매개 변수를 사용하여 Azure Cognitive Search 서비스를 만듭니다.
...
이 명령은 Azure Cognitive Search 서비스를 만듭니다.
...
### -HostingMode
Azure Cognitive Search 서비스 호스팅 모드입니다.
...
### -Location
Azure Cognitive Search 서비스 위치입니다.
...
### -PartitionCount
Azure Cognitive Search 서비스 파티션 수입니다.
...
### -PublicNetworkAccess
(선택 사항) Azure Cognitive Search Service 공용 네트워크 액세스(사용/비활성화)
...
### -ReplicaCount
Azure Cognitive Search 서비스 복제본 수입니다.
...
### -Sku
Azure Cognitive Search 서비스 SKU입니다.
