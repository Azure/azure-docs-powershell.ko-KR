...
### -DriveList
작업을 구성하는 드라이브 목록입니다.
생성을 위해 DRIVELIST 속성에 대한 NOTES 섹션을 참조하고 해시 테이블을 만드십시오.
...
### -LogLevel
오류 로깅 또는 Verbose 로깅을 사용하도록 설정되어 있는지 여부를 나타냅니다.
...
### -State
지정된 경우 값은 가져오기/내보내기 서비스에 작업의 패키지가 배송된 것을 알려 주어 배송되어야 합니다.
