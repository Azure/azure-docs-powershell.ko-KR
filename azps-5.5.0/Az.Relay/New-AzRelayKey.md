...
## 설명
**New-AzRelayKey** cmdlet은 주어진 Relay 엔터티(Namespace/WcfRelay/HybridConnection)에 대한 기본 및 보조 연결 문자열을 생성합니다.
...
주어진 Relay-Namespace 엔터티에 대한 기본 또는 보조 연결 문자열을 Relay-Namespace 생성합니다.

### 예제 1.1 - 네임스페이스 KeyValue 제공
```
...
제공된 키 값을 사용하여 제공된 Relay-Namespace 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
...
주어진 Relay-WcfRelay 엔터티에 대한 기본 또는 보조 연결 문자열을 Relay-WcfRelay 생성합니다.

### 예제 2.1 - 제공된 WcfRelay KeyValue
```
...
제공된 키 값을 사용하여 제공된 Relay-WcfRelay 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
...
주어진 Relay 엔터티(네임스페이스/WcfRelay/HybridConnection)에 대한 기본 또는 보조 연결 문자열을 다시 생성합니다.

### 예제 3.1 - HybridConnection KeyValue 제공
```
...
제공된 키 값을 사용하여 제공된 Relay-HybridConnection 엔터티에 대한 기본 또는 보조 연결 문자열을 생성합니다.
...
### -KeyValue
SAS 토큰 서명 및 유효성을 검사하기 위한 base64로 인코딩된 256비트 키입니다.
