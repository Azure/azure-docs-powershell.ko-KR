...
JSON 파일은 {과 유사한 구문을 사용하는 텍스트 파일입니다.  
    ...
    "Location": "West US",  
} **Set-AzNotificationHub** cmdlet과 함께 사용하는 경우 이전 JSON 샘플은 ContosoNotificationHub라는 알림 허브의 위치 값을 미국 서부로 설정합니다.
...
이 명령은 ContosoNamespace 네임스페이스에 있는 알림 허브의 속성 값을 수정하고 리소스 그룹 ContosoNotificationsGroup에 할당합니다.
