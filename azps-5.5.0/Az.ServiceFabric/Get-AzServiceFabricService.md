...
## SYNOPSIS
지정된 애플리케이션 및 클러스터에서 Service Fabric 서비스 세부 정보를 얻습니다. 배포된 ARM 지원됩니다.
...
## 설명
이 cmdlet은 지정된 애플리케이션 및 클러스터에서 서비스 세부 정보를 얻습니다.
...
이 예제에서는 "testApp~testService" 서비스에 대한 서비스 리소스 세부 정보를 얻습니다.
...
이 예제에서는 애플리케이션 "testApp"에서 서비스 목록을 얻습니다.
