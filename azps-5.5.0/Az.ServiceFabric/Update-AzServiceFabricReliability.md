...
## 설명
**Update-AzServiceFabricReliability를** 사용하여 클러스터의 주 노드 형식의 안정성을 업데이트합니다.
...
이 명령은 주 노드 유형의 안정성 계층을 실버로 변경합니다.

### 예제 2

클러스터에서 주 노드 유형의 안정성 계층을 업데이트합니다. (자동Generated)
