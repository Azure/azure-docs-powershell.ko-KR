...
## 설명
**Get-AzIntegrationAccountAssembly** cmdlet은 통합 계정에서 어셈블리를 얻습니다.

## 예제

### 예제 1: 매개 변수로 어셈블리를 얻게
```powershell
...
리소스 그룹 "sampleResourceGroup"에 포함된 통합 계정 "sampleIntegrationAccount"에 있는 "sampleAssembly"라는 어셈블리를 얻습니다.

### 예제 2: 매개 변수를 사용하여 통합 계정의 모든 어셈블리 나열
```powershell
...
"sampleResourceGroup" 리소스 그룹에 포함된 통합 계정 "sampleIntegrationAccount"에 있는 모든 어셈블리를 얻습니다.
