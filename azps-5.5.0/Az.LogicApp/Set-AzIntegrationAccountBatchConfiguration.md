...
"$batchConfigurationFilePath"에 포함된 파일 경로에 있는 로컬 파일을 사용하여 "sampleBatchConfig"라는 배치 구성을 수정합니다.
...
"$batchConfigurationContent"에 포함된 JSON 문자열을 사용하여 "sampleBatchConfig"라는 배치 구성을 수정합니다.
