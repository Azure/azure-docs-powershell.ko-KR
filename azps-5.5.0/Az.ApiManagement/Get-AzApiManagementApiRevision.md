...
## 설명
**Get-AzApiManagementApiRevision** cmdlet은 API의 모든 개정에 대한 세부 정보를 얻습니다.

## 예제

### 예제 1: API의 모든 API 개정을 얻습니다.
```powershell
...
이 명령은 특정 ApiManagement 컨텍스트에 대해 지정된 API의 모든 API 개정을 얻습니다.

## PARAMETERS

### -ApiId
나열하려는 개정이 있는 API 식별자입니다.
이 매개 변수는 필수입니다.
