...
## 설명
**Set-AzApiManagementApiSchema** cmdlet은 Azure API Management APIChema를 수정합니다.
...
이 예제에서는 Api Schema를 업데이트합니다.

### 예제 2

API Schema를 수정합니다. (자동Generated)
...
### -ResourceId
진단 또는 Api Schema의 Arm ResourceId입니다. 이 매개 변수는 필수입니다.
...
### -SchemaDocument
Api Schema 문서를 문자열로 지정합니다. 이 매개 변수는 -SchemaDocumentFile이 지정되지 않은 것입니다.
...
api Schema의 ContentType입니다. 이 매개 변수는 선택 사항입니다.
...
Api schema 문서 파일 경로입니다. 이 매개 변수는 -SchemaDocument가 지정되지 않은 것입니다.
