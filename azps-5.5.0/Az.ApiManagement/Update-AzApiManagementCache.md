...
## 설명
Cmdlet **Update-AzApiManagementCache는** ApiManagement 서비스의 캐시를 업데이트합니다.

## 예제

### 예제 1: 중앙에서 캐시에 대한 설명 업데이트
```powershell
...
### -PassThru
지정된 경우 수정된 캐시를 나타내는 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementCache 형식의 인스턴스가 출력에 기록됩니다.
