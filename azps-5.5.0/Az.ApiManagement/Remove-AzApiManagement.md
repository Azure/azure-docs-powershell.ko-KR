...
## 설명
**Remove-AzApiManagement** cmdlet은 Azure API Management 서비스를 제거합니다.
...
이 명령은 ContosoApi라는 API Management 서비스를 제거합니다.
...
### -Name
이 cmdlet에서 제거하는 API Management 배포의 이름을 지정합니다.
...
### -PassThru
이 cmdlet은 작업이 성공하면 $True 값을 반환합니다.
