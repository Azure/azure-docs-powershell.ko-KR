...
## 설명
**New-AzApiManagementProduct** cmdlet은 API Management 제품을 만듭니다.

## 예제

### 예제 1: 구독이 필요하지 않은 제품 만들기
```
...
이 명령은 제품을 만듭니다.
구독 및 승인이 필요합니다.
이 명령은 알림 기간을 10일로 설정합니다.
구독 기간은 1년으로 설정됩니다.

## PARAMETERS

### -ApprovalRequired
제품에 대한 구독에 승인이 필요한지 여부를 나타냅니다.
기본적으로 이 매개 변수는 **$False.**
