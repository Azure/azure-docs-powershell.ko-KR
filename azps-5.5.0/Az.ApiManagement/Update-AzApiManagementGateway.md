...
## 설명
**Update-AzApiManagementGateway** cmdlet은 API Management Gateway를 구성합니다.
...
### -InputObject
PsApiManagementGateway의 인스턴스입니다. 이 매개 변수는 필수입니다.
...
### -PassThru
지정된 경우 수정된 게이트웨이를 나타내는 Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway 형식의 인스턴스입니다.
...
### -ResourceId
게이트웨이의 Arm ResourceId입니다. 이 매개 변수는 필수입니다.
