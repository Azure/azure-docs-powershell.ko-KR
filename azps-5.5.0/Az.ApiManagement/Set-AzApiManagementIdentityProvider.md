...
이 cmdlet은 Facebook ID 공급자의 클라이언트 비밀을 업데이트합니다.

### 예제 2

기존 ID 공급자의 구성을 업데이트합니다. (자동Generated)
...
### -AllowedTenants
허용되는 Azure Active Directory 테넌트 목록입니다.
...
### -PassThru
이 cmdlet이 이 cmdlet이 수정한  **PsApiManagementIdentityProvider를** 반환합니다.
