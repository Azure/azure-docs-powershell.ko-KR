...
## 설명
**Set-AzAutomationCertificate** cmdlet은 Azure Automation에서 인증서 구성을 수정합니다.
...
두 번째 명령은 ContosoCertificate라는 인증서를 수정합니다.
이 명령은 사용자 이름에 저장된 암호를 $Password.
이 명령은 업로드하는 파일의 계정 이름 및 경로를 지정합니다.

## PARAMETERS

### -AutomationAccountName
이 cmdlet이 인증서를 수정하는 Automation 계정의 이름을 지정합니다.
...
### -Description
이 cmdlet이 수정하는 인증서에 대한 설명을 지정합니다.
...
### -Path
업로드할 스크립트 파일의 경로를 지정합니다.
파일은 .cer 파일 또는 .pfx 파일일 수 있습니다.
...
### -ResourceGroupName
이 cmdlet이 인증서를 수정하는 리소스 그룹의 이름을 지정합니다.
