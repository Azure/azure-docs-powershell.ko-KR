...
Automation Runbook을 만듭니다. (자동Generated)
...
이 cmdlet이 Runbook을 만드는 Automation 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 Runbook을 만드는 리소스 그룹의 이름을 지정합니다.
