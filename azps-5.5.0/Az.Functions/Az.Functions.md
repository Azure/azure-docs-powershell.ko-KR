...
# Az.Functions 모듈
## 설명
Microsoft Azure PowerShell - Windows PowerShell 및 PowerShell Core.\n\nFor의 Azure Resource Manager용 Azure Functions 서비스 cmdlet은 다음을 방문하세요. https://docs.microsoft.com/azure/azure-functions/
...
주어진 os 및 계획 유형에 대한 함수 앱을 사용할 수 있는 위치를 얻습니다.
...
지정된 RP 범위에서 사용할 수 있는 systemAssignedIdentity를 얻습니다.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
웹 사이트의 함수 또는 배포 슬롯에 대한 함수 키 Get에 대한 설명입니다.
...
구성 참조 앱 설정 및 앱 상태를 확인할 수 있는 설명

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
이에 대한 설명은 powershell 및 템플릿을 통한 호출을 ARM 합니다.
...
### [Test-Az](Test-Az.md)
리소스를 만들 수 있는 경우 유효성 검사에 대한 설명입니다.
