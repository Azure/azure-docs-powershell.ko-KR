...
INPUTOBJECT: <ISite> 
  ...
  - `[Config <ISiteConfig>]`: 앱의 구성입니다.
    - `IsPushEnabled <Boolean>`: 푸시 엔드포인트를 사용할 수 있는지 여부를 나타내는 플래그를 얻거나 설정합니다.
