...
### 예제 1: Windows에서 프리미엄을 사용할 수 있는 위치를 얻습니다. 매개 변수를 지정하지 않으면 PlanType이 'Premium'으로 설정되어 OSType이 'Windows'로 설정됩니다.
```powershell
...
이 명령은 Windows에서 프리미엄을 사용할 수 있는 위치를 얻습니다.

### 예제 2: Linux에서 프리미엄을 사용할 수 있는 위치를 얻습니다.
```powershell
...
이 명령은 Linux에서 프리미엄을 사용할 수 있는 위치를 얻습니다.
