...
## 설명
**Get-AzMetricAlertRuleV2** cmdlet은 이름 또는 URI 또는 지정된 리소스 그룹 또는 구독의 모든 메트릭 경고 규칙에 따라 메트릭 경고 규칙을 얻습니다.

## 예제

### 예제 1: 현재 구독의 모든 메트릭 경고 규칙 얻기
```powershell
