...
## 설명
**New-AzActionGroupReceiver** cmdlet은 메모리에 새 작업 그룹 수신기를 만듭니다.

## 예제

### 예제 1: 메모리에 새 전자 메일 수신기를 만드십시오.
```
...
### 예제 3: 메모리에 새 웹후크 수신기를 만드십시오.
```
PS C:\>$webhookReceiver = New-AzActionGroupReceiver -Name 'webhookReceiver1' -WebhookReceiver -ServiceUri 'http://test.com'
```

이 명령은 메모리에 새 웹후크 수신기를 만듭니다.
...
일반적인 경고 SCHEMA를 사용할지 여부에 대한 플래그입니다. 이 값은 SMS, Azure 앱 푸시, ITSM 및 음성 수신자에서 무시됩니다.
