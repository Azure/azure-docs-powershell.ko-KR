...
## 설명
**Add-AzAutoscaleSetting** cmdlet은 자동 크기 조정 설정을 만듭니다.
...
처음 두 명령은 [New-AzAutoscaleRule을](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) 사용하여 두 개의 자동 조정 규칙인 $Rule 1 및 $Rule 2를 생성합니다.
세 번째 및 네 번째 명령은 [New-AzAutoscaleProfile을](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) 사용하여 $Rule 1 및 $Profile 2를 사용하여 $Profile 1 및 $Profile 2 자동 조정 프로필을 $Rule.
마지막 명령은 $Profile 1 및 $Profile 2의 프로필을 사용하여 자동 조정 설정을 만듭니다.

## PARAMETERS

### -AutoscaleProfile
자동 조정 설정에 추가할 프로필 목록을 지정하거나 프로필을 $Null 수 있습니다.
...
### -ResourceGroupName
자동 조정 설정과 연결된 리소스에 대한 리소스 그룹의 이름을 지정합니다.
