...
## SYNOPSIS
V2(클래식이 아닌) 메트릭 경고 규칙을 제거합니다.

## 구문

### ByMetricRuleResourceName(기본값)
```
...
## 설명
**Remove-AzMetricAlertRuleV2** cmdlet은 경고 규칙을 제거합니다. 이 cmdlet은 ShouldProcess 패턴을 구현합니다. 즉, 리소스를 실제로 만들거나 수정하거나 제거하기 전에 사용자로부터 확인을 요청할 수 있습니다.
...
이 명령은 리소스 ID를 사용하여 경고 규칙을 제거합니다. `/subscriptions/00000000-0000-0000-0000-0000000/resourceGroups/metricAlertRG/providers/microsoft.insights/metricAlerts/myAlertRule`
