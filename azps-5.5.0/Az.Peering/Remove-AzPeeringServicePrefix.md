...
## 설명
피어링 서비스에서 피어링 서비스 Prefix를 제거합니다.
...
피어링 서비스 리소스 ID에서 prefix를 제거합니다.
...
피어링 서비스 리소스 그룹 이름 및 이름에서 prefix 제거
...
### -PassThru
성공의 경우 true, 실패한 경우 false를 반환합니다.
