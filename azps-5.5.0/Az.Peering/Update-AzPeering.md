...
피어링 서비스 플래그에 대한 사용 설정

### Exchange 피어링에 대한 IPv4 주소 업데이트
```powershell
...
ResourceId를 사용하여 Exchange 피어링에 대한 Ipv4 주소를 설정
...
### -DirectConnection
다음 명령을 사용하여 새 직접 New-AzDirectPeeringConnectionObject 이 명령에 파이프합니다.
...
### -ExchangeConnection
다음 명령을 사용하여 새 Exchange New-AzExchangePeeringConnectionObject 이 명령에 파이프합니다.
