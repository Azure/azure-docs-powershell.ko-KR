...
## 설명
**Set-AzDataLakeStoreTrustedIdProvider** cmdlet은 지정된 Data Lake Store에서 지정된 신뢰할 수 있는 ID 공급자를 수정합니다.

## 예제

### 예제 1: 신뢰할 수 있는 ID 공급자 엔드포인트 업데이트
```
...
"ContosoADL" 계정의 방화벽 규칙 "MyProvider"에 대한 공급자 엔드포인트를 ""로 https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 업데이트합니다.

## PARAMETERS

### -Account
신뢰할 수 있는 ID 공급자를 추가할 Data Lake Store 계정
...
### -ResourceGroupName
신뢰할 수 있는 ID 공급자를 업데이트할 계정이 포함된 리소스 그룹의 이름을 지정합니다.
