...
## 설명
**Add-AzDataLakeStoreTrustedIdProvider** cmdlet은 지정된 Data Lake Store 계정에 신뢰할 수 있는 ID 공급자를 추가합니다.
...
공급자 엔드포인트 ""를 통해 "ContosoADL"을 계정에 "MyProvider"를 https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 추가합니다.

## PARAMETERS

### -Account
지정된 신뢰할 수 있는 ID 공급자를 추가할 Data Lake Store 계정의 이름입니다.
...
### -ProviderEndpoint
유효한 신뢰할 수 있는 공급자 엔드포인트 형식: https://sts.windows.net/ \<provider identity\> "
