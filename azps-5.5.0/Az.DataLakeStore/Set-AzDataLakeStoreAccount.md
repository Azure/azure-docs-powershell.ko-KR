...
Data Lake Store 계정을 수정합니다. (자동Generated)
...
### -DefaultGroup
AzureActive 디렉터리 그룹의 ID를 지정합니다.
이 그룹은 만드는 파일 및 폴더에 대한 기본 그룹입니다.
...
### -FirewallState
선택적으로 기존 방화벽 규칙을 사용 또는 사용하지 않도록 설정합니다.
...
선택적으로 기존 신뢰할 수 있는 ID 공급자를 사용 또는 사용하지 않도록 설정합니다.
