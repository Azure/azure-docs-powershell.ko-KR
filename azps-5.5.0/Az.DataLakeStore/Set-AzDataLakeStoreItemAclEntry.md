...
## 설명
**Set-AzDataLakeStoreItemAclEntry** cmdlet은 Data Lake Store의 파일 또는 폴더의 ACL(액세스 제어 목록)에서 ACE(항목)를 수정합니다.
...
이 명령은 모든 사용 권한을 하게 하여 ACE for Patti Fuller를 수정합니다.

### 예제 2: 재발적으로 ACE에 대한 권한 수정
```
