...
## 설명
Event Grid 토픽의 속성을 지정합니다. Event Grid 토픽의 태그를 바꾸는 데 사용할 수 있습니다.
...
태그를 지정된 태그 "Department" 및 "Environment"로 바꾸기 위해 리소스 그룹 \` \` \` MyResourceGroupName에서 Event Grid 항목 Topic1의 \` 속성을 설정합니다.
