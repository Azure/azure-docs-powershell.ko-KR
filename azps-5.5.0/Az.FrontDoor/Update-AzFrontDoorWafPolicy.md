...
## 설명
**Update-AzFrontDoorWafPolicy** cmdlet은 기존 WAF 정책을 업데이트합니다. 입력 매개 변수가 제공되지 않은 경우 기존 WAF 정책의 이전 매개 변수가 사용됩니다.
...
다음의 모든 WAF 정책을 $resourceGroupName
...
### -EnabledState
정책이 활성화된 상태인지 또는 비활성화 상태인지 여부입니다.
...
### -RequestBodyCheck
관리되는 규칙에 의해 본문을 검사해야 하는지 정의합니다. 가능한 값은 'Enabled', 'Disabled'입니다.
