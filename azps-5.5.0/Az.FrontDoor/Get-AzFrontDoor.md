...
## 설명
**Get-AzFrontDoor** cmdletGet은 제공된 정보와 일치하는 현재 구독의 모든 기존 Front Door를 얻습니다.

## 예제

### 예제 1: 현재 구독의 모든 FrontDoors를 얻습니다.
```powershell
...
현재 구독의 모든 FrontDoors를 얻습니다.

### 예제 2: 현재 구독의 리소스 그룹 "rg1"에 있는 모든 FrontDoors를 얻습니다.
```powershell
...
현재 구독의 리소스 그룹 "rg1"에 있는 모든 FrontDoors를 얻습니다.

### 예제 3: 현재 구독에서 이름이 "frontDoor1"인 리소스 그룹 "rg1"의 FrontDoors를 얻습니다.
```powershell
...
현재 구독에서 이름이 "frontDoor1"인 리소스 그룹 "rg1"의 FrontDoors를 얻습니다.
