...
## 설명
**New-AzFrontDoor** cmdlet은 현재 구독의 지정된 리소스 그룹에 새 Azure Front Door 부하 부하를 만듭니다.

## 예제

### 예제 1: 주어진 매개 변수를 기반으로 Front Door를 생성합니다.
```powershell
...
주어진 매개 변수를 기반으로 Front Door를 생성합니다.

## PARAMETERS

### -BackendPool
라우팅 규칙에 사용할 수 있는 백endpools입니다.
...
### -EnabledState
Front Door 부하 균형 조정의 EnabledState입니다.
