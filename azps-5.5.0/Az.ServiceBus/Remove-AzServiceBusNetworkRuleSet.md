...
이름: defaultAction : 허용 ID : /subscriptions/subscriptionId/resourceGroups/ResourceGroup/providers/Microsoft.ServiceBus/namespaces/ServiceBus-Namespace-1375/networkRuleSets/default Type : Microsoft.ServiceBus/Namespaces/NetworkRuleSet IpRules : VirtualNetworkRules : 

주어진 "ServiceBus-Namespace1-1375" 네임스페이스에 대한 NetworkRuleSet을 삭제합니다. 

### 예제 2
```powershell
PS C:\> Remove-AzServiceBusNetworkRuleSet -InputObject $result1375
```
이름 : defaultAction : 허용 ID : /subscriptions/subscriptionId/resourceGroups/RSG-TestAzEventhub/providers/Microsoft.EventHub/namespaces/Eventhub-Namespace-1375/networkRuleSets/default Type : Microsoft.EventHub/Namespaces/NetworkRuleSet IpRules : VirtualNetworkRules : 

InputObject를 사용하여 NetworkRuleSet을 삭제합니다. 
...
네임스페이스의 ResourceId를 사용하여 NetworkRuleSet을 삭제합니다.
