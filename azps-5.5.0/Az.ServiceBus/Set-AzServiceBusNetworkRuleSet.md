...
## 설명
현재 Azure 구독에서 주어진 네임스페이스의 NetwrokruleSet을 업데이트합니다.
...
-InputObject를 사용하여 NetworkRuleSet 업데이트
...
다른 네임스페이스의 -ResourceId를 사용하여 NetworkRuleSet을 업데이트합니다.

## PARAMETERS

### -DefaultAction
NetworkRuleSet에 대한 기본 작업
