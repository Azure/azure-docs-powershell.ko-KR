...
주어진 네임스페이스에 대해 주어진 서브넷 및 IgnoreMissingVnetServiceEndpoint(VirtualNetworkRule)를 NetworkRuleSet에 추가합니다.
...
주어진 네임스페이스에 $virtualruleset 1을 NetworkRuleSet에 추가합니다.
