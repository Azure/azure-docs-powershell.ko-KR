...
## 설명
**New-AzServiceBusNamespace** cmdlet은 새 Service Bus 네임스페이스를 만듭니다. 네임스페이스 리소스 매니페스트를 만들면 변경이 불가능합니다. 이 작업은 idempotent입니다.
...
지정된 리소스 그룹 내에서 새 Service Bus 네임스페이스를 만듭니다.
...
### -SkuCapacity
Service Bus 프리미엄 네임스페이스의 작업당 단위(허용되는 값 1 또는 2 또는 4)
