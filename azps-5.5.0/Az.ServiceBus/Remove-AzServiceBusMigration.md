...
## 설명
**Remove-AzServiceBusMigration** cmdlet은 표준-프리미엄 네임스페이스에 대한 마이그레이션 구성을 삭제합니다.
...
'TestingNamespaceStandardMigration' 마이그레이션 구성을 삭제합니다.
...
### -InputObject
Service Bus 마이그레이션 표준 네임스페이스 개체
