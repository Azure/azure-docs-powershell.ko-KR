...
**Backup-AzRecoveryServicesBackupItem** cmdlet은 보호된 Azure 백업 항목의 추가 백업을 생성합니다. 이 cmdlet을 사용하면 보호를 사용하도록 설정한 직후에 초기 백업을 수행하거나 예약된 백업이 실패하는 경우 백업을 시작할 수 있습니다. 이 cmdlet은 만료 날짜가 있는 사용자 지정 보존에 사용할 수도 있습니다. 자세한 내용은 매개 변수 도움말 텍스트를 참조합니다. 

## 예제

### 예제 1: Backup 항목에 대한 백업 시작
...
첫 번째 명령은 pstestv2vm1이라는 AzureVM 유형의 Backup 컨테이너를 $NamedContainer 변수에 저장합니다.
두 번째 명령은 $NamedContainer 컨테이너에 해당하는 Backup 항목을 $Item 변수에 저장합니다.
마지막 명령은 백업 항목의 백업 작업을 $Item.

### 예제 2

Backup 항목에 대한 백업을 시작합니다. (자동Generated)
