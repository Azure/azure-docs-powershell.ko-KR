...
## 설명
이 Disable-AzRecoveryServicesBackupRPMountScript cmdlet은 Get-AzRecoveryServicesBackupRPMountScript cmdlet을 사용하여 탑재된 복구 지점의 파일을 Get-AzRecoveryServicesBackupRPMountScript 않습니다.
...
복구 지점의 모든 파일을 디스패치합니다. (자동Generated)
