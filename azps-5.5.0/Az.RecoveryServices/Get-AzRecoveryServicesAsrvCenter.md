...
## 설명
**Get-AzRecoveryServicesAsrvCenter** cmdlet은 ASR 패브릭에서 지정한 구성 서버에서 검색을 위해 등록된 vCenter 서버의 세부 정보를 얻습니다.
...
패브릭 이름 및 vCenter의 이름으로 Azure Site Recovery vCenter를 얻습니다.
