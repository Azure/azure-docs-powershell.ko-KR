...
## 설명
**Enable-AzRecoveryServicesBackupProtection** cmdlet은 보호 정책을 항목에 연결하여 백업을 활성화합니다.
...
세 번째 cmdlet은 V2VM이라는 ARM V2VM에 대한 Backup 보호 정책을 $Pol.
