...
## 설명
**Get-AzRecoveryServicesAsrNetworkMapping** cmdlet은 Recovery Services 자격 증명 모음에 대한 Azure Site Recovery 네트워크 매핑에 대한 정보를 얻습니다.
...
지정된 Azure Site Recovery 패브릭에서 제공된 이름으로 네트워크 매핑을 얻습니다.
...
### -Network
지정된 네트워크 ASR 개체에 해당하는 ASR 네트워크 매핑을 얻습니다.
...
### -PrimaryFabric
지정된 주 패브릭 개체에 해당하는 ASR 네트워크 매핑을 얻습니다.
