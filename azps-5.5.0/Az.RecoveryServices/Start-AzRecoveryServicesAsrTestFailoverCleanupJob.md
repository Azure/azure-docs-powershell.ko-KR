...
## 설명
**Start-AzRecoveryServicesAsrTestFailoverCleanupJob** cmdlet은 테스트 장애 조치(failover)가 수행된 복제 보호된 항목 또는 복구 계획에서 테스트 장애 조치(failover) 정리 작업을 시작합니다.

## 예제

### 예제 1

Azure Site Recovery RecoveryPlan의 테스트 장애 조치 정리를 추적하는 작업입니다.
...
테스트 장애 조치 정리 작업을 시작합니다. (자동Generated)
...
### -RecoveryPlan
테스트 장애 조치(failover) 정리를 수행하는 복구 계획입니다.
...
테스트 장애 조치(failover) 정리를 수행하는 복제 보호된 항목입니다.
...
### -ResourceId
테스트 장애 조치(failover) 정리를 위한 복제 보호 항목/복구 계획의 리소스 ID입니다.
