...
## 설명
이 New-AzCdnOrigin 지정된 엔드포인트 내에 새 CDN 원본을 생성합니다.
...
이 cmdlet은 지정된 엔드포인트에 대한 새 CDN 원본을 생성합니다. 제공된 호스트 이름을 원본으로 사용하게 됩니다. 
