...
이 명령은 "contosoadla" 계정의 모든 파이프라인 목록을 얻습니다.

## PARAMETERS

### -Account
작업 파이프라인을 검색하려는 Data Lake Analytics 계정 이름의 이름입니다.
...
### -SubmittedBefore
지정된 시간 전에만 제출된 작업 파이프라인을 반환하는 선택적 필터입니다.
