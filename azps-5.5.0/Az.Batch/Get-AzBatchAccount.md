...
이 명령은 CmdletExampleRG 리소스 그룹과 연결된 배치 계정을 얻습니다.
...
### -ResourceGroupName
리소스 그룹의 이름을 지정합니다.
리소스 그룹을 지정하는 경우 이 cmdlet은 지정된 리소스 그룹에서 계정을 얻습니다.
...
### -Tag
해시 테이블 형식의 키-값 쌍입니다. 예: @{key0="value0";key1=$null;key2="value2"} 이 cmdlet은 이 매개 변수가 지정하는 태그를 포함하는 계정을 얻습니다.
