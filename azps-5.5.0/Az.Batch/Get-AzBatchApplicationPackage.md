...
## 설명
**Get-AzBatchApplicationPackage** cmdlet은 Azure Batch 계정의 애플리케이션 패키지에 대한 정보를 얻습니다.

## 예제

### 예제 1: Batch 계정에서 애플리케이션 패키지의 세부 정보 확인
```
...
이 명령은 Litware 패키지 버전 1.0의 세부 정보를 얻습니다.

## PARAMETERS

### -AccountName
이 cmdlet이 정보를 얻을 Batch 계정의 이름을 지정합니다.
