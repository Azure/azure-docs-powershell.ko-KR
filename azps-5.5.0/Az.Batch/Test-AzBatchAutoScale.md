...
## 설명
**Test-AzBatchAutoScale** cmdlet은 지정된 풀에서 자동 크기 조정 수식의 결과를 얻습니다.

## 예제

### 예제 1: 풀에서 자동 조정 수식 평가
```
...
첫 번째 명령은 예제에서 사용할 수 $Formula 변수에 수식을 저장합니다.
두 번째 명령은 ID ContosoPool이 있는 풀에서 자동 조정 수식을 평가합니다.
마지막 명령은 표준 **점** 구문을 사용하여 결과를 표시합니다.
...
### -Id
자동 크기 조정을 테스트할 풀의 개체 ID를 지정합니다.
