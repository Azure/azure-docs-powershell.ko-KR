...
## 설명
이 Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate 인스턴스에 대해 투명한 데이터 암호화 인증서를 SQL Server 추가합니다.
...
리소스 그룹 이름 및 SQL Server 사용하여 SQL 서버에 TDE 인증서 추가
...
server resourceId를 사용하여 서버에 TDE 인증서 추가
