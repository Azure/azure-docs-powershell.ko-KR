...
### SetInstanceFailoverGroupDefaultSet(기본값)
```
...
## 설명
이 명령은 인스턴스 장애 조치(failover) 그룹의 구성을 수정합니다.

인스턴스 장애 조치 그룹의 주 지역을 사용하여 명령을 실행해야 합니다.
...
장애 조치(failover) 그룹에서 파이핑하여 인스턴스 장애 조치(failover) 그룹의 장애 조치(failover) 정책을 '수동'으로 설정합니다.
