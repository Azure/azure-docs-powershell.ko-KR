...
## 설명
**Update-AzSqlSyncGroup** cmdlet은 Azure SQL 데이터베이스 동기화 그룹의 속성을 수정합니다.

## 예제

### 예제 1: Azure SQL 데이터베이스의 동기화 그룹을 업데이트합니다.
```
...
이 동기화 그룹의 허브에 연결할 때 개인 링크 연결을 사용할지 여부입니다.
