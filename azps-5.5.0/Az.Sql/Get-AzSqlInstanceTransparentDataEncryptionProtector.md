...
## 설명
Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet은 지정된 관리되는 인스턴스에 SQL 보호기입니다.
...
이 명령은 ContosoResourceGroup이라는 리소스 그룹의 ContosoManagedInstanceName이라는 관리되는 인스턴스에 대한 TDE 보호기입니다.
