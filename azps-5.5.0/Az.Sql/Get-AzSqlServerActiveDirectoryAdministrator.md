...
## 설명
**Get-AzSqlServerActiveDirectoryAdministrator** cmdlet은 현재 구독에서 AzureSQL 서버에 대한 Azure AD(Azure Active Directory) 관리자에 대한 정보를 얻습니다.

## 예제

### 예제 1: 서버의 관리자에 대한 정보를 얻습니다.
```
...
이 명령은 ResourceGroup01이라는 리소스 그룹과 연결된 Server01 서버의 Azure AD 관리자에 대한 정보를 얻습니다.
...
### -ResourceGroupName
리소스 그룹이 할당된 리소스 SQL Server 지정합니다.
...
### -ServerName
이 cmdlet이 정보를 SQL Server 이름의 이름을 지정합니다.
