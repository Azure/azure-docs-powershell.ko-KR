...
## 설명
**Set-AzSqlServerFirewallRule** cmdlet은 Azure SQL 데이터베이스 서버에서 방화벽 규칙을 수정합니다.
...
이 명령은 Server01이라는 서버에서 Rule01이라는 방화벽 규칙을 수정합니다.
이 명령은 시작 및 끝 IP 주소를 수정합니다.
...
### -FirewallRuleName
이 cmdlet이 수정하는 방화벽 규칙의 이름을 지정합니다.
