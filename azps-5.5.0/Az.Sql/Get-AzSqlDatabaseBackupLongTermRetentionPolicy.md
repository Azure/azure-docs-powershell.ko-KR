...
## 설명
**Get-AzSqlDatabaseBackupLongTermRetentionPolicy** cmdlet은 이 데이터베이스에 등록된 장기 보존 정책을 얻습니다.
정책은 백업 저장소 정책을 정의하는 데 사용되는 Azure Backup 리소스입니다.

## 예제

### 예제 1: 현재 버전의 장기 보존 정책 다운로드
```powershell
...
이 명령은 database01에 대한 장기 보존 정책의 현재 버전을 얻습니다.
