...
## 설명
Invoke-AzSqlDatabaseFailover cmdlet은 Azure SQL 장애 조치합니다. 데이터베이스가 탄력적 풀에 있는 경우 이 명령은 동일한 탄력적 풀의 다른 데이터베이스에 영향을 주지 않고 주어진 데이터베이스를 장애 조치합니다.
...
이 명령은 "Server01"이라는 서버에서 "Database01"이라는 데이터베이스의 주 복제본을 장애 조치합니다.
...
### -DatabaseName
장애 조치할 Azure SQL 데이터베이스의 이름입니다.
...
### -ReadableSecondary
기본 주 복제본 대신 읽을 수 있는 보조 복제본 장애 조치
