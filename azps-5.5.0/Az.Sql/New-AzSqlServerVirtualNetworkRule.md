...
## 설명
Azure SQL Server Virtual Network 규칙을 만듭니다. Virtual Network 규칙은 Azure SQL Server Virtual Network 내에서만 사용할 수 있도록 Azure SQL Server 액세스를 제한하기 위해 특정 Virtual Network에 연결하는 데 사용됩니다. 
...
가상 네트워크에 vnet 서비스 엔드포인트를 사용하도록 설정하기 전에 방화벽 규칙을 생성합니다.
...
Azure Sql Server Virtual Network 규칙 이름입니다.
...
Microsoft.Network 세부 정보를 지정하는 Virtual Network 서브넷 ID
