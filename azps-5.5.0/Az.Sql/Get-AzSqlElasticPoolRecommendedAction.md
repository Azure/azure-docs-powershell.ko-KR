...
## 설명
**Get-AzSqlElasticPoolRecommendedAction** cmdlet은 Azure SQL 탄력적 풀 Advisor에 대해 권장되는 하나 이상의 작업을 얻습니다.
...
이 명령은 WIRunnerPool이라는 탄력적 풀에 사용할 수 있는 CreateIndex라는 Advisor의 모든 권장 작업 목록을 제공합니다.
...
이 명령은 \[ \] \[ CreateIndex라는 Advisor에서 IR_ test_schema _test_table_0.0361551 _6C7AE8CC9C87E7FD5893 권장되는 작업을 \] 얻습니다.
...
### -ElasticPoolName
이 cmdlet이 권장 작업을 요청하는 탄력적 풀의 이름을 지정합니다.
...
## 참고 사항
* 키워드: azure, azurerm, arm, 리소스, 관리, 관리자, sql, elasticpool, mssql, 관리자, recommendedaction
