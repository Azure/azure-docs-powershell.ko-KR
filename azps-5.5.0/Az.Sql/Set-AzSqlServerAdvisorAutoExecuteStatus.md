...
## 설명
**Set-AzSqlServerAdvisorAutoExecuteStatus** cmdlet은 Azure SQL Server Advisor에 대한 자동 실행 속성을 설정합니다.
...
이 명령을 사용하면 CreateIndex라는 Advisor의 자동 실행 상태를 사용할 수 있습니다.
...
### -AutoExecuteStatus
이 cmdlet이 자동 실행 상태를 업데이트하는 값을 지정합니다.
이 매개 변수에 허용되는 값은
- 사용
- 사용 안
- 기본값
