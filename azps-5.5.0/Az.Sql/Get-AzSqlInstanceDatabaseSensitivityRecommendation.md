...
## SYNOPSIS
Azure SQL 관리되는 인스턴스 데이터베이스에서 권장되는 정보 유형 및 민감도 레이블을 얻습니다.
...
## 설명
Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet은 Azure SQL 관리되는 인스턴스 데이터베이스에서 권장되는 정보 유형 및 민감도 레이블을 반환합니다.
