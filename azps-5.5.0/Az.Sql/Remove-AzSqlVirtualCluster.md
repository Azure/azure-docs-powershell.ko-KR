...
### RemoveVirtualClusterFromInputParameters(기본값)
```
...
## 설명
**Remove-AzSqlVirtualCluster** cmdlet은 Azure SQL Virtual Cluster를 제거합니다.
...
이 명령은 리소스 그룹 ResourceGroup01에 할당된 VirtualCluster1이라는 가상 클러스터를 제거합니다.
