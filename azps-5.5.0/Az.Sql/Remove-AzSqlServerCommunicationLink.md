...
## 설명
**Remove-AzSqlServerCommunicationLink** cmdlet은 Azure SQL Database에서 탄력적 데이터베이스 트랜잭션에 대한 서버 간 통신 링크를 삭제합니다.
...
이 명령은 ContosoServer17의 Link01이라는 서버 간 통신 링크를 삭제합니다.
...
### -LinkName
이 cmdlet이 삭제하는 서버 통신 링크의 이름을 지정합니다.
...
### -ServerName
서버의 이름을 지정합니다.
이 서버에는 이 cmdlet이 삭제하는 통신 링크가 포함되어 있습니다.
