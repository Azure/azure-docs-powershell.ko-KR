...
## 설명
Get-AzSqlInstanceKeyVaultKey cmdlet은 관리되는 인스턴스의 Key Vault 키에 SQL 정보를 얻습니다. 관리되는 인스턴스의 모든 키를 보거나 KeyId를 제공하여 특정 키를 볼 수 있습니다.
...
이 명령은 관리되는 인스턴스의 모든 Key Vault SQL 얻습니다.
