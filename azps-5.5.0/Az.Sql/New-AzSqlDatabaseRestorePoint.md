...
## 설명
**New-AzSqlDatabaseRestorePoint** cmdlet은 Azure SQL Data Warehouse를 복원할 수 있는 새 복원 지점을 만듭니다.
이 cmdlet은 현재 Azure SQL Data Warehouse에서 지원됩니다.
...
이 명령은 Azure SQL Data Warehouse에 대한 복원 지점을 만들고 복원 지점의 세부 정보를 반환합니다.
...
### -RestorePointLabel
쉽게 식별할 수 있도록 복원 지점의 레이블을 지정합니다.
