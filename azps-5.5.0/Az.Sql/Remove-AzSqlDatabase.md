...
## 설명
**Remove-AzSqlDatabase** cmdlet은 Azure SQL 제거합니다.
이 cmdlet은 Azure의 SQL Server Stretch Database 서비스에서도 지원됩니다.

## 예제

### 예제 1: Azure SQL 서버에서 데이터베이스 제거
```
PS C:\>Remove-AzSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

이 명령은 server Server01에서 Database01이라는 데이터베이스를 제거합니다.

## PARAMETERS

### -DatabaseName
이 cmdlet이 제거하는 데이터베이스의 이름을 지정합니다.
...
### -ResourceGroupName
데이터베이스가 할당된 Azure 리소스 그룹의 이름을 지정합니다.
