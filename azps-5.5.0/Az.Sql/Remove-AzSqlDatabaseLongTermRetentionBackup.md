...
## 설명
**Remove-AzSqlDatabaseLongTermRetentionBackup** cmdlet은 지정된 백업을 삭제합니다.

## 예제

### 예제 1: 리소스 그룹을 통해 단일 백업 삭제
```powershell
...
이름이 601061b7-d10b-46e0-bf77-a2bfb16a6add;13165666550000000인 백업을 삭제합니다.

### 예제 2: 리소스 그룹 없이 단일 백업 삭제
```powershell
...
이 명령은 northeurope 위치에 대한 모든 장기 보존 백업을 삭제합니다.
...
### -ServerName
백업이 SQL Server Azure 리소스의 이름입니다.
