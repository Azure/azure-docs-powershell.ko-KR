...
## 설명
**Set-AzSqlElasticPoolRecommendedActionState** cmdlet은 Azure SQL 탄력적 풀 권장 작업을 업데이트합니다.
이 cmdlet은 새 상태를 기반으로 권장되는 작업을 적용하거나, 되 돌리거나, 삭제합니다.
...
이 명령은 IR_ test_schema \[ \] \[ _test_table_0.0361551 _6C7AE8CC9C87E7FD5893 탄력적 풀 권장 작업의 상태를 \] 업데이트합니다.
...
### -State
이 cmdlet이 권장 작업 상태를 업데이트하는 값을 지정합니다.
이 매개 변수에 허용되는 값은
- 활성
- 보류 중
- PendingRevert
...
## 참고 사항
* 키워드: azure, azurerm, arm, 리소스, 관리, 관리자, sql, elasticpool, mssql, advisor, recommendedaction
