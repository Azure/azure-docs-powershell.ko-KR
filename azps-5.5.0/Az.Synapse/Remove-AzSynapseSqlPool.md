...
## 설명
**Remove-AzSynapseSqlPool** cmdlet은 Azure Synapse Analytics 풀을 SQL 삭제합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics SQL 풀을 삭제합니다.
...
이 명령은 지정된 리소스 ID를 SQL Azure Synapse Analytics 풀을 삭제합니다.
...
### -Version
Synapse SQL 버전입니다. 예를 들어 2 또는 3입니다.
