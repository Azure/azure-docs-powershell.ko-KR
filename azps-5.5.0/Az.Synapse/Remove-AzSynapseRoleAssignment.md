...
## 설명
**Remove-AzSynapseRoleAssignment** cmdlet은 Azure Synapse Analytics 역할 할당을 영구적으로 삭제합니다.
...
이 명령은 역할 할당 ID를 사용하여 Azure Synapse Analytics 역할 할당을 삭제합니다.
...
이 명령은 역할 이름 및 사용자 계정 이름으로 Azure Synapse Analytics 역할 할당을 삭제합니다.
...
이 명령은 파이프라인을 통해 역할 할당 ID가 있는 Azure Synapse Analytics 역할 할당을 삭제합니다.
