...
## 설명
**Remove-AzSynapseFirewallRule** cmdlet은 Azure Synapse Analytics 방화벽 규칙을 영구적으로 삭제합니다.
...
이 명령은 ContosoFirewallRule이라는 이름의 작업 영역 ContosoWorkspace에서 ContosoFirewallRule이라는 방화벽 규칙을 삭제합니다.
...
이 명령은 파이프라인을 통해 작업 영역 아래에 ContosoFirewallRule이라는 방화벽 규칙을 삭제합니다.
