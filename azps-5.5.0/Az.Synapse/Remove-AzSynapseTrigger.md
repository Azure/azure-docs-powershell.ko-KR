...
## 설명
**Remove-AzSynapseTrigger** cmdlet은 작업 영역의 트리거를 제거합니다.
...
작업 영역 ContosoWorkspace에서 ContosoTrigger라는 트리거를 제거합니다.
...
파이프라인을 통해 작업 영역 ContosoWorkspace에서 ContosoTrigger라는 트리거를 제거합니다.
