...
## 설명
Remove-AzSynapseSqlPoolSensitivityClassification cmdlet은 SQL 풀에 있는 열의 정보 형식 및 민감도 레이블을 제거합니다.

## 예제

### 예제 1: Azure Synapse 풀에서 열의 정보 유형 및 민감도 SQL 제거합니다.
```powershell
...
### 예제 2: Piping을 사용하여 Azure Synapse SQL 열의 현재 정보 유형 및 민감도 레이블을 제거합니다.
```powershell
...
### 예제 3: Piping을 사용하여 Azure Synapse SQL 열의 정보 유형 및 민감도 레이블을 제거합니다.
```powershell
