...
## 설명
Enable-AzSynapseSqlPoolSensitivityRecommendation cmdlet을 사용하면 SQL 풀의 열에 대한 민감도 권장 사항을 SQL 있습니다.

## 예제

### 예제 1: Azure Synapse 풀의 주어진 열에 대해 민감도 권장 SQL 있습니다.
```powershell
...
### 예제 2: Piping을 사용하여 Azure Synapse SQL 열에 대해 민감도 권장 사항을 사용하도록 설정합니다.
```powershell
