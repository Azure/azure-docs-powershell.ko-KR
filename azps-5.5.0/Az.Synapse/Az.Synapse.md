...
# Az.Synapse 모듈
## 설명
이 섹션의 항목에서는 Azure Synapse Analytics용 Azure PowerShell cmdlet을 설명합니다.
...
기본 풀에서 열에 대한 민감도 권장 사항(기본적으로 모든 열에서 권장 사항 사용)SQL 활성화합니다.
...
Synapse Analytics 작업 영역의 Azure AD 관리자에 대한 정보를 얻습니다.
...
이 기능은 제한된 미리 보기로 제공되어 처음에는 특정 구독에만 액세스할 수 있습니다. Synapse Analytics 데이터베이스를 SQL 만듭니다.
...
Synapse Analytics 역할 할당을 삭제합니다.
...
데이터 저장소 또는 클라우드 서비스를 작업 영역으로 연결합니다.
...
Synapse Analytics Spark 작업을 취소합니다.
...
Synapse Analytics Spark 문을 취소합니다.
...
Synapse Analytics SQL 일시 중단합니다.
...
이 기능은 제한된 미리 보기로 제공되어 처음에는 특정 구독에만 액세스할 수 있습니다. Synapse Analytics 및 데이터베이스의 SQL 검사합니다.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Synapse Analytics 풀의 존재를 SQL.
