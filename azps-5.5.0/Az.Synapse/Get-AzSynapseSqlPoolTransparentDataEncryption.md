...
## 설명
**Get-AzSynapseSqlPoolTransparentDataEncryption** cmdlet은 Azure Synapse Analytics SQL 풀에 대한 TDE(투명한 데이터 암호화) 상태를 얻습니다.
...
이 명령은 ContosoWorkspace라는 작업 SQL ContosoSqlPool이라는 SQL 풀에 대한 TDE의 상태를 얻습니다.
