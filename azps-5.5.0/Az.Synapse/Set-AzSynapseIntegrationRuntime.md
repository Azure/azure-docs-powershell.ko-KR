...
azure-SSIS Integration Runtime과 Azure-SSIS Integration Runtime 간에 데이터를 이동하는 경우 사용할 스테이징 데이터 저장소를 Self-Hosted Azure Blob Storage 연결된 서비스 이름입니다.
...
스테이징 데이터 저장소의 경로는 Self-Hosted Azure-SSIS Integration Runtime 간에 데이터를 이동하는 경우 기본 컨테이너가 지정되지 않은 경우 사용됩니다.
