...
## 설명
**Update-AzSynapseSqlPool** cmdlet은 Azure Synapse Analytics SQL 업데이트합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics SQL 풀을 업데이트합니다.
...
이 명령은 리소스 ID로 Azure Synapse Analytics SQL 풀을 업데이트합니다.
