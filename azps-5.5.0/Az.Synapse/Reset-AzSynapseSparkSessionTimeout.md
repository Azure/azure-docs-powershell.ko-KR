...
## 설명
**Remove-AzSynapseSparkSessionTimeout** cmdlet은 Synapse Analytics Spark 세션의 시간 제한을 다시 설정합니다.
...
이 명령은 지정된 livy ID를 사용하여 Synapse Analytics Spark 세션의 시간 제한을 다시 설정합니다.
...
이 명령은 파이프라인을 통해 지정된 livy ID를 사용하여 Synapse Analytics Spark 세션의 시간 제한을 다시 설정합니다.
