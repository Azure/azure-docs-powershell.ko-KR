...
## 설명
**Reset-AzSynapseSqlAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse 분석 작업 영역의 고급 위협 보호 설정을 제거합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역에서 고급 위협 보호 설정을 제거합니다.
