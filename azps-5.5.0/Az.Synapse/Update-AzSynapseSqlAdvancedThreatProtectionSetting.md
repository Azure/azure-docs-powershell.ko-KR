...
## 설명
**Update-AzSynapseSqlAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse 분석 작업 영역의 고급 위협 보호 설정을 업데이트합니다. 작업 영역의 고급 위협 방지를 사용하려면 해당 작업 영역의 감사 설정을 사용하도록 설정해야 합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 고급 위협 보호 설정을 업데이트합니다.
