...
## 설명
**Get-AzDataShareDataSet** cmdlet은 Azure 데이터 공유 계정의 공유에 추가된 데이터 집합에 대한 정보를 얻습니다. 데이터 집합의 이름을 지정하는 경우 이 cmdlet은 데이터 집합에 대한 정보를 얻습니다. 이름을 지정하지 않으면 이 cmdlet은 공유의 모든 데이터 집합에 대한 정보를 얻습니다. I
...
이 명령은 Azure 데이터 공유 계정 WikiAdsAccount 및 리소스 그룹 ADS의 Share AdsShare에서 AdsDataSet 데이터 집합에 대한 정보를 표시됩니다.

## PARAMETERS

### -AccountName
Azure 데이터 공유 계정 이름입니다.
