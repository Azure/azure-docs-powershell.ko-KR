...
## 설명
**New-AzDataShareSynchronizationSetting은** 특정 시간의 매일 또는 매시간 반복 간격에 대해 공유 계정의 공유에 대한 동기화 설정을 만듭니다.
...
이 명령은 데이터 공유 계정 WikiAds의 공유 AdsShare에 대해 매일 반복 간격으로 오전 9시에 동기화 설정을 만듭니다.
