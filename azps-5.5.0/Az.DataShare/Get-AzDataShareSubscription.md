...
## 설명
**Get-AzDataShareSubscription** cmdlet은 데이터 공유 계정의 공유 구독에 대한 정보를 제공합니다. 공유 구독 이름이 제공된 경우 cmdlet은 특정 공유 구독에 대한 정보를 제공합니다. 그렇지 않으면 cmdlet은 데이터 공유 계정의 공유 구독 목록을 제공합니다.
