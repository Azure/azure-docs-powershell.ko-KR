...
### 예제 1 Application Insights 리소스에 대한 연속 내보내기
```
...
리소스 그룹 "testgroup"에서 "test"라는 리소스에 대한 Application Insights 연속 내보내기 구성을 얻습니다.

### 예제 2 Application Insights 리소스에 대한 연속 내보내기
```
...
리소스 그룹 "testgroup"에서 "test"라는 리소스에 대한 내보내기 ID "ZJrfffySPdtG3ESn3iRxVIEFuNY="를 통해 Application Insights 연속 내보내기 구성을 얻습니다.
