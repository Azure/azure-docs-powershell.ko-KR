...
가격을 계산한 후 고객은 RI가 calculatePrice에서 제공하는 서비스를 제거할 수 있습니다.

## PARAMETERS

### -AppliedScope
혜택이 적용되는 구독입니다. --applied-scope-type이 Single인 경우 필수입니다. --applied-scope-type이 공유인 경우를 지정하지 않습니다.
...
### -AppliedScopeType
예약을 "단일" 또는 "공유"로 업데이트하는 적용된 범위의 유형
...
### -BillingPlan
이 SKU에 사용할 수 있는 청구 계획 옵션입니다. "월별" 또는 "선행"
...
### -DisplayName
예약을 쉽게 식별할 수 있는 사용자에게 친숙한 이름입니다.
...
### -InstanceFlexibility
{{ InstanceFlexibility Description }} 채우기
...
### -Renew
이를 true로 설정하면 만료 날짜에 새 예약이 자동으로 구매됩니다.
...
### -ReservationOrderId
구매할 예약 주문의 ID로, az reservations reservation-order calculate로 생성합니다.
