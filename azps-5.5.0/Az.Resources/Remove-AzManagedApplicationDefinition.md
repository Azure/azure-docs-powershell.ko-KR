...
## 설명
**Remove-AzManagedApplicationDefinition** cmdlet은 관리되는 애플리케이션 정의를 제거합니다.

## 예제

### 예제 1: 리소스 ID로 관리되는 애플리케이션 정의 제거
```
...
첫 번째 명령은 Get-AzManagedApplicationDefinition cmdlet을 사용하여 myAppDef라는 관리되는 애플리케이션 정의를 얻습니다.
명령은 이 변수를 $ApplicationDefinition 저장합니다.
두 번째 명령은 애플리케이션의 **ResourceId** 속성으로 식별되는 관리되는 애플리케이션 정의를 $ApplicationDefinition.
