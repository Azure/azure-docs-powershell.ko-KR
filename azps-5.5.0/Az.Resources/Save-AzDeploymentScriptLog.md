...
## 설명
**Save-AzDeploymentScriptLog는** 배포 스크립트 실행 로그를 디스크에 저장합니다.
...
지정한 이름 및 리소스 그룹으로 배포 스크립트의 로그를 저장합니다.
...
지정한 이름 및 리소스 그룹으로 배포 스크립트의 로그의 마지막 3줄을 저장합니다.
