...
## 설명
**Get-AzResourceProvider** cmdlet은 Azure 리소스 공급자를 얻습니다.

## 예제

### 예제 1: 현재 구독에 등록된 모든 리소스 공급자를 얻습니다.
...
이 명령은 구독에서 모든 리소스 공급자를 얻습니다.

### 예제 2: 주어진 ProviderNamespace에서 모든 리소스 공급자 세부 정보 얻기
...
이 명령은 "Microsoft.Compute" 아래에 있는 모든 리소스 공급자를 얻습니다.

### 예제 3: 제공된 ProviderNamespace 배열에서 모든 리소스 공급자 세부 정보 얻기
...
이 명령은 "Microsoft.Compute" 및 "Microsoft.Network" 아래에 있는 모든 리소스 공급자를 얻습니다.
...
### -ListAvailable
이 작업이 사용 가능한 모든 리소스 공급자를 얻게 됐습니다.
