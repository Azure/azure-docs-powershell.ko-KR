...
## 설명
**Test-AzResourceGroupDeployment** cmdlet은 Azure 리소스 그룹 배포 템플릿 및 해당 매개 변수 값이 유효한지 여부를 판단합니다.

## 예제

### 예제 1: 사용자 지정 템플릿 개체 및 매개 변수 파일을 사용하여 배포 테스트
...
이 명령은 지정한 템플릿 파일 및 매개 변수 파일에서 만든 메모리 내 해시테이블을 사용하여 주어진 리소스 그룹의 배포를 테스트합니다.

### 예제 2: 템플릿 파일 및 매개 변수 파일을 통해 배포 테스트
...
이 명령은 제공된 템플릿 파일 및 매개 변수 파일을 사용하여 주어진 리소스 그룹 및 리소스의 배포를 테스트합니다.
