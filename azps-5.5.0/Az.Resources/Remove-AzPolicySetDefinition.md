...
## 설명
**Remove-AzPolicySetDefinition** cmdlet은 정책 정의를 제거합니다.

## 예제

### 예제 1: 리소스 ID로 정책 집합 정의 제거
```
...
이 명령은 $PolicySetDefinition 변수에 저장합니다.
두 번째 명령은 리소스의 **ResourceId** 속성으로 식별되는 정책 집합 정의를 $PolicySetDefinition.
...
### -InputObject
다른 cmdlet에서 출력된 정의 개체를 제거할 정책 설정 정의 개체입니다.
