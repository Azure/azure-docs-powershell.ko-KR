...
## 설명
**Update-AzManagementGroup** cmdlet은 관리 그룹에 대한 **ParentId** 또는 **DisplayName을** 업데이트합니다.
...
### 예제 3: PSManagementGroup 개체를 파이핑하여 관리 그룹 업데이트
```
...
### 예제 4: ParentObject를 사용하여 관리 그룹의 부모 업데이트
```
