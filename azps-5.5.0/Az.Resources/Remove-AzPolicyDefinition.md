...
이 명령은 $PolicyDefinition 저장합니다.
두 번째 명령은 리소스의 **ResourceId** 속성으로 식별되는 정책 정의를 $PolicyDefinition.
...
### -Id
이 cmdlet이 제거하는 정책 정의에 대한 정식 리소스 ID를 지정합니다.
...
### -InputObject
다른 cmdlet에서 출력된 개체를 제거할 정책 정의 개체입니다.
