...
**Remove-AzResourceGroupDeployment** cmdlet은 Azure 리소스 그룹 배포 및 연결된 작업을 제거합니다.

## 예제

### 예제 1: ResourceId를 사용하여 리소스 그룹 배포 제거
...
이 명령은 배포의 정식 리소스 ID를 사용하여 리소스 그룹 배포를 제거합니다.
성공적으로 제거하면 true가 반환됩니다.

### 예제 2: ResourceGroupName 및 ResourceName을 사용하여 리소스 그룹 배포를 제거합니다.
...
이 명령은 제공된 ResourceGroupName 및 ResourceName을 사용하여 리소스 그룹 배포를 제거합니다.
성공적으로 제거하면 true가 반환됩니다.
