...
## 설명
ACR 매니페스트를 업데이트합니다.
이 cmdlet을 사용 `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -WriteEnable $true`
먼저
...
레지스트리에서 매니페스트 sha256:185518070891758909c9f839cf4ca393ee977ac378609f700f60a771a2dfe321에 대한 특성을 업데이트합니다.
...
레지스트리에서 최신 태그로 매니페스트에 대한 특성을 업데이트합니다.
