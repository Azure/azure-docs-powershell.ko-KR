...
## 설명
ACR 태그 태그를 지정하지 않습니다.
이 cmdlet을 사용 `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -DeleteEnable $true`
먼저
...
레지스트리에서 alpine:tag 태그 태그를 지정합니다.
