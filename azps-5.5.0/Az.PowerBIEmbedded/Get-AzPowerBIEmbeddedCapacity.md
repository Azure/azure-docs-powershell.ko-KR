...
## 설명
이 Get-AzPowerBIEmbeddedCapacity cmdlet은 PowerBI Embedded 용량의 세부 정보를 얻습니다.
...
이 명령은 testRG라는 리소스 그룹의 모든 Azure PowerBI Embedded Capacity를 얻습니다.
...
이 명령은 testRG라는 리소스 그룹에서 testcapacity라는 Azure PowerBI Embedded Capacity를 얻습니다.
