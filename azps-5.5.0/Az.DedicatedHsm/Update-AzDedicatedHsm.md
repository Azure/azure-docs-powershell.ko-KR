...
### 예제 1: 전용 HSM의 매개 변수 태그를 이름으로 업데이트합니다.
```powershell
...
이 명령은 Dedicated HSM의 매개 변수 태그를 이름으로 업데이트합니다.

### 예제 2: 개체에 의해 Dedicated HSM의 매개 변수 태그 업데이트
```powershell
...
이 명령은 개체에 의해 Dedicated HSM의 매개 변수 태그를 업데이트합니다.
