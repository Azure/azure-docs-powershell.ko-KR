...
## 설명
**Get-AzConsumptionReservationSummary** cmdlet은 일별 또는 월별 세분화에 대한 예약 요약을 얻습니다.

## 예제

### 예제 1: 월별 예약 주문 ID를 통해 예약 요약을 얻습니다.
```powershell
...
### 예제 2: 월별 예약 주문 ID 및 예약 ID를 통해 예약 요약을 얻습니다.
```powershell
...
### 예제 3: 일별 제공 날짜 범위에 대한 예약 주문 ID를 통해 예약 요약을 얻습니다.
```powershell
...
### 예제 4: 일별 제공 날짜 범위에 대한 예약 주문 ID 및 예약 ID를 통해 예약 요약을 얻습니다.
```powershell
...
### -EndDate
예약 요약의 최종 데이터(UTC의 YYYY-MM-DD)는 일별 세분성에만 필요합니다.
...
### -Grain
예약 요약의 시간 세분화는 일별 또는 월별일 수 있습니다.
...
### -StartDate
예약 요약의 시작 데이터(UTC의 YYYY-MM-DD)는 일별 세분성에만 필요합니다.
