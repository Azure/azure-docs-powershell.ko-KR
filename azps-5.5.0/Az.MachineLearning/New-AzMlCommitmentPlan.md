...
## 설명
기존 리소스 그룹에 Azure Machine Learning 약정 계획을 만듭니다.
리소스 그룹에 동일한 이름의 약정 계획이 있는 경우 호출은 업데이트 작업으로 작동하고 기존 약정 계획을 덮어 덮어 습니다.
...
"MyResourceGroup" 그룹 및 미국 중남부 지역에 "MyCommitmentPlanName"이라는 새 Azure Machine Learning 약정 계획을 만듭니다. 이 예제에서는 SKU DevTest/Standard가 사용됩니다. 즉, 약정 계획에서 제공하는 리소스는 DevTest/Standard의 제한으로 정의됩니다. 이 예제의 SkuCapacity는 1입니다. 즉, 계획 비용은 DevTest의 비용의 1배가 며 계획에 포함된 리소스는 DevTest에서 제공하는 리소스의 1배가 됩니다.
...
### -SkuCapacity
Azure ML 약정 계획을 프로비전할 때 사용할 SKU의 용량입니다.
...
### -SkuName
Azure ML 약정 계획을 프로비전할 때 사용할 SKU의 이름입니다.
...
### -SkuTier
Azure ML 약정 계획을 프로비전할 때 사용할 SKU의 계층입니다.
