...
## 설명
약정 연결 정보를 검색합니다.
전달된 매개 변수에 따라 cmdlet은 지정된 약정 계획에 대한 특정 약정 연결 또는 약정 연결 컬렉션을 반환합니다.
...
### 예제 2: 지정된 약정 계획에 대한 모든 약정 연결 얻기
```
...
### -CommitmentPlanName
하나 이상의 약정 연결로 연결되는 Azure ML 약정 계획의 이름입니다.
...
### -ResourceGroupName
Azure ML 약정 연결에 대한 리소스 그룹의 이름입니다.
