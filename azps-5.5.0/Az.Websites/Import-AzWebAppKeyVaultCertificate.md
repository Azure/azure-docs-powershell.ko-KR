...
## SYNOPSIS
Key Vault에서 웹앱으로 SSL 인증서를 가져올 수 있습니다.
...
## 설명
**Import-AzWebAppKeyVaultCertificate** cmdlet은 SSL 인증서를 Key Vault에서 웹앱으로 가져오습니다.
...
이 명령은 Key Vault에서 웹앱으로 SSL 인증서를 가져올 수 있습니다.
...
이 명령은 리소스 ID를 사용하여 Key Vault에서 웹앱으로 SSL 인증서를 가져올 수 있습니다(일반적으로 Key Vault가 다른 구독에 있는 경우).

## PARAMETERS

### -CertName
keyvault에서 만든 인증서의 KeyVaultCertName
