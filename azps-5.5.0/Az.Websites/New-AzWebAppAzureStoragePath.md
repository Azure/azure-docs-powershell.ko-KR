...
## 설명
웹앱 내에서 탑재할 Azure Storage 경로를 나타내는 개체를 만듭니다.
...
### -MountPath
ShareName에서 지정한 공유가 노출되는 컨테이너의 경로
...
### -Type
Azure Storage 계정의 유형입니다.
Windows 컨테이너는 Azure Files만 지원
