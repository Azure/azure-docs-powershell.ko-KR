...
javaproject.war의 콘텐츠를 리소스 그룹 ContosoRG에 속하는 ContosoApp이라는 웹앱의 스테이징 슬롯에 업로드합니다.
...
리소스 그룹 contosoRG에 app.zip ContosoApp이라는 웹앱에 콘텐츠 업로드 cmdlet은 백그라운드 작업에서 실행됩니다.
