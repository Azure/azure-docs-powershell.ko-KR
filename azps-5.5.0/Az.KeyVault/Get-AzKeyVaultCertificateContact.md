...
## 설명
**Get-AzKeyVaultCertificateContact** cmdlet은 Azure Key Vault의 키 자격 증명 모음에 대한 인증서 알림에 등록된 연락처를 얻습니다.

## 예제

### 예제 1: 모든 인증서 연락처를 얻습니다.
```powershell
...
이 명령은 Contoso 키 자격 증명 모음의 인증서 개체에 대한 모든 연락처를 택한 다음, $Contacts 변수에 저장합니다.
