...
## 설명
Key Vault 관리 Azure Storage SAS 정의를 제거합니다. 또한 이 SAS 정의에 따라 SAS 토큰을 사용하는 데 사용되는 비밀도 제거됩니다.
...
자격 증명 모음 'myvault'에서 'mystorageaccount' 계정과 연결된 Key Vault 관리 저장소 SAS 정의 'mysasdef'를 제거합니다.
