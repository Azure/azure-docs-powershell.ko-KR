...
파이핑 구문을 사용하여 제거 보호를 사용할 수 있습니다.
...
파이핑 구문을 사용하여 RBAC 권한 부여를 사용할 수 있습니다.
...
자격 증명 모음이라는 키 자격 증명 모음의 태그를 $keyVaultName.
...
자격 증명 모음이라는 키 자격 증명 모음의 모든 태그를 $keyVaultName.
...
이 키 자격 증명 모음에 대한 제거 보호 기능을 사용하도록 설정
사용하도록 설정하면 사용하지 않도록 설정할 수 없습니다.
소프트 삭제를 켜야 합니다.
...
RBAC(역할 기반 Access Control)에서 데이터 작업에 권한을 부여하려면 이 키 자격 증명 모음을 사용하도록 설정하거나 사용하지 않도록 설정하세요.
