...
### 예제 1: 이름으로 MySql 서버 Virtual Network 규칙 제거
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

이 cmdlet은 이름으로 MySql 서버 Virtual Network 규칙을 제거합니다.

### 예제 2: ID로 MySql 서버 Virtual Network 규칙 제거
```powershell
...
이러한 cmdlet은 ID에 의해 MySql 서버 Virtual Network 규칙을 제거합니다.
