...
## 설명
Azure IoT Hub Device Provisioning Service의 enrollmentGroup에서 디바이스 등록 상태 또는 디바이스의 등록 상태를 확인합니다.
...
Azure IoT Hub Device Provisioning Service에서 디바이스 등록 상태 세부 정보를 확인합니다.
...
이 enrollmentGroup에서 디바이스의 모든 등록 상태를 나열합니다.
