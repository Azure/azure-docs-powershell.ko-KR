...
EnrollmentWrite 및 ServiceConfig 권한을 사용하여 Azure IoT Hub 디바이스 프로비전 서비스에 새 공유 액세스 정책을 추가합니다.
...
EnrollmentRead 권한을 사용하여 Azure IoT Hub 디바이스 프로비전 서비스에 새 공유 액세스 정책을 추가합니다.
