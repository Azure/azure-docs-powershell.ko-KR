...
CosmosDB Cassandra 키스페이스를 업데이트합니다. 기존 Keyspace를 읽어 클라이언트 쪽 패치 작업을 수행 합니다.
...
CosmosDB Cassandra 테이블의 진행성 값을 업데이트합니다.
...
CosmosDB Sql 컨테이너의 처리성 값을 업데이트합니다.
