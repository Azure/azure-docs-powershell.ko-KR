...
## 설명
CosmosDB 계정의 속성을 업데이트합니다. 다른 속성으로 계정 지역을 시뮬레이션하여 업데이트할 수 없습니다.
...
DefaultConsistencyLevel을 "Strong", Enabled AutomaticFailover, Enabled MultipleWriteLocations 및 Enabled VirtualNetwork for CosmosDB Account with name accountName으로 업데이트했습니다. 
