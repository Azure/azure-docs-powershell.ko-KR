...
### 예제 10: 계산을 사용할 수 있는 Azure HDInsight 클러스터를 만들 수 있습니다.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
또는 다음 cmdlet을 Add-AzHDInsightStorage 있습니다.
...
또는 다음 cmdlet을 Add-AzHDInsightConfigValues 있습니다.
...
또는 다음 cmdlet을 Add-AzHDInsightMetastore 있습니다.
...
또는 다음 cmdlet을 Add-AzHDInsightSecurityProfile 있습니다.
