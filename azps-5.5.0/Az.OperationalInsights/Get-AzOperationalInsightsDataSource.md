...
## 설명
**Get-AzOperationalInsightsDataSource** cmdlet은 데이터 원본을 얻습니다.
사용할 데이터 원본을 지정할 수 있습니다.
데이터 원본의 종류에 따라 결과를 필터링할 수 있습니다.
...
### -ResourceGroupName
얻을 데이터 원본이 포함된 리소스 그룹의 이름을 지정합니다.
...
## 참고 사항
* 키워드: azure, azurerm, arm, 리소스, 관리, 관리자, 운영, 인사이트
