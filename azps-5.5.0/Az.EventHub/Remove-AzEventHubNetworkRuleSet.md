...
```
이름 : defaultAction : 허용 ID : /subscriptions/subscriptionId/resourceGroups/ResourceGroup/providers/Microsoft.EventHub/namespaces/EventHub-Namespace-1375/networkRuleSets/default Type : Microsoft.EventHub/Namespaces/NetworkRuleSet IpRules : VirtualNetworkRules : 


주어진 "Eventhub-Namespace1-1375" 네임스페이스에 대한 NetworkRuleSet을 삭제합니다. 
