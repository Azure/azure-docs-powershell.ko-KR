...
테넌트 범위에서 만든 개인 저장소에 대한 개인 + 공용 계획을 통해 제안을 만듭니다. 
...
구독 범위에서 만든 개인 저장소에 대한 전용 계획으로만 제안을 만듭니다. 
...
테넌트 범위에서 만든 개인 저장소에 대한 개인 + 공용 계획으로 제안을 업데이트합니다. Etag가 필요합니다.
...
구독 범위에서 만든 개인 계획만 있는 개인 저장소에 대한 제안을 업데이트합니다. Etag가 필요합니다.
...
### -ETag
Azure Marketplace privateStore 제안의 업데이트용 eTag
...
필수 Azure Marketplace privateStore 제안의 특정 계획 ID 제한
