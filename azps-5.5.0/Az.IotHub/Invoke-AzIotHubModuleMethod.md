...
## 설명
Edge 모듈 메서드를 호출합니다. 자세한 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods 내용은 다음을 참조하세요.
...
### -ConnectionTimeOut
연결이 성공적으로 완료될 때까지 대기하는 시간(초)입니다.
기본값은 10입니다.
...
### -ResponseTimeOut
직접 메서드에서 결과가 수신될 때까지 대기하는 시간(초)입니다.
기본값은 10입니다.
