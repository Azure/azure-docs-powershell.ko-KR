...
## 설명
IoT Hub를 보조 위치로 장애 조치(failover)를 트리거합니다. 이 작업을 수행하면 솔루션에 대한 다운 시간 및 원격 분석 손실이 발생할 수 있습니다. 이 작업은 장기 실행 작업으로 완료하는 데 몇 분 정도 걸릴 수 있습니다. 사용할 때는 주의를 기울이는 것이 좋습니다.
...
"myiothub" IoT Hub의 장애 조치(failover) 프로세스 시작
...
백그라운드에서 "myiothub" IoT Hub의 장애 조치(failover) 프로세스 시작
...
### -PassThru
부울 개체를 반환할 수 있습니다. 기본적으로 이 cmdlet은 출력을 생성하지 않습니다.
