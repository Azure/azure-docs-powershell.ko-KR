...
## 설명
새 인증서를 업로드하거나 기존 인증서를 동일한 이름으로 대체합니다.
Azure IoT Hub의 CA 인증서에 대한 자세한 설명은 다음을 참조하세요. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-x509ca-overview
...
IOT Hub에 CA 인증서 CER 파일을 업로드합니다. 
...
새 CER 파일을 업로드하여 IoT Hub에서 CA 인증서를 업데이트합니다. 
...
### -Path
base-64로 표현된 X509 인증서 .cer 파일 또는 .pem 파일 경로입니다.
