...
# Az.IotHub 모듈
## 설명
Azure IotHubs를 관리하기 위한 명령

## Az.IotHub Cmdlet
### [Add-AzIotHubCertificate](Add-AzIotHubCertificate.md)
Azure IoT Hub 인증서를 만들/업데이트합니다.
...
IoT Hub의 대상 IoT 디바이스에 모듈을 만들 수 있습니다.
...
구독의 IotHubs에 대한 정보를 얻습니다.

### [Get-AzIotHubCertificate](Get-AzIotHubCertificate.md)
Azure IoT Hub 내에 포함된 모든 인증서 또는 특정 인증서를 나열합니다. 
...
IoT Hub의 IoT 디바이스에 있는 IoT 디바이스 모듈 또는 목록 모듈의 세부 정보를 확인합니다.

### [Get-AzIotHubModuleConnectionString](Get-AzIotHubModuleConnectionString.md)
IoT Hub에서 대상 IoT 디바이스 모듈의 연결 문자열을 얻습니다.
...
IoT Hub에 대한 모든 엔드포인트에 대한 정보 얻기
...
지역 쌍 재해 복구 지역에 IoT Hub에 대한 장애 조치(failover) 프로세스를 호출합니다.
...
디바이스 쌍의 태그 및 desired 속성을 업데이트합니다.

### [Update-AzIotHubModuleTwin](Update-AzIotHubModuleTwin.md)
IoT 디바이스 모듈 쌍의 태그 및 desired 속성을 업데이트합니다.
