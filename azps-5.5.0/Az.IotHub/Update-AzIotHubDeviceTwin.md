...
## 설명
디바이스 쌍을 업데이트하거나 대체합니다. 자세한 https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins 내용은 다음을 참조하세요.
...
업데이트된 desired 속성을 사용하여 디바이스 쌍 개체를 반환합니다.
...
업데이트된 태그 속성을 사용하여 디바이스 쌍 개체를 반환합니다.
...
### -Desired
디바이스 쌍에서 desired 속성을 추가하거나 업데이트합니다.
...
### -Partial
디바이스 쌍의 태그 및 desired 속성만 부분적으로 업데이트할 수 있습니다.
