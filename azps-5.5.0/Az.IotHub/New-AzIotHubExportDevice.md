...
## 설명
IotHub에 대한 새 내보내기 디바이스 작업을 만듭니다.
이렇게 하면 모든 디바이스를 지정된 컨테이너로 내보낼 수 있습니다. SAS URI를 생성하는 방법에 대한 다음 문서를 참조하세요.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## 예제

### 예제 1 내보내기 디바이스 요청을 발급합니다.
```
...
키를 제외한 IotHub "myiothub"에 대한 새 내보내기 디바이스 요청을 만듭니다.
