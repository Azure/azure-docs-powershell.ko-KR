...
## 설명
**Get-AzVMImage** cmdlet은 VMImage의 모든 버전을 얻습니다.
...
이 명령은 지정된 값과 일치하는 VMImage의 모든 버전을 얻습니다.
...
이 명령은 지정된 값과 일치하는 특정 버전의 VMImage를 얻습니다.
...
이 명령은 지정된 값과 버전에 대한 필터링과 일치하는 VMImage의 모든 버전을 얻습니다.
...
### -OrderBy
반환된 결과의 순서를 지정합니다. OData 쿼리로 형식이 지정됩니다.
...
### -PublisherName
VMImage의 게시자를 지정합니다.
이미지 게시자를 얻습니다. Get-AzVMImagePublisher cmdlet을 사용 합니다.
...
### -SKU
VMImage SKU를 지정합니다.
SKU를 얻습니다. Get-AzVMImageSku cmdlet을 사용 합니다.
