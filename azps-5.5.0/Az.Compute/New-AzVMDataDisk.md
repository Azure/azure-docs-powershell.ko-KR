...
### NormalDiskParameterSetName(기본값)
```
...
## 설명
**New-AzVMDataDisk** cmdlet은 가상 머신 또는 Vmss VM에 대한 로컬 데이터 디스크 개체를 만듭니다.
...
마지막 명령은 새 데이터 디스크를 추가하여 Vmss VM을 업데이트합니다.

### 예제 2

가상 머신 또는 Vmss VM에 대한 로컬 데이터 디스크 개체를 만듭니다. (자동Generated)
