...
## 설명
미리 정의한 시간 간격으로 구독의 호출에 대한 통계 데이터를 성공, 실패 또는 스로틀된 상태에 따라 Microsoft.Compute API로 내보낼 수 있습니다. 로그는 GroupByOperationName, GroupByThrottlePolicy 또는 GroupByResourceName의 세 매개 변수로 추가로 그룹화할 수 있습니다.
...
이 명령은 2018-02-20T17:54:14와 2018-02-22T17:54:17 사이의 성공, 실패 또는 스로틀로 구분된 Microsoft.Compute API 호출의 집계된 수를 애플리케이션 ID별로 집계된 주어진 SAS URI에 저장합니다. 
...
이 명령은 사용자 에이전트별로 집계된 주어진 SAS URI에 2018-02-20T17:54:14와 2018-02-22T17:54:17 사이에 성공, 실패 또는 스로틀로 구분된 Microsoft.Compute API 호출의 집계된 번호를 저장합니다. 
