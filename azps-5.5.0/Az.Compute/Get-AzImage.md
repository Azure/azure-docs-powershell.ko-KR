...
## 설명
**Get-AzImage** cmdlet은 이미지의 속성을 얻습니다.
...
이 명령은 리소스 그룹 'ResourceGroup01'에서 'Image01'이라는 이미지의 속성을 얻습니다.
...
이 명령은 리소스 그룹 'ResourceGroup01'에 있는 모든 이미지의 속성을 얻습니다.
...
이 명령은 "이미지"로 시작하는 구독에서 모든 이미지의 속성을 얻습니다.
