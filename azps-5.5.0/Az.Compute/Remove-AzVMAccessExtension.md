...
## 설명
**Remove-AzVMAccessExtension** cmdlet은 가상 머신에서 VMAccess(Virtual Machine Access) Virtual Machine 확장을 제거합니다.

## 예제

### 예제 1

가상 머신에서 VMAccess 확장을 제거합니다. (자동Generated)
...
### -VMName
가상 머신의 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 가상 머신에 대한 VMAccess를 제거합니다.
