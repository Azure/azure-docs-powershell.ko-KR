...
## 설명
**Get-AzVMDiagnosticsExtension** cmdlet은 가상 머신에서 Azure Diagnostics 확장의 설정을 얻습니다.

## 예제

### 예제 1: 가상 머신에 적용되는 진단 확장을 얻습니다.
```powershell
...
가상 머신에서 진단 확장의 설정을 얻습니다. (자동Generated)
...
### -Name
이 cmdlet에서 설정을 얻을 진단 확장의 이름을 지정합니다.
...
### -VMName
이 cmdlet이 진단 확장을 얻을 가상 머신의 이름을 지정합니다.
