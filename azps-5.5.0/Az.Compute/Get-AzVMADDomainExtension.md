...
## 설명
**Get-AzVMADDomainExtension** cmdlet은 지정된 Azure AD(Active Directory) 도메인 확장에 대한 정보를 얻습니다.

## 예제

### 예제 1

AD 도메인 확장에 대한 정보를 얻습니다. (자동Generated)
...
### -Status
이 cmdlet이 도메인 확장의 인스턴스 보기를 얻게 됐습니다.
