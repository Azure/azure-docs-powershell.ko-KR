...
## SYNOPSIS
지정된 디스크 암호화 집합과 연결된 리소스 목록을 얻습니다.
...
## 설명
**Get-AzDiskEncryptionSetAssociatedResource** cmdlet은 지정된 디스크 암호화 집합과 연결된 리소스 목록을 얻습니다.
...
cmdlet은 제공된 디스크 암호화 집합과 연결된 두 리소스 'exampleDisk01' 및 'exampleDisk02'를 검색합니다.
