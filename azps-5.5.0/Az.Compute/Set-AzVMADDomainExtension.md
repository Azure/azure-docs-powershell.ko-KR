...
## 설명
**Set-AzVMADDomainExtension** cmdlet은 가상 머신에 Azure AD(Active Directory) 도메인 가상 머신 확장을 추가합니다.
이 확장을 사용하면 가상 머신이 도메인에 가입할 수 있습니다.
...
### -JoinOption
조인 옵션을 지정합니다. 조인 옵션은 [fJoinOptions를 참조하세요.](https://docs.microsoft.com/en-us/windows/desktop/api/lmjoin/nf-lmjoin-netjoindomain)
...
### -OUPath
도메인 계정에 대한 OU(조직 구성 단위)를 지정합니다.
OU의 전체 고유 이름을 인용 부호로 입력합니다.
...
### -Restart
이 cmdlet이 가상 머신을 다시 시작합니다.
변경을 유효하게 설정하려면 다시 시작해야 하는 경우가 종종 있습니다.
