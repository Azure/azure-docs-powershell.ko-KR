...
## 설명
**Get-AzDisk** cmdlet은 Managed Disk의 속성을 얻습니다.
...
이 명령은 리소스 그룹 'ResourceGroup01'에서 'Disk01'이라는 디스크의 속성을 얻습니다.
...
이 명령은 리소스 그룹 'ResourceGroup01'에 있는 모든 디스크의 속성을 얻습니다.
...
이 명령은 구독 이름으로 시작하여 모든 디스크의 속성을 win1_OsDisk.
