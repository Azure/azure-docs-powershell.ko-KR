...
## 설명
**Test-AzVMAEMExtension** cmdlet은 Azure AEM(고급 모니터링) 확장의 구성을 검사합니다.
...
이 명령은 contoso-server라는 가상 머신에 대한 AEM 확장의 구성을 검사합니다.
...
### -ResourceGroupName
이 cmdlet이 검사하는 가상 머신의 리소스 그룹의 이름을 지정합니다.
...
### -SkipStorageCheck
이 cmdlet이 저장소 구성의 확인을 건너뛰고 있습니다.
