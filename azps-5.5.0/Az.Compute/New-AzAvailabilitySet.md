...
## 설명
**New-AzAvailabilitySet** cmdlet은 Azure 가용성 집합을 만듭니다.
...
이 명령은 ResourceGroup11이라는 리소스 그룹에 AvailabilitySet03이라는 가용성 집합을 만듭니다.
...
이 가용성 집합에 사용할 근접 배치 그룹의 리소스 ID입니다.
