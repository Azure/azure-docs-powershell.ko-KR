...
## SYNOPSIS
연결된 클러스터를 삭제하고 Azure Resource Manager에서 추적된 리소스를 제거합니다(ARM.
...
이 명령은 개체에 의해 연결된 kubernetes를 제거합니다.
