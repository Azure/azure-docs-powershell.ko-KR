...
## SYNOPSIS
연결된 클러스터 리소스의 특정 속성을 업데이트하는 API
...
이 명령은 연결된 kubernetes를 업데이트합니다.

### 예제 2: 개체에 따라 연결된 kubernetes 업데이트
```powershell
...
이 명령은 개체에 따라 연결된 kubernetes를 업데이트합니다.
