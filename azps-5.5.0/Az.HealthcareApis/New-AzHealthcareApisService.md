...
### 예제 1: cosmosdb 제품 프로비전이 400인 westus2의 리소스 그룹 MyResourceGroup에 MyService라는 새 Azure Healthcareapis fhir 서비스를 만듭니다.
```powershell
...
### 예제 2: cosmosdb 제품 서비스량 = 400 및 키 자격 증명 모음 키 uri "https:// .vault.azure.net/keys/" 위치 westus2의 리소스 그룹 MyResourceGroup에 MyService라는 새 Azure Healthcareapis fhir 서비스를 만듭니다. \<my-keyvault> \<my-key>
```powershell
...
### -CorsMethod
Cors 메서드의 HealthcareApis Fhir 서비스 목록입니다.
