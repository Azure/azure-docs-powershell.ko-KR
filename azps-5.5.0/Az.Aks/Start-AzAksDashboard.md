...
## 설명
관리되는 클러스터의 대시보드에 대한 Kubectl SSH 터널을 생성합니다. SSH 터널은 SSH 터널이 Kubectl-Tunnel PowerShell 작업에서 설정되고 실행하여 찾을 수 `Get-Job` 있습니다. 터널은 .를 통해 액세스할 수 [http://127.0.0.1:8001](http://127.0.0.1:8001) 있습니다.

## 예제

### SSH 터널을 시작하고 Kubernetes 대시보드에 대한 브라우저 열기
```
...
### -DisableBrowser
kubectl 포트 전달을 설정한 후 브라우저를 열지 않습니다.
...
### -ListenPort
대시보드에 대한 수신 포트입니다. 기본값은 8003입니다.
...
### -PassThru
Cmdlet은 전달된 경우 KubeTunnelJob을 반환합니다.
