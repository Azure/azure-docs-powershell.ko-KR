...
## 설명
**Update-AzDataFactoryV2IntegrationRuntime** cmdlet은 통합 런타임 속성을 업데이트합니다. 현재 cmdlet은 자체 호스팅 통합 런타임에 대해 'AutoUpdate' 및 'AutoUpdateDelayOffset' 업데이트만 지원합니다.
...
### -AutoUpdate
자체 호스팅 통합 런타임 자동 업데이트를 사용하도록 설정하거나 해제합니다.
...
자체 호스팅 통합 런타임 자동 업데이트에 대한 시간(시간)입니다.
