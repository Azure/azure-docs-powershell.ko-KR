...
## 설명
**Get-AzDataFactoryGatewayAuthKey** cmdlet은 지정된 Azure Data Factory 게이트웨이에 대한 게이트웨이 auth 키를 얻습니다.
이 Auth 키의 key1 또는 key2를 사용하여 클라우드 서비스에 게이트웨이를 등록합니다.

## 예제

### 예제 1: 게이트웨이의 Auth 키를 얻습니다.
```
...
이 명령은 MyGateway라는 데이터 팩터리 게이트웨이에 대한 게이트웨이 Auth 키를 얻습니다.
