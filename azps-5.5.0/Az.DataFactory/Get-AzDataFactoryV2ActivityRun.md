...
## 설명
**Get-AzDataFactoryV2ActivityRun** cmdlet은 지정된 시간 프레임에서 발생된 지정된 파이프라인 실행에 대한 Azure Data Factory의 실행에 대한 정보를 얻습니다. 또한 활동 이름, 실행을 실행한 연결된 서비스 이름 및 실행 상태에 대한 필터를 지정할 수 있습니다.

## 예제

### 예제 1: 파이프라인 실행에 대한 모든 작업 실행을 얻습니다.
```
...
이 명령은 "2017-09-01"과 "2017-09-30" 사이에 발생된 ID "f288712d-fb08-4cb8-96ef-82d3b9b30621"을 사용하여 파이프라인 실행의 모든 작업 실행에 대한 세부 정보를 얻습니다.
...
### -RunStartedAfter
파이프라인 실행이 시작된 시간 또는 그 이후의 시간입니다.
