...
## 설명
**Start-AzDataFactoryV2IntegrationRuntime** cmdlet은 관리되는 전용 통합 런타임을 시작합니다. 리소스가 프로비전된 후 작업 후에 상태가 '시작'됩니다.
...
이 cmdlet은 'test-dedicated-ir'이라는 관리형 전용 통합 런타임이 시작됩니다.
