...
## 설명
**Sync-AzDataFactoryV2IntegrationRuntimeCredential** cmdlet은 통합 런타임 노드 사이에서 모든 프레미스 자격 증명을 동기화합니다. 이 경우 모든 노드에서 자격 증명이 동일하게 됩니다.

## 예제

### 예제 1: 통합 런타임 자격 증명 동기화

통합 런타임 노드 간 자격 증명을 동기화합니다. (자동Generated)
