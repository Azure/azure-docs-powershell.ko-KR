...
## 설명
**Invoke-AzDataFactoryV2TriggerRun** 명령은 새 트리거 실행 ID를 사용하여 트리거 실행의 다른 인스턴스를 시작합니다.
...
```
원래 트리거 실행과 동일한 windowStartTime 및 windowEndTime을 유지하여 새 트리거 실행 ID로 트리거 실행의 다른 인스턴스를 시작합니다.
