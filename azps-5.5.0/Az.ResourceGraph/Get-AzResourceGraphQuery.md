...
## SYNOPSIS
resourceName으로 단일 그래프 쿼리를 얻습니다.
...
### 예제 1: 리소스 그룹에서 모든 리소스 그래프 쿼리를 얻게
```powershell
...
이 명령은 리소스 그룹에서 모든 리소스 그래프 쿼리를 얻습니다.

### 예제 2: 이름으로 리소스 그래프 쿼리를 구합니다.
```powershell
...
이 명령은 이름으로 리소스 그래프 쿼리를 얻습니다.

### 예제 2: objecy를 통해 리소스 그래프 쿼리를 구합니다.
```powershell
