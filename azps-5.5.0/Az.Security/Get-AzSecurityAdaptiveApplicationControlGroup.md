...
## 설명
적응형 애플리케이션 제어는 Azure Security Center에서 자동으로 계산되며, 이 cmdlet을 사용하여 애플리케이션 제어 VM/서버 그룹을 얻습니다.
...
### -AscLocation
ASC가 구독의 데이터를 저장하는 위치입니다. 위치 Get에서 검색할 수 있습니다.
