...
## 설명
Get-AzIotSecurityAnalytics cmdlet은 특정 iot 보안 솔루션의 보안 분석 집합을 반환합니다.
...
"MyResourceGroup" 재할당 그룹에서 청각 장애가 있는 IoT 보안 분석 "MySolution"을 얻습니다.

## PARAMETERS

### -Default
있는 경우 기본 분석 집합을 얻습니다. 그렇지 않으면 모든 분석 집합 목록을 얻습니다.
