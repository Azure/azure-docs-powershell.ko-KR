...
ms.locfileid: "100197940"
---
# <span data-ttu-id="f9c9b-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="f9c9b-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="f9c9b-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="f9c9b-102">SYNOPSIS</span></span>
<span data-ttu-id="f9c9b-103">Azure Security Center에서 검색된 보안 경고를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="f9c9b-104">구문</span><span class="sxs-lookup"><span data-stu-id="f9c9b-104">SYNTAX</span></span>

### <span data-ttu-id="f9c9b-105">SubscriptionScope(기본값)</span><span class="sxs-lookup"><span data-stu-id="f9c9b-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f9c9b-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="f9c9b-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f9c9b-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="f9c9b-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="f9c9b-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="f9c9b-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="f9c9b-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="f9c9b-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="f9c9b-110">설명</span><span class="sxs-lookup"><span data-stu-id="f9c9b-110">DESCRIPTION</span></span>
<span data-ttu-id="f9c9b-111">Azure Security Center에서 검색된 보안 경고를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="f9c9b-112">예제</span><span class="sxs-lookup"><span data-stu-id="f9c9b-112">EXAMPLES</span></span>

### <span data-ttu-id="f9c9b-113">예제 1</span><span class="sxs-lookup"><span data-stu-id="f9c9b-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="f9c9b-114">구독 내 리소스에서 검색된 모든 보안 경고를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="f9c9b-115">예제 2</span><span class="sxs-lookup"><span data-stu-id="f9c9b-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="f9c9b-116">"myService1" 리소스 그룹 내 리소스에서 검색된 모든 보안 경고를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="f9c9b-117">예제 3</span><span class="sxs-lookup"><span data-stu-id="f9c9b-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="f9c9b-118">"myService1" 리소스 그룹 내 리소스에서 검색된 특정 보안 경고를 얻습니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="f9c9b-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="f9c9b-119">PARAMETERS</span></span>

### <span data-ttu-id="f9c9b-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="f9c9b-120">-DefaultProfile</span></span>
<span data-ttu-id="f9c9b-121">Azure와의 통신에 사용되는 자격 증명, 계정, 테넌트 및 구독입니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="f9c9b-122">-Location</span><span class="sxs-lookup"><span data-stu-id="f9c9b-122">-Location</span></span>
<span data-ttu-id="f9c9b-123">위치.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-123">Location.</span></span>
...
### <span data-ttu-id="f9c9b-124">-Name</span><span class="sxs-lookup"><span data-stu-id="f9c9b-124">-Name</span></span>
<span data-ttu-id="f9c9b-125">리소스 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-125">Resource name.</span></span>
...
### <span data-ttu-id="f9c9b-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="f9c9b-126">-ResourceGroupName</span></span>
<span data-ttu-id="f9c9b-127">리소스 그룹 이름입니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-127">Resource group name.</span></span>
...
### <span data-ttu-id="f9c9b-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="f9c9b-128">-ResourceId</span></span>
<span data-ttu-id="f9c9b-129">리소스 ID입니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-129">Resource ID.</span></span>
...
### <span data-ttu-id="f9c9b-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="f9c9b-130">CommonParameters</span></span>
<span data-ttu-id="f9c9b-131">이 cmdlet은 -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction 및 -WarningVariable의 일반적인 매개 변수를 지원합니다.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="f9c9b-132">자세한 내용은 [다음](http://go.microsoft.com/fwlink/?LinkID=113216)about_CommonParameters.</span><span class="sxs-lookup"><span data-stu-id="f9c9b-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="f9c9b-133">입력</span><span class="sxs-lookup"><span data-stu-id="f9c9b-133">INPUTS</span></span>

### <span data-ttu-id="f9c9b-134">System.String</span><span class="sxs-lookup"><span data-stu-id="f9c9b-134">System.String</span></span>

## <span data-ttu-id="f9c9b-135">출력</span><span class="sxs-lookup"><span data-stu-id="f9c9b-135">OUTPUTS</span></span>

### <span data-ttu-id="f9c9b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="f9c9b-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="f9c9b-137">참고 사항</span><span class="sxs-lookup"><span data-stu-id="f9c9b-137">NOTES</span></span>

## <span data-ttu-id="f9c9b-138">관련 링크</span><span class="sxs-lookup"><span data-stu-id="f9c9b-138">RELATED LINKS</span></span>
