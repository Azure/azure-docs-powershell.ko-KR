...
**Get-AzLocalNetworkGateway** cmdlet은 이름 및 리소스 그룹 이름에 따라 프레미스 게이트웨이를 나타내는 개체를 반환합니다.

## 예제

### 예제 1: 로컬 네트워크 게이트웨이를 얻게
```powershell
...
리소스 그룹 "myRG" 내에서 이름이 "myLocalGW1"인 로컬 네트워크 게이트웨이의 개체를 반환합니다.

### 예제 2: 필터링을 사용하여 로컬 네트워크 게이트웨이를 얻습니다.
```powershell
...
리소스 그룹 "myRG"에서 "myLocalGW"로 시작하는 이름으로 로컬 네트워크 게이트웨이의 개체를 반환합니다.
