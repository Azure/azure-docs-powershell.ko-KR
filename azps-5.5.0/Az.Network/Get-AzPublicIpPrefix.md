...
## 설명
**Get-AzPublicIpPrefix** cmdlet은 리소스 그룹에서 하나 이상의 공용 IP 주소를 얻습니다.
...
이 명령은 리소스 그룹 myRg에서 myPublicIpPrefix1을 사용하여 공용 IP 연결 리소스를 얻습니다.
...
이 명령은 myPublicIpPrefix로 시작하는 모든 공용 IP 사전 리소스를 얻습니다.
