...
위의 설명은 Azure의 "testRG" 리소스 그룹에 리소스 그룹, Virtual WAN, Virtual Network, Virtual Hub 및 ExpressRouteSite를 미국 서부에 만들 것입니다. ExpressRoute 게이트웨이는 2개 배율 단위가 있는 가상 허브에서 이후에 만들어집니다.

게이트웨이가 만들어졌다면 게이트웨이는 New-AzExpressRouteConnection 명령을 사용하여 프레미스 ExpressRoute 회로에 연결됩니다.
