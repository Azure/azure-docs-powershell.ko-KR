...
## 설명
**Remove-AzCustomIpPrefix** cmdlet은 CustomIpPrefix를 제거합니다.
...
리소스 그룹에서 이름 및 이름 $prefixName CustomIpPrefix를 제거합니다$rgName
