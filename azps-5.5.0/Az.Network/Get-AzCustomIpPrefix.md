...
## 설명
**Get-AzCustomIpPrefix** cmdlet은 입력 매개 변수 집합이 제공된 하나 이상의 CustomIpPrefixes를 얻습니다.
...
이 명령은 리소스 그룹 myRg에서 myCustomIpPrefix라는 CustomIpPrefix 리소스를 얻습니다.
