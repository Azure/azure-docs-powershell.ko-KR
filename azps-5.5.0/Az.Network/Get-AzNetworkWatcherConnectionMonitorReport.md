...
## 설명
Get-AzNetworkWatcherConnectionMonitorReport cmdlet은 가장 최근의 연결 상태 보고서를 반환합니다.

## 예제

### 예제 1: 지정된 위치의 이름으로 연결 모니터의 가장 최근 연결 스냅숏을 확인합니다.
```
...
이 예제에서는 지정된 연결 모니터의 가장 최근 연결 상태 쿼리합니다.
