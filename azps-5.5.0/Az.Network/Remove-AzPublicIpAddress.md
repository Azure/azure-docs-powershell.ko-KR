...
## 설명
**Remove-AzPublicIpAddress** cmdlet은 Azure 공용 IP 주소를 제거합니다.
...
이 명령은 리소스 그룹 $publicIpName 이름의 공용 IP 주소 리소스를 $rgName.
...
### -Name
이 cmdlet에서 제거하는 공용 IP 주소의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet에서 제거하는 공용 IP 주소를 포함하는 리소스 그룹의 이름을 지정합니다.
