...
위의 리소스 그룹인 Virtual WAN, Virtual Network, Virtual Hub 및 VpnGateway는 Vpngateway와 & NAT 규칙을 생성합니다.
그런 다음 NAT 규칙 이름을 사용하여 NAT 규칙을 얻습니다.
...
### -ParentObject
이 VpnGatewayNatRule에 대한 부모 VpnGateway입니다.
...
### -ParentResourceId
이 VpnGatewayNatRule에 대한 부모 VpnGateway의 리소스 ID입니다.
