...
## 설명
이 명령은 Azure 가상 네트워크 게이트웨이가 피어링하도록 구성된 BGP 피어를 열회합니다. 각 피어의 상태도 표시됩니다.
...
리소스 그룹 resourceGroup에서 gatewayName이라는 Azure 가상 네트워크 게이트웨이에 대한 BGP 피어를 검색합니다.
이 예제 출력은 IP가 10.0.0.254인 연결된 BGP 피어를 보여줍니다.
