...
## SYNOPSIS
VpnSiteLinkConnection과 연결할 수 있는 VpnGateway에 NAT 규칙을 만듭니다.
...
위의 리소스 그룹, Virtual WAN, Virtual Network, Virtual Hub를 만들 것입니다. 그런 다음 해당 Virtual Hub 아래에 VpnGateway를 만들 것입니다. 그런 다음, New-AzVpnGatewayNatRule 명령을 사용하여 NAT 규칙을 만들 수 있습니다. 생성된 VpnGateway와 연결됩니다.
