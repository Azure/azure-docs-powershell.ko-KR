...
## 설명
**Remove-AzApplicationGatewayRewriteRuleSet** cmdlet은 Azure 애플리케이션 게이트웨이에서 재작성 규칙 집합을 제거합니다.
...
두 번째 명령은 규칙 집합에 저장된 애플리케이션 게이트웨이에서 RuleSet02라는 다시 사용 규칙 집합을 $AppGw.
