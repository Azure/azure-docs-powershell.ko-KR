...
## 설명
**Get-AzApplicationGatewaySslPolicy** cmdlet은 애플리케이션 게이트웨이의 SSL 정책을 얻습니다.
...
두 번째 명령은 애플리케이션이라는 변수에 저장된 Application Gateway에서 ssl 정책을 $AppGW.

## PARAMETERS

### -ApplicationGateway
이 cmdlet에서 얻을 SSL 정책의 애플리케이션 게이트웨이를 지정합니다.
