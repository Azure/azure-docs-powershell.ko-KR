...
## 설명
**New-AzApplicationGatewayFirewallCondition은** 방화벽 사용자 지정 규칙에 대한 일치 조건을 만듭니다.
...
이 명령은 $variable 정의된 일치 변수를 사용하여 새 일치 조건을 만들고, 연산자가 포함되고, negation 조건은 false, 소문자 및 자르기 등의 Transfroms, 일치 값은 abc 및 cde입니다. 새 일치 조건은 새 $condition.
