...
## 설명
**Get-AzApplicationGatewayTrustedRootCertificate** cmdlet은 Application Gateway에서 특정 이름으로 신뢰할 수 있는 루트 인증서를 얻습니다.
...
첫 번째 명령은 Application Gateway를 사용하여 애플리케이션 게이트웨이를 $gw 저장합니다.
두 번째 명령은 Application Gateway에서 지정된 이름의 신뢰할 수 있는 루트 인증서를 얻습니다.
