...
이 cmdlet은 사용자가 PARAM:VpnClientIpsecPolicy에 전달할 수 있는 하나 또는 모든 매개 변수 값을 사용하여 ResourceGroup에서 New-AzVirtualNetworkGateway(새 VPN Gateway 만들기) /Set-AzVirtualNetworkGateway(기존 VPN Gateway 업데이트)를 사용하여 vpn ipsec 정책 개체를 만드는 데 사용됩니다.
