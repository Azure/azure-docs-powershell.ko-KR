...
그런 다음 이 commandlet을 사용하여 구성을 다운로드합니다.

commandlet이 성공하면 다운로드 구성이 SignedSasUrl로 표시된 Blob에 기록됩니다.
...
### -StorageSasUrl
구성을 생성해야 하는 저장소 위치에 대한 SAS URL입니다.
