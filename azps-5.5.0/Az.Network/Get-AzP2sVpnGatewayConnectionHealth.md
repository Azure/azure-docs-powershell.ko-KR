...
**Get-AzP2sVpnGatewayConnectionHealth** cmdlet을 사용하면 P2SVpnGateway에서 지점 및 사이트 간 연결의 현재 집계된 상태 정보를 얻을 수 있습니다. 위의 명령 let 출력 상태는 P2SVpnGateway에 연결된 지점 및 사이트 클라이언트 수가 2인 경우를 보여줍니다. P2SVpnGateway를 통해 전송된 총 송수신 bytes는 각각 100 및 200입니다. 연결된 지점 및 사이트 클라이언트에 할당된 IP 주소는 "192.168.2.1", "192.168.2.2"입니다.
