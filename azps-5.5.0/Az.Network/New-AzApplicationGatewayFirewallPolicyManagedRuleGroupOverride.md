...
## 설명
**New-AzApplicationGatewayFirewallPolicyManagedRuleGroupOverride는** 방화벽 정책에 대한 managedRuleSet에 ruleGroupOverride 항목을 만듭니다.
...
$rule 1, $rule 2로 그룹 이름으로 그룹 $ruleName RuleGroupOverride 항목을 만듭니다. 동일한 할당을 $overrideEntry
...
### -RuleGroupName
RuleGroup 항목의 ruleGroupName을 지정합니다.
