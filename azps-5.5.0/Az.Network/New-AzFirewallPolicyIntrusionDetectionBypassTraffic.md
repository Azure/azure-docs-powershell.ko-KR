...
## SYNOPSIS
새 Azure Firewall 정책 침입 감지 우회 트래픽 설정을 만듭니다.
...
## 설명
**New-AzFirewallPolicyIntrusionDetectionBypassTraffic** cmdlet은 트래픽 개체를 무시하는 Azure Firewall 정책 침입 감지를 만듭니다.

## 예제

### 예제 1: 1. 특정 포트 및 원본 주소를 사용하여 트래픽 우회 만들기
```powershell
