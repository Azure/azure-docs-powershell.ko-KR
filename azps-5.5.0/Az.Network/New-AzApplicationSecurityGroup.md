...
## 설명
**New-AzApplicationSecurityGroup** cmdlet은 애플리케이션 보안 그룹을 만듭니다.
...
이 예제에서는 연결 없는 애플리케이션 보안 그룹을 만듭니다. 생성되면 네트워크 인터페이스의 IP 구성을 그룹에 포함될 수 있습니다. 보안 규칙은 그룹을 해당 원본 또는 대상으로 참조할 수도 있습니다.
