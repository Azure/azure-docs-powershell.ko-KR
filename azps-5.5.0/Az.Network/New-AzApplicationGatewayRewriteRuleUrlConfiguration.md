...
이 명령은 다시 작성 규칙 URL 구성을 만들고 결과를 $urlConfiguration.

기존 UrlConfiguration을 업데이트하려는 경우 새 UrlConfiguration을 만들고 규칙 작업 집합 다시 작성의 UrlConfiguration 속성에 새 UrlConfiguration을 할당하여 업데이트할 수 있습니다.
...
### -Reroute
수정된 경로를 사용하여 경로 기반 요청 라우팅 규칙에 제공된 URL 경로 맵을 다시 평가하는 플래그입니다.
