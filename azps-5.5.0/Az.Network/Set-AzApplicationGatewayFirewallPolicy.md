...
## 설명
**Set-AzApplicationGatewayFirewallPolicy** cmdlet은 Azure Application Gateway 방화벽 정책을 업데이트합니다.
...
이 명령은 $AppGwFirewallPolicy 변수의 설정으로 애플리케이션 게이트웨이 방화벽 정책을 업데이트하고 업데이트된 게이트웨이를 $UpdatedAppGwFirewallPolicy 저장합니다.
