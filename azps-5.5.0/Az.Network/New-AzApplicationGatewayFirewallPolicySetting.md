...
이 명령은 $enabledState $enabledMode 모드로, requestBodyCheck을 false로, FileUploadLimitInMb를 $fileUploadLimitInMb $ $fileUploadLimitInMb, MaxRequestBodySizeInKb를 $$maxRequestBodySizeInKb.
