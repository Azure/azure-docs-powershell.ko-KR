...
## 설명
Virtual Network 게이트웨이 연결에서 패킷 캡처 작업을 중지하고 저장소 컨테이너의 주어진 SasUrl에 결과를 업로드합니다.
...
### -InputObject
패킷 캡처를 시작할 가상 네트워크 게이트웨이 연결 개체입니다.
...
### -ResourceId
패킷 캡처를 시작할 VirtualNetworkGatewayConnection의 Azure 리소스 ID입니다.
...
### -SasUrl
가상 네트워크 게이트웨이에서 패킷 캡처를 중지하기 위한 SAS URL입니다.
