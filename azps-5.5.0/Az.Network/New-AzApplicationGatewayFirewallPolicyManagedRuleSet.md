...
ruleSetType을 $ruleSetType, ruleSetVersion을 $ruleSetVersion로, ruleGroupOverrides를 $ruleGroupOverride 1, $ruleGroupOverride 2 새 ManagedRuleSet이 새 ManagedRuleSet에 할당된 목록으로 $managedRuleSet
...
### -RuleSetType
managedRuleSet에서 RuleSetType 지정
...
### -RuleSetVersion
managedRuleSet에서 RuleSetVersion 지정
