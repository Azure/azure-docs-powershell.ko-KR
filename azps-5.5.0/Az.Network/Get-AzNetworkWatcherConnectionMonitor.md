...
## 설명
Get-AzNetworkWatcherConnectionMonitor cmdlet은 지정된 이름/resourceId 또는 지정된 네트워크 감시자/위치에 해당하는 연결 모니터 목록을 사용하여 연결 모니터를 반환합니다.
