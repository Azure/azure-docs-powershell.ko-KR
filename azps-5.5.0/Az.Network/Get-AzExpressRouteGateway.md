...
위의 리소스 그룹인 Virtual WAN, Virtual Network, Azure의 "testRG" 리소스 그룹에 미국 중서부의 Virtual Hub가 생성됩니다. ExpressRoute 게이트웨이는 2개 배율 단위가 있는 가상 허브에서 이후에 만들어집니다.

그런 다음 resourceGroupName 및 게이트웨이 이름을 사용하여 ExpressRouteGateway를 얻습니다.
...
이 명령은 "test"로 시작하는 모든 ExpressRouteGateways를 얻습니다.
