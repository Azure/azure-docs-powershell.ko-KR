...
## 설명
**Remove-AzExpressRoutePort** cmdlet은 ExpressRoutePort를 제거합니다.
...
구독의 $PortName 리소스 $rg ExpressRoutePort 리소스를 제거합니다.
...
InputObject에서 ExpressRoutePort 리소스를 제거합니다.
...
ResourceId를 사용하여 ExpressRoutePort 리소스를 $id.
