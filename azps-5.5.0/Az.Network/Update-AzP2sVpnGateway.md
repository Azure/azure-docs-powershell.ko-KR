...
## 설명
**Update-AzP2sVpnGateway** cmdlet을 사용하면 VirtualHub의 기존 P2SVpnGateway를 새 VpnClientAddressPool 또는 새 VpnServerConfiguration 또는 VpnGatewayScaleUnit의 변경으로 업데이트할 수 있습니다.
...
**Update-AzP2sVpnGateway** cmdlet을 사용하면 VirtualHub의 기존 P2SVpnGateway를 새 VpnClientAddressPool로 업데이트할 수 있습니다. 지점 및 사이트 대 사이트 클라이언트가 이 P2SVpnGateway에 연결하면 이 VpnClientAddressPool의 IP 주소 중 하나는 해당 클라이언트에 할당됩니다.

### 예제 2

지점 및 사이트 연결을 위해 VirtualHub에서 기존 P2SVpnGateway를 업데이트합니다. (자동Generated)
...
이 P2SVpnGateway 연결에 대한 인터넷 보안 플래그를 사용하지 않도록 설정
