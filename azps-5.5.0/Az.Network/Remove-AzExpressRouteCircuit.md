...
## 설명
**Remove-AzExpressRouteCircuit** cmdlet은 ExpressRoute 회로를 제거합니다.

## 예제

### 예제 1: ExpressRoute 회로 삭제
```
Remove-AzExpressRouteCircuit -Name $CircuitName -ResourceGroupName $rg
```

### 예제 2: 파이프라인을 사용하여 ExpressRoute 회로 삭제
```
...
### -ResourceGroupName
이 ExpressRoute 회로가 속한 리소스 그룹의 이름을 지정합니다.
