...
**Set-AzExpressRouteGateway** cmdlet을 사용하면 기존 ExpressRouteGateway의 배율 단위를 업데이트하거나 리소스 태그를 업데이트할 수 있습니다.
...
위의 리소스 그룹인 Virtual WAN, Virtual Network, Azure의 "testRG" 리소스 그룹에 미국 서부의 Virtual Hub가 생성됩니다. ExpressRoute 게이트웨이는 2개 배율 단위가 있는 가상 허브에서 이후에 만들어지며 3개 배율 단위로 수정됩니다.
...
### -InputObject
업데이트해야 하는 ExpressRouteGateway입니다.
...
### -ResourceId
업데이트해야 하는 ExpressRouteGateway의 ID입니다.
