...
## SYNOPSIS
새 Azure Firewall 정책 침입 감지 서명 오버라이드를 만듭니다.
...
## 설명
**New-AzFirewallPolicyIntrusionDetectionSignatureOverride** cmdlet은 Azure Firewall Policy Signature Override 개체를 만듭니다.

## 예제

### 예제 1: 1. 서명 오버라이드를 사용하여 침입 감지 만들기
```powershell
PS C:\> $signatureOverride = New-AzFirewallPolicyIntrusionDetectionSignatureOverride -Id "123456798" -Mode "Deny"
PS C:\> New-AzFirewallPolicyIntrusionDetection -Mode "Alert" -SignatureOverride $signatureOverride
```
이 예제에서는 거부 모드로 특정 서명을 오버라이드하여 침입 감지를 만듭니다.
