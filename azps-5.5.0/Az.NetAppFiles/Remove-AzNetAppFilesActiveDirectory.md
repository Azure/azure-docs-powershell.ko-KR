...
## 설명
**Remove-AzNetAppFilesActiveDirectory** cmdlet은 ANF Active Directory 구성을 삭제합니다.
...
이 명령은 이름이 "MyADName"인 새 ANF Active Directory 구성을 삭제합니다.
...
### -PassThru
지정된 Active Directory가 성공적으로 제거됐는지 여부를 반환합니다.
