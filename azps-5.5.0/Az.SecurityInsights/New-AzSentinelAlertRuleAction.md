...
## 설명
**New-AzSentinelAlertRuleAction** cmdlet은 지정된 작업 영역의 경고 규칙에 대한 자동화된 응답을 만듭니다.
논리 앱 모듈을 사용하여 찾을 수 있는 논리 앱 재지정 ID 및 트리거 URI를 제공해야 합니다.
...
이 예제에서는 논리 앱의 속성을 사용하여 지정된 경고 규칙에 대한 **AlertRuleAction을** 만든 다음 $AlertRuleAction 변수에 저장합니다.
