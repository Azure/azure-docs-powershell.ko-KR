...
## 설명
**Get-AzSentinelAlertRuleTemplate** cmdlet은 지정된 작업 영역의 경고 규칙 템플릿을 얻습니다.
...
이 예제에서는 지정된 작업 영역의 **AlertRuleTemplates를** 모두 표시한 다음, $AlertRuleTemplates 변수에 저장합니다.
...
이 예제에서는 지정된 작업 영역의 **AlertRuleTemplate을** 얻은 다음, 경고 변수에 $AlertRuleTemplate 저장합니다.
