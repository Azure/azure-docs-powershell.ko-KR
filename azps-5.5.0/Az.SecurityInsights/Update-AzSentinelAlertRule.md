...
## 설명
**Update-AzSentinelAlertRule** cmdlet은 지정된 작업 영역의 분석(경고 규칙)을 업데이트합니다.
-InputObject 또는 -ResourceId 또는 -AlertId를 사용할 수 있습니다.  1개 이상의 proprtery parmaters를 업데이트할 수 있습니다.
...
이 예제에서는 **AlertRule** 설정을 *Disabled로* 업데이트하고 *Disabled-AlertRuleDisplayName으로 이름을 변경합니다.*  다른 모든 속성은 동일하게 유지됩니다.
...
이 예제에서는 InputObject 설정을 사용 안 으로 설정하여 **AlertRule을** *업데이트합니다.*  다른 모든 속성은 동일하게 유지됩니다.
