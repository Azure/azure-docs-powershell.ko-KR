...
해당 아티팩트를 통해 청사진 정의를 가져오고 구독 내에 저장합니다.
...
### -PassThru
설정하면 cmdlet은 가져온 청사진 정의를 나타내는 개체를 반환합니다. 기본적으로 이 cmdlet은 출력을 생성하지 않습니다.
