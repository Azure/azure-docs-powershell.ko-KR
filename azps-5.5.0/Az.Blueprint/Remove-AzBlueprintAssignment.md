...
지정된 구독에서 이름으로 지정된 청사진 할당을 제거합니다. cmdlet은 명령을 실행하기 전에 확인을 요청합니다.
...
### -PassThru
설정하면 cmdlet은 제거된 청사진 할당을 나타내는 개체를 반환합니다. 기본적으로 이 cmdlet은 출력을 생성하지 않습니다.
