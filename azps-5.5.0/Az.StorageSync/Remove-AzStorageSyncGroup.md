...
## 설명
이 명령은 지정된 동기화 그룹을 삭제합니다. 포함된 모든 엔드포인트가 먼저 삭제될 때만 동기화 그룹을 제거할 수 있습니다.
...
### -PassThru
정상적인 실행에서 이 cmdlet은 성공 시 값을 반환하지 않습니다. PassThru 매개 변수를 제공하는 경우 cmdlet은 성공적으로 실행된 후 파이프라인에 값을 기록합니다.
