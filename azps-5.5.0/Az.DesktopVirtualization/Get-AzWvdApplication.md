...
### 예제 1: 이름으로 Windows Virtual Desktop 애플리케이션 다운로드
```powershell
...
이 명령은 응용 프로그램 그룹에서 Windows Virtual Desktop 애플리케이션을 얻습니다.
...
이 명령은 응용 프로그램 그룹의 Windows Virtual Desktop 애플리케이션을 나열합니다.
