...
### 예제 1: 이름으로 Windows Virtual Desktop HostPool 다운로드
```powershell
...
이 명령은 리소스 그룹에서 Windows Virtual Desktop HostPool을 얻습니다.

### 예제 2: Windows Virtual Desktop HostPools 나열
```powershell
...
이 명령은 리소스 그룹에 Windows Virtual Desktop HostPools를 나열합니다.
