...
### 예제 1: 이름으로 Spring Cloud Service를 업데이트합니다.
```powershell
...
이름으로 Spring Cloud Service를 업데이트합니다.

### 예제 2: 파이프에서 Spring Cloud Service 업데이트
```powershell
...
파이프에서 Spring Cloud Service를 업데이트합니다.
