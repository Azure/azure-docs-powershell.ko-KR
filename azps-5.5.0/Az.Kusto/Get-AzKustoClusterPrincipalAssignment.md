...
### 예제 1: 모든 Kusto 클러스터 principalAssignment 나열
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터의 모든 principalAssignment를 나열합니다.

### 예제 2: 이름으로 Kusto 클러스터 principalAssignment를 얻습니다.
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터에 "kustoprincipal1"이라는 Kusto 클러스터 principalAssignment를 반환합니다.
