...
위의 명령은 "testnewkustoclusterf" 클러스터의 모든 AttachedDatabaseConfigurations를 나열합니다.
...
위의 명령은 "testnewkustoclusterf" 클러스터에 "myfollowerconfiguration"이라는 AttachedDatabaseConfigurations를 반환합니다.
