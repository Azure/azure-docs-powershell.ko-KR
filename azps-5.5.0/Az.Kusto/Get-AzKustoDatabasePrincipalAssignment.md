...
### 예제 1: 이름에 따라 데이터베이스의 모든 PrincipalAssignment 나열
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터에 있는 데이터베이스 "mykustodatabase"의 모든 PrincipalAssignment를 반환합니다.

### 예제 2: 이름으로 데이터베이스에서 특정 PrincipalAssignment를 얻습니다.
```powershell
...
위의 명령은 "testnewkustocluster" 클러스터에 있는 데이터베이스 "mykustodatabase"의 "kustoprincipal1"이라는 모든 PrincipalAssignment를 반환합니다.
