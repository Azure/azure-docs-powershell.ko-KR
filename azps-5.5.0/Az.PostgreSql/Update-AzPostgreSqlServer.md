...
### -MinimalTlsVersion
SSL을 사용할 때 서버에 연결하기 위한 최소 TLS 버전을 설정합니다.
기본값은 TLSEnforcementDisabled.accepted 값(TLS1_0, TLS1_1, TLS1_2, TLSEnforcementDisabled)입니다.
...
### -SslEnforcement
서버에 연결할 때 ssl 적용을 사용하도록 설정하지 않습니다.
