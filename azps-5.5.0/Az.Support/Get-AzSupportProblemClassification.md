...
### 예제 1: 서비스 ID 매개 변수를 사용하여 서비스에 대한 모든 문제 분류를 얻습니다.
```powershell
...
### 예제 2: 부모 서비스 개체를 사용하여 서비스에 대한 모든 문제 분류자 얻기
```powershell
...
### 예제 3: 서비스 개체를 파이핑하여 ID로 단일 문제 분류에 대한 세부 정보 얻습니다.
```powershell
