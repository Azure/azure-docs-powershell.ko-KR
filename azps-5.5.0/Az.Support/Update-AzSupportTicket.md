...
## 설명
이 cmdlet을 사용하여 지원 티켓의 심각도 수준, 상태 또는 고객 연락처 세부 정보를 업데이트합니다. 지원 티켓의 심각도 수준 또는 상태 업데이트는 지원 엔지니어에게 티켓을 할당할 때 허용되지 않습니다. 티켓 할당 후 심각도 수준 또는 상태를 업데이트할 경우 티켓에 대한 통신을 보내 지원 엔지니어에게 문의하세요.
