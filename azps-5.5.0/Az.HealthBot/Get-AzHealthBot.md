...
### 예제 2: ResourceGroupName에서 모든 HealthBot을 얻게
```powershell
...
ResourceGroupName에 의해 모든 HealthBot을 얻게 됩니다.

### 예제 3: ResourceGroupName 및 이름에 의해 HealthBot를 얻게
```powershell
...
ResourceGroupName 및 Name에 의해 HealthBot을 얻게 됩니다.

### 예제 4: InputObject로 HealthBot를 얻습니다.
```powershell
