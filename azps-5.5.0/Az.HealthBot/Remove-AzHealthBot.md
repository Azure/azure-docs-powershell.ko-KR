...
### 예제 1: ResourceGroupName 및 Name으로 HealthBot 삭제
```powershell
PS C:\> Remove-AzHealthBot -Name yourihealthbot -ResourceGroupName youriTest

```

ResourceGroupName 및 Name으로 HealthBot 삭제

### 예제 2: InputObject로 HealthBot 삭제
```powershell
...
INPUTOBJECT: <IHealthBotIdentity> ID 매개 변수
  - `[BotName <String>]`: 봇 리소스의 이름입니다.
  - `[Id <String>]`: 리소스 ID 경로
