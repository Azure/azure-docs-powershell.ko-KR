...
### -FilePath
SQL 정보 보호 정책 정의를 포함 하는 json 파일의 경로를 지정 합니다.
...
### -정책
SQL 정보 보호 정책 정의를 지정 합니다. Json 파일 또는 정책을 정의 하는 JSON 형식 문자열의 경로를 지정할 수 있습니다.
...
### SqlInformationProtectionPolicy. PSSqlInformationProtectionPolicy에 대 한 Microsoft
