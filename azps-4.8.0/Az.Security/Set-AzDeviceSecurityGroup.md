...
## 설명은
Set-AzDeviceSecurityGroup cmdlet은 iot security 솔루션에 정의 된 장치 보안 그룹을 만들거나 업데이트 합니다.
...
IoT Hub "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"에서 규칙 유형 "ActiveConnectionsNotInAllowedRange"으로 기존 장치 보안 그룹 업데이트
...
### Microsoft. DeviceSecurityGroups. PSThresholdCustomAlertRule [])

### Microsoft. DeviceSecurityGroups. PSTimeWindowCustomAlertRule [])

### Microsoft. DeviceSecurityGroups. PSAllowlistCustomAlertRule [])
