...
## 설명은
Set-AzSecuritySetting cmdlet은 Azure 보안 센터의 특정 보안 설정을 업데이트 합니다.
...
### System. 문자열
### Microsoft. i. i m/. 설정. PSSecuritySetting
### Microsoft. PSSecurityDataExportSetting으로 설정 합니다.
