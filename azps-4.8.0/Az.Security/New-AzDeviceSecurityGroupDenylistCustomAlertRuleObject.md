...
## 설명은
New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject cmdlet은 IoT security 솔루션에서 장치 보안 그룹에 대 한 denyed 사용자 지정 알림 규칙의 새 목록을 만듭니다.
...
새 거부 목록 만들기 rull 유형이 "SomeRuleType"이 고 상태가 desable로 설정 된 사용자 지정 알림 규칙
