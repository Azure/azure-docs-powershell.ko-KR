...
## 설명은
Spcific 컨트롤 세부 정보를 가져오거나 특정 규제 준수 표준 아래의 모든 컨트롤을 나열 합니다.
...
컨트롤 id에 따라 특정 컨트롤 세부 정보를 가져옵니다.
...
리소스 id에 따라 특정 컨트롤 세부 정보를 가져옵니다.
...
### RegulatoryCompliance. PSSecurityRegulatoryComplianceControl에 대 한 Microsoft
