...
## 설명은
Get-AzIotSecurityAnalyticsAggregatedAlert cmdlet은 iot hub 장치에서 하나 이상의 집계 된 권장 사항을 반환 합니다. 집계 된 추천의 이름은 해당 형식입니다.
...
보안 솔루션 "MySolution" 및 리소스 그룹 "Mysolution"에서 집계 된 권장 구성 "IoT_OpenPorts"를 가져옵니다.
...
보안 솔루션 "MySolution" 및 리소스 그룹 "Mysolution"에서 집계 권장 사항 목록 가져오기
...
### Microsoft. Azure. Irootsecurity솔루션 PSIoTSecurityAggregatedRecommendation
