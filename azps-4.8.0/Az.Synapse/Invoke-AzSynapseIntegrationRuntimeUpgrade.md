...
## 설명은
새 버전을 사용할 수 있는 경우 **AzSynapseIntegrationRuntimeUpgrade** cmdlet은 자체 호스트 된 통합 런타임을 업그레이드 합니다.
...
Cmdlet이 "selfhost-ir ' 이라는 자체 호스팅 통합 런타임을 작업 영역 ContosoWorkspace에서 업그레이드 합니다.
