...
## 설명은
**AzSynapseLinkedService** cmdlet은 작업 영역에서 연결 된 서비스를 제거 합니다.
...
이 명령은 ContosoWorkspace 이라는 작업 영역에서 ContosoLinkedService 이라는 연결 된 서비스를 제거 합니다.
...
이 명령은 ContosoWorkspace ~ 파이프라인 이라는 작업 영역에서 ContosoLinkedService 이라는 연결 된 서비스를 제거 합니다.
