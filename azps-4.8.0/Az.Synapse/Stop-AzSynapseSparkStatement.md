...
## 설명은
**AzSynapseSparkStatement** Cmdlet은 Synapse Analytics Spark 문을 취소 합니다.
...
이 명령은 지정 된 livy ID의 Spark 문을 취소 합니다.
...
이 명령은 지정 된 livy ID를 통해 파이프라인을 사용 하 여 Spark 문을 취소 합니다.
