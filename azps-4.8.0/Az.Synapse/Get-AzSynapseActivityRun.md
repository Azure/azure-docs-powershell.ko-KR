...
## 설명은
**AzSynapseActivityRun** cmdlet은 지정 된 시간에 발생 한 특정 파이프라인 실행에 대 한 작업 영역의 실행에 대 한 정보를 가져옵니다. 또한 활동 이름 및 실행 상태에 대 한 필터를 지정할 수도 있습니다.
...
이 명령은 "2018-09-01T21:00"과 "2018-09-30T21:00" 사이에 발생 한 ID가 "f288712d-fb08-4cb8-96ef-82d3b9b30621" 인 ContosoPipeline run 이라는 파이프라인의 모든 작업 실행에 대 한 세부 정보를 가져옵니다.
...
이 명령은 "2018-09-01T21:00" 및 "2018-09-30T21:00"에서 파이프라인 까지의 ID가 "f288712d-fb08-4cb8-96ef-82d3b9b30621" 인 ContosoPipeline run 이라는 파이프라인의 모든 작업 실행에 대 한 세부 정보를 가져옵니다.
...
### -RunStartedAfter
' ISO 8601 ' 형식으로 실행 이벤트가 업데이트 된 시간 또는 이후
...
### -RunStartedBefore
' ISO 8601 ' 형식으로 실행 이벤트를 업데이트 한 날짜 또는 그 이전의 시간
...
### Synapse. PSActivityRunsQueryResponse
