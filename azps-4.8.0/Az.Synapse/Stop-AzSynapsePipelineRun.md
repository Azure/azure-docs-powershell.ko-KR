...
## 설명은
**AzSynapsePipelineRun** cmdlet은 파이프라인 실행 ID를 사용 하 여 지정 된 작업 영역에서 파이프라인 실행을 중지 합니다.
...
이 명령은 workspace ContosoWorkspace에서 id b9730a13-aa12-4926-a8b3-8e3a974ab0bd를 사용 하 여 파이프라인 실행을 중지 합니다.
...
이 명령은 workspace ContosoWorkspace to 파이프라인에서 id b9730a13-aa12-4926-a8b3-8e3a974ab0bd를 사용 하 여 파이프라인 실행을 중지 합니다.
