...
## 설명은
**AzSynapseDataset** cmdlet은 작업 영역에서 데이터 집합을 만들거나 기존 데이터 집합을 업데이트 합니다.
...
이 명령은 ContosoWorkspace 이라는 작업 영역에 ContosoDataset 이라는 데이터 집합을 만듭니다.
명령은 파일의 Dataset.js정보를 기준으로 데이터 집합을 기준으로 합니다.
