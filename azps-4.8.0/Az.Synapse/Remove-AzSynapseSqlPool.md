...
## 설명은
**AzSynapseSqlPool** Cmdlet은 Azure SYNAPSE Analytics SQL 풀을 영구적으로 삭제 합니다.
...
이 명령은 Azure Synapse Analytics SQL 풀을 삭제 합니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics SQL 풀을 삭제 합니다.
...
이 명령은 지정 된 리소스 ID를 사용 하 여 Azure Synapse Analytics SQL 풀을 삭제 합니다.
