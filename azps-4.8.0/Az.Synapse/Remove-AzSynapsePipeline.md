...
## 설명은
**Remove-AzSynapsePipeline** cmdlet은 작업 영역에서 파이프라인을 제거 합니다.
...
이 cmdlet은 ContosoWorkspace 이라는 작업 영역에서 ContosoPipeline 이라는 파이프라인을 제거 합니다.
...
이 cmdlet은 ContosoPipeline 이라는 파이프라인을 ContosoWorkspace에서 파이프라인 이라는 작업 영역에서 제거 합니다.
