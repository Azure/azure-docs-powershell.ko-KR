...
## 설명은
**AzSynapseSparkSessionTimeout** Cmdlet은 Synapse Analytics Spark 세션의 시간 제한을 다시 설정 합니다.
...
이 명령은 지정 된 livy ID를 사용 하 여 Synapse Analytics Spark 세션의 시간 제한을 다시 설정 합니다.
...
이 명령은 지정 된 livy ID를 통해 파이프라인을 사용 하 여 Synapse Analytics Spark 세션의 시간 제한을 다시 설정 합니다.
