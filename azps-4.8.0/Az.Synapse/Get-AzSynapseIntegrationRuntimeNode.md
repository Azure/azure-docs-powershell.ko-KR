...
## 설명은
**AzSynapseIntegrationRuntimeNode** cmdlet은 통합 런타임 노드의 세부 정보를 가져옵니다.
...
Cmdlet은 작업 영역 ContosoWorkspace에서 자체 호스팅된 통합 런타임 ' selfhost-ir '의 ' Node_1 ' 노드에 대 한 정보를 가져옵니다.
...
Cmdlet은 IP 주소를 포함 하 여 ' selfhost-eu2 ' 작업 영역의 자체 호스팅된 통합 런타임 ' test-ir '의 ' Node_1 ' 노드에 대 한 정보를 가져옵니다.
...
### Synapse. PSManagedIntegrationRuntimeNode/.

### Synapse. PSSelfHostedIntegrationRuntimeNode/.
