...
## 설명은
**Remove-AzSynapseTrigger** cmdlet은 작업 영역에서 트리거를 제거 합니다.
...
작업 영역 ContosoWorkspace에서 ContosoTrigger 이라는 트리거를 제거 합니다.
...
파이프라인을 통해 작업 영역 ContosoWorkspace에서 ContosoTrigger 이라는 트리거를 제거 합니다.
