...
## 설명은
**AzSynapseIntegrationRuntimeMetric** cmdlet은 작업 영역의 통합 런타임에 대 한 메트릭 데이터를 가져옵니다.
...
이 명령은 ContosoWorkspace 이라는 작업 영역의 ' selfhost-ir ' 이라는 통합 런타임에 대 한 메트릭 데이터를 표시 합니다.
...
### Synapse. PSIntegrationRuntimeMetrics/.
