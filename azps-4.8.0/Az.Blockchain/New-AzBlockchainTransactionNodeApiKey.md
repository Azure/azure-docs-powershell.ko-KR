...
### 예제 1: 이름을 사용 하 여 트랜잭션 노드에 대 한 Api 키를 다시 생성 합니다.
```powershell
...
이 명령은 name, 리소스 그룹을 사용 하 여 트랜잭션 노드에 대 한 Api 키를 생성 합니다.

### 예제 2: 트랜잭션 노드에 대 한 Api 키 다시 생성
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
이 명령은 idenity를 사용 하 여 트랜잭션 노드에 대 한 Api 키를 생성 합니다.
