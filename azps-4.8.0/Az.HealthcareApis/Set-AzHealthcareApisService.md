...
## SYNOPSIS
기존 healthcareApis fa r 서비스를 업데이트 합니다.
...
### 예제 1: cosmosdb OfferThroughput = 500에서 리소스 그룹 MyResourceGroup의 MyService 라는 기존 healthcareapis 서비스를 업데이트 합니다.
...
### 예제 2: 리소스 그룹 MyResourceGroup의 MyService 이라는 기존 healthcareapis 서비스를 cosmosdb OfferThroughput = 500에 업데이트 합니다.
...
### -CorsOrigin
HealthcareApis FhirService Cors 원본 목록입니다. Cors 원본에 대 한 HealthcareApis Fa r 서비스 목록입니다. 이 API에 액세스할 수 있는 원본 사이트의 Url을 지정 하거나 *를 사용 하 여 사이트에서 액세스를 허용 합니다.
...
HealthcareApis FhirService CorsCredentials 허용 되지 않음.
...
HealthcareApis f r 서비스 내보내기 저장소 계정 이름입니다.
...
### -InputObject
AzHealthcareApisFhirService에서 HealthcareApis fa r 서비스를 시작 했습니다.
...
### -ResourceId
HealthcareApis Fa r 서비스 ResourceId.
