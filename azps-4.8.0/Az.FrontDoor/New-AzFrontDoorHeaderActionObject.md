...
## 설명은
PSRulesEngineAction 개체를 만들기 위한 PSHeaderAction 개체를 만듭니다.
...
### -값
지정 된 헤더 이름을 업데이트할 값입니다.
이 값은 actionType이 Delete 인 경우에는 사용 되지 않습니다.
