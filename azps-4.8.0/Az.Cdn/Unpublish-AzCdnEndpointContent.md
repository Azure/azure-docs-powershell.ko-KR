...
## 설명은
**AzCdnEndpointContent** Cmdlet은 Azure CDN (콘텐츠 배달 네트워크) 끝점에서 콘텐츠를 제거 합니다.
...
### -EndpointName
이 cmdlet이 제거 하는 끝점의 이름을 지정 합니다.
...
### -PurgeContent
이 cmdlet이 제거 하는 원본 서버의 콘텐츠에 대 한 상대 경로 배열을 지정 합니다.
