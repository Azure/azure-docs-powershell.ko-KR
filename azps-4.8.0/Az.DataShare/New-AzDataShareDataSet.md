...
## 설명은
Data 공유 계정의 azure data share에서 **AzDataShareDataSet** cmdlet이 데이터 집합을 추가 합니다. Blob, ADLS Gen2 및 ADLS Gen1 유형의 데이터 집합을 추가할 수 있습니다.
...
이 명령은 형식 blob 컨테이너의 AdsDataSet 이라는 데이터 집합을 azure data 공유 Adsdataset에 추가 합니다.
