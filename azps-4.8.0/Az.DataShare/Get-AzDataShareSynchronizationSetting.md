...
## 설명은
**AzDataShareSynchronizationSetting** cmdlet은 공유에서 사용 하도록 설정 된 동기화에 대 한 정보를 제공 합니다. 
...
이 명령은 data 공유 계정 WikiAds에서 ShareSynchronization 공유에서 사용 하도록 설정 된 동기화에 대 한 정보를 제공 합니다.
