...
## 설명은
**AzDataShareSubscriptionSynchronizationDetail** cmdlet은 공유 구독에 대해 시작 된 동기화에 대 한 세부 정보를 제공 합니다.
...
이 명령은 data 공유 계정 WikiAds에서 구독 공유 AdsShareSubscription 동기화 시작에 대 한 정보를 제공 합니다.
