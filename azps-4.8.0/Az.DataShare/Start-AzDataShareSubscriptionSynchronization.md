...
## 설명은
**AzDataShareSubscriptionSynchronization** cmdlet이 공유 구독에 대 한 동기화를 시작 합니다.
...
이 명령은 AdsShareSubscription 라는 계정 WikiAds의 sharesubscription에 대 한 동기화를 시작 합니다. 
