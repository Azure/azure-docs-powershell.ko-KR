...
## 설명은
New-AzSqlVMGroup cmdlet은 Azure SQL 가상 컴퓨터 그룹을 만듭니다.
...
리소스 그룹 ResourceGroup01에서 테스트 그룹 vm을 사용 하 여 새 Azure SQL 가상 컴퓨터 그룹을 만듭니다.
$profile는 WsfcDomainProfile 형식의 개체입니다. SqlVirtualMachine.
...
### -SqlServiceAccount
클러스터의 모든 참여 SQL 가상 컴퓨터에서 SQL 서비스를 실행할 때 사용할 수 있는 이름
