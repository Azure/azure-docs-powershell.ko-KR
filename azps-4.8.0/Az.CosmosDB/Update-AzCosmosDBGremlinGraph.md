...
PSConflictResolutionPolicy 형식의 ConflictResolutionPolicy 개체는 제공 되는 경우 컨테이너의 ConflictResolutionPolicy로 설정 됩니다.
...
### -IndexingPolicy
CosmosDB Indexingpolicy 유형의 인덱싱 정책 개체입니다.
...
### -UniqueKeyPolicy
UniqueKeyPolicy. CosmosDB. PSUniqueKeyPolicy의 형식 개체입니다.
...
### CosmosDB. PSUniqueKeyPolicy/.

### CosmosDB. PSConflictResolutionPolicy/.
