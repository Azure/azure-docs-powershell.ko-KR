...
## 설명은
**AzCosmosDBMongoDBDatabase** Cmdlet은 CosmosDB MongoDB 데이터베이스를 삭제 합니다.
...
Cmdlet은 삭제가 성공한 경우 true 인 bool (-PassThru가 전달 되는 경우) 형식의 개체를 반환 합니다.
...
### -PassThru
사용자가 출력을 받으려는 경우 true로 설정 됩니다.
작업에 성공한 경우 출력이 true이 고, 그렇지 않은 경우 오류가 발생 합니다.
