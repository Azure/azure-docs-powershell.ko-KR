...
계정에서 AnalyticalStorage을 사용할 수 있는지 여부를 나타내는 부울입니다.
...
### -EnableFreeTier
계정에서 FreeTier 사용 되는지 여부를 나타내는 부울입니다.
...
### -IpRule
방화벽 지원. 지정 된 데이터베이스 계정에 대 한 클라이언트 Ip의 허용 목록으로 포함할 IP 주소 또는 IP 주소 범위 집합을 지정 합니다.
...
### -ServerVersion
ServerVersion, MongoDB 계정의 경우에만 유효 합니다.
