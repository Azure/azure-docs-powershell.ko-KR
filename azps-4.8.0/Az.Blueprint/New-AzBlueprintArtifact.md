...
## 설명은
새 아티팩트를 만듭니다. 아티팩트를 입력 파일로 만들거나 아티팩트에 대 한 인라인 매개 변수를 제공 하는 두 가지 방법이 있습니다. JSON 메서드에는 인라인 매개 변수 메서드를 제공할 아티팩트의 형식이 필요 하지 않지만 사용자는 아티팩트를 통해 형식의 매개 변수를 제공 해야 합니다.
