...
## SYNOPSIS
Azure ActiveDirectory 응용 프로그램 세부 정보를 DataMigration 새 인스턴스를 만듭니다.
...
```
ApplicationId: "사용자의 AppId/서비스 사용자 Id" AppKey: System.webserver TenantId: "테 넌 트 Id"
...
### -ApplicationId
Azure Active Directory 응용 프로그램 Id
...
### DataMigration. PSAzureActiveDirectoryApp/.
