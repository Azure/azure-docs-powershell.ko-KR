...
New-AzDataMigrationSyncSelectedDB cmdlet은 원본 및 대상 데이터베이스에 대 한 정보를 포함 하는 동기화 시나리오와 관련 된 데이터베이스 정보 개체를 만듭니다.
...
이 예제에서는 데이터베이스 $DatabaseName $DatabaseName에 대 한 마이그레이션 설정을 설명 하는 데이터베이스 메타 데이터 개체를 만듭니다.  
...
### DataMigration. MigrateSqlServerSqlDbSyncTaskInput/.
