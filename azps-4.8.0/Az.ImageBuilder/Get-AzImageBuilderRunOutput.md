...
이 명령은 모든 실행 결과를 서식 파일에 나열 합니다.

### 예제 2: 템플릿 아래에서 실행 결과 가져오기
```powershell
...
이 명령은 서식 파일 아래에서 실행 결과를 가져옵니다.

### 예제 3: 템플릿 아래에서 실행 결과 가져오기
```powershell
