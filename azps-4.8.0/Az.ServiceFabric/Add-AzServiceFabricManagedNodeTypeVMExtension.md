...
## 설명은
노드 형식에 vm 확장을 추가 합니다. 이렇게 하면 확장은 가상 컴퓨터 확장 집합 리소스에 추가 됩니다.
...
이 명령은 설정 및 보호 된 설정과 함께 확장을 노드 형식에 추가 합니다.
...
이 명령은 노드 형식에 파이핑을 사용 하 여 확장을 추가 합니다.
...
이 확장을 프로 비전 해야 하는 확장명 이름 컬렉션입니다.
...
### -Publisher
확장 처리기 게시자의 이름입니다.
이는 Get-AzVMImagePublisher cmdlet을 사용 하 여 게시자를 가져올 수 있습니다.
...
Get-AzVMExtensionImageType cmdlet을 사용 하 여 확장 형식을 가져올 수 있습니다.
