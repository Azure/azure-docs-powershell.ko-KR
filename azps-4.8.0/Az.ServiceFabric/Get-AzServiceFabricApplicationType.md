...
## 설명은
이 cmdlet을 사용 하 여 지정 된 리소스 그룹 및 클러스터의 응용 프로그램 유형 세부 정보를 가져옵니다.
...
이 예제에서는 해당 리소스를 찾을 수 없는 경우 지정 된 매개 변수를 사용 하 여 응용 프로그램 형식 세부 정보를 가져옵니다.
...
이 예제에서는 지정 된 클러스터 아래에 정의 된 응용 프로그램 종류의 목록을 가져옵니다.
