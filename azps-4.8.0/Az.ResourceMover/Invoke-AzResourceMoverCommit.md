...
### 예제 1: 리소스를 커밋하기 전에 dependecies의 유효성 검사
```powershell
...
리소스를 커밋하기 전에 dependecies의 유효성을 검사 합니다.

### 예제 2: "MoveResource Name"을 입력으로 사용 하 여 Move Collection의 리소스 집합 커밋
```powershell
...
"MoveResource Name"을 입력으로 사용 하 여 Move Collection의 리소스 집합을 커밋합니다.

### 예제 3: "Sourc? Mid"를 입력으로 사용 하 여 Move Collection의 리소스 집합 커밋
```powershell
...
"Sourc? Mid"를 입력으로 사용 하 여 Move Collection의 리소스 집합을 커밋합니다.
