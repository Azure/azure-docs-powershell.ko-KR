...
### 예제 1: 구독의 모든 이동 컬렉션에 대 한 세부 정보 가져오기
```powershell
...
구독의 모든 이동 컬렉션에 대 한 세부 정보를 가져옵니다.

### 예제 2: 구독에서 지정 된 move collection 이름으로 이동 컬렉션의 세부 정보 가져오기
```powershell
...
구독에서 지정 된 move collection 이름으로 이동 컬렉션에 대 한 세부 정보를 가져옵니다.

### 예제 3: 구독에서 지정 된 리소스 그룹 이름을 갖는 Move collection에 대 한 세부 정보 가져오기
```powershell
...
구독에서 지정 된 리소스 그룹 이름을 갖는 Move Collection에 대 한 세부 정보를 가져옵니다.
...
### Api20191001Preview를 통해. a. i. PowerShell.
