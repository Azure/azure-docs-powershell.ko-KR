...
### 예제 1: resourceGroup 및 서버 이름으로 PostgreSql 서버 제거
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

이 cmdlet은 resourceGroup 및 서버 이름으로 PostgreSql 서버를 제거 합니다.

### 예제 2: id를 기준으로 PostgreSql 서버 제거
```powershell
...
이러한 cmdlet은 id를 기준으로 PostgreSql 서버를 제거 합니다.
