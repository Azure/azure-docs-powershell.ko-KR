...
### 예제 1: GeoReplica Restore를 사용 하 여 PostgreSql 서버 복원
```powershell
...
이 cmdlet은 GeoReplica Restore를 사용 하 여 PostgreSql 서버를 복원 합니다.

### 예제 2: PointInTime Restore를 사용 하 여 PostgreSql 서버 복원
```powershell
...
이러한 cmdlet은 PointInTime Restore를 사용 하 여 PostgreSql 서버를 복원 합니다.
