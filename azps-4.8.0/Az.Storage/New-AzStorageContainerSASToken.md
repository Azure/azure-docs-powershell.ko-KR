...
### 예제 3: OAuth 인증을 기반으로 하는 저장소 컨텍스트를 사용 하 여 사용자 Id 컨테이너 SAS 토큰 생성
```
...
이 예제에서는 OAuth 인증을 기반으로 하는 저장소 컨텍스트를 사용 하 여 사용자 Id 컨테이너 SAS 토큰을 생성 합니다.
...
저장소 컨텍스트가 OAuth 인증을 기반으로 하는 경우 사용자 Id 컨테이너 SAS 토큰이 생성 됩니다.
