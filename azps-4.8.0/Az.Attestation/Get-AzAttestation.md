...
## 설명은
Get-AzAttestation cmdlet은 구독의 증명에 대 한 정보를 가져옵니다.
...
리소스 그룹 *psh-테스트-rg* 에서 증명 공급자 *pshtest* 를 가져옵니다.
...
### -ResourceGroupName
쿼리 중인 증명에 연결 된 리소스 그룹의 이름을 지정 합니다.
...
### -ResourceId
쿼리 중인 증명에 연결 된 ResourceID의 이름을 지정 합니다.
