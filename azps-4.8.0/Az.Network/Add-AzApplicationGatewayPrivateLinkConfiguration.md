...
## SYNOPSIS
응용 프로그램 게이트웨이에 개인 링크 구성을 추가 합니다.
...
## 설명은
**Add-AzApplicationGatewayPrivateLinkConfiguration** cmdlet은 응용 프로그램 게이트웨이에 개인 링크 구성을 추가 합니다.
...
첫 번째 명령은 privateLinkIpConfiguration를 만들고이를 $PrivateLinkIpConfiguration 변수에 저장 합니다.
두 번째 명령은 ResourceGroup01 이라는 리소스 그룹에 속하는 ApplicationGateway01 라는 응용 프로그램 게이트웨이를 가져와이를 $AppGw 변수에 저장 합니다.
세 번째 명령은 privateLinkConfig01 이라는 개인 링크 구성을 해당 게이트웨이에 대해 $AppGw에 추가 합니다.
