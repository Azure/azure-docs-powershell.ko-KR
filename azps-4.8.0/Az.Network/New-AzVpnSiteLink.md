...
위의 작업을 통해 Azure의 "testRG" 리소스 그룹에 "VpnSiteLinks" 인 리소스 그룹, 가상 WAN 및 VpnSite를 만들 수 있습니다.

### 예제 2

Azure VpnSiteLink 개체를 만듭니다. 생성
