...
## 설명은
**AzVpnServerConfiguration** cmdlet을 사용 하면 다른 VpnProtocols, VpnAuthenticationTypes, 정책 가능 정책을 사용 하 여 새 VpnServerConfiguration를 만들고, 선택 된 vpn 인증 유형 관련 매개 변수를 사이트 연결 지점의 고객 요구 사항에 따라 설정할 수 있습니다.
...
사이트 연결을 위한 새 VpnServerConfiguration를 만듭니다. 생성
