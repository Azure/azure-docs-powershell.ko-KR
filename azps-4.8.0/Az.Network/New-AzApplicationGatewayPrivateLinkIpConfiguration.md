...
## SYNOPSIS
PrivateLink 구성에 연결할 Ip 구성을 만듭니다.
...
## 설명은
**AzApplicationGatewayPrivateLinkIpConfiguration** Cmdlet은 Azure application gateway에 대 한 PrivateLink 구성에 연결할 Ip 구성을 만듭니다.
...
이 명령은 이름이 ' ipConfig01 ' 인 PrivateLink IP 구성을 만들어 $PrivateLinkIpConfiguration 이라는 변수에 결과를 저장 합니다. 
...
### PSApplicationGatewayPrivateLinkIpConfiguration에 대 한.
