...
이름이 "testrg"이 고 ResourceGroupName "test" 인 특정 Express 경로를 가져옵니다.

### 예제 2: 필터링을 사용 하 여가을 기준으로 Express 회로 나열
```
...
이름이 "test"로 시작 하는 모든 Express 회로를 가져옵니다.
