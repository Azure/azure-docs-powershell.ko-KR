...
그런 다음 해당 ResourceGroupName 및 Context.resourcename을 사용 하 여 가상 허브를 삭제 합니다.
...
그런 다음 입력 개체를 사용 하 여 가상 허브를 삭제 합니다. 입력 개체는 PSVirtualHub 유형입니다.
...
그런 다음 AzVirtualHub의 출력을 사용 하 여 powershell 파이핑을 사용 하 여 가상 허브를 삭제 합니다.
