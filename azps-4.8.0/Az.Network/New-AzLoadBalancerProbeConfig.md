...
## 설명은
**AzLoadBalancerProbeConfig** Cmdlet은 Azure 부하 분산 장치에 대 한 프로브 구성을 만듭니다.
...
이 명령은 HTTP 프로토콜을 사용 하 여 MyProbe 라는 프로브 구성을 만듭니다.
새 프로브는 포트 80의 부하 분산 서비스에 연결 됩니다.

### 예제 2

부하 분산 장치에 대 한 프로브 구성을 만듭니다. 생성
...
### -포트
새 프로브가 부하 분산 서비스에 연결할 포트를 지정 합니다.
