...
### 예제 1
### 예제 2: 가상 네트워크 참조를 사용 하는 새 loadbalancer 주소 구성
```powershell
...
### PSLoadBalancerBackendAddress에 대 한.
