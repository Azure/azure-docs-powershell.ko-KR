...
## SYNOPSIS
네트워크 가상 기기 리소스에서 가상 기기 사이트를 제거 합니다.
...
## 설명은
Remove-AzVirtualApplianceSite 명령은 네트워크 가상 기기 리소스에서 가상 기기 사이트를 제거 합니다.
...
이 사이트와 연결 된 네트워크 가상 기기의 리소스 ID입니다.
