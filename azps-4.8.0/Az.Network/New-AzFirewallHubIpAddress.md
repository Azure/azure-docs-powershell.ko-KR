...
## 설명은
Ip 주소는 가상 허브의 방화벽으로 assoicated. 공용 주소와 개인 주소가 될 수 있습니다.
...
이 예제에서는 공용 Ip 수가 2 개 있는 허브 Ip 주소 개체를 만듭니다. HubIPAddress 개체는 가상 허브의 방화벽에만 해당 됩니다.
...
### PSAzureFirewallHubIpAddresses에 대 한.
