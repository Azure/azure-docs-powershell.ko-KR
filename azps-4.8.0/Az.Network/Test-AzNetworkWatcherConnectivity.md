...
## 설명
Test-AzNetworkWatcherConnectivity cmdlet은 지정된 원본 VM 및 대상에 대한 연결 정보를 반환합니다. 원본과 대상 간의 연결을 설정하지 못하면 cmdlet에서 문제의 세부 정보를 반환합니다.
...
지정된 원본 VM 및 대상에 대한 연결 정보를 반환합니다. (자동 재생)
