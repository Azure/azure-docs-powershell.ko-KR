...
## 설명은
**AzAutomationCertificate** Cmdlet은 Azure Automation에서 인증서 구성을 수정 합니다.
...
두 번째 명령은 ContosoCertificate 이라는 인증서를 수정 합니다.
...
이 cmdlet이 인증서를 수정 하는 Automation 계정의 이름을 지정 합니다.
...
### -설명
이 cmdlet이 수정 하는 인증서에 대 한 설명을 지정 합니다.
...
### -이름
이 cmdlet이 수정 하는 인증서의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 인증서를 수정할 리소스 그룹의 이름을 지정 합니다.
