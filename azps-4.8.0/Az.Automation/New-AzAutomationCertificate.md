...
### <span data-ttu-id="84ace-109">예제 1: 새 인증서 만들기</span><span class="sxs-lookup"><span data-stu-id="84ace-109">Example 1: Create a new certificate</span></span>
```
