...
## 설명은
**AzServiceBusMigration** Cmdlet이 표준 ~ premium 네임 스페이스 간의 마이그레이션을 종료 합니다.
...
Cmdlet은 마이그레이션 구성을 만드는 동안 제공 된 표준 네임 스페이스와 Premium 네임 스페이스 간의 마이그레이션을 종료 합니다.
...
### -ResourceId
Service Bus 마이그레이션 구성 표준 네임 스페이스 리소스 Id
