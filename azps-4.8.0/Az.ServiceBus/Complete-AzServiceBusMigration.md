...
## 설명은
**AzServiceBusMigration** cmdlet은 표준 네임 스페이스의 완전 한 연결 문자열로 서 premium 네임 스페이스를 가리키는 표준에서 premium 네임 스페이스로의 마이그레이션을 설정 합니다.
...
' NamespaceStandardMigration ' 네임 스페이스의 마이그레이션을 완료로 설정 합니다.
...
### -InputObject
Service Bus 마이그레이션 구성-표준 네임 스페이스 개체
...
### -ResourceId
서비스 버스 마이그레이션-표준 네임 스페이스 리소스 Id
