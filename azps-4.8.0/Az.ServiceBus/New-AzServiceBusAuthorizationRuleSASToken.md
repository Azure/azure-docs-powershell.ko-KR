...
## SYNOPSIS
네임 스페이스/큐/항목의 Azure servicebus 권한 부여 규칙에 대 한 SAS tolen를 생성 합니다. 
...
## 설명은
New-AzServiceBusAuthorizationRuleSASToken cmdlet이 Azure Eventhub Namesapce 또는 Azure Eventhub에 대 한 SAS (공유 액세스 서명) 토큰을 생성 합니다.
...
시작 및 만료 시간이 포함 된 네임 스페이스에 대해 지정 된 authorixation 규칙에 대 한 SAS 토큰을 생성 합니다.
...
만료 시간과 함께 네임 스페이스에 대해 지정 된 authorixation 규칙에 대 한 SAS 토큰을 생성 합니다.

## 변수

### -AuthorizationRuleId
기관 \ 조직 규칙의 팔 ResourceId
...
### ServiceBus를 호출 합니다. Pssharedaccess서명 특성
