...
## 설명은
**AzStackEdgeBandwidthSchedule** Cmdlet은 대역폭 일정에 대 한 정보를 가져옵니다. 리소스 그룹 이름 및 장치 이름과 함께 일정의 이름을 지정 하 여 특정 대역폭 일정에 대 한 정보를 얻을 수 있습니다.
...
### StackEdge. PSStackEdgeBandWidthSchedule에 대 한 Microsoft PowerShell
