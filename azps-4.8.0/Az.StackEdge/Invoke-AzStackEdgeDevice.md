...
## 설명은
**AzStackEdgeDevice** Cmdlet은 스택 경계 장치에서 업데이트를 검색 하 고 다운로드 하 고 설치 하는 작업을 호출 합니다. 장치에서 자동 스캔이 매일 실행 되며이 cmdlet을 실행 하 여 검사를 명시적으로 트리거할 수 있습니다.
...
### -FetchUpdate
스택 edge/gateway 장치에서 업데이트를 다운로드 합니다.
...
### -InstallUpdate
스택 가장자리/게이트웨이 장치에 업데이트를 설치 합니다.
