...
## 설명은
**AzStackEdgeStorageContainer** Cmdlet은 스택 가장자리 장치에서 저장소 컨테이너에 대 한 데이터를 새로 고치기 위한 작업을 호출 합니다. 
...
### -RefreshData
클라우드의 데이터를 사용 하 여 컨테이너 메타 데이터 새로 고침
