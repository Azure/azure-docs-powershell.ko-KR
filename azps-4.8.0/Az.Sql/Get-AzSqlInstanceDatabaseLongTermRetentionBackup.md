...
특정 데이터베이스에 대해 장기 보존 백업을 모두 가져옵니다.  리소스 그룹은 선택 사항입니다. 
...
### AzureSqlManagedDatabaseLongTermRetentionBackupModel (*). m. ManagedDatabaseBackup.
