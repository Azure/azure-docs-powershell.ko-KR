...
## 설명은
Get-AzSqlInstanceKeyVaultKey cmdlet은 SQL 관리 인스턴스의 키 자격 증명 키에 대 한 정보를 가져옵니다. 관리 되는 인스턴스의 모든 키를 보거나 KeyId을 제공 하 여 특정 키를 볼 수 있습니다.
...
이 명령은 SQL 관리 인스턴스의 모든 키 자격 증명 모음 키를 가져옵니다.
...
이 명령은 Id가 ' ' 인 키 보관소 키를 가져옵니다 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 .
