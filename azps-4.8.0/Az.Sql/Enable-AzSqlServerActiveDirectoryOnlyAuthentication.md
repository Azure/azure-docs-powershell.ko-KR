...
## 설명은
AzSqlServerActiveDirectoryOnlyAuthentication cmdlet을 **사용** 하면 현재 구독의 AzureSQL 서버에 대 한 azure AD (Active Directory) 인증 요구 사항만 사용할 수 있습니다.
...
이 명령은 ResourceGroup01 이라는 리소스 그룹과 연결 된 Server01 라는 AzureSQL server에 대해 azure AD (Active Directory)만 인증 요구 사항으로 설정 합니다.
