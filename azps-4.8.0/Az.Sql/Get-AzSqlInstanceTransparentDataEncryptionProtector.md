...
## 설명은
Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet은 지정 된 SQL 관리 인스턴스에 대 한 TDE 프로텍터를 가져옵니다.
...
이 명령은 ContosoResourceGroup 이라는 리소스 그룹의 ContosoManagedInstanceName 이라는 관리 되는 인스턴스에 대 한 TDE 프로텍터를 가져옵니다.
