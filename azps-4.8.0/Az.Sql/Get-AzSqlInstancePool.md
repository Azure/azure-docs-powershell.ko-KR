...
## 설명은
**AzSqlInstancePool** cmdlet은 하나 이상의 Azure SQL 인스턴스 풀에 대 한 정보를 반환 합니다.
해당 인스턴스 풀에 대 한 정보만 표시 하도록 인스턴스 풀의 이름을 지정 합니다.

## 예제의

### 예제 1: 고객 구독에서 모든 인스턴스 풀 가져오기
```powershell
...
이 명령은 고객 구독 내의 모든 인스턴스 풀에 대 한 정보를 가져옵니다.

### 예제 2: 리소스 그룹 전체의 모든 인스턴스 풀 가져오기
```powershell
...
이 명령은 리소스 그룹 resourcegroup01 내의 모든 인스턴스 풀에 대 한 정보를 가져옵니다.

### 예제 3: 인스턴스 풀에 대 한 정보 가져오기
```powershell
...
이 명령은 인스턴스 풀 instancePool0에 대 한 정보를 가져옵니다.

### 예제 4: 인스턴스 풀 리소스 id를 사용 하 여 인스턴스 풀에 대 한 정보 가져오기
```powershell
...
이 명령은 해당 리소스 식별자를 사용 하 여 인스턴스 풀에 대 한 정보를 가져옵니다.
