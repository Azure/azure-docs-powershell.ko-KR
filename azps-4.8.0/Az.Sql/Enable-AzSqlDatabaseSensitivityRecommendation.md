...
## 설명은
Enable-AzSqlDatabaseSensitivityRecommendation cmdlet은 데이터베이스의 열에 대 한 민감도 추천을 사용 하도록 설정 합니다.

## 예제의

### 예제 1: Azure SQL 데이터베이스에서 지정 된 열에 대해 민감도 추천을 사용 하도록 설정 합니다.
```powershell
...
### 예제 2: 파이핑을 사용 하 여 지정 된 열 Azure SQL 데이터베이스에 대해 민감도 추천을 사용 하도록 설정 합니다.
```powershell
