...
## 설명은
**AzSqlInstancePoolUsage** Cmdlet은 Azure SQL 인스턴스 풀의 사용에 대 한 정보를 반환 합니다.

## 예제의

### 예제 1: Azure SQL 인스턴스 풀의 사용 현황을 가져옵니다.
```powershell
...
Azure SQL 인스턴스 풀 instancepool0에 대 한 사용을 가져옵니다.

### 예제 2: 인스턴스 풀 개체를 사용 하 여 Azure SQL 인스턴스 풀의 사용을 가져옵니다.
```powershell
...
인스턴스 풀 개체를 사용 하 여 Azure SQL 인스턴스 풀 instancepool0에 대 한 사용을 가져옵니다.

### 예제 3: 인스턴스 풀 리소스 id를 사용 하 여 Azure SQL 인스턴스 풀의 사용을 가져옵니다.
```powershell
...
인스턴스 풀 리소스 식별자를 사용 하 여 Azure SQL 인스턴스 풀 instancepool0에 대 한 사용을 가져옵니다.

### 예제 3: 풀 내의 관리 되는 인스턴스 사용에 대 한 분석 결과를 포함 하는 Azure SQL 인스턴스 풀의 사용량을 가져옵니다.
```powershell
...
Instancepool0 내에서 관리 되는 인스턴스를 사용 하는 것과 함께 Azure SQL 인스턴스 풀 instancepool0의 사용 현황을 가져옵니다.
...
### -ExpandChildren
이 인스턴스 풀의 사용을 자식의 사용으로 확장할지 여부를 나타내는 플래그입니다.
