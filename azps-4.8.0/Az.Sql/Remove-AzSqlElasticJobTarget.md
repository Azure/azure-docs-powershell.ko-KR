...
## 설명은
대상 그룹에 대 한 대상 리소스를 제거 Remove-AzSqlElasticJobTarget cmdlet
...
대상 그룹에서 대상 (서버, 탄력적 풀, 데이터베이스 및 샤 드 맵)을 제거 합니다.

## 변수

### -AgentName
SQL 데이터베이스 에이전트 이름입니다.
