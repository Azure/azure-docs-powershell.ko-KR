...
## 설명은
**AzSqlDatabaseBackupShortTermRetentionPolicy** cmdlet은이 데이터베이스에 등록 된 단기 보존 정책을 가져옵니다.
...
### AzureSqlDatabaseBackupShortTermRetentionPolicyModel (Microsoft.).
