...
## 설명은
피어 링 서비스에서 피어 링 서비스 접두사를 제거 합니다.
...
피어 링 서비스 리소스 그룹 이름 및 이름에서 접두사 제거
...
### -PassThru
성공에 대해 true를 반환 하거나 실패에 대해 false를 반환 합니다.
