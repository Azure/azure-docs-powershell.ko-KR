...
## 설명은
**AzRecoveryServicesBackupProtectionPolicy** cmdlet은 자격 증명 모음에 대 한 Azure Backup 보호 정책을 가져옵니다.
...
보호 되는 리소스의 클래스입니다. 현재이 cmdlet에 대해 지원 되는 값은 Add-azurevm, AzureStorage, Azurestorage입니다.
...
### -WorkloadType
리소스의 작업 부하 유형입니다. 현재 지원 되는 값은 Add-azurevm, AzureFiles, MSSQL입니다.
