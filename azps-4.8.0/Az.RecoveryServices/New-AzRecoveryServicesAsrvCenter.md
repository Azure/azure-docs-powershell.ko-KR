...
## 설명은
**AzRecoveryServicesAsrvCenter** cmdlet은 보호 가능한 항목을 검색 하기 위해 vCenter server를 추가 합니다. 이 cmdlet은 구성 서버와 함께 검색을 위해 vCenter server를 등록 합니다.
...
보호 가능한 항목을 검색 하기 위해 vCenter server를 추가 합니다. 생성
...
### -I폰 Hostname
VCenter server의 IPv4 주소 또는 FQDN입니다.
