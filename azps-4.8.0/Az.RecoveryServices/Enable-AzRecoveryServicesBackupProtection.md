...
## 설명은
AzRecoveryServicesBackupProtection cmdlet을 **사용** 하면 보호 정책을 항목과 연결 하 여 백업할 수 있습니다.
...
두 번째 cmdlet은 백업할 디스크 Lun을 지정 하 $inclusionDiskLUNS 변수에 저장 합니다.
세 번째 cmdlet은 $Pol의 정책을 사용 하 여 V2VM 이라는 ARM 가상 컴퓨터에 대 한 백업 보호 정책을 설정 합니다.

### 예제 2

지정 된 백업 보호 정책이 있는 항목에 대해 백업을 사용 하도록 설정 합니다. 생성
...
### -ExclusionDisksList
백업에서 제외할 디스크 Lun 목록 및 나머지는 자동으로 포함 됩니다.
...
### -InclusionDisksList
백업에 포함할 디스크 Lun 목록은 나머지는 OS 디스크를 제외한 자동으로 제외 됩니다.
...
항목과 연결 된 디스크 제외 설정을 다시 설정 하도록 지정 합니다.
