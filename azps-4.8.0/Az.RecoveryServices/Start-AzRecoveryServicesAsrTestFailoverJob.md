...
## 설명은
**AzRecoveryServicesAsrTestFailoverJob** Cmdlet은 Azure Site Recovery 복제 보호 항목 또는 복구 계획의 장애 조치 테스트를 시작 합니다.
...
### -AzureVMNetworkId
장애 조치 후 복구 VM의 Azure vm 네트워크 id를 지정 합니다.
