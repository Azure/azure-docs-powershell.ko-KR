...
## 설명은
장치 트윈을 업데이트 하거나 바꿉니다. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twins자세한 내용은을 참조 하세요.
...
업데이트 된 속성을 사용 하 여 디바이스 모듈의 트윈 개체를 반환 합니다.
...
업데이트 된 태그 속성이 있는 디바이스 모듈 트윈 개체를 반환 합니다.
...
### -원하는
모듈 트윈에서 원하는 속성을 추가 하거나 업데이트 합니다.
...
### -부분
모듈 트윈의 태그 및 원하는 속성만 부분적 으로만 업데이트 하도록 허용 합니다.
...
### 태그
모듈 트윈에서 tags 속성을 추가 하거나 업데이트 합니다.
