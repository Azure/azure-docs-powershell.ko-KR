...
## 설명은
IoT Hub에서 다른 권한 부여 형식을 사용 하 여 디바이스를 만듭니다.
...
기본 권한 부여 (공유 개인 키)를 사용 하 여 edge 사용 IoT 장치를 만듭니다.
...
사용 안 함 상태 및 이유를 사용 하 여 루트 CA 권한 부여를 사용 하 여 IoT 장치를 만듭니다.
...
Edge 사용 IoT 장치를 만들고 여기에 자식 디바이스를 추가 합니다.
...
### -하위
하위 장치 목록 추가 (쉼표로 구분)에는 비 edge 장치만 포함 됩니다.
