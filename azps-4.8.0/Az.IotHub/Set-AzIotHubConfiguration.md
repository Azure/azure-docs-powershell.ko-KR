...
## 설명은
IoT 자동 장치 관리 구성의 지정 된 속성을 업데이트 합니다.
참고: 구성 콘텐츠는 변경할 수 없습니다. 업데이트할 수 있는 구성 속성은 ' 레이블 ', ' 메트릭 ', ' priority ' 및 ' targetCondition '입니다.
https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management자세한 내용은을 참조 하세요.
...
장치 구성의 우선 순위 변경 및 해당 대상 상태 업데이트
...
### -Force
마지막으로 검색 한 후에 업데이트 된 경우에도 구성 개체를 바꿀 수 있도록 합니다.
