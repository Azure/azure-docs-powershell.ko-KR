...
## 설명은
IotHub에 대 한 새 장치 가져오기 작업을 만듭니다.
이렇게 하면 지정 된 컨테이너에서 모든 장치를 IotHub로 가져옵니다. SAS URI를 생성 하는 방법에 대해서는 다음 문서를 참조 하세요.
...
IotHub "myiothub"에 대 한 새 가져오기 장치 요청을 만듭니다.
...
FileUpload에 대 한 입력 Blob 컨테이너 Uri
