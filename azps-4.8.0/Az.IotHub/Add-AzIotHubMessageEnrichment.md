...
## 설명은
IoT Hub 당 최대 10 개의 메시지 enrichments를 추가 합니다. 이는 선택한 끝점으로 전송 된 메시지에 응용 프로그램 속성으로 추가 됩니다.
자세히 알아보려면 다음을 참조 하세요. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
키 "newKey" 및 value "newValue" 인 새 보강를 추가 합니다. 이 새 보강 "endpoint1" 및 "endpoint2" 끝점에 적용 됩니다.
