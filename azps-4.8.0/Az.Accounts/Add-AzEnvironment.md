...
## 설명은
Add-AzEnvironment cmdlet은 azure resource manager cmdlet이 Azure Resource Manager의 새 인스턴스와 연결할 수 있도록 끝점 및 메타 데이터를 추가 합니다.
...
이 예제에서는 Uri에서 새 Azure 환경을 검색 https://configuredmetadata.net 합니다.
