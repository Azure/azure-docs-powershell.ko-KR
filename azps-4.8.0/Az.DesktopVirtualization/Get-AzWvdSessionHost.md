...
### 예제 1: 이름으로 Windows 가상 데스크톱 SessionHost 가져오기
```powershell
...
이 명령은 호스트 풀에서 Windows 가상 데스크톱 SessionHost를 가져옵니다.

### 예제 2: Windows 가상 데스크톱 SessionHosts 목록
```powershell
...
이 명령은 호스트 풀에 Windows 가상 데스크톱 SessionHosts를 나열 합니다.
...
### Api20191210Preview. ISessionHost (Microsoft. PowerShell.
