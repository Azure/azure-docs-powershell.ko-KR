...
## 설명은
**AzApiManagementLogger** Cmdlet은 Azure API Management **로 거** 를 만듭니다.
...
### -ConnectionString
다음으로 시작 하는 Azure 이벤트 허브 연결 문자열을 지정 합니다. `Endpoint=endpoint and key from Azure classic portal`
