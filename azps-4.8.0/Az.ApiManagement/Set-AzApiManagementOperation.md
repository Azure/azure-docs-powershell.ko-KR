...
## 설명은
**AzApiManagementOperation** CMDLET은 API 작업 세부 정보를 설정 합니다.
...
### -ApiRevision
API 개정판의 식별자입니다. 이 매개 변수는 선택 사항입니다. 지정 하지 않으면 현재 활성 상태인 api 개정판에서 작업이 업데이트 됩니다.
