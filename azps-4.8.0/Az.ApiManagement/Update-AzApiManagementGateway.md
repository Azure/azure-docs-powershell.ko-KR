...
## 설명은
**업데이트 AzApiManagementGateway** CMDLET은 API management 게이트웨이를 구성 합니다.
...
### -PassThru
지정 된 경우 ApiManagement의 인스턴스가 수정 된 게이트웨이를 나타내는 ServiceManagement 유형의 PsApiManagementGateway 형식입니다.
...
### -ResourceId
게이트웨이의 팔 인 ResourceId입니다. 이 매개 변수는 필수입니다.
