...
## 설명은
**AzApiManagementApi** cmdlet은 하나 이상의 Azure API 관리 api를 가져옵니다.
...
### -GatewayId
지정 된 경우 모든 게이트웨이 Api 가져오기를 시도 합니다.
