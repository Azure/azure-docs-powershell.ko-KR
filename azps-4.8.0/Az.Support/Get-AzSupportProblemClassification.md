...
### 예제 1: 서비스 id 매개 변수를 사용 하 여 서비스에 대 한 모든 문제 classificaitons를 가져옵니다.
```powershell
...
### 예제 2: 상위 서비스 개체를 사용 하 여 서비스에 대 한 모든 문제 classificaitons 가져오기
```powershell
...
### 예제 3: classificaiton 단일 문제에 대 한 세부 정보 가져오기 파이핑 서비스 개체 id
```powershell
...
### PSSupportProblemClassification를 지원 합니다.
