...
## 설명은
이 cmdlet을 사용 하 여 지원 티켓의 심각도 수준, 상태 또는 고객 연락처 정보를 업데이트 합니다. 지원 엔지니어에 게 티켓을 할당 하는 경우 지원 티켓의 심각도 수준을 업데이트 하거나 상태를 허용 하지 않는 것을 참고 하세요. 티켓을 배정한 후 심각도 수준이 나 상태를 업데이트 하려는 경우 티켓에 통신을 전송 하 여 지원 엔지니어에 게 문의 하세요.

## 예제의

### 예제 1: 지원 티켓의 심각도를 업데이트 합니다.
```powershell
...
### 예제 3: contact 개체를 지정 하 여 지원 티켓의 연락처 세부 정보를 업데이트 합니다.
```powershell
...
### 예제 4: 파이핑 지원 티켓 개체에 따라 지원 티켓의 심각도를 업데이트 합니다.
```powershell
...
### 예제 5: 개별 연락처 매개 변수를 지정 하 여 지원 티켓의 연락처 세부 정보를 업데이트 합니다.
```powershell
...
### 예제 6: 파이핑 지원 티켓 개체에 따라 지원 티켓의 상태를 업데이트 합니다.
```powershell
...
### -Customer연락처 세부 정보
SupportTicket의 연락처 세부 정보를 업데이트 합니다.
...
고객 선호 지원 언어.
여기에 나열 된 지원 언어 중 하나에 대 한 올바른 언어 contry 코드 여야 합니다 https://azure.microsoft.com/support/faq/ .
...
### -InputObject
이 cmdlet이 업데이트 하는 SupportTicket resource 개체입니다.
...
### -이름
이 cmdlet이 업데이트 하는 SupportTicket 리소스의 이름입니다.
