...
## 설명은
**AzResourceGroupDeployment** Cmdlet은 Azure 리소스 그룹 배포 템플릿과 해당 매개 변수 값이 유효한 지 여부를 결정 합니다.

## 예제의

### 예제 1: 사용자 지정 템플릿 개체 및 매개 변수 파일을 사용 하 여 배포 테스트
...
이 명령은 지정 된 템플릿 파일과 매개 변수 파일에서 만든 메모리 내 해시 테이블을 사용 하 여 지정 된 리소스 그룹의 배포를 테스트 합니다.

### 예제 2: 템플릿 파일 및 매개 변수 파일을 통한 배포 테스트
...
이 명령은 제공 된 템플릿 파일과 매개 변수 파일을 사용 하 여 지정 된 리소스 그룹 및 리소스에서 배포를 테스트 합니다.
