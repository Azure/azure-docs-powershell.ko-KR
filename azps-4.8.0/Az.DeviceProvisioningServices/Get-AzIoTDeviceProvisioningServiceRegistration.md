...
## 설명은
Azure IoT Hub Device 프로비저닝 서비스에서 enrollmentGroup 아래에 디바이스 등록 상태 또는 장치 등록 상태를 가져옵니다.
...
Azure IoT Hub 디바이스 프로비저닝 서비스에서 디바이스 등록 상태 세부 정보를 가져옵니다.
...
이 enrollmentGroup의 모든 장치에 대 한 등록 상태를 나열 합니다.
