...
AllocationWeight 및 ApplyAllocationPolicy를 사용 하 여 Azure IoT Hub 디바이스 프로비저닝 서비스에 연결 된 IoT hub
...
### -ApplyAllocationPolicy
IoT Hub에 할당 정책을 적용할지 여부를 나타내는 부울입니다.
...
### DeviceProvisioningServices. PSIotHubDefinitionDescription/. *

### DeviceProvisioningServices. PSIotHubDefinitions/. *
