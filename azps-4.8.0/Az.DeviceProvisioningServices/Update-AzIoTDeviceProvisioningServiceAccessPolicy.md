...
EnrollmentWrite 권한이 있는 Azure IoT Hub 디바이스 프로비저닝 서비스에서 액세스 정책 "mypolicy"을 업데이트 합니다.
...
파이프라인을 사용 하 여 EnrollmentWrite 권한이 있는 Azure IoT Hub 디바이스 프로비저닝 서비스에서 액세스 정책 "mypolicy"을 업데이트 합니다.
