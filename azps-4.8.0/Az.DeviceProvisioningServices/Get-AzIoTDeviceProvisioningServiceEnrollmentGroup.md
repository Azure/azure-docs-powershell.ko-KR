...
## 설명은
Azure IoT Hub Device 프로비저닝 서비스에서 등록 그룹의 세부 정보를 가져오거나 모든 등록 그룹을 나열 합니다.
...
Azure IoT Hub 디바이스 프로비저닝 서비스에서 장치 등록 그룹을 가져옵니다.
...
Azure IoT Hub 디바이스 프로비저닝 서비스의 모든 장치 등록 그룹을 나열 합니다.
...
### DeviceProvisioningServices를 PSEnrollmentGroups []으로 합니다.
