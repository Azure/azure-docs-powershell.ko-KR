...
### 예제 1: 이름별로 MySql 서버 가상 네트워크 규칙 제거
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

이 cmdlet은 이름으로 MySql 서버 가상 네트워크 규칙을 제거 합니다.

### 예제 2: id 별 MySql 서버 가상 네트워크 규칙 제거
```powershell
...
이러한 cmdlet은 id를 기준으로 MySql 서버 가상 네트워크 규칙을 제거 합니다.
