...
## 설명은
**Get-AzOperationalInsightsDataSource** cmdlet은 데이터 원본을 가져옵니다.
가져올 데이터 원본을 지정할 수 있습니다.
데이터 원본의 종류를 기준으로 결과를 필터링 할 수 있습니다.
...
### -ResourceGroupName
가져올 데이터 원본이 포함 된 리소스 그룹의 이름을 지정 합니다.
