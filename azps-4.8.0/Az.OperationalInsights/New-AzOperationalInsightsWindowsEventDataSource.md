...
## 설명은
**AzOperationalInsightsWindowsEventDataSource** Cmdlet은 Azure Operational Insights에서 windows 운영 체제를 실행 하는 연결 된 컴퓨터에서 windows 이벤트 로그를 수집 하는 데이터 원본을 추가 합니다.

## 예제의

### 예제 1: 시스템 창 이벤트 데이터 원본 만들기
```
$EventLogNames       = @()
...
### -CollectWarnings
Operational Insights가 경고 메시지를 수집 함을 나타냅니다.
