...
## 설명은
"-DataSourceType"이 지정 되지 않은 경우 연결 된 저장소 계정 가져오기, 연결 된 모든 저장소 계정 나열
...
작업 영역에 대 한 연결 된 저장소 accoounts 나열 {workspace-name}

## 변수

### -DataSourceType
데이터 원본 유형은 ' CustomLogs ', ' AzureWatson ' 중 하나 여야 합니다.
...
### OperationalInsights. PSLinkedStorageAccountsResource/.
