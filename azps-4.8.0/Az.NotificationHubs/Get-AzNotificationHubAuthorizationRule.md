...
## 설명은
**AzNotificationHubAuthorizationRule** cmdlet은 알림 허브에 연결 된 SAS (공유 액세스 서명) 권한 부여 규칙에 대 한 정보를 가져옵니다.
...
**AzNotificationHubAuthorizationRule** cmdlet은 알림 허브에 연결 된 권한 부여 규칙에 대 한 정보만 가져옵니다.
허브 자체에 대 한 정보를 얻으려면 Get-help를 AzNotificationHub를 사용 합니다.
