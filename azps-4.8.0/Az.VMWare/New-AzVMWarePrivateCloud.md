...
### -NetworkBlock
주소 블록은 구독 및 온-프레미스의 VNet에서 고유 해야 합니다.
A, B, C, D가 0과 255 사이에 있고 X가 0에서 22 사이인 CIDR 형식이 (A. b. .C/X)에 적용 되는지 확인 합니다.
...
### -NsxtPassword
필요에 따라 사설 클라우드가 생성 될 때 NSX Manager 암호를 설정 합니다.
...
### -Vc비밀 번호
선택적으로 사설 클라우드가 생성 될 때 vCenter 관리자 암호를 설정 합니다.
