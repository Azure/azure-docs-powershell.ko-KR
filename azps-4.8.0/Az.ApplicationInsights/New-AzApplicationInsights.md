...
"Java" 종류의 리소스 그룹 "testgroup"에서 "test" 라는 새 application insights 리소스를 추가 합니다.
...
Application Insights 수집에 액세스 하는 데 사용 되는 네트워크 액세스 형식입니다. 값은 ' Enabled ' 또는 ' Disabled ' 여야 합니다.
...
Application Insights 쿼리에 액세스 하는 데 사용할 네트워크 액세스 형식입니다. 값은 ' Enabled ' 또는 ' Disabled ' 여야 합니다.
