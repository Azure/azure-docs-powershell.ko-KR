...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대해 "myeventhubdc" 이라는 기존 EventHub 데이터 연결을 업데이트 합니다.
...
위의 명령은 "testnewkustocluster" 클러스터의 "mykustodatabase" 데이터베이스에 대 한 "myeventgriddc" 이라는 기존 EventGrid 데이터 연결을 업데이트 합니다.
...
위 명령은 "mykustodatabase" 데이터베이스의 "myiothubdc" ("IotHub")를 "testnewkustocluster" 클러스터에 있는 "*" (으)로 업데이트 합니다.
