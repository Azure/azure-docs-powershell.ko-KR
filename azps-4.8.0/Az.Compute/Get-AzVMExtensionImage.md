...
### 예제 2: 버전 필터링을 사용 하 여 확장 이미지 버전 가져오기
```
...
이 명령은 지정 된 위치, 게시자, 형식 및 12로 시작 하는 버전에 대 한 확장 이미지의 모든 버전을 가져옵니다.

### 예제 3: 버전 필터링을 사용 하 여 확장 이미지 버전 가져오기
```
...
이 명령은 지정 된 위치, 게시자, 형식 및 버전에 대 한 확장 이미지의 모든 버전을 가져옵니다.
