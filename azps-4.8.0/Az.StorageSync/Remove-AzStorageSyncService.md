...
## 설명은
이 명령은 지정 된 저장소 동기화 서비스를 삭제 합니다. 저장소 동기화 서비스는 포함 된 모든 동기화 그룹 및 등록 된 서버가 먼저 삭제 된 경우에만 제거할 수 있습니다.
...
### -InputObject
일반적으로 파이프라인을 통해 전달 되는 Storages Cservice 입력 개체입니다.
