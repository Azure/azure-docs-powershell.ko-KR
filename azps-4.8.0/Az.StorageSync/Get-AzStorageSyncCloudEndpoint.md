...
## 설명은
이 명령은 지정 된 동기화 그룹 내의 모든 클라우드 끝점을 나열 합니다. 또한 각 클라우드 끝점의 특성을 나열 하는 데 사용 될 수 있습니다.
...
이 명령은 지정 된 동기화 그룹 내에 포함 된 모든 클라우드 끝점을 가져옵니다. -CloudEndpointName를 지정 하 여 특정 항목을 반환 합니다.
