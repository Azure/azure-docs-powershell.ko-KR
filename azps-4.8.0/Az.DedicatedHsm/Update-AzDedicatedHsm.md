...
### 예제 1: 이름으로 전용 HSM의 매개 변수 태그 업데이트
```powershell
...
이 명령은 이름으로 전용 HSM의 parameter 태그를 업데이트 합니다.

### 예제 2: 전용 HSM의 매개 변수 태그를 개체 별로 업데이트
```powershell
...
이 명령은 전용 HSM의 parameter 태그를 개체 별로 업데이트 합니다.
