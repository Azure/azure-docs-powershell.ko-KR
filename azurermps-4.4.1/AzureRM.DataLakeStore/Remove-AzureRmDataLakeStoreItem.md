...
## 설명은
**AzureRmDataLakeStoreItem** Cmdlet은 Data Lake store에서 파일 또는 폴더를 삭제 합니다.
...
### -Clean
이 작업을 수행 하면 대상 폴더의 모든 내용이 제거 되 고 폴더가 유지 됨을 나타냅니다.
이 매개 변수를 *재귀적* 매개 변수와 함께 사용 합니다.
...
*Clean* 매개 변수를 지정 하지 않는 한 대상 폴더도 삭제 됩니다.
...
### 부울
PassThru가 지정 된 경우 연산의 결과를 반환 합니다.
