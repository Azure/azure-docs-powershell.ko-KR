...
이 명령은 Data Lake Store에서 TestSource.csv 파일을 C:\Test.csv으로 다운로드 합니다.
...
### -ConcurrentFileCount
폴더 다운로드에 대해 병렬로 다운로드할 최대 파일 수를 지정 합니다.
기본 값은 5입니다 (5).
...
### -Resume
복사 중인 파일이 이전 다운로드를 계속 됨을 나타냅니다.
다운로드는 완전히 다운로드 되지 않은 마지막 파일에서 다시 시작 하려고 시도 합니다.
