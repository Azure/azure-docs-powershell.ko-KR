...
## 설명은
**Set-AzureRmNotificationHubsNamespace** cmdlet은 기존 알림 허브 네임 스페이스의 속성 값을 설정 합니다.
...
Azure 위치를 최신 목록으로 가져오려면 다음 명령을 실행 합니다.
...
-태그 @ {Name = "CalendarYear"; Value = "2016"}

같은 명령에 여러 태그를 추가 하려면 각 태그를 쉼표로 구분 합니다.
