...
## 설명은
**AzureRmOperationalInsightsWindowsPerformanceCounterDataSource** Cmdlet은 windows 운영 체제를 실행 하는 연결 된 컴퓨터에 대 한 windows 성능 카운터 데이터 원본을 추가 합니다.
