...
## 설명은
**Get-AzureBatchJob** Cmdlet은 *batchaccountcontext* 매개 변수에 지정 된 일괄 처리 계정에 대 한 Azure 일괄 작업을 가져옵니다.
...
이 명령은 Get-AzureBatchJobSchedule cmdlet을 사용 하 여 ID JobSchedule27 인 작업 일정을 가져옵니다.
