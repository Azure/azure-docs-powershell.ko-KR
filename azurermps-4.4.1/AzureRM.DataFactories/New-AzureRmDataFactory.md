...
## 설명은
**AzureRmDataFactory** cmdlet은 지정 된 리소스 그룹 이름 및 위치를 사용 하 여 데이터 팩터리를 만듭니다.
...
### -Force
이 cmdlet이 확인 메시지 없이 기존 data factory를 대체 함을 나타냅니다.
...
### -위치
Data factory의 위치 (예: WestUS 또는 Ea Us)를 지정 합니다.
현재 WestUS만 지원 됩니다.
