...
## 설명은
지정 된 통합 런타임을 사용 하 여 연결 된 서비스의 자격 증명을 암호화 하 New-AzureRmDataFactoryV2LinkedServiceEncryptCredential cmdlet을 실행 합니다.

## 예제의

### 예제 1: 연결 된 서비스에서 creadentials 암호화
```
...
이 명령은 myIR 이라는 통합 런타임을 사용 하 여 파일 D:\sql.js에서 자격 증명을 암호화 합니다.
