...
이 명령은 5 개 이상의 병렬 처리를 사용 하 여 작업을 제출할 수 없도록 하는 id "83cb7ad2-3523-4b82-b909-d478b0d8aea3"의 사용자에 대해 "contosoadla" 계정에 "myPolicy" 라는 정책을 만듭니다.
...
이 명령은 5 개 이상의 병렬 처리를 사용 하거나 우선 순위가 100 보다 낮은 작업을 제출할 수 없도록 하는 id "83cb7ad2-3523-4b82-b909-d478b0d8aea3"의 사용자에 대해 "contosoadla" 계정에 "myPolicy" 라는 정책을 만듭니다.
...
이 정책에 대해 지원 되는 작업당 병렬 처리의 최대 수준입니다.
...
This, MaxDegreeOfParallelismPerJob 또는 both 매개 변수 중 하나를 지정 해야 합니다.
