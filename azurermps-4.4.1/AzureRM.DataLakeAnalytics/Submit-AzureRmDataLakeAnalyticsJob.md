...
### 스크립트 경로를 사용 하 여 U-SQL에 대 한 자세한 정보를 포함 한 작업 제출
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### U-SQL에 대 한 스크립트 경로를 사용 하 여 작업 제출 및 파이프라인 정보
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### 되풀이 및 파이프라인 정보가 포함 된 U-SQL 작업 제출
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-Script] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
 [[-Priority] <Int32>] -RecurrenceId <Guid> [-RecurrenceName <String>] -PipelineId <Guid>
...
### -CompileOnly
이 cmdlet이 작업을 실행 하지 않고 컴파일 한다는 것을 나타냅니다.
...
### -DegreeOfParallelism
작업의 허용 가능한 최대 병렬 처리를 나타내는 작업의 데이터 호수 분석 단위 (DLAU)를 지정 합니다.
...
### -우선 순위
작업의 우선 순위를 지정 합니다.
지정 하지 않은 경우 우선 순위는 1000입니다.
숫자가 작으면 높은 작업 우선 순위를 나타냅니다.
