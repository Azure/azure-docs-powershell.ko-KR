...
## 설명은
Remove-AzureRmVMSecret cmdlet은 가상 컴퓨터 개체에서 (a) 비밀을 제거 합니다.
...
리소스 그룹 "rg1"의 가상 머신 "vm1"에서 모든 비밀을 제거 하 고 VM을 업데이트 합니다.
...
### -SourceVaultId
이 cmdlet이 제거 하는 원본 보관소 Id의 배열을 지정 합니다.
...
### -VM
이 cmdlet가 암호 (a)를 제거 하는 가상 컴퓨터를 지정 합니다.
