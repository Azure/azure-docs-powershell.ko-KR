...
## 설명은
**업데이트 AzureRmDisk** cmdlet은 디스크를 업데이트 합니다.
...
또한이 명령은 리소스 그룹 ' ResourceGroup01 '에서 10gb 디스크 크기로 이름이 ' Disk01 ' 인 기존 디스크를 업데이트 합니다.
...
### System. 문자열
Microsoft. Update.exe 업데이트. m a. 관리. m a. * 디스크
