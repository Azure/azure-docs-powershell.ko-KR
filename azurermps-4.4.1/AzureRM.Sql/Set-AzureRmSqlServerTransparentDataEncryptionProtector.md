...
## 설명은
Set-AzureRmSqlServerTransparentDataEncryptionProtector cmdlet은 SQL server에 대 한 TDE 보호 기능을 설정 합니다.
TDE 프로텍터 유형을 변경 하면 보호기가 회전 합니다.

## 예제의

### --------------------------예제 1:--------------------------에 대 한 TDE (투명 데이터 암호화) 보호 기능을 ServiceManaged로 설정 합니다.
```
...
### --------------------------예제 2: 투명 한 데이터 암호화 보호기 유형을 Azure 키 자격 증명 모음으로 설정--------------------------
```
