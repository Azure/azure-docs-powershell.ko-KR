...
## 설명은
**AzureRmSqlDatabaseActivity** Cmdlet은 Azure SQL database의 탄력적 데이터베이스 풀로 이동 하거나 외부로 이동한 탄력적 데이터베이스의 상태를 가져옵니다.
...
### -ServerName
탄력적 데이터베이스 풀을 호스팅하는 Microsoft SQL Server의 이름을 지정 합니다.
