...
## 설명은
**AzureRmSqlDatabaseAuditingPolicy** Cmdlet은 Azure SQL 데이터베이스의 감사 정책을 가져옵니다.
Cmdlet을 사용 하려면 *ResourceGroupName* , *ServerName* 및 *DatabaseName* 매개 변수를 사용 하 여 데이터베이스를 식별 합니다.

## 예제의

### 예제 1: 테이블 감사가 정의 된 Azure SQL 데이터베이스의 감사 정책 가져오기
```
...
### 예제 2: Blob 감사가 정의 된 Azure SQL 데이터베이스의 감사 정책 가져오기
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
