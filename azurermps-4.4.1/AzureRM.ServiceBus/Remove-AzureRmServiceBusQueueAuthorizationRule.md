...
## 설명은
**AzureRmServiceBusQueueAuthorizationRule** cmdlet은 지정 된 Service Bus 네임 스페이스에서 큐의 권한 부여 규칙을 제거 합니다.
...
`SBAuthoRule1`네임 스페이스에서 큐의 권한 부여 규칙을 제거 합니다 `SB-Queue_exampl1` `SB-Example1` .
