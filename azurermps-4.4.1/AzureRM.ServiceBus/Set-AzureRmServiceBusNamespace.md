...
## 설명은
**AzureRmServiceBusNamespace** cmdlet은 리소스 그룹 내의 지정 된 Service Bus 네임 스페이스에 대 한 설명을 업데이트 합니다.
...
새 설명으로 Service Bus 네임 스페이스를 업데이트 합니다.
...
### -확인
지정 된 정보로 Service Bus 네임 스페이스를 업데이트 합니다.
...
### ServiceBus. NamespaceAttributes/.
