...
## 설명은
**AzureRmServiceBusAuthorizationRule** cmdlet은 지정 된 네임 스페이스 또는 큐 또는 항목에서 지정한 권한 부여 규칙에 대 한 설명을 가져옵니다.
...
### System.webserver. List ' 1 [[ServiceBus]. ServiceBus, Version = 0.4.2.0, Culture = 중립, PublicKeyToken = null]). 목록 ' ' [[Microsoft Azure.]
