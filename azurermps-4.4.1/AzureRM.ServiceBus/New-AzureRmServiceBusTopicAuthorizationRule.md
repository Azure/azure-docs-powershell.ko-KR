...
## 설명은
**AzureRmServiceBusTopicAuthorizationRule** cmdlet은 지정 된 Service Bus 항목에 대 한 새 권한 부여 규칙을 만듭니다.
...
`SBTopicAuthoRule1`항목에 대 한 **듣기** 및 **보내기** 권한이 있는 권한 부여 규칙을 만듭니다 `SB-Topic_exampl1` .
