...
## 설명은
**AzureRmServiceBusQueueAuthorizationRule** cmdlet은 지정 된 Service Bus 큐에 대해 지정한 권한 부여 규칙에 대 한 설명을 가져옵니다.
...
지정 된 Service Bus 큐에 대 한 지정 된 권한 부여 규칙 설명을 반환 합니다.
...
### -이름
EventHub AuthorizationRule 이름입니다.
