...
## 설명은
**AzureRmServiceBusTopicAuthorizationRule** cmdlet은 지정 된 Service Bus 항목에 대해 지정한 권한 부여 규칙에 대 한 설명을 가져옵니다.
...
주어진 주제에 대해 지정 된 권한 부여 규칙에 대 한 설명을 반환 합니다.
