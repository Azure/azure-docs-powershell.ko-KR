...
## 설명은
**AzureRmServiceBusQueueKey** cmdlet은 지정 된 Service Bus 큐에 대 한 기본 및 보조 연결 문자열을 반환 합니다. 
...
지정 된 Service Bus 큐에 대 한 기본 및 보조 연결 문자열을 반환 합니다.
...
### -이름
ServiceBus 대기열 AuthorizationRule 이름입니다.
