...
### 업데이트 의미 체계의 Add-AzureRmAutoscaleSetting cmdlet에 대 한 매개 변수
```
...
### 만들기 의미 체계의 Add-AzureRmAutoscaleSetting cmdlet에 대 한 매개 변수
```
...
### -SettingSpec
**AutoscaleSetting** 개체를 지정 합니다.
Get-AzureRmAutoscaleSetting cmdlet을 사용 하 여 **AutoscaleSetting** 개체를 가져오거나 Windows PowerShell 스크립트에서 생성할 수 있습니다.
