...
### 예약 된 시간 없이 New-AzureRmAutoscaleProfile cmdlet에 대 한 매개 변수
```
...
### 해결 방법 수정 날짜 일정을 사용 하는 New-AzureRmAutoscaleProfile cmdlet의 매개 변수
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
### 되풀이 일정을 사용 하는 New-AzureRmAutoscaleProfile cmdlet에 대 한 매개 변수
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
