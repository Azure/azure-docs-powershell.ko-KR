...
## 설명은
**Set-AzureRmIntegrationAccountMap** cmdlet은 통합 계정 맵을 수정 합니다.
이 cmdlet은 통합 계정 맵을 나타내는 개체를 반환 합니다.
통합 계정 이름, 리소스 그룹 이름 및 지도 이름을 지정 합니다.
...
이 명령은 지정 된 리소스 그룹의 통합 계정 맵을 수정 합니다.
...
### -MapFilePath
통합 계정 맵에 대 한 정의의 파일 경로를 지정 합니다.
