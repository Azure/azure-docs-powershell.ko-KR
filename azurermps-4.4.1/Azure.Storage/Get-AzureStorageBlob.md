...
## 설명은
**Get-AzureStorageBlob** Cmdlet은 Azure 저장소 계정의 지정 된 컨테이너에 있는 blob을 나열 합니다.
...
다섯 번째 명령은 **get-AzureStorageBlob** cmdlet을 사용 하 여 blob을 가져오는 **Do While** 문을 지정 합니다.
