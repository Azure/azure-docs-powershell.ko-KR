...
## 설명은
**AzureRmApiManagement** Cmdlet은 azurestorage blob에 상주 하는 지정 된 백업에서 API Management 서비스를 복원 합니다.
...
이 명령은 Azure storage blob에서 API Management 서비스를 복원 합니다.

## 변수

### -이름
백업과 함께 복원 될 API Management 인스턴스의 이름을 지정 합니다.
...
### -SourceBlobName
Azure 저장소 백업 원본 blob의 이름을 지정 합니다.
...
### -SourceContainerName
Azure 저장소 백업 원본 컨테이너의 이름을 지정 합니다.
