...
## 설명은
**AzureRmApiManagementContext** Cmdlet은 **PsAzureApiManagementContext** 의 인스턴스를 만듭니다.
컨텍스트는 모든 API Management 서비스 cmdlet에 사용 됩니다.
...
이 명령은 **PsApiManagementContext** 의 인스턴스를 만듭니다.

## 변수

### -ResourceGroupName
API Management 서비스를 배포 하는 리소스 그룹의 이름을 지정 합니다.
...
### -ServiceName
배포 된 API Management 서비스의 이름을 지정 합니다.
...
### ApiManagement. ServiceManagement. \ PsAzureApiManagementContext
