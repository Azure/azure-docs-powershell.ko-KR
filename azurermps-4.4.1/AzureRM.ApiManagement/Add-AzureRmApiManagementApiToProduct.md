...
## 설명은
**Add-AzureRmApiManagementApiToProduct** cmdlet은 제품에 Azure API Management api를 추가 합니다.
...
이 명령은 지정 된 제품에 지정한 API를 추가 합니다.

## 변수

### -ApiId
제품에 추가할 API의 ID를 지정 합니다.
