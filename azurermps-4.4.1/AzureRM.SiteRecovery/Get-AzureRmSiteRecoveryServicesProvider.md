...
## 설명은
**AzureRmSiteRecoveryServicesProvider** cmdlet은 자격 증명 모음의 Azure Site Recovery 공급자에 대 한 정보를 가져옵니다.
...
### -패브릭
Azure Site Recovery Fabric 개체를 지정 합니다.
...
### -FriendlyName
이 cmdlet이 가져오는 Azure Site Recovery 공급자의 이름을 지정 합니다.
...
### System.webserver. t e r ' 1 [[SiteRecovery Rrecovery서비스 공급자, Microsoft Azure. SiteRecovery, Version = 2.0.1.0, Culture = 중립, PublicKeyToken = null]]
