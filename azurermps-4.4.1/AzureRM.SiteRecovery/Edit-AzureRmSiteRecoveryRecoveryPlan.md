...
## 설명은
**편집-AzureRmSiteRecoveryRecoveryPlan** Cmdlet은 Azure Site Recovery 계획을 편집 합니다.
...
### -AppendGroup
이 작업이 복구 계획 개체에 그룹을 추가 함을 나타냅니다.
