...
## 설명은
**AzureRmSiteRecoveryProtectionEntity** Cmdlet은 Azure Site Recovery 보호 엔터티의 보호를 사용 하거나 사용 하지 않도록 설정 합니다.
...
### -WaitForCompletion
명령이 반환 하기 전에 완료 될 때까지 대기 함을 나타냅니다.
