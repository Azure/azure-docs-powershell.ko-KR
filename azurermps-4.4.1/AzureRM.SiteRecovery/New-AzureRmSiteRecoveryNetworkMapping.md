...
## 설명은
**AzureRMSiteRecoveryNetworkMapping** cmdlet은 두 가상 네트워크 간의 매핑을 만들고 Azure Site Recovery 작업을 추적 하기 위해 반환 합니다.
...
### ASRNetwork
' PrimaryNetwork ' 매개 변수는 파이프라인에서 ' ASRNetwork ' 형식의 값을 허용 합니다.
