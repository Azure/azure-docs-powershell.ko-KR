...
## 설명은
**AzureRmSiteRecoveryProtectionContainerMapping** Cmdlet은 Azure Site Recovery 보호 컨테이너 매핑을 제거 합니다.
...
Azure Site Recovery 보호 컨테이너 매핑 개체를 지정 합니다.
...
' ProtectionContainerMapping ' 매개 변수는 파이프라인에서 ' ASRProtectionContainerMapping ' 형식의 값을 허용 합니다.
