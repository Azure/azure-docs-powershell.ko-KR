...
## 설명은
**AzureRmSiteRecoveryProtectionContainerMapping** cmdlet은 정책을 보호 컨테이너에 연결 하 여 Azure Site Recovery 보호 컨테이너 매핑을 만듭니다.
...
### -정책
Azure Site Recovery 정책 개체를 지정 합니다.
