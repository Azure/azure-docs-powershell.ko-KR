...
## 설명은
**AzureRmStreamAnalyticsTransformation** Cmdlet은 Stream Analytics 작업에 정의 된 변환에 대 한 정보를 가져옵니다.

## 예제의

### 예제 1: Stream Analytics 변환에 대 한 정보 가져오기
```
...
이 명령은 StreamingJob 이라는 작업의 StreamingJob 이라는 변형에 대 한 정보를 반환 합니다.

## 변수

### -JobName
Azure Stream Analytics 변환이 속한 Azure Stream Analytics 작업의 이름을 지정 합니다.
...
### -이름
검색할 Azure Stream Analytics 변환의 이름을 지정 합니다.
...
### -ResourceGroupName
Azure Stream Analytics 변환이 속한 리소스 그룹의 이름을 지정 합니다.
...
### System.webserver. List ' 1 [[Microsoft Azure. PSTransformation, Microsoft azure. PSTransformation 분석]] Microsoft Azure. e. e t e. e 1.
