...
### 그룹 개체 id를 사용 하 여 그룹 구성원을--------------------------필터링--------------------------
```
PS C:\> Get-AzureRmADGroupMember -GroupObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE
```

85F89C90-780E-4AA6-9F4F-6F268D322EEE id를 사용 하 여 그룹 구성원을 가져옵니다.
...
### ActiveDirectory에서 ' 1 [Microsoft.Azure.Graph.RBAC.Version1_6 목록 '을 표시 합니다.
