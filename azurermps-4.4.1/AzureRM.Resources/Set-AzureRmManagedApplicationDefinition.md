...
### 관리 되는 응용 프로그램 정의 이름 매개 변수 집합 기본값
```
...
## 설명은
**AzureRmManagedApplicationDefinition** cmdlet은 관리 되는 응용 프로그램 정의를 업데이트 합니다.
...
이 명령은 관리 되는 응용 프로그램 정의 설명을 업데이트 합니다.
...
### -권한 부여
관리 되는 응용 프로그램 정의 권한 부여입니다.
다음과 같은 형식으로 쉼표로 구분 된 인증 쌍 \<principalId\>\<roleDefinitionId\>
...
### -PackageFileUri
관리 되는 응용 프로그램 정의 패키지 파일 uri입니다.
...
### -Id
구독을 포함 하는 정규화 된 관리 되는 응용 프로그램 정의 Id입니다. 예:/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}
...
### System. 문자열
System. String [] System.webserver
