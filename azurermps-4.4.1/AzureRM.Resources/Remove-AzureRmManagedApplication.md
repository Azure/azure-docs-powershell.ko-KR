...
## 설명은
**AzureRmManagedApplication** cmdlet은 관리 되는 응용 프로그램 제거

## 예제의

### 예제 1: 리소스 ID로 관리 되는 응용 프로그램 제거
```
...
첫 번째 명령은 Get-AzureRmManagedApplication cmdlet을 사용 하 여 myApp 라는 관리 되는 응용 프로그램을 가져옵니다.
명령이 $Application 변수에 저장 합니다.

두 번째 명령은 $Application의 **ResourceId** 속성으로 식별 되는 관리 되는 응용 프로그램을 제거 합니다.
