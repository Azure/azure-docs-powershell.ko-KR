...
## 설명은
**AzureKeyVaultCertificateContact** Cmdlet은 Azure key vault의 인증서 알림 용 키 보관소에 대 한 연락처를 추가 합니다.
...
이 명령은 Patti을 ContosoKV01 키 보관소에 대 한 인증서 연락처로 추가 하 고 "ContosoKV01" 볼트에 대 한 연락처 목록을 반환 합니다.
