...
이 명령은 OAuth 인증을 사용 하 여 컨텍스트를 만듭니다.
...
### -UseConnectedAccount
이 cmdlet이 OAuth 인증을 사용 하 여 Azure Storage 컨텍스트를 생성 함을 나타냅니다.
다른 anthentication가 지정 되지 않은 경우 cmdlet은 기본적으로 OAuth 인증을 사용 합니다.
