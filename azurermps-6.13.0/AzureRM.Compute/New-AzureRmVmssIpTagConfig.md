...
## 설명은
**AzureRmVmssIpTagConfig** CMDLET은 Vmss (가상 컴퓨터 크기 조정 집합)의 네트워크 인터페이스에 대 한 IP 태그 구성 개체를 만듭니다.
이 cmdlet의 구성을 New-AzureRmVmssIpConfig cmdlet의 *Iptag* 매개 변수로 지정 합니다.
