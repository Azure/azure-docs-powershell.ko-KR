...
이 명령은 **AzureRmApiManagementDeployment** cmdlet에 사용 됩니다.
...
이 예제에서는 가상 네트워크를 만든 다음 **AzureRmApiManagementDeployment** cmdlet을 호출 합니다.
...
### -위치
Api Management 서비스에 대해 지원 되는 지역에서의 위치를 지정 합니다.
