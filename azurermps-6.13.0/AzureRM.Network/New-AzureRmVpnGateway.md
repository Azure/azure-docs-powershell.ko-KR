...
New-AzureRmVpnGateway는 확장 가능한 VPN 게이트웨이를 만듭니다. 이는 VirtualHub 내 사이트 간 연결에 대 한 소프트웨어 정의 연결입니다. 

이 게이트웨이에는이 게이트웨이의 크기를 조정 하 고이를 Set-AzureRmVpnGateway cmdlet에 지정 된 배율 단위를 기준으로 확장 합니다. 
