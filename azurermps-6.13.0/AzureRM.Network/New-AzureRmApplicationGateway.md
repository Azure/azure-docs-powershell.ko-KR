...
## 설명은
**AzureRmApplicationGateway** Cmdlet은 Azure application gateway를 만듭니다.
...
다섯 번째 명령은 New-AzureRmPublicIpAddress를 사용 하 여 공용 IP 주소를 만듭니다.
...
WAF (웹 응용 프로그램 방화벽) 구성을 지정 합니다. Get-AzureRmApplicationGatewayWebApplicationFirewallConfiguration cmdlet을 사용 하 여 WAF를 얻을 수 있습니다.
...
### System.webserver. List ' 1 [[Microsoft Azure. 모델]. Psapplication의 Ipconfiguration, Microsoft Azure. 명령인. 네트워크, 버전 = 6.4.1.0, Culture = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewaySslCertificate, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[Microsoft Azure. 모델]. Psapplication의 Authenticationcertificate, Microsoft Azure. Network, Version = 6.4.1.0, Culture = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayFrontendIPConfiguration, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayFrontendPort, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[Microsoft Azure. e. 모델]. Psapplication네트워크 검색, Microsoft Azure. 6.4.1.0, Version =, Culture = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayBackendAddressPool, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayBackendHttpSettings, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayHttpListener, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayUrlPathMap, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[PSApplicationGatewayRequestRoutingRule, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]

### System.webserver. List ' 1 [[Microsoft Azure. 모델]. Psapplication게이트웨이 Redirectconfiguration, Microsoft Azure. 명령인. 네트워크, 버전 = 6.4.1.0, Culture = 중립, PublicKeyToken = null]
