...
## 설명은
**AzureRmExpressRouteCircuitPeeringConfig** cmdlet은 대상 경로 회로에 피어 링 구성을 추가 합니다. Express 경로 회로는 공용 인터넷 대신 연결 공급자를 사용 하 여 온-프레미스 네트워크를 Microsoft 클라우드에 연결 합니다. **Add-AzureRmExpressRouteCircuitPeeringConfig** 을 실행 한 후에는 Set-AzureRmExpressRouteCircuit cmdlet을 호출 하 여 구성을 활성화 해야 한다는 점에 주의 하세요.
...
### -ExpressRouteCircuit
수정 되는 Express 경로 회로입니다. **AzureRmExpressRouteCircuit** cmdlet에서 반환 된 Azure 개체입니다.
