...
## 설명은
**새 AzureRmNetworkInterface** Cmdlet은 Azure 네트워크 인터페이스를 만듭니다.
...
### System.webserver. List ' 1 [[PSNetworkInterfaceIPConfiguration, Microsoft azure. 6.4.1.0,. *. *. *. e l e = 중립, PublicKeyToken = null]]
