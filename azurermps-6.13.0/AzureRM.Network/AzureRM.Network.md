...
### [추가-AzureRmApplicationGatewayBackendHttpSettings](Add-AzureRmApplicationGatewayBackendHttpSettings.md)
...
### [추가-AzureRmApplicationGatewayProbeConfig](Add-AzureRmApplicationGatewayProbeConfig.md)
응용 프로그램 게이트웨이에 상태 프로브를 추가 합니다.

### [추가-AzureRmApplicationGatewayRedirectConfiguration](Add-AzureRmApplicationGatewayRedirectConfiguration.md)
...
### [추가-AzureRmApplicationGatewayTrustedRootCertificate](Add-AzureRmApplicationGatewayTrustedRootCertificate.md)
...
### [추가-AzureRmLoadBalancerInboundNatPoolConfig](Add-AzureRmLoadBalancerInboundNatPoolConfig.md)
...
### [추가-AzureRmLoadBalancerOutboundRuleConfig](Add-AzureRmLoadBalancerOutboundRuleConfig.md)
...
### [추가-AzureRmNetworkInterfaceTapConfig](Add-AzureRmNetworkInterfaceTapConfig.md)
{{Synopsis 채우기}}
...
### [추가-AzureRmServiceEndpointPolicyDefinition](Add-AzureRmServiceEndpointPolicyDefinition.md)
{{Synopsis 채우기}}

### [추가-AzureRmVirtualNetworkGatewayIpConfig](Add-AzureRmVirtualNetworkGatewayIpConfig.md)
...
응용 프로그램 게이트웨이에 대 한 자동 크기 조정 구성을 가져옵니다.
...
응용 프로그램 게이트웨이의 신뢰할 수 있는 루트 인증서를 가져옵니다.
...
ExpressRoutePort의 링크 구성을 가져옵니다.

### [Get-AzureRmExpressRoutePortsLocation](Get-AzureRmExpressRoutePortsLocation.md)
사용할 수 있는 ExpressRoutePorts 위치 목록을 가져옵니다. 지정 된 위치에 대 한 위치의 특성을 가져옵니다.
...
사용자가 New-AzureRmVpnClientConfiguration를 사용 하 여 생성 된 Vpn 프로필 패키지를 쉽게 다운로드할 수 있습니다.
...
### [새로운 AzureRmApplicationGatewayAutoscaleConfiguration](New-AzureRmApplicationGatewayAutoscaleConfiguration.md)
응용 프로그램 게이트웨이에 대 한 자동 크기 조정 구성을 만듭니다.
...
### [새로운 AzureRmApplicationGatewayConnectionDraining](New-AzureRmApplicationGatewayConnectionDraining.md)
백 엔드 HTTP 설정에 대 한 새 연결 드레이닝 구성을 만듭니다.

### [새로운 AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig](New-AzureRmApplicationGatewayFirewallDisabledRuleGroupConfig.md)
사용할 수 없도록 설정 된 새 규칙 그룹 구성을 만듭니다.

### [새로운 AzureRmApplicationGatewayFirewallExclusionConfig](New-AzureRmApplicationGatewayFirewallExclusionConfig.md)
...
### [새로운 AzureRmApplicationGatewayProbeConfig](New-AzureRmApplicationGatewayProbeConfig.md)
상태 프로브를 만듭니다.

### [새로운 AzureRmApplicationGatewayProbeHealthResponseMatch](New-AzureRmApplicationGatewayProbeHealthResponseMatch.md)
응용 프로그램 게이트웨이에 대 한 상태 프로브에 사용 되는 상태 프로브 응답 일치를 만듭니다.

### [새로운 AzureRmApplicationGatewayRedirectConfiguration](New-AzureRmApplicationGatewayRedirectConfiguration.md)
...
### [새로운 AzureRmApplicationGatewayTrustedRootCertificate](New-AzureRmApplicationGatewayTrustedRootCertificate.md)
...
### [새로운 AzureRmContainerNicConfig](New-AzureRmContainerNicConfig.md)
새 컨테이너 네트워크 인터페이스 구성 개체를 만듭니다.

### [새로운 AzureRmContainerNicConfigIpConfig](New-AzureRmContainerNicConfigIpConfig.md)
...
### [새로운 AzureRmFirewallNetworkRule](New-AzureRmFirewallNetworkRule.md)
방화벽 네트워크 규칙을 만듭니다.

### [새로운 AzureRmFirewallNetworkRuleCollection](New-AzureRmFirewallNetworkRuleCollection.md)
네트워크 규칙의 Azure 방화벽 네트워크 컬렉션을 만듭니다.

### [새로운 AzureRmExpressRoutePort](New-AzureRmExpressRoutePort.md)
ExpressRoutePort를 만듭니다.

### [새로운 AzureRmIpsecPolicy](New-AzureRmIpsecPolicy.md)
IPSec 정책을 만듭니다.
...
### [새로운 AzureRmLoadBalancerInboundNatPoolConfig](New-AzureRmLoadBalancerInboundNatPoolConfig.md)
...
### [새로운 AzureRmLoadBalancerOutboundRuleConfig](New-AzureRmLoadBalancerOutboundRuleConfig.md)
...
### [새로운 AzureRmNetworkProfile](New-AzureRmNetworkProfile.md)
새 네트워크 프로필을 만듭니다.
...
### [새로운 AzureRmPublicIpPrefix](New-AzureRmPublicIpPrefix.md)
공용 IP 접두사를 만듭니다.

### [새로운 AzureRmPublicIpTag](New-AzureRmPublicIpTag.md)
IP 태그를 만듭니다.
...
### [새로운 AzureRmRouteTable](New-AzureRmRouteTable.md)
경로 테이블을 만듭니다.

### [새로운 AzureRmServiceEndpointPolicy](New-AzureRmServiceEndpointPolicy.md)
{{Synopsis 채우기}}

### [새로운 AzureRmServiceEndpointPolicyDefinition](New-AzureRmServiceEndpointPolicyDefinition.md)
{{Synopsis 채우기}}

### [새로운 AzureRmVirtualHub](New-AzureRmVirtualHub.md)
Azure VirtualHub 리소스를 만듭니다.

### [새로운 AzureRmVirtualHubRoute](New-AzureRmVirtualHubRoute.md)
Azure 가상 허브 경로 개체를 만듭니다.

### [새로운 AzureRmVirtualHubRouteTable](New-AzureRmVirtualHubRouteTable.md)
Azure 가상 허브 경로 테이블 개체를 만듭니다.

### [새로운 AzureRmVirtualHubVnetConnection](New-AzureRmVirtualHubVnetConnection.md)
New-AzureRmVirtualHubVnetConnection cmdlet은 가상 네트워크를 Azure 가상 허브에 피어 HubVirtualNetworkConnection 리소스를 만듭니다.
...
### [새로운 AzureRmVirtualNetworkGatewayIpConfig](New-AzureRmVirtualNetworkGatewayIpConfig.md)
...
### [새로운 AzureRmVirtualNetworkTap](New-AzureRmVirtualNetworkTap.md)
{{Synopsis 채우기}}

### [새로운 AzureRmVirtualWan](New-AzureRmVirtualWan.md)
Azure 가상 WAN을 만듭니다.

### [새로운 AzureRmVpnClientConfiguration](New-AzureRmVpnClientConfiguration.md)
...
### [새로운 AzureRmVpnClientIpsecParameter](New-AzureRmVpnClientIpsecParameter.md)
...
### [새로운 AzureRmVpnClientIpsecPolicy](New-AzureRmVpnClientIpsecPolicy.md)
...
### [새로운 AzureRmVpnConnection](New-AzureRmVpnConnection.md)
VpnGateway를 RM에 VpnSite로 표시 되는 원격 고객 분기에 연결 하는 IPSec 연결을 만듭니다.

### [새로운 AzureRmVpnGateway](New-AzureRmVpnGateway.md)
확장 가능한 VPN 게이트웨이를 만듭니다.

### [새로운 AzureRmVpnSite](New-AzureRmVpnSite.md)
...
### [제거-AzureRmApplicationGatewayAutoscaleConfiguration](Remove-AzureRmApplicationGatewayAutoscaleConfiguration.md)
...
### [제거-AzureRmApplicationGatewayBackendHttpSettings](Remove-AzureRmApplicationGatewayBackendHttpSettings.md)
...
### [제거-AzureRmApplicationGatewayProbeConfig](Remove-AzureRmApplicationGatewayProbeConfig.md)
기존 응용 프로그램 게이트웨이에서 상태 프로브를 제거 합니다.

### [제거-AzureRmApplicationGatewayRedirectConfiguration](Remove-AzureRmApplicationGatewayRedirectConfiguration.md)
...
### [제거-AzureRmApplicationGatewaySslPolicy](Remove-AzureRmApplicationGatewaySslPolicy.md)
Azure application gateway에서 SSL 정책을 제거 합니다.

### [제거-AzureRmApplicationGatewayTrustedRootCertificate](Remove-AzureRmApplicationGatewayTrustedRootCertificate.md)
...
### [제거-AzureRmExpressRoutePort](Remove-AzureRmExpressRoutePort.md)
ExpressRoutePort 제거
...
### [제거-AzureRmLoadBalancerInboundNatPoolConfig](Remove-AzureRmLoadBalancerInboundNatPoolConfig.md)
...
### [제거-AzureRmLoadBalancerOutboundRuleConfig](Remove-AzureRmLoadBalancerOutboundRuleConfig.md)
...
### [제거-AzureRmNetworkProfile](Remove-AzureRmNetworkProfile.md)
네트워크 프로필을 제거 합니다.

### [제거-AzureRmNetworkInterfaceTapConfig](Remove-AzureRmNetworkInterfaceTapConfig.md)
{{Synopsis 채우기}}
...
### [제거-AzureRmPublicIpPrefix](Remove-AzureRmPublicIpPrefix.md)
공용 IP 접두사를 제거 합니다.
...
### [제거-AzureRmServiceEndpointPolicy](Remove-AzureRmServiceEndpointPolicy.md)
{{Synopsis 채우기}}

### [제거-AzureRmServiceEndpointPolicyDefinition](Remove-AzureRmServiceEndpointPolicyDefinition.md)
{{Synopsis 채우기}}

### [제거-AzureRmVirtualHub](Remove-AzureRmVirtualHub.md)
Azure VirtualHub 리소스를 제거 합니다.

### [제거-AzureRmVirtualHubVnetConnection](Remove-AzureRmVirtualHubVnetConnection.md)
Remove-AzureRmVirtualHubVnetConnection cmdlet은 원격 VNET을 허브 VNET에 피어 하는 Azure 가상 네트워크 연결을 제거 합니다.
...
### [제거-AzureRmVirtualNetworkGatewayDefaultSite](Remove-AzureRmVirtualNetworkGatewayDefaultSite.md)
가상 네트워크 게이트웨이에서 기본 사이트를 제거 합니다.

### [제거-AzureRmVirtualNetworkGatewayIpConfig](Remove-AzureRmVirtualNetworkGatewayIpConfig.md)
...
### [제거-AzureRmVirtualNetworkTap](Remove-AzureRmVirtualNetworkTap.md)
{{Synopsis 채우기}}

### [제거-AzureRmVirtualWan](Remove-AzureRmVirtualWan.md)
Azure 가상 WAN을 제거 합니다.

### [제거-AzureRmVpnClientIpsecParameter](Remove-AzureRmVpnClientIpsecParameter.md)
...
### [제거-AzureRmVpnConnection](Remove-AzureRmVpnConnection.md)
VpnConnection를 제거 합니다.

### [제거-AzureRmVpnGateway](Remove-AzureRmVpnGateway.md)
Remove-AzureRmVpnGateway cmdlet은 Azure VPN 게이트웨이를 제거 합니다. Azure 가상 WAN의 소프트웨어 정의 연결과 관련 된 게이트웨이입니다.

### [제거-AzureRmVpnSite](Remove-AzureRmVpnSite.md)
...
Application gateway에 대 한 자동 크기 조정 구성을 업데이트 합니다.
...
응용 프로그램 게이트웨이에 대 한 신뢰할 수 있는 루트 인증서를 업데이트 합니다.
...
### [테스트-AzureRmDnsAvailability](Test-AzureRmDnsAvailability.md)
...
### [테스트-AzureRmPrivateIPAddressAvailability](Test-AzureRmPrivateIPAddressAvailability.md)
가상 네트워크에서 개인 IP 주소의 사용 가능성을 테스트 합니다.

### [업데이트-AzureRmVirtualHub](Update-AzureRmVirtualHub.md)
가상 허브를 원하는 목표 상태로 업데이트 합니다.

### [업데이트-AzureRmVirtualWan](Update-AzureRmVirtualWan.md)
Azure 가상 WAN을 업데이트 합니다.

### [업데이트-AzureRmVpnConnection](Update-AzureRmVpnConnection.md)
VpnConnection 개체를 목표 상태로 업데이트 합니다.

### [업데이트-AzureRmVpnGateway](Update-AzureRmVpnGateway.md)
Update-AzureRmVpnGateway는 확장 가능한 VPN 게이트웨이를 적절 한 목표 상태로 업데이트 합니다.

### [업데이트-AzureRmVpnSite](Update-AzureRmVpnSite.md)
고객 분기를 나타내는 VpnSite을 의도 하는 목표 상태로 업데이트 합니다.
