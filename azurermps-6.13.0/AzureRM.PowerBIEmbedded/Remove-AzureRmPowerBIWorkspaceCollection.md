...
## 설명은
**AzureRmPowerBIWorkspaceCollection** Cmdlet은 Azure 구독 및 리소스 그룹에서 Power BI 작업 영역 컬렉션을 제거 합니다.
...
이 명령은 지정 된 리소스 그룹에서 WCN11 이라는 작업 영역 컬렉션을 제거 합니다.
...
### -ResourceGroupName
이 cmdlet이 작업 영역 컬렉션을 제거 하는 리소스 그룹의 이름을 지정 합니다.
...
이 cmdlet이 제거 하는 Power BI workspace 컬렉션의 이름을 지정 합니다.
