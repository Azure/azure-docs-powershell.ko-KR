...
- 매주 
- 월간 
- 매년 사용할 각 보존 유형에 대해 하나의 보존 정책을 만듭니다.
...
- 금요일 
- 토요일 
- 일요일 *WeeklyRetention* , *MonthlyRetentionInWeeklyFormat* 및 *YearlyRetentionInWeeklyFormat* 매개 변수를 지정 하는 경우이 매개 변수를 지정 합니다.
...
### AzureRMBackupRetentionPolicy를 통한 명령.
