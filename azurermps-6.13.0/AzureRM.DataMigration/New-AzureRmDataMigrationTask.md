...
## 설명은
New-AzureRmDataMigrationTask cmdlet은 데이터 마이그레이션 작업을 만듭니다. 이 cmdlet은 작업 유형 열거자, Azure 리소스 그룹, 연결 된 Azure 데이터베이스 마이그레이션 서비스의 이름 및 프로젝트의 입력에 대 한 매개 변수를 가져옵니다. 
