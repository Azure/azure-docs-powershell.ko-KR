...
## 설명은
Remove-AzureRmAutomationSourceControl cmdlet은 Azure Automation에서 소스 제어를 제거 합니다.

## 예제의

### 예제 1
이 명령은 devAccount 라는 계정에서 VSTSNative 이라는 자동화 원본 컨트롤을 제거 합니다.
이 명령은 *Force* 매개 변수를 지정 합니다. 따라서 확인 메시지가 표시 되지 않습니다.
...
### -PassThru
PassThru 작업 중인 항목을 나타내는 개체를 반환 합니다.
