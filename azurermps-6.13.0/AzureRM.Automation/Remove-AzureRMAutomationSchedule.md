...
## 설명은
**AzureRmAutomationSchedule** Cmdlet은 Azure 자동화에서 일정을 삭제 합니다.
...
이 명령은 리소스 그룹 ResourceGroup01의 automation 계정 Contoso17에서 Schedule01 이라는 일정을 삭제 합니다.

## 변수

### -AutomationAccountName
이 cmdlet이 일정을 제거 하는 Automation 계정의 이름을 지정 합니다.
...
### -이름
이 cmdlet이 제거 하는 일정의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 일정을 제거할 리소스 그룹의 이름을 지정 합니다.
