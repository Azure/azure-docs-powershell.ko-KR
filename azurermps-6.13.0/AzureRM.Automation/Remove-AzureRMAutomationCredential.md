...
## 설명은
**AzureRmAutomationCredential** Cmdlet은 Azure Automation에서 자격 증명을 제거 합니다.
...
이 명령은 Contoso17 이라는 Azure Automation 계정에서 ContosoCredential 이라는 자격 증명을 제거 합니다.

## 변수

### -AutomationAccountName
이 cmdlet에서 자격 증명을 제거 하는 Automation 계정의 이름을 지정 합니다.
...
### -이름
이 cmdlet이 제거 하는 자격 증명의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet에서 자격 증명을 제거 하는 리소스 그룹의 이름을 지정 합니다.
