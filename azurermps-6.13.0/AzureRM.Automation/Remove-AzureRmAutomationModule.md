...
## 설명은
**AzureRmAutomationModule** Cmdlet은 Azure Automation의 자동화 계정에서 모듈을 제거 합니다.
...
이 명령은 Contoso17 이라는 자동화 계정에서 ContosoModule 이라는 모듈을 제거 합니다.

## 변수

### -AutomationAccountName
이 cmdlet에서 모듈을 제거 하는 Automation 계정의 이름을 지정 합니다.
...
### -이름
이 cmdlet이 제거 하는 모듈의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 모듈을 제거 하는 리소스 그룹의 이름을 지정 합니다.
