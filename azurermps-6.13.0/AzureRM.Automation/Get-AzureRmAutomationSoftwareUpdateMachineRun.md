...
### -TargetComputer
컴퓨터 실행을 위한 대상 컴퓨터.
비 azure 컴퓨터 이름 또는 azure VM 리소스 id 일 수 있습니다.
...
### 시스템 Null 허용 ' 1 [[UpdateManagement]. SoftwareUpdateMachineRunStatus, Microsoft azure. e. t e 5.1.1.0, Version =, Culture = 중립, PublicKeyToken = null]]
