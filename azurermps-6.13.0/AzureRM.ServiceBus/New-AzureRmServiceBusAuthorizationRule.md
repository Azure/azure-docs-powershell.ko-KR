...
## 설명은
**AzureRmServiceBusAuthorizationRule** cmdlet은 지정 된 Service Bus 네임 스페이스 또는 큐 또는 항목에 대 한 새 권한 부여 규칙을 만듭니다.
...
`AuthoRule1`큐에 대 한 **수신 대기** 및 **보내기** 권한을 사용 하 여 만듭니다 `SBQueue` .
...
`AuthoRule1`항목에 대 한 **듣기** 및 **보내기** 권한을 사용 하 여 만듭니다 `SBTopic` .
