...
## 설명은
**AzureRmServiceBusMigration** Cmdlet은 표준 ~ premium 네임 스페이스 간 마이그레이션을 tremitates 합니다.
...
cmdlet은 마이그레이션 구성을 만드는 동안 제공 되는 표준 네임 스페이스와 Premium 네임 스페이스 간의 마이그레이션을 termitates.
