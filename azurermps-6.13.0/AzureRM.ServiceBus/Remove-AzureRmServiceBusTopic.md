...
## 설명은
**AzureRmServiceBusTopic** cmdlet은 지정 된 Service Bus 네임 스페이스에서 항목을 제거 합니다.
...
`SB-Topic_exampl1`네임 스페이스에서 항목을 제거 `SB-Example1` 합니다.
