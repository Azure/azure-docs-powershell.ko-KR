...
## 설명은
**Add-AzureRmServiceFabricNode** 를 사용 하 여 특정 노드 형식에 노드를 추가 합니다. 노드 형식에 추가 하려는 노드 수를 지정 하기만 하면 됩니다.
...
이 명령은 노드 형식 ' n1 '에 2 개의 노드를 추가 합니다.
...
### 시스템. i i.
매개 변수: NumberOfNodesToAdd (ByValue)
