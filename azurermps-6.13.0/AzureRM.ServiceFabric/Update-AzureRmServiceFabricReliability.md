...
## 설명은
**업데이트-AzureRmServiceFabricReliability** 를 사용 하 여 클러스터의 기본 노드 유형의 안정성을 업데이트 합니다.
...
이 명령은 기본 노드 유형의 안정성 계층을 은색으로 변경 합니다.

## 변수

### -AutoAddNode
안정성을 변경할 때 노드 수를 자동으로 추가 합니다.
...
### ServiceFabric. ReliabilityLevel/.
매개 변수: ReliabilityLevel (ByValue)

### System.webserver 매개 변수
매개 변수: AutoAddNode (ByValue)
