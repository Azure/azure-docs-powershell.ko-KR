...
## 설명은
**Remove-AzureRmServiceFabricNode** 를 사용 하 여 클러스터에서 특정 노드 유형에 서 노드를 제거 합니다. 클러스터 상태 메트릭을 충족 하는 경우에만 제거가 진행 됩니다.
...
이 명령은 NodeType ' nt1 '에서 2 개의 노드를 제거 합니다.
...
### 시스템. i i.
매개 변수: NumberOfNodesToRemove (ByValue)

### System. 문자열
매개 변수: NodeType (ByValue)
