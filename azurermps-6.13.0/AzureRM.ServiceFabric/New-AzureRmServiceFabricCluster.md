...
### System. 문자열
매개 변수: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), KeyVaultName (byvalue), KeyVaultResouceGroupName (byvalue), 위치 (byvalue), ParameterFile (값), Name (byvalue), (인 서 값),, (byvalue), VmUserName (ByValue)

### System.webserver
매개 변수: CertificatePassword (ByValue), SecondaryCertificatePassword (ByValue)

### 시스템. i i.
매개 변수: ClusterSize (ByValue)
