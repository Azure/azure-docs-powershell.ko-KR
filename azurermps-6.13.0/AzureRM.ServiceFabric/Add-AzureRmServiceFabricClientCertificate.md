...
### System. 문자열
매개 변수: CommonName (ByValue), IssuerThumbprint (ByValue), 손도장 (ByValue)

### System.webserver []
매개 변수: AdminClientThumbprint (ByValue), ReadonlyClientThumbprint (ByValue)

### ServiceFabric. PSClientCertificateCommonName []
매개 변수: ClientCertificateCommonName (ByValue)
