...
## 설명은
**AzureRmActivityLogAlert** cmdlet은 새 작업을 만들거나 기존 활동 로그 알림을 설정 합니다.
...
### System.webserver. List ' 1 [[ActivityLogAlertLeafCondition, Microsoft azure. 5.1.0.0, Version =, Culture = 중립, PublicKeyToken = null]]을 표시 합니다.

### System.webserver. List ' 1 [[5.1.0.0]. ActivityLogAlertActionGroup, Microsoft Azure. 명령-Insights, Version =, Culture = 중립, PublicKeyToken = null]]
