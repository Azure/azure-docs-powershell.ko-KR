...
## 설명은
**Add-AzureRmDataLakeAnalyticsFirewallRule** Cmdlet은 Azure Data Lake Analytics 계정에 방화벽 규칙을 추가 합니다.
...
이 명령은 "ContosoAdlAcct" 계정의 "my 방화벽 규칙" 이라는 방화벽 규칙을 IP 범위: 127.0.0.1-127.0.0.10에 추가 합니다.

## 변수

### -계정
방화벽 규칙을 추가할 Data Lake Analytics 계정
