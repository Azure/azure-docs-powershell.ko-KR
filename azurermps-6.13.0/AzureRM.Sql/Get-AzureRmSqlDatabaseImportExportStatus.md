...
## 설명은
**AzureRmSqlDatabaseImportExportStatus** cmdlet은 저장소 계정에서 Azure sql 데이터베이스로의 bacpac 파일 가져오기에 대 한 세부 정보를 가져오거나 저장소 계정에 대 한 Bacpac 파일로 Azure sql 데이터베이스 내보내기를 가져옵니다.
...
### -OperationStatusLink
New-AzureRmSqlDatabaseExport 또는 New-AzureRmSqlDatabaseImport cmdlet에서 반환 되는 상태 링크를 지정 합니다.
