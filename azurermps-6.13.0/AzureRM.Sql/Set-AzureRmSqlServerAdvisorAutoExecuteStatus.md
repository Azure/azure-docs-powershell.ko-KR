...
## 설명은
**Set-AzureRmSqlServerAdvisorAutoExecuteStatus** Cmdlet은 Azure SQL Server Advisor에 대 한 자동 실행 속성을 설정 합니다.
...
이 명령은 CreateIndex 라는 이름의 관리자의 자동 실행 상태를 설정 합니다.
...
### -AutoExecuteStatus
이 cmdlet이 자동 실행 상태를 업데이트 하는 값을 지정 합니다.
