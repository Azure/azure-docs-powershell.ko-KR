...
테이블 감사에서이 cmdlet을 실행 하기 전에 데이터베이스에서 감사에 대 한 서버 정책을 사용한 경우 감사가 해당 정책의 사용을 중지 합니다. Blob 감사의 경우,이 cmdlet을 실행 하기 전에 데이터베이스에서 감사에 대 한 서버 정책을 사용 하는 경우 두 감사 정책이 모두 나란히 존재 하 게 됩니다.
