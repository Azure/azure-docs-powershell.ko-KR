...
### [추가-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate](Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate.md)
지정 된 관리 되는 인스턴스에 대 한 투명 한 데이터 암호화 인증서를 추가 합니다.

### [추가-AzureRmSqlServerKeyVaultKey](Add-AzureRmSqlServerKeyVaultKey.md)
SQL server에 키 보관소 키를 추가 합니다.

### [추가-AzureRmSqlServerTransparentDataEncryptionCertificate](Add-AzureRmSqlServerTransparentDataEncryptionCertificate.md)
지정 된 SQL Server 인스턴스에 대 한 투명 한 데이터 암호화 인증서를 추가 합니다.

### [일반-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline](Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
취약점 평가 규칙 기준을 지웁니다.

### [일반-AzureRmSqlDatabaseVulnerabilityAssessmentSettings](Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings.md)
데이터베이스의 취약점 평가 설정을 지웁니다.

### [변환-AzureRmSqlDatabaseVulnerabilityAssessmentScan](Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan.md)
...
### [새로운 AzureRmSqlDatabaseCopy](New-AzureRmSqlDatabaseCopy.md)
현재 시간에 스냅숏을 사용 하는 SQL 데이터베이스의 복사본을 만듭니다.

### [새로운 AzureRmSqlDatabaseDataMaskingRule](New-AzureRmSqlDatabaseDataMaskingRule.md)
...
### [새로운 AzureRmSqlDatabaseRestorePoint](New-AzureRmSqlDatabaseRestorePoint.md)
...
### [새로운 AzureRmSqlInstance](New-AzureRmSqlInstance.md)
Azure SQL 데이터베이스 관리 인스턴스를 만듭니다.

### [새로운 AzureRmSqlInstanceDatabase](New-AzureRmSqlInstanceDatabase.md)
...
### [새로운 AzureRmSqlServerDisasterRecoveryConfiguration](New-AzureRmSqlServerDisasterRecoveryConfiguration.md)
데이터베이스 서버 시스템 복구 구성을 만듭니다.

### [새로운 AzureRmSqlServerDnsAlias](New-AzureRmSqlServerDnsAlias.md)
...
### [새로운 AzureRmSqlServerVirtualNetworkRule](New-AzureRmSqlServerVirtualNetworkRule.md)
Azure SQL Server 가상 네트워크 규칙을 만듭니다. 

### [새로운 AzureRmSqlSyncAgent](New-AzureRmSqlSyncAgent.md)
Azure SQL 동기화 에이전트를 만듭니다.

### [새로운 AzureRmSqlSyncAgentKey](New-AzureRmSqlSyncAgentKey.md)
Azure SQL 동기화 에이전트 키를 만듭니다.

### [새로운 AzureRmSqlSyncGroup](New-AzureRmSqlSyncGroup.md)
...
### [제거-AzureRmSqlDatabaseRestorePoint](Remove-AzureRmSqlDatabaseRestorePoint.md)
SQL 데이터베이스에서 지정 된 복원 지점을 제거 합니다.

### [제거-AzureRmSqlDatabaseSecondary](Remove-AzureRmSqlDatabaseSecondary.md)
...
### [제거-AzureRmSqlInstance](Remove-AzureRmSqlInstance.md)
Azure SQL 관리 데이터베이스 인스턴스를 제거 합니다.

### [제거-AzureRmSqlInstanceDatabase](Remove-AzureRmSqlInstanceDatabase.md)
...
### [제거-AzureRmSqlServerAuditing](Remove-AzureRmSqlServerAuditing.md)
...
### [제거-AzureRmSqlServerDnsAlias](Remove-AzureRmSqlServerDnsAlias.md)
...
### [제거-AzureRmSqlServerKeyVaultKey](Remove-AzureRmSqlServerKeyVaultKey.md)
SQL server에서 키 자격 증명 모음 키를 제거 합니다.

### [제거-AzureRmSqlServerThreatDetectionPolicy](Remove-AzureRmSqlServerThreatDetectionPolicy.md)
서버에서 위협 검색 정책을 제거 합니다.

### [제거-AzureRmSqlServerVirtualNetworkRule](Remove-AzureRmSqlServerVirtualNetworkRule.md)
Azure SQL Server 가상 네트워크 규칙을 삭제 합니다.

### [제거-AzureRmSqlSyncAgent](Remove-AzureRmSqlSyncAgent.md)
Azure SQL 동기화 에이전트를 제거 합니다.

### [제거-AzureRmSqlSyncGroup](Remove-AzureRmSqlSyncGroup.md)
...
### [시작-AzureRmSqlDatabaseExecuteIndexRecommendation](Start-AzureRmSqlDatabaseExecuteIndexRecommendation.md)
추천 인덱스 작업을 실행 하는 워크플로를 시작 합니다.

### [시작-AzureRmSqlDatabaseVulnerabilityAssessmentScan](Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan.md)
취약점 평가 검사를 시작 합니다.

### [시작-AzureRmSqlServerUpgrade](Start-AzureRmSqlServerUpgrade.md)
SQL 데이터베이스 서버의 업그레이드를 시작 합니다.

### [시작-AzureRmSqlSyncGroupSync](Start-AzureRmSqlSyncGroupSync.md)
동기화 그룹 동기화를 시작 합니다.

### [중지-AzureRmSqlDatabaseActivity](Stop-AzureRmSqlDatabaseActivity.md)
데이터베이스에서 비동기 업데이트 작업을 취소 합니다.

### [중지-AzureRmSqlDatabaseExecuteIndexRecommendation](Stop-AzureRmSqlDatabaseExecuteIndexRecommendation.md)
추천 인덱스 작업을 실행 하는 워크플로를 중지 합니다.

### [중지-AzureRmSqlElasticPoolActivity](Stop-AzureRmSqlElasticPoolActivity.md)
탄력적 풀에서 비동기 업데이트 작업을 취소 합니다.

### [중지-AzureRmSqlServerUpgrade](Stop-AzureRmSqlServerUpgrade.md)
SQL 데이터베이스 서버의 업그레이드를 중지 합니다.

### [중지-AzureRmSqlSyncGroupSync](Stop-AzureRmSqlSyncGroupSync.md)
동기화 그룹 동기화를 중지 합니다.
...
### [업데이트-AzureRmSqlDatabaseVulnerabilityAssessmentSettings](Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings.md)
데이터베이스의 취약점 평가 설정을 업데이트 합니다.

### [업데이트-AzureRmSqlSyncGroup](Update-AzureRmSqlSyncGroup.md)
...
### [업데이트-AzureRmSqlSyncSchema](Update-AzureRmSqlSyncSchema.md)
