...
### 예제 1 application insights 리소스에서 cotinuous 내보내기 구성을 제거 합니다.
```
...
리소스 그룹 "testgroup"에서 "test" 리소스에 대 한 내보내기 id가 "uGOoki0jQsyEs3IdQ83Q4QsNr4 =" 인 application insights 연속 내보내기 구성을 제거 합니다.
