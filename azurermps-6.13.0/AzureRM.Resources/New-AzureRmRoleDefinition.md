...
Get-AzureRmProviderOperation를 사용 하 여 Azure RBAC를 사용 하 여 보호할 수 있는 Azure 리소스 공급자에 대 한 작업을 가져옵니다.
다음은 유효한 작업 문자열입니다.
...
3) NotDataActions: 사용자 지정 역할에 대 한 유효 dataactions를 결정 하기 위해 DataActions에서 제외 해야 하는 작업 집합입니다.
