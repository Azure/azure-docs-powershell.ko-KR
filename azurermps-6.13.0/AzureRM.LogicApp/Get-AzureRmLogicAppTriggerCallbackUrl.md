...
## 설명은
**Get-AzureRmLogicAppTriggerCallbackUrl** cmdlet은 리소스 그룹에서 논리 앱 트리거 콜백 URL을 가져옵니다.
이 cmdlet은 콜백 URL을 나타내는 **Workflowtriggercallbackurl** 개체를 반환 합니다.
리소스 그룹 이름, 논리 앱 이름 및 트리거 이름을 지정 합니다.
...
### Microsoft. Azure. 관리. i m l. 모델. WorkflowTriggerCallbackUrl
