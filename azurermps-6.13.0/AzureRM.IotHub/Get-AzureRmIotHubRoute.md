...
## 설명은
경로에 대 한 정보를 가져옵니다. IoT Hub에서 모든 경로를 가져오고, 끝점 형식에 대 한 경로를 가져오거나, 특정 끝점에 대 한 경로를 가져올 수 있습니다.
...
"Myiothub" IoT Hub에서 모든 경로를 가져옵니다.
...
"Myiothub" IoT Hub에서 경로 정보를 가져옵니다.
...
### IotHub. PSRouteMetadata/. *
System.webserver. List ' 1 [[IotHub]. PSRouteProperties, Microsoft IotHub, Version = 3.1.3.0, Culture = 중립, PublicKeyToken = null]]을 표시 합니다.
