...
---
# <span data-ttu-id="2bfd6-101">Get-AzAttestationPolicySigners</span><span class="sxs-lookup"><span data-stu-id="2bfd6-101">Get-AzAttestationPolicySigners</span></span>

## <span data-ttu-id="2bfd6-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="2bfd6-102">SYNOPSIS</span></span>
<span data-ttu-id="2bfd6-103">Azure 증명의 테 넌 트에서 신뢰할 수 있는 정책 서명자를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-103">Gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="2bfd6-104">구문과</span><span class="sxs-lookup"><span data-stu-id="2bfd6-104">SYNTAX</span></span>

### <span data-ttu-id="2bfd6-105">NameParameterSet</span><span class="sxs-lookup"><span data-stu-id="2bfd6-105">NameParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-Name] <String> [-ResourceGroupName] <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="2bfd6-106">ResourceIdParameterSet</span><span class="sxs-lookup"><span data-stu-id="2bfd6-106">ResourceIdParameterSet</span></span>
```
Get-AzAttestationPolicySigners [-ResourceId] <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

## <span data-ttu-id="2bfd6-107">설명은</span><span class="sxs-lookup"><span data-stu-id="2bfd6-107">DESCRIPTION</span></span>
<span data-ttu-id="2bfd6-108">Get-AzAttestationPolicySigners cmdlet은 Azure 증명의 테 넌 트에서 신뢰할 수 있는 정책 서명자를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-108">The Get-AzAttestationPolicySigners cmdlet gets the trusted policy signers from a tenant in Azure Attestation.</span></span>

## <span data-ttu-id="2bfd6-109">예제의</span><span class="sxs-lookup"><span data-stu-id="2bfd6-109">EXAMPLES</span></span>

### <span data-ttu-id="2bfd6-110">예제 1</span><span class="sxs-lookup"><span data-stu-id="2bfd6-110">Example 1</span></span>
```powershell
...
<span data-ttu-id="2bfd6-111">리소스 그룹 *psh-rg* 의 증명 공급자 *pshtest* 에 대 한 신뢰할 수 있는 정책 서명자를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-111">Gets the trusted policy signers for the Attestation Provider *pshtest* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="2bfd6-112">이 증명 공급자에 대 한 신뢰할 수 있는 서명자가 없는 것을 참고 하세요.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-112">Note that there are no trusted signers for this Attestation Provider.</span></span>

### <span data-ttu-id="2bfd6-113">예제 2</span><span class="sxs-lookup"><span data-stu-id="2bfd6-113">Example 2</span></span>
```powershell
...
<span data-ttu-id="2bfd6-114">리소스 그룹 *psh-rg* 의 증명 공급자 *pshtest2* 에 대 한 신뢰할 수 있는 정책 서명자를 가져옵니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-114">Gets the trusted policy signers for the Attestation Provider *pshtest2* in Resource Group *psh-test-rg*.</span></span>  <span data-ttu-id="2bfd6-115">이 증명 공급자에 대 한 신뢰할 수 있는 서명자가 하나 있다는 점에 유의 하세요.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-115">Note that there is one trusted signer for this Attestation Provider.</span></span>

## <span data-ttu-id="2bfd6-116">변수</span><span class="sxs-lookup"><span data-stu-id="2bfd6-116">PARAMETERS</span></span>

### <span data-ttu-id="2bfd6-117">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="2bfd6-117">-DefaultProfile</span></span>
<span data-ttu-id="2bfd6-118">Azure와 통신 하는 데 사용 되는 자격 증명, 계정, 테 넌 트 및 구독입니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-118">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="2bfd6-119">-이름</span><span class="sxs-lookup"><span data-stu-id="2bfd6-119">-Name</span></span>
<span data-ttu-id="2bfd6-120">증명 공급자의 이름을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-120">Specifies the name of an attestation provider.</span></span>
...
### <span data-ttu-id="2bfd6-121">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="2bfd6-121">-ResourceGroupName</span></span>
<span data-ttu-id="2bfd6-122">증명 공급자의 리소스 그룹 이름을 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-122">Specifies the resource group name of an attestation provider.</span></span>
...
### <span data-ttu-id="2bfd6-123">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="2bfd6-123">-ResourceId</span></span>
<span data-ttu-id="2bfd6-124">증명 공급자의 ResourceID를 지정 합니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-124">Specifies the ResourceID of an attestation provider.</span></span>
...
### <span data-ttu-id="2bfd6-125">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="2bfd6-125">CommonParameters</span></span>
<span data-ttu-id="2bfd6-126">이 cmdlet은-Debug,-ErrorAction,-Erroraction,-InformationAction,-Informationaction,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose,-WarningAction,-WarningVariable 등의 공통 매개 변수를 지원 합니다.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-126">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="2bfd6-127">자세한 내용은 [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216)을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="2bfd6-127">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="2bfd6-128">입력</span><span class="sxs-lookup"><span data-stu-id="2bfd6-128">INPUTS</span></span>

### <span data-ttu-id="2bfd6-129">System. 문자열</span><span class="sxs-lookup"><span data-stu-id="2bfd6-129">System.String</span></span>

## <span data-ttu-id="2bfd6-130">출력</span><span class="sxs-lookup"><span data-stu-id="2bfd6-130">OUTPUTS</span></span>

### <span data-ttu-id="2bfd6-131">PSPolicySigners/. i m m</span><span class="sxs-lookup"><span data-stu-id="2bfd6-131">Microsoft.Azure.Commands.Attestation.Models.PSPolicySigners</span></span>

## <span data-ttu-id="2bfd6-132">상속자</span><span class="sxs-lookup"><span data-stu-id="2bfd6-132">NOTES</span></span>

## <span data-ttu-id="2bfd6-133">관련 링크</span><span class="sxs-lookup"><span data-stu-id="2bfd6-133">RELATED LINKS</span></span>
