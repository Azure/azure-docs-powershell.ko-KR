...
## 설명은
**AzAutomationJob** Cmdlet은 Azure Automation 작업을 일시 중단 합니다.
실행 중인 자동화 작업을 지정 합니다.
일시 중단 된 작업을 다시 시작 하려면 Resume-AzAutomationJob cmdlet을 사용 합니다.
...
이 cmdlet이 작업을 일시 중단 하는 Automation 계정의 이름을 지정 합니다.
