...
## 설명은
**AzAutomationCertificate** Cmdlet은 Azure Automation에서 인증서를 제거 합니다.
...
이 cmdlet이 인증서를 제거 하는 Automation 계정의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 인증서를 제거할 리소스 그룹의 이름을 지정 합니다.
