...
## SYNOPSIS
Azure eventhub에 대 한 SAS 토큰을 생성 합니다. 네임 스페이스/eventhub의 권한 부여 규칙입니다. 
...
## 설명은
New-AzEventHubAuthorizationRuleSASToken cmdlet이 Azure Eventhub Namesapce 또는 Azure Eventhub에 대 한 SAS (공유 액세스 서명) 토큰을 생성 합니다.
...
### Microsoft. *. m a m. 모델. Pssharedaccess서명 특성
