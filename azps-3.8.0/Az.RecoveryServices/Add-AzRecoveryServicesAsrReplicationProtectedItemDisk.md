...
## 설명은
**AzRecoveryServicesAsrReplicationProtectedItemDisk** cmdlet은 이미 보호 된 azure 가상 머신에 대 한 보호를 위해 디스크를 추가 합니다.
...
보호를 위해 지정 된 디스크 구성을 추가 하는 작업을 시작 합니다.
...
보호를 위해 지정 된 디스크 구성을 추가 하는 작업을 시작 합니다. 파이핑 입력 복제 보호 된 항목입니다.

## 변수

### -AzureToAzureDiskReplicationConfiguration
Azure에서 Azure 재해 복구 시나리오의 디스크 보호에 사용할 디스크 구성을 지정 합니다.
...
### -InputObject
Cmdlet에 대 한 입력 개체: 새 디스크에 대해 보호 되어야 하는 ASR 복제 보호 항목 개체입니다.
