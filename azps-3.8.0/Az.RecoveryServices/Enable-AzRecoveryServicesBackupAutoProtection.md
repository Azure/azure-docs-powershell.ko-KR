...
## 설명은
**AzRecoveryServicesBackupAutoProtection** cmdlet은 보호 가능한 항목에 대 한 Azure 자동 백업 보호 정책을 설정 합니다.
...
두 번째 cmdlet은 $Pol의 정책을 사용 하 여 AzureWorkload 부하에 대 한 백업 보호 정책을 설정 합니다.

## 변수

### -BackupManagementType
리소스의 백업 관리 유형 (예: MAB, DPM, AzureWorkload)입니다.
...
### -InputItem
입력으로 전달할 수 있는 보호 가능한 항목 개체를 지정 합니다.
