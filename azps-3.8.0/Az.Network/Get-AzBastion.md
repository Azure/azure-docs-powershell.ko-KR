...
## 설명은
**Get-방호** cmdlet은 리소스 그룹 또는 subscritption에서 하나 이상의 bastions를 가져옵니다.
...
### 1.13.0.0 ' 1 [[Microsoft Azure. e. 모델]. PSBastion, Microsoft Azure. PowerShell, Version =, Culture = 중립, PublicKeyToken = null]]
