...
## 설명은
**AzExpressRoutePort** Cmdlet은 ExpressRoutePort를 제거 합니다.
...
구독에서 $rg 리소스 그룹의 $PortName ExpressRoutePort 리소스를 제거 합니다.
...
InputObject에서 ExpressRoutePort 리소스를 제거 합니다.
...
ResourceId $id를 사용 하 여 ExpressRoutePort 리소스를 제거 합니다.
