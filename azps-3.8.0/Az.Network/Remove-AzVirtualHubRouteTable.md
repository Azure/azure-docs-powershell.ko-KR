...
### ByVirtualHubRouteTableName (기본값)
```
...
## 설명은
지정 된 가상 허브에 연결 된 지정 된 경로 테이블을 삭제 합니다.
...
이 명령은 가상 허브 westushub의 routeTable1를 삭제 합니다.
...
### -InputObject
제거할 virtualhubroutetable 리소스입니다.
...
### -ResourceId
제거할 virtualhubroutetable 리소스의 리소스 id입니다.
