...
허브 가상 네트워크 연결을 만든 후에는 해당 리소스 그룹 이름, 허브 이름 및 연결 이름을 사용 하 여 허브 가상 네트워크 연결을 제거 합니다.
...
허브 가상 네트워크 연결을 만든 후에는 AzHubVirtualNetworkConnection의 출력에서 powershell 파이핑을 사용 하 여 허브 가상 네트워크 연결을 제거 합니다.
