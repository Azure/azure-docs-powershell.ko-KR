...
## 설명은
**AzApplicationGatewayFirewallPolicySetting** 는 방화벽 정책에 대 한 정책 설정을 만듭니다.
...
명령이 상태가 $enabledState로 설정 되 고, mode가 $enabledMode FileUploadLimitInMb RequestBodyCheck false로, MaxRequestBodySizeInKb에서는 $ $maxRequestBodySizeInKb으로 $fileUploadLimitInMb와
새 policySettings $condition에 저장 됩니다.
...
방화벽 정책의 정책 설정에서 requestBodyCheck을 가능 하 게 합니다.
...
방화벽 정책의 정책 설정 MaxRequestBodySizeInKb.
...
### PSApplicationGatewayFirewallPolicySettings에 대 한.
