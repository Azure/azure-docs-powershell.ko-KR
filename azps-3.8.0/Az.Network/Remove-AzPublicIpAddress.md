...
## 설명은
**AzPublicIpAddress** Cmdlet은 AZURE 공용 IP 주소를 제거 합니다.
...
이 명령은 리소스 그룹 $rgName에서 $publicIpName 이라는 공용 IP 주소 리소스를 제거 합니다.
...
### -이름
이 cmdlet이 제거 하는 공용 IP 주소의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 제거할 공용 IP 주소를 포함 하는 리소스 그룹의 이름을 지정 합니다.
