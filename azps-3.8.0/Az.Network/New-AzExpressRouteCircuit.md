...
## 설명은
**AzExpressRouteCircuit** Cmdlet은 Azure express 경로 회로를 만듭니다.
...
### -ServiceProviderName
회로 서비스 공급자의 이름입니다. 이것은 Get-AzExpressRouteServiceProvider cmdlet에 나열 된 이름과 일치 해야 합니다.
...
### -서 고 U계층
회로에 대 한 서비스 계층입니다. 이 매개 변수에 사용할 수 있는 값 `Standard` 은 다음과 같습니다. `Premium` `Local`
...
### PSExpressRouteCircuitAuthorization [] (으)로
