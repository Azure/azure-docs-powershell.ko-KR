...
## 설명은
New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject cmdlet은 끝점 필터 항목을 만듭니다.
...
### -Type
필터에 포함 된 항목의 유형입니다. 현재 ' AgentAddress '만 지원 됩니다.
...
### Microsoft. 네트워크. PSConnectionMonitorEndpointFilterItem
