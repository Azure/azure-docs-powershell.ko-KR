...
## 설명은
**새 AzApplicationGatewayFirewallPolicy** cmdlet은 응용 프로그램 게이트웨이 방화벽 정책을 만듭니다.
...
이 명령은 $customRule 변수에 정의 된 사용자 지정 규칙이 있는 "westus" 리소스 그룹 "rg1"에 "wafResource1" 이라는 새 Azure application gateway 방화벽 정책을 만듭니다.
...
### PSApplicationGatewayFirewallCustomRule [] (으)로

### PSApplicationGatewayFirewallPolicySettings에 대 한.

### PSApplicationGatewayFirewallPolicyManagedRules에 대 한.
