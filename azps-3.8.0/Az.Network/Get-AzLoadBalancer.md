...
## 설명은
**AzLoadBalancer** cmdlet은 리소스 그룹에 포함 된 하나 이상의 Azure 부하 분산 장치를 가져옵니다.
...
이 명령은 "MyLoadBalancer"로 시작 하는 이름을 사용 하 여 모든 부하 분산 장치를 가져옵니다.
