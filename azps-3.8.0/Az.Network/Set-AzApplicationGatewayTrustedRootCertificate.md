...
## 설명은
**AzApplicationGatewayTrustedRootCertificate** Cmdlet은 응용 프로그램 게이트웨이의 기존 신뢰할 수 있는 루트 인증서를 수정 합니다.
...
위 예제 시나리오에서는 루트 인증서가 롤백될 때 기존 신뢰할 수 있는 루트 인증서를 업데이트 하는 방법을 보여 줍니다.
첫 번째 명령은 응용 프로그램 게이트웨이를 가져와 $gw 변수에 저장 합니다.
두 번째 명령은 새 루트 인증서를 사용 하 여 기존 신뢰할 수 있는 루트 인증서를 수정 합니다.
