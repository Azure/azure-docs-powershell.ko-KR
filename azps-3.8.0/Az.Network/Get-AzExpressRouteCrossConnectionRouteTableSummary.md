...
## 설명은
**AzExpressRouteCrossConnectionRouteTableSummary** cmdlet은 특정 라우팅 컨텍스트에 대 한 BGP 인접 정보 요약을 검색 합니다. 이 정보는 라우팅 컨텍스트가 설정 된 시간과 피어 링 라우터에서 알린 경로 접두사의 수를 확인 하는 데 유용 합니다.

## 예제의

### 예제 1: 기본 경로의 경로 요약 표시
```
...
### PSExpressRouteCrossConnectionRoutesTableSummary에 대 한.
