...
```
## 설명은
**New-AzIpConfigurationBgpPeeringAddressObject** 는 가상 네트워크 게이트웨이 Bgpsettings에서 BgpPeeringAddresses 속성을 나타내는 IpConfigurationBgpPeeringAddressObject 개체를 만듭니다.

## 예제의

### 1: AzIpConfigurationBgpPeeringAddressObject 만들기
```
...
위의 방법으로 IpConfigurationBgpPeeringAddressObject를 만들 수 있습니다 .이 새 개체는 gw1ipconfBgp1.
...
### -CustomAddress
BgpPeeringAddresses의 가상 네트워크 게이트웨이 CustomAddress 목록입니다.
...
### -IpConfigurationId
BgpPeeringAddresses에 대 한 가상 네트워크 게이트웨이 IpConfigurationId.
...
### PSIpConfigurationBgpPeeringAddress에 대 한.
