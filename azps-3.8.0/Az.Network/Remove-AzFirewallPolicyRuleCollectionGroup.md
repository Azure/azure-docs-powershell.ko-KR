...
## 설명은
**AzFirewallPolicyRuleCollectionGroup** Cmdlet은 Azure 방화벽 정책에서 규칙 모음 그룹을 제거 합니다.
...
이 예제에서는 방화벽 정책 개체에서 "testRcGroup" 이라는 방화벽 정책 규칙 colelction 그룹을 제거 합니다 $fp
...
이 예제에서는 "fpName" frpm 인 방화벽에서 "testRcGroup" 이라는 방화벽 정책 규칙 colelction 그룹을 제거 합니다. resourcegroup 이름 "testRg"
...
### PSAzureFirewallPolicyRuleCollectionGroupWrapper에 대 한.
