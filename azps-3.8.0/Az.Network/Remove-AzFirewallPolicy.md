...
## 설명은
**AzFirewallPolicy** Cmdlet은 Azure 방화벽 정책을 제거 합니다.
...
이 예제에서는 resourcegroup "TestRg"에서 "firewallpolicy" 이라는 방화벽 정책을 제거 합니다.
...
이 예제에서는 Id를 기준으로 방화벽 정책을 제거 합니다.
