...
## 설명은
New-AzTrafficSelectorPolicy cmdlet은 가상 네트워크 게이트웨이 연결에 사용 되는 트래픽 선택기 정책 제안을 만듭니다.
...
IKEv2 프로토콜을 사용 하 여 가상 네트워크 게이트웨이 연결을 만들 때 트래픽 선택기 정책의 인스턴스를 만들고이를 매개 변수로 추가 합니다.
