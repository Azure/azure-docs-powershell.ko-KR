...
## 설명은
**AzLoadBalancerRuleConfig** cmdlet은 부하 분산 장치에 대 한 하나 이상의 규칙 구성을 가져옵니다.

## 예제의

### 예제 1: 부하 분산 장치에 대 한 규칙 구성 가져오기
```
...
두 번째 명령은 $slb의 부하 분산 장치에서 MyLBrulename 이라는 연결 된 규칙 구성을 가져옵니다.
...
### -LoadBalancer
가져올 규칙 구성에 연결 된 부하 분산 장치를 지정 합니다.
