...
## 설명은
이 명령은 트리거 정의에서 지정 된 외부 서비스 이벤트에 대 한 이벤트 트리거를 구독 하지 않도록 합니다.
...
이 명령은 트리거 정의에서 지정 된 이벤트에 대 한 BlobEnetTrigger1 trigger의 구독을 취소 합니다.
...
### -PassThru
지정 하면 delete가 성공한 경우 false를 반환 합니다.
