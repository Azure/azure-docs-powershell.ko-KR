...
## SYNOPSIS
Azure Data Factory에서 모든 활성 데이터 흐름 디버그 세션 가져오기
...
## 설명은
자세한 내용은 Azure Data Factory에서 모든 활성 데이터 흐름 디버그 세션을 나열 합니다.
...
Azure Data Factory "WikiADF"에서 모든 활성 데이터 흐름 디버그 세션을 가져옵니다.
