...
위의 명령은 리소스 그룹 "testrg"에 있는 기존 클러스터 "mykustocluster"에 "mykustodatabase" 이라는 새 Kusto 데이터베이스를 만듭니다.

## 변수

### -ClusterName
데이터베이스를 만드는 데 사용할 클러스터의 이름입니다.
...
쿼리에 대 한 액세스를 중지 하기 전에 데이터를 유지 해야 하는 날짜 수입니다.
