...
## 설명은
**AzImageConfig** cmdlet은 구성 가능한 image 개체를 만듭니다.
...
다음 세 개의 명령은 os 디스크의 경로와 두 개의 데이터 디스크를 $osDiskVhdUri, $dataDiskVhdUri 1 및 $dataDiskVhdUri 2 변수에 할당 합니다. 이 방법은 다음 명령에 대 한 읽기 전용입니다.
...
### -HyperVGeneration
이미지에서 만든 가상 컴퓨터에 대 한 HyperVGeneration 형식을 지정 합니다.  허용 되는 값은 V1 및 V2입니다.
...
### ImageOSDisk를 통해 계산 합니다.

### Microsoft. g. ImageDataDisk []
