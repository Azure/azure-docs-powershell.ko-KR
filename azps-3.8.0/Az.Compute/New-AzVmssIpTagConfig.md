...
## 설명은
**AzVmssIpTagConfig** CMDLET은 Vmss (가상 컴퓨터 크기 조정 집합)의 네트워크 인터페이스에 대 한 IP 태그 구성 개체를 만듭니다.
이 cmdlet의 구성을 New-AzVmssIpConfig cmdlet의 *Iptag* 매개 변수로 지정 합니다.
...
이 명령은 ' FirstPartyUsage ' 형식 및 ' Sql ' 태그를 사용 하 여 IP 태그 로컬 개체를 만든 다음이 IP 태그를 사용 하 여 IP 구성을 만듭니다.
...
### VirtualMachineScaleSetIpTag를 통해 계산 합니다.
