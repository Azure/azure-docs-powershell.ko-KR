...
이 명령은 리소스 그룹 "rg"의 VMSS "vmss1"의 자동 복구 서비스를 일시 중단 합니다.
...
이 명령은 리소스 그룹 "rg"에서 VMSS "vmss1"의 자동 복구 서비스를 다시 시작 합니다.

## 변수

### -작업
수행할 작업입니다.  사용할 수 있는 값은: Resume, Suspend입니다.
