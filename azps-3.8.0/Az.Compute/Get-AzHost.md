...
## 설명은
이 cmdlet은 호스트 그룹의 호스트를 가져옵니다.
이 cmdlet은 호스트 이름이 지정 되지 않은 경우 호스트 그룹의 모든 호스트도 나열 합니다.
...
이 명령은 지정 된 호스트 그룹의 모든 호스트를 반환 합니다.
...
### -InstanceView
이 cmdlet이 호스트의 인스턴스 보기만을 가져옵니다.
