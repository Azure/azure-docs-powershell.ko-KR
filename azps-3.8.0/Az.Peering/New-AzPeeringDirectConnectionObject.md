...
피어 링 서비스를 사용할 수 있는 직접적인 피어 링 연결 및 Microsoft 제공 IP 주소를 만듭니다.
...
피어 링 서비스를 사용 하 여 직접 피어 링 연결 만들기 및 피어 제공 IP 주소
...
Bgp 세션 IP 주소 없이 직접 피어 링 연결을 만듭니다. 피어는 bgp 세션을 구성할 수 있으려면 먼저 IP 주소를 설정 해야 합니다.

## 변수

### -BandwidthInMbps
이 위치에서 제공 되는 대역폭 (Mbps 단위)입니다.
...
Microsoft에 BGP 세션 주소를 제공 하도록 알리는 플래그를 사용 하도록 설정 합니다.
...
### -PeeringDBFacilityId
에서 찾은 피어 링 기능 Id https://peeringdb.com
...
MPS (Microsoft 피어 링 서비스)에 사용할 수 있도록 설정 합니다.
