...
## 설명은
**AzPolicyRemediation** cmdlet은 진행 중인 정책 수정을 취소 합니다. 활성 배포가 취소 되 고 새 배포가 생성 되지 않습니다.

## 예제의

### 예제 1: 리소스 그룹 범위에서 정책 업데이트 취소
```
PS C:\> Stop-AzPolicyRemediation -ResourceGroupName "myRG" -Name "remediation1"
```

이 명령은 리소스 그룹 ' myRG '의 ' remediation1 ' 재구성을 취소 합니다.

### 예제 2: 파이핑을 통해 관리 그룹 재구성 취소
```
PS C:\> $remediation = Get-AzPolicyRemediation -ManagementGroupName "mg1" -Name "remediation1"
PS C:\> $remediation | Stop-AzPolicyRemediation
```

이 명령은 관리 그룹 ' mg1 '에 ' remediation1 ' 인 재구성을 취소 합니다.
