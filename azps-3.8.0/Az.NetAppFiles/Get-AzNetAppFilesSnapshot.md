...
## 설명은
**Get-AzNetAppFilesSnapshot** cmdlet은 anf 스냅숏의 세부 정보를 가져옵니다.
...
이 명령은 "MyAnfVolume" 볼륨에서 MyAnfSnapshot 라는 스냅샷을 가져옵니다.
