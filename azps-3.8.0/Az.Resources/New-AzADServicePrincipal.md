...
"ServicePrincipalName" 및 암호 "StrongPassworld!23"을 사용하여 새 애플리케이션을 만들고 방금 만든 애플리케이션을 기반으로 서비스 주체를 만듭니다. 시작 날짜 및 종료 날짜가 암호 자격 증명에 추가됩니다.
...
이름이 "ServicePrincipalName"인 새 애플리케이션을 만들고 "$cert"를 인증하고 방금 만든 애플리케이션을 기반으로 서비스 주체를 만듭니다. 종료 날짜가 키 자격 증명에 추가됩니다.
