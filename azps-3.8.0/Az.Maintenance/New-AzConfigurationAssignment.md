...
Didicated host에 대 한 유지 관리 구성을 등록 합니다.
...
구성 할당 이름은 MaintenanceConfigurationName와 일치 해야 합니다.
...
정규화 된 MaintenanceConfiguration.
...
### Microsoft. Azure. PSConfigurationAssignment
