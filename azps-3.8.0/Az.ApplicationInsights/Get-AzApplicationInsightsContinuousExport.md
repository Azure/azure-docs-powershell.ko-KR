...
### 예제 1 application insights 리소스에 대 한 연속 내보내기 가져오기
```
...
리소스 그룹 "testgroup"에서 "test" 라는 리소스에 대 한 application insights 연속 내보내기 구성을 가져옵니다.

### 예제 2 application insights 리소스의 연속 내보내기를 가져옵니다.
```
...
리소스 그룹 "testgroup"에서 "test" 리소스에 대 한 내보내기 id가 "ZJrfffySPdtG3ESn3iRxVIEFuNY =" 인 application insights 연속 내보내기 구성을 가져옵니다.
