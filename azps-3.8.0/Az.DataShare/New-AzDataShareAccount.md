...
## 설명은
**AzDataShareAccount** cmdlet은 지정 된 Azure 리소스 그룹에 datashare account를 만듭니다.
...
"WikiADS" 라는 계정을 "ADS" 리소스 그룹에 만듭니다.
...
### -ResourceGroupName
Azure data share 계정에 대 한 리소스 그룹 이름이에 생성 됩니다.
...
### 태그
Azure data share 계정과 연결할 태그입니다.
