...
## 설명은
**AzDataShareDataSetMapping** cmdlet은 공유 구독의 원본 데이터 집합 및 싱크 저장소 계정 간에 데이터 집합 매핑을 만듭니다.
...
이 명령은 데이터 공유 계정 WikiAdsAccount에서 구독 공유 AdsShareSubscription 저장소 계정 AdsStorage에 대 한 AdsDataSetMapping 데이터 집합 매핑을 만듭니다.
