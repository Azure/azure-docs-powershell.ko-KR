...
## 설명은
**AzStackEdgeDevice** cmdlet은 사용 가능한 스택 경계 장치에 대 한 정보를 가져옵니다. 리소스 그룹 이름과 함께 디바이스의 이름을 지정 하 여 특정 장치에 대 한 정보를 가져올 수 있습니다. 
...
### -ExtendedInfo
지정 된 스택 경계 또는 스택 게이트웨이 장치에 대 한 추가 정보를 가져옵니다.
...
### -NetworkSetting
지정 된 스택 경계 또는 스택 게이트웨이 장치의 네트워크 설정을 가져옵니다.
