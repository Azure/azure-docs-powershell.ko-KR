...
## 설명은
**AzCosmosDBCassandraTable** cmdlet은 새를 만들거나 기존 CosmosDB Cassandra Keyspace를 업데이트 합니다.
...
{{Get-AzCosmosDBCassandraTable는 기존 CassandraKeyspace의 속성을 가져옵니다. 리소스를 확장 하 여 DefaultTtl, Schema, _etag, _ts _rid 속성을 가져올 수 있습니다.}}
...
### -세부 정보
그런 다음 cmdlet은 해당 처리 값이 지정 된 Cassandra 테이블을 반환 합니다.
