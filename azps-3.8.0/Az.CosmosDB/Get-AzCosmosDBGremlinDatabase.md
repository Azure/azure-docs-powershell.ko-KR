...
## SYNOPSIS
CosmosDB Gremlin 데이터베이스를 가져옵니다.
...
## 설명은
**Get-AzCosmosDBGremlinDatabase** Cmdlet은 CosmosDB Gremlin 데이터베이스를 가져옵니다.
...
리소스 개체에 _rid, _ts _etag 포함 되어 있습니다.
...
### -세부 정보
그런 다음 cmdlet은 해당 처리 값을 사용 하 여 데이터베이스를 반환 합니다.
