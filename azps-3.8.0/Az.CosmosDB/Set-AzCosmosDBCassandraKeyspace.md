...
## SYNOPSIS
CosmosDB Cassandra Keyspace를 설정 합니다.
...
## 설명은
**Set-AzCosmosDBCassandraKeyspace** Cmdlet은 CosmosDB Cassandra Keyspace를 설정 합니다.
...
Resource 개체에는 _rid, _ts _etag 속성 값이 포함 됩니다.
