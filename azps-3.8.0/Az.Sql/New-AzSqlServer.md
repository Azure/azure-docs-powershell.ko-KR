...
## 설명은
**새 AzSqlServer** Cmdlet은 Azure SQL 데이터베이스 서버를 만듭니다.
...
### -PublicNetworkAccess
설정/해제 플래그를 사용 하 여 서버에 대 한 공용 네트워크 액세스 허용 여부를 지정 합니다.
이 기능을 사용 하지 않도록 설정 하면 비공개 링크를 통해 생성 된 연결만이 서버에 도달할 수 있습니다.
