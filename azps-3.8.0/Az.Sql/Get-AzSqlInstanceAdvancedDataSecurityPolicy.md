...
## 설명은
**AzSqlInstanceAdvancedDataSecurityPolicy** cmdlet은 관리 되는 인스턴스의 고급 데이터 보안 정책을 검색 합니다.

## 예제의

### 예제 1-관리 되는 인스턴스를 가져옵니다. 고급 데이터 보안
```powershell
...
### 예제 2-관리 되는 인스턴스 리소스의 관리 되는 인스턴스 고급 데이터 보안을 가져옵니다.
```powershell
