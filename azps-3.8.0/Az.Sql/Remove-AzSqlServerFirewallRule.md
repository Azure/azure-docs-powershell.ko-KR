...
## 설명은
**AzSqlServerFirewallRule** cmdlet은 지정 된 Azure SQL 데이터베이스 서버에서 방화벽 규칙을 삭제 합니다.
...
이 명령은 Server01 이라는 서버에서 Rule01 이라는 방화벽 규칙을 삭제 합니다.
...
### -FirewallRuleName
이 cmdlet이 삭제 하는 방화벽 규칙의 이름을 지정 합니다.
