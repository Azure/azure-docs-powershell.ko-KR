...
## 설명은
특정 Azure SQL Server DNS 별칭을 가져오거나 서버에 대 한 모든 서버 DNS 별칭을 나열 합니다.
...
특정 서버에 대 한 모든 서버 DNS 별칭을 나열 합니다.
...
서버 및 별칭 이름으로 지정 된 서버 DNS 별칭을 가져옵니다.
...
"Dnsaliasname"로 시작 하는 특정 서버에 대 한 모든 서버 DNS 별칭을 나열 합니다.
