...
## 설명은
**업데이트 AzFrontDoorWafPolicy** cmdlet은 기존 waf 정책을 업데이트 합니다. 입력 매개 변수를 제공 하지 않으면 기존 WAF 정책의 이전 매개 변수가 사용 됩니다.
...
기존 WAF 정책 사용자 지정 상태 코드를 업데이트 합니다.
...
기존 WAF 정책 사용 상태 및 모드를 업데이트 합니다.
...
$resourceGroupName의 모든 WAF 정책 업데이트
...
[새로운 AzFrontDoorWafPolicy](./New-AzFrontDoorWafPolicy.md) 
 ...
 [새로운 AzFrontDoorWafCustomRuleObject](./New-AzFrontDoorWafManagedRuleObject.md)
