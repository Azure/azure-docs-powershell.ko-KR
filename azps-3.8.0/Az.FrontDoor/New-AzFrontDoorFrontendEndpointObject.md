...
전방 도어 만들기에 대 한 PSFrontendEndpoint 개체를 만듭니다.
...
### -CertificateType
frontendEndpoint에 대 한 보안 연결에 사용 되는 인증서의 유형입니다.
...
해당 되는 경우 세션 선호도에 대 한 시간 (초)을 사용 하는 TTL입니다. 기본값은 0입니다.
...
### -WebApplicationFirewallPolicyLink
각 호스트에 대 한 웹 응용 프로그램 방화벽 정책의 리소스 id (해당 하는 경우)
