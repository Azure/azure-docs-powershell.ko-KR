...
## 설명은
**Get-AzLogicApp** cmdlet은 논리 앱을 가져옵니다.
...
이 명령은 ResourceGroup11 이라는 리소스 그룹에서 논리 앱을 가져옵니다.
...
### -이름
이 cmdlet이 가져오는 논리 앱의 이름을 지정 합니다.
...
### -ResourceGroupName
이 cmdlet이 논리 앱을 가져오는 리소스 그룹의 이름을 지정 합니다.
...
### Microsoft. Azure. WorkflowVersion
