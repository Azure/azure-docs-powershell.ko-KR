...
### ByIntegrationAccountAndParameters (기본값)
```
...
## 설명은
**Set-AzIntegrationAccountBatchConfiguration** cmdlet은 통합 계정 일괄 처리 구성을 수정 합니다.

## 예제의

### 예제 1: 로컬 파일을 사용 하 여 일괄 처리 구성 수정
```powershell
...
"$BatchConfigurationFilePath"에 포함 된 파일 경로에 있는 로컬 파일을 사용 하 여 "sampleBatchConfig" 이라는 일괄 처리 구성을 수정 합니다.

### 예제 2: JSON 문자열을 사용 하 여 일괄 처리 구성 수정
```powershell
...
"$BatchConfigurationContent"에 포함 된 JSON 문자열을 사용 하 여 "sampleBatchConfig" 이라는 일괄 처리 구성을 수정 합니다.

### 예제 3: 매개 변수를 사용 하 여 일괄 처리 구성 수정
```powershell
...
필요한 모든 매개 변수를 수동으로 제공 하 여 "sampleBatchConfig" 이라는 일괄 처리 구성을 수정 합니다.

## 변수

### -BatchConfigurationDefinition
통합 계정 일괄 처리 구성 정의입니다.
...
### LogicApp. PSIntegrationAccountBatchConfiguration/.
