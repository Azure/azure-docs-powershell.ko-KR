...
## 설명은
**Get-AzIntegrationAccountSchema** cmdlet은 통합 계정 스키마를 가져옵니다.
통합 계정 이름, 리소스 그룹 이름 및 스키마 이름 지정
...
이 명령은 IntegrationAccountSchema43 이라는 통합 계정 스키마를 가져옵니다.

### 예제 2: 리소스 그룹에 대 한 통합 계정 스키마 가져오기
```
...
이 명령은 ResourceGroup11 이라는 리소스 그룹에 대 한 통합 계정 스키마를 가져옵니다.
