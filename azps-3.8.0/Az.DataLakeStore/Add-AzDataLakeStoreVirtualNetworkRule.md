...
## 설명은
**추가-AzDataLakeStoreVirtualNetworkRule** cmdlet은 지정 된 Data Lake store 계정에 가상 네트워크 규칙을 추가 합니다.
...
이렇게 하면 "testId" 계정 "dl"에 "myVNET" 이라는 새 가상 네트워크 규칙이 만들어집니다.

## 변수

### -계정
가상 네트워크 규칙을 추가할 Data Lake Store 계정
