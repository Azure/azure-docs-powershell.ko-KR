...
## 설명은
**Set-AzNotificationHub** cmdlet은 알림 허브의 속성 값을 수정 합니다.
...
JSON 파일은 다음과 같은 구문을 사용 하는 텍스트 파일입니다.  
    ...
    "위치": "서쪽 미국",  
} **AzNotificationHub** cmdlet과 함께 사용 하는 경우 앞의 JSON 샘플에서는 ContosoNotificationHub 이라는 알림 허브의 위치 값을 서쪽 미국으로 설정 합니다.
