...
구독의 모든 Azure IoT Hub 디바이스 프로비저닝 서비스를 나열 합니다.
...
리소스 그룹 ' myresourcegroup '의 모든 Azure IoT Hub 디바이스 프로비저닝 서비스를 나열 합니다.
...
Azure IoT Hub device 프로비저닝 서비스 ' myiotdps '의 세부 정보를 표시 합니다.
