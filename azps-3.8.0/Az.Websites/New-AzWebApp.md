...
### -AppServicePlan
App Service 계획 이름 또는 앱 서비스 계획 Id입니다. Web app 및 App Service 계획이 서로 다른 리소스 그룹에 있는 경우 이름 대신 ID를 사용 합니다. 앱 서비스 계획 Id는: $asp = Get-AzAppServicePlan-ResourceGroup myRG-Name MyWebapp $asp를 사용 하 여 검색할 수 있습니다. Id는 앱 서비스 계획 Id를 반환 합니다.
...
### -GitRepositoryPath
배포할 웹 응용 프로그램이 포함 된 GitHub 리포지토리의 경로입니다.
