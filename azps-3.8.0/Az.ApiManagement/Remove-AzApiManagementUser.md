...
## 설명은
**제거-AzApiManagementUser** cmdlet은 기존 사용자를 삭제 합니다.
...
이 매개 변수를 지정 하지 않고 구독이 있으면이 cmdlet은 예외를 발생 시킵니다.
이 매개 변수는 선택 사항입니다.
...
### -PassThru
이 cmdlet이 $Ture 값을 반환 하거나, 성공할 경우, $False의 값이 반환 됨을 나타냅니다.
