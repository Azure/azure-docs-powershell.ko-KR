...
**AzAzureRmApiManagementApiVersionSet** cmdlet은 기존 API 버전 집합을 제거 합니다.
...
이 명령은 지정 된 ApiVersionSetId를 사용 하 여 API 버전 집합을 제거 합니다.
...
### -ResourceId
ApiVersionSet의 Arm ResourceId입니다. 이 매개 변수는 필수입니다.
