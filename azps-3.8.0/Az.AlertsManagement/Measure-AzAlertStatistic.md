...
## 설명은
**AzAlertStatistic cmdlet은** 알림 요약 세부 정보를 가져옵니다.
...
활성 상태별로 필터링 된 경고 수를 심각도 및 상태별로 그룹화 하 여 요약 합니다.
...
### -CustomTimeRange
지원 되는 형식- \< 시작 시간 \> / \< 종료 시간이 \> ISO-8601 형식으로 되어 있습니다.
...
### AlertsManagement 모델. PSAlertsSummary.
