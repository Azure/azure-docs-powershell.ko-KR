...
## 설명은
AzHDInsightMonitoring cmdlet을 **사용** 하면 Azure HDInsight 클러스터에서 모니터링할 수 있습니다.
...
HDInsight 클러스터에서 모니터링을 사용할 수 있으며, 관련 로그가 id 1d364e89-bb71-4503-aa3d-a23535aea7bd를 사용 하 여 모니터링 작업 영역으로 전송 됩니다.
