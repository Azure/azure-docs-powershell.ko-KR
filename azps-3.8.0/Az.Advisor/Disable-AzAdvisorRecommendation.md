...
## SYNOPSIS
Azure Advisor 추천을 사용 하지 않도록 설정 합니다.
...
## 설명은
추천 단어에 대 한 억제를 만들어 특정 기간이 나 무한정으로 특정 권장 사항을 연기 하도록 할 수 있습니다.
...
지정 된 권고안 이름에 대 한 SuppressionName 및 default 일을-1로 사용 하 여 비 표시를 만듭니다.
...
지정 된 권고안 Id에 대 한 비 표시 (제거)가 생성 됩니다.
...
Get-AzAdvisorRecommendation에서 AzAdvisorRecommendation를 사용 하지 않도록 설정 하 여 비 표시 금지, 파이핑을 만듭니다.
...
### -InputObject
Get-AzAdvisorRecommendation 호출에서 반환 된 powershell 개체 유형 PsAzureAdvisorResourceRecommendationBase.
...
### PsAzureAdvisorResourceRecommendationBase를 통한 명령입니다.

## 출력

### PsAzureAdvisorSuppressionContract를 통한 명령입니다.
