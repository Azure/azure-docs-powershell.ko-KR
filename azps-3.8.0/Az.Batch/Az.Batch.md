...
# Az.Batch 모듈
## 설명은
Azure 모듈의 Azure Batch cmdlet을 사용 하 여 Azure PowerShell에서 Microsoft Azure 일괄 처리 서비스를 관리할 수 있습니다.
...
### [새로운 AzBatchCertificate](New-AzBatchCertificate.md)
...
### [새로운 AzBatchResourceFile](New-AzBatchResourceFile.md)
...
### [제거-AzBatchComputeNode](Remove-AzBatchComputeNode.md)
풀에서 계산 노드를 제거 합니다.
...
### [제거-AzBatchNodeFile](Remove-AzBatchNodeFile.md)
...
### [시작-AzBatchComputeNodeServiceLogUpload](Start-AzBatchComputeNodeServiceLogUpload.md)
Azure 저장소 컨테이너에 계산 노드 서비스 로그 파일을 업로드 합니다.

### [시작-AzBatchPoolResize](Start-AzBatchPoolResize.md)
풀의 크기를 조정 하기 시작 합니다.

### [중지-AzBatchCertificateDeletion](Stop-AzBatchCertificateDeletion.md)
실패 한 인증서 삭제를 취소 합니다.
...
### [테스트-AzBatchAutoScale](Test-AzBatchAutoScale.md)
