...
처음 세 명령은 *VaultName, Name* 및 ContentType 매개 변수에 사용할 문자열 *변수를 정의합니다.*  네 번째 명령은 Get-AzKeyVaultKey cmdlet을 사용하여 지정된 키를 얻습니다. 키를 Update-AzKeyVaultSecret cmdlet에 파이프하여 해당 콘텐츠 형식을 XML로 설정합니다.
