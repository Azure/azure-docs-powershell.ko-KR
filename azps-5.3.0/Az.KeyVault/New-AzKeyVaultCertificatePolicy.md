...
메모리 내 인증서 정책 개체를 만듭니다. (자동Generated)
...
### -DnsName
인증서의 DNS 이름을 지정합니다. 주체 대체 이름(SANS)을 DNS 이름으로 지정할 수 있습니다.
...
### -EmailAtNumberOfDaysBeforeExpiry
자동 알림 프로세스가 만료되기 전의 일 수를 지정합니다.
...
> [!NOTE]
> 매개 변수의 속성 내에 콤마(,) 또는 마침표(.)를 사용하려면 속성 필드를 인용 부호로 `SubjectName` 묶아야 합니다. 예를 들어 O="Contoso, Ltd"를 사용할 수 있습니다. 를 입력합니다.
