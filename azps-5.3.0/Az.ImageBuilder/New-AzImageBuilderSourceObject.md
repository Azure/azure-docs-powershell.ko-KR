...
### -ImageId
ARM 구독에서 관리되는 이미지의 리소스 ID를 만듭니다.
...
### -ImageVersionId
ARM 이미지 버전의 리소스 ID를 공유 이미지 갤러리에 만듭니다.
...
### -Offer
Azure 갤러리 [이미지의 이미지 제품](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
### -Publisher
Azure 갤러리 이미지의 이미지 [게시자](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
### -Sku
Azure 갤러리 이미지의 [이미지 SKU입니다.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
Azure 갤러리 이미지의 [이미지 원본을 설명합니다.](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
...
### -Version
Azure 갤러리 [이미지의 이미지 버전](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachineimages)
