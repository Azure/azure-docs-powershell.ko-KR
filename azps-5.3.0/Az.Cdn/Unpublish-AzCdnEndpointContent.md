...
## 설명
**Unpublish-AzCdnEndpointContent** cmdlet은 Azure CDN(Content Delivery Network) 엔드포인트에서 콘텐츠를 제거합니다.
...
### -EndpointName
이 cmdlet에서 제거한 엔드포인트의 이름을 지정합니다.
...
### -PurgeContent
이 cmdlet이 제거한 원본 서버의 콘텐츠에 대한 상대 경로 배열을 지정합니다.
