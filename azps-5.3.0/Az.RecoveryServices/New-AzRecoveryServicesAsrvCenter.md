...
## 설명
**New-AzRecoveryServicesAsrvCenter** cmdlet은 보호 가능한 항목을 검색하는 vCenter 서버를 추가합니다. 이 cmdlet은 구성 서버에 검색을 위해 vCenter 서버를 등록합니다.
...
보호 가능한 항목을 검색하는 vCenter 서버를 추가합니다. (자동Generated)
