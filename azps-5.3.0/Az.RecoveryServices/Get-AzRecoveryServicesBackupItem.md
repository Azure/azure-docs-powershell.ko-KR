...
두 번째 명령은 V2VM이라는 Backup 항목을 $Container V2VM을 $BackupItem 변수에 저장합니다.
...
FriendlyName 매개 변수를 사용하면 Azure 파일 공유가 두 개 이상 반환될 수 있습니다. 이러한 경우 -Name 매개 변수에 대한 값을 이름 매개 변수의 결과 집합에 반환된 Name 속성으로 전달하여 cmdlet을 $BackupItem.
