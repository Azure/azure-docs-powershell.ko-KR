...
## 설명
보호된 항목이 다시 동시화 필요한 상태인 경우 **Start-AzRecoveryServicesAsrResynchronizeReplicationJob** cmdlet은 지정된 보호된 항목에 대한 복제 다시동기화를 시작 합니다.
...
전달된 복제 보호된 항목에 대한 복제를 다시동기화하는 작업을 시작합니다.
...
복제를 다시동기화하기 위해 ASR 복제 보호된 항목입니다.
