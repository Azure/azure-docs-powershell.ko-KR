...
## 설명
**Remove-AzRecoveryServicesAsrvCenter** cmdlet은 ASR 패브릭에서 vCenter 서버를 제거하고 vCenter 서버에서 가상 머신의 검색을 중지합니다.
...
ASR 패브릭에서 vCenter 서버를 제거합니다.

### 예제 2

ASR 패브릭에서 vCenter 서버를 제거하고 vCenter 서버에서 가상 머신의 검색을 중지합니다. (자동Generated)
...
### -InputObject
제거할 vCenter 서버를 나타내는 ASR vCenter 개체입니다.
...
### -ResourceId
제거할 vCenter의 resourceId를 지정합니다.
