...
## 설명
**Get-AzRecoveryServicesAsrProtectionContainerMapping** cmdlet은 지정된 ASR 보호 컨테이너에 대한 자격 증명 모음의 복제 정책 매핑(연결)에 대한 보호 컨테이너에 대한 정보를 얻습니다.
...
지정된 보호 컨테이너에 대한 모든 보호 컨테이너 매핑을 얻습니다.
...
### -ProtectionContainer
지정된 ASR 보호 컨테이너 개체에 해당하는 보호 컨테이너 매핑을 얻습니다.
