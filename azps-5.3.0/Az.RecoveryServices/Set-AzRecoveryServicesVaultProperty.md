...
## 설명
**Set-AzRecoveryServicesVaultProperty** cmdlet은 Recovery Services 자격 증명 모음의 속성을 업데이트합니다. 이 cmdlet은 두 개의 다른 매개 변수 집합이 있는 자격 증명 모음에 대해 소프트 삭제를 활성화/비활성화하거나 CMK 암호화를 설정하는 데 사용할 수 있습니다. 
