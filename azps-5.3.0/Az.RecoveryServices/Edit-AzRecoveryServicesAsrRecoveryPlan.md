...
## 설명
**Edit-AzRecoveryServicesAsrRecoveryPlan** cmdlet은 Azure Site Recovery 계획을 편집합니다.
...
기존 Azure Site Recovery 계획에 그룹을 추가하고 메모리 내 업데이트된 복구 계획을 반환합니다. 

### 예제 2

Site Recovery 계획을 편집합니다. (자동Generated)
...
### -AddProtectedItem
복구 계획 개체의 복구 계획 그룹에 추가할 ASR 복제 보호 항목 목록입니다.
...
### -AppendGroup
매개 변수를 전환하여 복구 계획 그룹에 복구 계획 개체를 추가합니다.
...
### -InputObject
편집할 ASR 복구 계획 개체(메모리 작업에서). 복구 계획을 업데이트하려면 편집된 Update-AzASRRecoveryPlan 개체를 사용하여 복구 계획을 실행합니다.)
...
### -RemoveProtectedItem
복구 계획 개체의 복구 계획 그룹에서 제거할 ASR 복제 보호 항목 목록입니다.
