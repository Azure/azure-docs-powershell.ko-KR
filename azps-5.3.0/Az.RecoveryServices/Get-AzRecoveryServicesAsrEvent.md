...
## 설명
**Get-AzRecoveryServicesAsrEvent는** 지정된 선택 필터에 따라 자격 증명 모음의 이벤트 목록을 얻습니다.
...
시간 시작 시간과 종료 시간, 심각도 중요 및 상태 유형 VmHealth 사이의 이벤트 목록입니다.

## PARAMETERS

### -AffectedObjectFriendlyName
검색에 대한 AffectedObject FriendlyName을 지정합니다.
