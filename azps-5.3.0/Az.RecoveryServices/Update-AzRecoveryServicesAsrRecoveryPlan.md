...
## 설명
**Update-AzRecoveryServicesAsrRecoveryPlan** cmdlet은 지정된 ASR 복구 계획 개체 또는 ASR 복구 계획 정의 json 파일의 내용을 사용하여 복구 계획의 콘텐츠를 업데이트합니다.
...
### -InputObject
cmdlet에 대한 입력 개체: ASR 복구 계획 개체를 지정합니다. 이 개체에서 참조하는 복구 계획을 업데이트하는 데 사용되는 콘텐츠입니다.
