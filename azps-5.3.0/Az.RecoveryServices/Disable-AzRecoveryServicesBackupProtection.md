...
## 설명
**Disable-AzRecoveryServicesBackupProtection** cmdlet은 Azure Backup 보호 항목에 대한 보호를 사용하지 않도록 설정합니다.
...
마지막 명령은 $PI 0의 항목에 대한 Backup 보호를 사용하지 않도록 설정하지만 데이터는 \[ \] 보존합니다.

### 예제 2

Backup으로 보호된 항목에 대한 보호를 사용하지 않도록 설정합니다. (자동Generated)
