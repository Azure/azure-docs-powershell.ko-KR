...
## 설명
이 New-AzRecoveryServicesAsrProtectionContainer cmdlet은 지정된 Azure Site Recovery Fabric 아래에 보호 컨테이너를 만듭니다.
...
지정된 매개 변수를 사용하여 보호 컨테이너 만들기를 시작하고 작업을 추적하는 데 사용되는 ASR 작업을 반환합니다.
...
### -InputObject
지정된 입력 개체(Azure Fabric)에 복제 보호 컨테이너를 만듭니다.
