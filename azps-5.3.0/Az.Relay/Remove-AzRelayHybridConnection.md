...
## 설명
**Remove-AzRelayHybridConnection** cmdlet은 지정된 Relay 네임스페이스에서 HybridConnection을 제거합니다.
...
네임스페이스에서 HybridConnection을 `TestHybridConnection` `TestNameSpace-Relay1` 제거합니다.
