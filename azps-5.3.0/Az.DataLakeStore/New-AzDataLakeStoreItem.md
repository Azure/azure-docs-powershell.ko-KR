...
## 설명
**New-AzDataLakeStoreItem** cmdlet은 Data Lake Store에 새 파일 또는 폴더를 만듭니다.
...
첫 번째 명령은 지정된 계정에 NewFile.txt 파일을 만듭니다.
...
### -Force
이 작업이 이미 있는 경우 대상 항목을 덮어써도 됐습니다.
...
### -Path
루트 디렉터리(/)로 시작하여 만들 항목의 Data Lake Store 경로를 지정합니다.
