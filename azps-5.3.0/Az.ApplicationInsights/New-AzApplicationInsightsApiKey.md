...
### 예제 1 Application Insights 리소스에 대한 새 API 키 만들기
```
...
리소스 그룹 "testGroup"에서 리소스 "test"에 대한 "ReadTelemetry", "WriteAnnotations" 권한이 있는 "testapiKey"로 Application Insights API 키 설명을 생성합니다.
