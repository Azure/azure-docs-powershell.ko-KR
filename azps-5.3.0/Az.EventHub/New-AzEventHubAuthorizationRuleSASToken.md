...
## SYNOPSIS
네임스페이스/eventhub의 Azure eventhub 권한 부여 규칙에 대한 SAS 토큰을 생성합니다. 
...
## 설명
이 New-AzEventHubAuthorizationRuleSASToken cmdlet은 Azure Eventhub 네임스페이스 또는 Azure Eventhub에 대한 SAS(공유 액세스 서명) 토큰을 생성합니다.
