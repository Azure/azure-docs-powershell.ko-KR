...
이 명령은 ContosoResourceGroup에서 ContosoRollout이라는 롤아웃을 얻습니다. -Verbose 스위치는 모든 롤아웃 세부 정보를 계층적으로 표시됩니다. 서비스, ServiceUnits 및 각 ServiceUnit의 단계 및 롤아웃의 전체적인 보기에 대한 각 단계에 대한 상황별 정보를 보여 줄 수 있습니다.
