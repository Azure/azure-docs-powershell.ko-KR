...
이 명령은 구독에서 모든 Windows IoT 서비스를 얻습니다.
...
이 명령은 리소스 그룹에서 모든 Windows IoT 서비스를 얻습니다.
...
이 명령은 개체로 Windows IoT 서비스를 얻습니다.

### 예제 4: 파이프라인으로 Windows IoT 서비스 다운로드
```powershell
