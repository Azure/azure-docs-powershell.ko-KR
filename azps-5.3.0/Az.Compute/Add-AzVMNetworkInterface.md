...
가상 머신을 만들 때 인터페이스를 추가하거나 기존 가상 머신에 추가할 수 있습니다.
...
두 번째 명령은 네트워크 인터페이스를 네트워크 인터페이스에 저장된 가상 머신에 $VirtualMachine.
...
### -Primary
이 cmdlet이 네트워크 인터페이스를 기본 인터페이스로 추가하는지 나타냅니다.
...
기존 가상 머신을 얻습니다. **Get-AzVM** cmdlet을 사용하세요.
