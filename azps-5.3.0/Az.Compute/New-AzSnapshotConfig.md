...
## 설명
**New-AzSnapshotConfig** cmdlet은 구성 가능한 스냅숏 개체를 만듭니다.
...
첫 번째 명령은 저장소 계정 유형에서 크기가 5GB인 Standard_LRS 만듭니다.  또한 Windows OS 유형을 설정하고 암호화 설정을 사용할 수 있습니다.
두 번째 및 세 번째 명령은 스냅숏 개체에 대한 디스크 암호화 키 및 키 암호화 키 설정을 지정합니다.
마지막 명령은 스냅숏 개체를 만들고 리소스 그룹 'ResourceGroup01'에서 'Snapshot01'으로 스냅숏을 만듭니다.

### 예제 2

구성 가능한 스냅숏 개체를 만듭니다. (자동Generated)
...
### -증분
증분 스냅숏을 지정합니다. 동일한 디스크의 증분 스냅숏은 전체 스냅숏보다 공간을 적게 차지하고 확산될 수 있습니다.
