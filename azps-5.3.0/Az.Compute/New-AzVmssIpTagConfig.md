...
## 설명
**New-AzVmssIpTagConfig** cmdlet은 VMSS(Virtual Machine Scale Set)의 네트워크 인터페이스에 대한 IP 태그 구성 개체를 만듭니다.
이 cmdlet의 구성을 New-AzVmssIpConfig cmdlet의 *IPTag* 매개 변수로 지정합니다.
...
이 명령은 'FirstPartyUsage' 형식 및 'Sql' 태그를 사용하여 IP 태그 로컬 개체를 만든 다음, 이 IP 태그를 사용하여 IP 구성을 만듭니다.
