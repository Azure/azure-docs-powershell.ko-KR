...
## 설명
**Get-AzAvailabilitySet** cmdlet은 리소스 그룹에서 Azure 가용성 집합을 얻습니다.
얻을 특정 가용성 집합의 이름을 지정할 수 있습니다.
...
이 명령은 ResourceGroup11이라는 리소스 그룹에서 AvailabilitySet03이라는 가용성 집합을 얻습니다.
...
이 명령은 ResourceGroup11이라는 리소스 그룹의 모든 가용성 집합을 얻습니다.

### 예제 3: 필터링을 사용하여 모든 가용성 집합을 얻게
```
...
이 명령은 "AvailabilitySet0"으로 시작하는 ResourceGroup11이라는 리소스 그룹의 모든 가용성 집합을 얻습니다.

### 예제 4: AvailabilitySet0으로 시작하는 이름으로 모든 가용성 집합을 얻게 됩니다.
```
...
이 명령은 "AvailabilitySet0"으로 시작하는 모든 가용성 집합을 얻습니다.
