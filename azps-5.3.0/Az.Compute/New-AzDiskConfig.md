...
### -DiskIOPSReadOnly
공유 디스크를 ReadOnly로 탑재하는 모든 VM에서 허용되는 총 IOPS 수입니다. 하나의 작업은 4k에서 256k bytes 사이를 전송할 수 있습니다.
...
### -DiskIOPSReadWrite
이 디스크에 허용되는 IOPS 수입니다. UltraSSD 디스크에만 설정할 수 있습니다. 하나의 작업은 4k에서 256k bytes 사이를 전송할 수 있습니다.
...
GalleryImageReference 개체입니다.  갤러리 이미지에서 만드는 경우 필수입니다. ID는 디스크를 ARM 공유 galley 이미지 버전의 id입니다.
...
두 개 이상의 값은 여러 VM에 동시에 탑재할 수 있는 디스크를 나타냅니다.
