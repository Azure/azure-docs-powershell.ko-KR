...
## 설명
**Stop-AzVM** cmdlet은 Azure 가상 머신을 중지합니다.
...
이 명령은 ResourceGroup11에서 VirtualMachine07이라는 가상 머신을 중지합니다.
...
### -SkipShutdown
VM을 프로비전된 유지 시 비보상 VM 종료를 요청합니다.
...
### -StayProvisioned
cmdlet은 VMSS 내의 모든 가상 머신을 중지하지만 해당 가상 머신의 재배포는 중지하지 않습니다. 계정에 중지된 가상 머신에 대한 요금이 청구됩니다.
