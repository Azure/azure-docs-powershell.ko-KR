...
## 설명
**Remove-AzVMCustomScriptExtension** cmdlet은 가상 머신에서 사용자 지정 스크립트 Virtual Machine 확장을 제거합니다.

## 예제

### 예제 1

가상 머신에서 사용자 지정 스크립트 확장을 제거합니다. (자동Generated)
...
### -Name
이 cmdlet에서 제거하는 사용자 지정 스크립트 확장의 이름을 지정합니다.
...
### -VMName
이 cmdlet이 사용자 지정 스크립트 확장을 제거하는 가상 머신의 이름을 지정합니다.
