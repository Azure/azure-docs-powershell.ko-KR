...
# Az.Compute 모듈
## 설명
이 항목에서는 Azure Compute Cmdlet에 대한 도움말 항목을 제공합니다.
...
가상 머신에서 서버 SQL 자격 증명 모음 자격 증명에 대한 구성 개체를 만듭니다.
...
VMSS 또는 VMSS 내의 가상 머신을 다시 시작합니다.
...
디스크 개체에 대한 디스크 암호화 키 속성을 설정합니다.
...
모든 가상 머신 확장 집합 인스턴스를 사용 가능한 최신 플랫폼 이미지 OS 버전으로 이동하는 롤링 업그레이드를 시작합니다.
