...
리소스 그룹 'rgname'에서 'vmssname'의 가상 머신 확장 집합에 있는 'sample.ps1' 및 ID '0' VM의 매개 변수를 정의하여 RunPowerShellScript의 실행 명령을 호출합니다.
...
### -ScriptPath
실행할 스크립트의 경로입니다.  이 값을 지정하면 제공된 스크립트가 명령의 기본 스크립트를 다시 지정합니다.
...
PS Virtual Machine Scale Set VM 개체입니다.
