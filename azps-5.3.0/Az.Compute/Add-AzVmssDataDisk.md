...
### -DiskIOPSReadWrite
관리 디스크에 Read-Write IOPS를 지정합니다. StorageAccountType이 UltraSSD_LRS. 지정하지 않으면 diskSizeGB에 따라 기본값이 할당됩니다.
...
### -DiskMBpsReadWrite
관리 디스크의 대역폭을 초당 MB로 지정합니다. StorageAccountType이 UltraSSD_LRS. 지정하지 않으면 diskSizeGB에 따라 기본값이 할당됩니다.
