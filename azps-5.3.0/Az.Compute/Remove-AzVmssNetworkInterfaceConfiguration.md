...
## 설명
**Remove-AzVmssNetworkInterfaceConfiguration** cmdlet은 VMSS(Virtual Machine Scale Set)에서 네트워크 인터페이스 구성을 제거합니다.
...
첫 번째 명령은 Get-AzVmss cmdlet을 사용하여 VMSS를 $VMSS 변수에 저장합니다.
두 번째 명령은 ContosoVmssInterface02라는 이름의 네트워크 인터페이스 구성을 $VMSS.
...
### -Id
이 cmdlet이 제거하는 네트워크 인터페이스 구성의 ID를 지정합니다.
...
### -Name
이 cmdlet이 제거하는 네트워크 인터페이스 구성의 이름을 지정합니다.
