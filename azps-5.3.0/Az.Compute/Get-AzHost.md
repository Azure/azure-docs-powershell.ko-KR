...
## 설명
이 cmdlet은 호스트 그룹에 호스트를 얻습니다.
또한 이 cmdlet은 호스트 이름이 지정되지 않은 경우 호스트 그룹의 모든 호스트를 나열합니다.
...
이 명령은 주어진 호스트 그룹의 모든 호스트를 반환합니다.
...
### -InstanceView
이 cmdlet이 호스트의 인스턴스 보기만 얻게 된다고 나타냅니다.
