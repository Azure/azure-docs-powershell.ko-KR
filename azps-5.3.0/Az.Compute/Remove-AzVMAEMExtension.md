...
## 설명
**Remove-AzVMAEMExtension** cmdlet은 가상 머신에서 AEM(Azure 고급 모니터링) 확장을 제거합니다.
...
이 명령은 contoso-server라는 가상 머신에 대한 AEM 확장을 제거합니다.
...
### -Name
이 cmdlet이 AEM 확장을 제거하는 가상 머신의 이름을 지정합니다.
...
이 cmdlet은 해당 가상 머신에서 AEM 확장을 제거합니다.
...
### -VMName
가상 머신의 이름을 지정합니다.
이 cmdlet은 이 매개 변수가 지정하는 가상 머신에 대한 AEM 확장을 제거합니다.
