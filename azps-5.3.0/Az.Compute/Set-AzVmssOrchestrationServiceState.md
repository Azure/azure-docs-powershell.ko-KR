...
이 명령은 리소스 그룹 "rg"의 VMSS "vmss1"에서 자동 복구 서비스를 일시 중단합니다.
...
이 명령은 리소스 그룹 "rg"의 VMSS "vmss1"에서 자동 복구 서비스를 다시 시작됩니다.

## PARAMETERS

### -Action
수행할 작업입니다.  가능한 값은 Resume, Suspend입니다.
