...
이 명령은 지정된 환경의 모든 참조 데이터 집합을 나열합니다.

### 예제 2: 이름에 따라 지정된 참조 데이터 집합을 얻게 됩니다.
```powershell
...
이 명령은 지정된 참조 데이터 집합을 얻습니다.

### 예제 3: 개체에 의해 지정된 참조 데이터 집합을 얻게 됩니다.
```powershell
...
### -Name
지정된 환경과 연결된 Time Series Insights 참조 데이터 집합의 이름입니다.
