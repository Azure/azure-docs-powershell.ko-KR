...
## 설명
리소스에 대한 보안 평가 결과를 만들거나 업데이트하거나 기존 결과의 상태를 변경하거나 추가 데이터를 추가하는 데 사용할 수 있습니다.
"고객 관리" 평가 유형에만 사용할 수 있으며 일치하는 평가 메타데이터를 만든 후에만 사용할 수 있습니다.
...
"4FB6C0A0-1137-42C7-A1C7-4BD37C91DE8D" 형식의 평가에 대한 구독 결과를 "Unhealthy"로 표시 - 평가 유형에 대한 자세한 내용은 assessmentMetadata 형식에서 찾을 수 있습니다.

## PARAMETERS

### -AdditionalData
더 나은 조사 또는 상태 명확성을 위해 평가 결과에 연결된 데이터입니다.
...
### -StatusCode
평가 결과에 대한 예시 코드입니다.
"정상", "정상" 또는 "NotApplicable"일 수 있습니다.
...
### -StatusDescription
평가 결과의 원인에 대한 사람이 읽을 수 있는 설명입니다.
