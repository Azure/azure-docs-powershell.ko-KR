...
## 설명
이 Get-AzIotSecurityAnalyticsAggregatedAlert cmdlet은 iot Hub의 디바이스에서 하나 이상의 집계된 경고를 반환합니다.
집계된 경고의 이름은 경고 유형과 경고가 집계된 날짜를 '/'로 구분한 조합입니다.
...
솔루션 "mySolution" 및 리소스 그룹 "myResourceGroup"에서 집계된 경고 "IoT_Bruteforce_Fail/2019-02-02"(경고 유형 및 집계 날짜에서 결합된 이름)를 얻음
...
솔루션 "MySolution" 및 리소스 그룹 "MyResourceGroup"에서 집계된 모든 경고 목록을 얻습니다.
