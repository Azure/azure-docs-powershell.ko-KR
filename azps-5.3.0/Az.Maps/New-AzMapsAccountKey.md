...
## 설명
이 New-AzMapsAccountKey cmdlet은 Azure Maps 계정에 대한 API 키를 다시 생성합니다.
...
리소스 그룹 MyResourceGroup에서 MyAccount 계정에 대한 기본 API 키를 다시 생성합니다.
...
지정된 Azure Maps 계정에 대한 보조 API 키를 다시 생성합니다.
