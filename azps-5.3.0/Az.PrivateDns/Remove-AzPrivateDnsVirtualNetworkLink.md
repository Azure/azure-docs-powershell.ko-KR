...
이 명령은 MyResourceGroup이라는 리소스 그룹에서 myzone.com 연결된 mylink 링크를 제거합니다.
...
또는 파이프라인 또는 Link 매개 변수를 통해 전달된 **PSPrivateDnsVirtualNetworkLink** 개체를 사용하여 DNS 영역이 지정될 *수* 있습니다.
