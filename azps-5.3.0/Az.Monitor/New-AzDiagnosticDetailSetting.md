...
## 설명
PSMetricSettings 또는 PSLogSettings 개체를 만듭니다. .를 사용하여 범주를 얻을 수 `Get-AzDiagnosticSettingCategory` 있습니다.
