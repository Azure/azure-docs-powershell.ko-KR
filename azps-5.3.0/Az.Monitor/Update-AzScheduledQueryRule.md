...
## 설명
로그 경고 규칙을 업데이트하고 이 명령에서 "Enabled" 속성만 업데이트할 수 있습니다.
다른 속성을 업데이트하기 위해 [Set-AzScheduledQueryRule 명령을 참조합니다.](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule)
