...
## 설명
PSServiceDiagnosticSettings 개체를 만듭니다.
이 매개 변수로 사용할 수 `-InputObject` 있습니다. `Set-AzDiagnosticSetting`
...
PSServiceDiagnosticSettings 개체를 만듭니다. 대상 리소스에 대한 진단 설정을 만들 수 있습니다.

## PARAMETERS

### -DedicatedLogAnalyticsDestinationType
ODS로 내보낼지(있는 경우) 또는 AzureDiagnostics(기본값, 존재하지 않는 경우)로 내보낼지 여부를 나타내는 값입니다.
