...
Front Door를 만들기 위한 PSFrontendEndpoint 개체를 만듭니다.
...
### -CertificateType
frontendEndpoint에 대한 보안 연결에 사용되는 인증서의 형식
...
해당하는 경우 세션에 대한 효율성에 사용할 TTL(초)입니다. 기본값은 0입니다.
...
### -WebApplicationFirewallPolicyLink
각 호스트에 대한 웹 애플리케이션 방화벽 정책의 리소스 ID(해당하는 경우)
