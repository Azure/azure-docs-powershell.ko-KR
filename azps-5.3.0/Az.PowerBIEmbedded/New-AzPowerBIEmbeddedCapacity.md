...
## 설명
이 New-AzPowerBIEmbeddedCapacity 새 PowerBI Embedded Capacity를 만듭니다.
...
미국 중서부 Azure 지역 및 리소스 그룹 testRG에서 testcapacity라는 용량을 만듭니다. 용량에 대한 SKU 수준은 A1입니다.

## PARAMETERS

### -Administrator
용량에 관리자로 설정할 콤마로 구분된 이름
...
### -Location
PowerBI Embedded Capacity가 호스트되는 Azure 지역
