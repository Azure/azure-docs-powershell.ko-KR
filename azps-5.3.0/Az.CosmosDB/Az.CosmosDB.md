...
# Az.CosmosDB 모듈
## 설명
이 섹션의 항목에서는 Azure Resource Manager(ARM) 프레임워크의 Azure CosmosDB용 Azure PowerShell cmdlet을 설명합니다. cmdlet은 Microsoft.Azure.Commands.CosmosDB 네임스페이스에 있습니다.
...
주어진 CosmosDB 계정에 대한 키({"ConnectionKeys", "PrimaryReadOnly" 또는 "Keys"}의 값)를 얻습니다. 
...
기존 CosmosDB Sql 컨테이너를 얻습니다.

### [Get-AzCosmosDBSqlContainerThroughput](Get-AzCosmosDBSqlContainerThroughput.md)
기존 CosmosDB Sql 컨테이너에 대한 ThroughputSettingsResource를 얻습니다.
...
기존 CosmosDB Sql Database에 대한 ThroughputSettingsResource를 얻습니다.
...
CosmosDB Cassandra Keyspace를 삭제합니다.
...
CosmosDB Gremlin 데이터베이스를 삭제합니다.
