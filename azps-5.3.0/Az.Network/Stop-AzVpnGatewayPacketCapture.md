...
## 설명
Vpn Gateway에서 패킷 캡처 작업을 중지하고 저장소 컨테이너의 주어진 SasUrl에 결과를 업로드합니다.
...
### -ResourceId
패킷 캡처를 시작할 VpnGateway의 Azure 리소스 ID입니다.
