...
첫 번째 명령은 리소스 그룹 ResourceGroup001에 속하는 Gateway01이라는 가상 네트워크 게이트웨이를 사용하여 저장합니다$Gateway 두 번째 명령은 AAD 인증 구성 params:aadTenantUri, aadAudienceId, VpnClient용 aadIssuerUri로 가상 네트워크 게이트웨이 Gateway01을 업데이트합니다.
