...
## 설명
**Set-AzFirewallPolicyRuleCollectionGroup** cmdlet은 Azure Firewall 정책에서 규칙 컬렉션 그룹을 업데이트합니다.
...
이 예제에서는 방화벽 정책에서 규칙 컬렉션 그룹을 업데이트합니다$fp

### 예제 2

수정된 Azure 방화벽 정책 규칙 컬렉션 그룹을 저장합니다. (자동Generated)
