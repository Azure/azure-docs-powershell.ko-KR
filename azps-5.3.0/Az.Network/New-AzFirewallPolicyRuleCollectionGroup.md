...
## 설명
**New-AzFirewallPolicyRuleCollectionGroup** cmdlet은 Azure Firewall 정책에서 규칙 컬렉션 그룹을 만듭니다.
...
이 예제에서는 방화벽 정책 그룹에 규칙 컬렉션 그룹을 $fp

### 예제 2

새 Azure Firewall 정책 규칙 컬렉션 그룹을 만들 수 있습니다. (자동Generated)
