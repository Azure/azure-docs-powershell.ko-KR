...
### 예제 1: Application Gateway PrivateLink 구성 제거
```
...
두 번째 명령은 $AppGw.에 저장된 애플리케이션 게이트웨이에서 privateLinkConfig01이라는 privateLink 구성을 $AppGw.
...
### -Name
Application Gateway privateLink 구성의 이름
