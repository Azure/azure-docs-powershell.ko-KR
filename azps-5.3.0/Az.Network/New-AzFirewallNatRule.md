...
## 설명
**New-AzFirewallNatRule** cmdlet은 Azure Firewall에 대한 NAT 규칙을 만듭니다.

## 예제

### 예제 1: 10.0.0.0/24에서 대상 10.1.2.3:80에서 대상 10.4.5.6:8080까지의 모든 TCP 트래픽을 DNAT에 규칙 만들기
```powershell
...
### -Protocol
이 규칙에 따라 필터링할 트래픽 유형을 지정합니다.
지원되는 프로토콜은 TCP 및 UDP입니다.
특수 값 "Any"는 허용됩니다. 즉, TCP와 UDP는 일치하지만 다른 프로토콜은 일치하지 않습니다.
