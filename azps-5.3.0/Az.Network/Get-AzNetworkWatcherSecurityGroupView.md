...
## 설명
이 Get-AzNetworkWatcherSecurityGroupView VM에 적용된 구성되고 효과적인 네트워크 보안 그룹 규칙을 볼 수 있습니다.

## 예제

### 예제 1: VM에서 보안 그룹 보기 호출 만들기
```
...
위의 예제에서는 먼저 지역 Network Watcher를, 해당 지역의 VM을 얻습니다. 그런 다음 지정된 VM에서 보안 그룹 보기를 호출합니다.
