...
## 설명
**Get-AzExpressRouteCrossConnectionARPTable** cmdlet은 ExpressRoute 교차 연결의 두 인터페이스에서 ARP 테이블을 검색합니다. ARP 테이블은 특정 피어링에 대한 MAC 주소에 대한 IPv4 주소 매핑을 제공 합니다. ARP 테이블을 사용하여 계층 2 구성 및 연결의 유효성을 검사할 수 있습니다.
