...
## 설명
**Get-AzPrivateLinkResource** cmdlet은 PrivateLinkResource에 속하는 모든 링크 리소스를 검색합니다.
...
이 예제에서는 mySql이라는 sql Server에 대한 모든 개인 링크 리소스 nbelong을 나열합니다.
...
개인 링크 리소스의 Azure 리소스 관리자 ID입니다.
