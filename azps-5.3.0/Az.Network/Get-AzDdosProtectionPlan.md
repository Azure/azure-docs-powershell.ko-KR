...
## 설명
Get-AzDdosProtectionPlan cmdlet은 DDoS 보호 계획을 얻습니다.

## 예제

### 예제 1: 특정 DDoS 보호 계획 얻기
```
...
이 경우 리소스 그룹 및 DDoS 보호 계획의 이름에 해당하는 **ResourceGroupName** 및 **Name** 특성을 모두 지정해야 합니다.

### 예제 2: 리소스 그룹의 모든 DDoS 보호 계획 얻기
```
...
이 시나리오에서는 **ResourceGroupName** 매개 변수만 지정하여 DDoS 보호 계획 목록을 얻습니다.

### 예제 3: 구독에서 모든 DDoS 보호 계획 확인
```
...
여기서는 구독의 모든 DDoS 보호 계획 목록을 표시하는 매개 변수를 지정하지 않습니다.

### 예제 4: 구독의 모든 DDoS 보호 계획 확인
```
...
이 cmdlet은 "test"로 시작하는 모든 DdosProtectionPlans를 반환합니다.
