...
## 설명
**Add-AzLoadBalancerOutboundRuleConfig** cmdlet은 Azure Load Balancer에 아웃바운드 규칙 구성을 추가합니다.

## 예제

### 예제 1: 부하 균형 조정에 아웃바운드 규칙 구성 추가
```powershell
...
두 번째 명령은 파이프라인 연산자를 사용하여 부하 분산 $slb **Add-AzLoadBalancerOutboundRuleConfig에** 전달합니다. 이 명령은 부하 분산에 아웃바운드 규칙 구성을 추가합니다.
