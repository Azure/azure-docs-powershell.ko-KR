...
## 설명
Test-AzNetworkWatcherConnectivity cmdlet은 지정된 원본 VM 및 대상에 대한 연결 정보를 반환합니다. 원본과 대상 간의 연결을 설정할 수 없는 경우 cmdlet은 문제의 세부 정보를 반환합니다.

## 예제

### 예제 1: VM에서 웹 사이트로 Network Watcher 연결 테스트
```powershell
...
이 예제에서는 Azure의 VM에서 VM으로의 연결을 www.bing.com.

### 예제 2

지정된 원본 VM 및 대상에 대한 연결 정보를 반환합니다. (자동Generated)
