...
## 설명
**Set-AzPublicIpPrefix** cmdlet은 네트워크 프로필을 업데이트합니다.
...
첫 번째 명령은 기존 네트워크 프로필을 얻습니다. 두 번째 명령은 태그를 업데이트하고 세 번째 명령은 네트워크 프로필에 네트워크 인터페이스 구성을 추가합니다. 네 번째 명령은 네트워크 프로필을 업데이트합니다.
