...
## 설명
**Get-AzVirtualWanVpnServerConfiguration** cmdlet은 이 VirtualWan과 연결된 모든 VpnServerConfigurations 목록을 반환합니다. 즉, 이 VirtualWan의 VirutalHubs 아래에 있는 모든 P2SVpnGateways에 연결된 모든 VpnServerConfigurations입니다.
