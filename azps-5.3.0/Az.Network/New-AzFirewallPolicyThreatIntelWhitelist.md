...
## 설명
**New-AzFirewallPolicyThreatIntelWhitelist** cmdlet은 Azure Firewall 정책을 만들거나 설정할 때 사용할 수 있는 위협 Intel 허용 목록 개체를 만듭니다.
...
이 예제에서는 하나의 항목의 FQDN 화이트리스트와 두 개의 항목으로 된 Ip 주소 화이트리스트를 포함하는 위협 Intel 화이트리스트를 만듭니다.
