...
## 설명
**Add-AzApplicationGatewayFrontendPort** cmdlet은 애플리케이션 게이트웨이에 프런트 엔드 포트를 추가합니다.
...
두 번째 명령은 포트 80을 게이트웨이에 저장된 애플리케이션 게이트웨이의 프런트 엔드 포트로 $AppGw FrontEndPort01의 이름을 추가합니다.

## PARAMETERS

### -ApplicationGateway
이 cmdlet이 프런트 엔드 포트를 추가할 애플리케이션 게이트웨이를 지정합니다.
