...
## 설명
**AzApplicationGatewayRewriteRuleCondition cmdlet은** Azure 애플리케이션 게이트웨이에 대한 다시 작성 규칙 조건을 만듭니다.
...
```
이 명령은 다시 작성 규칙에 조건을 만들고 결과를 $condition.
