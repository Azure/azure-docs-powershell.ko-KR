...
New-AzExpressRouteGateway ExpressRoute 게이트웨이를 만듭니다. VirtualHub 내에서 Azure에 대한 프레미스에 대한 소프트웨어 정의 연결입니다. 

이 게이트웨이는 이 또는 이 cmdlet에 지정된 배율 단위에 따라 Set-AzExpressRouteGateway 수 있습니다. 
...
위의 리소스 그룹인 Virtual WAN, Virtual Network, Azure의 "testRG" 리소스 그룹에 미국 서부의 Virtual Hub가 생성됩니다. ExpressRoute 게이트웨이는 2개 배율 단위가 있는 가상 허브에서 이후에 만들어집니다.
...
### -MaxScaleUnits
이 ExpressRouteGateway의 최대 배율 단위 수입니다. 유효한 범위 > 2
