...
## 설명
**Remove-AzLoadBalancerOutboundRuleConfig** cmdlet은 Azure Load Balancer에서 아웃바운드 규칙 구성을 제거합니다.

## 예제

### 예제 1: Azure Load Balancer에서 아웃바운드 규칙 삭제
```powershell
...
첫 번째 명령은 제거하려는 아웃바운드 규칙 구성과 연결된 부하 $slb 변수에 저장합니다.
두 번째 명령은 부하 균형 조정기에서 연결된 아웃바운드 규칙 구성을 제거합니다.
세 번째 명령은 부하 균형 조정을 업데이트합니다.
