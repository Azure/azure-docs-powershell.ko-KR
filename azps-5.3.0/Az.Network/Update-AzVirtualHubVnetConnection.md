...
위의 리소스 그룹인 Virtual WAN, Virtual Network, Azure의 해당 리소스 그룹에 미국 중부의 Virtual Hub가 생성됩니다. Virtual Network를 가상 허브에 피어링하는 Virtual Network 연결도 만들어집니다. 그런 다음 이 Virtual Network 연결이 인터넷 보안을 사용하도록 업데이트됩니다.
