...
## 설명
**Set-AzApplicationGatewayRequestRoutingRule** cmdlet은 리디렉션 구성을 수정합니다.
...
두 번째 명령은 Application Gateway에 대한 리디렉션 구성을 수정하여 영구 형식을 리디렉션하고 대상 URL을 사용합니다.

### 예제 2

기존 Application Gateway에서 리디렉션 구성을 설정합니다. (자동Generated)
