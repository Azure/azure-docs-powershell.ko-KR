...
## SYNOPSIS
VirtualHub와 연결된 허브 경로 테이블 리소스를 삭제합니다.
...
## 설명
제공된 경로 또는 레이블을 통해 지정된 가상 허브와 연결된 지정된 경로 테이블을 업데이트합니다.
...
### -ResourceId
업데이트할 vhubroutetable 리소스의 리소스 ID입니다.
