...
## 설명
**New-AzLoadBalancerInboundNatRuleConfig** cmdlet은 Azure Load Balancer에 대한 인바운드 NAT(네트워크 주소 변환) 규칙 구성을 만듭니다.

## 예제

### 예제 1: 부하 균형 조정에 대한 인바운드 NAT 규칙 구성 만들기
```
...
세 번째 명령은 명령의 프런트 엔드 개체를 사용하여 MyInboundNatRule이라는 인바운드 NAT 규칙 구성을 $frontend.
