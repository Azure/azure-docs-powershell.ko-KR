...
## 설명
**Update-AzVpnSite** cmdlet은 VPN 사이트를 업데이트합니다.
...
사이트가 만들어지면 Set-AzVpnSite 명령을 사용하여 사이트의 IpAddress를 업데이트합니다.

## PARAMETERS

### -AddressSpace
가상 네트워크의 주소입니다.
이 또는 AddressSpaceObject를 사용하지만 둘 다 사용할 수 없습니다.
