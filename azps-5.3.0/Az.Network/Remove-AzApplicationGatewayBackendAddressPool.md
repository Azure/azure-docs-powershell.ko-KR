...
## 설명
**Remove-AzApplicationGatewayBackendAddressPool** cmdlet은 Azure 애플리케이션 게이트웨이에서 백 엔드 주소 풀을 제거합니다.

## 예제

### 예제 1: 애플리케이션 게이트웨이에서 백 엔드 주소 풀 제거
```
...
두 번째 명령은 애플리케이션 게이트웨이에서 BackEndPool02라는 백 엔드 주소 풀을 제거합니다.

## PARAMETERS

### -ApplicationGateway
이 cmdlet이 백 엔드 주소 풀을 제거하는 애플리케이션 게이트웨이를 지정합니다.
...
### -Name
이 cmdlet에서 제거하는 백 엔드 주소 풀의 이름을 지정합니다.
