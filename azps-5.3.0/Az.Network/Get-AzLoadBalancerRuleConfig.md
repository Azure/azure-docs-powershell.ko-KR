...
## 설명
**Get-AzLoadBalancerRuleConfig** cmdlet은 부하 분산에 대한 하나 이상의 규칙 구성을 얻습니다.

## 예제

### 예제 1: 부하 균형 조정의 규칙 구성을 얻게 됩니다.
```
...
두 번째 명령은 MyLBrulename이라는 연결된 규칙 구성을 $slb.
...
### -LoadBalancer
얻을 규칙 구성과 연결된 부하 균형 조정기를 지정합니다.
