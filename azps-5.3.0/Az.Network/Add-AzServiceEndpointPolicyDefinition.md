...
이 명령은 ServiceEndpointPolicyDefinition1, service Microsoft.Storage, 서비스 리소스 구독/sub1 및 ResourceGroup01이라는 리소스 그룹에 속하는 설명 "새 정의"를 사용하여 서비스 엔드포인트 정책 정의를 업데이트하고 $policydef 변수에 저장합니다.
