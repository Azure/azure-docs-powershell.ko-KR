...
## 설명
**Remove-AzHDInsightClusterAutoscaleConfiguration** cmdlet은 HDInsight 클러스터의 자동 크기 조정 구성을 제거합니다.

## 예제

### 예제 1: HDInsight 클러스터의 자동 조정 구성을 제거합니다.
```powershell
...
이 명령은 HDInsight 클러스터의 자동 조정 구성을 제거합니다.
