...
## 설명
**New-AzHDInsightSqoopJobDefinition** cmdlet은 Azure HDInsight 클러스터와 함께 사용할 Sqoop 작업 개체를 정의합니다.

## 예제

### 예제 1: Sqoop 작업 정의 만들기
```
PS C:\># Cluster info
...
클러스터와 연결된 Storage 계정에서 파일을 사용할 수 있어야 합니다.
