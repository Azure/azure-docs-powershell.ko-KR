...
## 설명
Add-AzHDInsightComponentVersion cmdlet은 클러스터에서 실행되는 서비스에 대한 버전을 New-AzHDInsightClusterConfig cmdlet에서 만든 Azure HDInsight 구성 개체에 추가합니다.

## 예제

### 예제 1: 클러스터 구성 개체에 Spark에 대한 버전을 추가합니다.
```
...
이 명령은 'your-spark-001'이라는 HDInsight 클러스터에 Spark 버전을 추가합니다.
