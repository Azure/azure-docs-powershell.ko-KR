...
## 설명
**Set-AzHDInsightClusterSize** cmdlet은 지정된 Azure HDInsight 클러스터의 Worker 노드 수를 설정합니다.

## 예제

### 예제 1: 지정된 클러스터의 크기 설정
```
PS C:\>Set-AzHDInsightClusterSize -ClusterName "your-hadoop-001" -TargetInstanceCount 6
```

이 명령은 your-hadoop-001이라는 클러스터의 크기를 설정합니다.
...
### -TargetInstanceCount
클러스터에서 원하는 수의 Worker 노드를 지정합니다.
