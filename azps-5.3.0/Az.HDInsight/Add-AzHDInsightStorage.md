...
## 설명
**Add-AzHDInsightStorage** cmdlet은 Azure Storage 계정 항목을 New-AzHDInsightClusterConfig cmdlet에서 만든 Azure HDInsight 구성 개체에 추가합니다.

## 예제

### 예제 1: 클러스터 구성 개체에 Azure 저장소 키 추가
```
...
이 명령은 hadoop-001이라는 HDInsight 구성에 Blob Storage 계정 항목을 추가합니다.
...
### -StorageAccountKey
새 클러스터에 추가할 저장소 계정에 대한 저장소 계정 키를 지정합니다.
...
### -StorageAccountName
클러스터에 추가할 저장소 계정의 저장소 계정 이름을 지정합니다.
