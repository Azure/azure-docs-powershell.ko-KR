...
## 설명
**New-AzHDInsightStreamingMapReduceJobDefinition** cmdlet은 Azure HDInsight 클러스터와 함께 사용할 스트리밍 MapReduce 작업 개체를 정의합니다.
...
### -CommandEnvironment
작업이 작업 노드에서 실행될 때 설정할 명령줄 환경 변수의 배열을 지정합니다.
