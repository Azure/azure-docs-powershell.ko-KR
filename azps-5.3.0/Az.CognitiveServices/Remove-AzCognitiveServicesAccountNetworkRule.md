...
## 설명
**Remove-AzCognitiveServicesAccountNetworkRule** cmdlet은 Cognitive Services 계정의 NetWorkRule 속성에서 IpRules 또는 VirtualNetworkRules를 제거합니다.
...
이 명령은 파이프라인이 있는 첫 번째 IpRule을 제거합니다.
...
Cognitive Services 계정 NetworkRule VirtualNetworkRules VirtualNetworkResourceId(문자열).
