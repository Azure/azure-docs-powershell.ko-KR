...
## 설명
**New-AzHpcCacheStorageTarget** cmdlet은 Azure HPC 캐시에 저장소 대상을 추가합니다.
...
### -Force
cmdlet이 확인 메시지를 표시하지 않는다는 의미입니다. 기본적으로 이 cmdlet은 캐시를 플러시할지 묻는 메시지를 제공합니다.
...
### -ResourceGroupName
"주어진 캐시에 대한 저장소 대상을 만들 리소스 그룹의 이름입니다.
