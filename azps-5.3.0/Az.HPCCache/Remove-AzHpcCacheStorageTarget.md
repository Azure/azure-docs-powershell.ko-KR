...
## 설명
**Remove-AzHpcCacheStorageTarget** cmdlet은 Azure HPC 캐시에서 저장소 대상을 제거합니다.
...
### -Force
cmdlet이 확인 메시지를 표시하지 않는다는 의미입니다. 기본적으로 이 cmdlet은 저장소 대상을 제거할지 묻는 메시지를 제공합니다.
...
### -ResourceGroupName
캐시에서 저장소 대상을 제거하려는 리소스 그룹의 이름입니다.
