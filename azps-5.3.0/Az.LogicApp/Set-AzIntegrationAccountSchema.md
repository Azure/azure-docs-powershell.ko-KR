...
## 설명
**Set-AzIntegrationAccountSchema** cmdlet은 통합 계정 스마마를 수정합니다.
이 cmdlet은 통합 계정 키마를 나타내는 개체를 반환합니다.
통합 계정 이름, 리소스 그룹 이름 및 스마마 이름을 지정합니다.
...
이 명령은 IntegrationAccountSchema43이라는 통합 계정 스마마를 수정합니다.
