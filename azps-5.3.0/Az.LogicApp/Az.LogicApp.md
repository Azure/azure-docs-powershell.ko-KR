...
# Az.LogicApp 모듈
## 설명
이 항목에서는 Logic Apps cmdlet에 대한 도움말 항목을 제공합니다.
...
이 cmdlet은 규약당 수신된 특정 교환 컨트롤 번호 및 컨트롤 번호 값을 검색합니다.
...
Azure 리소스 그룹에서 통합 계정이 받은 교환 제어 번호(ICN)를 업데이트합니다.
