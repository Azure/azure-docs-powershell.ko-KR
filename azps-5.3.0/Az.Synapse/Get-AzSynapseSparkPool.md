...
## 설명
**Get-AzSynapseSparkPool** cmdlet은 Azure Synapse Analytics Spark 풀에 대한 정보를 얻습니다.
...
이 명령은 작업 영역 아래에 있는 모든 Spark 풀을 얻습니다.
...
이 명령은 ContosoSparkPool 이름의 작업 영역 ContosoWorkspace에서 Spark 풀을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역의 모든 Spark 풀을 얻습니다.
...
이 명령은 지정된 리소스 ID를 사용하여 Spark 풀을 얻습니다.
