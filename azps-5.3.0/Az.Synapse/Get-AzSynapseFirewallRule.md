...
규칙 이름을 지정하지 않으면 이 cmdlet은 모든 규칙을 얻습니다.
...
이 명령은 ContosoFirewallRule 이름의 작업 영역 ContosoWorkspace에서 방화벽 규칙을 얻습니다.
...
이 명령은 파이프라인을 통해 작업 영역의 모든 방화벽 규칙을 얻습니다.
