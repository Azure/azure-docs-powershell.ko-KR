...
## 설명
**Stop-AzSynapseSparkJob** cmdlet은 Synapse Analytics Spark 작업을 취소합니다.
...
이 명령은 Synapse Analytics Spark 작업을 취소합니다.
...
이 명령은 파이프라인을 통해 Synapse Analytics Spark 작업을 취소합니다.
