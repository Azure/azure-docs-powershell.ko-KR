...
## 설명
**Remove-AzSynapseSqlActiveDirectoryAdministrator** cmdlet은 Azure Synapse Analytics 작업 영역의 Azure AD(Azure Active Directory) 관리자를 제거합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 Azure AD 관리자를 제거합니다.
