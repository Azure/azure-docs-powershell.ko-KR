...
## 설명
**Remove-AzSynapseWorkspace** cmdlet은 Azure Synapse Analytics 작업 영역이 영구적으로 삭제됩니다.
...
이 명령은 Azure Synapse Analytics 작업 영역이 삭제됩니다.
...
이 명령은 파이프라인을 통해 Azure Synapse Analytics 작업 영역이 삭제됩니다.
...
이 명령은 지정된 리소스 ID를 사용하여 파이프라인을 통해 Azure Synapse Analytics 작업 영역이 삭제됩니다.
