...
## 설명
**Set-AzSynapseSqlPoolTransparentDataEncryption** cmdlet은 Azure Synapse Analytics 풀의 TDE(투명한 데이터 암호화) 속성을 SQL 수정합니다.
...
이 명령은 ContosoWorkspace라는 작업 SQL ContosoSqlPool이라는 이름의 풀에 대해 TDE를 사용할 수 있습니다.
...
### -State
Azure Synapse 분석 Sql 풀 투명한 데이터 암호화 상태입니다.
