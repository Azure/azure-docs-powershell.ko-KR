...
## 설명
**Set-AzSynapseDataset** cmdlet은 데이터 세트를 생성하거나 작업 영역의 기존 데이터 세트를 업데이트합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 ContosoDataset이라는 데이터 세트를 만듭니다.
이 명령은 데이터 세트를 on 파일의 Dataset.js기반입니다.
