...
## 설명
**Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting** cmdlet은 Azure Synapse Analytics 풀에서 고급 위협 보호 설정을 SQL 설정합니다.
SQL 풀에서 고급 위협 방지를 사용하려면 해당 풀에서 감사 설정을 사용하도록 SQL 합니다.
...
이 명령은 ContosoWorkspace라는 작업 영역 아래에 contosoSqlPool이라는 SQL 풀에 대한 고급 위협 보호 설정을 지정합니다.
...
경고를 보낼 세미코론으로 구분된 전자 메일 주소 목록입니다.
