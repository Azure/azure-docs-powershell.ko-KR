...
## 설명
**Get-AzSynapseSqlActiveDirectoryAdministrator** cmdlet은 현재 구독에서 Azure Synapse 분석 작업 영역의 Azure AD(Azure Active Directory) 관리자에 대한 정보를 얻습니다.
...
이 명령은 ContosoWorkspace라는 작업 영역의 Azure AD 관리자에 대한 정보를 얻습니다.
