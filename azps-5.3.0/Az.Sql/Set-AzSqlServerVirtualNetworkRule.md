...
## 설명
이 명령은 Azure SQL Server Virtual Network 규칙의 구성을 수정합니다.
서버의 가상 네트워크 규칙 집합을 제어하려면 'Add-AzSqlServerVirtualNetworkRule' 및 'Remove-AzSqlServerVirtualNetworkRule'을 대신 사용합니다.
...
새 가상 네트워크에 대한 정보가 포함된 새 가상 네트워크 서브넷 ID로 기존 가상 네트워크 규칙을 수정합니다.
...
Azure Sql Server Virtual Network 규칙의 이름입니다.
...
규칙에 대한 Virtual Network 서브넷 ID입니다.
