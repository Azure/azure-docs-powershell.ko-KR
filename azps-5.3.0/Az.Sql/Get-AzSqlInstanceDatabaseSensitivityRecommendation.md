...
## 설명
이 Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet은 Azure SQL 관리되는 인스턴스 데이터베이스에서 권장되는 정보 유형 및 민감도 레이블을 반환합니다.

## 예제

### 예제 1: Azure SQL 관리되는 인스턴스 데이터베이스의 권장 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
...
### 예제 2: Piping을 사용하여 Azure SQL 관리되는 인스턴스 데이터베이스의 권장 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
