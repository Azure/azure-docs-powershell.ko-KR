...
## 설명
Set-AzSqlServerTransparentDataEncryptionProtector cmdlet은 SQL 서버에 대한 TDE 보호기 SQL 설정합니다.
TDE 보호기 유형을 변경하면 보호기 회전이 회전됩니다.
...
이 명령은 서버의 TDE 보호기 유형을 서비스 관리로 업데이트합니다.
...
이 명령은 서버 키 자격 증명 모음 키와 ID '를 TDE 보호기로 사용하여 https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 서버를 업데이트합니다.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Azure Sql Database TDE 보호기 유형입니다.
