...
## 설명
이 Get-AzSqlDatabaseSensitivityRecommendation cmdlet은 데이터베이스에 있는 열의 권장 정보 유형 및 민감도 레이블을 반환합니다.

## 예제

### 예제 1: Azure SQL 데이터베이스의 권장 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
...
### 예제 2: Piping을 사용하여 Azure SQL 데이터베이스의 권장 정보 유형 및 민감도 레이블을 얻습니다.
```powershell
