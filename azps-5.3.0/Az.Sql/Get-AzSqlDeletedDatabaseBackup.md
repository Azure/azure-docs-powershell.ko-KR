...
## 설명
**Get-AzSqlDeletedDatabaseBackup** cmdlet은 복원할 수 있는 지정된 삭제된 SQL 데이터베이스 백업 또는 복원할 수 있는 모든 삭제된 백업을 얻습니다.
...
이 명령은 ContosoDatabase에 대한 삭제된 데이터베이스 백업을 얻습니다.
...
### -DeletionDate
데이터베이스가 삭제된 날짜를 **DateTime** 개체로 지정합니다.
