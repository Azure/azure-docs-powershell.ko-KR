...
## 설명
**Disable-AzSqlServerActiveDirectoryOnlyAuthentication** cmdlet은 현재 구독에서 AzureSQL 서버에 대한 Azure AD(Azure Active Directory) 인증 요구 사항만 비활성화합니다.
...
이 명령은 ResourceGroup01이라는 리소스 그룹과 연결된 Server01이라는 AzureSQL 서버에 대한 Azure AD(Azure Active Directory) 인증 요구 사항만 비활성화합니다.
...
### -ServerName
Azure Active Directory SQL Server 있는 Azure 리소스의 이름입니다.
