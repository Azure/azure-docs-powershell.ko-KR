...
## 설명
이 Remove-AzSqlInstanceKeyVaultKey cmdlet은 지정된 Managed Instance에서 Key Vault 키를 제거합니다. 키의 SQL 관리되는 인스턴스의 사용 권한은 변경되지 않습니다. 사용 권한을 변경하려면 Set-AzKeyVaultAccessPolicy를 사용 합니다. 이 cmdlet은 Key Vault를 변경하지 않습니다. Key Vault에서 키를 제거하려면 Remove-AzureKeyVaultKey를 사용하세요.
