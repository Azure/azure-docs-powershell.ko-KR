...
## 설명
**Get-AzSqlInstancePoolUsage** cmdlet은 Azure SQL Instance 풀의 사용량에 대한 정보를 반환합니다.

## 예제

### 예제 1: Azure SQL Instance 풀의 사용량을 얻습니다.
```powershell
...
Azure SQL Instance pool instancepool0에 대한 사용량을 얻습니다.

### 예제 2: 인스턴스 풀 개체를 사용하여 Azure SQL Instance 풀의 사용량을 얻습니다.
```powershell
...
### 예제 3: 인스턴스 풀 리소스 ID를 사용하여 Azure SQL Instance 풀의 사용량을 얻습니다.
```powershell
...
### 예제 3: 풀 내에서 관리되는 인스턴스 사용량을 분석하여 Azure SQL Instance 풀의 사용량을 얻습니다.
```powershell
...
instancepool0 내에서 관리되는 인스턴스의 사용량과 함께 Azure SQL Instance pool instancepool0에 대한 사용량을 얻습니다.
...
### -ExpandChildren
자식 사용량을 통해 이 인스턴스 풀의 사용량을 확장할지 여부를 나타내는 플래그입니다.
