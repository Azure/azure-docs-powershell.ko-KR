...
특정 리소스에 대해 Azure AD 전용 인증을 SQL Server.
...
Azure SQL 탄력적 풀 Advisor에 대한 하나 이상의 권장 작업을 얻습니다.

### [Get-AzSqlInstance](Get-AzSqlInstance.md)
Managed Database 인스턴스에서 Azure SQL 정보를 반환합니다.
...
Azure 및 DNS 별칭을 SQL Server 나열합니다.
...
Azure SQL 장애 조치(failover) 그룹을 제거합니다.

### [Remove-AzSqlDatabaseFromFailoverGroup](Remove-AzSqlDatabaseFromFailoverGroup.md)
Azure SQL 데이터베이스 장애 조치 그룹에서 하나 이상의 데이터베이스를 제거합니다.
