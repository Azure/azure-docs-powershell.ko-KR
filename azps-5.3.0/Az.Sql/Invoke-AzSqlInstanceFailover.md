...
## 설명
**Invoke-AzSqlInstanceFailover** cmdlet은 Azure SQL Managed Instance를 장애 조치합니다.
...
이 명령은 "ManagedInstance01"이라는 인스턴스의 주 복제본을 장애 조치합니다.
...
이 명령은 관리되는 인스턴스 "ManagedInstance01"의 읽을 수 있는 보조 복제본을 장애 조치합니다.
