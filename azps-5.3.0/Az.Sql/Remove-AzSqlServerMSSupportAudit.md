...
## 설명
**Remove-AzSqlServerMSSupportAudit** cmdlet은 Azure SQL 서버의 Microsoft 지원 작업 감사 설정을 제거합니다.
cmdlet을 사용 설정하기 위해 *ResourceGroupName* 및 *ServerName* 매개 변수를 사용하여 서버를 식별합니다.

## 예제

### 예제 1: Azure SQL 서버의 Microsoft 지원 작업 감사 설정 제거
```powershell
PS C:\>Remove-AzSqlServerMSSupportAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
```

### 예제 2: 파이프라인을 통해 Microsoft에서 Azure SQL 서버의 감사 설정을 지원
```
