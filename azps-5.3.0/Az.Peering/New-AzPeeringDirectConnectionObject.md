...
피어링 서비스를 사용하도록 설정하고 Microsoft에서 제공한 IP 주소를 사용하여 직접 피어링 연결 만들기
...
피어링 서비스 사용 및 피어링 제공 IP 주소에 사용하는 직접 피어링 연결 만들기
...
bgp 세션 IP 주소 없이 직접 피어링 연결을 만들 수 있습니다. bgp 세션을 구성하기 전에 피어가 IP 주소를 설정해야 합니다.

## PARAMETERS

### -BandwidthInMbps
이 위치에서 제공되는 대역폭(Mbps)입니다.
...
Microsoft에 BGP 세션 주소를 제공하도록 지정하는 플래그를 사용하도록 설정합니다.
...
### -PeeringDBFacilityId
찾은 피어링 시설 ID https://peeringdb.com
...
Microsoft MPS(피어링 서비스)에서 사용할 수 있습니다.
...
### Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PSDectConnection
