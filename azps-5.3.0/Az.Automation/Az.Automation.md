...
# Az.Automation 모듈
## 설명
이 항목에서는 Azure Automation Cmdlet에 대한 도움말 항목을 설명합니다.
...
DSC 노드 또는 Hybrid Worker를 Automation에 등록하기 위한 등록 정보를 얻습니다.
...
Azure Automation 소프트웨어 업데이트 구성 목록을 얻습니다.
...
Azure Automation 원본 제어 목록을 얻습니다.
...
Azure 가상 머신을 Automation 계정에 대한 DSC 노드로 등록합니다.
...
Automation에서 Hybrid Worker 그룹을 제거합니다.
