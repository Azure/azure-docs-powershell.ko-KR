...
## 설명
**Unregister-AzAutomationScheduledRunbook** cmdlet은 Azure Automation Runbook과 일정 간의 연관을 제거합니다.
일정이 더 이상 Runbook을 시작하지 않습니다.

## 예제

### 예제 1: Runbook과 일정 간의 연결 제거
```
...
이 명령은 Runbk01이라는 Runbook과 Runbk01Sched라는 일정 간의 연결은 제거합니다.
...
### -RunbookName
이 cmdlet이 일정에서 해리하는 Runbook의 이름을 지정합니다.
...
### -ScheduleName
이 cmdlet이 Runbook을 해리하는 일정의 이름을 지정합니다.
