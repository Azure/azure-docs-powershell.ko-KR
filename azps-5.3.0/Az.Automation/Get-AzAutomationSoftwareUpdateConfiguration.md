...
## 설명
이 Get-AzAutomationSoftwareUpdateConfiguration 소프트웨어 업데이트 구성 목록을 반환합니다. 특정 소프트웨어 업데이트 구성을 얻습니다. 이름 매개 변수를 지정합니다. 이 가상 머신에 대한 Azure 리소스 ID를 지정하여 특정 Azure 가상 머신을 대상으로 하는 소프트웨어 업데이트 구성을 나열할 수도 있습니다.

## 예제

### 예제 1
이름으로 Azure Automation 소프트웨어 업데이트 구성을 얻습니다.
