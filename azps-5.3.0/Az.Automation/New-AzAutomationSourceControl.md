...
## 설명
이 New-AzAutomationSourceControl cmdlet은 내 VSTS TFVC, VSTS Git 또는 GitHub와 Azure Automation 계정을 연결하는 구성을 만듭니다.

## 예제

### 예제 1
내 AZURE Automation 계정을 내 VSTS TFVC 프로젝트와 연결하기 위한 소스 제어 구성을 생성합니다. TFVC 프로젝트에는 분기가 없습니다. 따라서 분기 매개 변수는 지정되지 않습니다.
...
### 예제 2
내 AZURE Automation 계정을 내 VSTS Git 프로젝트와 연결하기 위한 소스 제어 구성을 생성합니다.
...
### 예제 3
내 Azure Automation 계정을 GitHub 프로젝트와 연결하기 위한 소스 제어 구성을 생성합니다.
...
### -DoNotPublishRunbook
원본 제어의 publishRunbook 속성입니다.
DoNotPublishRunbook을 설정하면 사용자 Runbook을 '초안'으로 가져올 수 있습니다.
