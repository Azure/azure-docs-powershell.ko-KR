...
## 설명
**Get-AzAutomationModule** cmdlet은 Azure Automation에서 모듈에 대한 메타데이터를 얻습니다.
...
이 cmdlet이 모듈 메타데이터를 얻을 Automation 계정의 이름을 지정합니다.
...
### -Name
이 cmdlet이 메타데이터를 얻을 모듈의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 모듈 메타데이터를 얻을 리소스 그룹의 이름을 지정합니다.
