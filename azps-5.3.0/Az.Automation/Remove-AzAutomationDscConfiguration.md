...
## 설명
**Remove-AzAutomationDscConfiguration** cmdlet은 Azure Automation에서 APS DSC(Desired State Configuration) 구성을 제거합니다.

## 예제

### 예제 1

Automation에서 DSC 구성을 제거합니다. (자동Generated)
...
이 cmdlet에서 제거하는 DSC 구성을 포함하는 Automation 계정의 이름을 지정합니다.
...
### -Name
이 cmdlet에서 제거하는 DSC 구성의 이름을 지정합니다.
