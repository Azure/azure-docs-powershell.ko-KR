...
## 설명
**Get-AzAutomationWebhook** cmdlet은 웹후크를 얻습니다.
특정 웹후크를 얻습니다. 웹후크 이름을 지정하거나 Azure Automation Runbook의 이름을 지정하여 웹후크를 연결합니다.

## 예제

### 예제 1: Runbook에 대한 모든 웹후크를 얻습니다.
```
PS C:\>Get-AzAutomationWebhook -RunbookName "Runbook03" -ResourceGroup "ResourceGroup01" -AutomationAccountName "AutomationAccount01"
```

이 명령은 ResourceGroup01이라는 리소스 그룹의 AutomationAccount01 Automation 계정에서 Runbook03이라는 Runbook에 대한 모든 웹후크를 얻습니다.

## PARAMETERS

### -AutomationAccountName
이 cmdlet이 웹후크를 얻을 Automation 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 웹후크를 얻을 리소스 그룹의 이름을 지정합니다.
...
### -RunbookName
이 cmdlet이 웹후크를 얻을 Runbook의 이름을 지정합니다.
