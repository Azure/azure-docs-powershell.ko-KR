...
## 설명
**Remove-AzAutomationSchedule** cmdlet은 Azure Automation에서 일정을 삭제합니다.
...
이 명령은 리소스 그룹 ResourceGroup01의 Automation 계정 Contoso17에서 Schedule01이라는 일정을 삭제합니다.

## PARAMETERS

### -AutomationAccountName
이 cmdlet이 일정을 제거하는 Automation 계정의 이름을 지정합니다.
...
### -ResourceGroupName
이 cmdlet이 일정을 제거하는 리소스 그룹의 이름을 지정합니다.
