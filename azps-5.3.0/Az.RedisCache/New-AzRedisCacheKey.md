...
## 설명
**New-AzRedisCacheKey** cmdlet은 Azure Redis Cache의 액세스 키를 다시 생성합니다.
...
이 명령은 Redis Cache의 기본 키를 다시 생성합니다.
...
이 명령은 Redis Cache의 보조 키를 다시 생성합니다.
...
### -KeyType
기본 또는 보조 액세스 키를 다시 생성할지 여부를 지정합니다.
유효한 값은 기본, 보조입니다.
