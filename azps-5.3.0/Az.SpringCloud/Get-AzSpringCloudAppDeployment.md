...
### 예제 1: 이름에 따라 Spring Cloud App Deploymeng를 다운로드합니다.
```powershell
...
이름으로 Spring Cloud App Deploymeng를 다운로드합니다.

### 예제 2: 주어진 Spring 클라우드 앱 아래에 모든 배포를 나열합니다.
```powershell
...
지정한 Spring Cloud 앱 아래에 모든 배포를 나열합니다.
