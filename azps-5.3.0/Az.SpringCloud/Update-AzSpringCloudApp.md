...
### 예제 1: Spring Cloud App을 이름으로 업데이트합니다.
```powershell
...
Spring Cloud App을 이름으로 업데이트합니다.

### 예제 2: 파이프에서 Spring Cloud App 업데이트
```powershell
...
파이프에서 Spring Cloud App을 업데이트합니다.
