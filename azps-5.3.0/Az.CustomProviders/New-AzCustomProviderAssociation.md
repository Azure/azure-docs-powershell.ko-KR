...
사용자 지정 공급자 연결 만들기, "연결"에 대한 경로로 연결된 대상 provioder를 올바르게 구성해야 합니다.
...
예를 들어 가상 머신 리소스에 '/subscriptions/{subscription-id}/resourceGroups/{resource-group-name}/providers/Microsoft.Compute/virtualMachines/{vm-name}'을 사용할 수 있습니다.
...
### -TargetResourceId
이 연결에 대한 대상 리소스의 REST 리소스 인스턴스입니다.
