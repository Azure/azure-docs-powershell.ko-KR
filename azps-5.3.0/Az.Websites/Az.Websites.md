...
# Az.Websites 모듈
## 설명
ARM(Azure Resource Manager) 웹앱 및 App Service 계획 명령을 실행합니다.
...
지정된 사이트 또는 슬롯 및 지정된 리소스 그룹에 지정된 Windows 컨테이너에 원격 PowerShell 세션을 여는 경우
...
지정된 리소스 그룹에서 Azure Web Apps를 얻습니다.

### [Get-AzWebAppAccessRestrictionConfig](Get-AzWebAppAccessRestrictionConfig.md)
Azure Web App에 대한 Access Restiction 구성을 얻습니다.
