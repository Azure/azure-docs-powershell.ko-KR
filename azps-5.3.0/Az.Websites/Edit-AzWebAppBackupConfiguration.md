...
## 설명
**Edit-AzWebAppBackupConfiguration** cmdlet은 Azure 웹앱에 대한 현재 구성 백업을 편집합니다.

## 예제

### 예제 1

이 Edit-AzWebAppBackupConfiguration cmdlet은 Azure Web App에 대한 현재 구성 백업을 편집합니다. (자동Generated)
