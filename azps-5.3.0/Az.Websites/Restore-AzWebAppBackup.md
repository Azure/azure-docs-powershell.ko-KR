...
리소스 그룹인 ContosoWebApp에 있는 Blob "myBlob"의 Default-Web-WestUS 내에 있는 지정된 앱의 백업을 복원합니다. https://storageaccount.file.core.windows.net

### 예제 2

Restore-AzWebAppBackup cmdlet은 Azure Web App Backup을 복원합니다. (자동Generated)
