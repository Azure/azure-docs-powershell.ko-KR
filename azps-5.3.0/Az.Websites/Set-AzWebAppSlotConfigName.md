...
## 설명
**Set-AzWebAppSlotConfigName** cmdlet은 앱 설정 및 연결 문자열을 슬롯 설정으로 표시
...
이 명령은 리소스 그룹 Default-Web-WestUS와 연결된 웹앱 ContosoWebApp에 대한 모든 앱 설정 및 연결 문자열을 제거합니다.

### 예제 2

웹앱 슬롯 구성 이름을 설정합니다. (자동Generated)
