...
### 예제 2: 리소스 그룹 및 서버 이름으로 MySql 서버 얻기
```powershell
...
### 예제 3: 지정된 리소스 그룹의 모든 MySql 서버를 나열합니다.
```powershell
...
이 cmdlet은 지정된 리소스 그룹의 모든 MySql 서버를 나열합니다.

### 예제 4: ID로 MySql 서버 얻기
```powershell
...
이 cmdlet 목록은 ID로 MySql 서버를 얻습니다.
