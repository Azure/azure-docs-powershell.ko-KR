...
ResourceGroup01에서 test-group vm을 사용하여 새 Azure SQL 가상 머신 그룹을 만듭니다.
$profile Microsoft.Azure.Management.SqlVirtualMachine.Models.WsfcDomainProfile 형식의 개체입니다.
...
### -SqlServiceAccount
클러스터의 모든 SQL 가상 머신에서 SQL 서비스에서 실행되는 이름
