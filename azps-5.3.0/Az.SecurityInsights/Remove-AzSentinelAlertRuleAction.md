...
## 설명
**Remove-AzSentinelAlertRuleAction** cmdlet은 지정된 작업 영역의 경고 규칙에서 자동화된 응답을 영구적으로 삭제합니다.
파이프라인 연산자를 사용하여 **AlertRuleAction** 개체를 전달하거나 필요한 매개 변수를 지정할 수 있습니다.
