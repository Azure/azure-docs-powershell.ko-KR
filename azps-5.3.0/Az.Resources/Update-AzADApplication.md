...
개체 ID 'fb7b3405-ca44-4b5b-8584-12392f5d96d7'을 'MyNewDisplayName'으로 애플리케이션의 표시 이름을 업데이트합니다.
...
### 예제 3 - 파이핑을 사용하여 애플리케이션의 표시 이름 업데이트
...
### -ReplyUrl
로그인을 위해 사용자 토큰이 전송된 URL 또는 OAuth 2.0 인증 코드 및 액세스 토큰이 전송된 리디렉션 URIS를 지정합니다.
