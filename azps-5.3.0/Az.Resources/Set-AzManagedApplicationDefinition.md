...
관리되는 애플리케이션 정의를 업데이트합니다. (자동Generated)
...
### -Id
구독을 포함하여 정식으로 관리되는 애플리케이션 정의 ID입니다. 예: /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
