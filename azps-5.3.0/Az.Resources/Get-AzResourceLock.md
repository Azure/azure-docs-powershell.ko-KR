...
이 명령은 리소스 그룹 또는 구독에 대한 리소스 잠금을 얻습니다.
...
### -AtScope
이 cmdlet이 지정된 범위 이상의 모든 잠금을 반환합니다.
