...
## 설명
**Get-AzPolicyDefinition** cmdlet은 이름 또는 ID로 식별된 정책 정의 또는 특정 정책 정의의 컬렉션을 얻습니다.
...
### 예제 3: 이름에 따라 관리 그룹에서 정책 정의를 얻을 수 있습니다.
```
...
이 명령은 ID가 3bf44b72-c631-427a-b8c8-53e2595398ca인 구독에서 모든 기본 제공 정책 정의를 얻습니다.
...
### -Id
이 cmdlet에서 얻을 정책 정의에 대한 정식 리소스 ID를 지정합니다.
...
### -Name
이 cmdlet에서 얻을 정책 정의의 이름을 지정합니다.
