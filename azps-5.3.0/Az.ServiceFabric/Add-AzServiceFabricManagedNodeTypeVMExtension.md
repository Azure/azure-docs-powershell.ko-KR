...
## 설명
노드 유형에 vm 확장을 추가합니다. 이렇게 하면 확장이 밑이 있는 Virtual Machine Scale Set 리소스에 추가됩니다.
...
이 명령은 설정 및 보호된 설정이 있는 확장을 노드 유형에 추가합니다.
...
이 명령은 파이핑을 사용하여 노드 형식에 확장을 추가합니다.
...
### -ForceUpdateTag
값이 제공되고 이전 값과 다른 경우 확장 구성이 변경되지 않은 경우에도 확장 처리기에서 강제로 업데이트됩니다.
...
### -Publisher
확장 처리기 게시자의 이름입니다.
이 경우 Get-AzVMImagePublisher cmdlet을 사용하여 게시자를 얻을 수 있습니다.
