...
리소스 그룹의 지역에서 표준 가격 책정 계층 S1 및 태그를 사용하여 Azure IoT Hub 디바이스 프로비전 서비스를 만들 수 있습니다.
...
'eastus' 지역에 표준 가격 책정 계층 S1을 사용하여 Azure IoT Hub 디바이스 프로비전 서비스를 만들 수 있습니다.

## PARAMETERS

### -AllocationPolicy
IoT Device Provisioning Service 할당 정책
...
### -Tag
IoT Device Provisioning Service 인스턴스 태그입니다. 해시 테이블 형식의 키-값 쌍에 있는 속성 바입니다.
