...
## 설명
Azure IoT Hub 내에 포함된 대상 IoT 디바이스의 모든 모듈 또는 지정된 모듈의 연결 문자열을 나열합니다.
...
IoT Hub에서 대상 IoT 디바이스의 모든 모듈 연결 문자열을 보여 줄 수 있습니다.
...
IoT Hub에서 대상 IoT 디바이스의 보조 모듈 연결 문자열을 얻습니다.
