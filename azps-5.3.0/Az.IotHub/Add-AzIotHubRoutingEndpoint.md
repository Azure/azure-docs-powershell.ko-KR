...
## 설명
IoT Hub에 새 엔드포인트를 추가합니다. 지원되는 엔드포인트에 대한 자세한 내용은 https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
EventHub 유형의 새 엔드포인트 "E2"를 "myiothub" IoT Hub에 추가합니다.
...
AzureStorageContainer 유형의 새 엔드포인트 "S1"을 "myiothub" IoT Hub에 추가합니다.
...
### -Encoding
데이터를 라우팅할 형식을 선택합니다. JSON 또는 AVRO를 선택할 수 있습니다. 기본값은 AVRO로 설정됩니다.
