...
현재 계정에 대해 권한이 부여된 주어진 테넌트의 모든 구독을 나열합니다.
...
### 예제 4: 특정 구독을 사용하기 위해 현재 컨텍스트 변경
```
...
이 명령은 지정된 구독을 얻은 다음, 사용할 현재 컨텍스트를 설정합니다. 이 세션의 모든 후속 cmdlet은 기본적으로 새 구독(Contoso 구독 1)을 사용 합니다.
