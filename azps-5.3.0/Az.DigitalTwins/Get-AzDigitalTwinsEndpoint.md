...
### 예제 2: EndpointName으로 AzDigitalTwinsEndpoint Get
```powershell
...
ResourceGroup에서 EndpointName으로 AzDigitalTwinsEndpoint를 Get

### 예제 3: 'AzDigitalTwinsEndpoint' 개체로 AzDigitalTwinsEndpoint Get
```powershell
...
'AzDigitalTwinsEndpoint' 개체로 AzDigitalTwinsEndpoint를 만듭니다.
