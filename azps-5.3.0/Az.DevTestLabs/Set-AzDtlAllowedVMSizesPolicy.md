...
## 설명
**Set-AzDtlAllowedVMSizesPolicy** cmdlet은 허용되는 가상 머신 크기 정책을 설정하여 랩에서 허용되는 가상 머신 크기 목록을 지정합니다.
...
### -Disable
이 cmdlet이 정책을 사용하지 않도록 설정하는지 나타냅니다.
...
### -Enable
이 cmdlet에서 정책을 사용 가능하게 하여 나타냅니다.
...
### -LabName
이 cmdlet이 가상 머신 크기 정책을 설정하는 랩의 이름을 지정합니다.
...
### -VmSizes
문자열 배열로 랩에 허용되는 가상 머신 크기 목록을 지정합니다.
