...
## 설명
**Set-AzDtlAutoStartPolicy** cmdlet은 랩의 자동 시작 정책을 설정하여 랩 가상 머신을 자동 시작으로 예약할 수 있습니다.
cmdlet은 지정된 리소스 그룹 및 랩의 이름을 사용하여 정책을 설정합니다.

## 예제

### 예제 1

DevTest Labs에서 랩의 자동 시작 정책을 설정합니다. (자동Generated)
...
### -Days
랩의 가상 머신을 시작해야 하는 경우를 배열로 지정합니다.
...
### -Disable
이 cmdlet이 랩의 가상 머신에 대한 정책을 사용하지 않도록 설정하는지 나타냅니다.
...
### -Enable
이 cmdlet을 사용하여 랩의 가상 머신에 대한 정책을 사용할 수 있습니다.
...
### -LabName
이 cmdlet이 자동 시작 정책을 설정하는 랩의 이름을 지정합니다.
