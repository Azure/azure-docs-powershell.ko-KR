...
현재 구독 및 리소스 그룹 "rg1"에서 Spatial Anchors 계정 "example"의 개발자 키를 얻습니다.
...
현재 구독에서 Spatial Anchors 계정 "example"의 개발자 키를, 파이핑을 사용하여 리소스 그룹 "rg1"을 얻습니다.
