...
## 설명
**Stop-AzServiceBusMigration** cmdlet은 표준에서 프리미엄 네임스페이스로의 마이그레이션을 종료합니다.
...
Cmdlet은 마이그레이션 구성을 만드는 동안 제공된 표준 네임스페이스와 프리미엄 네임스페이스 간의 마이그레이션을 종료합니다.
...
### -ResourceId
Service Bus 마이그레이션 구성 표준 네임스페이스 리소스 ID
