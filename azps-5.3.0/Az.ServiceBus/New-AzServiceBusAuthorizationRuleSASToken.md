...
## SYNOPSIS
네임스페이스/큐/토픽의 Azure Servicebus 권한 부여 규칙에 대해 도난당한 SAS를 생성합니다. 
...
## 설명
이 New-AzServiceBusAuthorizationRuleSASToken cmdlet은 Azure Eventhub 네임스페이스 또는 Azure Eventhub에 대한 SAS(공유 액세스 서명) 토큰을 생성합니다.
...
시작 및 만료 시간이 있는 네임스페이스에 대해 주어진 승인 규칙에 대한 SAS 토큰을 생성합니다.
...
만료 시간이 있는 네임스페이스에 대해 주어진 승인 규칙에 대한 SAS 토큰을 생성합니다.
