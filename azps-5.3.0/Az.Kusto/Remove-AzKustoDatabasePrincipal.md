...
VALUE <IDatabasePrincipal[]>: Kusto 데이터베이스 보안 주체 목록입니다.
  ...
  - `[Email <String>]`: 데이터베이스 보안 주체 전자 메일이 있는 경우
  - `[Fqn <String>]`: 데이터베이스 주체의 정식 이름입니다.
