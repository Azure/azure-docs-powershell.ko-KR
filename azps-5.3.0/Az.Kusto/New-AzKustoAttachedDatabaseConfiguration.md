...
위의 명령은 클러스터 "testnewkustoclusterf"에 ReadOnly 데이터베이스 "mykustodatabase"를 만듭니다.
"testnewkustocluster" 클러스터의 데이터베이스 "mykustodatabase"를 따르는 경우
...
### -DatabaseName
연결하려는 데이터베이스의 이름입니다. 현재 및 미래의 모든 데이터베이스를 수행하려는 경우 *를 사용합니다.
