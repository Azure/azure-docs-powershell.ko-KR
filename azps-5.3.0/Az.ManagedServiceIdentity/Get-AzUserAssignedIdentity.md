...
## 설명
**Get-AzUserAssignedIdentity는** 기존 사용자 할당 ID를 얻습니다.

## 예제

### 예제 1
이 예제 cmdlet은 리소스 그룹 PSRG에서 이름 **ID1이** 있는 사용자 할당 ID를 **얻습니다.**
...
### 예제 2
이 예제 cmdlet은 리소스 그룹 PSRG에서 모든 사용자 할당 ID를 **얻습니다.**
...
### 예제 3
이 예제 cmdlet은 구독에서 모든 사용자 할당 ID를 얻습니다.
