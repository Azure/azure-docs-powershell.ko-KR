...
## 설명
**Remove-AzStreamAnalyticsInput** cmdlet은 Azure의 Stream Analytics 작업에서 입력을 비동기적으로 삭제합니다.
...
이 명령은 StreamingJob에서 입력 EventStream을 제거합니다.
...
### -Name
제거할 Azure Stream Analytics 입력의 이름을 지정합니다.
