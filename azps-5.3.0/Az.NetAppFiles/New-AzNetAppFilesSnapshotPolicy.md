...
## 설명
**New-AzNetAppFilesActiveDirectory** cmdlet은 ANF 계정에 대한 새 스냅숏 정책을 만듭니다.
...
이 명령은 "MyAccount"라는 ANF 계정에 대한 새 ANF 스냅숏 정책을 만듭니다.
