...
## 설명
**Remove-AzNetAppFilesBackupPolicy** cmdlet은 ANF 백업 정책을 삭제합니다.
...
이 명령은 "MyAccount" 계정에 대해 이름이 "MyBackupPolicy"인 새 ANF 백업 정책을 삭제합니다.
...
### -PassThru
지정된 백업 정책이 성공적으로 제거됐는지 여부를 반환합니다.
