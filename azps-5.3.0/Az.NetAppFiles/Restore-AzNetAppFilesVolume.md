...
## 설명
SnapshotId paramter에 지정된 스냅숏으로 볼륨 복원/되감기
...
이 명령은 7d6e4069-6c78-6c61-7bf6-c60968e45fbf의 snapshotId를 사용하여 볼륨 MyVolume을 해당 스냅숏 중 하나로 복원/되감기
...
### -PassThru
지정된 볼륨이 성공적으로 복원/되감은지 여부를 반환합니다.
