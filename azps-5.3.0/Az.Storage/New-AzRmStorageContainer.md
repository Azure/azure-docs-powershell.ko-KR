...
### 예제 2: Blob으로 공용 액세스가 있는 Storage 계정 개체 및 컨테이너 이름을 사용하여 Storage Blob 컨테이너 만들기
```
...
### 예제 3: EncryptionScope 설정을 사용하여 저장소 컨테이너 만들기
```
...
이 명령은 defalt encryptionScope를 사용하여 저장소 컨테이너를 만들고, 컨테이너 기본값에서 암호화 범위를 차단합니다.
그런 다음 관련 컨테이너 속성을 보여 주며,
