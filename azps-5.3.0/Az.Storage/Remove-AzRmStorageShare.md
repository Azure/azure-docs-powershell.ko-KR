...
## 설명
**New-AzRmStorageShare** cmdlet은 Storage 파일 공유를 제거합니다.

## 예제

### 예제 1: Storage 계정 이름 및 공유 이름을 사용하여 Storage 파일 공유 제거
```
...
### 예제 3: 파이프라인이 있는 Storage 계정의 모든 Storage 파일 공유 제거
```
...
### -Force
강제로 공유 및 해당 콘텐츠의 모든 콘텐츠를 제거합니다.
