...
### -NoExpiryTime
이 cmdlet이 저장된 액세스 정책에서 **ExpiryTime** 속성을 지우는지 나타냅니다.
...
### -NoStartTime
이 cmdlet이 저장된 액세스 정책에서 **StartTime** 속성을 지우는지 나타냅니다.
...
### -Permission
저장된 액세스 정책에서 공유 또는 그 아래에 있는 파일에 액세스할 수 있는 권한을 지정합니다.
