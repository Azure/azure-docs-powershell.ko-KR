...
## 설명
**Get-AzStorageServiceProperty** cmdlet은 Azure Storage 서비스에 대한 속성을 얻습니다.

## 예제

### 예제 1: Blob service의 Azure Storage 서비스 속성 얻기
```
...
이 명령은 Blob service의 DefaultServiceVersion 속성을 얻습니다.
