...
### 예제 1: Storage 계정 이름 및 공유 이름으로 Storage 파일 공유 다운로드
```
...
이 명령은 Storage 계정 이름 및 공유 이름을 사용하여 Storage 파일 공유를 얻습니다.
...
이 명령은 Storage 계정 이름을 사용하여 Storage 계정의 모든 Storage 파일 공유를 나열합니다.
...
### 예제 4: 공유 사용량이 있는 저장소 파일 공유(Bytes)
```
...
이 명령은 Storage 계정 이름 및 공유 이름을 사용하여 Storage 파일 공유를 얻게 하며, 공유 사용량을 Bytes로 포함합니다.
...
이 명령은 Storage 계정 이름을 사용하여 Storage 계정의 삭제된 공유를 포함해 모든 Storage 파일 공유를 나열합니다.
...
### -GetShareUsage
이 매개 변수를 지정하여 공유 사용량(Bytes)을 얻습니다.
