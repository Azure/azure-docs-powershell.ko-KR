...
## 설명
**Get-AzStorageAccount** cmdlet은 지정된 Storage 계정 또는 리소스 그룹 또는 구독의 모든 Storage 계정을 얻습니다.

## 예제

### 예제 1: 지정된 Storage 계정 얻기
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01" -Name "mystorageaccount"
```

이 명령은 지정된 Storage 계정을 얻습니다.

### 예제 2: 리소스 그룹의 모든 Storage 계정 얻기
```
PS C:\>Get-AzStorageAccount -ResourceGroupName "RG01"
```

이 명령은 리소스 그룹의 모든 Storage 계정을 얻습니다.

### 예제 3: 구독의 모든 Storage 계정 얻기
```
PS C:\>Get-AzStorageAccount
```

이 명령은 구독의 모든 Storage 계정을 얻습니다.

### 예제 4: Blob 복원 상태가 있는 Storage 계정 얻기
```
...
이 명령은 Blob 복원 상태가 있는 Storage 계정을 얻게 하여 Blob 복원 상태를 보여 주며,
...
Storage 계정의 BlobRestoreStatus를 얻습니다.
...
Storage 계정의 GeoReplicationStats를 얻습니다.
...
### -ResourceGroupName
얻을 Storage 계정이 포함된 리소스 그룹의 이름을 지정합니다.
