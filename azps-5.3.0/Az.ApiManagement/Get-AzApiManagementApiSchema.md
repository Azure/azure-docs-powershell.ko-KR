...
### 예제 1: API의 모든 API Schema에 대한 세부 정보 확인
```powershell
...
이 명령은 특정 ApiManagement 컨텍스트에 대한 API와 연결된 모든 `swagger-petstore-extensive` API 스마마를 얻습니다.

### 예제 2: API와 연결된 특정 스마마를 얻게 됩니다.
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceId /subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.ApiManagement/service/sdktestapim4163
...
### -ResourceId
Api Schema의 Arm 리소스 식별자입니다. 지정된 경우 식별자에 의해 API 스마마를 찾으려고 시도합니다. 이 매개 변수는 필수입니다.
