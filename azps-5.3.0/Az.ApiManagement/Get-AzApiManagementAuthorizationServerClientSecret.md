...
## 설명
**Get-AzApiManagementAuthorizationServerClientSecret** cmdlet은 Azure API Management 권한 부여 서버의 클라이언트 비밀을 얻습니다.

## 예제

### 예제 1: ID로 지정된 권한 부여 서버 클라이언트 비밀을 얻게
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

이 명령은 지정된 권한 부여 서버 cient 비밀을 얻습니다.
...
지정된 경우 식별자에 의해 권한 부여 서버를 찾으려고 시도합니다.
이 매개 변수는 필수입니다.
...
### -ServerId
권한 부여 서버의 식별자입니다.
지정된 경우 식별자에 의해 권한 부여 서버를 찾을 수 있습니다.
이 매개 변수는 선택 사항입니다.
