...
## 설명
**New-AzApiManagementUserToken** cmdlet은 지정된 사용자에 대한 공유 액세스 토큰을 생성합니다.
...
이 스크립트는 ApiManagement 서비스에서 구성된 Git 사용자를 사용하고 8시간 동안 유효한 기본 키를 사용하여 공유 액세스 토큰을 생성합니다.

### 예제 2

사용자에 대한 공유 액세스 토큰을 생성합니다. (자동Generated)
