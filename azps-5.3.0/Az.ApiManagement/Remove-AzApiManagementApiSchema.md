...
## 설명
Api에서 **Remove-AzApiManagementSchema cmdlet입니다.**

## 예제

### 예제 1: API에서 Api Schema 제거
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzAzureRmApiManagementApiSchema -Context $apimContext -ApiId "echo-api" -SchemaId "2"
```

스크립트는 참조되지 않는 경우 `2` API에서 Schema를 `echo-api` 제거합니다.

### 예제 2

스크립트는 참조되지 않는 경우 Api echo-api에서 Schema 2를 제거합니다. (자동Generated)
...
### -ResourceId
ApiSchema의 Arm ResourceId입니다. 이 매개 변수는 필수입니다.
