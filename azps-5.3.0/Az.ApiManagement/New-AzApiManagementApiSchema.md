...
## 설명
API의 새 API Schema를 만듭니다.

## 예제

### 예제 1: Swagger Petstore 광범위한 API에 대한 새 Schema 만들기
```powershell
...
**New-AzApiManagementApiSchema** cmdlet은 aPI의 스마마를 생성하거나 `swagger-petstore-extensive` 업데이트합니다.
...
api Schema의 ContentType입니다. 이 매개 변수는 필수입니다.
