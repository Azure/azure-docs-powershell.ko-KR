...
## 설명
**Set-AzApiManagementTenantAccess** cmdlet은 테넌트 액세스를 활성화하거나 비활성화합니다.
...
이 명령을 사용하면 지정된 컨텍스트에서 테넌트에 액세스할 수 있습니다.
...
### -Enabled
이 cmdlet이 테넌트 액세스를 활성화 또는 비활성화할지 여부를 지정합니다.
사용하지 않도록 설정하거나 $True 값을 $False 지정합니다.
...
### -PassThru
이 cmdlet이 이 cmdlet이 수정한 **PsApiManagementAccessInformation을** 반환합니다.
