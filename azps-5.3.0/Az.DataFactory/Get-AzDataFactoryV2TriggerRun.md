...
## 설명
**Get-AzDataFactoryV2TriggerRun** 명령은 지정된 시간 프레임에서 지정된 트리거에 대한 트리거 실행에 대한 자세한 정보를 반환합니다.

## 예제

### 예제 1: 트리거 실행에 대한 정보 얻기
```
...
이 명령은 "2017-09-01"과 "2019-09-30" 사이에 시작된 팩터리 "WikiADF"의 "WikiTrigger"에 대한 실행에 대한 정보를 보여줍니다.
...
트리거 실행이 ISO8601 형식으로 실행하기 시작한 시간 또는 그 이후의 시간입니다.
...
트리거 실행이 ISO8601 형식으로 실행되기 시작한 시간 또는 이전 시간입니다.
