...
## 설명
**Stop-AzDataFactoryV2PipelineRun** cmdlet은 파이프라인 실행 ID로 지정된 데이터 팩터리에서 파이프라인 실행을 중지합니다.
...
이 명령은 팩터리 WikiADF에서 id b9730a13-aa12-4926-a8b3-8e3a974ab0bd를 사용하여 파이프라인 실행을 중지합니다.
