...
## 설명
**Get-AzDataFactoryV2IntegrationRuntimeNode** cmdlet은 통합 런타임 노드의 세부 정보를 얻습니다.

## 예제

### 예제 1: 통합 런타임 노드의 세부 정보를 얻습니다.
```
...
cmdlet은 데이터 팩터리 'test-df-eu2'의 자체 호스팅 통합 런타임 'test-selfhost-ir'에서 'Node_1'라는 노드의 정보를 얻습니다.

### 예제 2: IP 주소와 함께 통합 런타임 노드의 세부 정보를 얻습니다.
```
...
cmdlet은 IP 주소를 포함하여 데이터 팩터리 'test-df-eu2'의 자체 호스팅 통합 런타임 'test-selfhost-ir'에서 'Node_1'라는 노드의 정보를 얻습니다.
