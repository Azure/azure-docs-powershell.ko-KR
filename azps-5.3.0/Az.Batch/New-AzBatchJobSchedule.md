...
## 설명
**New-AzBatchJobSchedule** cmdlet은 Azure Batch 서비스에 작업 일정을 만듭니다.
...
이 명령은 New-Object 및 표준 Azure PowerShell 구문을 사용 합니다.
명령은 이러한 개체를 $Schedule 변수에 $JobSpecification 저장합니다.
...
### -Id
이 cmdlet에서 만드는 작업 일정의 ID를 지정합니다.
...
### -Metadata
작업 일정에 추가할 메타데이터를 키/값 쌍으로 지정합니다.
키는 메타데이터 이름입니다.
값은 메타데이터 값입니다.
