...
## 설명
**Enable-AzBatchAutoScale** cmdlet을 사용하면 지정된 풀의 자동 크기 조정을 사용할 수 있습니다.

## 예제

### 예제 1: 풀에 대한 자동 크기 조정 사용
```
...
첫 번째 명령은 수식을 정의한 다음, 수식을 $Formula 저장합니다.
두 번째 명령은 명령에서 수식을 사용하여 MyPool이라는 풀에서 자동 크기 조정을 $Formula.

## PARAMETERS

### -AutoScaleEvaluationInterval
풀 크기가 자동 크기 조정 수식에 따라 자동으로 조정되기 전에 경과하는 시간(분)을 지정합니다.
기본값은 15분, 최소값은 5분입니다.
...
### -Id
자동 크기 조정을 사용하도록 설정할 풀의 개체 ID를 지정합니다.
