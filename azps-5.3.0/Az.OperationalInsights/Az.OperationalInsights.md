...
## 설명
이 항목에서는 Azure Operational Insights Cmdlet에 대한 도움말 항목을 제공합니다.
...
Azure Log Analytics 작업 영역 아래에서 데이터 원본을 얻습니다.
