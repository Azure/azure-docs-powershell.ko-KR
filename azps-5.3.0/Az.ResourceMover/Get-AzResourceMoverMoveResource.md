...
### 예제 1: 이동 컬렉션의 모든 리소스에 대한 세부 정보를 얻습니다.
```powershell
...
이동 컬렉션의 모든 리소스에 대한 세부 정보를 얻습니다.

### 예제 2: 리소스 이름을 이동하여 이동 컬렉션에서 특정 리소스에 대한 세부 정보를 얻습니다.
```powershell
...
이동 리소스 이름을 사용하여 이동 컬렉션에서 특정 리소스에 대한 세부 정보를 얻습니다.

### 예제 3:SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState와 같은 필터를 사용하여 이동 컬렉션의 특정 리소스에 대한 세부 정보 얻습니다.
```powershell
...
armid, moveStatusMoveState(verify) 등의 필터를 사용하여 Move 컬렉션의 특정 리소스에 대한 세부 정보를 얻습니다.
