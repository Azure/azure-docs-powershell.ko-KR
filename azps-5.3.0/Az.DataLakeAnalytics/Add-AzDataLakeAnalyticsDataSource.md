...
## 설명
**Add-AzDataLakeAnalyticsDataSource** cmdlet은 Azure Data Lake Analytics 계정에 데이터 원본을 추가합니다.
...
이 명령은 Data Lake Analytics 계정에 Data Lake Store 데이터 원본을 추가합니다.

### 예제 2

데이터 레이크 분석 계정에 데이터 원본을 추가합니다. (자동Generated)
...
### -AccessKey
추가할 Azure Blob Storage 계정의 액세스 키를 지정합니다.
...
### -Blob
추가할 Azure Blob Storage 계정의 이름을 지정합니다.
...
### -DataLakeStore
추가할 Azure Data Lake Store 계정의 이름을 지정합니다.
