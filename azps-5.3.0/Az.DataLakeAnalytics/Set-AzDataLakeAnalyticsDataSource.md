...
## 설명
**Set-AzDataLakeAnalyticsDataSource** cmdlet은 Azure Data Lake Analytics 계정의 데이터 원본에 대한 세부 정보를 수정합니다.

## 예제

### 예제 1: 데이터 원본에 대한 액세스 키 변경
```
PS C:\>Set-AzDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "contosowasb" -AccessKey "...newaccesskey..."
```

이 명령은 Azure Blob Storage 데이터 원본에 대해 저장된 액세스 키를 변경합니다.

## PARAMETERS

### -AccessKey
Azure Blob Storage 데이터 원본의 새 액세스 키를 지정합니다.
