...
## 설명
**Remove-AzDataLakeAnalyticsComputePolicy는** 지정된 Azure Data Lake Analytics 계산 정책을 제거합니다.
...
이 명령은 계정 'contosoadla'에서 이름이 'myPolicy'인 지정된 계산 정책을 제거합니다.

## PARAMETERS

### -Account
계산 정책을 제거할 계정의 이름입니다.
