...
## 설명
**Get-AzDataBoxCredential** cmdlet은 특정 작업의 데이터 상자 자격 증명을 얻습니다. 반환된 자격 증명 개체의 내부 속성은 SKU 유형마다 다릅니다.
...
그러면 지정된 작업의 JobSecrets가 다시 계산됩니다.
